...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 442C620F385
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Jun 2020 13:28:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730645AbgF3L2B (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 30 Jun 2020 07:28:01 -0400
Received: from mga14.intel.com ([192.55.52.115]:9353 "EHLO mga14.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1730106AbgF3L2A (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 30 Jun 2020 07:28:00 -0400
IronPort-SDR: XQA6AyiajpP3U2/gAxfCzzgytiS+kZl7RkAULbJTBzuidELoVF/wz+7iuAjreiZZbRzhbl5/Yj
 8HMZSqMQj+1A==
X-IronPort-AV: E=McAfee;i="6000,8403,9666"; a="145257846"
X-IronPort-AV: E=Sophos;i="5.75,297,1589266800"; 
   d="yaml'?scan'208";a="145257846"
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 30 Jun 2020 02:26:35 -0700
IronPort-SDR: G2d3KhDbqq8nwxNmh2k+RiodG5iFC+EPmoekujK17RZ4qDv5Xc0Kjl/9fTGImJ42zGWArsEtJE
 7nXtfP0u+u8A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,297,1589266800"; 
   d="yaml'?scan'208";a="321342458"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.3])
  by orsmga007.jf.intel.com with ESMTP; 30 Jun 2020 02:26:32 -0700
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="mSyhTGF9VKBQ91i8"
...
Content-Disposition: attachment; filename="config-5.6.0-11868-g2913aa304cefe"
...
export_top_env()
{
	...
	export job_origin='/lkp/lkp/.src-20200508-142806/allot/cyclic:p2:linux-devel:devel-hourly/lkp-hsw-d01/filebench-part1.yaml'
...
queue_at_least_once'
	...
	export submit_id='5ef83d870de43711bb85bfb3'
	export job_file='/lkp/jobs/scheduled/lkp-hsw-d01/filebench-performance-1HDD-f2fs-createfiles.f-ucode=0x27-debian-x86_64-20191114.cgz-2913aa304cefe4033228a315bc497983b3f3be08-20200628-4539-1gdim4w-2.yaml'
	export id='f838167eafc827c364d2c504780eb2233feb2b58'
...
CONFIG_PCI=y
CONFIG_F2FS_FS'
	export commit='2913aa304cefe4033228a315bc497983b3f3be08'
	export ucode='0x27'
...
CONFIG_ATA_PIIX'
	...
	export enqueue_time='2020-06-28 14:49:44 +0800'
	export _id='5ef83d870de43711bb85bfb3'
	export _rt='/result/filebench/performance-1HDD-f2fs-createfiles.f-ucode=0x27/lkp-hsw-d01/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/2913aa304cefe4033228a315bc497983b3f3be08'
	export user='lkp'
	export head_commit='33119470d950e6fc3e228a25bdab29a12b4ff7b4'
	export base_commit='0e698dfa282211e414076f9dc7e83c1c288314fd'
	export branch='linux-devel/devel-hourly-2020050816'
	export rootfs='debian-x86_64-20191114.cgz'
	export result_root='/result/filebench/performance-1HDD-f2fs-createfiles.f-ucode=0x27/lkp-hsw-d01/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/2913aa304cefe4033228a315bc497983b3f3be08/3'
	export scheduler_version='/lkp/lkp/.src-20200628-114944'
	export LKP_SERVER='inn'
	export arch='x86_64'
	export max_uptime=739.28
	export initrd='/osimage/debian/debian-x86_64-20191114.cgz'
	export bootloader_append='root=/dev/ram0
user=lkp
job=/lkp/jobs/scheduled/lkp-hsw-d01/filebench-performance-1HDD-f2fs-createfiles.f-ucode=0x27-debian-x86_64-20191114.cgz-2913aa304cefe4033228a315bc497983b3f3be08-20200628-4539-1gdim4w-2.yaml
ARCH=x86_64
kconfig=x86_64-rhel-7.6
branch=linux-devel/devel-hourly-2020050816
commit=2913aa304cefe4033228a315bc497983b3f3be08
BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/2913aa304cefe4033228a315bc497983b3f3be08/vmlinuz-5.6.0-11868-g2913aa304cefe
max_uptime=739
RESULT_ROOT=/result/filebench/performance-1HDD-f2fs-createfiles.f-ucode=0x27/lkp-hsw-d01/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/2913aa304cefe4033228a315bc497983b3f3be08/3
LKP_SERVER=inn
nokaslr
selinux=0
debug
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-7.6/gcc-7/2913aa304cefe4033228a315bc497983b3f3be08/modules.cgz'
	...
	export last_kernel='5.7.0-rc4-07563-g33119470d950e'
	export repeat_to=4
	export schedule_notify_address=
	export queue_at_least_once=1
	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-7/2913aa304cefe4033228a315bc497983b3f3be08/vmlinuz-5.6.0-11868-g2913aa304cefe'
	export dequeue_time='2020-06-28 15:02:02 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-hsw-d01/filebench-performance-1HDD-f2fs-createfiles.f-ucode=0x27-debian-x86_64-20191114.cgz-2913aa304cefe4033228a315bc497983b3f3be08-20200628-4539-1gdim4w-2.cgz'
...
filebench-setup:
  test: createfiles.f
filebench: 
job_origin: "/lkp/lkp/.src-20200508-142806/allot/cyclic:p2:linux-devel:devel-hourly/lkp-hsw-d01/filebench-part1.yaml"
...
submit_id: 5ef82ee976743b0d6d88a332
job_file: "/lkp/jobs/scheduled/lkp-hsw-d01/filebench-performance-1HDD-f2fs-createfiles.f-ucode=0x27-debian-x86_64-20191114.cgz-2913aa304cefe4033228a315bc497983b3f3be08-20200628-3437-1ndwdqm-1.yaml"
id: 3e0fc9e696c2c7966356fc035ff4f8de2b13d466
...
kconfig: x86_64-rhel-7.6
compiler: gcc-7
enqueue_time: 2020-06-28 13:47:22.084980500 +08:00
_id: 5ef82eee76743b0d6d88a333
_rt: "/result/filebench/performance-1HDD-f2fs-createfiles.f-ucode=0x27/lkp-hsw-d01/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/2913aa304cefe4033228a315bc497983b3f3be08"

#! schedule options
user: lkp
head_commit: 33119470d950e6fc3e228a25bdab29a12b4ff7b4
base_commit: 0e698dfa282211e414076f9dc7e83c1c288314fd
branch: linux-devel/devel-hourly-2020050816
rootfs: debian-x86_64-20191114.cgz
result_root: "/result/filebench/performance-1HDD-f2fs-createfiles.f-ucode=0x27/lkp-hsw-d01/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/2913aa304cefe4033228a315bc497983b3f3be08/0"
scheduler_version: "/lkp/lkp/.src-20200628-114944"
LKP_SERVER: inn
arch: x86_64
max_uptime: 739.28
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-hsw-d01/filebench-performance-1HDD-f2fs-createfiles.f-ucode=0x27-debian-x86_64-20191114.cgz-2913aa304cefe4033228a315bc497983b3f3be08-20200628-3437-1ndwdqm-1.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2020050816
- commit=2913aa304cefe4033228a315bc497983b3f3be08
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/2913aa304cefe4033228a315bc497983b3f3be08/modules.cgz"
...
#! /lkp/lkp/.src-20200508-221914/include/site/inn
LKP_CGI_PORT: 80
LKP_CIFS_PORT: 139
oom-killer: 
watchdog: 
...
#! runtime status
last_kernel: 5.7.0-00161-gc1b32c27f77ce
repeat_to: 2
schedule_notify_address: 

#! user overrides
queue_at_least_once: 0
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/2913aa304cefe4033228a315bc497983b3f3be08/vmlinuz-5.6.0-11868-g2913aa304cefe"
dequeue_time: 2020-06-28 14:05:39.731318291 +08:00

#! /lkp/lkp/.src-20200628-114944/include/site/inn
job_state: finished
loadavg: 1.85 0.59 0.21 1/169 1637
start_time: '1593324402'
end_time: '1593324414'
version: "/lkp/lkp/.src-20200628-115020:2538e288:d153ddb5e"
