...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0A4A72E75C5
	for <lists+linux-kernel@lfdr.de>; Wed, 30 Dec 2020 04:16:04 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726244AbgL3DN1 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 29 Dec 2020 22:13:27 -0500
Received: from mga17.intel.com ([192.55.52.151]:44534 "EHLO mga17.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726161AbgL3DN0 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 29 Dec 2020 22:13:26 -0500
IronPort-SDR: oM8wLJc9T5Yvhx/gS957nBEPGJRmS65s9QwvbXVvk05ed5P2vRACv5gdku5lvXjf+eqZS+Zo26
 SIcFDE6t60pw==
X-IronPort-AV: E=McAfee;i="6000,8403,9849"; a="156350078"
X-IronPort-AV: E=Sophos;i="5.78,460,1599548400"; 
   d="yaml'?scan'208";a="156350078"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 29 Dec 2020 19:12:43 -0800
IronPort-SDR: oJDdkjQ47b40vPM/9bzqmzf4jL5m7GGeXz6sSTtfIzOJ4JcHcQL7ZWpYTTGi6paW+WFaNTWJt7
 2kxwZAItajAQ==
X-IronPort-AV: E=Sophos;i="5.78,460,1599548400"; 
   d="yaml'?scan'208";a="567913543"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.140])
  by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 29 Dec 2020 19:12:39 -0800
...
Subject: [mm/filemap.c]  06c0444290:  stress-ng.sendfile.ops_per_sec 26.7%
 improvement
Message-ID: <20201230032753.GC22185@xsang-OptiPlex-9020>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.10.0-g06c0444290ce"
...
export_top_env()
{
	...
	export testtime=30
	export job_origin='/lkp-src/allot/cyclic:p1:internal-devel:devel-hourly/lkp-csl-2sp5/stress-ng-part2.yaml'
...
queue_at_least_once'
	...
	export submit_id='5feb50ba9022471c434e2a6d'
	export job_file='/lkp/jobs/scheduled/lkp-csl-2sp5/stress-ng-pipe-performance-1HDD-100%-30s-ucode=0x5003003-monitor=0fe5055f-debian-10.4-x86_64-20200603.cgz-06c0444290cecf04c89c62-20201229-7235-rqhbq0-3.yaml'
	export id='8b191df728eddb06b06191c742cc2831d9d14d44'
...
CONFIG_PCI=y
CONFIG_SECURITY_APPARMOR=y'
	export commit='06c0444290cecf04c89c62e6d448b8461507d247'
	export need_kconfig_hw='CONFIG_I40E=y
CONFIG_SATA_AHCI'
	export ucode='0x5003003'
	export enqueue_time='2020-12-29 23:52:26 +0800'
	export _id='5feb50bd9022471c434e2a6e'
	export _rt='/result/stress-ng/pipe-performance-1HDD-100%-30s-ucode=0x5003003-monitor=0fe5055f/lkp-csl-2sp5/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/06c0444290cecf04c89c62e6d448b8461507d247'
	export user='lkp'
	export compiler='gcc-9'
	export LKP_SERVER='internal-lkp-server'
	export head_commit='88fdf0d0c1537f37465295463ea5fb0c8963c203'
	export base_commit='2c85ebc57b3e1817b6ce1a6b703928e113a90442'
	export branch='linus/master'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export monitor_sha='0fe5055f'
	export result_root='/result/stress-ng/pipe-performance-1HDD-100%-30s-ucode=0x5003003-monitor=0fe5055f/lkp-csl-2sp5/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/06c0444290cecf04c89c62e6d448b8461507d247/3'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-csl-2sp5/stress-ng-pipe-performance-1HDD-100%-30s-ucode=0x5003003-monitor=0fe5055f-debian-10.4-x86_64-20200603.cgz-06c0444290cecf04c89c62-20201229-7235-rqhbq0-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-8.3
branch=linus/master
commit=06c0444290cecf04c89c62e6d448b8461507d247
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/06c0444290cecf04c89c62e6d448b8461507d247/vmlinuz-5.10.0-g06c0444290ce
max_uptime=2100
RESULT_ROOT=/result/stress-ng/pipe-performance-1HDD-100%-30s-ucode=0x5003003-monitor=0fe5055f/lkp-csl-2sp5/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/06c0444290cecf04c89c62e6d448b8461507d247/3
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/06c0444290cecf04c89c62e6d448b8461507d247/modules.cgz'
	...
	export last_kernel='5.10.0-10486-ge1b4cc38cd31'
	export repeat_to=4
	export queue_at_least_once=1
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/06c0444290cecf04c89c62e6d448b8461507d247/vmlinuz-5.10.0-g06c0444290ce'
	export dequeue_time='2020-12-30 00:15:31 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2sp5/stress-ng-pipe-performance-1HDD-100%-30s-ucode=0x5003003-monitor=0fe5055f-debian-10.4-x86_64-20200603.cgz-06c0444290cecf04c89c62-20201229-7235-rqhbq0-3.cgz'
...
stress-ng:
  class: pipe
job_origin: "/lkp-src/allot/cyclic:p1:internal-devel:devel-hourly/lkp-csl-2sp5/stress-ng-part2.yaml"
...
kconfig: x86_64-rhel-8.3
submit_id: 5feb3fb54feed114bd4f8693
job_file: "/lkp/jobs/scheduled/lkp-csl-2sp5/stress-ng-pipe-performance-1HDD-100%-30s-ucode=0x5003003-monitor=0fe5055f-debian-10.4-x86_64-20200603.cgz-06c0444290cecf04c89c62-20201229-5309-lcu8jc-0.yaml"
id: 7c5c383617e7a2ed3e2dc9cb372c0526c819374f
...
- CONFIG_SATA_AHCI
ucode: '0x5003003'
enqueue_time: 2020-12-29 22:39:49.645322451 +08:00
_id: 5feb3fb54feed114bd4f8693
_rt: "/result/stress-ng/pipe-performance-1HDD-100%-30s-ucode=0x5003003-monitor=0fe5055f/lkp-csl-2sp5/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/06c0444290cecf04c89c62e6d448b8461507d247"

#! schedule options
user: lkp
compiler: gcc-9
LKP_SERVER: internal-lkp-server
head_commit: 88fdf0d0c1537f37465295463ea5fb0c8963c203
base_commit: 2c85ebc57b3e1817b6ce1a6b703928e113a90442
branch: internal-devel/devel-hourly-2020122608
rootfs: debian-10.4-x86_64-20200603.cgz
monitor_sha: 0fe5055f
result_root: "/result/stress-ng/pipe-performance-1HDD-100%-30s-ucode=0x5003003-monitor=0fe5055f/lkp-csl-2sp5/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/06c0444290cecf04c89c62e6d448b8461507d247/0"
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-csl-2sp5/stress-ng-pipe-performance-1HDD-100%-30s-ucode=0x5003003-monitor=0fe5055f-debian-10.4-x86_64-20200603.cgz-06c0444290cecf04c89c62-20201229-5309-lcu8jc-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- branch=internal-devel/devel-hourly-2020122608
- commit=06c0444290cecf04c89c62e6d448b8461507d247
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/06c0444290cecf04c89c62e6d448b8461507d247/modules.cgz"
...
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/06c0444290cecf04c89c62e6d448b8461507d247/vmlinuz-5.10.0-g06c0444290ce"
dequeue_time: 2020-12-29 23:34:33.649692020 +08:00

#! /lkp/lkp/.src-20201229-084757/include/site/inn
job_state: finished
loadavg: 529.10 492.87 207.76 1/818 17658
start_time: '1609319859'
end_time: '1609320042'
