...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B0CC430013B
	for <lists+linux-kernel@lfdr.de>; Fri, 22 Jan 2021 12:12:21 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728277AbhAVLJu (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 22 Jan 2021 06:09:50 -0500
Received: from mga07.intel.com ([134.134.136.100]:24040 "EHLO mga07.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728246AbhAVLDx (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 22 Jan 2021 06:03:53 -0500
IronPort-SDR: wVWRd0O4NaZ+8VgvbUTaiv4JdPK3KY/tqKvrTojeNKRKKQCWeYKMfKYxDDwvAz3MDhRqAW3sYY
 64Jvlwxx6lhQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9871"; a="243508232"
X-IronPort-AV: E=Sophos;i="5.79,366,1602572400"; 
   d="scan'208";a="243508232"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 22 Jan 2021 03:02:32 -0800
IronPort-SDR: u4sdJtWQHtyBVQ/LDMIOgT7VgMVpzh/3cC9gBUOjx6MW1XYuC+NAEq9l9icEY1C/5UMBN/d0iJ
 mw663WJ8+3Ow==
X-IronPort-AV: E=Sophos;i="5.79,366,1602572400"; 
   d="scan'208";a="385718419"
Received: from shsi6026.sh.intel.com (HELO localhost) ([10.239.147.88])
  by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 22 Jan 2021 03:02:23 -0800
...
Subject: [PATCH v8 09/18] virt: acrn: Introduce I/O request management
Date:   Fri, 22 Jan 2021 19:01:13 +0800
Message-Id: <20210122110122.45800-10-shuo.a.liu@intel.com>
...
---
 ...
 7 files changed, 839 insertions(+), 10 deletions(-)
...
index 2c40d3dc5e94..9fb83845bf3e 100644
...
@@ -147,6 +148,31 @@ static long acrn_dev_ioctl(struct file *filp, unsigned int cmd,
...
+		break;
 	default:
 		...
 		ret = -ENOTTY;
@@ -188,14 +214,23 @@ static int __init hsm_init(void)
 		return -EPERM;
...
index ec4c61e7c170..0f79b2b01132 100644
