...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A4F421BEE76
	for <lists+linux-kernel@lfdr.de>; Thu, 30 Apr 2020 05:01:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726510AbgD3DBC (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 29 Apr 2020 23:01:02 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37928 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-FAIL-OK-FAIL)
        by vger.kernel.org with ESMTP id S1726180AbgD3DBB (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 29 Apr 2020 23:01:01 -0400
Received: from mail-qv1-xf31.google.com (mail-qv1-xf31.google.com [IPv6:2607:f8b0:4864:20::f31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 64691C035494
        for <linux-kernel@vger.kernel.org>; Wed, 29 Apr 2020 20:01:01 -0700 (PDT)
Received: by mail-qv1-xf31.google.com with SMTP id t8so2303095qvw.5
        for <linux-kernel@vger.kernel.org>; Wed, 29 Apr 2020 20:01:01 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=lca.pw; s=google;
        h=from:content-transfer-encoding:mime-version:subject:message-id:date
         :cc:to;
        bh=pcX1iBST3ggSmLCKwPwjWXP0fehPqRnU84dLFQKUi24=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=pcX1iBST3ggSmLCKwPwjWXP0fehPqRnU84dLFQKUi24=;
        b=
X-Gm-Message-State: AGi0PuYj3zp+sLvq8Q156yxbIAdToT52OuHo7JhVX3VGsJU6x/n94MP2
        NNBHkvAVHpSyw3n/Q/pPzoQWry/f3v/o+g==
X-Google-Smtp-Source: APiQypLp8eY0rZ/6uMZBgpQ4FgvaY/zyoCjDn1Aiw/DvDydrUDU6IerHbraBRUGHRVrNk8bEYZ6ULQ==
X-Received: by 2002:a0c:d993:: with SMTP id y19mr997052qvj.144.1588215659961;
        Wed, 29 Apr 2020 20:00:59 -0700 (PDT)
Received: from [192.168.1.153] (pool-71-184-117-43.bstnma.fios.verizon.net. [71.184.117.43])
        by smtp.gmail.com with ESMTPSA id b19sm854771qkg.72.2020.04.29.20.00.58
...
Subject: rcu_barrier() + membarrier() + scheduler deadlock?
Message-Id: <F64C791A-0EA7-458E-82C0-B98A1032066C@lca.pw>
Date:   Wed, 29 Apr 2020 23:00:58 -0400
...
Doing some fuzzers on many CPUs triggers a deadlock really quickly.  I =
can see that there were several tasks had been stuck for a while,
...
[52902.560427][T151328] futex_wake_op: trinity-c10 tries to shift op by =
-1; fix this program
[52902.571250][  T310] INFO: task trinity-c18:145344 can't die for more =
than 123 seconds.
[52902.648554][  T310] trinity-c18     R  running task    26944 145344  =
74932 0x10004004
...
[52903.068733][  T310] RSP: 002b:00007fff1d6588c8 EFLAGS: 00000246 =
ORIG_RAX: 00000000000000cb
[52903.107680][  T310] RAX: 0000000000000000 RBX: 00000000000000cb RCX: =
00007fa3d9cd670d
[52903.144861][  T310] RDX: 00007fa3d7c38000 RSI: 0000000000000004 RDI: =
0000000000000000
[52903.182189][  T310] RBP: 00000000000000cb R08: 000000000000ca23 R09: =
00000000000000b3
[52903.219290][  T310] R10: 000000002ab3d706 R11: 0000000000000246 R12: =
0000000000000002
[52903.256653][  T310] R13: 00007fa3d8608058 R14: 00007fa3d9b956c0 R15: =
00007fa3d8608000
[52903.294988][  T310] INFO: task trinity-c24:146199 can't die for more =
than 124 seconds.
[52903.333911][  T310] trinity-c24     R  running task    26944 146199  =
74932 0x10000004
...
[52904.231318][  T310] RSP: 002b:00007fff1d6588c8 EFLAGS: 00000246 =
ORIG_RAX: 00000000000000cb
[52904.269002][  T310] RAX: ffffffffffffffda RBX: 00000000000000cb RCX: =
00007fa3d9cd670d
[52904.344529][  T310] RDX: 00007fa3d803c000 RSI: 0000000000000200 RDI: =
0000000000000000
[52904.382761][  T310] RBP: 00000000000000cb R08: 0001802261008040 R09: =
00000000000000ba
[52904.422223][  T310] R10: 00000000000000a8 R11: 0000000000000246 R12: =
0000000000000002
[52904.458152][  T310] R13: 00007fa3d85de058 R14: 00007fa3d9b956c0 R15: =
00007fa3d85de000
[52904.494711][  T310] INFO: task trinity-c6:146436 can't die for more =
than 125 seconds.
[52904.530683][  T310] trinity-c6      R  running task    27328 146436  =
74932 0x10000004
...
[52905.390680][  T310] RSP: 002b:00007fff1d6588c8 EFLAGS: 00000246 =
ORIG_RAX: 00000000000000cb
[52905.432007][  T310] RAX: ffffffffffffffda RBX: 00000000000000cb RCX: =
00007fa3d9cd670d
[52905.470212][  T310] RDX: 00007fa3d7e3c000 RSI: 0000000000000004 RDI: =
0000000000000000
[52905.507836][  T310] RBP: 00000000000000cb R08: 00000000fffffff9 R09: =
ffffffffffff896f
[52905.545501][  T310] R10: 000000000000fff7 R11: 0000000000000246 R12: =
0000000000000002
[52905.581885][  T310] R13: 00007fa3d865c058 R14: 00007fa3d9b956c0 R15: =
00007fa3d865c000
[52905.620176][  T310] INFO: task trinity-c38:147003 can't die for more =
than 126 seconds.
[52905.656622][  T310] trinity-c38     R  running task    27880 147003  =
74932 0x10000004
...
[52906.511339][  T310] RSP: 002b:00007fff1d6588c8 EFLAGS: 00000246 =
ORIG_RAX: 00000000000000cb
[52906.549312][  T310] RAX: ffffffffffffffda RBX: 00000000000000cb RCX: =
00007fa3d9cd670d
[52906.585138][  T310] RDX: 00007fa3d7c3c000 RSI: 0000000000000008 RDI: =
0000000000000000
[52906.620955][  T310] RBP: 00000000000000cb R08: fffffffffffffff8 R09: =
fffffffffffffffc
[52906.657616][  T310] R10: 0000000000000200 R11: 0000000000000246 R12: =
0000000000000002
[52906.694196][  T310] R13: 00007fa3d857c058 R14: 00007fa3d9b956c0 R15: =
00007fa3d857c000
[52906.730152][  T310] INFO: task trinity-c2:147285 can't die for more =
than 127 seconds.
[52906.766086][  T310] trinity-c2      R  running task    27896 147285  =
74932 0x10000004
...
[52907.711803][  T310] RSP: 002b:00007fff1d6588c8 EFLAGS: 00000246 =
ORIG_RAX: 0000000000000144
[52907.750495][  T310] RAX: ffffffffffffffda RBX: 0000000000000144 RCX: =
00007fa3d9cd670d
[52907.786490][  T310] RDX: 0000000000000080 RSI: 0000000000000000 RDI: =
0000000000000001
[52907.822363][  T310] RBP: 0000000000000144 R08: 00000000eeeeeeee R09: =
0000000000003418
[52907.858106][  T310] R10: 0000000000004ff8 R11: 0000000000000246 R12: =
0000000000000002
[52907.894476][  T310] R13: 00007fa3d8678058 R14: 00007fa3d9b956c0 R15: =
00007fa3d8678000
[52907.930457][  T310] INFO: task trinity-c27:149010 can't die for more =
than 129 seconds.
[52907.971719][  T310] trinity-c27     R  running task    26944 149010  =
74932 0x10000004
...
[52908.397305][T151560] futex_wake_op: trinity-c39 tries to shift op by =
-852; fix this program
[52908.415599][  T310]  ? __x64_sys_sched_getattr+0x3e0/0x3e0
[52908.455822][T151560] futex_wake_op: trinity-c39 tries to shift op by =
-852; fix this program
...
[52908.904432][  T310] RSP: 002b:00007fff1d6588c8 EFLAGS: 00000246 =
ORIG_RAX: 00000000000000cb
[52908.942172][  T310] RAX: ffffffffffffffda RBX: 00000000000000cb RCX: =
00007fa3d9cd670d
[52908.981963][  T310] RDX: 00007fa3d843c000 RSI: 0000000000000004 RDI: =
0000000000000000
[52909.020646][  T310] RBP: 00000000000000cb R08: 00000000ffffffff R09: =
fffffffffffffffa
[52909.057043][  T310] R10: 000000000000001b R11: 0000000000000246 R12: =
0000000000000002
[52909.093664][  T310] R13: 00007fa3d85c9058 R14: 00007fa3d9b956c0 R15: =
00007fa3d85c9000
[52909.129758][  T310] INFO: task trinity-c20:149065 can't die for more =
than 130 seconds.
[52909.166089][  T310] trinity-c20     R  running task    27712 149065  =
74932 0x10000004
...
[52910.035569][  T310] RSP: 002b:00007fff1d6588c8 EFLAGS: 00000246 =
ORIG_RAX: 00000000000000cb
[52910.073407][  T310] RAX: ffffffffffffffda RBX: 00000000000000cb RCX: =
00007fa3d9cd670d
[52910.109426][  T310] RDX: 00007fa3d7c37000 RSI: 00000000000000a2 RDI: =
0000000000000000
[52910.145197][  T310] RBP: 00000000000000cb R08: ffffffdffdefffff R09: =
000000008084b740
[52910.181004][  T310] R10: 0000000000000080 R11: 0000000000000246 R12: =
0000000000000002
[52910.217004][  T310] R13: 00007fa3d85fa058 R14: 00007fa3d9b956c0 R15: =
00007fa3d85fa000
[52910.254432][  T310]=20
[52910.254432][  T310] Showing all locks held in the system:
[52910.289717][  T310] 1 lock held by ksoftirqd/16/94:
[52910.312041][  T310]  #0: ffff88985fa453d8 (&rq->lock){-.-.}-{2:2}, =
at: newidle_balance+0x88d/0x9c0
[52910.353309][  T310] 1 lock held by khungtaskd/310:
[52910.375374][  T310]  #0: ffffffffb3bcacc0 =
(rcu_read_lock){....}-{1:2}, at: rcu_lock_acquire.constprop.30+0x0/0x30
[52910.422536][  T310] 3 locks held by kworker/u96:1/60424:
[52910.446875][  T310]  #0: ffff88984fef1538 =
((wq_completion)netns){+.+.}-{0:0}, at: process_one_work+0x45c/0xb90
[52910.493637][  T310]  #1: ffffc900240ffe00 =
(net_cleanup_work){+.+.}-{0:0}, at: process_one_work+0x45c/0xb90
[52910.542269][  T310]  #2: ffffffffb409cf30 =
(pernet_ops_rwsem){++++}-{3:3}, at: cleanup_net+0xa9/0x5c0
[52910.583972][  T310] 2 locks held by runc/74923:
[52910.604801][  T310]  #0: ffff88842f510898 =
(&tty->ldisc_sem){++++}-{0:0}, at: ldsem_down_read+0x32/0x40
[52910.647284][  T310]  #1: ffffc900064bb2e8 =
(&ldata->atomic_read_lock){+.+.}-{3:3}, at: n_tty_read+0x187/0xe20
[52910.692274][  T310] 8 locks held by runc/74924:
[52910.713003][  T310]  #0: ffff888842e453d8 (&rq->lock){-.-.}-{2:2}, =
at: __schedule+0x227/0x1070
[52910.752393][  T310]  #1: ffffffffb3bcacc0 =
(rcu_read_lock){....}-{1:2}, at: perf_iterate_sb+0x0/0x500
[52910.794272][  T310]  #2: ffff88842f510ae8 =
(&o_tty->termios_rwsem/1){++++}-{3:3}, at: n_tty_write+0x126/0x7c0
[52910.839386][  T310]  #3: ffff88842f510d30 =
(&tty->write_wait){-.-.}-{2:2}, at: remove_wait_queue+0x29/0xc0
[52910.885384][  T310]  #4: ffff888429bb0558 =
(&port->lock#2){-.-.}-{2:2}, at: pty_write+0x82/0xf0
[52910.924906][  T310]  #5: ffffffffb3bcacc0 =
(rcu_read_lock){....}-{1:2}, at: __queue_work+0x8b/0xa40
[52910.965808][  T310]  #6: ffff88820f19c418 =
(&pool->lock/1){-.-.}-{2:2}, at: __queue_work+0x154/0xa40
[52911.008506][  T310]  #7: ffff888349990828 (&p->pi_lock){-.-.}-{2:2}, =
at: try_to_wake_up+0xb0/0xfb0
[52911.054482][  T310] 2 locks held by kworker/26:2/87166:
[52911.078400][  T310]  #0: ffff888207838338 =
((wq_completion)events){+.+.}-{0:0}, at: process_one_work+0x45c/0xb90
[52911.124769][  T310]  #1: ffffc900203ffe00 =
((work_completion)(&ctx->exit_work)){+.+.}-{0:0}, at: =
process_one_work+0x45c/0xb90
[52911.175647][  T310] 2 locks held by kworker/13:2/110105:
[52911.199910][  T310]  #0: ffff888207838338 =
((wq_completion)events){+.+.}-{0:0}, at: process_one_work+0x45c/0xb90
[52911.246366][  T310]  #1: ffffc90031bffe00 =
(free_ipc_work){+.+.}-{0:0}, at: process_one_work+0x45c/0xb90
[52911.289451][  T310] 2 locks held by kworker/24:0/140617:
[52911.313772][  T310]  #0: ffff888207018938 =
((wq_completion)rcu_gp){+.+.}-{0:0}, at: process_one_work+0x45c/0xb90
[52911.360933][  T310]  #1: ffffc90021a6fe00 =
((work_completion)(&rew.rew_work)){+.+.}-{0:0}, at: =
process_one_work+0x45c/0xb90
[52911.411991][  T310] 3 locks held by kworker/36:2/142207:
[52911.437085][  T310]  #0: ffff888207838338 =
((wq_completion)events){+.+.}-{0:0}, at: process_one_work+0x45c/0xb90
[52911.483296][  T310]  #1: ffffc9002420fe00 =
(slab_caches_to_rcu_destroy_work){+.+.}-{0:0}, at: =
process_one_work+0x45c/0xb90
[52911.537354][  T310]  #2: ffffffffb3bd9128 =
(rcu_state.barrier_mutex){+.+.}-{3:3}, at: rcu_barrier+0x4c/0x440
[52911.585581][  T310] 1 lock held by trinity-c11/151262:
[52911.609175][  T310]  #0: ffff889660160248 =
(&sb->s_type->i_mutex_key#8){+.+.}-{3:3}, at: __sock_release+0x54/0x120
[52911.655737][  T310] 1 lock held by trinity-c35/151367:
[52911.680063][  T310]  #0: ffffffffb3bd9220 =
(rcu_state.exp_mutex){+.+.}-{3:3}, at: =
synchronize_rcu_expedited+0x4cc/0x5e0
[52911.768193][  T310] 2 locks held by trinity-c30/151624:
[52911.792141][  T310] 1 lock held by trinity-c33/151643:
[52911.815251][  T310]  #0: ffffffffb3bd9220 =
(rcu_state.exp_mutex){+.+.}-{3:3}, at: =
synchronize_rcu_expedited+0x4cc/0x5e0
[52911.863988][  T310] 1 lock held by trinity-c19/151731:
[52911.889078][  T310]=20
[52911.899680][  T310] =3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
