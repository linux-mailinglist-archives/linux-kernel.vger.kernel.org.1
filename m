...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BDA4E2F251A
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Jan 2021 02:18:22 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732486AbhALAr4 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 11 Jan 2021 19:47:56 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57626 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1731112AbhALAp6 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 11 Jan 2021 19:45:58 -0500
Received: from mail-lf1-x12e.google.com (mail-lf1-x12e.google.com [IPv6:2a00:1450:4864:20::12e])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 33832C0617A5
        for <linux-kernel@vger.kernel.org>; Mon, 11 Jan 2021 16:45:16 -0800 (PST)
Received: by mail-lf1-x12e.google.com with SMTP id x20so712007lfe.12
        for <linux-kernel@vger.kernel.org>; Mon, 11 Jan 2021 16:45:16 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=HgUra/XQWD3R47xve2wIBMR51nv2uaCjwcKQY0mMSrk=;
        b=
X-Gm-Message-State: AOAM531aYs0mefZ0G8X+nDOIk3yOW8RDfnsRHxJKNOa45VSxhbuPGxG4
        ooJ/D2Q15rMbkIOPI7NTMINgu1LyIVHm1jQ3O7g=
...
MIME-Version: 1.0
References: <20210111051543.243387-1-daeho43@gmail.com> <e99edf49-543e-151c-ff9a-6095fc9b695b@huawei.com>
...
2021=EB=85=84 1=EC=9B=94 11=EC=9D=BC (=EC=9B=94) =EC=98=A4=ED=9B=84 6:34, C=
...
> >   compress_log_size=3D%u         Support configuring compress cluster s=
ize, the size will
...
>                                           - cprc->f2fs_issue_ckpt =3D NUL=
L;
>                                           - kthread_stop(ckpt_task);
>    - access NULL sbi->cprc_info
>

When we remount the filesystem, we use
f2fs_destroy_ckpt_req_control(sbi, "false").
So, it keeps sbi->cprc_info alive.
...
> > +             return;
>
> Before this function, we have checked lockless list by llist_empty(&cprc-=
>issue_list),
> so, if we can not grab any entries from list, is that caused by race betw=
een
...
;
>
> Is DEFAULT_CHECKPOINT_IOPRIO not same to default priority of kernel threa=
d?
> If it is the same, above line is unneeded for this patch, otherwise, do w=
e
...
Those were for debugging purposes, but I think we don't need those anymore.
Recording max/avg time of that is a good idea. I am going to implement it.
