...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 64C6120BF12
	for <lists+linux-kernel@lfdr.de>; Sat, 27 Jun 2020 08:54:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726383AbgF0GyK (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 27 Jun 2020 02:54:10 -0400
Received: from szxga04-in.huawei.com ([45.249.212.190]:6836 "EHLO huawei.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1725900AbgF0Gxq (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 27 Jun 2020 02:53:46 -0400
Received: from DGGEMS412-HUB.china.huawei.com (unknown [172.30.72.60])
        by Forcepoint Email with ESMTP id A21CACC2AB0BC12678FA;
        Sat, 27 Jun 2020 14:53:41 +0800 (CST)
Received: from localhost.localdomain (10.175.118.36) by
 DGGEMS412-HUB.china.huawei.com (10.3.19.212) with Microsoft SMTP Server id
 14.3.487.0; Sat, 27 Jun 2020 14:53:31 +0800
From:   Luo bin <luobin9@huawei.com>
To:     <davem@davemloft.net>
CC:     <linux-kernel@vger.kernel.org>, <netdev@vger.kernel.org>,
        <luoxianjun@huawei.com>, <yin.yinshi@huawei.com>,
        <cloud.wangxiaoyun@huawei.com>, <chiqijun@huawei.com>
Subject: [PATCH net-next v3 2/5] hinic: add support to set and get irq coalesce
Date:   Sat, 27 Jun 2020 14:52:39 +0800
Message-ID: <20200627065242.26761-3-luobin9@huawei.com>
...
index c2afa0585dbf..062c295f95dc 100644
...
index 76e3debfebe5..deeec09770ae 100644
...
@@ -1021,6 +1025,48 @@ static int set_features(struct hinic_dev *nic_dev,
 	return 0;
 }
...
+
  ...
  * @pdev: the NIC pci device
@@ -1156,6 +1202,12 @@ static int nic_dev_init(struct pci_dev *pdev)
...
@@ -1165,6 +1217,8 @@ static int nic_dev_init(struct pci_dev *pdev)
 	return 0;
...
@@ -1279,6 +1333,8 @@ static void hinic_remove(struct pci_dev *pdev)
