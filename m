...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 35884248064
	for <lists+linux-kernel@lfdr.de>; Tue, 18 Aug 2020 10:19:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726620AbgHRITm (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 18 Aug 2020 04:19:42 -0400
Received: from mx0b-001b2d01.pphosted.com ([148.163.158.5]:12788 "EHLO
        mx0a-001b2d01.pphosted.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1726422AbgHRITi (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 18 Aug 2020 04:19:38 -0400
Received: from pps.filterd (m0098419.ppops.net [127.0.0.1])
        by mx0b-001b2d01.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id 07I82SGs157238;
        Tue, 18 Aug 2020 04:18:55 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ibm.com; h=from : content-type :
 mime-version : subject : message-id : date : cc : to; s=pp1;
 bh=rfKv1cPDffmVFrMg1ZoTYUbaUhTkT9n8fdptT5Meo30=;
 b= lw== 
Received: from ppma04ams.nl.ibm.com (63.31.33a9.ip4.static.sl-reverse.com [169.51.49.99])
        by mx0b-001b2d01.pphosted.com with ESMTP id 3304t19jhw-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Tue, 18 Aug 2020 04:18:54 -0400
Received: from pps.filterd (ppma04ams.nl.ibm.com [127.0.0.1])
        by ppma04ams.nl.ibm.com (8.16.0.42/8.16.0.42) with SMTP id 07I8EaDM003387;
        Tue, 18 Aug 2020 08:18:53 GMT
Received: from b06avi18878370.portsmouth.uk.ibm.com (b06avi18878370.portsmouth.uk.ibm.com [9.149.26.194])
        by ppma04ams.nl.ibm.com with ESMTP id 3304cc0d1a-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Tue, 18 Aug 2020 08:18:51 +0000
Received: from b06wcsmtp001.portsmouth.uk.ibm.com (b06wcsmtp001.portsmouth.uk.ibm.com [9.149.105.160])
        by b06avi18878370.portsmouth.uk.ibm.com (8.14.9/8.14.9/NCO v10.0) with ESMTP id 07I8Imss53084552
        (version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Tue, 18 Aug 2020 08:18:48 GMT
Received: from b06wcsmtp001.portsmouth.uk.ibm.com (unknown [127.0.0.1])
        by IMSVA (Postfix) with ESMTP id 7A5ADA405F;
        Tue, 18 Aug 2020 08:18:48 +0000 (GMT)
Received: from b06wcsmtp001.portsmouth.uk.ibm.com (unknown [127.0.0.1])
        by IMSVA (Postfix) with ESMTP id 1A0C5A405C;
        Tue, 18 Aug 2020 08:18:47 +0000 (GMT)
Received: from [9.199.51.31] (unknown [9.199.51.31])
        by b06wcsmtp001.portsmouth.uk.ibm.com (Postfix) with ESMTP;
        Tue, 18 Aug 2020 08:18:46 +0000 (GMT)
From:   Sachin Sant <sachinp@linux.vnet.ibm.com>
Content-Type: multipart/mixed;
        boundary="Apple-Mail=_9C9BC77D-4A40-4194-B154-E823A061F325"
Mime-Version: 1.0 (Mac OS X Mail 12.4 \(3445.104.15\))
Subject: [powerpc] 5.9.0-rc1 boot failure on POWER9 PowerVM LPAR
Message-Id: <2CD14C97-9145-4D98-8C7C-783B278663A2@linux.vnet.ibm.com>
Date:   Tue, 18 Aug 2020 13:48:46 +0530
...
X-Proofpoint-Spam-Details: rule=outbound_notspam policy=outbound score=0 spamscore=0 adultscore=0
 suspectscore=1 mlxscore=0 lowpriorityscore=0 mlxlogscore=575
...
--Apple-Mail=_9C9BC77D-4A40-4194-B154-E823A061F325
...
Modules linked in: papr_scm(+) uio_pdrv_genirq uio sch_fq_codel =
ip_tables sd_mod t10_pi ibmvscsi scsi_transport_srp ibmveth
CPU: 14 PID: 7 Comm: kworker/u32:0 Not tainted =
5.9.0-rc1-00085-g06a4ec1d9dc6 #1
Workqueue: events_unbound async_run_entry_fn
NIP:  c0000000005417e0 LR: c000000000541784 CTR: c000000000871e30
REGS: c00000067871b710 TRAP: 0300   Not tainted  =
(5.9.0-rc1-00085-g06a4ec1d9dc6)
MSR:  8000000000009033 <SF,EE,ME,IR,DR,RI,LE>  CR: 24822484  XER: =
00000000
CFAR: c00000000054178c DAR: 0000000000000188 DSISR: 40000000 IRQMASK: 0=20=

GPR00: c000000000541784 c00000067871b9a0 c00000000173cb00 =
0000000000000000=20
GPR04: c000000000f9eb50 0000000000000002 0000000000000001 =
c000000678689000=20
GPR08: c000000000d45e20 0000000000000180 0000000000000001 =
0000000000000220=20
GPR12: c000000000871e30 c00000001ec5ba00 c00000000017ba18 =
c000000678220e00=20
...
0000000000000003=20
GPR28: c0000000037eb018 c00000000166f9e8 c00000066992dd80 =
c000000000d45f00=20
NIP [c0000000005417e0] internal_create_group+0x180/0x4e0
LR [c000000000541784] internal_create_group+0x124/0x4e0
Call Trace:
[c00000067871b9a0] [c000000000541784] internal_create_group+0x124/0x4e0 =
(unreliable)
[c00000067871ba60] [c000000000541d70] =
internal_create_groups.part.4+0x70/0x120
...
Instruction dump:
7f07c378 38a00000 7fc3f378 4bffe47d 60000000 7c7a1b79 40820218 e93d0009=20=

3b7b0001 7f7b07b4 2fa90000 419e0024 <a3490008> 4192ff7c e8890000 =
38a00000=20
...
Content-Disposition: attachment;
	filename=config-5.9.0-rc1
Content-Type: application/octet-stream;
	x-unix-mode=0644;
	name="config-5.9.0-rc1"
Content-Transfer-Encoding: 7bit

#
# Automatically generated file; DO NOT EDIT.
# Linux/powerpc 5.9.0-rc1 Kernel Configuration
#
CONFIG_CC_VERSION_TEXT="gcc (GCC) 8.3.1 20190507 (Red Hat 8.3.1-4)"
CONFIG_CC_IS_GCC=y
