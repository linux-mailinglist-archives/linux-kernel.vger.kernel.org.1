...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8E9B721064D
	for <lists+linux-kernel@lfdr.de>; Wed,  1 Jul 2020 10:33:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729151AbgGAIdI (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 1 Jul 2020 04:33:08 -0400
Received: from mga01.intel.com ([192.55.52.88]:9193 "EHLO mga01.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728217AbgGAIdC (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 1 Jul 2020 04:33:02 -0400
IronPort-SDR: YRrRVYy10ImkryKX1hXwxKJAeHY4W8bfGjysitAaQbcpHggpXgHob8Hta0ToYOeGMACaSUjFPJ
 YqVnpa67d+tQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9668"; a="164503336"
X-IronPort-AV: E=Sophos;i="5.75,299,1589266800"; 
   d="scan'208";a="164503336"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 01 Jul 2020 00:49:55 -0700
IronPort-SDR: cPVn95eQie/HeaYPOGVr3Qp8eF3KUOBUIf8HOm5cr3o6GoiNofJ9jn0kYUa1m6kkajLsCjBQrd
 CrPXRbxC7eIg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,299,1589266800"; 
   d="scan'208";a="386935369"
Received: from xingzhen-mobl1.ccr.corp.intel.com (HELO [10.238.4.18]) ([10.238.4.18])
  by fmsmga001.fm.intel.com with ESMTP; 01 Jul 2020 00:49:53 -0700
...
Message-ID: <45df2ba8-6089-463e-670d-ee34a0b3d36c@linux.intel.com>
Date:   Wed, 1 Jul 2020 15:49:52 +0800
User-Agent: Mozilla/5.0 (Windows NT 10.0; WOW64; rv:68.0) Gecko/20100101
 Thunderbird/68.9.0
MIME-Version: 1.0
In-Reply-To: <a080165c-824f-3d48-44e8-388fa94d32fe@linux.intel.com>
...
>>        8.56 ±  3%      -4.3        4.25        
>> perf-profile.calltrace.cycles-pp.__filemap_fdatawrite_range.file_write_and_wait_range.xfs_file_fsync.xfs_file_buffered_aio_write.new_sync_write 
>>
>>        8.50 ±  3%      -4.3        4.20        
>> perf-profile.calltrace.cycles-pp.do_writepages.__filemap_fdatawrite_range.file_write_and_wait_range.xfs_file_fsync.xfs_file_buffered_aio_write 
>>
>>        8.47 ±  3%      -4.3        4.17        
...
>>        8.74 ±  3%      -4.0        4.70        
>> perf-profile.calltrace.cycles-pp.file_write_and_wait_range.xfs_file_fsync.xfs_file_buffered_aio_write.new_sync_write.vfs_write 
>>
>>       77.69            -3.9       73.75        
...
>>
>>       76.43            -3.6       72.80        
>> perf-profile.calltrace.cycles-pp.xfs_file_buffered_aio_write.new_sync_write.vfs_write.ksys_write.do_syscall_64 
>>
>>       69.22            -2.6       66.62        
>> perf-profile.calltrace.cycles-pp.xfs_file_fsync.xfs_file_buffered_aio_write.new_sync_write.vfs_write.ksys_write 
>>
>>        4.70 ±  2%      -2.2        2.50        
>> perf-profile.calltrace.cycles-pp.iomap_submit_ioend.xfs_vm_writepages.do_writepages.__filemap_fdatawrite_range.file_write_and_wait_range 
>>
>>        4.63 ±  2%      -2.2        2.45        
>> perf-profile.calltrace.cycles-pp.submit_bio.iomap_submit_ioend.xfs_vm_writepages.do_writepages.__filemap_fdatawrite_range 
>>
>>        4.60 ±  2%      -2.2        2.43        
>> perf-profile.calltrace.cycles-pp.generic_make_request.submit_bio.iomap_submit_ioend.xfs_vm_writepages.do_writepages 
>>
>>        4.32 ±  2%      -2.1        2.22        
>> perf-profile.calltrace.cycles-pp.brd_make_request.generic_make_request.submit_bio.iomap_submit_ioend.xfs_vm_writepages 
>>
>>        3.72 ±  4%      -2.1        1.63        
>> perf-profile.calltrace.cycles-pp.iomap_writepages.xfs_vm_writepages.do_writepages.__filemap_fdatawrite_range.file_write_and_wait_range 
>>
>>        3.71 ±  4%      -2.1        1.62        
>> perf-profile.calltrace.cycles-pp.write_cache_pages.iomap_writepages.xfs_vm_writepages.do_writepages.__filemap_fdatawrite_range 
>>
>>        2.63 ±  4%      -2.0        0.63 ±  3%  
>> perf-profile.calltrace.cycles-pp.iomap_finish_ioend.brd_make_request.generic_make_request.submit_bio.iomap_submit_ioend 
>>
>>        7.72            -2.0        5.74 ±  2%  
>> perf-profile.calltrace.cycles-pp.__flush_work.xlog_cil_force_lsn.xfs_log_force_lsn.xfs_file_fsync.xfs_file_buffered_aio_write 
>>
>>        3.08 ±  5%      -1.9        1.13        
>> perf-profile.calltrace.cycles-pp.iomap_writepage_map.write_cache_pages.iomap_writepages.xfs_vm_writepages.do_writepages 
>>
>>        2.49 ±  5%      -1.9        0.55 ±  3%  
>> perf-profile.calltrace.cycles-pp.end_page_writeback.iomap_finish_ioend.brd_make_request.generic_make_request.submit_bio 
>>
>>        2.48 ±  5%      -1.9        0.55 ±  3%  
>> perf-profile.calltrace.cycles-pp.test_clear_page_writeback.end_page_writeback.iomap_finish_ioend.brd_make_request.generic_make_request 
>>
>>        2.41 ±  6%      -1.8        0.61 ±  2%  
>> perf-profile.calltrace.cycles-pp.__test_set_page_writeback.iomap_writepage_map.write_cache_pages.iomap_writepages.xfs_vm_writepages 
>>
>>        4.90            -1.5        3.40 ±  3%  
>> perf-profile.calltrace.cycles-pp._raw_spin_lock_irq.__flush_work.xlog_cil_force_lsn.xfs_log_force_lsn.xfs_file_fsync 
>>
>>        4.78            -1.5        3.30 ±  3%  
>> perf-profile.calltrace.cycles-pp.native_queued_spin_lock_slowpath._raw_spin_lock_irq.__flush_work.xlog_cil_force_lsn.xfs_log_force_lsn 
>>
>>        2.35            -0.6        1.77 ±  2%  
>> perf-profile.calltrace.cycles-pp.iomap_apply.iomap_file_buffered_write.xfs_file_buffered_aio_write.new_sync_write.vfs_write 
>>
>>        2.36            -0.6        1.79        
>> perf-profile.calltrace.cycles-pp.iomap_file_buffered_write.xfs_file_buffered_aio_write.new_sync_write.vfs_write.ksys_write 
>>
>>        3.40            -0.5        2.87 ±  6%  
>> perf-profile.calltrace.cycles-pp.__xfs_trans_commit.xfs_vn_update_time.file_update_time.xfs_file_aio_write_checks.xfs_file_buffered_aio_write 
>>
>>        1.83            -0.5        1.33 ±  2%  
>> perf-profile.calltrace.cycles-pp.iomap_write_actor.iomap_apply.iomap_file_buffered_write.xfs_file_buffered_aio_write.new_sync_write 
>>
>>        3.26            -0.5        2.75 ±  6%  
>> perf-profile.calltrace.cycles-pp.xfs_log_commit_cil.__xfs_trans_commit.xfs_vn_update_time.file_update_time.xfs_file_aio_write_checks 
>>
>>        2.85            -0.4        2.40        
>> perf-profile.calltrace.cycles-pp.complete.process_one_work.worker_thread.kthread.ret_from_fork 
>>
>>        2.79            -0.4        2.34        
>> perf-profile.calltrace.cycles-pp.try_to_wake_up.swake_up_locked.complete.process_one_work.worker_thread 
>>
>>        2.83            -0.4        2.38        
>> perf-profile.calltrace.cycles-pp.swake_up_locked.complete.process_one_work.worker_thread.kthread 
>>
>>        1.48            -0.4        1.05 ±  2%  
>> perf-profile.calltrace.cycles-pp.brd_do_bvec.brd_make_request.generic_make_request.submit_bio.iomap_submit_ioend 
>>
>>        0.61 ±  2%      -0.4        0.26 ±100%  
>> perf-profile.calltrace.cycles-pp.sched_ttwu_pending.scheduler_ipi.reschedule_interrupt.native_queued_spin_lock_slowpath._raw_spin_lock 
>>
>>        1.89            -0.3        1.54        
>> perf-profile.calltrace.cycles-pp.wait_for_completion.__flush_work.xlog_cil_force_lsn.xfs_log_force_lsn.xfs_file_fsync 
>>
>>        1.71            -0.3        1.38        
>> perf-profile.calltrace.cycles-pp.schedule_timeout.wait_for_completion.__flush_work.xlog_cil_force_lsn.xfs_log_force_lsn 
>>
>>        1.65            -0.3        1.34        
>> perf-profile.calltrace.cycles-pp.schedule.schedule_timeout.wait_for_completion.__flush_work.xlog_cil_force_lsn 
>>
>>        0.69            -0.3        0.38 ± 57%  
...
>>
>>        1.59            -0.3        1.29        
>> perf-profile.calltrace.cycles-pp.__sched_text_start.schedule.schedule_timeout.wait_for_completion.__flush_work 
>>
>>        0.86            -0.3        0.58 ±  2%  
>> perf-profile.calltrace.cycles-pp.rwsem_down_read_slowpath.xfs_log_commit_cil.__xfs_trans_commit.xfs_vn_update_time.file_update_time 
>>
>>        1.52            -0.3        1.26 ±  3%  
>> perf-profile.calltrace.cycles-pp.xlog_cil_insert_items.xfs_log_commit_cil.__xfs_trans_commit.xfs_vn_update_time.file_update_time 
>>
>>        1.75            -0.2        1.50 ±  2%  
>> perf-profile.calltrace.cycles-pp.ttwu_do_activate.try_to_wake_up.swake_up_locked.complete.process_one_work 
>>
>>        1.74            -0.2        1.49 ±  2%  
>> perf-profile.calltrace.cycles-pp.enqueue_task_fair.activate_task.ttwu_do_activate.try_to_wake_up.swake_up_locked 
>>
>>        1.74            -0.2        1.50 ±  2%  
>> perf-profile.calltrace.cycles-pp.activate_task.ttwu_do_activate.try_to_wake_up.swake_up_locked.complete 
>>
>>        2.15            -0.2        1.94        
>> perf-profile.calltrace.cycles-pp.__account_scheduler_latency.enqueue_entity.enqueue_task_fair.activate_task.ttwu_do_activate 
>>
>>        0.79 ±  3%      -0.2        0.60 ±  4%  
>> perf-profile.calltrace.cycles-pp._raw_spin_lock.xlog_cil_insert_items.xfs_log_commit_cil.__xfs_trans_commit.xfs_vn_update_time 
>>
>>        1.81            -0.2        1.62        
>> perf-profile.calltrace.cycles-pp.arch_stack_walk.stack_trace_save_tsk.__account_scheduler_latency.enqueue_entity.enqueue_task_fair 
>>
>>        1.87            -0.2        1.68        
>> perf-profile.calltrace.cycles-pp.stack_trace_save_tsk.__account_scheduler_latency.enqueue_entity.enqueue_task_fair.activate_task 
>>
>>        0.70 ±  4%      -0.2        0.54 ±  4%  
>> perf-profile.calltrace.cycles-pp.native_queued_spin_lock_slowpath._raw_spin_lock.xlog_cil_insert_items.xfs_log_commit_cil.__xfs_trans_commit 
>>
>>        0.81            -0.1        0.68        
>> perf-profile.calltrace.cycles-pp.unwind_next_frame.arch_stack_walk.stack_trace_save_tsk.__account_scheduler_latency.enqueue_entity 
>>
>>        0.65 ±  2%      -0.1        0.55 ±  2%  
>> perf-profile.calltrace.cycles-pp.reschedule_interrupt.native_queued_spin_lock_slowpath._raw_spin_lock.xlog_cil_force_lsn.xfs_log_force_lsn 
>>
>>        0.62 ±  2%      -0.1        0.52 ±  3%  
>> perf-profile.calltrace.cycles-pp.scheduler_ipi.reschedule_interrupt.native_queued_spin_lock_slowpath._raw_spin_lock.xlog_cil_force_lsn 
>>
>>        1.18            -0.0        1.16        
>> perf-profile.calltrace.cycles-pp.sched_ttwu_pending.do_idle.cpu_startup_entry.start_secondary.secondary_startup_64 
>>
>>        1.01            -0.0        0.99        
>> perf-profile.calltrace.cycles-pp.activate_task.ttwu_do_activate.sched_ttwu_pending.do_idle.cpu_startup_entry 
>>
>>        1.00            -0.0        0.98        
>> perf-profile.calltrace.cycles-pp.enqueue_task_fair.activate_task.ttwu_do_activate.sched_ttwu_pending.do_idle 
>>
>>        0.96            -0.0        0.93        
>> perf-profile.calltrace.cycles-pp.enqueue_entity.enqueue_task_fair.activate_task.ttwu_do_activate.sched_ttwu_pending 
>>
>>        1.01            -0.0        0.99        
...
>>
>>        0.58 ±  3%      +0.1        0.67        
>> perf-profile.calltrace.cycles-pp.__sched_text_start.schedule_idle.do_idle.cpu_startup_entry.start_secondary 
>>
>>        0.53            +0.1        0.63 ±  3%  
>> perf-profile.calltrace.cycles-pp.try_to_wake_up.__wake_up_common.__wake_up_common_lock.xlog_cil_push_work.process_one_work 
>>
>>        0.91 ±  3%      +0.1        1.02 ±  2%  
>> perf-profile.calltrace.cycles-pp.xlog_write.xlog_cil_push_work.process_one_work.worker_thread.kthread 
>>
>>        0.54            +0.1        0.65 ±  3%  
>> perf-profile.calltrace.cycles-pp.__wake_up_common.__wake_up_common_lock.xlog_cil_push_work.process_one_work.worker_thread 
>>
>>        0.57            +0.1        0.69 ±  3%  
>> perf-profile.calltrace.cycles-pp.__wake_up_common_lock.xlog_cil_push_work.process_one_work.worker_thread.kthread 
>>
>>        1.83            +0.2        1.99        
>> perf-profile.calltrace.cycles-pp.xlog_cil_push_work.process_one_work.worker_thread.kthread.ret_from_fork 
>>
>>        0.00            +0.6        0.57 ±  2%  
>> perf-profile.calltrace.cycles-pp.activate_task.ttwu_do_activate.try_to_wake_up.autoremove_wake_function.__wake_up_common 
>>
>>        0.00            +0.6        0.57 ±  2%  
>> perf-profile.calltrace.cycles-pp.enqueue_task_fair.activate_task.ttwu_do_activate.try_to_wake_up.autoremove_wake_function 
>>
>>        0.00            +0.6        0.57 ±  2%  
>> perf-profile.calltrace.cycles-pp.ttwu_do_activate.try_to_wake_up.autoremove_wake_function.__wake_up_common.wake_up_page_bit 
>>
>>        0.00            +0.7        0.70 ±  2%  
>> perf-profile.calltrace.cycles-pp.xfs_bmap_add_extent_unwritten_real.xfs_bmapi_convert_unwritten.xfs_bmapi_write.xfs_iomap_write_unwritten.xfs_end_ioend 
>>
>>        0.00            +0.8        0.75 ±  4%  
>> perf-profile.calltrace.cycles-pp.xfs_bmapi_convert_unwritten.xfs_bmapi_write.xfs_iomap_write_unwritten.xfs_end_ioend.xfs_end_io 
>>
>>        0.00            +0.8        0.80        
>> perf-profile.calltrace.cycles-pp.try_to_wake_up.autoremove_wake_function.__wake_up_common.wake_up_page_bit.iomap_finish_ioend 
>>
>>        0.00            +0.8        0.80        
>> perf-profile.calltrace.cycles-pp.autoremove_wake_function.__wake_up_common.wake_up_page_bit.iomap_finish_ioend.iomap_finish_ioends 
>>
>>        0.00            +0.8        0.80 ± 30%  
>> perf-profile.calltrace.cycles-pp.xfs_trans_reserve.xfs_trans_alloc.xfs_vn_update_time.file_update_time.xfs_file_aio_write_checks 
>>
>>        0.00            +0.8        0.82        
>> perf-profile.calltrace.cycles-pp.__wake_up_common.wake_up_page_bit.iomap_finish_ioend.iomap_finish_ioends.xfs_end_ioend 
>>
>>        0.00            +0.8        0.85        
>> perf-profile.calltrace.cycles-pp.wake_up_page_bit.iomap_finish_ioend.iomap_finish_ioends.xfs_end_ioend.xfs_end_io 
>>
>>        0.00            +0.9        0.89 ±  2%  
>> perf-profile.calltrace.cycles-pp.xfs_bmapi_write.xfs_iomap_write_unwritten.xfs_end_ioend.xfs_end_io.process_one_work 
>>
>>        0.00            +0.9        0.92 ± 21%  
>> perf-profile.calltrace.cycles-pp.xfs_log_commit_cil.__xfs_trans_commit.xfs_iomap_write_unwritten.xfs_end_ioend.xfs_end_io 
>>
>>        0.00            +1.0        0.97 ± 20%  
>> perf-profile.calltrace.cycles-pp.__xfs_trans_commit.xfs_iomap_write_unwritten.xfs_end_ioend.xfs_end_io.process_one_work 
>>
>>       35.68            +1.0       36.68        
>> perf-profile.calltrace.cycles-pp.xlog_cil_force_lsn.xfs_log_force_lsn.xfs_file_fsync.xfs_file_buffered_aio_write.new_sync_write 
>>
>>        0.00            +1.0        1.04        
>> perf-profile.calltrace.cycles-pp.iomap_finish_ioend.iomap_finish_ioends.xfs_end_ioend.xfs_end_io.process_one_work 
>>
>>        0.00            +1.0        1.05        
>> perf-profile.calltrace.cycles-pp.iomap_finish_ioends.xfs_end_ioend.xfs_end_io.process_one_work.worker_thread 
>>
>>        9.35            +1.2       10.54        
...
>>       14.38            +1.4       15.81 ±  2%  
>> perf-profile.calltrace.cycles-pp.xlog_wait_on_iclog.__xfs_log_force_lsn.xfs_log_force_lsn.xfs_file_fsync.xfs_file_buffered_aio_write 
>>
>>       13.41            +1.4       14.86 ±  2%  
>> perf-profile.calltrace.cycles-pp.remove_wait_queue.xlog_wait_on_iclog.__xfs_log_force_lsn.xfs_log_force_lsn.xfs_file_fsync 
>>
>>       13.37            +1.5       14.82 ±  2%  
>> perf-profile.calltrace.cycles-pp._raw_spin_lock_irqsave.remove_wait_queue.xlog_wait_on_iclog.__xfs_log_force_lsn.xfs_log_force_lsn 
>>
>>       13.34            +1.5       14.80 ±  2%  
>> perf-profile.calltrace.cycles-pp.native_queued_spin_lock_slowpath._raw_spin_lock_irqsave.remove_wait_queue.xlog_wait_on_iclog.__xfs_log_force_lsn 
>>
>>       58.91            +1.6       60.56        
>> perf-profile.calltrace.cycles-pp.xfs_log_force_lsn.xfs_file_fsync.xfs_file_buffered_aio_write.new_sync_write.vfs_write 
>>
>>        0.00            +2.2        2.24 ± 13%  
>> perf-profile.calltrace.cycles-pp.xfs_iomap_write_unwritten.xfs_end_ioend.xfs_end_io.process_one_work.worker_thread 
>>
>>        5.63            +2.5        8.15        
>> perf-profile.calltrace.cycles-pp.native_queued_spin_lock_slowpath._raw_spin_lock_irqsave.remove_wait_queue.xlog_cil_force_lsn.xfs_log_force_lsn 
>>
>>        5.65            +2.5        8.19        
>> perf-profile.calltrace.cycles-pp._raw_spin_lock_irqsave.remove_wait_queue.xlog_cil_force_lsn.xfs_log_force_lsn.xfs_file_fsync 
>>
>>        5.69            +2.5        8.23        
>> perf-profile.calltrace.cycles-pp.remove_wait_queue.xlog_cil_force_lsn.xfs_log_force_lsn.xfs_file_fsync.xfs_file_buffered_aio_write 
>>
>>        7.04            +2.8        9.80 ±  2%  
...
>>        0.00            +3.3        3.30 ±  9%  
>> perf-profile.calltrace.cycles-pp.xfs_end_ioend.xfs_end_io.process_one_work.worker_thread.kthread 
>>
>>        0.00            +3.3        3.32 ±  8%  
>> perf-profile.calltrace.cycles-pp.xfs_end_io.process_one_work.worker_thread.kthread.ret_from_fork 
>>
>>        8.56 ±  3%      -4.3        4.25        
