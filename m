...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8D7761E4EA4
	for <lists+linux-kernel@lfdr.de>; Wed, 27 May 2020 21:54:14 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387651AbgE0TyF (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 27 May 2020 15:54:05 -0400
Received: from mail.kernel.org ([198.145.29.99]:36906 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2387476AbgE0TyC (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 27 May 2020 15:54:02 -0400
Received: from localhost.localdomain (c-98-220-238-81.hsd1.il.comcast.net [98.220.238.81])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id B6402208B8;
        Wed, 27 May 2020 19:53:57 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1590609238;
        bh=jHKT9LFTxQ0hAYnbqFQofnBWYPJGR02MV93TghEK4Xw=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:In-Reply-To:
         References:From;
        b=S/hPg4g9aN/Wxy44m8UxnaurJgUVkZnyovElwTFdtbnTMSkka9pYHcW032VT8MDgz
         kaVmKT7mbB71yL0o6JWHuNvfin7mN3ZjT3rlXjlXjntexY+NwZn1bkECj/2sSCII13
         NXfKbqjWcZtpLRvTNRZo4hbyBkduPV7btMbwjwZA=
From:   Tom Zanussi <zanussi@kernel.org>
To:     rostedt@goodmis.org
Cc:     mhiramat@kernel.org, skhan@linuxfoundation.org,
        linux-kernel@vger.kernel.org
Subject: [PATCH 1/2] tracing: Move synthetic events to a separate file
Date:   Wed, 27 May 2020 14:53:47 -0500
Message-Id: <9fc01420bdbf756ef3f8267b33aff6de2e6f2b60.1590608239.git.zanussi@kernel.org>
...
index 5f6834a2bf41..6de81ced80d7 100644
...
@@ -491,1894 +422,201 @@ struct action_data {
 		struct {
 			char			*event;
 			char			*event_system;
-		} match_data;
...
@@ -7386,37 +5624,3 @@ __init int register_trigger_hist_enable_disable_cmds(void)
