...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 558072E1627
	for <lists+linux-kernel@lfdr.de>; Wed, 23 Dec 2020 03:59:43 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731182AbgLWC6g (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 22 Dec 2020 21:58:36 -0500
Received: from mail.kernel.org ([198.145.29.99]:46404 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728985AbgLWCU2 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 22 Dec 2020 21:20:28 -0500
Received: by mail.kernel.org (Postfix) with ESMTPSA id 3D445229C5;
        Wed, 23 Dec 2020 02:20:12 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1608690013;
        bh=+F0EPuA52M9mA4T6oZ/kVchllnHsry3q1z+WMkEAg+0=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH AUTOSEL 5.4 092/130] clocksource/drivers/sh_cmt: Fix potential deadlock when calling runtime PM
Date:   Tue, 22 Dec 2020 21:17:35 -0500
Message-Id: <20201223021813.2791612-92-sashal@kernel.org>
...
index ef773db080e90..6ac5cdf3d8cac 100644
--- a/drivers/clocksource/sh_cmt.c
+++ b/drivers/clocksource/sh_cmt.c
@@ -315,7 +315,6 @@ static int sh_cmt_enable(struct sh_cmt_channel *ch)
 {
 	int k, ret;
...
-	pm_runtime_get_sync(&ch->cmt->pdev->dev);
 	...
 	/* enable clock */
@@ -390,7 +389,6 @@ static void sh_cmt_disable(struct sh_cmt_channel *ch)
...
-	pm_runtime_put(&ch->cmt->pdev->dev);
 ...
 /* private flags */
@@ -558,10 +556,16 @@ static int sh_cmt_start(struct sh_cmt_channel *ch, unsigned long flag)
 	int ret = 0;
 	unsigned long flags;
...
+	}
 	...
 	if (ret)
 		goto out;
@@ -586,14 +590,20 @@ static void sh_cmt_stop(struct sh_cmt_channel *ch, unsigned long flag)
