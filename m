...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D531527F6B7
	for <lists+linux-kernel@lfdr.de>; Thu,  1 Oct 2020 02:29:27 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732106AbgJAA1s (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 30 Sep 2020 20:27:48 -0400
Received: from mx0b-00082601.pphosted.com ([67.231.153.30]:53524 "EHLO
        mx0a-00082601.pphosted.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1730707AbgJAA1r (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 30 Sep 2020 20:27:47 -0400
Received: from pps.filterd (m0001303.ppops.net [127.0.0.1])
        by m0001303.ppops.net (8.16.0.42/8.16.0.42) with SMTP id 0910RdNk005978
        for <linux-kernel@vger.kernel.org>; Wed, 30 Sep 2020 17:27:42 -0700
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=fb.com; h=from : to : cc : subject
 : date : message-id : in-reply-to : references : mime-version :
 content-transfer-encoding : content-type; s=facebook;
 bh=fY6Q/+p8pgRTaKWIE5jJxdAZWFvnWCM+P/aG+ikcXdQ=;
 b=fHmXFLzlYavpr+JbOHMPChslyvIB9sWN5fCoFbH1VSNthk9OatFffE/hhc4p2Du8zNWe
 ygGhk/5GkeZ9joHjfLJpwYSYwolD8pX/APTzcLCSok/IBbY3iCeYO8u5VmGLAjUeITAE
 nxwmc7j9UtXd+4zxuk2+V3+MK2qZrHN9KQ8= 
Received: from mail.thefacebook.com ([163.114.132.120])
        by m0001303.ppops.net with ESMTP id 33w05n1hhf-9
...
Received: by devvm1755.vll0.facebook.com (Postfix, from userid 111017)
        id C2E5CDE9667; Wed, 30 Sep 2020 17:27:17 -0700 (PDT)
...
Subject: [PATCH v4 1/4] mm: memcontrol: use helpers to access page's memcg data
Date:   Wed, 30 Sep 2020 17:27:07 -0700
Message-ID: <20201001002710.748166-2-guro@fb.com>
...
@@ -743,15 +835,19 @@ static inline void mod_memcg_state(struct mem_cgrou=
p *memcg,
...
@@ -834,16 +930,17 @@ static inline void __mod_lruvec_page_state(struct p=
age *page,
...
=20
@@ -878,8 +975,10 @@ static inline void count_memcg_events(struct mem_cgr=
oup *memcg,
...
+
 ...
 {
 	return true;
@@ -1430,7 +1550,7 @@ static inline void mem_cgroup_track_foreign_dirty(s=
truct page *page,
...
@@ -5627,14 +5618,14 @@ static int mem_cgroup_move_account(struct page *p=
age,
=20
 	/*
...
@@ -5689,13 +5680,13 @@ static int mem_cgroup_move_account(struct page *p=
age,
 	/*
...
+	 * to save space. As soon as we switch page's memory cgroup to a
 	 ...
 	 */
@@ -5704,7 +5695,7 @@ static int mem_cgroup_move_account(struct page *pag=
e,
 	css_get(&to->css);
 	css_put(&from->css);
=20
...
=20
@@ -5770,7 +5761,7 @@ static enum mc_target_type get_mctgt_type(struct vm=
_area_struct *vma,
...
@@ -5814,7 +5805,7 @@ static enum mc_target_type get_mctgt_type_thp(struc=
...
+	if (page_memcg(page) =3D=3D mc.from) {
 		...
 		if (target) {
 			get_page(page);
@@ -6760,12 +6751,12 @@ int mem_cgroup_charge(struct page *page, struct m=
...
@@ -6849,21 +6840,21 @@ static void uncharge_page(struct page *page, stru=
...
@@ -6880,7 +6871,7 @@ static void uncharge_page(struct page *page, struct=
 uncharge_gather *ug)
 	}
=20
...
=20
 	uncharge_gather_clear(&ug);
@@ -6973,11 +6964,11 @@ void mem_cgroup_migrate(struct page *oldpage, str=
uct page *newpage)
 		return;
=20
...
+	memcg =3D page_memcg(oldpage);
 	if (!memcg)
 		return;
=20
@@ -7172,7 +7163,7 @@ void mem_cgroup_swapout(struct page *page, swp_entr=
y_t entry)
...
=20
 	...
 	if (!memcg)
@@ -7193,7 +7184,7 @@ void mem_cgroup_swapout(struct page *page, swp_entr=
y_t entry)
...
@@ -7236,7 +7227,7 @@ int mem_cgroup_try_charge_swap(struct page *page, s=
wp_entry_t entry)
 	if (!cgroup_subsys_on_dfl(memory_cgrp_subsys))
 		return 0;
=20
...
--- a/mm/page_alloc.c
+++ b/mm/page_alloc.c
@@ -1057,7 +1057,7 @@ static inline bool page_expected_state(struct page =
*page,
...
+			(unsigned long)page_memcg(page) |
 		...
 		return false;
@@ -1082,7 +1082,7 @@ static const char *page_bad_reason(struct page *pag=
