...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 332AD2F3A35
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Jan 2021 20:29:35 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2436769AbhALTXO (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 12 Jan 2021 14:23:14 -0500
Received: from foss.arm.com ([217.140.110.172]:52012 "EHLO foss.arm.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2436761AbhALTXN (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 12 Jan 2021 14:23:13 -0500
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id CA75A1684;
        Tue, 12 Jan 2021 11:22:16 -0800 (PST)
Received: from e120937-lin.home (unknown [172.31.20.19])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id E39133F66E;
        Tue, 12 Jan 2021 11:22:14 -0800 (PST)
...
Subject: [PATCH v5 36/36] firmware: arm_scmi: add dynamic scmi devices creation
Date:   Tue, 12 Jan 2021 19:20:18 +0000
Message-Id: <20210112192018.34994-37-cristian.marussi@arm.com>
...
index c09035edd57a..adf40ec3aca4 100644
...
+	struct idr active_protocols;
 	...
 	struct list_head node;
 	int users;
@@ -897,6 +909,13 @@ static void scmi_devm_put_protocol(struct scmi_device *sdev, u8 protocol_id)
 	WARN_ON(ret);
 }
...
+
  ...
  *
@@ -918,8 +937,7 @@ struct scmi_handle *scmi_handle_get(struct device *dev)
...
@@ -1062,63 +1080,267 @@ scmi_txrx_setup(struct scmi_info *info, struct device *dev, int prot_id)
 	return ret;
 }
...
@@ -1143,6 +1365,7 @@ static int scmi_probe(struct platform_device *pdev)
...
@@ -1195,6 +1418,19 @@ static int scmi_probe(struct platform_device *pdev)
 			continue;
 		}
...
@@ -1208,9 +1444,10 @@ void scmi_free_channel(struct scmi_chan_info *cinfo, struct idr *idr, int id)
...
@@ -1228,6 +1465,10 @@ static int scmi_remove(struct platform_device *pdev)
