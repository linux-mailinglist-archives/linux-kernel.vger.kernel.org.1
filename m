...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 771451B7063
	for <lists+linux-kernel@lfdr.de>; Fri, 24 Apr 2020 11:14:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726863AbgDXJOS (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 24 Apr 2020 05:14:18 -0400
Received: from mail.kernel.org ([198.145.29.99]:50380 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726383AbgDXJOR (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 24 Apr 2020 05:14:17 -0400
Received: from localhost (83-86-89-107.cable.dynamic.v4.ziggo.nl [83.86.89.107])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id E98642074F;
        Fri, 24 Apr 2020 09:14:11 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1587719652;
        bh=kcxFa8pOjQUURKze3YVQtG0c62uScdokfVnkq7bqb74=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=Euzw3BACr6UxWwEhkccV722Lmf7r23uccXx7Uy0uYa1871nAEnB3HoltO1xw6ASl6
         PtIWiUgIUz8XV72eLHAzLRGRjVXLLb38aCLJDyxRLAA/NmfoqPC7XrJy46xCj20qOO
         AXohAJWOeBEPL/LSO7mUno5yZnNc1tDGtAiJenaw=
Date:   Fri, 24 Apr 2020 11:14:10 +0200
From:   Greg KH <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org,
        Andrew Morton <akpm@linux-foundation.org>,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, Jiri Slaby <jslaby@suse.cz>
Subject: Re: Linux 4.9.220
Message-ID: <20200424091410.GB359552@kroah.com>
References: <20200424091403.GA359552@kroah.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20200424091403.GA359552@kroah.com>
...
@@ -1185,7 +1185,7 @@ struct backref_node *build_backref_tree(struct reloc_control *rc,
...
@@ -2457,7 +2459,21 @@ void merge_reloc_roots(struct reloc_control *rc)
...
--- a/fs/jbd2/commit.c
+++ b/fs/jbd2/commit.c
@@ -990,9 +990,10 @@ void jbd2_journal_commit_transaction(journal_t *journal)
...
--- a/kernel/kmod.c
+++ b/kernel/kmod.c
@@ -119,7 +119,7 @@ static int call_modprobe(char *module_name, int wait)
  * invoke it.
  *
