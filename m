...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id ED1A02AA912
	for <lists+linux-kernel@lfdr.de>; Sun,  8 Nov 2020 05:29:58 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727990AbgKHE3l (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 7 Nov 2020 23:29:41 -0500
...
IronPort-SDR: lp7IO+iCZUukw9mXIrJEEsBT7SPndqZ6fQTZi14iMICVc4Cx2sTz5mTMT1ouiI4AZBlE+vK4uA
 cnqSvgmlV2hw==
X-IronPort-AV: E=McAfee;i="6000,8403,9798"; a="168900974"
X-IronPort-AV: E=Sophos;i="5.77,460,1596524400"; 
   d="scan'208";a="168900974"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 07 Nov 2020 20:29:38 -0800
IronPort-SDR: 7DQWfbzaRX9Fg6kuDvmBdqJFOnCtNv1k3qNqlR3avuGwavAc4rd1sIyL7+yalQcxluB2mMW7mB
 bvou+smwgLOg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,460,1596524400"; 
   d="scan'208";a="307244984"
...
Subject: [PATCH 2/4] x86/bus_lock: Handle warn and fatal in #DB for bus lock
Date:   Sun,  8 Nov 2020 04:29:16 +0000
Message-Id: <20201108042918.1011889-3-fenghua.yu@intel.com>
...
@@ -1115,14 +1129,41 @@ bool handle_guest_split_lock(unsigned long ip)
 }
...
@@ -1162,7 +1203,7 @@ static const struct x86_cpu_id split_lock_cpu_ids[] __initconst = {
 	{}
 };
...
+static void __init split_lock_setup(struct cpuinfo_x86 *c)
 {
 	...
 	u64 ia32_core_caps;
@@ -1189,5 +1230,45 @@ void __init cpu_set_core_cap_bits(struct cpuinfo_x86 *c)
 	}
