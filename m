...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9D37426058E
	for <lists+linux-kernel@lfdr.de>; Mon,  7 Sep 2020 22:21:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729394AbgIGUV3 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 7 Sep 2020 16:21:29 -0400
Received: from ex13-edg-ou-002.vmware.com ([208.91.0.190]:12713 "EHLO
        EX13-EDG-OU-002.vmware.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1729650AbgIGUVU (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 7 Sep 2020 16:21:20 -0400
Received: from sc9-mailhost3.vmware.com (10.113.161.73) by
 EX13-EDG-OU-002.vmware.com (10.113.208.156) with Microsoft SMTP Server id
 15.0.1156.6; Mon, 7 Sep 2020 13:21:18 -0700
Received: from akaher-virtual-machine.eng.vmware.com (unknown [10.197.103.239])
        by sc9-mailhost3.vmware.com (Postfix) with ESMTP id 38BEA4073A;
        Mon,  7 Sep 2020 13:21:19 -0700 (PDT)
...
Subject: [PATCH v4.14.y 3/3] vfio-pci: Invalidate mmaps and block MMIO access on disabled memory
Date:   Tue, 8 Sep 2020 01:47:07 +0530
Message-ID: <1599509828-23596-3-git-send-email-akaher@vmware.com>
...
@@ -1166,15 +1347,32 @@ static void vfio_pci_mmap_close(struct vm_area_struct *vma)
...
@@ -1408,12 +1607,6 @@ static struct pci_driver vfio_pci_driver = {
...
@@ -1435,6 +1628,39 @@ static int vfio_pci_get_devs(struct pci_dev *pdev, void *data)
 	return 0;
 }
