...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 4E7D320796B
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jun 2020 18:45:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2405080AbgFXQpU (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 24 Jun 2020 12:45:20 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43600 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2404173AbgFXQpT (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 24 Jun 2020 12:45:19 -0400
Received: from perceval.ideasonboard.com (perceval.ideasonboard.com [IPv6:2001:4b98:dc2:55:216:3eff:fef7:d647])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 54996C061573
        for <linux-kernel@vger.kernel.org>; Wed, 24 Jun 2020 09:45:19 -0700 (PDT)
Received: from pendragon.bb.dnainternet.fi (81-175-216-236.bb.dnainternet.fi [81.175.216.236])
        by perceval.ideasonboard.com (Postfix) with ESMTPSA id 885442A8;
        Wed, 24 Jun 2020 18:45:17 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=ideasonboard.com;
        s=mail; t=1593017118;
        bh=xMloTcPpobH0DNKJ/RjqmFIvaYYWyCyudbDsapf8gJs=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=XKOofcbM8t+gsuuxkS5cbP/hVd5OP3EvajsmoTVWzi/wh/qvJZYP0lo2/873K1SHK
         bMOT4hdmhKLNZ+LTPt48dCcAatlUxqW3R8377lNXhQrCJDYRtTsYggja/ioALl2UTi
         Y+0B0cW4CMIb3fcHb042MNQS4Y8uAX/Bd0iRDqBk=
...
Subject: [PATCH v8.1 2/3] phy: zynqmp: Add PHY driver for the Xilinx ZynqMP Gigabit Transceiver
Date:   Wed, 24 Jun 2020 19:44:48 +0300
Message-Id: <20200624164448.13850-1-laurent.pinchart@ideasonboard.com>
X-Mailer: git-send-email 2.27.0
In-Reply-To: <20200513172239.26444-3-laurent.pinchart@ideasonboard.com>
References: <20200513172239.26444-3-laurent.pinchart@ideasonboard.com>
MIME-Version: 1.0
...
- Enable compilation with COMPILE_TEST
- Fix years in copyright notice
...
---
 ...
 6 files changed, 1023 insertions(+), 1 deletion(-)
...
index 30f58b6c9f98..f53e05554ee8 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -18597,6 +18597,15 @@ F:	Documentation/devicetree/bindings/dma/xilinx/xlnx,zynqmp-dpdma.yaml
...
index 310c149a9df5..21312268ab04 100644
--- a/drivers/phy/Makefile
+++ b/drivers/phy/Makefile
@@ -28,4 +28,5 @@ obj-y					+= broadcom/	\
 					   samsung/	\
 					   socionext/	\
 					   st/		\
-					   ti/
...
new file mode 100644
index 000000000000..8babee2ce9ec
--- /dev/null
