...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0B8C0255CD6
	for <lists+linux-kernel@lfdr.de>; Fri, 28 Aug 2020 16:42:57 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727970AbgH1Oms (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 28 Aug 2020 10:42:48 -0400
Received: from relaydlg-01.paragon-software.com ([81.5.88.159]:49831 "EHLO
        relaydlg-01.paragon-software.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1727965AbgH1Ok5 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 28 Aug 2020 10:40:57 -0400
Received: from dlg2.mail.paragon-software.com (vdlg-exch-02.paragon-software.com [172.30.1.105])
        by relaydlg-01.paragon-software.com (Postfix) with ESMTPS id 8E6A0821EC;
        Fri, 28 Aug 2020 17:40:16 +0300 (MSK)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=paragon-software.com; s=mail; t=1598625616;
        bh=t1vVP4yWfC9mo+76f7isyoh67gQ5AWAUo+au0jkcnR4=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=MEgxLp8T5uqNjUvM/XN+OssMy7RIlR+wCU9BAPrki9E69ixCCb23y6f5dhFXiPZMm
         XvwxRsMGx96N0ma8jZsGgE8QxgQldQPNgGZYDXffR0jimdLKw3xWjG8uzpqXd2tJtY
         e/LgWFnEySh9i2Mp1+uOuXMnvBz10YPG2yidmflk=
Received: from localhost.localdomain (172.30.8.44) by
 vdlg-exch-02.paragon-software.com (172.30.1.105) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1847.3; Fri, 28 Aug 2020 17:40:15 +0300
...
Subject: [PATCH v3 02/10] fs/ntfs3: Add initialization of super block
Date:   Fri, 28 Aug 2020 07:39:30 -0700
Message-ID: <20200828143938.102889-3-almaz.alexandrovich@paragon-software.com>
...
---
 ...
 4 files changed, 8353 insertions(+)
...
index 000000000000..c5ab623763aa
--- /dev/null
+++ b/fs/ntfs3/fsntfs.c
@@ -0,0 +1,2218 @@
...
+}
+
+static int ntfs_write_bh(struct ntfs_sb_info *sbi, const void *buf,
...
new file mode 100644
index 000000000000..37ea369318ec
--- /dev/null
+++ b/fs/ntfs3/index.c
@@ -0,0 +1,2661 @@
+// SPDX-License-Identifier: GPL-2.0
...
new file mode 100644
index 000000000000..ddc1b5810959
--- /dev/null
+++ b/fs/ntfs3/inode.c
@@ -0,0 +1,2068 @@
+// SPDX-License-Identifier: GPL-2.0
...
+		goto out;
+	if (rsize < sizeof(struct ATTR_STD_INFO))
+		goto out;
+
+	if (std5)
+		goto next_attr;
...
+		goto out;
+
+	mode = sb->s_root ? (S_IFDIR | (0777 & sbi->options.fs_dmask_inv)) :
+			    (S_IFDIR | 0777);
+	goto next_attr;
+
+check_alloc:
...
+	nlen = le16_to_cpu(((struct REPARSE_POINT *)rp)->ReparseDataLength) -
...
new file mode 100644
index 000000000000..cedce3c6555b
--- /dev/null
+++ b/fs/ntfs3/super.c
@@ -0,0 +1,1406 @@
+// SPDX-License-Identifier: GPL-2.0
...
+}
+
+/* print info about inode using name or inode number */
...
+	} else {
+		snprintf(name, name_len, "r=%lx", inode->i_ino);
+	}
+
+	va_start(args, fmt);
+
