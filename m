...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 156EC19CB0F
	for <lists+linux-kernel@lfdr.de>; Thu,  2 Apr 2020 22:24:24 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2389974AbgDBUYR (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 2 Apr 2020 16:24:17 -0400
Received: from mail.kernel.org ([198.145.29.99]:37226 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2389421AbgDBUYQ (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 2 Apr 2020 16:24:16 -0400
Received: from localhost (83-86-89-107.cable.dynamic.v4.ziggo.nl [83.86.89.107])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 900BC206E9;
        Thu,  2 Apr 2020 20:24:12 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1585859053;
        bh=1hpM3H3Ccza5A01FjsHDnacQAr9uvqTDu01H1MxaLg4=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=P00B6WZ1gmTkpwXAvz9Hmk6di5pRMYxu23KLP31tpj2YDfqnA+Iyu6nNV/O2R/y3+
         rZ0kQu83ap8PQsTgj5s0myg+/GvmbMC+wjpXqj7WYGmRV1VyTjKaV3K1yOliKUAd+A
         NaGMxXQC6Oa3FnpOKuFyTRWb/4B/vb2dWuale20k=
Date:   Thu, 2 Apr 2020 22:24:10 +0200
From:   Greg KH <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org,
        Andrew Morton <akpm@linux-foundation.org>,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, Jiri Slaby <jslaby@suse.cz>
Subject: Re: Linux 4.9.218
Message-ID: <20200402202410.GB3259218@kroah.com>
References: <20200402202403.GA3259218@kroah.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20200402202403.GA3259218@kroah.com>
...
@@ -646,7 +647,7 @@ int find_loopback_devices(struct loopback_test *t)
...
+		} else {
 			...
 			c->page = NULL;
@@ -2935,11 +2943,13 @@ static __always_inline void do_slab_free(struct kmem_cache *s,
 	barrier();
...
+	rcu_read_unlock();
 invalid:
 	...
 	return 0;
@@ -364,6 +364,7 @@ static int hsr_get_node_status(struct sk_buff *skb_in, struct genl_info *info)
 	/* Fall through */
...
@@ -371,16 +372,14 @@ static int hsr_get_node_status(struct sk_buff *skb_in, struct genl_info *info)
  */
...
--- a/net/mac80211/tx.c
+++ b/net/mac80211/tx.c
@@ -3412,8 +3412,26 @@ struct sk_buff *ieee80211_tx_dequeue(struct ieee80211_hw *hw,
 	tx.skb = skb;
