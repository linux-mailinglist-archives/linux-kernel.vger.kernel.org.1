...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id ED91A2C3F1A
	for <lists+linux-kernel@lfdr.de>; Wed, 25 Nov 2020 12:32:05 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727614AbgKYLa7 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 25 Nov 2020 06:30:59 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40334 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725792AbgKYLa6 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 25 Nov 2020 06:30:58 -0500
Received: from mail-ej1-x641.google.com (mail-ej1-x641.google.com [IPv6:2a00:1450:4864:20::641])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A6E0DC0613D4
        for <linux-kernel@vger.kernel.org>; Wed, 25 Nov 2020 03:30:41 -0800 (PST)
Received: by mail-ej1-x641.google.com with SMTP id i19so2496662ejx.9
        for <linux-kernel@vger.kernel.org>; Wed, 25 Nov 2020 03:30:41 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=monstr-eu.20150623.gappssmtp.com; s=20150623;
        h=sender:from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=o5FmXFdGkGV3A6+pcRPtfroL6UK4XDvZ2sYAbrKEDwk=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=o5FmXFdGkGV3A6+pcRPtfroL6UK4XDvZ2sYAbrKEDwk=;
        b=
X-Gm-Message-State: AOAM5306Tkod5GxC0NnbCMh0DM/CXo64w36IdJ4c8xO8hc8btGD4D+Jr
        nh3E+ooL+Hje0iOEyvyADic7ZInWBOrwk6Az
X-Google-Smtp-Source: ABdhPJzkvWerI0l9Enrd5kE++fToXEWzYbFOLSBOd9MSBQVfuOOJ9pLDAkuEmWBduQ4ltLpxJZh3Qw==
X-Received: by 2002:a17:906:888b:: with SMTP id ak11mr2724773ejc.278.1606303838242;
        Wed, 25 Nov 2020 03:30:38 -0800 (PST)
Received: from localhost (nat-35.starnet.cz. [178.255.168.35])
        by smtp.gmail.com with ESMTPSA id o17sm1085477edz.10.2020.11.25.03.30.37
        (version=TLS1_2 cipher=ECDHE-ECDSA-CHACHA20-POLY1305 bits=256/256);
        Wed, 25 Nov 2020 03:30:37 -0800 (PST)
...
Subject: [PATCH] microblaze: Remove noMMU code
Date:   Wed, 25 Nov 2020 12:30:32 +0100
Message-Id: <caa5c3cbe6253d67fed83c4351d85224f8cf226c.1606303816.git.michal.simek@xilinx.com>
...
---
 ...
 arch/microblaze/include/asm/page.h            |  53 --
 ...
 arch/microblaze/kernel/hw_exception_handler.S | 124 +---
 ...
 32 files changed, 11 insertions(+), 1239 deletions(-)
...
index b13463d39b38..ca873436f86d 100644
...
@@ -70,8 +59,6 @@ extern unsigned int __page_offset;
...
@@ -86,25 +73,12 @@ typedef struct page *pgtable_t;
...
@@ -142,28 +116,12 @@ extern int page_is_ram(unsigned long pfn);
...
@@ -174,12 +132,6 @@ extern int page_is_ram(unsigned long pfn);
...
@@ -188,14 +140,9 @@ extern int page_is_ram(unsigned long pfn);
...
index 54411de22fa6..629e262b146a 100644
...
@@ -1044,7 +933,6 @@ ex_unaligned_fixup:
...
@@ -1093,11 +981,7 @@ lw_r27:		R3_TO_LWREG	(27);
...
-#endif
 ...
 sw_table:
 sw_r0:		SWREG_TO_R3	(0);
@@ -1131,13 +1015,8 @@ sw_r27:		SWREG_TO_R3	(27);
...
@@ -1205,7 +1084,6 @@ sw_r28_vm:	SWREG_TO_R3_VM_V	(28);
