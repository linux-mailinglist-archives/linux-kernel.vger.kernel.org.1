...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id AA2302EA388
	for <lists+linux-kernel@lfdr.de>; Tue,  5 Jan 2021 04:00:17 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728248AbhAEC7C (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 4 Jan 2021 21:59:02 -0500
Received: from mga17.intel.com ([192.55.52.151]:41800 "EHLO mga17.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728047AbhAEC7B (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 4 Jan 2021 21:59:01 -0500
IronPort-SDR: FUmtgkXPj8PAdTbom4W7QwHRjisEZVg0ozia2rlMWx7VLbeX8xLDx0b5vvaqBhpcqlvon3tBhS
 OXKgY9z6QPJw==
X-IronPort-AV: E=McAfee;i="6000,8403,9854"; a="156827511"
X-IronPort-AV: E=Sophos;i="5.78,475,1599548400"; 
   d="scan'208";a="156827511"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 04 Jan 2021 18:58:13 -0800
IronPort-SDR: WJlM36u8KuxGWlp4d9nhsrnpi+tj4okDGobbnEDxMYEgVtWgTltQH5QXzBiACYCWcKp1obSqnD
 0BTM0udDRXiA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,475,1599548400"; 
   d="scan'208";a="397632117"
Received: from txasoft-yocto.an.intel.com ([10.123.72.192])
  by fmsmga002.fm.intel.com with ESMTP; 04 Jan 2021 18:58:13 -0800
From:   Mike Ximing Chen <mike.ximing.chen@intel.com>
To:     linux-kernel@vger.kernel.org
Cc:     arnd@arndb.de, gregkh@linuxfoundation.org,
        dan.j.williams@intel.com, pierre-louis.bossart@linux.intel.com,
        Gage Eads <gage.eads@intel.com>
Subject: [PATCH v8 03/20] dlb: add resource and device initialization
Date:   Mon,  4 Jan 2021 20:58:22 -0600
Message-Id: <20210105025839.23169-4-mike.ximing.chen@intel.com>
...
---
 ...
 drivers/misc/dlb/dlb_hw_types.h | 179 ++++++++++++++++++++++++++
 drivers/misc/dlb/dlb_main.c     |  47 +++++++
 drivers/misc/dlb/dlb_main.h     |   8 ++
 drivers/misc/dlb/dlb_pf_ops.c   |  63 +++++++++
 drivers/misc/dlb/dlb_regs.h     | 119 +++++++++++++++++
 drivers/misc/dlb/dlb_resource.c | 219 ++++++++++++++++++++++++++++++++
 drivers/misc/dlb/dlb_resource.h |  17 +++
 9 files changed, 729 insertions(+), 1 deletion(-)
...
index a4ce28c157de..a791f6c98a50 100644
...
index f58116b62d5e..daa5eb75380f 100644
...
+
 ...
 {
 	/*
@@ -121,8 +139,35 @@ static int dlb_probe(struct pci_dev *pdev,
 	if (ret)
...
+wait_for_device_ready_fail:
 ...
 map_pci_bar_fail:
@@ -139,6 +184,8 @@ static void dlb_remove(struct pci_dev *pdev)
 {
...
index f0567b836e27..aaa806be66af 100644
...
index 0951c99f6183..a88f9519ac60 100644
...
+#include "dlb_resource.h"
 ...
 /********************************/
 /****** PCI BAR management ******/
@@ -40,6 +44,62 @@ dlb_pf_map_pci_bar_space(struct dlb *dlb, struct pci_dev *pdev)
 	return 0;
 }
...
+
+static int
+dlb_pf_init_driver_state(struct dlb *dlb)
+{
...
+
+static void
+dlb_pf_enable_pm(struct dlb *dlb)
+{
+	/*
...
+static int
+dlb_pf_wait_for_device_ready(struct dlb *dlb, struct pci_dev *pdev)
+{
...
+
 ...
 /****** DLB PF Device Ops ******/
 /********************************/
@@ -47,4 +107,7 @@ dlb_pf_map_pci_bar_space(struct dlb *dlb, struct pci_dev *pdev)
...
new file mode 100644
index 000000000000..3c60b704f3d6
--- /dev/null
