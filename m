...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A9D2E2E09AC
	for <lists+linux-kernel@lfdr.de>; Tue, 22 Dec 2020 12:29:00 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726536AbgLVL1E (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 22 Dec 2020 06:27:04 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39894 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726503AbgLVL1C (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 22 Dec 2020 06:27:02 -0500
Received: from mail-wm1-x335.google.com (mail-wm1-x335.google.com [IPv6:2a00:1450:4864:20::335])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E58EAC0613D3
        for <linux-kernel@vger.kernel.org>; Tue, 22 Dec 2020 03:26:21 -0800 (PST)
Received: by mail-wm1-x335.google.com with SMTP id x22so1570944wmc.5
        for <linux-kernel@vger.kernel.org>; Tue, 22 Dec 2020 03:26:21 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=brainfault-org.20150623.gappssmtp.com; s=20150623;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc;
        bh=DQWqFR4RkLj2n6StlAHAuY/9uDAhYeXZT6MKiOomovU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=DQWqFR4RkLj2n6StlAHAuY/9uDAhYeXZT6MKiOomovU=;
        b=
X-Gm-Message-State: AOAM530U2TJFIDFZi+cIOKp1Zu2k3zJPhKzrzNhiq7asKqI2GZw2AxWW
        zkT0niAv/dXmGs0Z3Q22U18s+/7l6rM+4O6MOgPwew==
X-Google-Smtp-Source: ABdhPJzPSQ06X00MmjOOk4w0QwWtZ8QOmyqvx/ASCjQJ5Lwy0cj4cYyEJPSEHZEXnlbjoFgTtet/oEvLGLhFcCQ3PGI=
X-Received: by 2002:a1c:1fc2:: with SMTP id f185mr21716292wmf.134.1608636380228;
 Tue, 22 Dec 2020 03:26:20 -0800 (PST)
MIME-Version: 1.0
References: <20201221203719.15988-1-vitaly.wool@konsulko.com>
 <CAAhSdy3bPdS3SnQ=AQtFrZNhb5Vvg7-fnjH3cbf1k5Pyyub-Gw@mail.gmail.com> <CAM4kBBJtQJSx=m=4FQE5LTM6U9pA9vYYLfFDjCgWonYkPgQEcQ@mail.gmail.com>
In-Reply-To: <CAM4kBBJtQJSx=m=4FQE5LTM6U9pA9vYYLfFDjCgWonYkPgQEcQ@mail.gmail.com>
From:   Anup Patel <anup@brainfault.org>
Date:   Tue, 22 Dec 2020 16:56:08 +0530
Message-ID: <CAAhSdy3-2mPvA9F3HSqcNs+-nHLRGGkTV6jV0eAzXhcCYD3FVA@mail.gmail.com>
...
On Tue, Dec 22, 2020 at 3:55 PM Vitaly Wool <vitaly.wool@konsulko.com> wrote:
>
> Hi Anup,
>
> On Tue, Dec 22, 2020 at 6:16 AM Anup Patel <anup@brainfault.org> wrote:
> >
...
>
> That's right but I think it actually makes things harder to
> understand. Instead, I can implement a static inline helper like
> get_secondary_start_phys() which will return the appropriate value
> depending on the actual configuration. Does that sound reasonable?

Yes, that would be better.

Overall, I would also suggest to use more pre-processor tricks to
minimize "#ifdef" both in assembly and C sources.
...
>
> Well, as you can see if you look further down the patch, I do set
> dtb_early_va to __va(dtb_early_pa) for the non-XIP case.
...
>
> vmlinux-xip loaded script doesn't have to be a carbon copy of the
> original one. Is there something special that you believe is needed
> for the XIP version?

Atish's series improves kernel strict mappings and in the process those
patches end-up re-organizing sections in linker script.

Make sure you test XIP + strict kernel mappings.
...
This assignment deserve's a detailed comment for non-XIP case. Also, this
assignemt should be moved to setup_vm_final() where the switch from
early_pg_dir to swapper_pg_dir for boot CPU happens.
...
>
> For XIP cases we shouldn't care too much about virtual address space.
> We are saving RAM (and power, FWIW, but that's unrelated) :-)
>
> > Also, DTB_EARLY_BASE_VA is an adhoc address falling in user-space
> > address range.
>
> That's fair. Would you agree with me changing the mapping to point to
> somewhere between VMALLOC_END and XIP_VIRT_ADDR_START?

Please don't change DTB_EARLY_BASE_VA for the non-XIP case.

The mapping done by setup_vm() is really temporary and once boot CPU
switches to swapper_pg_dir we don't need DTB early mappings.
...
>
> No, I don't want to copy DTB to RAM at all as long as I can avoid
> that. See also above, we have a goal of *saving* RAM. It is directly
> contradictory to this goal to waste up to 100+K of RAM.
>
> Again, what if I change DTB_EARLY_BASE_VA to be something like
> (XIP_VIRT_ADDR_START-2*PMD_SIZE) in the XIP case?

Maybe you can keep DTB_EARLY_BASE_VA as-is and introduce
XIP_DTB_VA define for mapping DTB in setup_vm_final() for the XIP case.

The non-XIP case does not need any DTB mappings in setup_vm_final().

Also, setup_vm_final() should do smaller mappings for the DTB instead
of PGDIR_SIZE mappings.
...
> > Anup
>
> ...and thanks for the thorough review of course.
>
> Best regards,
>    Vitaly
