...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 159781E0A8A
	for <lists+linux-kernel@lfdr.de>; Mon, 25 May 2020 11:30:38 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2389468AbgEYJag (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 25 May 2020 05:30:36 -0400
Received: from smtp-fw-9102.amazon.com ([207.171.184.29]:54689 "EHLO
        smtp-fw-9102.amazon.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2388669AbgEYJag (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 25 May 2020 05:30:36 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  d=amazon.com; i=@amazon.com; q=dns/txt; s=amazon201209;
  t=1590399034; x=1621935034;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version;
  bh=wjHzgm2CkrYmvLi68oR7gawRM2UzLtbySYRBl9GtCA8=;
  b=IP7qogjdxh7OsSJbHLHa5DgQfeiEJeaXsHG9bby3MO/Jz1o9LmoP0TDp
   JXg1sMROm6CdgbHQ6uvDl669II5RI3j8qul7Jkhi4CI2eCxaCHVbLEkQU
   kyPMuPzwfLFWrvFjL1ZGnn3XUKaZEaY7Fu5kjxAvIZR17+SHWGBTMYcC3
   U=;
IronPort-SDR: Cdx2t3m4njzzyB0G1xa/vTVFiZH0wcnzFOC0nVQU9kaZkOhdX3vOIRarEppatHmuKYC0IcWiBl
 cWCvsyKm8wZw==
X-IronPort-AV: E=Sophos;i="5.73,432,1583193600"; 
   d="scan'208";a="45715472"
Received: from sea32-co-svc-lb4-vlan3.sea.corp.amazon.com (HELO email-inbound-relay-1a-67b371d8.us-east-1.amazon.com) ([10.47.23.38])
  by smtp-border-fw-out-9102.sea19.amazon.com with ESMTP; 25 May 2020 09:30:28 +0000
Received: from EX13MTAUEA002.ant.amazon.com (iad55-ws-svc-p15-lb9-vlan3.iad.amazon.com [10.40.159.166])
        by email-inbound-relay-1a-67b371d8.us-east-1.amazon.com (Postfix) with ESMTPS id 0CD69A16D2;
        Mon, 25 May 2020 09:30:16 +0000 (UTC)
Received: from EX13D31EUA001.ant.amazon.com (10.43.165.15) by
 EX13MTAUEA002.ant.amazon.com (10.43.61.77) with Microsoft SMTP Server (TLS)
 id 15.0.1497.2; Mon, 25 May 2020 09:30:16 +0000
Received: from u886c93fd17d25d.ant.amazon.com (10.43.162.140) by
 EX13D31EUA001.ant.amazon.com (10.43.165.15) with Microsoft SMTP Server (TLS)
 id 15.0.1497.2; Mon, 25 May 2020 09:29:59 +0000
...
Subject: [PATCH v13 13/15] mm/damon: Add kunit tests
Date:   Mon, 25 May 2020 11:29:43 +0200
Message-ID: <20200525092943.920-1-sjpark@amazon.com>
...
index ffd011282c48..76eca256a8ae 100644
--- a/mm/damon.c
+++ b/mm/damon.c
@@ -25,7 +25,11 @@
...
@@ -1509,3 +1513,5 @@ module_exit(damon_exit);
 MODULE_LICENSE("GPL");
