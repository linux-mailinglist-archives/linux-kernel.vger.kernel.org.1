...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A22E42EBAD2
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Jan 2021 08:56:09 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726959AbhAFHwo (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 6 Jan 2021 02:52:44 -0500
Received: from mga01.intel.com ([192.55.52.88]:39727 "EHLO mga01.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726865AbhAFHwn (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 6 Jan 2021 02:52:43 -0500
IronPort-SDR: p1B/GpqBFLapoEjr7dHWwybqivO+EZ8PtU79Q0VSjYua/lg4eeN+1ZqSselgeat5+yhmhVN8tP
 /8RGgSbg4cSA==
X-IronPort-AV: E=McAfee;i="6000,8403,9855"; a="195788763"
X-IronPort-AV: E=Sophos;i="5.78,479,1599548400"; 
   d="scan'208";a="195788763"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 05 Jan 2021 23:52:02 -0800
IronPort-SDR: 8uR3urRAm+6LeUGCy9vV9ShbTazIvjj3fNrtIuM3zN6i9Dd4GFCaHrkHwl9iU7FQpwKHUuvk9c
 UbJqjYQpBvrA==
X-IronPort-AV: E=Sophos;i="5.78,479,1599548400"; 
   d="scan'208";a="350138556"
Received: from shsi6026.sh.intel.com (HELO localhost) ([10.239.147.88])
  by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 05 Jan 2021 23:51:57 -0800
...
Subject: [PATCH v7 08/18] virt: acrn: Introduce EPT mapping management
Date:   Wed,  6 Jan 2021 15:50:45 +0800
Message-Id: <20210106075055.47226-9-shuo.a.liu@intel.com>
...
index 2d04ebaa43f8..c3858a64031a 100644
...
@@ -119,6 +120,20 @@ static long acrn_dev_ioctl(struct file *filp, unsigned int cmd,
 				vm->vmid);
 		kfree(cpu_regs);
 		break;
...
index d5d66b93586e..c260d0e9caea 100644
--- a/include/uapi/linux/acrn.h
+++ b/include/uapi/linux/acrn.h
@@ -102,6 +102,50 @@ struct acrn_vcpu_regs {
...
@@ -121,4 +165,9 @@ struct acrn_vcpu_regs {
