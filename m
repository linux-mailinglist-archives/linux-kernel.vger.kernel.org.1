...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 30FD72F7D60
	for <lists+linux-kernel@lfdr.de>; Fri, 15 Jan 2021 14:57:14 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387528AbhAON4N (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 15 Jan 2021 08:56:13 -0500
Received: from esa.microchip.iphmx.com ([68.232.153.233]:30623 "EHLO
        esa.microchip.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1731075AbhAON4H (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 15 Jan 2021 08:56:07 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1610718966; x=1642254966;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=XMr6NCIZadTPF/llnz6C63I3REEXdgyp6pcI6Ws71ls=;
  b=y+MMOtXfRtEI5EtksROtUWEWKmaYhgP4FeUtLPQiNbmSl1rvPEpPN/U4
   T1BodxZBimZVnVKCzu3jyoZrR/cuaXpamurtf5Ai88/0TXNVFp6eJUivp
   ehQpE6+g52/fgGFSV/FZ99Q5NN3KKPpO7WK9QzhX/QvrEr4m+V210NowZ
   7YtAWD5Y2YnQRLnf/+0Wel4rfW7/T5cRwsv+Js2tFuqLdWQiybqG9Xjcw
   pjsW3Yvlw4WAK/3UK10DE+4WZJko57qMflMJN2FBN45vGRAHTmlu8XoYi
   9e44gA130KEBiwDtY+gM/48275D5ea8QJ7hxqMY3LsBe65bG7rvE16h/U
   A==;
IronPort-SDR: 
X-IronPort-AV: E=Sophos;i="5.79,349,1602572400"; 
   d="scan'208";a="111177424"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa1.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 15 Jan 2021 06:54:16 -0700
Received: from chn-vm-ex02.mchp-main.com (10.10.85.144) by
 chn-vm-ex01.mchp-main.com (10.10.85.143) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1979.3; Fri, 15 Jan 2021 06:54:15 -0700
Received: from mchp-dev-shegelun.microchip.com (10.10.115.15) by
 chn-vm-ex02.mchp-main.com (10.10.85.144) with Microsoft SMTP Server id
 15.1.1979.3 via Frontend Transport; Fri, 15 Jan 2021 06:54:12 -0700
...
Subject: [RFC PATCH v3 6/8] net: sparx5: add calendar bandwidth allocation support
Date:   Fri, 15 Jan 2021 14:53:37 +0100
Message-ID: <20210115135339.3127198-7-steen.hegelund@microchip.com>
...
index 000000000000..b5ce378d3227
--- /dev/null
...
index 6994bb7580cb..e612d7cab131 100644
--- a/drivers/net/ethernet/microchip/sparx5/sparx5_main.c
+++ b/drivers/net/ethernet/microchip/sparx5/sparx5_main.c
@@ -605,7 +605,14 @@ static int sparx5_start(struct sparx5 *sparx5)
...
index d0a7f5902346..a375f6e236a7 100644
--- a/drivers/net/ethernet/microchip/sparx5/sparx5_main.h
+++ b/drivers/net/ethernet/microchip/sparx5/sparx5_main.h
@@ -191,6 +191,10 @@ int sparx5_vlan_vid_add(struct sparx5_port *port, u16 vid, bool pvid,
