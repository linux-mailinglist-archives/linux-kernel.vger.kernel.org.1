...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 29B4A2298B7
	for <lists+linux-kernel@lfdr.de>; Wed, 22 Jul 2020 14:54:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732495AbgGVMyW (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 22 Jul 2020 08:54:22 -0400
Received: from mail.kernel.org ([198.145.29.99]:48600 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1732340AbgGVMxx (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 22 Jul 2020 08:53:53 -0400
Received: from localhost (83-86-89-107.cable.dynamic.v4.ziggo.nl [83.86.89.107])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 437BD205CB;
        Wed, 22 Jul 2020 12:53:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1595422423;
        bh=lA6QyT5HX1dP126lQC+4C1jl0oQNmio7X+ue3QQSvJk=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=I5za2NzsnJ7p6HEsfdIfLYEZIjdZZL7gZhSmUAAmyBJg5ESDWHgWu5BKmq/8tTC/w
         geZe8k85xar9/Vns+cImOzN3i/wOCA1b23FRsEDzM0jOXFNxuW7f7fhgKgf3JN6dnc
         JrPh+SuZxExNL9veFj+BMJwYkimaP4s3NhaL0Ddo=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 5.4.53
Date:   Wed, 22 Jul 2020 14:53:42 +0200
Message-Id: <159542242075140@kroah.com>
X-Mailer: git-send-email 2.27.0
In-Reply-To: <1595422420145236@kroah.com>
References: <1595422420145236@kroah.com>
MIME-Version: 1.0
...
+	sysc_write_sysconfig(ddata, reg);
 ...
 set_midle:
 	/* Set MIDLE mode */
@@ -931,14 +1005,14 @@ static int sysc_enable_module(struct device *dev)
...
+	sysc_write_sysconfig(ddata, reg);
 ...
 set_sidle:
 	/* Set SIDLE mode */
@@ -1022,7 +1096,7 @@ static int sysc_disable_module(struct device *dev)
 	if (regbits->autoidle_shift >= 0 &&
 	    ddata->cfg.sysc_val & BIT(regbits->autoidle_shift))
 		reg |= 1 << regbits->autoidle_shift;
-	sysc_write(ddata, ddata->offsets[SYSC_SYSCONFIG], reg);
