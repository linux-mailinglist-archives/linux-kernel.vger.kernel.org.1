...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CACD32AE89F
	for <lists+linux-kernel@lfdr.de>; Wed, 11 Nov 2020 07:06:46 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725909AbgKKGGn (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 11 Nov 2020 01:06:43 -0500
Received: from mga14.intel.com ([192.55.52.115]:62295 "EHLO mga14.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725867AbgKKGGm (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 11 Nov 2020 01:06:42 -0500
IronPort-SDR: 5nGnqvH6mT9ijHjWhSdio8Q3pX1s3YnV3eO6jqokjUpL2Q5zgqhBhpE2jf3KYpEhQYqwxQAA2r
 Pwr5Ae7Y/wLg==
X-IronPort-AV: E=McAfee;i="6000,8403,9801"; a="169316434"
X-IronPort-AV: E=Sophos;i="5.77,468,1596524400"; 
   d="gz'50?scan'50,208,50";a="169316434"
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 10 Nov 2020 22:06:38 -0800
IronPort-SDR: kOP2mzzMGhnNWCGXJyN0di4e27tKa2AaH+xGfhL7i5g9tVGg+++X7eMZqVKCaqnl5/3B9ViYc/
 DTZSyNnA3VDw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,468,1596524400"; 
   d="gz'50?scan'50,208,50";a="530111095"
Received: from lkp-server02.sh.intel.com (HELO 898ef09051d7) ([10.239.97.151])
  by fmsmga006.fm.intel.com with ESMTP; 10 Nov 2020 22:06:36 -0800
Received: from kbuild by 898ef09051d7 with local (Exim 4.92)
        (envelope-from <lkp@intel.com>)
        id 1kcjH9-00000t-VF; Wed, 11 Nov 2020 06:06:35 +0000
Date:   Wed, 11 Nov 2020 14:06:26 +0800
...
Message-ID: <202011111418.a13B6VI5-lkp@intel.com>
MIME-Version: 1.0
...
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  356   *	/dev/watchdog handling
...
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  359  static ssize_t usb_pcwd_write(struct file *file, const char __user *data,
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  360  						size_t len, loff_t *ppos)
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  361  {
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  362  	/* See if we got the magic character 'V' and reload the timer */
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  363  	if (len) {
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  364  		if (!nowayout) {
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  365  			size_t i;
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  366  
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  367  			/* note: just in case someone wrote the magic character
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  368  			 * five months ago... */
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  369  			expect_release = 0;
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  370  
143a2e54bf5321 drivers/watchdog/pcwd_usb.c      Wim Van Sebroeck    2009-03-18  371  			/* scan to see whether or not we got the
143a2e54bf5321 drivers/watchdog/pcwd_usb.c      Wim Van Sebroeck    2009-03-18  372  			 * magic character */
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  373  			for (i = 0; i != len; i++) {
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  374  				char c;
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16 @375  				if (get_user(c, data + i))
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  376  					return -EFAULT;
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  377  				if (c == 'V')
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  378  					expect_release = 42;
...
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  382  		/* someone wrote to us, we should reload the timer */
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  383  		usb_pcwd_keepalive(usb_pcwd_device);
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  384  	}
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  385  	return len;
...
c9488520512df6 drivers/watchdog/pcwd_usb.c      Alan Cox            2008-07-03  388  static long usb_pcwd_ioctl(struct file *file, unsigned int cmd,
c9488520512df6 drivers/watchdog/pcwd_usb.c      Alan Cox            2008-07-03  389  						unsigned long arg)
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  390  {
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  391  	void __user *argp = (void __user *)arg;
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  392  	int __user *p = argp;
42747d712de56c drivers/watchdog/pcwd_usb.c      Wim Van Sebroeck    2009-12-26  393  	static const struct watchdog_info ident = {
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  394  		.options =		WDIOF_KEEPALIVEPING |
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  395  					WDIOF_SETTIMEOUT |
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  396  					WDIOF_MAGICCLOSE,
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  397  		.firmware_version =	1,
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  398  		.identity =		DRIVER_NAME,
...
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  401  	switch (cmd) {
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  402  	case WDIOC_GETSUPPORT:
7944d3a5a70ee5 drivers/watchdog/pcwd_usb.c      Wim Van Sebroeck    2008-08-06  403  		return copy_to_user(argp, &ident, sizeof(ident)) ? -EFAULT : 0;
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  404  
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  405  	case WDIOC_GETSTATUS:
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  406  	case WDIOC_GETBOOTSTATUS:
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  407  		return put_user(0, p);
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  408  
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  409  	case WDIOC_GETTEMP:
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  410  	{
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  411  		int temperature;
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  412  
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  413  		if (usb_pcwd_get_temperature(usb_pcwd_device, &temperature))
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  414  			return -EFAULT;
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  415  
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  416  		return put_user(temperature, p);
...
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  419  	case WDIOC_SETOPTIONS:
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  420  	{
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  421  		int new_options, retval = -EINVAL;
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  422  
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16 @423  		if (get_user(new_options, p))
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  424  			return -EFAULT;
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  425  
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  426  		if (new_options & WDIOS_DISABLECARD) {
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  427  			usb_pcwd_stop(usb_pcwd_device);
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  428  			retval = 0;
...
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  431  		if (new_options & WDIOS_ENABLECARD) {
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  432  			usb_pcwd_start(usb_pcwd_device);
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  433  			retval = 0;
...
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  436  		return retval;
...
0c06090c9472db drivers/watchdog/pcwd_usb.c      Wim Van Sebroeck    2008-07-18  439  	case WDIOC_KEEPALIVE:
0c06090c9472db drivers/watchdog/pcwd_usb.c      Wim Van Sebroeck    2008-07-18  440  		usb_pcwd_keepalive(usb_pcwd_device);
0c06090c9472db drivers/watchdog/pcwd_usb.c      Wim Van Sebroeck    2008-07-18  441  		return 0;
0c06090c9472db drivers/watchdog/pcwd_usb.c      Wim Van Sebroeck    2008-07-18  442  
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  443  	case WDIOC_SETTIMEOUT:
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  444  	{
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  445  		int new_heartbeat;
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  446  
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  447  		if (get_user(new_heartbeat, p))
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  448  			return -EFAULT;
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  449  
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  450  		if (usb_pcwd_set_heartbeat(usb_pcwd_device, new_heartbeat))
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  451  			return -EINVAL;
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  452  
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  453  		usb_pcwd_keepalive(usb_pcwd_device);
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  454  	}
bd490f8222510d drivers/watchdog/pcwd_usb.c      Gustavo A. R. Silva 2020-07-07  455  		fallthrough;
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  456  
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  457  	case WDIOC_GETTIMEOUT:
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  458  		return put_user(heartbeat, p);
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  459  
58b519f3e5e491 drivers/char/watchdog/pcwd_usb.c Wim Van Sebroeck    2006-05-21  460  	case WDIOC_GETTIMELEFT:
58b519f3e5e491 drivers/char/watchdog/pcwd_usb.c Wim Van Sebroeck    2006-05-21  461  	{
58b519f3e5e491 drivers/char/watchdog/pcwd_usb.c Wim Van Sebroeck    2006-05-21  462  		int time_left;
58b519f3e5e491 drivers/char/watchdog/pcwd_usb.c Wim Van Sebroeck    2006-05-21  463  
58b519f3e5e491 drivers/char/watchdog/pcwd_usb.c Wim Van Sebroeck    2006-05-21  464  		if (usb_pcwd_get_timeleft(usb_pcwd_device, &time_left))
58b519f3e5e491 drivers/char/watchdog/pcwd_usb.c Wim Van Sebroeck    2006-05-21  465  			return -EFAULT;
58b519f3e5e491 drivers/char/watchdog/pcwd_usb.c Wim Van Sebroeck    2006-05-21  466  
58b519f3e5e491 drivers/char/watchdog/pcwd_usb.c Wim Van Sebroeck    2006-05-21  467  		return put_user(time_left, p);
...
^1da177e4c3f41 drivers/char/watchdog/pcwd_usb.c Linus Torvalds      2005-04-16  470  	default:
795b89d207d8ff drivers/char/watchdog/pcwd_usb.c Samuel Tardieu      2006-09-09  471  		return -ENOTTY;
...
H4sICFl4q18AAy5jb25maWcAnDzbcuM4ru/7FaqeqlO7Dz3jOOl0UqfyQEuUxbEkqkXKcfKi
