...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 58F452B6F73
	for <lists+linux-kernel@lfdr.de>; Tue, 17 Nov 2020 20:59:28 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731434AbgKQT5c (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 17 Nov 2020 14:57:32 -0500
Received: from mga12.intel.com ([192.55.52.136]:48614 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1731362AbgKQT5b (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 17 Nov 2020 14:57:31 -0500
IronPort-SDR: eW+B6lZt182R58Fn8DEJ0fMPQkfwUcDG7TBqgmg4B/DnlCGs069M7YBHgDS6NmVm3Sgz6Z8DeF
 PAWvEhWLaOgg==
X-IronPort-AV: E=McAfee;i="6000,8403,9808"; a="150270467"
X-IronPort-AV: E=Sophos;i="5.77,486,1596524400"; 
   d="scan'208";a="150270467"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 17 Nov 2020 11:57:31 -0800
IronPort-SDR: 0dXIuhdyRBTOfFfIYNd1+q9XOab8phtbBArf6d4aoSokSXKbSwkau/XIgxwaABo1tDdu3pSmni
 wt1hwCGqYu9A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,486,1596524400"; 
   d="scan'208";a="544188130"
...
Subject: [PATCH 04/12] perf sort: Add sort option for data page size
Date:   Tue, 17 Nov 2020 11:56:29 -0800
Message-Id: <20201117195637.6499-5-kan.liang@linux.intel.com>
...
index 15385ea00190..9e9a848a2746 100644
--- a/tools/perf/util/machine.c
+++ b/tools/perf/util/machine.c
@@ -2019,11 +2019,12 @@ static void ip__resolve_ams(struct thread *thread,
 	ams->ms.sym = al.sym;
 	ams->ms.map = al.map;
 	ams->phys_addr = 0;
...
@@ -2037,6 +2038,7 @@ static void ip__resolve_data(struct thread *thread,
 	ams->ms.sym = al.sym;
 	ams->ms.map = al.map;
...
@@ -2049,7 +2051,8 @@ struct mem_info *sample__resolve_mem(struct perf_sample *sample,
