...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7821F23B480
	for <lists+linux-kernel@lfdr.de>; Tue,  4 Aug 2020 07:37:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729712AbgHDFhB (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 4 Aug 2020 01:37:01 -0400
Received: from mga17.intel.com ([192.55.52.151]:35313 "EHLO mga17.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1729636AbgHDFg7 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 4 Aug 2020 01:36:59 -0400
IronPort-SDR: EJrsg1zuUY7xHhc64nq6XcueLYrn9qy+SgyfI/Hd8bo7od9kr4Y+KLrdKDOa4/HnXsqPKZ9Qw6
 A58IY3wPrdUw==
X-IronPort-AV: E=McAfee;i="6000,8403,9702"; a="132301726"
X-IronPort-AV: E=Sophos;i="5.75,432,1589266800"; 
   d="yaml'?scan'208";a="132301726"
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 03 Aug 2020 20:21:53 -0700
IronPort-SDR: edGRl52RlIYqGXe9mXcIFxhsgChiA9pwbQ6M3aJrr2D9qgIcWiKo2LPcr21VChpEkU0zNHzHZ0
 Cc4oeAlPZCSQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,432,1589266800"; 
   d="yaml'?scan'208";a="332333251"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.3])
  by orsmga007.jf.intel.com with ESMTP; 03 Aug 2020 20:21:50 -0700
...
Content-Disposition: attachment; filename="config-5.8.0-rc7-00001-ge83a3e282ebea"
...
queue_at_least_once'
	...
	export submit_id='5f209c99089ab77759700418'
	export job_file='/lkp/jobs/scheduled/lkp-csl-2ap3/will-it-scale-performance-process-50%-signal1-ucode=0x5002f01-debian-10.4-x86_64-20200603.cgz-e83a3e282ebeab6bcf3eec024b93fcab0d-20200729-30553-1wq6pvs-2.yaml'
	export id='99e1c3459d96047528b4cf84a5819cd683f696f7'
	...
	export commit='e83a3e282ebeab6bcf3eec024b93fcab0d6e4dc5'
	export need_kconfig_hw='CONFIG_IGB=y
CONFIG_BLK_DEV_NVME'
	export ucode='0x5002f01'
	export enqueue_time='2020-07-29 05:46:01 +0800'
	export _id='5f209c99089ab77759700418'
	export _rt='/result/will-it-scale/performance-process-50%-signal1-ucode=0x5002f01/lkp-csl-2ap3/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/e83a3e282ebeab6bcf3eec024b93fcab0d6e4dc5'
	export user='lkp'
	...
	export branch='driver-core/readfile'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export result_root='/result/will-it-scale/performance-process-50%-signal1-ucode=0x5002f01/lkp-csl-2ap3/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/e83a3e282ebeab6bcf3eec024b93fcab0d6e4dc5/3'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-csl-2ap3/will-it-scale-performance-process-50%-signal1-ucode=0x5002f01-debian-10.4-x86_64-20200603.cgz-e83a3e282ebeab6bcf3eec024b93fcab0d-20200729-30553-1wq6pvs-2.yaml
ARCH=x86_64
kconfig=x86_64-rhel-8.3
branch=driver-core/readfile
commit=e83a3e282ebeab6bcf3eec024b93fcab0d6e4dc5
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/e83a3e282ebeab6bcf3eec024b93fcab0d6e4dc5/vmlinuz-5.8.0-rc7-00001-ge83a3e282ebea
acpi_rsdp=0x67f44014
max_uptime=1500
RESULT_ROOT=/result/will-it-scale/performance-process-50%-signal1-ucode=0x5002f01/lkp-csl-2ap3/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/e83a3e282ebeab6bcf3eec024b93fcab0d6e4dc5/3
LKP_SERVER=inn
nokaslr
selinux=0
debug
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/e83a3e282ebeab6bcf3eec024b93fcab0d6e4dc5/modules.cgz'
	...
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/e83a3e282ebeab6bcf3eec024b93fcab0d6e4dc5/vmlinuz-5.8.0-rc7-00001-ge83a3e282ebea'
	export dequeue_time='2020-07-29 05:56:46 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2ap3/will-it-scale-performance-process-50%-signal1-ucode=0x5002f01-debian-10.4-x86_64-20200603.cgz-e83a3e282ebeab6bcf3eec024b93fcab0d-20200729-30553-1wq6pvs-2.cgz'
...
kconfig: x86_64-rhel-8.3
submit_id: 5f208c53089ab7755d47982c
job_file: "/lkp/jobs/scheduled/lkp-csl-2ap3/will-it-scale-performance-process-50%-signal1-ucode=0x5002f01-debian-10.4-x86_64-20200603.cgz-e83a3e282ebeab6bcf3eec024b93fcab0d-20200729-30045-dg3agx-1.yaml"
id: 9a1bf4b76b4d4ee2048eaa78147dd1d6b91fe14f
...
- CONFIG_BLK_DEV_NVME
ucode: '0x5002f01'
enqueue_time: 2020-07-29 04:36:35.720800966 +08:00
_id: 5f209674089ab7755d47982d
_rt: "/result/will-it-scale/performance-process-50%-signal1-ucode=0x5002f01/lkp-csl-2ap3/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/e83a3e282ebeab6bcf3eec024b93fcab0d6e4dc5"
...
result_root: "/result/will-it-scale/performance-process-50%-signal1-ucode=0x5002f01/lkp-csl-2ap3/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/e83a3e282ebeab6bcf3eec024b93fcab0d6e4dc5/0"
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-csl-2ap3/will-it-scale-performance-process-50%-signal1-ucode=0x5002f01-debian-10.4-x86_64-20200603.cgz-e83a3e282ebeab6bcf3eec024b93fcab0d-20200729-30045-dg3agx-1.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- branch=linux-devel/devel-hourly-2020072723
- commit=e83a3e282ebeab6bcf3eec024b93fcab0d6e4dc5
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/e83a3e282ebeab6bcf3eec024b93fcab0d6e4dc5/modules.cgz"
...
#! /lkp/lkp/.src-20200728-154800/include/site/inn
LKP_CGI_PORT: 80
LKP_CIFS_PORT: 139
oom-killer: 
watchdog: 
...
#! runtime status
last_kernel: 5.8.0-rc7
repeat_to: 2
schedule_notify_address: 

#! user overrides
queue_at_least_once: 0
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/e83a3e282ebeab6bcf3eec024b93fcab0d6e4dc5/vmlinuz-5.8.0-rc7-00001-ge83a3e282ebea"
dequeue_time: 2020-07-29 05:24:30.185307967 +08:00

#! /lkp/lkp/.src-20200728-224826/include/site/inn
job_state: finished
loadavg: 74.86 58.90 26.69 1/1303 12892
start_time: '1595971528'
end_time: '1595971830'
