...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 506942EBADF
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Jan 2021 08:56:16 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727225AbhAFHxf (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 6 Jan 2021 02:53:35 -0500
Received: from mga04.intel.com ([192.55.52.120]:40048 "EHLO mga04.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727047AbhAFHxc (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 6 Jan 2021 02:53:32 -0500
IronPort-SDR: T2yE6LWZI3k9wuri1hXI8rfzoSltyP/vyPOERM32PU3BA/gq5VeDqHVIUt+G5rRPcTX0YH2xtl
 OhJdXpoy4BXA==
X-IronPort-AV: E=McAfee;i="6000,8403,9855"; a="174669289"
X-IronPort-AV: E=Sophos;i="5.78,479,1599548400"; 
   d="scan'208";a="174669289"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 05 Jan 2021 23:52:53 -0800
IronPort-SDR: Hw2YCakRjhD48+PvBj+HMXaxlCJjW3EzH+cisTE+pLO6psSYh99kSISpkWUSDnDcwiWP0K6sFk
 1xRCw9t5h48g==
X-IronPort-AV: E=Sophos;i="5.78,479,1599548400"; 
   d="scan'208";a="361469320"
Received: from shsi6026.sh.intel.com (HELO localhost) ([10.239.147.88])
  by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 05 Jan 2021 23:52:48 -0800
...
Subject: [PATCH v7 16/18] virt: acrn: Introduce irqfd
Date:   Wed,  6 Jan 2021 15:50:53 +0800
Message-Id: <20210106075055.47226-17-shuo.a.liu@intel.com>
...
+	struct acrn_irqfd irqfd;
 	...
 	u64 cstate_cmd;
 	int i, ret = 0;
@@ -327,6 +328,12 @@ static long acrn_dev_ioctl(struct file *filp, unsigned int cmd,
...
index d6d026f7454a..0309b087829f 100644
--- a/include/uapi/linux/acrn.h
+++ b/include/uapi/linux/acrn.h
@@ -404,6 +404,19 @@ struct acrn_ioeventfd {
 	__u64	data;
 };
...
@@ -460,5 +473,7 @@ struct acrn_ioeventfd {
