...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A366B1FDA99
	for <lists+linux-kernel@lfdr.de>; Thu, 18 Jun 2020 02:50:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726946AbgFRAuY (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 17 Jun 2020 20:50:24 -0400
Received: from mga04.intel.com ([192.55.52.120]:12722 "EHLO mga04.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726890AbgFRAuW (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 17 Jun 2020 20:50:22 -0400
IronPort-SDR: 3zVY2htK9N4BmQ+x7JB2rlhUgDT3Ve6UVG6Ng+7Mefe/N/jX6Max3nWzk7MGol1t1u2ugUKAsb
 bHVoyiguezgA==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 17 Jun 2020 17:48:18 -0700
IronPort-SDR: oRpcl4q6orm3dIs3luzY07/NNabVFqwwyEVsQ6a5hVfS+0NOXf7pPbaSSR3vXfRS545Ah0kvKw
 6I1vLJwtQGZg==
X-IronPort-AV: E=Sophos;i="5.73,524,1583222400"; 
   d="scan'208";a="291601725"
Received: from dwillia2-desk3.jf.intel.com (HELO dwillia2-desk3.amr.corp.intel.com) ([10.54.39.16])
  by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 17 Jun 2020 17:48:17 -0700
Subject: [PATCH v6 1/2] x86,
...
Date:   Wed, 17 Jun 2020 17:32:03 -0700
Message-ID: <159244032378.1107636.15651284864427232258.stgit@dwillia2-desk3.amr.corp.intel.com>
...
index 6a0cc524882d..b64a115085a5 100644
--- a/arch/x86/Kconfig
+++ b/arch/x86/Kconfig
...
index ce9120c4f740..bbce2e3bc7dc 100644
...
index 74f3c506f084..9963e8a29455 100644
...
@@ -978,7 +978,8 @@ static void writecache_resume(struct dm_target *ti)
 	}
 	wc->freelist_size = 0;
...
@@ -994,7 +995,8 @@ static void writecache_resume(struct dm_target *ti)
 			e->seq_count = -1;
 			continue;
 		}
...
+				      sizeof(struct wc_memory_entry));
 		if (r) {
 			writecache_error(wc, r, "hardware memory error when reading metadata entry %lu: %d",
 					 (unsigned long)b, r);
@@ -1192,7 +1194,7 @@ static void bio_copy_block(struct dm_writecache *wc, struct bio *bio, void *data
...
@@ -2329,7 +2331,7 @@ static int writecache_ctr(struct dm_target *ti, unsigned argc, char **argv)
 		}
 	}
...
+	r = copy_mc_to_kernel(&s, sb(wc), sizeof(struct wc_memory_superblock));
 	if (r) {
 		...
 		goto bad;
@@ -2340,7 +2342,8 @@ static int writecache_ctr(struct dm_target *ti, unsigned argc, char **argv)
...
index 7bcadca22100..9f53936d0952 100644
...
index 5fbb90a80d23..f07adee5df9e 100644
--- a/tools/objtool/check.c
+++ b/tools/objtool/check.c
@@ -547,8 +547,8 @@ static const char *uaccess_safe_builtin[] = {
