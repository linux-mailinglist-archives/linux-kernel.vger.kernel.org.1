...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E9F2722C1E7
	for <lists+linux-kernel@lfdr.de>; Fri, 24 Jul 2020 11:17:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728101AbgGXJRh (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 24 Jul 2020 05:17:37 -0400
Received: from szxga06-in.huawei.com ([45.249.212.32]:56064 "EHLO huawei.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1726863AbgGXJRg (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 24 Jul 2020 05:17:36 -0400
Received: from DGGEMS413-HUB.china.huawei.com (unknown [172.30.72.58])
        by Forcepoint Email with ESMTP id 5F91DE060991CF74A933;
...
Subject: [PATCH net-next v4 1/2] hinic: add support to handle hw abnormal event
Date:   Fri, 24 Jul 2020 17:17:31 +0800
Message-ID: <20200724091732.19819-2-luobin9@huawei.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20200724091732.19819-1-luobin9@huawei.com>
...
V0~V1: fix auto build test WARNING
 ...
 10 files changed, 714 insertions(+), 36 deletions(-)
...
index a40a10ac1ee9..c66d2447d021 100644
...
@@ -317,12 +317,302 @@ void hinic_devlink_free(struct devlink *devlink)
...
+
+	if (priv_ctx) {
+		err = fault_report_show(fmsg, priv_ctx);
+		if (err)
+			return err;
+	}
+
