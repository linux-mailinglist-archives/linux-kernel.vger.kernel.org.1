...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BEDEA300137
	for <lists+linux-kernel@lfdr.de>; Fri, 22 Jan 2021 12:12:19 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728155AbhAVLIv (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 22 Jan 2021 06:08:51 -0500
Received: from mga12.intel.com ([192.55.52.136]:6231 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727626AbhAVLD6 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 22 Jan 2021 06:03:58 -0500
IronPort-SDR: GT74Rd1MTx8fRAW3vkkmhVU3o151mruN60WgVxPQZ5yVz6arpWQDxAhsZ+6tLjJs1iV9xMFlwN
 +4uZNwExTCtA==
X-IronPort-AV: E=McAfee;i="6000,8403,9871"; a="158610326"
X-IronPort-AV: E=Sophos;i="5.79,366,1602572400"; 
   d="scan'208";a="158610326"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 22 Jan 2021 03:03:20 -0800
IronPort-SDR: YEG/o7vADJSB0aJQDrwM6p3rJQPgL/vsRY+JQiDs8rsqHMgpS9zRqC8ceNzsDNRAK3FiV24bqB
 2NiZfOWVEIVw==
X-IronPort-AV: E=Sophos;i="5.79,366,1602572400"; 
   d="scan'208";a="400531650"
Received: from shsi6026.sh.intel.com (HELO localhost) ([10.239.147.88])
  by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 22 Jan 2021 03:03:16 -0800
...
Subject: [PATCH v8 16/18] virt: acrn: Introduce irqfd
Date:   Fri, 22 Jan 2021 19:01:20 +0800
Message-Id: <20210122110122.45800-17-shuo.a.liu@intel.com>
...
index 2cb5e5fe1b7a..9513aa7f2ec7 100644
...
+	struct acrn_irqfd irqfd;
 	...
 	u64 cstate_cmd;
 	int i, ret = 0;
@@ -340,6 +341,12 @@ static long acrn_dev_ioctl(struct file *filp, unsigned int cmd,
...
index 23a5b767c3e2..c8270d3355ea 100644
