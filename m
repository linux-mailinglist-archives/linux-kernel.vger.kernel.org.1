...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E8A6F2CC61D
	for <lists+linux-kernel@lfdr.de>; Wed,  2 Dec 2020 20:03:46 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731019AbgLBTDc (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 2 Dec 2020 14:03:32 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57238 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728650AbgLBTDc (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 2 Dec 2020 14:03:32 -0500
Received: from merlin.infradead.org (merlin.infradead.org [IPv6:2001:8b0:10b:1231::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id BFF1AC0613D6;
        Wed,  2 Dec 2020 11:02:51 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        d=infradead.org; s=merlin.20170209; h=Mime-Version:Content-Type:References:
        In-Reply-To:Date:Cc:To:From:Subject:Message-ID:Sender:Reply-To:
        Content-Transfer-Encoding:Content-ID:Content-Description;
        bh=8TJ89M1ucglhALKu+XQjibsi4kOuz6/h2SUuQVXu1zU=; b=TnYyqpddfR9no824IuVJD/Xofy
        ;
Received: from 54-240-197-235.amazon.com ([54.240.197.235] helo=u3832b3a9db3152.ant.amazon.com)
        by merlin.infradead.org with esmtpsa (Exim 4.92.3 #3 (Red Hat Linux))
        id 1kkXOd-00081t-Rl; Wed, 02 Dec 2020 19:02:36 +0000
...
> > > > I might be more inclined to go for a model where the kernel handles=
 the
> > > > evtchn_pending/evtchn_mask for us. What would go into the irq routi=
ng
> > > > table is { vcpu, port# } which get passed to kvm_xen_evtchn_send().
> > >=20
> > > But passing port to the routing and handling the sending of events wo=
uldn't it lead to
> > > unnecessary handling of event channels which aren't handled by the ke=
rnel, compared to
...
> >  =E2=80=A2 HVMIRQ_callback_pci_intx, taking an eventfd (or a pair, for =
EOI?)
> >=20
>=20
...
> I feel we could just accommodate it as subtype in KVM_XEN_ATTR_TYPE_CALLB=
ACK_VIA.
> Don't see the adavantage in having another xen attr type.

Yeah, fair enough.

> But kinda have mixed feelings in having kernel handling all event channel=
s ABI,
> as opposed to only the ones userspace asked to offload. It looks a tad un=
ncessary besides
> the added gain to VMMs that don't need to care about how the internals of=
 event channels.
> But performance-wise it wouldn't bring anything better. But maybe, the fo=
rmer is reason
> enough to consider it.

Yeah, we'll see. Especially when it comes to implementing FIFO event
channels, I'd rather just do it in one place =E2=80=94 and if the kernel do=
es
...
MjAyMTkwMjMzWjAvBgkqhkiG9w0BCQQxIgQgynp/Rk8BOdyXwnNq/nc64v28KxP6FYrdbdyF6/Oo
nWMwgb4GCSsGAQQBgjcQBDGBsDCBrTCBlzELMAkGA1UEBhMCR0IxGzAZBgNVBAgTEkdyZWF0ZXIg
...

