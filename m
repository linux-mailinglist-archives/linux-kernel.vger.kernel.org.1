...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 94FF527B840
	for <lists+linux-kernel@lfdr.de>; Tue, 29 Sep 2020 01:33:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727175AbgI1Xdw (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 28 Sep 2020 19:33:52 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39658 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727068AbgI1Xdm (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 28 Sep 2020 19:33:42 -0400
Received: from mail-pj1-x1042.google.com (mail-pj1-x1042.google.com [IPv6:2607:f8b0:4864:20::1042])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E9D5AC0613E3;
        Mon, 28 Sep 2020 15:16:54 -0700 (PDT)
Received: by mail-pj1-x1042.google.com with SMTP id j19so378745pjl.4;
        Mon, 28 Sep 2020 15:16:54 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=date:from:to:cc:subject:message-id:references:mime-version
         :content-disposition:in-reply-to;
        bh=9TB70Sv50rOoUB9K1Zw3p6T5FKMGF4yzLAOQ6mNF3/8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=9TB70Sv50rOoUB9K1Zw3p6T5FKMGF4yzLAOQ6mNF3/8=;
        b=
X-Gm-Message-State: AOAM530XrDqAsi8RVd8jvhQat7F+3058ctJCAgaz5afyvDlswbmXBB10
        oyqHjWwVB9fJywVzImtgThs=
X-Google-Smtp-Source: ABdhPJz3uRN6mhAJUXnSIAUhj2WF8K4hGkSOVhsqjUkMTF19BG6OaMq2iI5VXHFBQC8MjMKED3PwPg==
X-Received: by 2002:a17:90a:1b62:: with SMTP id q89mr1185373pjq.74.1601331413977;
        Mon, 28 Sep 2020 15:16:53 -0700 (PDT)
Received: from dtor-ws ([2620:15c:202:201:a6ae:11ff:fe11:fcc3])
        by smtp.gmail.com with ESMTPSA id m188sm2763444pfd.56.2020.09.28.15.16.52
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 28 Sep 2020 15:16:53 -0700 (PDT)
Date:   Mon, 28 Sep 2020 15:16:50 -0700
...
Message-ID: <20200928221650.GQ1681290@dtor-ws>
...
On Sun, Sep 27, 2020 at 02:35:41PM +0200, kholk11@gmail.com wrote:
...
Please use shorthand - u16 - in kernel.
...
Sounds like regmap is a good option to be used here.
...
Is the chip even no in bootloader mode? I only see transfers to
NT36XXX_BLDR_ADDR...
...
I think INPUT_MT_TRACK_UNUSED will help here.
...
You are using threaded interrupt, there is no need to involve workqueue
here.
...
What are you protecting here with this mutex?
...
You need to add error handling and some flags here.
...
Please use API from include/linux/input/touchscreen.h to enable basic
transformations.
...
Rely on DT and I2C core to set up device for wakeup.
...
You are using managed input device, no need to unregister explicitly.

> +error:
> +	regulator_bulk_disable(NT36XXX_NUM_SUPPLIES, ts->supplies);

Please install as custom devm action (devm_add_action_or_reset).
...
All of this can be removed I believe.
...
If this is needed it needs to be in input core.
...
You are asserting reset and keep it asserted?
...
Is this all needed if the device is configured for wakeup and power to
the device was not cut?
...
I'd keep all of this in .c file.
