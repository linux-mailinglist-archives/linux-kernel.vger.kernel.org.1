...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8DAD71C19FF
	for <lists+linux-kernel@lfdr.de>; Fri,  1 May 2020 17:47:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729832AbgEAPro (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 1 May 2020 11:47:44 -0400
Received: from mout.gmx.net ([212.227.17.21]:39895 "EHLO mout.gmx.net"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728495AbgEAPrm (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 1 May 2020 11:47:42 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=gmx.net;
        s=badeba3b8450; t=1588348012;
        bh=vZmI0LHrEaxvL+oFExJJzd9yObXFWVTTXbiOCwlyWiw=;
        h=X-UI-Sender-Class:From:To:Cc:Subject:Date;
        b=gQM8Nj7ANoLKmLlhfcmMj5g5VMCh8K892/eVjLQC9sPsiE5xLdVrO0aAYvowHMoNI
         dvHpa5qR8GU0XJ/BkjXiKGYk7L1d100wNhpclcVpXqPfu2y77wH151Q0FW9YZD7l1k
         YWrOSBtRGcj8jHhf2fvzJUzhd3qEtT5/WTZZu/lA=
X-UI-Sender-Class: 01bb95c1-4bf8-414a-932a-4f6e2808ef9c
Received: from strobe-jhalfs ([188.109.202.215]) by mail.gmx.com (mrgmx104
 [212.227.17.168]) with ESMTPSA (Nemesis) id 1MkYXm-1ijydj1k46-00m3yW; Fri, 01
 May 2020 17:46:52 +0200
...
Date:   Fri, 01 May 2020 17:46:48 +0200
Message-ID: <87bln7ves7.fsf@gmx.net>
User-Agent: Gnus/5.13 (Gnus v5.13) Emacs/28.0.50 (gnu/linux)
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="=-=-="
X-Provags-ID: V03:K1:dH0umaE5K1tTIdSBdKRowU8YrgX47cdkspPZ2TYEh2SO9ads5BA
 /ZMwyIYcvJDzhHqdv34UgRqUdp6+GFJPApFQZHMYSC53fLGdmpsDpsuf8Z3uwWjQFWGH7Bp
 3v4fOv+qIp1XMbBFKqPxQedK0niI8YevsCoApb6Lz8dueCH3VPdV9fQ8zNMxiy+ZDxEGntA
 /L9TJteI2G2Y+5uB7OlRQ==
X-Spam-Flag: NO
X-UI-Out-Filterresults: notjunk:1;V03:K0:VOZV3OlYcrU=:BzSycO/ugJshP+Gt70sB0w
 
...
# bad: [a2d635decbfa9c1e4ae15cb05b68b2559f7f827c] Merge tag 'drm-next-2019-=
05-09' of git://anongit.freedesktop.org/drm/drm
git bisect bad a2d635decbfa9c1e4ae15cb05b68b2559f7f827c
# bad: [82efe439599439a5e1e225ce5740e6cfb777a7dd] Merge tag 'devicetree-for=
-5.2' of git://git.kernel.org/pub/scm/linux/kernel/git/robh/linux
git bisect bad 82efe439599439a5e1e225ce5740e6cfb777a7dd
# bad: [78438ce18f26dbcaa8993bb45d20ffb0cec3bc3e] Merge branch 'stable-fodd=
er' of git://git.kernel.org/pub/scm/linux/kernel/git/viro/vfs
git bisect bad 78438ce18f26dbcaa8993bb45d20ffb0cec3bc3e
# bad: [275b103a26e218b3d739e5ab15be6b40303a1428] Merge tag 'edac_for_5.2' =
of git://git.kernel.org/pub/scm/linux/kernel/git/bp/bp
git bisect bad 275b103a26e218b3d739e5ab15be6b40303a1428
# bad: [0bc40e549aeea2de20fc571749de9bbfc099fb34] Merge branch 'x86-mm-for-=
linus' of git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip
git bisect bad 0bc40e549aeea2de20fc571749de9bbfc099fb34
# good: [007dc78fea62610bf06829e38f1d8c69b6ea5af6] Merge branch 'locking-co=
...
# bad: [a0e928ed7c603a47dca8643e58db224a799ff2c5] Merge branch 'timers-core=
-for-linus' of git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip
git bisect bad a0e928ed7c603a47dca8643e58db224a799ff2c5
# good: [f447e4eb3ad1e60d173ca997fcb2ef2a66f12574] perf/x86/intel: Force re=
sched when TFA sysctl is modified
git bisect good f447e4eb3ad1e60d173ca997fcb2ef2a66f12574
# bad: [08ae95f4fd3b38b257f5dc7e6507e071c27ba0d5] nohz_full: Allow the boot=
 CPU to be nohz_full
git bisect bad 08ae95f4fd3b38b257f5dc7e6507e071c27ba0d5
# bad: [bee9853932e90ce94bce4276ec6b7b06bc48070b] sched/core: Fix typo in c=
omment
...
1st test: power off 45 seconds after the message "Bringing down the loopback
 interface" (the last thing done in LFS by `shutdown' before it runs `halt =
-d
...
5th test: waited more than 3 minutes after loopback message, no power
 off, pressed restart button (bad).=20
6th test: power off within 4 seconds after loopback message (good).=20
...
--=-=-=
Content-Type: application/text/plain
Content-Disposition: attachment; filename=config-5.1.0
Content-Transfer-Encoding: quoted-printable
