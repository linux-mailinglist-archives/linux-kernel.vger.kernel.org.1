...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A09F22CBB65
	for <lists+linux-kernel@lfdr.de>; Wed,  2 Dec 2020 12:19:58 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729592AbgLBLST (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 2 Dec 2020 06:18:19 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41240 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727209AbgLBLST (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 2 Dec 2020 06:18:19 -0500
Received: from merlin.infradead.org (merlin.infradead.org [IPv6:2001:8b0:10b:1231::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id ACE0DC0613CF;
        Wed,  2 Dec 2020 03:17:38 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        d=infradead.org; s=merlin.20170209; h=Mime-Version:Content-Type:References:
        In-Reply-To:Date:Cc:To:From:Subject:Message-ID:Sender:Reply-To:
        Content-Transfer-Encoding:Content-ID:Content-Description;
        bh=2ZCLWFfPU6syhG/ZaDob6GGoX9B+ffNM17NOreUe/+E=; b=THYgDQNziaezvInEEGNsIgb6gg
        ;
Received: from 54-240-197-235.amazon.com ([54.240.197.235] helo=u3832b3a9db3152.ant.amazon.com)
        by merlin.infradead.org with esmtpsa (Exim 4.92.3 #3 (Red Hat Linux))
        id 1kkQ8d-0003Yt-7k; Wed, 02 Dec 2020 11:17:35 +0000
Message-ID: <71753a370cd6f9dd147427634284073b78679fa6.camel@infradead.org>
...
In-Reply-To: <20190220201609.28290-11-joao.m.martins@oracle.com>
References: <20190220201609.28290-1-joao.m.martins@oracle.com>
         <20190220201609.28290-11-joao.m.martins@oracle.com>
Content-Type: multipart/signed; micalg="sha-256";
        protocol="application/x-pkcs7-signature";
        boundary="=-pVlUDTxbpk4Ut313iSVZ"
...
--=-pVlUDTxbpk4Ut313iSVZ
Content-Type: text/plain; charset="UTF-8"
Content-Transfer-Encoding: quoted-printable

On Wed, 2019-02-20 at 20:15 +0000, Joao Martins wrote:
> @@ -176,6 +177,9 @@ int kvm_arch_set_irq_inatomic(struct kvm_kernel_irq_r=
outing_entry *e,
>         int r;
> =20
>         switch (e->type) {
...
>                 break;
> +       case KVM_IRQ_ROUTING_XEN_EVTCHN:
> +               e->set =3D kvm_xen_set_evtchn;
> +               e->evtchn.vcpu =3D ue->u.evtchn.vcpu;
> +               e->evtchn.vector =3D ue->u.evtchn.vector;
> +               e->evtchn.via =3D ue->u.evtchn.via;
> +
...
MjAyMTExNzMyWjAvBgkqhkiG9w0BCQQxIgQgnxeuMLBOFUmKDcSbsh6oDhw+OKZ0MAbkUHr1R5/f
ZoYwgb4GCSsGAQQBgjcQBDGBsDCBrTCBlzELMAkGA1UEBhMCR0IxGzAZBgNVBAgTEkdyZWF0ZXIg
...

