...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 34D452234E3
	for <lists+linux-kernel@lfdr.de>; Fri, 17 Jul 2020 08:45:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727001AbgGQGpu (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 17 Jul 2020 02:45:50 -0400
Received: from mga06.intel.com ([134.134.136.31]:59679 "EHLO mga06.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726141AbgGQGpt (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 17 Jul 2020 02:45:49 -0400
IronPort-SDR: ga5XnB5oNlClIGhmM71kEemlqa+3oyO0yXV1kdc8aiFScWRssiATHPIe7vlUqHSxI1ybNa3OZR
 7nxUvhfBziWw==
X-IronPort-AV: E=McAfee;i="6000,8403,9684"; a="211084955"
X-IronPort-AV: E=Sophos;i="5.75,362,1589266800"; 
   d="scan'208";a="211084955"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 16 Jul 2020 23:45:46 -0700
IronPort-SDR: P6RLWCq2zeNlizYHNii+bcBf/Uh6C3FSfJ2pwp1xq2R4TuSPHtHgQeyn0pnelEV0CjB7zF3fKB
 aTyzJ5MjJgpw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,362,1589266800"; 
   d="scan'208";a="269461480"
Received: from linux.intel.com ([10.54.29.200])
  by fmsmga007.fm.intel.com with ESMTP; 16 Jul 2020 23:45:46 -0700
Received: from [10.249.224.34] (abudanko-mobl.ccr.corp.intel.com [10.249.224.34])
        by linux.intel.com (Postfix) with ESMTP id 0A3DA58066D;
        Thu, 16 Jul 2020 23:45:43 -0700 (PDT)
From:   Alexey Budankov <alexey.budankov@linux.intel.com>
Subject: [PATCH v12 00/15] perf: support enable and disable commands in stat
 and record modes
...
Message-ID: <8d91c3a0-3db4-0a7a-ae13-299adb444bd6@linux.intel.com>
Date:   Fri, 17 Jul 2020 09:45:42 +0300
...
- fixed fdarray sanity test (36) failure - due to usage of uninitialized memory
  after realloc() of priv data; added explicit memset(0) for newly allocated part
- captured and mentioned acquired Acked-by tags

v11: https://lore.kernel.org/lkml/037d737f-0ada-a9f0-9686-f7521ca6fbc3@linux.intel.com/
...
Alexey Budankov (15):
 ...
 14 files changed, 500 insertions(+), 86 deletions(-)
