...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 4172E1A9A2D
	for <lists+linux-kernel@lfdr.de>; Wed, 15 Apr 2020 12:13:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2896325AbgDOKL7 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 15 Apr 2020 06:11:59 -0400
Received: from mga14.intel.com ([192.55.52.115]:60792 "EHLO mga14.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2896287AbgDOKLf (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 15 Apr 2020 06:11:35 -0400
IronPort-SDR: cO4y6ZrE6Nrg6T5oQW8TZyHv1E1pxMVT6EGM0kH+9QD8TwFKwqtw0FF8G6wMUyMliqcVshQL2J
 X1DPRBnb334w==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 15 Apr 2020 03:11:35 -0700
IronPort-SDR: FY75YnhgVCXRo4VEtHv/khBaR9wBzJPqrPO16i5WrNhk8KE9HZcADGNE2DKAZKJCI8OicpfQvs
 O+x+t/Fd515w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.72,386,1580803200"; 
   d="scan'208";a="253483278"
Received: from yilunxu-optiplex-7050.sh.intel.com ([10.239.159.141])
  by orsmga003.jf.intel.com with ESMTP; 15 Apr 2020 03:11:30 -0700
...
Subject: [PATCH v4 6/7] fpga: dfl: afu: add AFU interrupt support
Date:   Wed, 15 Apr 2020 18:07:34 +0800
Message-Id: <1586945255-30823-7-git-send-email-yilun.xu@intel.com>
...
index 357cd5d..4bbeb3a 100644
--- a/drivers/fpga/dfl-afu-main.c
+++ b/drivers/fpga/dfl-afu-main.c
@@ -529,6 +529,34 @@ static const struct dfl_feature_ops port_stp_ops = {
 	.init = port_stp_init,
 };
...
@@ -547,6 +575,10 @@ static struct dfl_feature_driver port_feature_drvs[] = {
 		.ops = &port_stp_ops,
 	},
 	{
