...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 90BC52D2959
	for <lists+linux-kernel@lfdr.de>; Tue,  8 Dec 2020 11:59:45 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729117AbgLHK6B (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 8 Dec 2020 05:58:01 -0500
Received: from mail.kernel.org ([198.145.29.99]:51446 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728980AbgLHK6A (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 8 Dec 2020 05:58:00 -0500
...
Subject: Re: Linux 4.19.162
Date:   Tue,  8 Dec 2020 11:58:11 +0100
Message-Id: <1607425090149153@kroah.com>
X-Mailer: git-send-email 2.29.2
In-Reply-To: <1607425090235144@kroah.com>
References: <1607425090235144@kroah.com>
MIME-Version: 1.0
...
index 84807cee57b8..71e55c5cd74a 100644
--- a/Makefile
+++ b/Makefile
@@ -1,7 +1,7 @@
...
index 35116cdb5e38..35d6bd1b3099 100644
...
index 2294fb06bef3..7ea9dcfd7c49 100644
...
index 9adc72d65c63..ee3ff0894d09 100644
...
index a59333b87eaf..c21c4291921f 100644
...
-	new_slave->dev = slave_dev;
 	 ...
 	 */
@@ -1821,7 +1846,7 @@ int bond_enslave(struct net_device *bond_dev, struct net_device *slave_dev,
...
index 36dee305c687..9ec0498d7d54 100644
...
index 2938ac440fb3..d762eb491a7c 100644
...
@@ -2156,6 +2158,12 @@ static int ibmvnic_poll(struct napi_struct *napi, int budget)
...
@@ -2778,13 +2786,18 @@ static int ibmvnic_complete_tx(struct ibmvnic_adapter *adapter,
...
index f84e2c2d02c0..3ad46d1f58f6 100644
...
index 3200c75b9ed2..985601a65def 100644
...
index bc4eda52372a..dd0c9604d3c9 100644
...
index 04bee450eb3d..e4e43519710d 100644
...
index 2e2afc824a6a..69660102182b 100644
...
index d84a09172ddb..fe0e02e11f29 100644
--- a/drivers/net/tun.c
+++ b/drivers/net/tun.c
...
index 568918fae8d4..ade6c3070c62 100644
...
index be4bc833c28a..b5d9c9b2c702 100644
--- a/net/core/skbuff.c
+++ b/net/core/skbuff.c
...
index 48081e6d50b4..2fe50f6f876d 100644
--- a/net/ipv4/route.c
+++ b/net/ipv4/route.c
...
index 32c3162baf3e..00a7482b6fbd 100644
...
index 7cc9cd83ecb5..86c8ea7d7006 100644
...
index ad3e515f91f0..d59f2341bfec 100644
...
index b3db0b0a52f5..f43d037ea852 100644
--- a/net/x25/af_x25.c
+++ b/net/x25/af_x25.c
