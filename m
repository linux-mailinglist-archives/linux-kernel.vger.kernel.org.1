...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 28F7D205486
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Jun 2020 16:25:54 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1733009AbgFWOZP (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 23 Jun 2020 10:25:15 -0400
Received: from szxga06-in.huawei.com ([45.249.212.32]:55706 "EHLO huawei.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1732827AbgFWOZK (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 23 Jun 2020 10:25:10 -0400
Received: from DGGEMS412-HUB.china.huawei.com (unknown [172.30.72.60])
        by Forcepoint Email with ESMTP id 621CAEE0D3694C403642;
        Tue, 23 Jun 2020 22:25:02 +0800 (CST)
Received: from localhost.localdomain (10.175.118.36) by
 DGGEMS412-HUB.china.huawei.com (10.3.19.212) with Microsoft SMTP Server id
 14.3.487.0; Tue, 23 Jun 2020 22:24:55 +0800
From:   Luo bin <luobin9@huawei.com>
To:     <davem@davemloft.net>
CC:     <linux-kernel@vger.kernel.org>, <netdev@vger.kernel.org>,
        <luoxianjun@huawei.com>, <yin.yinshi@huawei.com>,
        <cloud.wangxiaoyun@huawei.com>
Subject: [PATCH net-next v2 2/5] hinic: add support to set and get irq coalesce
Date:   Tue, 23 Jun 2020 22:24:06 +0800
Message-ID: <20200623142409.19081-3-luobin9@huawei.com>
...
index e69edb01fd9b..31baabc10ee2 100644
...
+
  ...
  * @pdev: the NIC pci device
@@ -1138,6 +1184,12 @@ static int nic_dev_init(struct pci_dev *pdev)
...
@@ -1147,6 +1199,8 @@ static int nic_dev_init(struct pci_dev *pdev)
 	return 0;
...
@@ -1260,6 +1314,8 @@ static void hinic_remove(struct pci_dev *pdev)
