...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E941B2A9E69
	for <lists+linux-kernel@lfdr.de>; Fri,  6 Nov 2020 21:05:31 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728398AbgKFUFW (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 6 Nov 2020 15:05:22 -0500
Received: from us-smtp-delivery-124.mimecast.com ([216.205.24.124]:27665 "EHLO
        us-smtp-delivery-124.mimecast.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1728413AbgKFUFQ (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 6 Nov 2020 15:05:16 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1604693110;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=XNXA/CeQS7zyJo2u4lKUSyDZW3GAa/bFqKiyxW4Ayu8=;
        b=hqfba4SepikL4W2GMfogXiMmWcTeTv7jzPp429f20FWkVcCGu4atKMU6XifH0q0hDx+Yhd
        gVkHfS449ahnFH1MbYacg57gpOV2Nn2oisDVWvq/aUaLhqg6a0X/8gb5dRy2mbB471RU5l
        pX2htZ3hRH1KZNhn2mEZVwsWVLSOuEc=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-433-fwN__yRINzO_zKIkvdxLNg-1; Fri, 06 Nov 2020 15:05:05 -0500
X-MC-Unique: fwN__yRINzO_zKIkvdxLNg-1
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.phx2.redhat.com [10.5.11.13])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 48D80803652;
        Fri,  6 Nov 2020 20:05:03 +0000 (UTC)
Received: from f33vm.wilsonet.com.wilsonet.com (dhcp-17-185.bos.redhat.com [10.18.17.185])
        by smtp.corp.redhat.com (Postfix) with ESMTP id AE1AB7366D;
...
Subject: [PATCH 5/5] bonding: update Documentation for port/bond terminology
Date:   Fri,  6 Nov 2020 15:04:36 -0500
Message-Id: <20201106200436.943795-6-jarod@redhat.com>
...
@@ -53,10 +62,11 @@ who to ask for help, please follow the links at the end of this file.
...
@@ -747,11 +760,11 @@ peer_notif_delay
...
+	Selects the transmit hash policy to use for port selection in
 	...
 	layer2
@@ -860,10 +873,10 @@ xmit_hash_policy
...
@@ -879,13 +892,13 @@ xmit_hash_policy
...
@@ -1004,15 +1017,18 @@ Determining this is fairly straightforward.
...
+This is the package that provides your network initialization scripts.
 ...
 issue the command::
@@ -1020,7 +1036,14 @@ issue the command::
...
+Note: classic ifenslave binaries are considered deprecated.
 ...
 ----------------------------------------
@@ -1034,9 +1057,9 @@ front end does not provide any means to work with bonding devices.
...
@@ -1047,8 +1070,8 @@ Where the "xx" portion will be replaced with the digits from
...
@@ -1111,7 +1134,7 @@ The possible values are:
 	======== ======================================================
...
@@ -1119,9 +1142,9 @@ for the bonding mode, link monitoring, and so on here.  Do not include
...
@@ -1129,7 +1152,7 @@ a device early in the sequence has failed.  The device specifiers
...
@@ -1162,7 +1185,7 @@ Under sysconfig, configuring a device with BOOTPROTO='dhcp'
...
@@ -1237,6 +1260,14 @@ place the following text::
...
@@ -1416,8 +1447,85 @@ RHEL 4 as well.  On kernels exhibiting this problem, it will be impossible
...
@@ -1444,7 +1552,7 @@ To add a new bond foo::
...
@@ -1456,30 +1564,30 @@ To show all existing bonds::
...
@@ -1536,7 +1644,7 @@ To configure the interval between learning packet transmits::
 .. note::
...
@@ -1570,7 +1678,7 @@ your init script::
...
@@ -1589,7 +1697,7 @@ Example Configurations
 ----------------------
...
@@ -1623,7 +1731,7 @@ For a full list of ``bond-*`` supported options in /etc/network/interfaces and
...
@@ -1645,7 +1753,7 @@ tx_queues can be used to change this value.  There is no sysfs parameter
...
+ID is now printed for each slave port::
 	...
 	Primary Slave: None
@@ -1667,18 +1775,20 @@ ID is now printed for each slave::
...
@@ -1695,16 +1805,16 @@ selection policy to be overridden, selecting instead qid 2, which maps to eth1.
...
@@ -1759,7 +1869,8 @@ few bonding parameters:
...
@@ -1788,14 +1899,14 @@ bonding configuration, state, and version of the bonding driver.
 -------------------------
...
@@ -1868,29 +1979,29 @@ For reasons of simplicity, and to support the use of adapters
...
@@ -1907,7 +2018,7 @@ mode, which might not be what you want.
 ==================
...
@@ -1927,8 +2038,8 @@ The ARP monitor relies on the device driver itself to verify
...
@@ -2013,9 +2124,9 @@ as an unsolicited ARP reply (because ARP matches replies on an
...
@@ -2037,12 +2148,12 @@ For example, given a modules.conf containing the following::
 	alias eth2 e1000
 	alias eth3 e1000
...
@@ -2099,7 +2210,7 @@ before any network drivers participating in a bond.  This requirement
...
@@ -2146,25 +2257,25 @@ When running network monitoring tools, e.g., tcpdump, it is
...
@@ -2594,9 +2705,9 @@ It is not uncommon to observe a short burst of duplicated
...
+For example, on a bond in active-backup mode with five ports
 all connected to one switch, the output may appear as follows::
 	...
 	# ping -n 10.0.4.2
@@ -2618,7 +2729,7 @@ traffic to all ports until its MAC forwarding table is updated.  Since
...
@@ -2752,22 +2863,22 @@ Any Ethernet type cards (you can even mix cards - a Intel
...
@@ -2819,14 +2930,14 @@ The active-backup mode should work with any Layer-II switch.
...
@@ -2837,19 +2948,23 @@ ifconfig or ip link::
