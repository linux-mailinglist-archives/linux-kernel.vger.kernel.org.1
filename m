...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 090791E9F93
	for <lists+linux-kernel@lfdr.de>; Mon,  1 Jun 2020 09:54:20 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728399AbgFAHyM (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 1 Jun 2020 03:54:12 -0400
Received: from mga09.intel.com ([134.134.136.24]:24509 "EHLO mga09.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726072AbgFAHyL (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 1 Jun 2020 03:54:11 -0400
IronPort-SDR: u8JRMOfPwR/dNZZ4N0LXTm9wFfHD6bYcgHox9mnfBooUK2HWChOIAWeI4LAmkuojlK2LP6ajPC
 vq6OIGKk6iOA==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 01 Jun 2020 00:53:59 -0700
IronPort-SDR: bWcTG6/CVtcXTJt54v4LPb+8wnJ25F5Wp8z3yPVdUADx1Dz8jRIUl0tzhMezssH/7Feq6Pubyk
 bPV2iKUPa//A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,460,1583222400"; 
   d="scan'208";a="311879712"
Received: from yhanin-mobl1.ger.corp.intel.com (HELO localhost) ([10.249.43.17])
  by FMSMGA003.fm.intel.com with ESMTP; 01 Jun 2020 00:53:52 -0700
...
Subject: [PATCH v32 13/21] x86/sgx: Add a page reclaimer
Date:   Mon,  1 Jun 2020 10:52:10 +0300
Message-Id: <20200601075218.65618-14-jarkko.sakkinen@linux.intel.com>
...
---
 ...
 arch/x86/kernel/cpu/sgx/main.c   | 465 +++++++++++++++++++++++++++++++
...
index 5085724595eb..325b918ab8d2 100644
...
index 506cb0756147..4dfa1bbf15b7 100644
...
@@ -94,6 +497,8 @@ static struct sgx_epc_page *__sgx_alloc_epc_page_from_section(struct sgx_epc_sec
...
@@ -126,6 +531,57 @@ struct sgx_epc_page *__sgx_alloc_epc_page(void)
 	return ERR_PTR(-ENOMEM);
 }
...
+
  ...
  * @page:	an EPC page
@@ -137,12 +593,20 @@ void sgx_free_epc_page(struct sgx_epc_page *page)
...
@@ -193,6 +657,7 @@ static bool __init sgx_setup_epc_section(u64 addr, u64 size,
...
index aae6bfb3bc8a..f2fb7e362226 100644
