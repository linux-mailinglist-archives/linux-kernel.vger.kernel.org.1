...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id F39CA2EF355
	for <lists+linux-kernel@lfdr.de>; Fri,  8 Jan 2021 14:45:30 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727239AbhAHNoj (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 8 Jan 2021 08:44:39 -0500
Received: from mail-lf1-f46.google.com ([209.85.167.46]:40993 "EHLO
        mail-lf1-f46.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726952AbhAHNoi (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 8 Jan 2021 08:44:38 -0500
Received: by mail-lf1-f46.google.com with SMTP id s26so22959669lfc.8
        for <linux-kernel@vger.kernel.org>; Fri, 08 Jan 2021 05:44:19 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:date:from:to:cc:subject:message-id:references
         :mime-version:content-disposition:in-reply-to;
        bh=rH9A/HEb8qg42Bpyf3z26WKcnm+w66Wzl441ZUuDg7Y=;
        b=
X-Gm-Message-State: AOAM532u8IOMG93qhsHQ8P7LD7ak7L4MJlqunQM3JNbFlXo3rRXhfG09
        BpNIZOVGOvK/qI0EBifXWXM=
X-Google-Smtp-Source: ABdhPJy0jWtGZGBaxT+BzgjXdh+PYkL2JSCvVm9ekC7Kkv9QD4a4G+uSzFl5I2Ze45K5r5kggXXiqg==
X-Received: by 2002:a19:705:: with SMTP id 5mr1574364lfh.478.1610113433927;
        Fri, 08 Jan 2021 05:43:53 -0800 (PST)
Received: from localhost.localdomain (62-78-225-252.bb.dnainternet.fi. [62.78.225.252])
        by smtp.gmail.com with ESMTPSA id v23sm2164493ljg.97.2021.01.08.05.43.52
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 08 Jan 2021 05:43:53 -0800 (PST)
Date:   Fri, 8 Jan 2021 15:43:46 +0200
...
Subject: [PATCH 12/15] regulator: Support ROHM BD71815 regulators
Message-ID: <8eb1ea2fb52e97cdacab6b5944bb43c34e1449c1.1610110144.git.matti.vaittinen@fi.rohmeurope.com>
...
index 020a00d6696b..b2426f30f9fd 100644
--- a/drivers/regulator/Kconfig
+++ b/drivers/regulator/Kconfig
@@ -196,6 +196,17 @@ config REGULATOR_BD70528
...
index 6ebae516258e..6223c73a8000 100644
--- a/drivers/regulator/Makefile
+++ b/drivers/regulator/Makefile
@@ -29,6 +29,7 @@ obj-$(CONFIG_REGULATOR_AS3722) += as3722-regulator.o
...
index 000000000000..56d3292361d2
--- /dev/null
...
+
+#define BD71815_STANDBY_OFFSET		0
+#define BD71815_DVS_BUCK_NUM		2
+#define BD71815_DVS_HIGH_LOW		2
+
...
+		 * controls. NOTE: This means that if voltage is changed
...
+	 * voltage is set to BD71815_VOLT_MASK. Changing SUSPEND/LPSR voltages at
+	 * runtime is not supported by this driver.
+	 */
...
+};
+
+int bd7181x_probe(struct platform_device *pdev)
+{
...
+	ret = regmap_update_bits(pmic->regmap, BD71815_REG_PWRCTRL, RESTARTEN, 0);
+	if (ret)
+		return ret;
+
