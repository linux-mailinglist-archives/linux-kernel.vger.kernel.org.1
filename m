...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BE321252BDA
	for <lists+linux-kernel@lfdr.de>; Wed, 26 Aug 2020 12:57:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728806AbgHZK5Q (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 26 Aug 2020 06:57:16 -0400
Received: from mail.kernel.org ([198.145.29.99]:42696 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728713AbgHZK4K (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 26 Aug 2020 06:56:10 -0400
Received: from localhost (83-86-89-107.cable.dynamic.v4.ziggo.nl [83.86.89.107])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id A52102080C;
        Wed, 26 Aug 2020 10:56:04 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1598439365;
        bh=L3FVKQqEE5cA0bp7K1HvcQwCtbMNNigBpIg3FvNSXto=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=zVxzhI2ujkx7tQAhw9EhVCYchrbMRjCBgxnY4r8WKGjWPxzftsn/Y0/3A8QV60PvT
         DBr5F8R3MPTQguNUDcer415dpzJQQQr3Ox50URp+ACDsBRk97FWk/HCq5DBtTM4yjy
         kWYGHljzsZjQMDjsi7eMkbsJFoeWVSxPs0sivepU=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 4.19.142
Date:   Wed, 26 Aug 2020 12:56:11 +0200
Message-Id: <15984393718198@kroah.com>
X-Mailer: git-send-email 2.28.0
In-Reply-To: <159843937111637@kroah.com>
References: <159843937111637@kroah.com>
MIME-Version: 1.0
...
index 5b2440e591fc..430a4bc66f60 100644
...
index 11429df74306..d32e32e79174 100644
...
index 1656ef0e959f..bdfe159a60da 100644
--- a/fs/btrfs/inode.c
+++ b/fs/btrfs/inode.c
@@ -628,7 +628,21 @@ static noinline void compress_file_range(struct inode *inode,
 						     PAGE_SET_WRITEBACK |
 						     page_error_op |
 						     PAGE_END_WRITEBACK);
-			goto free_pages_out;
...
@@ -706,13 +720,6 @@ static noinline void compress_file_range(struct inode *inode,
 	*num_added += 1;
...
index ed539496089f..4d2810a32b4a 100644
--- a/fs/btrfs/super.c
+++ b/fs/btrfs/super.c
...
index 58f48ea0db23..f988ccd064a2 100644
--- a/fs/eventpoll.c
+++ b/fs/eventpoll.c
...
index a8f2e3549bb9..186a2dd05bd8 100644
--- a/fs/ext4/namei.c
+++ b/fs/ext4/namei.c
...
index 483c4573695a..f37be43f8cae 100644
--- a/mm/khugepaged.c
+++ b/mm/khugepaged.c
...
index 7181dfe76440..5717ee66c8b3 100644
--- a/mm/page_alloc.c
+++ b/mm/page_alloc.c
...
index 8f004db6f603..1ee33d2e15bf 100644
...
index a5bc10d30618..41d6285c3da9 100644
