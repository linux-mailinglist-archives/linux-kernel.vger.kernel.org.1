...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id F0C942F0080
	for <lists+linux-kernel@lfdr.de>; Sat,  9 Jan 2021 15:37:29 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725952AbhAIOff (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 9 Jan 2021 09:35:35 -0500
Received: from smtp05.smtpout.orange.fr ([80.12.242.127]:57704 "EHLO
        smtp.smtpout.orange.fr" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725882AbhAIOff (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 9 Jan 2021 09:35:35 -0500
Received: from localhost.localdomain ([153.202.107.157])
        by mwinf5d52 with ME
        id EeZ4240053PnFJp03eZCnm; Sat, 09 Jan 2021 15:33:20 +0100
X-ME-Helo: localhost.localdomain
X-ME-Auth: bWFpbGhvbC52aW5jZW50QHdhbmFkb28uZnI=
X-ME-Date: Sat, 09 Jan 2021 15:33:20 +0100
...
Subject: [PATCH v9] can: usb: etas_es58X: add support for ETAS ES58X CAN USB interfaces
Date:   Sat,  9 Jan 2021 23:32:11 +0900
Message-Id: <20210109143239.3069-1-mailhol.vincent@wanadoo.fr>
...
---
 ...
 drivers/net/can/usb/etas_es58x/es58x_core.c | 2634 +++++++++++++++++++
...
new file mode 100644
index 000000000000..5dc3a0ee8669
--- /dev/null
...
+ *
+ * Remarks: a.) The payload of CAN FD frames with BRS flag are sent at
...
+	struct es58x_priv *priv = es58x_priv(netdev);
+	struct es58x_device *es58x_dev = priv->es58x_dev;
+	unsigned int packet_idx, tx_msg_threshold, can_frame_bytes;
+	u16 skb_idx;
...
+	can_frame_bytes = es58x_can_frame_bytes(skb);
...
+	priv->tx_can_msg_cnt++;
+
+	send_doorbell = __netdev_sent_queue(netdev, can_frame_bytes,
+					    netdev_xmit_more());
