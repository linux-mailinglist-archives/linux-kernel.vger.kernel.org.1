...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 75C2A279AEB
	for <lists+linux-kernel@lfdr.de>; Sat, 26 Sep 2020 18:29:48 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730121AbgIZQ3U (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 26 Sep 2020 12:29:20 -0400
Received: from mail.kernel.org ([198.145.29.99]:33660 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1730096AbgIZQ3N (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 26 Sep 2020 12:29:13 -0400
Received: from localhost (83-86-74-64.cable.dynamic.v4.ziggo.nl [83.86.74.64])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id C0A52221E5;
        Sat, 26 Sep 2020 16:29:09 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1601137750;
        bh=KgD27VIG/V2U/m5vJMPIvTnfPIRb0ZVKAfj9/KGooPs=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=S0h/AHeRG8T140RPSDxH4a1B/c/bBxTgXOcm5ZW467vB++0EqpltCXselff1YJs9n
         fau8xo0QbmMKSmHLdPS6NYhtYqlV1Bxlb6r6SLyGqDvNQLg1JJ9+WeH4YG23HpCacV
         C0y3KBpYrcHi19zQPN6BadhsWEu5DDm/c0OsaGDY=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 5.8.12
Date:   Sat, 26 Sep 2020 18:29:17 +0200
Message-Id: <16011377565117@kroah.com>
X-Mailer: git-send-email 2.28.0
In-Reply-To: <160113775678120@kroah.com>
References: <160113775678120@kroah.com>
MIME-Version: 1.0
...
index 0b025b3a5640..d0d40c628dc3 100644
--- a/Makefile
+++ b/Makefile
@@ -1,7 +1,7 @@
...
index cd5c7a1412c6..dd07db656a5c 100644
...
@@ -11854,7 +11863,8 @@ static void bnxt_vpd_read_info(struct bnxt *bp)
 	if (len + pos > vpd_size)
 		goto exit;
...
@@ -2543,6 +2550,8 @@ static int bnxt_set_eee(struct net_device *dev, struct ethtool_eee *edata)
 	if (netif_running(dev))
...
index 842db20493df..76b23ba7a468 100644
...
index 3b892ec301b4..cccf65fc116e 100644
...
@@ -605,8 +605,8 @@ static int mlx5e_alloc_rq(struct mlx5e_channel *c,
 	}
...
@@ -616,10 +616,16 @@ static int mlx5e_alloc_rq(struct mlx5e_channel *c,
...
index 98369430a3be..067910d242ab 100644
...
index a69e79327c29..d13ea1642b97 100644
--- a/net/core/filter.c
+++ b/net/core/filter.c
