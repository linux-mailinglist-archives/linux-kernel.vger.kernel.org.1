...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8FFE72F3A3D
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Jan 2021 20:29:38 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2393072AbhALTZT (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 12 Jan 2021 14:25:19 -0500
Received: from foss.arm.com ([217.140.110.172]:52060 "EHLO foss.arm.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2436615AbhALTWj (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 12 Jan 2021 14:22:39 -0500
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id A6E911476;
        Tue, 12 Jan 2021 11:21:22 -0800 (PST)
Received: from e120937-lin.home (unknown [172.31.20.19])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id ADDED3F66E;
...
Subject: [PATCH v5 11/36] firmware: arm_scmi: port Perf protocol to new protocols interface
Date:   Tue, 12 Jan 2021 19:19:53 +0000
Message-Id: <20210112192018.34994-12-cristian.marussi@arm.com>
...
index 4f1fc2789d7c..99f66cfa68d4 100644
...
+
 struct scmi_perf_ops {
 	int (*limits_set)(const struct scmi_handle *handle, u32 domain,
 			  u32 max_perf, u32 min_perf);
@@ -612,8 +637,6 @@ struct scmi_notify_ops {
...
@@ -644,7 +667,6 @@ struct scmi_handle {
