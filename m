...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 960F72E042D
	for <lists+linux-kernel@lfdr.de>; Tue, 22 Dec 2020 03:00:35 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726197AbgLVB7W (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 21 Dec 2020 20:59:22 -0500
Received: from mailout1.samsung.com ([203.254.224.24]:25164 "EHLO
        mailout1.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725785AbgLVB7W (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 21 Dec 2020 20:59:22 -0500
Received: from epcas2p1.samsung.com (unknown [182.195.41.53])
        by mailout1.samsung.com (KnoxPortal) with ESMTP id 20201222015832epoutp011d24fc8f425f8876aa84a68fa4a265b7~S50e9dL_g0061400614epoutp017
        for <linux-kernel@vger.kernel.org>; Tue, 22 Dec 2020 01:58:32 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout1.samsung.com 20201222015832epoutp011d24fc8f425f8876aa84a68fa4a265b7~S50e9dL_g0061400614epoutp017
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=samsung.com;
        s=mail20170921; t=1608602312;
        bh=wdZzuNPTHCAoYeooqyVlWH5JfS2J4/ISWXyTu7xbk1M=;
        h=Subject:Reply-To:From:To:CC:In-Reply-To:Date:References:From;
        b=aQ3Fgluk8KXnsXB2V4YuQUg1xPk9mgl42McpVmLo71RtYAGlY1pOJ2yI6lUFIPg5f
         0vFMXpdkJHxe+6MQjrzlQHtpWHi3x9rwF5VY0EtABRY42g1SanwGwt7ClPqGFnMSSo
         +/2xgKrFVSNFn2og2LMDUwGVDAmwDchky0A+KbyM=
Received: from epsnrtp1.localdomain (unknown [182.195.42.162]) by
        epcas2p2.samsung.com (KnoxPortal) with ESMTP id
        20201222015830epcas2p21616e3fe50557b7feda048f14ca28612~S50dvZ-zQ0447204472epcas2p2l;
        Tue, 22 Dec 2020 01:58:30 +0000 (GMT)
Received: from epsmges2p4.samsung.com (unknown [182.195.40.191]) by
        epsnrtp1.localdomain (Postfix) with ESMTP id 4D0KHm4vfLz4x9Pp; Tue, 22 Dec
        2020 01:58:28 +0000 (GMT)
X-AuditID: b6c32a48-4f9ff7000000cd1f-89-5fe152c4653b
Received: from epcas2p2.samsung.com ( [182.195.41.54]) by
        epsmges2p4.samsung.com (Symantec Messaging Gateway) with SMTP id
        43.3B.52511.4C251EF5; Tue, 22 Dec 2020 10:58:28 +0900 (KST)
Mime-Version: 1.0
Subject: [PATCH v18 2/3] scsi: ufs: L2P map management for HPB read
...
X-Msg-Type: PERSONAL
X-Reply-Demand: N
Message-ID: <20201222015828epcms2p5afcd414c373360044dccc95f89129bc9@epcms2p5>
Date:   Tue, 22 Dec 2020 10:58:28 +0900
X-CMS-MailID: 20201222015828epcms2p5afcd414c373360044dccc95f89129bc9
...
X-CPGSPASS: Y
CMS-TYPE: 102P
X-Brightmail-Tracker: H4sIAAAAAAAAA+NgFnrAJsWRmVeSWpSXmKPExsWy7bCmme6RoIfxBis2K1tsvPuK1eLBvG1s
        ...
        
DLP-Filter: Pass
...
References: <20201222015704epcms2p643f0c5011064a7ce56b08331811a8509@epcms2p6>
        <CGME20201222015704epcms2p643f0c5011064a7ce56b08331811a8509@epcms2p5>
Precedence: bulk
...
index 8fcaa6cb1937..0ec0ed237140 100644
...
@@ -9135,6 +9138,7 @@ EXPORT_SYMBOL(ufshcd_shutdown);
...
index badb613ac281..37ae61fbf36a 100644
...
@@ -229,11 +1030,47 @@ static int ufshpb_lu_hpb_init(struct ufs_hba *hba, struct ufshpb_lu *hpb)
 {
 	int ret;
...
@@ -264,6 +1101,33 @@ static struct ufshpb_lu *ufshpb_alloc_hpb_lu(struct ufs_hba *hba, int lun,
 	return NULL;
 }
...
+
 ...
 {
 	int err = 0;
@@ -307,7 +1171,7 @@ void ufshpb_reset(struct ufs_hba *hba)
...
@@ -324,13 +1188,15 @@ void ufshpb_reset_host(struct ufs_hba *hba)
 	struct scsi_device *sdev;
...
@@ -340,13 +1206,14 @@ void ufshpb_suspend(struct ufs_hba *hba)
 	struct scsi_device *sdev;
...
@@ -356,7 +1223,7 @@ void ufshpb_resume(struct ufs_hba *hba)
 	struct scsi_device *sdev;
...
@@ -364,6 +1231,7 @@ void ufshpb_resume(struct ufs_hba *hba)
...
@@ -416,7 +1284,7 @@ static int ufshpb_get_lu_info(struct ufs_hba *hba, int lun,
...
+	struct ufshpb_lu *hpb = ufshpb_get_hpb_data(sdev);
 	...
 	if (!hpb)
 		return;
@@ -426,8 +1294,13 @@ void ufshpb_destroy_lu(struct ufs_hba *hba, struct scsi_device *sdev)
...
+
 	...
 	kfree(hpb);
@@ -435,24 +1308,41 @@ void ufshpb_destroy_lu(struct ufs_hba *hba, struct scsi_device *sdev)
...
@@ -474,6 +1364,9 @@ void ufshpb_init_hpb_lu(struct ufs_hba *hba, struct scsi_device *sdev)
 	if (!hpb)
 		goto out;
...
@@ -483,6 +1376,57 @@ void ufshpb_init_hpb_lu(struct ufs_hba *hba, struct scsi_device *sdev)
...
@@ -548,7 +1492,13 @@ void ufshpb_init(struct ufs_hba *hba)
...
@@ -557,3 +1507,16 @@ void ufshpb_init(struct ufs_hba *hba)
 			break;
 	}
 }
+
