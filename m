...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 89C392A9E6A
	for <lists+linux-kernel@lfdr.de>; Fri,  6 Nov 2020 21:05:32 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728441AbgKFUF2 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 6 Nov 2020 15:05:28 -0500
Received: from us-smtp-delivery-124.mimecast.com ([63.128.21.124]:38423 "EHLO
        us-smtp-delivery-124.mimecast.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1728372AbgKFUFJ (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 6 Nov 2020 15:05:09 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1604693101;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=Hut9t+L21hWuI1cUfugt0bdHrX2fSnCj3LjDZ9+oX70=;
        b=DAu9xVQ0jnwj/tX7I2WycOqymGpfxPlkYnDskJcS8AF4XN6nD4XNh1eY+1qbX4QoB0u1TT
        jIwc8qfpaFVCL9vRG3FIey8Elj5C8q8eKbeiHm+PxaGKmMavTiNquuH5iUMvvfQ+mEo61q
        RzKU/DFXfF4EihdKnu7bRbMNzuyDYxM=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-192-U-th9JKzPKCMkXiJSqFBNQ-1; Fri, 06 Nov 2020 15:04:57 -0500
X-MC-Unique: U-th9JKzPKCMkXiJSqFBNQ-1
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.phx2.redhat.com [10.5.11.13])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 88A47809DC2;
        Fri,  6 Nov 2020 20:04:55 +0000 (UTC)
Received: from f33vm.wilsonet.com.wilsonet.com (dhcp-17-185.bos.redhat.com [10.18.17.185])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 7E4E76EF71;
...
Subject: [PATCH 1/5] bonding: rename 802.3ad's struct port to ad_port
Date:   Fri,  6 Nov 2020 15:04:32 -0500
Message-Id: <20201106200436.943795-2-jarod@redhat.com>
...
index 71c9677d135f..d79643f6b01e 100644
...
@@ -4338,7 +4338,7 @@ int bond_update_slave_arr(struct bonding *bond, struct slave *skipslave)
 		if (BOND_MODE(bond) == BOND_MODE_8023AD) {
 			struct aggregator *agg;
