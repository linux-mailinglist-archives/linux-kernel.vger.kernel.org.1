...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7CA08286C05
	for <lists+linux-kernel@lfdr.de>; Thu,  8 Oct 2020 02:17:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728008AbgJHARM (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 7 Oct 2020 20:17:12 -0400
Received: from mga01.intel.com ([192.55.52.88]:22305 "EHLO mga01.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727652AbgJHAQ6 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 7 Oct 2020 20:16:58 -0400
IronPort-SDR: GMADB0CpGWE7CL9E29FxFMGcM5RdA14Q0mYjScUOVlFtyV+1AFpX50nCxHhWHX/010iT+bEW6t
 VCrP6K9zgC9A==
X-IronPort-AV: E=McAfee;i="6000,8403,9767"; a="182629365"
X-IronPort-AV: E=Sophos;i="5.77,348,1596524400"; 
   d="scan'208";a="182629365"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 07 Oct 2020 17:16:54 -0700
IronPort-SDR: NrS0N71jbZnDHwvyHhMTP7hO9xtg7JhnBQHhcYBVmmjZ+GXOxV2kK19rozIXNDo8IAJAZ7f6ti
 vtRSm26btX7w==
X-IronPort-AV: E=Sophos;i="5.77,348,1596524400"; 
   d="scan'208";a="355169295"
...
Subject: [PATCH v4 6/7] fpga: sec-mgr: enable cancel of secure update
Date:   Wed,  7 Oct 2020 17:16:40 -0700
Message-Id: <20201008001641.28305-7-russell.h.weight@intel.com>
...
index da5b4c8fe2bb..40a526ff8fa4 100644
--- a/drivers/fpga/fpga-sec-mgr.c
+++ b/drivers/fpga/fpga-sec-mgr.c
@@ -159,6 +159,23 @@ static void fpga_sec_dev_error(struct fpga_sec_mgr *smgr,
...
+
 ...
 {
 	mutex_lock(&smgr->lock);
@@ -190,16 +207,20 @@ static void fpga_sec_mgr_update(struct work_struct *work)
...
@@ -212,7 +233,9 @@ static void fpga_sec_mgr_update(struct work_struct *work)
 		offset += blk_size;
 	}
...
@@ -658,6 +706,9 @@ void fpga_sec_mgr_unregister(struct fpga_sec_mgr *smgr)
 		goto unregister;
 	}
...
index 6e46f18ad990..168ce9c26a08 100644
