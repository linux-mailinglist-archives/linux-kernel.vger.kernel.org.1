...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 65FB51D730E
	for <lists+linux-kernel@lfdr.de>; Mon, 18 May 2020 10:37:10 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726442AbgERIhF (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 18 May 2020 04:37:05 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59034 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726040AbgERIhF (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 18 May 2020 04:37:05 -0400
Received: from michel.telenet-ops.be (michel.telenet-ops.be [IPv6:2a02:1800:110:4::f00:18])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8FEE2C061A0C
        for <linux-kernel@vger.kernel.org>; Mon, 18 May 2020 01:37:04 -0700 (PDT)
Received: from ramsan ([IPv6:2a02:1810:ac12:ed60:6c27:925d:6b9c:58b2])
        by michel.telenet-ops.be with bizsmtp
        id g8d32200911gx4G068d3rt; Mon, 18 May 2020 10:37:03 +0200
Received: from rox.of.borg ([192.168.97.57])
        by ramsan with esmtp (Exim 4.90_1)
        (envelope-from <geert@linux-m68k.org>)
        id 1jabGh-0004ZD-1s
        for linux-kernel@vger.kernel.org; Mon, 18 May 2020 10:37:03 +0200
...
Subject: Build regressions/improvements in v5.7-rc6
Date:   Mon, 18 May 2020 10:37:02 +0200
Message-Id: <20200518083702.26851-1-geert@linux-m68k.org>
...
v5.7-rc6[1] compared to v5.6[2].

Summarized:
  - build errors: +0/-8
  - build warnings: +51/-253

JFYI, when comparing v5.7-rc6[1] to v5.7-rc5[3], the summaries are:
  - build errors: +0/-2
  - build warnings: +14/-193
...
[1] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/b9bbe6ed63b2b9f2c9ee5cbd0f2c946a2723f4ce/ (194 out of 239 configs)
[2] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/7111951b8d4973bda27ff663f2cf18b663d15b48/ (all 239 configs)
[3] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/2ef96a5bb12be62ef75b5828c0aab838ebb29cb8/ (all 239 configs)
...
8 error improvements:
  ...
  - error: arch/sparc/kernel/signal_32.o: relocation truncated to fit: R_SPARC_WDISP22 against `.text': (.fixup+0x4), (.fixup+0x28), (.fixup+0x10), (.fixup+0x1c), (.fixup+0x34) => 
...
253 warning improvements:
  - .config: warning: override: reassigning to symbol MIPS_CPS_NS16550_SHIFT: 11983, 11986, 11981, 11987 => 12169, 12168, 12164
  ...
  - /kisskb/src/drivers/hwmon/drivetemp.c: warning: 'temp_raw' may be used uninitialized in this function [-Wuninitialized]: 250:20, 250:9 => 
  ...
  - /kisskb/src/drivers/i2c/busses/i2c-mlxcpld.c: warning: 'val' may be used uninitialized in this function [-Wuninitialized]: 513:11, 271:6, 337:25 => 
  ...
  - /kisskb/src/drivers/iio/adc/ad7606_par.c: warning: unused variable 'st' [-Wunused-variable]: 21:23, 36:23 => 
  ...
  - /kisskb/src/drivers/net/ethernet/smsc/smc91x.c: warning: passing argument 1 of 'inw' makes integer from pointer without a cast [enabled by default]: 406:18, 391:2, 1217:2, 792:3, 1278:4, 462:4, 671:12, 1902:2, 1671:2, 1858:2, 852:2, 1925:2, 744:2, 1337:2, 1638:2, 718:17, 1218:9, 1876:2, 1225:12, 484:3, 685:3, 1804:16, 1281:4, 1669:2, 673:4, 1334:9, 1227:3, 723:2, 766:2, 614:2, 1335:2, 788:2, 1268:4, 326:2, 310:2, 1166:2, 416:2, 711:14, 1242:4, 1643:2, 1338:2, 1258:4, 1889:2, 748:2, 1664:2, 1333:11, 563:14, 825:2, 1272:4, 434:3, 1190:2 => 
  ...
  - /kisskb/src/drivers/net/ethernet/smsc/smc91x.c: warning: passing argument 2 of 'outw' makes integer from pointer without a cast [enabled by default]:
    385:2, 390:2, 749:2, 352:2, 1193:2, 1449:3, 1278:4, 1016:3, 1288:2, 1446:2, 343:2, 1165:2, 377:2, 1017:3, 1665:2, 1662:2, 482:3, 586:2, 1674:2, 789:2, 1875:2, 353:2, 249:2, 306:2, 1673:2, 1336:2, 1632:2, 1066:2, 830:2, 292:2, 345:2, 1448:3, 685:3, 1281:4, 1259:4, 250:2, 673:4, 386:2, 267:2, 754:2, 752:2, 324:2, 384:2, 1067:2, 932:2, 1635:2, 719:2, 342:2, 1646:2, 797:3, 321:2, 857:2, 1242:4, 1645:2, 573:2, 607:2, 931:2, 592:2, 843:2, 722:2, 825:2, 1272:4, 391:2, 1219:2, 1659:2, 413:2, 930:2, 266:2, 1817:2, 274:2, 1924:2, 346:2, 1191:2, 1287:2, 753:2, 1789:2, 775:3, 813:2, 1637:2, 852:2, 1339:2, 1189:2, 325:2, 574:2, 341:2, 1639:2, 463:4, 1660:2, 1888:2, 1167:2, 305:2, 307:2, 309:2, 1451:2, 1227:3, 614:2, 435:3, 745:2, 1445:2, 1790:2, 1268:4, 1663:2, 1124:2, 663:2, 1192:2, 1796:2, 1257:4, 485:3, 795:3, 376:2, 1901:2, [truncated] => 
  ...
  - /kisskb/src/drivers/net/phy/mdio-cavium.c: warning: cast to pointer from integer of different size [-Wint-to-pointer-cast]: 24:2, 21:16, 131:2, 39:2, 54:16, 138:16, 86:2, 93:16, 47:2, 125:2 => 
  ...
  - /kisskb/src/drivers/net/tun.c: warning: 'linear' may be used uninitialized in this function [-Wuninitialized]: 1526:34, 1749:46 => 
  ...
  - /kisskb/src/drivers/usb/gadget/udc/fsl_qe_udc.c: warning: cast to pointer from integer of different size [-Wint-to-pointer-cast]: 837:5, 965:5, 1491:27, 837:28, 1491:4, 965:28 => 1491:27, 837:28, 965:28
  ...
  - /kisskb/src/fs/nfs/read.c: warning: value computed is not used [-Wunused-value]: 353:2, 196:5 => 
