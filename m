...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7A4272B2FD4
	for <lists+linux-kernel@lfdr.de>; Sat, 14 Nov 2020 19:52:15 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726215AbgKNSug (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 14 Nov 2020 13:50:36 -0500
Received: from smtprelay0194.hostedemail.com ([216.40.44.194]:47036 "EHLO
        smtprelay.hostedemail.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1726172AbgKNSue (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 14 Nov 2020 13:50:34 -0500
Received: from filter.hostedemail.com (clb03-v110.bra.tucows.net [216.40.38.60])
        by smtprelay06.hostedemail.com (Postfix) with ESMTP id 70F9A18224D7B;
...
X-HE-Tag: boys84_1803dcf27319
X-Filterd-Recvd-Size: 15339
Received: from joe-laptop.perches.com (unknown [47.151.133.149])
        (Authenticated sender: joe@perches.com)
        by omf14.hostedemail.com (Postfix) with ESMTPA;
        Sat, 14 Nov 2020 18:50:32 +0000 (UTC)
From:   Joe Perches <joe@perches.com>
To:     Andrew Morton <akpm@linux-foundation.org>,
        Mike Kravetz <mike.kravetz@oracle.com>
Cc:     linux-mm@kvack.org, linux-kernel@vger.kernel.org
Subject: [PATCH V2 1/5] mm: Use sysfs_emit for struct kobject * uses
Date:   Sat, 14 Nov 2020 10:50:22 -0800
Message-Id: <9c249215bad6df616ba0410ad980042694970c1b.1605376435.git.joe@perches.com>
...
index b4630ccfd3c8..2d0540964d0e 100644
--- a/mm/huge_memory.c
+++ b/mm/huge_memory.c
...
index 16ef3d2346d5..6b28101059ac 100644
--- a/mm/hugetlb.c
+++ b/mm/hugetlb.c
@@ -2758,7 +2758,7 @@ static ssize_t nr_hugepages_show_common(struct kobject *kobj,
 	else
...
@@ -2831,7 +2831,8 @@ HSTATE_ATTR(nr_hugepages);
...
@@ -2849,7 +2850,7 @@ static ssize_t nr_overcommit_hugepages_show(struct kobject *kobj,
 					struct kobj_attribute *attr, char *buf)
 {
...
@@ -2887,7 +2888,7 @@ static ssize_t free_hugepages_show(struct kobject *kobj,
 	else
...
@@ -2895,7 +2896,7 @@ static ssize_t resv_hugepages_show(struct kobject *kobj,
 					struct kobj_attribute *attr, char *buf)
 {
 	struct hstate *h = kobj_to_hstate(kobj, NULL);
-	return sprintf(buf, "%lu\n", h->resv_huge_pages);
...
@@ -2912,7 +2913,7 @@ static ssize_t surplus_hugepages_show(struct kobject *kobj,
 	else
