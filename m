...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C80F21FD1BE
	for <lists+linux-kernel@lfdr.de>; Wed, 17 Jun 2020 18:15:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726987AbgFQQOA (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 17 Jun 2020 12:14:00 -0400
Received: from mail.kernel.org ([198.145.29.99]:50296 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726597AbgFQQN7 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 17 Jun 2020 12:13:59 -0400
Received: from localhost (83-86-89-107.cable.dynamic.v4.ziggo.nl [83.86.89.107])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id DFD7921527;
        Wed, 17 Jun 2020 16:13:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1592410430;
        bh=wmTXs8SPWyUrkKavhYcS2kKW0ji/JRlqs6E1noG/mwY=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=fNDOgcOvSqfr1F4w4OPtdP5tpJEM6rD2HhS4hgdWiQMULF5UlWGpNk9Ht4UQHTTdW
         HUpY/XAU6Tyy/ocS/IDh1aqYr2Bac5a0GkeP8Hs1GrRVxLJfoEzKlrmFRAtykWvWXi
         1OcKDrBgb/OeNMpeIv2Ev36vls19mfnQfbquTXQQ=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 5.6.19
Date:   Wed, 17 Jun 2020 18:13:33 +0200
Message-Id: <159241041212625@kroah.com>
X-Mailer: git-send-email 2.27.0
In-Reply-To: <1592410412126243@kroah.com>
References: <1592410412126243@kroah.com>
MIME-Version: 1.0
...
@@ -1314,10 +1314,12 @@ static void vmx_vcpu_pi_load(struct kvm_vcpu *vcpu, int cpu)
 		pi_set_on(pi_desc);
 }
...
@@ -6908,7 +6908,7 @@ int x86_emulate_instruction(struct kvm_vcpu *vcpu, gpa_t cr2_or_gpa,
...
@@ -358,7 +358,7 @@ static int ena_xdp_xmit_buff(struct net_device *dev,
...
--- a/mm/huge_memory.c
+++ b/mm/huge_memory.c
@@ -1465,13 +1465,12 @@ vm_fault_t do_huge_pmd_wp_page(struct vm_fault *vmf, pmd_t orig_pmd)
 }
