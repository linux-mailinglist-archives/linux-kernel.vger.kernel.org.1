...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 814E82467AE
	for <lists+linux-kernel@lfdr.de>; Mon, 17 Aug 2020 15:48:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728661AbgHQNss (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 17 Aug 2020 09:48:48 -0400
Received: from mail.kernel.org ([198.145.29.99]:52218 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728443AbgHQNsq (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 17 Aug 2020 09:48:46 -0400
Received: from mail-lj1-f171.google.com (mail-lj1-f171.google.com [209.85.208.171])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 341722075B;
        Mon, 17 Aug 2020 13:48:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1597672124;
        bh=9Auy9X5tOP0G+Xmg/GApxO4SI02UgTj5KCuVCr4/29I=;
        h=References:In-Reply-To:From:Date:Subject:To:Cc:From;
        b=D3Rae4K0MXXQUgg6NUhTt9TWOO06dZi1eijhCbzzoIs3BS9mr0NZssPcmbIuuOeB5
         ahPeeOsrLr/ZO03LLE3sMIhSDm+2HJM25++SqCGM1coedN5XOBAMr5lUpzJoXDop+G
         JxFQ3Ecu9+8RZN4sW4j8DvI1zEArXd2V2SB7qVds=
Received: by mail-lj1-f171.google.com with SMTP id f26so17527559ljc.8;
        Mon, 17 Aug 2020 06:48:44 -0700 (PDT)
X-Gm-Message-State: AOAM5325+NVsW5kOx49subAXikecWO2rQIM0o2tOcvo7iE0C9OgNU74c
        1k3D6OVfqabMcClhKjyHn0tDRlgL2jIUoeADUhY=
X-Google-Smtp-Source: ABdhPJx31+5cX1oxU1KN7osJxcy1pYfNLpEMpllP7zTM3rB03o+hQqoU7p+yaKyKCAqtlTgSKkkaMl2UG3qRl1mOfV8=
X-Received: by 2002:a2e:9bc1:: with SMTP id w1mr6689474ljj.79.1597672122390;
 Mon, 17 Aug 2020 06:48:42 -0700 (PDT)
MIME-Version: 1.0
References: <1594683562-68149-5-git-send-email-guoren@kernel.org> <mhng-7b97b519-96e4-4a4c-bba8-3d14e0eda33c@palmerdabbelt-glaptop1>
In-Reply-To: <mhng-7b97b519-96e4-4a4c-bba8-3d14e0eda33c@palmerdabbelt-glaptop1>
From:   Guo Ren <guoren@kernel.org>
Date:   Mon, 17 Aug 2020 21:48:30 +0800
X-Gmail-Original-Message-ID: <CAJF2gTSv6ciRqTYi0yFsgFR4CuzkgZRqLWGQbsr2ABESrvNV7g@mail.gmail.com>
Message-ID: <CAJF2gTSv6ciRqTYi0yFsgFR4CuzkgZRqLWGQbsr2ABESrvNV7g@mail.gmail.com>
...
On Sat, Aug 15, 2020 at 6:36 AM Palmer Dabbelt <palmerdabbelt@google.com> w=
rote:
>
...
> > +}
>
> IIRC I mentioned this in the original version, but I'd anticipate that we=
 need
> to at least prevent LR/SC sequences from being probed.
        /*
         * Instructions which load PC relative literals are not going to wo=
rk
         * when executed from an XOL slot. Instructions doing an exclusive
         * load/store are not going to complete successfully when single-st=
ep
