...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7C4262C21DB
	for <lists+linux-kernel@lfdr.de>; Tue, 24 Nov 2020 10:40:22 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731407AbgKXJkL (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 24 Nov 2020 04:40:11 -0500
Received: from mxout70.expurgate.net ([91.198.224.70]:30434 "EHLO
        mxout70.expurgate.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1731367AbgKXJkI (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 24 Nov 2020 04:40:08 -0500
Received: from [127.0.0.1] (helo=localhost)
        by relay.expurgate.net with smtp (Exim 4.92)
        (envelope-from <ms@dev.tdt.de>)
        id 1khUns-000677-0F; Tue, 24 Nov 2020 10:40:04 +0100
Received: from [195.243.126.94] (helo=securemail.tdt.de)
        by relay.expurgate.net with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <ms@dev.tdt.de>)
        id 1khUnr-000QLs-AV; Tue, 24 Nov 2020 10:40:03 +0100
Received: from securemail.tdt.de (localhost [127.0.0.1])
        by securemail.tdt.de (Postfix) with ESMTP id 8C3CD240041;
        Tue, 24 Nov 2020 10:40:02 +0100 (CET)
Received: from mail.dev.tdt.de (unknown [10.2.4.42])
        by securemail.tdt.de (Postfix) with ESMTP id 0C93A240040;
        Tue, 24 Nov 2020 10:40:02 +0100 (CET)
Received: from mschiller01.dev.tdt.de (unknown [10.2.3.20])
        by mail.dev.tdt.de (Postfix) with ESMTPSA id 7FF8520115;
        Tue, 24 Nov 2020 10:39:56 +0100 (CET)
...
Date:   Tue, 24 Nov 2020 10:39:35 +0100
Message-ID: <20201124093938.22012-3-ms@dev.tdt.de>
...
X-purgate: clean
X-purgate-ID: 151534::1606210803-00001F6B-47459BC8/0/0
