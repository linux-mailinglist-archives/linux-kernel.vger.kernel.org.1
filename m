...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6223A225404
	for <lists+linux-kernel@lfdr.de>; Sun, 19 Jul 2020 22:16:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727814AbgGSUQa (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 19 Jul 2020 16:16:30 -0400
Received: from mx0a-0016f401.pphosted.com ([67.231.148.174]:15098 "EHLO
        mx0b-0016f401.pphosted.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1727779AbgGSUQ1 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 19 Jul 2020 16:16:27 -0400
Received: from pps.filterd (m0045849.ppops.net [127.0.0.1])
        by mx0a-0016f401.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id 06JKFv4f012760;
        Sun, 19 Jul 2020 13:16:23 -0700
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=marvell.com; h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-transfer-encoding : content-type; s=pfpt0818;
 bh=Zxi74M6dqPumX2ss3va02MmRucaDmW73d1Q5u8/7ro8=;
 b= wA== 
Received: from sc-exch03.marvell.com ([199.233.58.183])
        by mx0a-0016f401.pphosted.com with ESMTP id 32bxenbyv9-1
...
Received: from maili.marvell.com (10.69.176.80) by DC5-EXCH01.marvell.com
 ...
 Transport; Sun, 19 Jul 2020 13:16:22 -0700
Received: from NN-LT0049.marvell.com (NN-LT0049.marvell.com [10.193.54.6])
        by maili.marvell.com (Postfix) with ESMTP id DEA693F7040;
        Sun, 19 Jul 2020 13:16:17 -0700 (PDT)
...
Subject: [PATCH v2 net-next 14/14] qed/qede: add support for the extended speed and FEC modes
Date:   Sun, 19 Jul 2020 23:14:53 +0300
Message-ID: <20200719201453.3648-15-alobakin@marvell.com>
...
---
 ...
 drivers/net/ethernet/qlogic/qed/qed_main.c    | 267 +++++++++++++++++-
...
index 28f13cd7bd9b..87b997f2c6b7 100644
...
@@ -1556,6 +1638,148 @@ static bool qed_can_link_change(struct qed_dev *cdev)
 	return true;
 }
...
@@ -1609,6 +1833,9 @@ static int qed_set_link(struct qed_dev *cdev, struct qed_link_params *params)
 	if (params->override_flags & QED_LINK_OVERRIDE_SPEED_FORCED_SPEED)
...
@@ -1686,7 +1913,6 @@ static int qed_get_port_type(u32 media_type)
...
@@ -1695,6 +1921,7 @@ static int qed_get_port_type(u32 media_type)
 	case MEDIA_BASE_T:
 		port_type = PORT_TP;
 		break;
+	case MEDIA_KR:
 	case MEDIA_NOT_PRESENT:
 		port_type = PORT_NONE;
 		break;
@@ -1986,9 +2213,34 @@ static void qed_fill_link(struct qed_hwfn *hwfn,
 	if (link.link_up)
...
@@ -1996,13 +2248,6 @@ static void qed_fill_link(struct qed_hwfn *hwfn,
