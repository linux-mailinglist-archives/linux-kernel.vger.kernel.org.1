...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9CC1922EC0D
	for <lists+linux-kernel@lfdr.de>; Mon, 27 Jul 2020 14:24:11 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728495AbgG0MYC (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 27 Jul 2020 08:24:02 -0400
Received: from mail-eopbgr80110.outbound.protection.outlook.com ([40.107.8.110]:17030
        "EHLO EUR04-VI1-obe.outbound.protection.outlook.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1728419AbgG0MYA (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 27 Jul 2020 08:24:00 -0400
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=EZpU6q4t4+k91m9MY88ors8vuuzyVM5tvdc6vWXkQR4=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=plvision.eu;
 ...
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=EZpU6q4t4+k91m9MY88ors8vuuzyVM5tvdc6vWXkQR4=;
 b=TxB7Qge9LV0kV5UQPliiTQsXXLl2LzcFbd6Xdk2zmc/qREJz+yVJ9/S2WBRl9TBmSFIQReiH00KxwNGhsYTgrfNkUGEE8G/1LtfjsA6ZNQJ2gxiUcjqbB4LcvgFZJpJINr6I0J8PP/ZCeyK1nm07xy8nQqHmfLjrA9Br3b82f7g=
...
Received: from DB6P190MB0534.EURP190.PROD.OUTLOOK.COM (2603:10a6:6:33::15) by
 ...
 15.20.3216.24; Mon, 27 Jul 2020 12:23:17 +0000
...
Subject: [net-next v4 5/6] net: marvell: prestera: Add Switchdev driver implementation
Date:   Mon, 27 Jul 2020 15:22:41 +0300
Message-Id: <20200727122242.32337-6-vadym.kochan@plvision.eu>
...
Received: from pc60716vkochan.x.ow.s (217.20.186.93) by AM5PR0602CA0010.eurprd06.prod.outlook.com (2603:10a6:203:a3::20) with Microsoft SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.3216.20 via Frontend Transport; Mon, 27 Jul 2020 12:23:15 +0000
X-Mailer: git-send-email 2.17.1
X-Originating-IP: [217.20.186.93]
X-MS-PublicTrafficType: Email
X-MS-Office365-Filtering-Correlation-Id: 6633a504-e09f-48d4-004a-08d83227d722
X-MS-TrafficTypeDiagnostic: DB6P190MB0151:
X-MS-Exchange-Transport-Forked: True
X-Microsoft-Antispam-PRVS: <DB6P190MB015132104EC19D9CDF273F8E95720@DB6P190MB0151.EURP190.PROD.OUTLOOK.COM>
X-MS-Oob-TLC-OOBClassifiers: OLM:3276;
X-MS-Exchange-SenderADCheck: 1
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:DB6P190MB0534.EURP190.PROD.OUTLOOK.COM;PTR:;CAT:NONE;SFTY:;SFS:(39830400003)(396003)(136003)(376002)(346002)(366004)(6506007)(508600001)(83380400001)(956004)(30864003)(52116002)(316002)(66946007)(8936002)(36756003)(26005)(2616005)(8676002)(66476007)(66556008)(186003)(44832011)(54906003)(6486002)(110136005)(16526019)(6512007)(86362001)(1076003)(107886003)(4326008)(6666004)(5660300002)(2906002)(921003)(559001)(579004);DIR:OUT;SFP:1102;
X-MS-Exchange-AntiSpam-MessageData: 
X-OriginatorOrg: plvision.eu
X-MS-Exchange-CrossTenant-Network-Message-Id: 6633a504-e09f-48d4-004a-08d83227d722
X-MS-Exchange-CrossTenant-AuthSource: DB6P190MB0534.EURP190.PROD.OUTLOOK.COM
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 27 Jul 2020 12:23:16.9746
 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 03707b74-30f3-46b6-a0e0-ff0a7438c9c4
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: LGDslm6YnNkRxe8jgsDsbfB0nbm89gokNt4cN3hUJdeo9KchR927sGV3RX/K/Utjzlw70hUYhOOdrQvu9qoBFHgmok/3qxDkClZkmQ0K9ck=
...
index c54435b0f786..cc7ddbace454 100644
...
@@ -308,10 +386,25 @@ static int prestera_fw_parse_port_evt(u8 *msg, struct prestera_event *evt)
 	return 0;
 }
...
@@ -450,6 +543,17 @@ void prestera_hw_switch_fini(struct prestera_switch *sw)
...
+
 int prestera_hw_port_state_set(const struct prestera_port *port,
 			       bool admin_state)
 {
@@ -490,6 +594,20 @@ int prestera_hw_port_mac_set(const struct prestera_port *port, char *mac)
 			    &req.cmd, sizeof(req));
 }
...
+
 int prestera_hw_port_cap_get(const struct prestera_port *port,
 			     struct prestera_port_caps *caps)
 {
@@ -840,6 +958,210 @@ int prestera_hw_port_stats_get(const struct prestera_port *port,
 	return 0;
 }
...
index bcb04848894b..e1d7bf515eba 100644
...
@@ -83,6 +103,7 @@ struct prestera_rxtx_params;
 /* Switch API */
...
+int prestera_hw_switch_ageing_set(struct prestera_switch *sw, u32 ageing);
 ...
 /* Port API */
@@ -115,6 +136,33 @@ int prestera_hw_port_mdix_get(const struct prestera_port *port, u8 *status,
 			      u8 *admin_mode);
...
index ee872518f4d9..9aafb5aeaa07 100644
...
+
 ...
 {
@@ -36,8 +60,7 @@ struct prestera_port *prestera_port_find_by_hwid(struct prestera_switch *sw,
 	return NULL;
 }
...
@@ -235,6 +258,8 @@ static int prestera_port_create(struct prestera_switch *sw, u32 id)
...
+	port->pvid = PRESTERA_DEFAULT_VID;
 	...
 	port->id = id;
 	port->sw = sw;
@@ -428,6 +453,72 @@ static int prestera_switch_set_base_mac_addr(struct prestera_switch *sw)
...
+
 ...
 {
 	int err;
@@ -444,10 +535,18 @@ static int prestera_switch_init(struct prestera_switch *sw)
 	if (err)
 		return err;
...
@@ -468,6 +567,10 @@ static int prestera_switch_init(struct prestera_switch *sw)
...
+	prestera_netdev_event_handler_unregister(sw);
 	...
 	return err;
@@ -479,6 +582,8 @@ static void prestera_switch_fini(struct prestera_switch *sw)
