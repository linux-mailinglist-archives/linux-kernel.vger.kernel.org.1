...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5CA881CDA4B
	for <lists+linux-kernel@lfdr.de>; Mon, 11 May 2020 14:42:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729886AbgEKMmK (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 11 May 2020 08:42:10 -0400
Received: from smtp-fw-2101.amazon.com ([72.21.196.25]:35218 "EHLO
        smtp-fw-2101.amazon.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728367AbgEKMmK (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 11 May 2020 08:42:10 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  d=amazon.com; i=@amazon.com; q=dns/txt; s=amazon201209;
  t=1589200926; x=1620736926;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version;
  bh=h4PQ/Gelf/iQuLrS5dNRZg0BlmE47UNNgzE29Bpj2xo=;
  b=MWp1GNpvDI7ZTnnjYSVBbeS3LQv20iUM3JynINrJOd45gtK+R0H/eHfL
   vx1xWDv91rqDtS8xcWNbNa14emvaCsbQN2Wglywt6TGn7CIVJvltGDpE7
   CKMJ9kx88BArzdXOSwrXXgVNvbwQdhhyRNeAfgNf+yBYx3ZlqHLybVPeb
   k=;
IronPort-SDR: 1tmkUuC3XlxQQct05PXGoUemmt7R4Hf9YxL/tnJmBwm2gWd+ahUTWrJr3dOs1mHNmE0VACNWbq
 bsg78vpBMEjQ==
X-IronPort-AV: E=Sophos;i="5.73,379,1583193600"; 
   d="scan'208";a="29804010"
Received: from iad12-co-svc-p1-lb1-vlan2.amazon.com (HELO email-inbound-relay-1d-474bcd9f.us-east-1.amazon.com) ([10.43.8.2])
  by smtp-border-fw-out-2101.iad2.amazon.com with ESMTP; 11 May 2020 12:42:05 +0000
Received: from EX13MTAUEA002.ant.amazon.com (iad55-ws-svc-p15-lb9-vlan2.iad.amazon.com [10.40.159.162])
        by email-inbound-relay-1d-474bcd9f.us-east-1.amazon.com (Postfix) with ESMTPS id B615CA1BD1;
        Mon, 11 May 2020 12:41:53 +0000 (UTC)
Received: from EX13D31EUA001.ant.amazon.com (10.43.165.15) by
 EX13MTAUEA002.ant.amazon.com (10.43.61.77) with Microsoft SMTP Server (TLS)
 id 15.0.1497.2; Mon, 11 May 2020 12:41:52 +0000
Received: from u886c93fd17d25d.ant.amazon.com (10.43.161.253) by
 EX13D31EUA001.ant.amazon.com (10.43.165.15) with Microsoft SMTP Server (TLS)
 id 15.0.1497.2; Mon, 11 May 2020 12:41:36 +0000
...
Subject: [PATCH v11 14/16] mm/damon: Add kunit tests
Date:   Mon, 11 May 2020 14:33:00 +0200
Message-ID: <20200511123302.12520-15-sjpark@amazon.com>
...
index ee117e920b39..6fb847312a5d 100644
--- a/mm/damon.c
+++ b/mm/damon.c
@@ -25,7 +25,11 @@
...
@@ -1503,3 +1507,5 @@ module_exit(damon_exit);
 MODULE_LICENSE("GPL");
