...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2419D2B3886
	for <lists+linux-kernel@lfdr.de>; Sun, 15 Nov 2020 20:24:48 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727799AbgKOTWL (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 15 Nov 2020 14:22:11 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37936 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727741AbgKOTWI (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 15 Nov 2020 14:22:08 -0500
Received: from mail-wr1-x434.google.com (mail-wr1-x434.google.com [IPv6:2a00:1450:4864:20::434])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2AF08C0613D2;
        Sun, 15 Nov 2020 11:22:07 -0800 (PST)
Received: by mail-wr1-x434.google.com with SMTP id j7so16472825wrp.3;
        Sun, 15 Nov 2020 11:22:07 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=pZpzEFyq4AVe6W3EFSSW+zycG+jQXalQDb3O+ZSedkI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=pZpzEFyq4AVe6W3EFSSW+zycG+jQXalQDb3O+ZSedkI=;
        b=
X-Gm-Message-State: AOAM530cH+gFUhJQ2Rba7pxmkXuCG8qHhJNdoZuSfp0hcj3oka+ya6al
        2JRrfkLY+LzSFnXqf/mEgnKdOccx30Y=
X-Google-Smtp-Source: ABdhPJyT5G0ORO47ggXhh/rRT03Pp8RhtT5lMYLFs6+ZekYKWRk7GC6ZyjR4JySwBDa7AcGgO0FrzQ==
X-Received: by 2002:adf:cc91:: with SMTP id p17mr15539613wrj.368.1605468122193;
        Sun, 15 Nov 2020 11:22:02 -0800 (PST)
Received: from xws.fritz.box (p5487b28b.dip0.t-ipconnect.de. [84.135.178.139])
        by smtp.gmail.com with ESMTPSA id u8sm17106600wmg.6.2020.11.15.11.21.58
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 15 Nov 2020 11:22:00 -0800 (PST)
...
Subject: [PATCH 1/9] platform/surface: Add Surface Aggregator subsystem
Date:   Sun, 15 Nov 2020 20:21:35 +0100
Message-Id: <20201115192143.21571-2-luzmaximilian@gmail.com>
...
---
 ...
 drivers/platform/surface/aggregator/Kconfig   |   39 +
 drivers/platform/surface/aggregator/Makefile  |   10 +
 .../platform/surface/aggregator/controller.c  | 2482 +++++++++++++++++
 .../platform/surface/aggregator/controller.h  |  279 ++
 drivers/platform/surface/aggregator/core.c    |  779 ++++++
 .../platform/surface/aggregator/ssh_msgb.h    |  201 ++
 .../surface/aggregator/ssh_packet_layer.c     | 1661 +++++++++++
 .../surface/aggregator/ssh_packet_layer.h     |  172 ++
 .../platform/surface/aggregator/ssh_parser.c  |  229 ++
 .../platform/surface/aggregator/ssh_parser.h  |  157 ++
 .../surface/aggregator/ssh_request_layer.c    | 1200 ++++++++
 ...
 17 files changed, 8853 insertions(+)
...
index 0e54a5841b98..f0ebf547d984 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
...
index 000000000000..e0be15109e2f
--- /dev/null
...
new file mode 100644
index 000000000000..fed5b069489c
--- /dev/null
...
new file mode 100644
index 000000000000..7688cbc7d0ae
--- /dev/null
...
new file mode 100644
index 000000000000..58ba000e95d6
--- /dev/null
...
new file mode 100644
index 000000000000..eb0b142148db
--- /dev/null
...
new file mode 100644
index 000000000000..01ac27d60c3a
--- /dev/null
...
new file mode 100644
index 000000000000..2b0368bb2d79
--- /dev/null
