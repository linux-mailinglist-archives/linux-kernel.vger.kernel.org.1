...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 25056283871
	for <lists+linux-kernel@lfdr.de>; Mon,  5 Oct 2020 16:47:20 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726997AbgJEOq7 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 5 Oct 2020 10:46:59 -0400
Received: from foss.arm.com ([217.140.110.172]:49356 "EHLO foss.arm.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726950AbgJEOqv (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 5 Oct 2020 10:46:51 -0400
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 9AA371435;
        Mon,  5 Oct 2020 07:46:49 -0700 (PDT)
Received: from e120937-lin.home (unknown [172.31.20.19])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id CF29D3F70D;
        Mon,  5 Oct 2020 07:46:47 -0700 (PDT)
...
Subject: [PATCH 2/6] firmware: arm_scmi: add SCMIv3.0 Sensors descriptors extensions
Date:   Mon,  5 Oct 2020 15:45:14 +0100
Message-Id: <20201005144518.31832-3-cristian.marussi@arm.com>
...
@@ -114,6 +198,178 @@ static int scmi_sensor_attributes_get(const struct scmi_handle *handle,
 	return ret;
 }
...
+
 ...
 {
@@ -131,9 +387,10 @@ static int scmi_sensor_description_get(const struct scmi_handle *handle,
 	buf = t->rx.buf;
...
-
 		...
 		if (ret)
 			break;
@@ -147,22 +404,95 @@ static int scmi_sensor_description_get(const struct scmi_handle *handle,
 			break;
 		}
...
+			sdesc = (typeof(sdesc))((u8 *)sdesc + dsize);
 		...
 		desc_index += num_returned;
@@ -172,6 +502,7 @@ static int scmi_sensor_description_get(const struct scmi_handle *handle,
 		 */
 	} while (num_returned && num_remaining);
