...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B68F01E4958
	for <lists+linux-kernel@lfdr.de>; Wed, 27 May 2020 18:08:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2390819AbgE0QId (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 27 May 2020 12:08:33 -0400
Received: from mail.kernel.org ([198.145.29.99]:48904 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725294AbgE0QIa (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 27 May 2020 12:08:30 -0400
Received: from localhost (83-86-89-107.cable.dynamic.v4.ziggo.nl [83.86.89.107])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 72F8720873;
        Wed, 27 May 2020 16:08:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1590595706;
        bh=nA49XXV1yFf8izkYtEgZQtOuYGOxZOpDhclCX8HQXK8=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=SaGIFwA9Aawgjwi31VjV+uvhFRZI1yJAWCOIa0HEhEQQdlmvbBJfubcpIHn1mnA3D
         zMYEM3iwnWXJxTeIREAV/pyQOTpESlAjPQAFQNa7gk40d9HcDn8gU4yhTdKpKVJVL4
         NILco1tr0fHK81jj4Gfj4JLGzfz+QmTvJiRRjmOw=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 4.14.182
Date:   Wed, 27 May 2020 18:08:20 +0200
Message-Id: <1590595699192176@kroah.com>
X-Mailer: git-send-email 2.26.2
In-Reply-To: <1590595698236215@kroah.com>
References: <1590595698236215@kroah.com>
MIME-Version: 1.0
...
+
 	for_each_port(adapter, i) {
 		netdev = alloc_etherdev_mq(sizeof(struct port_info),
 					   MAX_ETH_QSETS);
@@ -5252,6 +5254,7 @@ static int init_one(struct pci_dev *pdev, const struct pci_device_id *ent)
