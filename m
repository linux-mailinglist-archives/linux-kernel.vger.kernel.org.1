...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A13C31E5211
	for <lists+linux-kernel@lfdr.de>; Thu, 28 May 2020 02:05:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725826AbgE1AFY (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 27 May 2020 20:05:24 -0400
Received: from mga12.intel.com ([192.55.52.136]:54203 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725267AbgE1AFX (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 27 May 2020 20:05:23 -0400
IronPort-SDR: 1yg8dYG4+npkww7cd+08sz4AdkXlNj94jZ6huUEg9ZKdwE381jfypLQ5kmpDUx7NTGvm6PV6Fd
 J8qRMtIAIEbg==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 27 May 2020 16:32:21 -0700
IronPort-SDR: pr56nC3WD9P+UnH1ScDESlPaeJ/mrNQY68G/yIvPsehhYqXqnkDbNo/CLhUXbZl+HjfOWkmwLy
 VOhOEwfjzGtQ==
X-IronPort-AV: E=Sophos;i="5.73,442,1583222400"; 
   d="scan'208";a="345705455"
Received: from dwillia2-desk3.jf.intel.com (HELO dwillia2-desk3.amr.corp.intel.com) ([10.54.39.16])
  by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 27 May 2020 16:32:20 -0700
Subject: [PATCH v5 1/2] x86,
...
Date:   Wed, 27 May 2020 16:16:08 -0700
Message-ID: <159062136858.2192412.3596959547026901848.stgit@dwillia2-desk3.amr.corp.intel.com>
...
index d13b5328ca10..cb7ae6d240a0 100644
...
index 0969285996cb..152018b03274 100644
...
@@ -436,20 +462,6 @@ raw_copy_to_user(void __user *to, const void *from, unsigned long n)
 	return ret;
 }
...
index b8de3be10eb4..72299d5afa57 100644
...
index 0fcb49e8044b..8814922c5806 100644
--- a/arch/x86/Kconfig
+++ b/arch/x86/Kconfig
...
index f909d3ce36e6..714e1eb78588 100644
...
index d8f283b9a569..6e856e180096 100644
...
index 9893fa124303..aa413bc1f948 100644
...
@@ -2045,7 +2044,7 @@ void mce_disable_bank(int bank)
 	and older.
...
+ * mce=recovery force enable copy_mc_fragile()
 ...
 {
@@ -2653,13 +2652,10 @@ static void __init mcheck_debugfs_init(void)
...
index 613c171b1b6d..3d4ed6ebcd08 100644
