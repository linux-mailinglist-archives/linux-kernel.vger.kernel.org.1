...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5E08F1CCB83
	for <lists+linux-kernel@lfdr.de>; Sun, 10 May 2020 16:17:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729085AbgEJORT (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 10 May 2020 10:17:19 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40462 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-FAIL-OK-FAIL)
        by vger.kernel.org with ESMTP id S1726085AbgEJORS (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 10 May 2020 10:17:18 -0400
Received: from mail-wm1-x343.google.com (mail-wm1-x343.google.com [IPv6:2a00:1450:4864:20::343])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 408ACC061A0C
        for <linux-kernel@vger.kernel.org>; Sun, 10 May 2020 07:17:18 -0700 (PDT)
Received: by mail-wm1-x343.google.com with SMTP id g12so15831945wmh.3
        for <linux-kernel@vger.kernel.org>; Sun, 10 May 2020 07:17:18 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=BMzP3pnh+BVY0+GzzuQ9ddGZLJ2rCHg1/ZYJIFtWfYc=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=BMzP3pnh+BVY0+GzzuQ9ddGZLJ2rCHg1/ZYJIFtWfYc=;
        b=
X-Gm-Message-State: AGi0PuZVndyOspXyjAakMigmoPxGlfATi783Q56yJ38sa7GtFX9ZuYy3
        SflJYlxGm+XRbTX0sx8g6iE=
X-Google-Smtp-Source: APiQypJQqfv3tCSTX2SUDkebQym7f0Oi+bHdbq1D5/5ocWS81fL1gtwwGZ6Y5Ig4FXoNdDvcdabjbg==
X-Received: by 2002:a7b:cd10:: with SMTP id f16mr27529845wmj.21.1589120236611;
        Sun, 10 May 2020 07:17:16 -0700 (PDT)
Received: from akira-laptop.home ([2a01:cb19:8b28:7600:48ff:3af:e1d8:fd19])
        by smtp.googlemail.com with ESMTPSA id w15sm12630816wrl.73.2020.05.10.07.17.15
...
Subject: [PATCH v6 5/9] w1_therm: adding resolution sysfs entry
Date:   Sun, 10 May 2020 16:17:07 +0200
Message-Id: <20200510141707.173273-1-akira215corp@gmail.com>
...
@@ -76,7 +89,8 @@ struct w1_therm_family_converter {
 	u16		reserved;
 	struct w1_family	*f;
...
@@ -87,11 +101,15 @@ struct w1_therm_family_converter {
...
+	struct w1_therm_family_converter *specific_functions;
 ...
 /**
@@ -124,6 +142,25 @@ struct therm_info {
  */
...
@@ -152,11 +189,18 @@ static ssize_t w1_seq_show(struct device *device,
...
@@ -183,6 +227,13 @@ static void w1_therm_remove_slave(struct w1_slave *sl);
 /* Family attributes */
...
+static struct attribute *w1_ds18s20_attrs[] = {
 	...
 	&dev_attr_ext_power.attr,
 	NULL,
@@ -192,12 +243,14 @@ static struct attribute *w1_ds28ea00_attrs[] = {
 	&dev_attr_w1_slave.attr,
...
@@ -259,6 +312,13 @@ static struct w1_family_ops w1_therm_fops = {
...
+
 static struct w1_family_ops w1_ds28ea00_fops = {
 	.add_slave	= w1_therm_add_slave,
 	.remove_slave	= w1_therm_remove_slave,
@@ -270,7 +330,7 @@ static struct w1_family_ops w1_ds28ea00_fops = {
...
@@ -298,92 +358,66 @@ static struct w1_family w1_therm_family_DS1825 = {
...
@@ -422,37 +456,62 @@ static struct w1_therm_family_converter w1_therm_families[] = {
 	{
...
@@ -496,6 +555,9 @@ static inline int w1_convert_temp(u8 rom[9], u8 fid)
...
+	/* Allocate memory*/
 	sl->family_data = kzalloc(sizeof(struct w1_therm_family_data),
 		GFP_KERNEL);
 	if (!sl->family_data)
@@ -503,6 +565,15 @@ static int w1_therm_add_slave(struct w1_slave *sl)
...
@@ -513,6 +584,18 @@ static int w1_therm_add_slave(struct w1_slave *sl)
...
+
 ...
 {
 	struct w1_slave *sl = dev_to_w1_slave(device);
@@ -788,26 +958,38 @@ static ssize_t w1_slave_store(struct device *device,
...
+	return size; /* always return size to avoid infinite calling */
 ...
 static ssize_t ext_power_show(struct device *device,
@@ -832,6 +1014,66 @@ static ssize_t ext_power_show(struct device *device,
