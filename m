...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 789DD2CB828
	for <lists+linux-kernel@lfdr.de>; Wed,  2 Dec 2020 10:10:48 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387718AbgLBJJS (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 2 Dec 2020 04:09:18 -0500
Received: from mail.kernel.org ([198.145.29.99]:41152 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728978AbgLBJJR (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 2 Dec 2020 04:09:17 -0500
...
Subject: Re: Linux 4.14.210
Date:   Wed,  2 Dec 2020 10:09:33 +0100
Message-Id: <160690017224142@kroah.com>
X-Mailer: git-send-email 2.29.2
In-Reply-To: <160690017278228@kroah.com>
References: <160690017278228@kroah.com>
MIME-Version: 1.0
...
index 653e6472a8dc..fa6ea54e2604 100644
--- a/Makefile
+++ b/Makefile
@@ -1,7 +1,7 @@
...
index 1dbc64bbd866..fcea3aa19c23 100644
...
index 60c63b23e3ba..bb33888151fb 100644
--- a/arch/x86/kernel/cpu/intel_rdt_rdtgroup.c
+++ b/arch/x86/kernel/cpu/intel_rdt_rdtgroup.c
@@ -393,6 +393,24 @@ static ssize_t rdtgroup_cpus_write(struct kernfs_open_file *of,
 	return ret ?: nbytes;
 }
...
index ff8b7042d28f..c034f506e015 100644
...
index 2db352308e5c..314f175cf8d0 100644
...
index a1e5e0529545..be0707cfc0fd 100644
...
index 07a043ae69f1..0e63cedcc3b5 100644
...
index b5bd5cb7d532..aa078c1dad14 100644
...
index a6531ffe29a6..a5694dec3f2e 100644
...
index 824f4c1c1f31..0e9f248370a3 100644
...
index 680ee8345211..a3f2548c5548 100644
...
index aed8ab6d6c5b..99c42f297afd 100644
...
index d9ece9ac6f53..938170b91f85 100644
...
index e146f6a1fa80..ea2a539e6e0f 100644
...
index 8b8a0c4fbc99..9a524b0e3e7b 100644
...
index 3f09d7fd2285..da7ca08d185e 100644
...
index 3788c053a0b1..540fab9f850d 100644
...
index 11aa5902a9ac..9c55e0f45ea8 100644
--- a/drivers/phy/tegra/xusb.c
+++ b/drivers/phy/tegra/xusb.c
@@ -912,6 +912,7 @@ static int tegra_xusb_padctl_probe(struct platform_device *pdev)
 reset:
...
index 8221e000c8c2..25955b4d80b0 100644
...
index 662df16b07a4..f7e1af90849b 100644
...
index c1792f271ac5..a3a3ee6e2a00 100644
...
index da80c03de6ea..d9fcef82ddf5 100644
...
index 4fb4cf8c2f14..a334933b5d52 100644
...
index 71cf552b8828..34c0a385516e 100644
...
index 2fd49b2358f8..f3938c527883 100644
...
index e985e820724e..c5ae2f4a7ec3 100644
--- a/fs/btrfs/inode.c
+++ b/fs/btrfs/inode.c
@@ -5584,11 +5584,14 @@ void btrfs_evict_inode(struct inode *inode)
 }
...
@@ -6546,11 +6566,6 @@ static struct inode *btrfs_new_inode(struct btrfs_trans_handle *trans,
 	return ERR_PTR(ret);
 }
...
@@ -7162,6 +7177,14 @@ struct extent_map *btrfs_get_extent(struct btrfs_inode *inode,
...
index 39a00b57ff01..53f6bb5d0b72 100644
--- a/fs/btrfs/qgroup.c
+++ b/fs/btrfs/qgroup.c
@@ -424,13 +424,13 @@ int btrfs_read_qgroup_config(struct btrfs_fs_info *fs_info)
 			break;
 	}
 out:
+	btrfs_free_path(path);
...
index 398cdf9a9f0c..eba167e1700e 100644
--- a/fs/proc/self.c
+++ b/fs/proc/self.c
...
index 4ef4bde2cc2d..b61ce96ae1d3 100644
...
index 75bdcede04e6..21d9b7d96eb0 100644
...
index 289ef63208fb..7514aa9c68c9 100644
...
index a19e840db54a..70cada80d185 100644
