...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7962A280F02
	for <lists+linux-kernel@lfdr.de>; Fri,  2 Oct 2020 10:34:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730433AbgJBIeI (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 2 Oct 2020 04:34:08 -0400
Received: from mga11.intel.com ([192.55.52.93]:15648 "EHLO mga11.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725961AbgJBIeI (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 2 Oct 2020 04:34:08 -0400
IronPort-SDR: m6s7MQ2zuEEA73xxNoE35RzkSmW5zjfVD01CoiY1y8GLND28VCF0XRPhWhTdsxS29/YB0ijiBN
 ANjmwnuEEo3Q==
X-IronPort-AV: E=McAfee;i="6000,8403,9761"; a="160277090"
X-IronPort-AV: E=Sophos;i="5.77,326,1596524400"; 
   d="yaml'?scan'208";a="160277090"
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 02 Oct 2020 01:34:02 -0700
IronPort-SDR: JaW/QA1iL3H2pIeUogFeqP/p7H08xU212jJKRZtCGwFJagZswzqQGMT7KyogPE8Z5PVCL2/IW+
 ky2DFreirCGw==
X-IronPort-AV: E=Sophos;i="5.77,326,1596524400"; 
   d="yaml'?scan'208";a="507535424"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.3])
  by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 02 Oct 2020 01:33:56 -0700
Date:   Fri, 2 Oct 2020 16:33:11 +0800
...
Message-ID: <20201002083311.GK393@shao2-debian>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="DheUW4aQn8WJk6WR"
...
Content-Disposition: attachment; filename="config-5.9.0-rc1-00125-gbdfcae11403e50"
...
queue_at_least_once'
	...
	export submit_id='5f767335c024f62052cdb786'
	export job_file='/lkp/jobs/scheduled/lkp-skl-fpga01/will-it-scale-performance-thread-50%-context_switch1-ucode=0x2006906-monitor=a122c70f-debian-10.4-x86_64-20200603.cgz-bdfcae1140-20201002-8274-10ve148-3.yaml'
	export id='d0a176e242d837d40b24278b9c03c2f7144db0f7'
	...
	export commit='bdfcae11403e5099769a7c8dc3262e3c4193edef'
	export ucode='0x2006906'
	export disable_latency_stats=1
	export enqueue_time='2020-10-02 08:24:22 +0800'
	export _id='5f76733dc024f62052cdb787'
	export _rt='/result/will-it-scale/performance-thread-50%-context_switch1-ucode=0x2006906-monitor=a122c70f/lkp-skl-fpga01/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/bdfcae11403e5099769a7c8dc3262e3c4193edef'
	export user='lkp'
	...
	export branch='linux-review/Mathieu-Desnoyers/Membarrier-updates/20200925-012549'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export monitor_sha='a122c70f'
	export result_root='/result/will-it-scale/performance-thread-50%-context_switch1-ucode=0x2006906-monitor=a122c70f/lkp-skl-fpga01/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/bdfcae11403e5099769a7c8dc3262e3c4193edef/3'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-skl-fpga01/will-it-scale-performance-thread-50%-context_switch1-ucode=0x2006906-monitor=a122c70f-debian-10.4-x86_64-20200603.cgz-bdfcae1140-20201002-8274-10ve148-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-8.3
branch=linux-review/Mathieu-Desnoyers/Membarrier-updates/20200925-012549
commit=bdfcae11403e5099769a7c8dc3262e3c4193edef
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/bdfcae11403e5099769a7c8dc3262e3c4193edef/vmlinuz-5.9.0-rc1-00125-gbdfcae11403e50
acpi_rsdp=0x6b447014
max_uptime=3600
RESULT_ROOT=/result/will-it-scale/performance-thread-50%-context_switch1-ucode=0x2006906-monitor=a122c70f/lkp-skl-fpga01/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/bdfcae11403e5099769a7c8dc3262e3c4193edef/3
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/bdfcae11403e5099769a7c8dc3262e3c4193edef/modules.cgz'
	...
	export last_kernel='5.9.0-rc7-10808-gd4d11af98ced64'
	export repeat_to=4
	export schedule_notify_address=
	export queue_at_least_once=1
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/bdfcae11403e5099769a7c8dc3262e3c4193edef/vmlinuz-5.9.0-rc1-00125-gbdfcae11403e50'
	export dequeue_time='2020-10-02 08:32:44 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-skl-fpga01/will-it-scale-performance-thread-50%-context_switch1-ucode=0x2006906-monitor=a122c70f-debian-10.4-x86_64-20200603.cgz-bdfcae1140-20201002-8274-10ve148-3.cgz'
...
kconfig: x86_64-rhel-8.3
submit_id: 5f766342c024f61e6596a4f0
job_file: "/lkp/jobs/scheduled/lkp-skl-fpga01/will-it-scale-performance-thread-50%-context_switch1-ucode=0x2006906-monitor=a122c70f-debian-10.4-x86_64-20200603.cgz-bdfcae1140-20201002-7781-yibiq5-1.yaml"
id: 41dadb0779613db55a1fde2f5d1c47b5488e8ac5
...
enqueue_time: 2020-10-02 07:16:18.458513199 +08:00
_id: 5f7669ddc024f61e6596a4f1
_rt: "/result/will-it-scale/performance-thread-50%-context_switch1-ucode=0x2006906-monitor=a122c70f/lkp-skl-fpga01/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/bdfcae11403e5099769a7c8dc3262e3c4193edef"
...
result_root: "/result/will-it-scale/performance-thread-50%-context_switch1-ucode=0x2006906-monitor=a122c70f/lkp-skl-fpga01/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/bdfcae11403e5099769a7c8dc3262e3c4193edef/1"
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-skl-fpga01/will-it-scale-performance-thread-50%-context_switch1-ucode=0x2006906-monitor=a122c70f-debian-10.4-x86_64-20200603.cgz-bdfcae1140-20201002-7781-yibiq5-1.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- branch=linux-devel/devel-hourly-2020100113
- commit=bdfcae11403e5099769a7c8dc3262e3c4193edef
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/bdfcae11403e5099769a7c8dc3262e3c4193edef/modules.cgz"
...
#! runtime status
last_kernel: 5.9.0-rc1-00125-gbdfcae11403e50
repeat_to: 2
schedule_notify_address: 

#! user overrides
queue_at_least_once: 0
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/bdfcae11403e5099769a7c8dc3262e3c4193edef/vmlinuz-5.9.0-rc1-00125-gbdfcae11403e50"
dequeue_time: 2020-10-02 07:54:41.249243315 +08:00
job_state: finished
loadavg: 47.81 37.44 16.91 1/775 10387
...
do
 ...
 "/lkp/benchmarks/python3/bin/python3" "./runtest.py" "context_switch1" "295" "thread" "52"
