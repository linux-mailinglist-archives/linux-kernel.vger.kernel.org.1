...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 069812CE7F7
	for <lists+linux-kernel@lfdr.de>; Fri,  4 Dec 2020 07:19:50 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728141AbgLDGSf (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 4 Dec 2020 01:18:35 -0500
Received: from mail-bn8nam12on2070.outbound.protection.outlook.com ([40.107.237.70]:28018
        "EHLO NAM12-BN8-obe.outbound.protection.outlook.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1725601AbgLDGSe (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 4 Dec 2020 01:18:34 -0500
...
CC:     Arnd Bergmann <arnd@arndb.de>,
        ...
        "Yang, Stanley" <Stanley.Yang@amd.com>, "Ma, Le" <Le.Ma@amd.com>,
...
x-forefront-antispam-report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:BYAPR12MB2888.namprd12.prod.outlook.com;PTR:;CAT:NONE;SFS:(4636009)(396003)(136003)(366004)(346002)(39860400002)(376002)(921005)(55016002)(186003)(6506007)(53546011)(52536014)(71200400001)(86362001)(83380400001)(26005)(8936002)(316002)(4326008)(33656002)(9686003)(6636002)(7696005)(2906002)(66446008)(8676002)(76116006)(110136005)(66556008)(5660300002)(66476007)(64756008)(478600001)(54906003)(66946007);DIR:OUT;SFP:1101;
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 04 Dec 2020 06:17:39.2267
 (UTC)
...
> <Christian.Koenig@amd.com>; David Airlie <airlied@linux.ie>; Daniel Vette=
r
...
> amdgpu_device *adev)
>=20
> Change the code again to make the compiler actually drop this code but no=
t
> warn about it.
>=20
> Fixes: ae2bf61ff39e ("drm/amdgpu: guard ras debugfs creation/removal base=
d
> on CONFIG_DEBUG_FS")
...
>  {
>  	struct amdgpu_ras *con =3D amdgpu_ras_get_context(adev); @@ -1189,7
