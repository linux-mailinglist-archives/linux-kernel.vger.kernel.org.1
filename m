...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A778323AF86
	for <lists+linux-kernel@lfdr.de>; Mon,  3 Aug 2020 23:15:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729175AbgHCVOv (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 3 Aug 2020 17:14:51 -0400
Received: from smtp-fw-4101.amazon.com ([72.21.198.25]:3137 "EHLO
        smtp-fw-4101.amazon.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728570AbgHCVOu (ORCPT
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  ...
  bh=wzJpkBTmSTYzoND6tGf43f4NzKCl5Q40J5r6Scs7VzM=;
  b=Z0oiArXEJLbuWmaBo+Ui1TrmELnsOHyoijHbbIgEjJUZYah3+FftQNkt
   F4uty+yvERAo9f1lqrLpbiyt5FedjitH2necODEcsxj2YYB5if4t8c/6o
   6K3Cn/g9gWOSW3/KUlvpCyQwk3Jcz36UI0KL/WTeAftbgKDniY+nQg+qZ
   c=;
IronPort-SDR: 2FrvN6ChsBDp5kvdDjY2AKBG+SpG0/OhSuMyepdGz73hRymkMw6pTbEwlALDek2E4+Aymwd2NB
 tzZ+7s4oP/hA==
X-IronPort-AV: E=Sophos;i="5.75,431,1589241600"; 
   d="scan'208";a="45882896"
Received: from iad12-co-svc-p1-lb1-vlan3.amazon.com (HELO email-inbound-relay-1d-5dd976cd.us-east-1.amazon.com) ([10.43.8.6])
  by smtp-border-fw-out-4101.iad4.amazon.com with ESMTP; 03 Aug 2020 21:14:46 +0000
Received: from EX13MTAUWC001.ant.amazon.com (iad55-ws-svc-p15-lb9-vlan2.iad.amazon.com [10.40.159.162])
        by email-inbound-relay-1d-5dd976cd.us-east-1.amazon.com (Postfix) with ESMTPS id 5625CA2401;
        Mon,  3 Aug 2020 21:14:42 +0000 (UTC)
...
Subject: [PATCH v4 2/3] KVM: x86: Introduce allow list for MSR emulation
Date:   Mon, 3 Aug 2020 23:14:22 +0200
Message-ID: <20200803211423.29398-3-graf@amazon.com>
...
@@ -3550,6 +3588,7 @@ int kvm_vm_ioctl_check_extension(struct kvm *kvm, long ext)
...
@@ -5075,6 +5114,110 @@ int kvm_vm_ioctl_enable_cap(struct kvm *kvm,
 	return r;
 }
...
+
 ...
 {
@@ -5381,6 +5524,12 @@ long kvm_arch_vm_ioctl(struct file *filp,
...
@@ -10102,6 +10253,8 @@ void kvm_arch_destroy_vm(struct kvm *kvm)
 	}
