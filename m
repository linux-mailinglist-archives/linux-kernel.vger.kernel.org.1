...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id EAC4027023B
	for <lists+linux-kernel@lfdr.de>; Fri, 18 Sep 2020 18:31:39 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726524AbgIRQbK (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 18 Sep 2020 12:31:10 -0400
Received: from relaydlg-01.paragon-software.com ([81.5.88.159]:53567 "EHLO
        relaydlg-01.paragon-software.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726397AbgIRQbJ (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 18 Sep 2020 12:31:09 -0400
Received: from dlg2.mail.paragon-software.com (vdlg-exch-02.paragon-software.com [172.30.1.105])
        by relaydlg-01.paragon-software.com (Postfix) with ESMTPS id F1064822E1;
        Fri, 18 Sep 2020 19:24:11 +0300 (MSK)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=paragon-software.com; s=mail; t=1600446251;
        bh=uHDMzXV70bd+32MaDfPjzRBZ4F1GpRKG98XKWtE39eU=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=X6vzrjajOlr4T5zS4Nfjs/mtDVmEDOLECNmZ/TyEG0U7L9+GXn3ESumTeud4qxtzo
         O1i+cTN5koBh/r2CAGeH2Rk1Jwh0MqDZdob3+AHzzp8f/FvpIXmu3sMrsJkYOHFlnX
         dH4t3KYUuAOcKuhXT3txy2OgJYU0PsxZKB6sfqPY=
...
Subject: [PATCH v6 03/10] fs/ntfs3: Add bitmap
Date:   Fri, 18 Sep 2020 19:21:57 +0300
Message-ID: <20200918162204.3706029-4-almaz.alexandrovich@paragon-software.com>
...
new file mode 100644
index 000000000000..74d8ed81e00c
--- /dev/null
+++ b/fs/ntfs3/bitmap.c
@@ -0,0 +1,1520 @@
+// SPDX-License-Identifier: GPL-2.0
...
+
+		if (!(iw & ra_mask)) {
+			const u32 tail = (len + PAGE_SIZE - 1) >> PAGE_SHIFT;
+
+			page_cache_readahead_unbounded(mapping, NULL,
+						       lbo >> PAGE_SHIFT,
+						       min(ra_pages, tail), 0);
+		}
+
