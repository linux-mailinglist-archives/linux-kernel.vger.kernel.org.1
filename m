...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8727A1B05D8
	for <lists+linux-kernel@lfdr.de>; Mon, 20 Apr 2020 11:41:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726112AbgDTJla (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 20 Apr 2020 05:41:30 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33114 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-FAIL-OK-FAIL)
        by vger.kernel.org with ESMTP id S1725773AbgDTJla (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 20 Apr 2020 05:41:30 -0400
Received: from laurent.telenet-ops.be (laurent.telenet-ops.be [IPv6:2a02:1800:110:4::f00:19])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1F75EC061A0C
        for <linux-kernel@vger.kernel.org>; Mon, 20 Apr 2020 02:41:28 -0700 (PDT)
Received: from ramsan ([IPv6:2a02:1810:ac12:ed60:124:221f:3928:ed52])
        by laurent.telenet-ops.be with bizsmtp
        id UxhS22002079KS601xhSJy; Mon, 20 Apr 2020 11:41:26 +0200
Received: from rox.of.borg ([192.168.97.57])
        by ramsan with esmtp (Exim 4.90_1)
        (envelope-from <geert@linux-m68k.org>)
        id 1jQSvd-0001W5-UH
        for linux-kernel@vger.kernel.org; Mon, 20 Apr 2020 11:41:25 +0200
...
Subject: Build regressions/improvements in v5.7-rc2
Date:   Mon, 20 Apr 2020 11:41:25 +0200
Message-Id: <20200420094125.24591-1-geert@linux-m68k.org>
...
v5.7-rc2[1] compared to v5.6[2].

Summarized:
  - build errors: +132/-3
  - build warnings: +256/-84

JFYI, when comparing v5.7-rc2[1] to v5.7-rc1[3], the summaries are:
  - build errors: +0/-0
  - build warnings: +0/-6
...
[1] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/ae83d0b416db002fe95601e7f97f64b59514d936/ (all 239 configs)
[2] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/7111951b8d4973bda27ff663f2cf18b663d15b48/ (all 239 configs)
[3] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/8f3d9f354286745c751374f5f1fcafee6b3f3136/ (all 239 configs)
...
132 error regressions:
  ...
  + /kisskb/src/arch/powerpc/include/asm/book3s/64/pgtable.h: error: expected identifier or '(' before '!' token:  => 939:19, 873:19, 959:19, 904:19, 868:19, 916:19
  ...
  + /kisskb/src/arch/powerpc/include/asm/book3s/64/pgtable.h: error: incompatible types when returning type 'int' but 'pte_t' was expected:  => 632:2, 660:2, 637:2, 690:2, 642:2, 652:2, 627:2, 1070:2, 665:2, 971:2, 685:2, 714:2, 647:2, 670:2, 695:2, 930:2, 675:2, 552:2
  + /kisskb/src/arch/powerpc/include/asm/book3s/64/pgtable.h: error: incompatible types when returning type 'int' but 'pte_t' {aka 'struct <anonymous>'} was expected:  => 652:9, 971:9, 627:9, 637:9, 685:9, 552:9, 695:9, 632:9, 665:9, 675:9, 670:9, 642:9, 647:9, 660:9, 714:9, 1070:9, 690:9, 930:9
  ...
  + /kisskb/src/arch/powerpc/include/asm/book3s/64/pgtable.h: error: redefinition of 'pud_is_leaf':  => 1368:20, 1366:21
  ...
  + /kisskb/src/arch/powerpc/include/asm/nohash/64/pgtable.h: error: expected identifier or '(' before '!' token:  => 143:25, 161:24, 160:25, 146:27, 144:24
...
256 warning regressions:
  ...
  + /kisskb/src/drivers/net/ethernet/mellanox/mlx5/core/en/tc_ct.c: warning: 'rule' may be used uninitialized in this function [-Wmaybe-uninitialized]:  => 1133:27
  ...
  + /kisskb/src/drivers/vdpa/ifcvf/ifcvf_main.c: warning: large integer implicitly truncated to unsigned type [-Woverflow]:  => 233:2
  + /kisskb/src/drivers/vdpa/vdpa_sim/vdpa_sim.c: warning: large integer implicitly truncated to unsigned type [-Woverflow]:  => 440:2
  + /kisskb/src/drivers/vhost/vdpa.c: warning: 'map_pfn' may be used uninitialized in this function [-Wuninitialized]:  => 579:52
  ...
  + /kisskb/src/kernel/events/core.c: warning: 'perf_event_cgroup_output' uses dynamic stack allocation:  => 7824:1
  ...
  + /kisskb/src/kernel/trace/ftrace.c: warning: 'filtered_pids' may be used uninitialized in this function [-Wmaybe-uninitialized]:  => 7244:8
  + /kisskb/src/kernel/trace/ftrace.c: warning: 'filtered_pids' may be used uninitialized in this function [-Wuninitialized]:  => 7244:6, 7244:23
  + /kisskb/src/kernel/trace/ftrace.c: warning: 'other_pids' may be used uninitialized in this function [-Wmaybe-uninitialized]:  => 7261:22
  + /kisskb/src/kernel/trace/ftrace.c: warning: 'other_pids' may be used uninitialized in this function [-Wuninitialized]:  => 7261:22, 7261:25
  + /kisskb/src/kernel/trace/ftrace.c: warning: 'seq_ops' may be used uninitialized in this function [-Wmaybe-uninitialized]:  => 7166:6
  + /kisskb/src/kernel/trace/ftrace.c: warning: 'seq_ops' may be used uninitialized in this function [-Wuninitialized]:  => 7166:6
...
84 warning improvements:
  ...
  - /kisskb/src/drivers/usb/gadget/udc/fsl_qe_udc.c: warning: cast to pointer from integer of different size [-Wint-to-pointer-cast]: 837:28, 837:5, 1491:27, 965:5, 1491:4, 965:28 => 837:28, 1491:27, 965:28
