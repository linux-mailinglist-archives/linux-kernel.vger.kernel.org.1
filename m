...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0B0642CD05F
	for <lists+linux-kernel@lfdr.de>; Thu,  3 Dec 2020 08:26:56 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2388176AbgLCHZg (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 3 Dec 2020 02:25:36 -0500
Received: from mailgw01.mediatek.com ([210.61.82.183]:48034 "EHLO
        mailgw01.mediatek.com" rhost-flags-OK-FAIL-OK-FAIL) by vger.kernel.org
        with ESMTP id S2388109AbgLCHZf (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 3 Dec 2020 02:25:35 -0500
X-UUID: 853c5f38c8de401896e36b1ce641f45a-20201203
X-UUID: 853c5f38c8de401896e36b1ce641f45a-20201203
Received: from mtkexhb01.mediatek.inc [(172.21.101.102)] by mailgw01.mediatek.com
        (envelope-from <stanley.chu@mediatek.com>)
        (Cellopoint E-mail Firewall v4.1.14 Build 0819 with TLSv1.2 ECDHE-RSA-AES256-SHA384 256/256)
        with ESMTP id 2024878828; Thu, 03 Dec 2020 15:24:48 +0800
...
Subject: [PATCH v2 2/3] scsi: ufs: Refine error history functions
Date:   Thu, 3 Dec 2020 15:24:42 +0800
Message-ID: <20201203072443.6663-3-stanley.chu@mediatek.com>
...
X-TM-SNTS-SMTP: 3B196CD25EE764E76BF03AB213755108C59C3082B5FC18043025812614E7222C2000:8
X-MTK:  N
Precedence: bulk
...
@@ -8697,7 +8711,7 @@ static int ufshcd_suspend(struct ufs_hba *hba, enum ufs_pm_op pm_op)
...
@@ -8821,7 +8835,7 @@ static int ufshcd_resume(struct ufs_hba *hba, enum ufs_pm_op pm_op)
 out:
 	hba->pm_op_in_progress = 0;
 	if (ret)
...
index 7a7e056a33a9..b2eab23a17e8 100644
