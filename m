...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 245C125C1DF
	for <lists+linux-kernel@lfdr.de>; Thu,  3 Sep 2020 15:51:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728935AbgICNu6 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 3 Sep 2020 09:50:58 -0400
Received: from mga12.intel.com ([192.55.52.136]:23396 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728951AbgICMpk (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 3 Sep 2020 08:45:40 -0400
IronPort-SDR: xMZO0qCq4VtyXD8CdSczx3KlLEE0YxVzcWEQSDj4COutigauGmjuGfgeNXoQLDtFmv9of3z23p
 6XzcQGd3ppCw==
X-IronPort-AV: E=McAfee;i="6000,8403,9732"; a="137083348"
X-IronPort-AV: E=Sophos;i="5.76,386,1592895600"; 
   d="scan'208";a="137083348"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 03 Sep 2020 05:43:13 -0700
IronPort-SDR: aiFFqKKMxzLy9cAyLGtRR0dsM8H4bjPGDRemsNOUzWExYGkEOsRGf3WRwIYLxUoYX+H1EqDazZ
 sMzaeu+IimyQ==
X-IronPort-AV: E=Sophos;i="5.76,386,1592895600"; 
   d="scan'208";a="315460173"
Received: from shsi6026.sh.intel.com (HELO localhost) ([10.239.147.135])
  by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 03 Sep 2020 05:43:06 -0700
...
Subject: [PATCH v2 09/17] virt: acrn: Introduce I/O request management
Date:   Thu,  3 Sep 2020 20:41:53 +0800
Message-Id: <20200903124201.17275-10-shuo.a.liu@intel.com>
...
index 3a1cac02ad9f..cb0824b6e5bd 100644
...
@@ -125,6 +126,29 @@ static long acrn_dev_ioctl(struct file *filp, unsigned int cmd,
...
+		break;
 	default:
 		...
 		ret = -ENOTTY;
@@ -172,11 +196,13 @@ static int __init hsm_init(void)
 	}
...
index 000000000000..08a4a8ee41c1
--- /dev/null
...
index 089627bcc8b4..a237a7def494 100644
--- a/drivers/virt/acrn/vm.c
+++ b/drivers/virt/acrn/vm.c
@@ -32,9 +32,17 @@ struct acrn_vm *acrn_vm_create(struct acrn_vm *vm,
 	}
...
@@ -56,6 +64,8 @@ int acrn_vm_destroy(struct acrn_vm *vm)
