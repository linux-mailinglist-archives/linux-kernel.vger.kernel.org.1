...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9F3B82819F0
	for <lists+linux-kernel@lfdr.de>; Fri,  2 Oct 2020 19:42:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2388471AbgJBRlb (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 2 Oct 2020 13:41:31 -0400
Received: from us-smtp-delivery-124.mimecast.com ([63.128.21.124]:55766 "EHLO
        us-smtp-delivery-124.mimecast.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S2387692AbgJBRla (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 2 Oct 2020 13:41:30 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1601660461;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=LqMHj3lwZniJM2VYgkSIDdUQhsQjL4kPUjiMSO7oqdU=;
        b=AHnsiEyyWGOD/rlEEyDFnnIfTDjNOowm+rB8dE651ujFigCpyDzQS6Seu4CyEs2wBCst5C
        xdNPnrGL0/xn90zjWnsbE3w9QISw8HXqKuRnWKICgQL3ghmU+4zw+VBwZtyjMSbUTOEsUk
        3Lk47ju1Win70PNXdMjMlo8rQ9E63Nc=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-492-pMDKCsnKN1u1NUjP0TSnuw-1; Fri, 02 Oct 2020 13:40:55 -0400
X-MC-Unique: pMDKCsnKN1u1NUjP0TSnuw-1
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.phx2.redhat.com [10.5.11.22])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 3DF861040C2C;
...
Received: from hpe-dl360pgen9-01.klab.eng.bos.redhat.com (hpe-dl360pgen9-01.klab.eng.bos.redhat.com [10.16.160.31])
        by smtp.corp.redhat.com (Postfix) with ESMTP id DF6BB1002C34;
...
Subject: [PATCH net-next v2 3/6] bonding: rename slave to port where possible
Date:   Fri,  2 Oct 2020 13:39:58 -0400
Message-Id: <20201002174001.3012643-4-jarod@redhat.com>
...
The /proc/net/bonding/<bond> output simply duplicates output information
on otherwise identical "Port" and "Slave" lines.
...
---
 ...
 drivers/net/bonding/bond_procfs.c             |   56 +-
 drivers/net/bonding/bond_sysfs.c              |  113 +-
 ...
 include/net/lag.h                             |    2 +-
 23 files changed, 2456 insertions(+), 2374 deletions(-)
...
index 2ac60cff9b3a..2e65472e3c58 100644
...
@@ -83,7 +83,9 @@ static void bond_info_show_bond_dev(struct seq_file *seq)
 	}
...
+			   primary ? primary->dev->name : "None");
 		seq_printf(seq, "Primary Slave: %s",
 			   primary ? primary->dev->name : "None");
 		if (primary) {
@@ -93,7 +95,9 @@ static void bond_info_show_bond_dev(struct seq_file *seq)
 				   optval->string);
 		}
...
@@ -166,32 +170,34 @@ static void bond_info_show_bond_dev(struct seq_file *seq)
 	}
 }
...
+		const struct ad_port *ad_port = &PORT_AD_INFO(port)->ad_port;
 		...
 		if (agg) {
@@ -247,7 +253,7 @@ static int bond_info_seq_show(struct seq_file *seq, void *v)
 		seq_printf(seq, "%s\n", bond_version);
...
index 152c470e9e49..1c2f44a76f31 100644
--- a/drivers/net/bonding/bond_sysfs.c
+++ b/drivers/net/bonding/bond_sysfs.c
@@ -59,8 +59,8 @@ static ssize_t bonding_show_bonds(struct class *cls,
...
+					   class_attr_bonding_devs);
 
 	return __bonding_show_bonds(bn, buf);
 }
@@ -79,7 +79,6 @@ static struct net_device *bond_get_by_name(struct bond_net *bn, const char *ifna
...
-
 	...
 	char *ifname;
 	int rv, res = count;
@@ -135,8 +134,8 @@ static ssize_t bonding_store_bonds(struct class *cls,
 				   struct class_attribute *attr,
...
@@ -213,19 +212,19 @@ static ssize_t bonding_sysfs_store_option(struct device *d,
 	return ret;
 }
...
+	bond_for_each_port(bond, port, iter) {
 		if (res > (PAGE_SIZE - IFNAMSIZ)) {
 			...
 			if ((PAGE_SIZE - res) > 10)
@@ -233,7 +232,7 @@ static ssize_t bonding_show_slaves(struct device *d,
...
+		res += sprintf(buf + res, "%s ", port->dev->name);
 	...
 	rtnl_unlock();
@@ -243,7 +242,7 @@ static ssize_t bonding_show_slaves(struct device *d,
 
 	return res;
 }
-static DEVICE_ATTR(slaves, 0644, bonding_show_slaves,
+static DEVICE_ATTR(ports, 0644, bonding_show_ports,
 		   bonding_sysfs_store_option);
 
 /* Show the bonding mode. */
@@ -456,17 +455,17 @@ static ssize_t bonding_show_miimon(struct device *d,
...
+	primary = rcu_dereference(bond->primary_port);
 	if (primary)
 		count = sprintf(buf, "%s\n", primary->dev->name);
 	rcu_read_unlock();
@@ -506,25 +505,25 @@ static DEVICE_ATTR(use_carrier, 0644,
...
+static DEVICE_ATTR(active_port, 0644,
+		   bonding_show_active_port, bonding_sysfs_store_option);
 
 /* Show link status of the bond interface. */
 static ssize_t bonding_show_mii_status(struct device *d,
@@ -636,20 +635,20 @@ static ssize_t bonding_show_ad_partner_mac(struct device *d,
 }
...
+	bond_for_each_port(bond, port, iter) {
 		if (res > (PAGE_SIZE - IFNAMSIZ - 6)) {
 			...
 			if ((PAGE_SIZE - res) > 10)
@@ -658,7 +657,7 @@ static ssize_t bonding_show_queue_id(struct device *d,
 			break;
 		}
...
@@ -671,17 +670,17 @@ static DEVICE_ATTR(queue_id, 0644, bonding_show_queue_id,
 		   bonding_sysfs_store_option);
...
+static DEVICE_ATTR(all_ports_active, 0644,
...
@@ -717,17 +716,17 @@ static ssize_t bonding_show_tlb_dynamic_lb(struct device *d,
...
@@ -792,7 +802,7 @@ static struct attribute *per_bond_attrs[] = {
...
@@ -800,15 +810,21 @@ static struct attribute *per_bond_attrs[] = {
 	&dev_attr_ad_partner_key.attr,
 	&dev_attr_ad_partner_mac.attr,
 	&dev_attr_queue_id.attr,
-	&dev_attr_all_slaves_active.attr,
+	&dev_attr_all_ports_active.attr,
 	&dev_attr_resend_igmp.attr,
 	&dev_attr_min_links.attr,
 	&dev_attr_lp_interval.attr,
-	&dev_attr_packets_per_slave.attr,
+	&dev_attr_packets_per_port.attr,
...
@@ -829,6 +845,7 @@ int bond_create_sysfs(struct bond_net *bn)
...
@@ -840,7 +857,7 @@ int bond_create_sysfs(struct bond_net *bn)
 	 * configure multiple bonding devices.
 	 */
 	if (ret == -EEXIST) {
-		/* Is someone being naming a device bonding_devs? */
+		/* Is someone naming a device bonding_devs? */
...
index a94c15cdae92..16d9240776c4 100644
...
@@ -1624,7 +1624,7 @@ enum netdev_priv_flags {
...
+ *	@adj_list:	Directly linked devices, like ports for bonding
  ...
  *
@@ -2720,9 +2720,9 @@ extern rwlock_t				dev_base_lock;		/* Device list lock */
 						     dev_list)
...
@@ -4581,7 +4581,7 @@ struct sk_buff *skb_mac_gso_segment(struct sk_buff *skb,
...
@@ -4811,7 +4811,7 @@ static inline bool netif_is_bond_dev(const struct net_device *dev)
...
@@ -4878,7 +4878,7 @@ static inline bool netif_is_lag_master(const struct net_device *dev)
