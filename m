...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C17081FFA35
	for <lists+linux-kernel@lfdr.de>; Thu, 18 Jun 2020 19:28:05 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732283AbgFRR1y (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 18 Jun 2020 13:27:54 -0400
Received: from foss.arm.com ([217.140.110.172]:55840 "EHLO foss.arm.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1732087AbgFRR1R (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 18 Jun 2020 13:27:17 -0400
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 30A2D31B;
        Thu, 18 Jun 2020 10:27:16 -0700 (PDT)
Received: from e120937-lin.home (unknown [172.31.20.19])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 0CF313F6CF;
        Thu, 18 Jun 2020 10:27:14 -0700 (PDT)
From:   Cristian Marussi <cristian.marussi@arm.com>
To:     linux-kernel@vger.kernel.org, linux-arm-kernel@lists.infradead.org
Cc:     sudeep.holla@arm.com, lukasz.luba@arm.com,
        james.quinlan@broadcom.com, Jonathan.Cameron@Huawei.com,
        cristian.marussi@arm.com, dave.martin@arm.com
Subject: [PATCH v9 3/9] firmware: arm_scmi: Add notification dispatch and delivery
Date:   Thu, 18 Jun 2020 18:26:26 +0100
Message-Id: <20200618172632.42842-4-cristian.marussi@arm.com>
...
+	struct workqueue_struct	*wq;
 ...
 /**
@@ -316,9 +347,266 @@ struct scmi_event_handler {
...
@@ -341,13 +629,22 @@ static void scmi_kfifo_free(void *kfifo)
...
+	return ret;
 ...
 /**
@@ -747,6 +1044,37 @@ scmi_get_or_create_handler(struct scmi_notify_instance *ni, u32 evt_key)
...
@@ -862,6 +1190,16 @@ static void scmi_put_handler(struct scmi_notify_instance *ni,
...
@@ -1101,6 +1439,12 @@ int scmi_notification_init(struct scmi_handle *handle)
 	ni->gid = gid;
 	ni->handle = handle;
...
@@ -1142,5 +1486,12 @@ void scmi_notification_exit(struct scmi_handle *handle)
 		return;
 	ni = handle->notify_priv;
...
index 4c2416404b0b..83142f1fe737 100644
--- a/drivers/firmware/arm_scmi/notify.h
+++ b/drivers/firmware/arm_scmi/notify.h
@@ -36,6 +36,11 @@ struct scmi_event {
...
@@ -53,5 +61,7 @@ int scmi_register_protocol_events(const struct scmi_handle *handle,
