...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E389B2B2DEE
	for <lists+linux-kernel@lfdr.de>; Sat, 14 Nov 2020 16:26:19 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727076AbgKNPY1 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 14 Nov 2020 10:24:27 -0500
Received: from smtp04.smtpout.orange.fr ([80.12.242.126]:18389 "EHLO
        smtp.smtpout.orange.fr" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726953AbgKNPY1 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 14 Nov 2020 10:24:27 -0500
Received: from tomoyo.flets-east.jp ([153.230.197.127])
        by mwinf5d07 with ME
        id sFPY230052lQRaH03FPh3a; Sat, 14 Nov 2020 16:23:48 +0100
X-ME-Helo: tomoyo.flets-east.jp
X-ME-Auth: bWFpbGhvbC52aW5jZW50QHdhbmFkb28uZnI=
X-ME-Date: Sat, 14 Nov 2020 16:23:48 +0100
...
Subject: [PATCH v6] can: usb: etas_es58X: add support for ETAS ES58X CAN USB interfaces
Date:   Sun, 15 Nov 2020 00:22:56 +0900
Message-Id: <20201114152325.523630-1-mailhol.vincent@wanadoo.fr>
...
*Warning*: this patch is based on the testing branch of linux-can-next:
...
---
 ...
 drivers/net/can/usb/etas_es58x/es581_4.c    |  550 ++++
 drivers/net/can/usb/etas_es58x/es581_4.h    |  206 ++
 drivers/net/can/usb/etas_es58x/es58x_core.c | 2626 +++++++++++++++++++
 drivers/net/can/usb/etas_es58x/es58x_core.h |  722 +++++
 drivers/net/can/usb/etas_es58x/es58x_fd.c   |  656 +++++
 drivers/net/can/usb/etas_es58x/es58x_fd.h   |  242 ++
 9 files changed, 5015 insertions(+)
...
new file mode 100644
index 000000000000..d4cb413f4b6f
--- /dev/null
...
new file mode 100644
index 000000000000..95f16f6fb2f4
--- /dev/null
...
new file mode 100644
index 000000000000..77b216bb41f8
--- /dev/null
...
new file mode 100644
index 000000000000..8b5dbcb19343
--- /dev/null
...
base-commit: bff6f1db91e330d7fba56f815cdbc412c75fe163
prerequisite-patch-id: f43825af6723fff787c2a0692443fb88d5740c8f
prerequisite-patch-id: 00e69a83c61b17b59c7aec4a581ff162f28549be
prerequisite-patch-id: d4726c467242aa3c11ab1f621fe2701a29248eca
prerequisite-patch-id: dac3ee5698166b32bc924ecc0e831e6e5d9b13bd
prerequisite-patch-id: 780ec3b28595bf1b038d7a823aa0b30f32d80f1e
prerequisite-patch-id: 65957ad057126a9b0e7253d232e5cbd0438c5c5b
prerequisite-patch-id: 9035d1fecb9a8a5f4ab066be48ad6b38177fa299
prerequisite-patch-id: e326320db7010eece042f5ec8d32aef8801a5028
prerequisite-patch-id: b37c0d9eac5e9455a77e3a360e57d04a8bcff2b7
prerequisite-patch-id: c78f7165bd545689b694bd2d397a33033b64133d
prerequisite-patch-id: baa63332a462829df616c37d701df377fd18ee2f
prerequisite-patch-id: c84ce070019ece01be32617ee21c0a992c1cda58
prerequisite-patch-id: d3adcc60e59b65362509fc81e85a448f4636465f
-- 
2.26.2
