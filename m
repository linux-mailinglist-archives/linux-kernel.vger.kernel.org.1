...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A5AFE26DEF0
	for <lists+linux-kernel@lfdr.de>; Thu, 17 Sep 2020 17:00:20 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727860AbgIQPAN (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 17 Sep 2020 11:00:13 -0400
Received: from mail.kernel.org ([198.145.29.99]:50300 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727786AbgIQOzo (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 17 Sep 2020 10:55:44 -0400
Received: from localhost (83-86-74-64.cable.dynamic.v4.ziggo.nl [83.86.74.64])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 55B1F22227;
        Thu, 17 Sep 2020 14:45:28 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1600353929;
        bh=tpHsKRUnyMNfnZZ8zfoEcUfiES4bH42v2vmv3Ska9+E=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=BkyFOBgtkRMMf+U+ivYU3QnRXfOznvEo5hNRp0E0GhgPusC4HEaAh0qEc3D+qaJyS
         XLO44DH75ysikWrp+MMayo8njH5zuPlYHtARdbkSJj2z1gM1yAVwKTNPG8G0VdyiH8
         qwqscJxn+6dz3XO99EXlD4cKHGuAlldW9zj8FBrc=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 5.4.66
Date:   Thu, 17 Sep 2020 16:45:54 +0200
Message-Id: <16003539535393@kroah.com>
X-Mailer: git-send-email 2.28.0
In-Reply-To: <160035395369154@kroah.com>
References: <160035395369154@kroah.com>
MIME-Version: 1.0
...
index 927eb3fd2366..b9ca89dc75c7 100644
...
index 7829247de60e..24b55103bfe0 100644
...
index 4e29f4fe4a05..99f081ccc15d 100644
...
index fbc93d8dda5e..e03a4d794240 100644
...
index ea24d7c58b12..8ae4cf135157 100644
...
index a8c11b5e1e94..70c4ea438664 100644
...
index 996eb9c55b39..2cff914aada5 100644
...
index 74b8818ac9a1..3bb71f177dfd 100644
...
index d0336545e1fe..f0847f2bb117 100644
...
@@ -920,6 +932,7 @@ static int nvme_rdma_configure_io_queues(struct nvme_rdma_ctrl *ctrl, bool new)
...
index 0166ff0e4738..9b81763b44d9 100644
...
@@ -1785,6 +1797,7 @@ static int nvme_tcp_configure_admin_queue(struct nvme_ctrl *ctrl, bool new)
...
index a17aebe0aa7a..55fc80de5ef1 100644
...
@@ -5205,13 +5220,11 @@ regulator_register(const struct regulator_desc *regulator_desc,
 	mutex_lock(&regulator_list_mutex);
...
index 8146c2d91d30..9d8ceb63f7db 100644
...
index 31f00d72f149..8685d28dfdaa 100644
...
index a13bad262598..51798632d334 100644
