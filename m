...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E078D20B4DE
	for <lists+linux-kernel@lfdr.de>; Fri, 26 Jun 2020 17:40:23 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729795AbgFZPjw (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 26 Jun 2020 11:39:52 -0400
Received: from ale.deltatee.com ([207.54.116.67]:34828 "EHLO ale.deltatee.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1729726AbgFZPji (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        ...
        bh=eGX9NZYbZuhmVERXyCfL9A3rbvnEOAEFyzQEwpIKnXQ=; b=IOWCj0fnYowseVN4i+wTnee0IF
        ;
Received: from cgy1-donard.priv.deltatee.com ([172.16.1.31])
        by ale.deltatee.com with esmtps (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <gunthorp@deltatee.com>)
        id 1joqRu-0000oV-4A; Fri, 26 Jun 2020 09:39:32 -0600
Received: from gunthorp by cgy1-donard.priv.deltatee.com with local (Exim 4.92)
        (envelope-from <gunthorp@deltatee.com>)
        id 1joqRn-0007Hf-GN; Fri, 26 Jun 2020 09:39:23 -0600
...
Cc:     Christoph Hellwig <hch@lst.de>, Sagi Grimberg <sagi@grimberg.me>,
        ...
        Chaitanya Kulkarni <chaitanya.kulkarni@wdc.com>
Date:   Fri, 26 Jun 2020 09:39:16 -0600
Message-Id: <20200626153918.27929-8-logang@deltatee.com>
...
Subject: [PATCH v14 7/9] nvmet-passthru: Add passthru code to process commands
...
index cea7c3834021..ce16d6af4d44 100644
...
@@ -533,6 +544,34 @@ static inline u32 nvmet_dsm_len(struct nvmet_req *req)
...
index 000000000000..96799febdbc3
--- /dev/null
