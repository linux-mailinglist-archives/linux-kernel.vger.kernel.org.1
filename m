...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 21A8B22D85E
	for <lists+linux-kernel@lfdr.de>; Sat, 25 Jul 2020 17:08:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728024AbgGYPHv (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 25 Jul 2020 11:07:51 -0400
Received: from mail-eopbgr20112.outbound.protection.outlook.com ([40.107.2.112]:19488
        "EHLO EUR02-VE1-obe.outbound.protection.outlook.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1726652AbgGYPHq (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 25 Jul 2020 11:07:46 -0400
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=JxPbZ5kFn+nkPgNa5dNCf4+YuKrlt/Hq14GTCInfAcM=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=plvision.eu;
 ...
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=JxPbZ5kFn+nkPgNa5dNCf4+YuKrlt/Hq14GTCInfAcM=;
 b=n3uVc7u9I0m7rsXDbQjBCMYQPw993nZ3/nKjK7qJwknqhgJzLyVBLpui3XNO5Jt467/lkjY5dY+C2Q6oEx1h6Z7F6WTGs25KTDPVtRiqQvWbyghS6qoVAbgcKzcE6oqEl2radWrwrRDB8CIZ3flqtH9WfpjyWM943g2Uw2iZQW8=
...
Received: from DB6P190MB0534.EURP190.PROD.OUTLOOK.COM (2603:10a6:6:33::15) by
 ...
 15.20.3216.21; Sat, 25 Jul 2020 15:07:19 +0000
...
Subject: [net-next v3 5/6] net: marvell: prestera: Add Switchdev driver implementation
Date:   Sat, 25 Jul 2020 18:06:50 +0300
Message-Id: <20200725150651.17029-6-vadym.kochan@plvision.eu>
...
Received: from pc60716vkochan.x.ow.s (217.20.186.93) by AM6PR05CA0032.eurprd05.prod.outlook.com (2603:10a6:20b:2e::45) with Microsoft SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.3216.23 via Frontend Transport; Sat, 25 Jul 2020 15:07:18 +0000
X-Mailer: git-send-email 2.17.1
X-Originating-IP: [217.20.186.93]
X-MS-PublicTrafficType: Email
X-MS-Office365-Filtering-Correlation-Id: 295ae606-26b6-48f3-592a-08d830ac6cd2
X-MS-TrafficTypeDiagnostic: DB6P190MB0568:
X-MS-Exchange-Transport-Forked: True
X-Microsoft-Antispam-PRVS: <DB6P190MB05687FF540817D952F34721B95740@DB6P190MB0568.EURP190.PROD.OUTLOOK.COM>
X-MS-Oob-TLC-OOBClassifiers: OLM:1751;
X-MS-Exchange-SenderADCheck: 1
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:DB6P190MB0534.EURP190.PROD.OUTLOOK.COM;PTR:;CAT:NONE;SFTY:;SFS:(136003)(39830400003)(376002)(366004)(396003)(346002)(2616005)(86362001)(26005)(1076003)(956004)(6506007)(8936002)(4326008)(16526019)(36756003)(6666004)(186003)(8676002)(30864003)(83380400001)(44832011)(52116002)(5660300002)(6512007)(66556008)(6486002)(66476007)(508600001)(107886003)(66946007)(2906002)(110136005)(54906003)(316002)(921003)(579004)(559001);DIR:OUT;SFP:1102;
X-MS-Exchange-AntiSpam-MessageData: 
X-OriginatorOrg: plvision.eu
X-MS-Exchange-CrossTenant-Network-Message-Id: 295ae606-26b6-48f3-592a-08d830ac6cd2
X-MS-Exchange-CrossTenant-AuthSource: DB6P190MB0534.EURP190.PROD.OUTLOOK.COM
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 25 Jul 2020 15:07:19.3816
 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 03707b74-30f3-46b6-a0e0-ff0a7438c9c4
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: 7BSfTwMQN4lCjr83s+eVtAV7kgUo8v00qusJ5eRGNr8OjXLvbEjqZkS38A0Dot4fZz8Oxucm0SXcxFkhN5w/DwpBxtRu0t9loLQzjPywdjI=
...
---
 ...
 7 files changed, 1813 insertions(+), 6 deletions(-)
...
index 25f1310da4cf..075ad9b9fabf 100644
...
+
 ...
 {
@@ -37,8 +61,7 @@ struct prestera_port *prestera_port_find_by_hwid(struct prestera_switch *sw,
 	return NULL;
 }
...
@@ -249,6 +272,8 @@ static int prestera_port_create(struct prestera_switch *sw, u32 id)
...
+	port->pvid = PRESTERA_DEFAULT_VID;
 	...
 	port->id = id;
 	port->sw = sw;
@@ -442,6 +467,72 @@ static int prestera_switch_set_base_mac_addr(struct prestera_switch *sw)
...
+
 ...
 {
 	int err;
@@ -458,10 +549,18 @@ static int prestera_switch_init(struct prestera_switch *sw)
 	if (err)
 		return err;
...
@@ -482,6 +581,10 @@ static int prestera_switch_init(struct prestera_switch *sw)
...
+	prestera_netdev_event_handler_unregister(sw);
 	...
 	return err;
@@ -493,6 +596,8 @@ static void prestera_switch_fini(struct prestera_switch *sw)
