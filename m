...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 160142F3538
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Jan 2021 17:16:06 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2392860AbhALQOn (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 12 Jan 2021 11:14:43 -0500
Received: from aserp2130.oracle.com ([141.146.126.79]:54406 "EHLO
        aserp2130.oracle.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2392754AbhALQOm (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 12 Jan 2021 11:14:42 -0500
Received: from pps.filterd (aserp2130.oracle.com [127.0.0.1])
        by aserp2130.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 10CG9jlO086635;
        Tue, 12 Jan 2021 16:13:20 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com; h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-transfer-encoding; s=corp-2020-01-29;
 bh=PuUytsiBFAHe7f1ncojgFUdF3Cy5IubYrXvOjXIrQMM=;
 b= jg== 
Received: from aserp3030.oracle.com (aserp3030.oracle.com [141.146.126.71])
        by aserp2130.oracle.com with ESMTP id 360kg1q4uj-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Tue, 12 Jan 2021 16:13:20 +0000
Received: from pps.filterd (aserp3030.oracle.com [127.0.0.1])
        by aserp3030.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 10CGA2jP094645;
        Tue, 12 Jan 2021 16:13:20 GMT
Received: from userv0121.oracle.com (userv0121.oracle.com [156.151.31.72])
        by aserp3030.oracle.com with ESMTP id 360key121s-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Tue, 12 Jan 2021 16:13:20 +0000
Received: from abhmp0012.oracle.com (abhmp0012.oracle.com [141.146.116.18])
        by userv0121.oracle.com (8.14.4/8.13.8) with ESMTP id 10CGDIxG017560;
        Tue, 12 Jan 2021 16:13:18 GMT
Received: from revolver.jebus.ca (/23.233.25.87)
        by default (Oracle Beehive Gateway v4.0)
        with ESMTP ; Tue, 12 Jan 2021 08:13:17 -0800
...
Subject: [PATCH v2 14/70] mm/mmap: Change do_brk_flags() to expand existing VMA and add do_brk_munmap()
Date:   Tue, 12 Jan 2021 11:11:44 -0500
Message-Id: <20210112161240.2024684-15-Liam.Howlett@Oracle.com>
...
+	MA_STATE(mas, &mm->mm_mt, 0, 0);
 	...
 	if (mmap_write_lock_killable(mm))
 		return -EINTR;
@@ -235,37 +238,49 @@ SYSCALL_DEFINE1(brk, unsigned long, brk)
 		goto success;
 	}
...
+
 ...
 success:
@@ -276,13 +291,12 @@ SYSCALL_DEFINE1(brk, unsigned long, brk)
...
@@ -367,16 +381,16 @@ static void validate_mm(struct mm_struct *mm)
 	validate_mm_mt(mm);
...
+#endif
 		...
 		vma = vma->vm_next;
 		i++;
@@ -537,6 +551,39 @@ static void __vma_link_file(struct vm_area_struct *vma)
 	}
 }
...
@@ -2849,15 +3009,29 @@ static int do_brk_flags(unsigned long addr, unsigned long len,
 	vma->vm_flags |= VM_SOFTDIRTY;
 	validate_mm_mt(mm);
 	return 0;
+
...
+	MA_STATE(mas, &mm->mm_mt, addr, addr);
 	...
 	if (len < request)
@@ -2868,10 +3042,11 @@ int vm_brk_flags(unsigned long addr, unsigned long request, unsigned long flags)
 	if (mmap_write_lock_killable(mm))
 		return -EINTR;
