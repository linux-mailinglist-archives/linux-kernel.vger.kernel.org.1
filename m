...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3200C2CF48C
	for <lists+linux-kernel@lfdr.de>; Fri,  4 Dec 2020 20:11:01 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729494AbgLDTJJ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 4 Dec 2020 14:09:09 -0500
Received: from mail.kernel.org ([198.145.29.99]:53090 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726021AbgLDTJI (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 4 Dec 2020 14:09:08 -0500
Date:   Fri, 4 Dec 2020 11:08:24 -0800
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1607108906;
        bh=n4xEgsb2TZ35maqPPbhahK9BlDM5GTNj5+76hTTx4K8=;
        h=From:To:Cc:Subject:References:In-Reply-To:From;
        b=
...
Subject: Re: [PATCH v5] f2fs: compress: add compress_inode to cache
 compressed blocks
Message-ID: <X8qJKC/lKRfh/+8s@google.com>
References: <20201202145018.6505-1-chao@kernel.org>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20201202145018.6505-1-chao@kernel.org>
Precedence: bulk
...
> index 08987923513d..db82da311fe4 100644
...
> @@ -726,25 +728,14 @@ static int f2fs_compress_pages(struct compress_ctx *cc)
>  	return ret;
>  }
>  
...
>  
> @@ -802,6 +793,7 @@ void f2fs_decompress_pages(struct bio *bio, struct page *page, bool verity)
...
>  
> @@ -838,6 +830,30 @@ void f2fs_decompress_pages(struct bio *bio, struct page *page, bool verity)
>  		f2fs_free_dic(dic);
>  }
>  
...
> @@ -1608,6 +1624,164 @@ void f2fs_decompress_end_io(struct page **rpages,
>  	}
>  }
>  
...
> index e85fd8f77f3f..06684d60491c 100644
> --- a/fs/f2fs/data.c
> +++ b/fs/f2fs/data.c
...
>  
>  	/*
> @@ -2236,6 +2243,22 @@ int f2fs_read_multi_pages(struct compress_ctx *cc, struct bio **bio_ret,
...
> index 1cd4374f77de..377a2e2bf466 100644
> --- a/fs/f2fs/f2fs.h
> +++ b/fs/f2fs/f2fs.h
...
> @@ -1292,6 +1293,9 @@ enum compress_flag {
>  	COMPRESS_MAX_FLAG,
>  };
>  
...
> @@ -1563,6 +1567,11 @@ struct f2fs_sb_info {
>  #ifdef CONFIG_F2FS_FS_COMPRESSION
...
>  };
>  
> @@ -3528,7 +3537,8 @@ struct f2fs_stat_info {
...
> @@ -3867,7 +3877,8 @@ bool f2fs_is_compress_backend_ready(struct inode *inode);
...
> @@ -3886,10 +3897,19 @@ void f2fs_decompress_end_io(struct page **rpages,
...
> @@ -3910,10 +3930,20 @@ static inline struct page *f2fs_compress_control_page(struct page *page)
>  }
...
> index 47858e0c5e95..8442333ca0e2 100644
> --- a/fs/f2fs/super.c
> +++ b/fs/f2fs/super.c
> @@ -148,6 +148,7 @@ enum {
