...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0893D266512
	for <lists+linux-kernel@lfdr.de>; Fri, 11 Sep 2020 18:52:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726294AbgIKQwX (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 11 Sep 2020 12:52:23 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46886 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726375AbgIKQuF (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 11 Sep 2020 12:50:05 -0400
Received: from mail-wr1-x441.google.com (mail-wr1-x441.google.com [IPv6:2a00:1450:4864:20::441])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8D6EFC061756;
        Fri, 11 Sep 2020 09:50:03 -0700 (PDT)
Received: by mail-wr1-x441.google.com with SMTP id a17so12142338wrn.6;
        Fri, 11 Sep 2020 09:50:03 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=sender:subject:to:cc:references:from:autocrypt:message-id:date
         ...
         :content-language;
        bh=eEAHbIxXNJnX+tLgsi/nCDbJpO2WQZMzFjZbxN4OY0A=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=eEAHbIxXNJnX+tLgsi/nCDbJpO2WQZMzFjZbxN4OY0A=;
        b=
X-Gm-Message-State: AOAM532q+942PgLScNNFsepodqiDcqM1VbHkntWiVuXOETmXFH2GU6pt
        ALp780qIfetMVoMSLMGRpUU=
X-Google-Smtp-Source: ABdhPJy2BEEqg3YPXBR9u33ubb4prAtpolBpKvBEu1om6vYgErWhDV2Wshk2A1GDVr603zR00RP0FQ==
X-Received: by 2002:a5d:5261:: with SMTP id l1mr2888470wrc.193.1599843001140;
        Fri, 11 Sep 2020 09:50:01 -0700 (PDT)
Received: from ?IPv6:2a02:8010:64ea:0:fad1:11ff:fead:57db? ([2a02:8010:64ea:0:fad1:11ff:fead:57db])
        by smtp.googlemail.com with ESMTPSA id f23sm12081379wmc.3.2020.09.11.09.49.59
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Fri, 11 Sep 2020 09:50:00 -0700 (PDT)
...
Message-ID: <2011cd8c-7dc4-b2e7-114b-d5647336ec92@harmstone.com>
Date:   Fri, 11 Sep 2020 17:49:58 +0100
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.11.0
MIME-Version: 1.0
In-Reply-To: <20200911141018.2457639-3-almaz.alexandrovich@paragon-software.com>
...
match your comments, and it'd have been picked up if you'd done that!
...
> new file mode 100644
> index 000000000000..807c6af44ecd
> --- /dev/null
> +++ b/fs/ntfs3/inode.c
> @@ -0,0 +1,2004 @@
> +// SPDX-License-Identifier: GPL-2.0
