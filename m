...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3159822551A
	for <lists+linux-kernel@lfdr.de>; Mon, 20 Jul 2020 02:47:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726801AbgGTArd (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 19 Jul 2020 20:47:33 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42238 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726589AbgGTArd (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 19 Jul 2020 20:47:33 -0400
Received: from mail-pj1-x1041.google.com (mail-pj1-x1041.google.com [IPv6:2607:f8b0:4864:20::1041])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id EE54BC0619D2
        for <linux-kernel@vger.kernel.org>; Sun, 19 Jul 2020 17:47:32 -0700 (PDT)
Received: by mail-pj1-x1041.google.com with SMTP id f16so9173096pjt.0
        for <linux-kernel@vger.kernel.org>; Sun, 19 Jul 2020 17:47:32 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=date:from:to:cc:subject:message-id:mail-followup-to:references
         :mime-version:content-disposition:in-reply-to;
        bh=MNLgO7+E9GpgW1bu3PhVkXGKNWf3ktDiRmsTGNCBOLk=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:date:from:to:cc:subject:message-id
         ...
         :in-reply-to;
        bh=MNLgO7+E9GpgW1bu3PhVkXGKNWf3ktDiRmsTGNCBOLk=;
        b=
X-Gm-Message-State: AOAM533h1q9YwJhsgjuBu7VUrkPR1HDnL2jw9t2o+e5+97r/+BFqXsR7
        gWaN3MlKEGnO0fnxasvK7n0=
X-Google-Smtp-Source: ABdhPJxIDIvVlIAXUVA7NuIKLuZzefeIOM4QikWWopiyQ9TItWiemmZFUVW2wQB9hG8cFZMno4G5dw==
X-Received: by 2002:a17:90a:db8a:: with SMTP id h10mr21483818pjv.58.1595206050603;
        Sun, 19 Jul 2020 17:47:30 -0700 (PDT)
Received: from Gentoo ([212.102.36.1])
        by smtp.gmail.com with ESMTPSA id a68sm9905262pje.35.2020.07.19.17.47.22
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 19 Jul 2020 17:47:29 -0700 (PDT)
Date:   Mon, 20 Jul 2020 06:17:09 +0530
From:   Bhaskar Chowdhury <unixbhaskar@gmail.com>
To:     Linus Torvalds <torvalds@linux-foundation.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: Re: Oops build error...Linux 5.8-rc6 
Message-ID: <20200720004709.GA16677@Gentoo>
...
In-Reply-To: <CAHk-=wj_gy9xpqFx_aLTtLtFTCTKKLfV9E2bgE5J2GeKit3MCg@mail.gmail.com>
...
Meh..well my automated script reported erros ..so some hands on stuff ...wh=
at's wrong ......or is this something I am only seeing??

bhaskar@Gentoo_06:12:21_Mon Jul 20:~/git-linux> cd linux
=E2=9C=94 ~/git-linux/linux [master|=E2=9C=94]
06:12 $ make clean
   CLEAN   arch/x86/entry/vdso
   make[3]: *** arch/x86/platform/sfi/Makefile: Input/output error.
   Stop.
   make[2]: *** [scripts/Makefile.clean:66: arch/x86/platform/sfi] Error
   2
   make[1]: *** [scripts/Makefile.clean:66: arch/x86/platform] Error 2
   make: *** [Makefile:1763: _clean_arch/x86] Error 2
...
>      ovl: fix oops in ovl_indexdir_cleanup() with nfs_export=3Don
...
>
>Chuhong Yuan (2):
>      iio: mma8452: Add missed iio_device_unregister() call in mma8452_pro=
be()
>      serial: mxs-auart: add missed iounmap() in probe failure and remove
>
>Colin Ian King (2):
>      phy: sun4i-usb: fix dereference of pointer phy0 before it is null ch=
ecked
...
>      Revert "Input: elants_i2c - report resolution information for touch =
major"
>
>Douglas Anderson (1):
...
>      dmaengine: fsl-edma: Fix NULL pointer exception in fsl_edma_tx_handl=
er
>      dmaengine: mcf-edma: Fix NULL pointer exception in mcf_edma_tx_handl=
er
...
>      HID: logitech-hidpp: avoid repeated "multiplier =3D " log messages
...
>      dmaengine: ti: k3-udma: Fix delayed_work usage for tx drain workarou=
nd
...
>
>Qi Liu (2):
>      drivers/perf: Fix kernel panic when rmmod PMU modules during perf sa=
mpling
...
>
>Saravana Kannan (3):
>      driver core: Don't do deferred probe in parallel with kernel_init th=
read
...
>      genirq/affinity: Handle affinity setting on inactive interrupts corr=
ectly
>
>Tiezhu Yang (1):
...
>
>Tony Lindgren (3):
>      bus: ti-sysc: Fix wakeirq sleeping function called from invalid cont=
ext
...

=eY3Z
-----END PGP SIGNATURE-----
