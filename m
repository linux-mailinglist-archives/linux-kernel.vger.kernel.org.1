...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7EFDE25C1DB
	for <lists+linux-kernel@lfdr.de>; Thu,  3 Sep 2020 15:49:16 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729003AbgICNtC (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 3 Sep 2020 09:49:02 -0400
Received: from mga05.intel.com ([192.55.52.43]:55119 "EHLO mga05.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728958AbgICMpv (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 3 Sep 2020 08:45:51 -0400
IronPort-SDR: Habcf4suc+/RdcUQj34o3rdxBkcbFgA6JfGr5qLhob+dzYg0FcBCie/q75lKLzVctbK3OeXQyC
 ccZAgbKjCTJQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9732"; a="242383151"
X-IronPort-AV: E=Sophos;i="5.76,386,1592895600"; 
   d="scan'208";a="242383151"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 03 Sep 2020 05:43:30 -0700
IronPort-SDR: ztGztoq1nBilL/a7c0ylc9rBu76gb4ZN28MGcHEaVPyT41fXatk7pGM8px+CgUt/VxwsLvneYn
 11bF94pd6rlQ==
X-IronPort-AV: E=Sophos;i="5.76,386,1592895600"; 
   d="scan'208";a="331776027"
Received: from shsi6026.sh.intel.com (HELO localhost) ([10.239.147.135])
  by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 03 Sep 2020 05:43:26 -0700
...
Subject: [PATCH v2 12/17] virt: acrn: Introduce interrupt injection interfaces
Date:   Thu,  3 Sep 2020 20:41:56 +0800
Message-Id: <20200903124201.17275-13-shuo.a.liu@intel.com>
...
index b2ec029ebb47..9546193456b9 100644
--- a/drivers/virt/acrn/hsm.c
+++ b/drivers/virt/acrn/hsm.c
@@ -54,7 +54,9 @@ static long acrn_dev_ioctl(struct file *filp, unsigned int cmd,
...
@@ -172,6 +174,39 @@ static long acrn_dev_ioctl(struct file *filp, unsigned int cmd,
...
+		if (ret < 0)
+			dev_err(dev, "Failed to set interrupt line!\n");
+		break;
...
+		if (ret < 0) {
+			put_page(page);
+			dev_err(dev, "Failed to monitor intr data!\n");
+			return ret;
+		}
+		if (vm->monitor_page)
...
index a237a7def494..7b3b14b53c55 100644
--- a/drivers/virt/acrn/vm.c
+++ b/drivers/virt/acrn/vm.c
@@ -65,6 +65,10 @@ int acrn_vm_destroy(struct acrn_vm *vm)
...
+	}
 	...
 	if (ret < 0) {
@@ -79,3 +83,34 @@ int acrn_vm_destroy(struct acrn_vm *vm)
