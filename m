...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B3EA31B4E88
	for <lists+linux-kernel@lfdr.de>; Wed, 22 Apr 2020 22:48:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726817AbgDVUsD (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 22 Apr 2020 16:48:03 -0400
Received: from mx0a-00082601.pphosted.com ([67.231.145.42]:39130 "EHLO
        mx0a-00082601.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726601AbgDVUra (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 22 Apr 2020 16:47:30 -0400
Received: from pps.filterd (m0044010.ppops.net [127.0.0.1])
        by mx0a-00082601.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id 03MKeMli018783
...
Received: from mail.thefacebook.com ([163.114.132.120])
        by mx0a-00082601.pphosted.com with ESMTP id 30ghjpuj58-13
...
Subject: [PATCH v3 12/19] mm: memcg/slab: use a single set of kmem_caches for all accounted allocations
...
-	struct list_head kmem_caches;
 ...
 #endif
@@ -1426,9 +1425,7 @@ static inline void memcg_set_shrinker_bit(struct me=
m_cgroup *memcg,
 }
 #endif
=20
...
--- a/mm/memcontrol.c
+++ b/mm/memcontrol.c
@@ -330,7 +330,7 @@ static void memcg_reparent_objcgs(struct mem_cgroup *=
memcg,
 }
=20
 /*
...
@@ -2910,31 +2909,24 @@ static void memcg_kmem_cache_create_func(struct w=
ork_struct *w)
 {
...
=20
@@ -2942,102 +2934,26 @@ static void memcg_schedule_kmem_cache_create(str=
...
=20
 /**
@@ -3708,7 +3624,6 @@ static int memcg_online_kmem(struct mem_cgroup *mem=
cg)
 	 */
...
@@ -3721,22 +3636,13 @@ static void memcg_offline_kmem(struct mem_cgroup =
*memcg)
=20
...
@@ -3771,10 +3677,8 @@ static void memcg_free_kmem(struct mem_cgroup *mem=
cg)
...
@@ -5363,9 +5267,6 @@ mem_cgroup_css_alloc(struct cgroup_subsys_state *pa=
rent_css)
=20
...
@@ -3862,7 +3851,8 @@ static int do_tune_cpucache(struct kmem_cache *cach=
ep, int limit,
 		return ret;
=20
...
gfp,
@@ -385,16 +325,25 @@ static inline struct kmem_cache *memcg_slab_pre_all=
...
=20
@@ -433,7 +382,6 @@ static inline void memcg_slab_post_alloc_hook(struct =
kmem_cache *s,
 		}
 	}
 	obj_cgroup_put(objcg);
...
e *page,
@@ -457,7 +405,7 @@ static inline void memcg_slab_free_hook(struct kmem_c=
...
=20
@@ -465,9 +413,6 @@ extern void memcg_link_cache(struct kmem_cache *s, st=
...
-
 ...
 {
 	return true;
@@ -489,7 +434,17 @@ static inline struct kmem_cache *memcg_root_cache(st=
ruct kmem_cache *s)
 	return s;
 }
=20
...
@@ -526,8 +481,7 @@ static inline void slab_init_memcg_params(struct kmem=
_cache *s)
 {
 }
=20
...
=20
@@ -548,17 +502,14 @@ static __always_inline int charge_slab_page(struct =
page *page,
 					    gfp_t gfp, int order,
 					    struct kmem_cache *s)
 {
...
+
 	mod_node_page_state(page_pgdat(page), cache_vmstat_idx(s),
 			    PAGE_SIZE << order);
 	return 0;
@@ -567,12 +518,9 @@ static __always_inline int charge_slab_page(struct p=
age *page,
...
@@ -721,9 +669,6 @@ static inline struct kmem_cache_node *get_node(struct=
...
-
 ...
 {
 	struct kmem_cache *s;
@@ -4303,7 +4273,7 @@ static struct kmem_cache * __init bootstrap(struct =
...
=20
@@ -4371,7 +4341,8 @@ __kmem_cache_alias(const char *name, unsigned int s=
