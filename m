...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A17501F0937
	for <lists+linux-kernel@lfdr.de>; Sun,  7 Jun 2020 03:18:01 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728893AbgFGBRt (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 6 Jun 2020 21:17:49 -0400
Received: from us-smtp-delivery-1.mimecast.com ([205.139.110.120]:57111 "EHLO
        us-smtp-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1728723AbgFGBRs (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 6 Jun 2020 21:17:48 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1591492661;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=9bUhtvFVIxyPvH377e3W0nGcFSqMIvCNQpU/Rwc1KFc=;
        b=KnmKz/LbSrHuY+CRMqlYHRJFFKS2MmU8nXa62iaCMD/BZ6W315o8+C0I9PoqiAb2HJzARk
        lDP9sHxhnDR0IxVwTfv0Dk78BEvq7L0XxiuNDoA2xCjdGezoum3HKl+gXN88VrUmC+Nm+m
        HWV08g2QnYq5k3ho5PzbkHgS21pUr/0=
...
cc:     dhowells@redhat.com, airlied@redhat.com,
        intel-gfx@lists.freedesktop.org, dri-devel@lists.freedesktop.org,
        linux-kernel@vger.kernel.org
Subject: Re: A panic and a hang in the i915 drm driver
MIME-Version: 1.0
...
[    0.007846] Initmem setup node 0 [mem 0x0000000000001000-0x000000041fdf=
ffff]
...
[    0.064070] Reserving Intel graphics memory at [mem 0xdb200000-0xdf1fff=
ff]
...
[    0.064159] IOAPIC[0]: apic_id 8, version 32, address 0xfec00000, GSI 0=
-23
...
[    0.064204] clocksource: refined-jiffies: mask: 0xffffffff max_cycles: =
0xffffffff, max_idle_ns: 7645519600211568 ns
[    0.077227] setup_percpu: NR_CPUS:4 nr_cpumask_bits:4 nr_cpu_ids:4 nr_n=
ode_ids:1
[    0.077563] percpu: Embedded 54 pages/cpu s181200 r8192 d31792 u524288
[    0.077569] pcpu-alloc: s181200 r8192 d31792 u524288 alloc=3D1*2097152
[    0.077570] pcpu-alloc: [0] 0 1 2 3 =

[    0.077588] Built 1 zonelists, mobility grouping on.  Total pages: 4097=
694
[    0.077588] Policy zone: Normal
[    0.077590] Kernel command line: BOOT_IMAGE=3D/data/tftp/andromeda-vmli=
nuz ip=3Denp3s0:dhcp console=3Dtty0 console=3DttyS0,115200 ro root=3D/dev/=
sdb2
[    0.079327] Dentry cache hash table entries: 2097152 (order: 12, 167772=
16 bytes, linear)
...
[    0.159182] Memory: 16016000K/16651052K available (12290K kernel code, =
1927K rwdata, 5372K rodata, 1608K init, 1296K bss, 635052K reserved, 0K cm=
a-reserved)
...
[    0.172294] rcu: RCU calculated value of scheduler-enlistment delay is =
25 jiffies.
[    0.175046] NR_IRQS: 4352, nr_irqs: 456, preallocated irqs: 16
[    0.175193] rcu: 	Offload RCU callbacks from CPUs: (none).
[    0.175244] random: get_random_bytes called from start_kernel+0x3f5/0x5=
c0 with crng_init=3D0
...
[    0.963468] clocksource: hpet: mask: 0xffffffff max_cycles: 0xffffffff,=
 max_idle_ns: 133484882848 ns
[    0.971296] APIC: Switch to symmetric I/O mode setup
[    0.975260] ..TIMER: vector=3D0x30 apic1=3D0 pin1=3D2 apic2=3D0 pin2=3D=
0
[    0.999294] clocksource: tsc-early: mask: 0xffffffffffffffff max_cycles=
: 0x6a6cab8f549, max_idle_ns: 881590883366 ns
[    1.008503] Calibrating delay loop (skipped), value calculated using ti=
mer frequency.. 7383.19 BogoMIPS (lpj=3D14766392)
...
[    1.030772] Mount-cache hash table entries: 32768 (order: 6, 262144 byt=
es, linear)
[    1.032558] Mountpoint-cache hash table entries: 32768 (order: 6, 26214=
4 bytes, linear)
...
[    1.044502] Last level dTLB entries: 4KB 1024, 2MB 1024, 4MB 1024, 1GB =
4
[    1.048505] Spectre V1 : Mitigation: usercopy/swapgs barriers and __use=
r pointer sanitization
[    1.052503] Spectre V2 : Spectre mitigation: kernel not compiled with r=
etpoline; no mitigation available!
...
[    1.178187] smpboot: CPU0: Intel(R) Core(TM) i3-4170 CPU @ 3.70GHz (fam=
ily: 0x6, model: 0x3c, stepping: 0x3)
[    1.180565] Performance Events: PEBS fmt2+, Haswell events, 16-deep LBR=
...
[    1.212577] NMI watchdog: Enabled. Permanently consumes one hw-PMU coun=
ter.
[    1.216539] smp: Bringing up secondary CPUs ...
[    1.220566] x86: Booting SMP configuration:
[    1.223447] .... node  #0, CPUs:      #1 #2
[    1.224922] MDS CPU bug present and SMT on, data leak possible. See htt=
...
[    1.238667] clocksource: jiffies: mask: 0xffffffff max_cycles: 0xffffff=
ff, max_idle_ns: 7645041785100000 ns
[    1.248506] futex hash table entries: 1024 (order: 4, 65536 bytes, line=
ar)
...
[    1.276507] audit: type=3D2000 audit(1591492487.292:1): state=3Dinitial=
ized audit_enabled=3D0 res=3D1
[    1.280505] cpuidle: using governor ladder
[    1.284508] cpuidle: using governor menu
[    1.288569] ACPI FADT declares the system doesn't support PCIe ASPM, so=
 disable it
[    1.292503] ACPI: bus type PCI registered
[    1.296538] PCI: MMCONFIG for domain 0000 [bus 00-3f] at [mem 0xf800000=
0-0xfbffffff] (base 0xf8000000)
[    1.304504] PCI: MMCONFIG at [mem 0xf8000000-0xfbffffff] reserved in E8=
20
[    1.308507] pmd_set_huge: Cannot satisfy [mem 0xf8000000-0xf8200000] wi=
th a huge-page mapping due to MTRR override.
[    1.320528] PCI: Using configuration type 1 for base access
[    1.324555] core: PMU erratum BJ122, BV98, HSD29 worked around, HT is o=
n
[    1.328598] ENERGY_PERF_BIAS: Set to 'normal', was 'performance'
[    1.337943] HugeTLB registered 2.00 MiB page size, pre-allocated 0 page=
s
...
[    2.480507] ACPI: SSDT 0xFFFF88840D189400 0003D3 (v01 PmRef  Cpu0Cst  0=
0003001 INTL 20051117)
[    2.488608] ACPI: Dynamic OEM Table Load:
[    2.491316] ACPI: SSDT 0xFFFF88840D153000 0005AA (v01 PmRef  ApIst    0=
0003000 INTL 20051117)
[    2.497383] ACPI: Dynamic OEM Table Load:
[    2.500506] ACPI: SSDT 0xFFFF88840D185800 000119 (v01 PmRef  ApCst    0=
0003000 INTL 20051117)
[    2.509943] ACPI: Interpreter enabled
[    2.512510] ACPI: (supports S0 S5)
[    2.514606] ACPI: Using IOAPIC for interrupt routing
[    2.516531] PCI: Using host bridge windows from ACPI; if necessary, use=
...
[    2.568507] acpi PNP0A08:00: _OSC: OS supports [ExtendedConfig ASPM Clo=
ckPM Segments MSI HPX-Type3]
[    2.576752] acpi PNP0A08:00: _OSC: platform does not support [PME]
[    2.580671] acpi PNP0A08:00: _OSC: OS now controls [AER PCIeCapability =
LTR]
[    2.588503] acpi PNP0A08:00: FADT indicates ASPM is unsupported, using =
BIOS configuration
[    2.592818] PCI host bridge to bus 0000:00
[    2.596504] pci_bus 0000:00: root bus resource [io  0x0000-0x0cf7 windo=
w]
[    2.600503] pci_bus 0000:00: root bus resource [io  0x0d00-0xffff windo=
w]
[    2.608503] pci_bus 0000:00: root bus resource [mem 0x000a0000-0x000bff=
ff window]
[    2.612503] pci_bus 0000:00: root bus resource [mem 0x000d0000-0x000d3f=
ff window]
[    2.620503] pci_bus 0000:00: root bus resource [mem 0x000d4000-0x000d7f=
ff window]
[    2.624503] pci_bus 0000:00: root bus resource [mem 0x000d8000-0x000dbf=
ff window]
[    2.632504] pci_bus 0000:00: root bus resource [mem 0x000dc000-0x000dff=
ff window]
[    2.636503] pci_bus 0000:00: root bus resource [mem 0xdf200000-0xfeafff=
ff window]
...
[    2.668510] pci 0000:00:02.0: reg 0x10: [mem 0xf7400000-0xf77fffff 64bi=
t]
[    2.672506] pci 0000:00:02.0: reg 0x18: [mem 0xe0000000-0xefffffff 64bi=
t pref]
[    2.680505] pci 0000:00:02.0: reg 0x20: [io  0xf000-0xf03f]
[    2.684576] pci 0000:00:03.0: [8086:0c0c] type 00 class 0x040300
[    2.688508] pci 0000:00:03.0: reg 0x10: [mem 0xf7c10000-0xf7c13fff 64bi=
t]
[    2.692593] pci 0000:00:14.0: [8086:8cb1] type 00 class 0x0c0330
[    2.700521] pci 0000:00:14.0: reg 0x10: [mem 0xf7c00000-0xf7c0ffff 64bi=
t]
[    2.704554] pci 0000:00:14.0: PME# supported from D3hot D3cold
[    2.708571] pci 0000:00:16.0: [8086:8cba] type 00 class 0x078000
[    2.712519] pci 0000:00:16.0: reg 0x10: [mem 0xf7c19000-0xf7c1900f 64bi=
t]
...
[    2.836516] pci 0000:00:1f.3: reg 0x10: [mem 0xf7c14000-0xf7c140ff 64bi=
t]
...
[    2.860611] pci 0000:02:00.0: 8.000 Gb/s available PCIe bandwidth, limi=
ted by 5.0 GT/s PCIe x2 link at 0000:00:1c.0 (capable of 31.504 Gb/s with =
8.0 GT/s PCIe x4 link)
[    2.872586] pci 0000:00:1c.0: PCI bridge to [bus 02]
[    2.876506] pci 0000:00:1c.0:   bridge window [mem 0xf7b00000-0xf7bffff=
f]
[    2.884546] pci 0000:03:00.0: [10ec:8168] type 00 class 0x020000
[    2.888530] pci 0000:03:00.0: reg 0x10: [io  0xe000-0xe0ff]
[    2.892528] pci 0000:03:00.0: reg 0x18: [mem 0xf7a00000-0xf7a00fff 64bi=
t]
[    2.896517] pci 0000:03:00.0: reg 0x20: [mem 0xf0000000-0xf0003fff 64bi=
t pref]
...
[    2.920505] pci 0000:00:1c.2:   bridge window [mem 0xf7a00000-0xf7affff=
f]
[    2.924505] pci 0000:00:1c.2:   bridge window [mem 0xf0000000-0xf00ffff=
f 64bit pref]
[    2.932539] pci 0000:04:00.0: [1b21:1080] type 01 class 0x060401
[    2.936660] pci 0000:00:1c.3: PCI bridge to [bus 04-05] (subtractive de=
code)
[    2.944509] pci 0000:00:1c.3:   bridge window [io  0x0000-0x0cf7 window=
] (subtractive decode)
[    2.948503] pci 0000:00:1c.3:   bridge window [io  0x0d00-0xffff window=
] (subtractive decode)
[    2.956503] pci 0000:00:1c.3:   bridge window [mem 0x000a0000-0x000bfff=
f window] (subtractive decode)
[    2.964503] pci 0000:00:1c.3:   bridge window [mem 0x000d0000-0x000d3ff=
f window] (subtractive decode)
[    2.972503] pci 0000:00:1c.3:   bridge window [mem 0x000d4000-0x000d7ff=
f window] (subtractive decode)
[    2.980503] pci 0000:00:1c.3:   bridge window [mem 0x000d8000-0x000dbff=
f window] (subtractive decode)
[    2.988503] pci 0000:00:1c.3:   bridge window [mem 0x000dc000-0x000dfff=
f window] (subtractive decode)
[    2.996503] pci 0000:00:1c.3:   bridge window [mem 0xdf200000-0xfeaffff=
f window] (subtractive decode)
[    3.004527] pci_bus 0000:05: extended config space not accessible
[    3.008570] pci 0000:04:00.0: PCI bridge to [bus 05] (subtractive decod=
e)
[    3.016518] pci 0000:04:00.0:   bridge window [io  0x0000-0x0cf7 window=
] (subtractive decode)
[    3.020504] pci 0000:04:00.0:   bridge window [io  0x0d00-0xffff window=
] (subtractive decode)
[    3.028503] pci 0000:04:00.0:   bridge window [mem 0x000a0000-0x000bfff=
f window] (subtractive decode)
[    3.036504] pci 0000:04:00.0:   bridge window [mem 0x000d0000-0x000d3ff=
f window] (subtractive decode)
[    3.044503] pci 0000:04:00.0:   bridge window [mem 0x000d4000-0x000d7ff=
f window] (subtractive decode)
[    3.052503] pci 0000:04:00.0:   bridge window [mem 0x000d8000-0x000dbff=
f window] (subtractive decode)
[    3.060503] pci 0000:04:00.0:   bridge window [mem 0x000dc000-0x000dfff=
f window] (subtractive decode)
[    3.068503] pci 0000:04:00.0:   bridge window [mem 0xdf200000-0xfeaffff=
f window] (subtractive decode)
[    3.076549] pci 0000:06:00.0: [8086:10fb] type 00 class 0x020000
[    3.080528] pci 0000:06:00.0: reg 0x10: [mem 0xf7880000-0xf78fffff 64bi=
t]
[    3.088510] pci 0000:06:00.0: reg 0x18: [io  0xd000-0xd01f]
[    3.092522] pci 0000:06:00.0: reg 0x20: [mem 0xf7900000-0xf7903fff 64bi=
t]
[    3.096510] pci 0000:06:00.0: reg 0x30: [mem 0xf7800000-0xf787ffff pref=
]
[    3.100568] pci 0000:06:00.0: PME# supported from D0 D3hot
[    3.108502] pci 0000:06:00.0: 8.000 Gb/s available PCIe bandwidth, limi=
ted by 5.0 GT/s PCIe x2 link at 0000:00:1c.4 (capable of 32.000 Gb/s with =
...
[    3.128505] pci 0000:00:1c.4:   bridge window [mem 0xf7800000-0xf79ffff=
f]
[    3.136510] ACPI: PCI Interrupt Link [LNKA] (IRQs 3 4 5 6 7 10 *11 12 1=
4 15)
[    3.140557] ACPI: PCI Interrupt Link [LNKB] (IRQs 3 4 5 6 7 10 11 12 14=
 15) *0, disabled.
[    3.148557] ACPI: PCI Interrupt Link [LNKC] (IRQs *3 4 5 6 7 10 11 12 1=
4 15)
[    3.152556] ACPI: PCI Interrupt Link [LNKD] (IRQs 3 4 5 6 7 10 11 12 14=
 *15)
[    3.160556] ACPI: PCI Interrupt Link [LNKE] (IRQs 3 4 *5 6 7 10 11 12 1=
4 15)
[    3.164555] ACPI: PCI Interrupt Link [LNKF] (IRQs 3 4 5 6 7 *10 11 12 1=
4 15)
[    3.172555] ACPI: PCI Interrupt Link [LNKG] (IRQs 3 4 5 6 7 10 11 12 14=
 15) *0, disabled.
[    3.176556] ACPI: PCI Interrupt Link [LNKH] (IRQs 3 4 5 6 7 10 11 12 *1=
4 15)
[    3.184849] iommu: Default domain type: Translated =

[    3.188515] pci 0000:00:02.0: vgaarb: setting as boot VGA device
[    3.192501] pci 0000:00:02.0: vgaarb: VGA device added: decodes=3Dio+me=
...
[    3.224505] pps_core: Software ver. 5.3.6 - Copyright 2005-2007 Rodolfo=
...
[    3.247052] NetLabel:  domain hash size =3D 128
[    3.248506] NetLabel:  protocols =3D UNLABELED CIPSOv4 CALIPSO
...
[    3.393083] system 00:00: Plug and Play ACPI device, IDs PNP0c02 (activ=
e)
[    3.393108] pnp 00:01: Plug and Play ACPI device, IDs PNP0b00 (active)
[    3.393147] system 00:02: [io  0x1854-0x1857] has been reserved
[    3.397770] system 00:02: Plug and Play ACPI device, IDs INT3f0d PNP0c0=
2 (active)
...
[    3.411720] system 00:03: Plug and Play ACPI device, IDs PNP0c02 (activ=
e)
[    3.411768] system 00:04: [io  0x04d0-0x04d1] has been reserved
[    3.416384] system 00:04: Plug and Play ACPI device, IDs PNP0c02 (activ=
e)
[    3.416625] pnp 00:05: [dma 0 disabled]
[    3.416656] pnp 00:05: Plug and Play ACPI device, IDs PNP0501 (active)
[    3.416710] pnp 00:06: Plug and Play ACPI device, IDs IFX0102 PNP0c31 (=
active)
...
[    3.464747] system 00:07: [mem 0xfee00000-0xfeefffff] could not be rese=
rved
...
[    3.481007] system 00:07: Plug and Play ACPI device, IDs PNP0c02 (activ=
e)
[    3.481204] pnp: PnP ACPI: found 8 devices
[    3.489528] clocksource: acpi_pm: mask: 0xffffff max_cycles: 0xffffff, =
max_idle_ns: 2085701024 ns
[    3.497098] pci 0000:00:01.0: PCI bridge to [bus 01]
[    3.500758] pci 0000:00:1c.0: PCI bridge to [bus 02]
[    3.504423] pci 0000:00:1c.0:   bridge window [mem 0xf7b00000-0xf7bffff=
f]
[    3.509912] pci 0000:00:1c.2: PCI bridge to [bus 03]
[    3.513575] pci 0000:00:1c.2:   bridge window [io  0xe000-0xefff]
[    3.518368] pci 0000:00:1c.2:   bridge window [mem 0xf7a00000-0xf7affff=
f]
[    3.523853] pci 0000:00:1c.2:   bridge window [mem 0xf0000000-0xf00ffff=
f 64bit pref]
...
[    3.546342] pci 0000:00:1c.4:   bridge window [mem 0xf7800000-0xf79ffff=
f]
[    3.551833] pci_bus 0000:00: resource 4 [io  0x0000-0x0cf7 window]
[    3.556706] pci_bus 0000:00: resource 5 [io  0x0d00-0xffff window]
[    3.561577] pci_bus 0000:00: resource 6 [mem 0x000a0000-0x000bffff wind=
ow]
[    3.567148] pci_bus 0000:00: resource 7 [mem 0x000d0000-0x000d3fff wind=
ow]
[    3.572711] pci_bus 0000:00: resource 8 [mem 0x000d4000-0x000d7fff wind=
ow]
[    3.578275] pci_bus 0000:00: resource 9 [mem 0x000d8000-0x000dbfff wind=
ow]
[    3.583840] pci_bus 0000:00: resource 10 [mem 0x000dc000-0x000dffff win=
dow]
[    3.589490] pci_bus 0000:00: resource 11 [mem 0xdf200000-0xfeafffff win=
dow]
...
[    3.609318] pci_bus 0000:03: resource 2 [mem 0xf0000000-0xf00fffff 64bi=
t pref]
[    3.615230] pci_bus 0000:04: resource 4 [io  0x0000-0x0cf7 window]
[    3.620099] pci_bus 0000:04: resource 5 [io  0x0d00-0xffff window]
[    3.624970] pci_bus 0000:04: resource 6 [mem 0x000a0000-0x000bffff wind=
ow]
[    3.630534] pci_bus 0000:04: resource 7 [mem 0x000d0000-0x000d3fff wind=
ow]
[    3.636096] pci_bus 0000:04: resource 8 [mem 0x000d4000-0x000d7fff wind=
ow]
[    3.641662] pci_bus 0000:04: resource 9 [mem 0x000d8000-0x000dbfff wind=
ow]
[    3.647225] pci_bus 0000:04: resource 10 [mem 0x000dc000-0x000dffff win=
dow]
[    3.652875] pci_bus 0000:04: resource 11 [mem 0xdf200000-0xfeafffff win=
dow]
[    3.658527] pci_bus 0000:05: resource 4 [io  0x0000-0x0cf7 window]
[    3.663396] pci_bus 0000:05: resource 5 [io  0x0d00-0xffff window]
[    3.668268] pci_bus 0000:05: resource 6 [mem 0x000a0000-0x000bffff wind=
ow]
[    3.673830] pci_bus 0000:05: resource 7 [mem 0x000d0000-0x000d3fff wind=
ow]
[    3.679394] pci_bus 0000:05: resource 8 [mem 0x000d4000-0x000d7fff wind=
ow]
[    3.684959] pci_bus 0000:05: resource 9 [mem 0x000d8000-0x000dbfff wind=
ow]
[    3.690530] pci_bus 0000:05: resource 10 [mem 0x000dc000-0x000dffff win=
dow]
[    3.696182] pci_bus 0000:05: resource 11 [mem 0xdf200000-0xfeafffff win=
dow]
...
[    3.714368] tcp_listen_portaddr_hash hash table entries: 8192 (order: 6=
, 327680 bytes, linear)
[    3.721733] TCP established hash table entries: 131072 (order: 8, 10485=
76 bytes, linear)
[    3.728717] TCP bind hash table entries: 65536 (order: 9, 2097152 bytes=
, linear)
[    3.735208] TCP: Hash tables configured (established 131072 bind 65536)
[    3.740558] UDP hash table entries: 8192 (order: 7, 786432 bytes, linea=
r)
[    3.746203] UDP-Lite hash table entries: 8192 (order: 7, 786432 bytes, =
linear)
...
[    3.772010] pci 0000:00:02.0: Video device with shadowed ROM at [mem 0x=
000c0000-0x000dffff]
[    3.800593] pci 0000:00:1a.0: quirk_usb_early_handoff+0x0/0x603 took 20=
830 usecs
[    3.828587] pci 0000:00:1d.0: quirk_usb_early_handoff+0x0/0x603 took 21=
383 usecs
...
[    4.043257] RAPL PMU: API unit is 2^-32 Joules, 4 fixed counters, 65536=
0 ms ovfl timer
...
[    4.073747] workingset: timestamp_bits=3D40 max_order=3D22 bucket_order=
=3D0
...
[    4.089805] SGI XFS with ACLs, security attributes, quota, no debug ena=
bled
...
[    4.111434] Block layer SCSI generic (bsg) driver version 0.4 loaded (m=
ajor 249)
...
[    4.140969] input: Power Button as /devices/LNXSYSTM:00/LNXSYBUS:00/PNP=
0C0C:00/input/input0
[    4.148013] ACPI: Power Button [PWRB]
[    4.150405] input: Power Button as /devices/LNXSYSTM:00/LNXPWRBN:00/inp=
ut/input1
...
[    4.189113] 00:05: ttyS0 at I/O 0x3f8 (irq =3D 4, base_baud =3D 115200)=
 is a 16550A
[    4.195804] i915 0000:00:02.0: vgaarb: deactivate vga console
[    4.201050] [drm] Supports vblank timestamp caching Rev 2 (21.10.2013).
[    4.206693] i915 0000:00:02.0: vgaarb: changed VGA decodes: olddecodes=3D=
io+mem,decodes=3Dio+mem:owns=3Dio+mem
[    4.226176] [drm] Initialized i915 1.6.0 20200430 for 0000:00:02.0 on m=
inor 0
[    4.233345] ACPI: Video Device [GFX0] (multi-head: yes  rom: no  post: =
no)
[    4.239141] input: Video Bus as /devices/LNXSYSTM:00/LNXSYBUS:00/PNP0A0=
8:00/LNXVIDEO:00/input/input2
[    4.248274] loop: module loaded
[    4.250269] ACPI Warning: SystemIO range 0x0000000000001828-0x000000000=
000182F conflicts with OpRegion 0x0000000000001800-0x000000000000187F (\PM=
IO) (20200326/utaddress-204)
[    4.260568] i915 0000:00:02.0: [drm] Cannot find any crtc or sizes
[    4.264448] ACPI: If an ACPI driver is available for this device, you s=
hould use it instead of the native driver
[    4.278156] ACPI Warning: SystemIO range 0x0000000000001C40-0x000000000=
0001C4F conflicts with OpRegion 0x0000000000001C00-0x0000000000001FFF (\GP=
R) (20200326/utaddress-204)
[    4.292218] ACPI: If an ACPI driver is available for this device, you s=
hould use it instead of the native driver
[    4.301081] ACPI Warning: SystemIO range 0x0000000000001C30-0x000000000=
0001C3F conflicts with OpRegion 0x0000000000001C00-0x0000000000001C3F (\GP=
RL) (20200326/utaddress-204)
[    4.307503] i915 0000:00:02.0: [drm] Cannot find any crtc or sizes
[    4.315249] ACPI Warning: SystemIO range 0x0000000000001C30-0x000000000=
0001C3F conflicts with OpRegion 0x0000000000001C00-0x0000000000001FFF (\GP=
R) (20200326/utaddress-204)
[    4.324146] i915 0000:00:02.0: [drm] Cannot find any crtc or sizes
[    4.334185] ACPI: If an ACPI driver is available for this device, you s=
hould use it instead of the native driver
[    4.347899] ACPI Warning: SystemIO range 0x0000000000001C00-0x000000000=
0001C2F conflicts with OpRegion 0x0000000000001C00-0x0000000000001C3F (\GP=
RL) (20200326/utaddress-204)
[    4.362051] ACPI Warning: SystemIO range 0x0000000000001C00-0x000000000=
0001C2F conflicts with OpRegion 0x0000000000001C00-0x0000000000001FFF (\GP=
R) (20200326/utaddress-204)
[    4.376115] ACPI: If an ACPI driver is available for this device, you s=
hould use it instead of the native driver
[    4.384972] lpc_ich: Resource conflict(s) found affecting gpio_ich
[    4.389960] ahci 0000:00:1f.2: version 3.0
[    4.390085] ahci 0000:00:1f.2: AHCI 0001.0300 32 slots 4 ports 6 Gbps 0=
xf impl SATA mode
[    4.396864] ahci 0000:00:1f.2: flags: 64bit ncq led clo pio slum part e=
ms apst =
...
[    4.443488] ata1: SATA max UDMA/133 abar m2048@0xf7c15000 port 0xf7c151=
00 irq 31
[    4.449575] ata2: SATA max UDMA/133 abar m2048@0xf7c15000 port 0xf7c151=
80 irq 31
[    4.455664] ata3: SATA max UDMA/133 abar m2048@0xf7c15000 port 0xf7c152=
00 irq 31
[    4.461748] ata4: SATA max UDMA/133 abar m2048@0xf7c15000 port 0xf7c152=
80 irq 31
[    4.478234] ahci 0000:02:00.0: AHCI 0001.0300 32 slots 1 ports 6 Gbps 0=
x1 impl SATA mode
[    4.485020] ahci 0000:02:00.0: flags: 64bit ncq led clo only pio ccc =

[    4.490352] scsi host4: ahci
[    4.491989] ata5: SATA max UDMA/133 abar m8192@0xf7b00000 port 0xf7b001=
00 irq 32
[    4.498189] tun: Universal TUN/TAP device driver, 1.6
[    4.502030] ixgbe: Intel(R) 10 Gigabit PCI Express Network Driver - ver=
sion 5.1.0-k
[    4.508394] ixgbe: Copyright (c) 1999-2016 Intel Corporation.
[    4.679612] ixgbe 0000:06:00.0: Multiqueue Enabled: Rx Queue count =3D =
4, Tx Queue count =3D 4 XDP Queue count =3D 0
[    4.688584] ixgbe 0000:06:00.0: 8.000 Gb/s available PCIe bandwidth, li=
mited by 5.0 GT/s PCIe x2 link at 0000:00:1c.4 (capable of 32.000 Gb/s wit=
h 5.0 GT/s PCIe x8 link)
[    4.702503] ixgbe 0000:06:00.0: MAC: 2, PHY: 14, SFP+: 3, PBA No: Unkno=
wn
...
[    4.720807] r8169 0000:03:00.0: can't disable ASPM; OS doesn't have ASP=
M control
[    4.737408] libphy: r8169: probed
[    4.739557] r8169 0000:03:00.0 eth1: RTL8168g/8111g, f0:79:59:65:de:78,=
 XID 4c0, IRQ 38
[    4.746257] r8169 0000:03:00.0 eth1: jumbo features [frames: 9200 bytes=
, tx checksumming: ko]
...
[    4.765898] ehci-pci 0000:00:1a.0: new USB bus registered, assigned bus=
 number 1
[    4.771993] ehci-pci 0000:00:1a.0: debug port 2
[    4.779123] ehci-pci 0000:00:1a.0: cache line size of 64 is not support=
ed
...
[    4.811891] ata1.00: 1953525168 sectors, multi 16: LBA48 NCQ (depth 32)=
, AA
[    4.816783] ehci-pci 0000:00:1a.0: USB 2.0 started, EHCI 1.00
[    4.818118] ata5.00: ATA-9: SAMSUNG MZHPV128HDGM-00000, BXW2500Q, max U=
DMA/133
[    4.818119] ata5.00: 250069680 sectors, multi 1: LBA48 NCQ (depth 32), =
AA
[    4.818329] ata5.00: configured for UDMA/133
[    4.823220] ata1.00: configured for UDMA/133
[    4.826983] hub 1-0:1.0: USB hub found
[    4.832838] scsi 0:0:0:0: Direct-Access     ATA      ST1000DM003-1CH1 C=
C49 PQ: 0 ANSI: 5
...
[    4.841384] sd 0:0:0:0: [sda] 1953525168 512-byte logical blocks: (1.00=
 TB/932 GiB)
...
[    4.841396] sd 0:0:0:0: [sda] Write cache: enabled, read cache: enabled=
, doesn't support DPO or FUA
[    4.844215] ehci-pci 0000:00:1d.0: new USB bus registered, assigned bus=
 number 2
[    4.846742] scsi 4:0:0:0: Direct-Access     ATA      SAMSUNG MZHPV128 5=
00Q PQ: 0 ANSI: 5
[    4.853453] ehci-pci 0000:00:1d.0: debug port 2
[    4.856260] sd 4:0:0:0: Attached scsi generic sg1 type 0
[    4.856280] sd 4:0:0:0: [sdb] 250069680 512-byte logical blocks: (128 G=
B/119 GiB)
[    4.856288] sd 4:0:0:0: [sdb] Write Protect is off
[    4.856289] sd 4:0:0:0: [sdb] Mode Sense: 00 3a 00 00
[    4.856300] sd 4:0:0:0: [sdb] Write cache: enabled, read cache: enabled=
, doesn't support DPO or FUA
[    4.863965] ehci-pci 0000:00:1d.0: cache line size of 64 is not support=
ed
...
[    4.978594] xhci_hcd 0000:00:14.0: new USB bus registered, assigned bus=
 number 3
[    4.989035] xhci_hcd 0000:00:14.0: hcc params 0x200077c1 hci version 0x=
100 quirks 0x0000000000009810
[    4.996865] xhci_hcd 0000:00:14.0: cache line size of 64 is not support=
ed
...
[    5.012356] xhci_hcd 0000:00:14.0: new USB bus registered, assigned bus=
 number 4
...
[    5.048465] rtc_cmos 00:01: setting system clock to 2020-06-07T01:14:52=
 UTC (1591492492)
[    5.055257] rtc_cmos 00:01: alarms up to one month, y3k, 242 bytes nvra=
m, hpet irqs
...
[    5.077851] iTCO_wdt: Found a 9 Series TCO device (Version=3D2, TCOBASE=
=3D0x1860)
[    5.083707] tsc: Refined TSC clocksource calibration: 3691.451 MHz
[    5.083757] iTCO_wdt: initialized. heartbeat=3D30 sec (nowayout=3D0)
[    5.088589] clocksource: tsc: mask: 0xffffffffffffffff max_cycles: 0x6a=
6b9449ba6, max_idle_ns: 881590891201 ns
[    5.093302] iTCO_vendor_support: vendor-support=3D0
[    5.105394] device-mapper: uevent: version 1.0.3
[    5.108737] clocksource: Switched to clocksource tsc
[    5.108762] device-mapper: ioctl: 4.42.0-ioctl (2020-02-27) initialised=
: dm-devel@redhat.com
...
[    5.166421] sched_clock: Marking stable (4357120504, 809288175)->(52171=
85576, -50776897)
...
[    5.206707] Loaded X.509 cert 'Build time autogenerated kernel key: c0a=
a0c87903d5a43603e1674589edab2dd4eb1a6'
[    5.215321] kAFS: Red Hat AFS client v0.1 registering.
[    5.219256] FS-Cache: Netfs 'afs' registered for caching
[    5.223479] Btrfs loaded, crc32c=3Dcrc32c-generic, debug=3Don, integrit=
y-checker=3Don, ref-verify=3Don
...
[    5.278704]     HOME=3D/
[    5.278704]     TERM=3Dlinux
[    5.278705]     BOOT_IMAGE=3D/data/tftp/andromeda-vmlinuz
[    5.278705]     ip=3Denp3s0:dhcp
[    5.292497] systemd[1]: systemd 239 running in system mode. (+PAM +AUDI=
...
[    5.422009] systemd[1]: File /usr/lib/systemd/system/systemd-journald.s=
ervice:26 configures an IP firewall (IPAddressDeny=3Dany), but the local s=
ystem does not support BPF/cgroup based firewalling.
[    5.438102] systemd[1]: Proceeding WITHOUT firewalling in effect! (This=
...
[    5.704833] audit: type=3D1130 audit(1591492493.152:2): pid=3D1 uid=3D0=
 auid=3D4294967295 ses=3D4294967295 subj=3Dkernel msg=3D'unit=3Dsystemd-jo=
urnald comm=3D"systemd" exe=3D"/usr/lib/systemd/systemd" hostname=3D? addr=
=3D? terminal=3D? res=3Dsuccess'
[    5.740600] audit: type=3D1130 audit(1591492493.188:3): pid=3D1 uid=3D0=
 auid=3D4294967295 ses=3D4294967295 subj=3Dkernel msg=3D'unit=3Dsystemd-vc=
onsole-setup comm=3D"systemd" exe=3D"/usr/lib/systemd/systemd" hostname=3D=
? addr=3D? terminal=3D? res=3Dsuccess'
[    5.759627] audit: type=3D1131 audit(1591492493.188:4): pid=3D1 uid=3D0=
 auid=3D4294967295 ses=3D4294967295 subj=3Dkernel msg=3D'unit=3Dsystemd-vc=
onsole-setup comm=3D"systemd" exe=3D"/usr/lib/systemd/systemd" hostname=3D=
? addr=3D? terminal=3D? res=3Dsuccess'
[    5.792571] audit: type=3D1130 audit(1591492493.240:5): pid=3D1 uid=3D0=
 auid=3D4294967295 ses=3D4294967295 subj=3Dkernel msg=3D'unit=3Dsystemd-tm=
pfiles-setup-dev comm=3D"systemd" exe=3D"/usr/lib/systemd/systemd" hostnam=
e=3D? addr=3D? terminal=3D? res=3Dsuccess'
[    5.824597] audit: type=3D1130 audit(1591492493.272:6): pid=3D1 uid=3D0=
 auid=3D4294967295 ses=3D4294967295 subj=3Dkernel msg=3D'unit=3Dsystemd-sy=
sctl comm=3D"systemd" exe=3D"/usr/lib/systemd/systemd" hostname=3D? addr=3D=
? terminal=3D? res=3Dsuccess'
[    5.888651] audit: type=3D1130 audit(1591492493.336:7): pid=3D1 uid=3D0=
 auid=3D4294967295 ses=3D4294967295 subj=3Dkernel msg=3D'unit=3Dsystemd-tm=
pfiles-setup comm=3D"systemd" exe=3D"/usr/lib/systemd/systemd" hostname=3D=
? addr=3D? terminal=3D? res=3Dsuccess'
[    5.920619] audit: type=3D1130 audit(1591492493.368:8): pid=3D1 uid=3D0=
 auid=3D4294967295 ses=3D4294967295 subj=3Dkernel msg=3D'unit=3Ddracut-cmd=
line comm=3D"systemd" exe=3D"/usr/lib/systemd/systemd" hostname=3D? addr=3D=
? terminal=3D? res=3Dsuccess'
[    5.968699] audit: type=3D1130 audit(1591492493.416:9): pid=3D1 uid=3D0=
 auid=3D4294967295 ses=3D4294967295 subj=3Dkernel msg=3D'unit=3Ddracut-pre=
-udev comm=3D"systemd" exe=3D"/usr/lib/systemd/systemd" hostname=3D? addr=3D=
? terminal=3D? res=3Dsuccess'
[    6.020600] audit: type=3D1130 audit(1591492493.468:10): pid=3D1 uid=3D=
0 auid=3D4294967295 ses=3D4294967295 subj=3Dkernel msg=3D'unit=3Dsystemd-u=
devd comm=3D"systemd" exe=3D"/usr/lib/systemd/systemd" hostname=3D? addr=3D=
? terminal=3D? res=3Dsuccess'
...
[    6.564043] EXT4-fs (sdb2): mounted filesystem with ordered data mode. =
Opts: (null)
[    6.724445] kauditd_printk_skb: 4 callbacks suppressed
[    6.724447] audit: type=3D1130 audit(1591492494.168:15): pid=3D1 uid=3D=
0 auid=3D4294967295 ses=3D4294967295 subj=3Dkernel msg=3D'unit=3Dinitrd-pa=
rse-etc comm=3D"systemd" exe=3D"/usr/lib/systemd/systemd" hostname=3D? add=
r=3D? terminal=3D? res=3Dsuccess'
[    6.748244] audit: type=3D1131 audit(1591492494.168:16): pid=3D1 uid=3D=
0 auid=3D4294967295 ses=3D4294967295 subj=3Dkernel msg=3D'unit=3Dinitrd-pa=
rse-etc comm=3D"systemd" exe=3D"/usr/lib/systemd/systemd" hostname=3D? add=
r=3D? terminal=3D? res=3Dsuccess'
[    6.926226] audit: type=3D1130 audit(1591492494.372:17): pid=3D1 uid=3D=
0 auid=3D4294967295 ses=3D4294967295 subj=3Dkernel msg=3D'unit=3Ddracut-pr=
e-pivot comm=3D"systemd" exe=3D"/usr/lib/systemd/systemd" hostname=3D? add=
r=3D? terminal=3D? res=3Dsuccess'
[    6.949110] audit: type=3D1131 audit(1591492494.396:18): pid=3D1 uid=3D=
0 auid=3D4294967295 ses=3D4294967295 subj=3Dkernel msg=3D'unit=3Ddracut-pr=
e-pivot comm=3D"systemd" exe=3D"/usr/lib/systemd/systemd" hostname=3D? add=
r=3D? terminal=3D? res=3Dsuccess'
[    6.969876] audit: type=3D1130 audit(1591492494.416:19): pid=3D1 uid=3D=
0 auid=3D4294967295 ses=3D4294967295 subj=3Dkernel msg=3D'unit=3Dsystemd-t=
mpfiles-setup comm=3D"systemd" exe=3D"/usr/lib/systemd/systemd" hostname=3D=
? addr=3D? terminal=3D? res=3Dsuccess'
[    6.989403] audit: type=3D1131 audit(1591492494.416:20): pid=3D1 uid=3D=
0 auid=3D4294967295 ses=3D4294967295 subj=3Dkernel msg=3D'unit=3Dsystemd-t=
mpfiles-setup comm=3D"systemd" exe=3D"/usr/lib/systemd/systemd" hostname=3D=
? addr=3D? terminal=3D? res=3Dsuccess'
[    7.010288] audit: type=3D1130 audit(1591492494.460:21): pid=3D1 uid=3D=
0 auid=3D4294967295 ses=3D4294967295 subj=3Dkernel msg=3D'unit=3Ddracut-in=
itqueue comm=3D"systemd" exe=3D"/usr/lib/systemd/systemd" hostname=3D? add=
r=3D? terminal=3D? res=3Dsuccess'
[    7.029843] audit: type=3D1131 audit(1591492494.460:22): pid=3D1 uid=3D=
0 auid=3D4294967295 ses=3D4294967295 subj=3Dkernel msg=3D'unit=3Ddracut-in=
itqueue comm=3D"systemd" exe=3D"/usr/lib/systemd/systemd" hostname=3D? add=
r=3D? terminal=3D? res=3Dsuccess'
[    7.029933] audit: type=3D1130 audit(1591492494.476:23): pid=3D1 uid=3D=
0 auid=3D4294967295 ses=3D4294967295 subj=3Dkernel msg=3D'unit=3Dsystemd-s=
ysctl comm=3D"systemd" exe=3D"/usr/lib/systemd/systemd" hostname=3D? addr=3D=
? terminal=3D? res=3Dsuccess'
[    7.068200] audit: type=3D1131 audit(1591492494.476:24): pid=3D1 uid=3D=
0 auid=3D4294967295 ses=3D4294967295 subj=3Dkernel msg=3D'unit=3Dsystemd-s=
ysctl comm=3D"systemd" exe=3D"/usr/lib/systemd/systemd" hostname=3D? addr=3D=
? terminal=3D? res=3Dsuccess'
[    7.199317] systemd-journald[1910]: Received SIGTERM from PID 1 (system=
d).
[    7.218785] printk: systemd: 11 output lines suppressed due to ratelimi=
ting
[    7.375860] SELinux:  Permission watch in class filesystem not defined =
in policy.
[    7.382044] SELinux:  Permission watch in class file not defined in pol=
icy.
[    7.387694] SELinux:  Permission watch_mount in class file not defined =
in policy.
[    7.393866] SELinux:  Permission watch_sb in class file not defined in =
policy.
[    7.399777] SELinux:  Permission watch_with_perm in class file not defi=
ned in policy.
[    7.406293] SELinux:  Permission watch_reads in class file not defined =
in policy.
[    7.412466] SELinux:  Permission watch in class dir not defined in poli=
cy.
[    7.418037] SELinux:  Permission watch_mount in class dir not defined i=
n policy.
[    7.424122] SELinux:  Permission watch_sb in class dir not defined in p=
olicy.
[    7.429947] SELinux:  Permission watch_with_perm in class dir not defin=
ed in policy.
[    7.436385] SELinux:  Permission watch_reads in class dir not defined i=
n policy.
[    7.442473] SELinux:  Permission watch in class lnk_file not defined in=
 policy.
[    7.448475] SELinux:  Permission watch_mount in class lnk_file not defi=
ned in policy.
[    7.454991] SELinux:  Permission watch_sb in class lnk_file not defined=
 in policy.
[    7.461250] SELinux:  Permission watch_with_perm in class lnk_file not =
defined in policy.
[    7.468112] SELinux:  Permission watch_reads in class lnk_file not defi=
ned in policy.
[    7.474632] SELinux:  Permission watch in class chr_file not defined in=
 policy.
[    7.480636] SELinux:  Permission watch_mount in class chr_file not defi=
ned in policy.
[    7.487153] SELinux:  Permission watch_sb in class chr_file not defined=
 in policy.
[    7.493411] SELinux:  Permission watch_with_perm in class chr_file not =
defined in policy.
[    7.500274] SELinux:  Permission watch_reads in class chr_file not defi=
ned in policy.
[    7.506795] SELinux:  Permission watch in class blk_file not defined in=
 policy.
[    7.512798] SELinux:  Permission watch_mount in class blk_file not defi=
ned in policy.
[    7.519316] SELinux:  Permission watch_sb in class blk_file not defined=
 in policy.
[    7.525572] SELinux:  Permission watch_with_perm in class blk_file not =
defined in policy.
[    7.532438] SELinux:  Permission watch_reads in class blk_file not defi=
ned in policy.
[    7.538955] SELinux:  Permission watch in class sock_file not defined i=
n policy.
[    7.545038] SELinux:  Permission watch_mount in class sock_file not def=
ined in policy.
[    7.551643] SELinux:  Permission watch_sb in class sock_file not define=
d in policy.
[    7.557988] SELinux:  Permission watch_with_perm in class sock_file not=
 defined in policy.
[    7.564946] SELinux:  Permission watch_reads in class sock_file not def=
ined in policy.
[    7.571553] SELinux:  Permission watch in class fifo_file not defined i=
n policy.
[    7.577643] SELinux:  Permission watch_mount in class fifo_file not def=
ined in policy.
[    7.584245] SELinux:  Permission watch_sb in class fifo_file not define=
d in policy.
[    7.590591] SELinux:  Permission watch_with_perm in class fifo_file not=
 defined in policy.
[    7.597542] SELinux:  Permission watch_reads in class fifo_file not def=
ined in policy.
...
[    7.617379] SELinux: the above unknown classes and permissions will be =
allowed
[    7.623300] SELinux:  policy capability network_peer_controls=3D1
[    7.627908] SELinux:  policy capability open_perms=3D1
[    7.631566] SELinux:  policy capability extended_socket_class=3D1
[    7.636177] SELinux:  policy capability always_check_network=3D0
[    7.640701] SELinux:  policy capability cgroup_seclabel=3D1
[    7.644791] SELinux:  policy capability nnp_nosuid_transition=3D1
[    7.649402] SELinux:  policy capability genfs_seclabel_symlinks=3D0
[    7.684944] systemd[1]: Successfully loaded SELinux policy in 416.158ms=
.
[    7.754705] systemd[1]: Relabelled /dev, /run and /sys/fs/cgroup in 52.=
855ms.
[    7.762864] systemd[1]: systemd 239 running in system mode. (+PAM +AUDI=
T +SELINUX +IMA -APPARMOR +SMACK +SYSVINIT +UTMP +LIBCRYPTSETUP +GCRYPT +G=
NUTLS +ACL +XZ +LZ4 +SECCOMP +BLKID +ELFUTILS +KMOD +IDN2 -IDN +PCRE2 defa=
ult-hierarchy=3Dhybrid)
[    7.800637] systemd[1]: Detected architecture x86-64.
[    7.805413] systemd[1]: Set hostname to <andromeda.procyon.org.uk>.
[    7.871918] systemd[1]: File /usr/lib/systemd/system/systemd-journald.s=
ervice:26 configures an IP firewall (IPAddressDeny=3Dany), but the local s=
ystem does not support BPF/cgroup based firewalling.
[    7.887999] systemd[1]: Proceeding WITHOUT firewalling in effect! (This=
 warning is only shown for the first loaded unit using IP firewalling.)
[    8.011700] systemd[1]: Stopped Switch Root.
[    8.014934] systemd[1]: systemd-journald.service: Service has no hold-o=
ff time (RestartSec=3D0), scheduling restart.
[    8.025363] systemd[1]: systemd-journald.service: Scheduled restart job=
...
[    8.126253] systemd-journald[3397]: Received request to flush runtime j=
ournal from PID 1
[    8.140536] Adding 67108860k swap on /dev/sda1.  Priority:-2 extents:1 =
across:67108860k =

[    8.660947] EXT4-fs (sdb1): mounted filesystem with ordered data mode. =
Opts: (null)
[    8.665412] EXT4-fs (sdb5): mounted filesystem with ordered data mode. =
Opts: (null)
[    8.667800] ext4 filesystem being mounted at /boot supports timestamps =
until 2038 (0x7fffffff)
[    9.311410] Generic FE-GE Realtek PHY r8169-300:00: attached PHY driver=
 [Generic FE-GE Realtek PHY] (mii_bus:phy_addr=3Dr8169-300:00, irq=3DIGNOR=
E)
...
[    9.996542] ixgbe 0000:06:00.0 enp6s0: NIC Link is Up 10 Gbps, Flow Con=
trol: RX/TX
...
[   10.421249] ixgbe 0000:06:00.0 enp6s0: NIC Link is Up 10 Gbps, Flow Con=
trol: RX/TX
[   10.457505] device virbr0-nic left promiscuous mode
[   10.461093] virbr0: port 1(virbr0-nic) entered disabled state
[   12.185669] r8169 0000:03:00.0 enp3s0: Link is Up - 1Gbps/Full - flow c=
ontrol rx/tx
