...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 506852DC6DC
	for <lists+linux-kernel@lfdr.de>; Wed, 16 Dec 2020 20:05:12 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732990AbgLPTED (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 16 Dec 2020 14:04:03 -0500
Received: from mga14.intel.com ([192.55.52.115]:53480 "EHLO mga14.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727242AbgLPTED (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 16 Dec 2020 14:04:03 -0500
IronPort-SDR: 12RtCYNRkQGErkKgEFk7aHSw8GR0VpLANMbbHhoU/KMTn++6sCZRyXMhcTCekaGyw12sxiDnxo
 P+BpYiLQt/bw==
X-IronPort-AV: E=McAfee;i="6000,8403,9837"; a="174349563"
X-IronPort-AV: E=Sophos;i="5.78,425,1599548400"; 
   d="scan'208";a="174349563"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 16 Dec 2020 10:59:41 -0800
IronPort-SDR: RHAMHQCVIsvE5H8nZBwciJl3OCgPvCVt/fU1mr7pjbMun53s6xw2MpYp8MpEI9WGRw0vyZ3AxD
 RikpNif2zOzg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,425,1599548400"; 
   d="scan'208";a="342165173"
Received: from labuser-ice-lake-client-platform.jf.intel.com ([10.54.55.65])
  by orsmga006.jf.intel.com with ESMTP; 16 Dec 2020 10:59:41 -0800
...
Subject: [PATCH V3 6/9] perf tools: Add support for PERF_SAMPLE_CODE_PAGE_SIZE
Date:   Wed, 16 Dec 2020 10:58:02 -0800
Message-Id: <20201216185805.9981-7-kan.liang@linux.intel.com>
...
index fd3911650612..17f131cdd528 100644
--- a/tools/perf/builtin-record.c
+++ b/tools/perf/builtin-record.c
@@ -2474,6 +2474,8 @@ static struct option __record_options[] = {
...
index c26ea82220bd..992b9723e0ae 100644
...
index 2947e3f3c6d9..590f5e0c88e3 100644
