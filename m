...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5DB7F280EAD
	for <lists+linux-kernel@lfdr.de>; Fri,  2 Oct 2020 10:21:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387641AbgJBIVX (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 2 Oct 2020 04:21:23 -0400
Received: from mga12.intel.com ([192.55.52.136]:39600 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725961AbgJBIVX (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 2 Oct 2020 04:21:23 -0400
IronPort-SDR: BdWARgXS5MV6CC4mqDe0tmMGuDvtukw0B3z680IOHi0t2fBbuH4VZ3Gv8zcQex3T8gyaPmQx47
 K+kbRRDyisyg==
X-IronPort-AV: E=McAfee;i="6000,8403,9761"; a="142335140"
X-IronPort-AV: E=Sophos;i="5.77,326,1596524400"; 
   d="yaml'?scan'208";a="142335140"
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 02 Oct 2020 01:21:14 -0700
IronPort-SDR: mUW0U1yrl6+oRtKvRZi0Pzm/hVzKY/wT86IMzTz6FEyD/7P3r/0OZJpx5Twaa0SjWc3GnT0XSQ
 Tg5E+73JUx6w==
X-IronPort-AV: E=Sophos;i="5.77,326,1596524400"; 
   d="yaml'?scan'208";a="507470522"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.3])
  by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 02 Oct 2020 01:21:10 -0700
Date:   Fri, 2 Oct 2020 16:20:23 +0800
...
Subject: [kprobes] d002b8bc6d: will-it-scale.per_process_ops 8.4% improvement
Message-ID: <20201002082023.GG393@shao2-debian>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.8.0-rc1-00004-gd002b8bc6dbc2"
...
queue_at_least_once'
	...
	export submit_id='5f74f8a7ad83ab19b5e9129e'
	export job_file='/lkp/jobs/scheduled/lkp-csl-2ap3/will-it-scale-performance-process-50%-signal1-ucode=0x5002f01-monitor=a122c70f-debian-10.4-x86_64-20200603.cgz-d002b8bc6dbc20e90-20201001-6581-k9gqa-2.yaml'
	export id='3b5e38cfaa201fa89c9ec5dccf67e1da80e53cdc'
	...
	export commit='d002b8bc6dbc20e9043e279196cff8795dba05fe'
	export need_kconfig_hw='CONFIG_IGB=y
CONFIG_BLK_DEV_NVME'
	export ucode='0x5002f01'
	export enqueue_time='2020-10-01 05:29:11 +0800'
	export _id='5f74f8a7ad83ab19b5e9129e'
	export _rt='/result/will-it-scale/performance-process-50%-signal1-ucode=0x5002f01-monitor=a122c70f/lkp-csl-2ap3/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/d002b8bc6dbc20e9043e279196cff8795dba05fe'
	export user='lkp'
	export compiler='gcc-9'
	export head_commit='1f0a58d75c9252d4c740d36eeaae9801e1976d80'
	export base_commit='dcb7fd82c75ee2d6e6f9d8cc71c52519ed52e258'
	export branch='linus/master'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export result_root='/result/will-it-scale/performance-process-50%-signal1-ucode=0x5002f01-monitor=a122c70f/lkp-csl-2ap3/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/d002b8bc6dbc20e9043e279196cff8795dba05fe/3'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-csl-2ap3/will-it-scale-performance-process-50%-signal1-ucode=0x5002f01-monitor=a122c70f-debian-10.4-x86_64-20200603.cgz-d002b8bc6dbc20e90-20201001-6581-k9gqa-2.yaml
ARCH=x86_64
kconfig=x86_64-rhel-8.3
branch=linus/master
commit=d002b8bc6dbc20e9043e279196cff8795dba05fe
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/d002b8bc6dbc20e9043e279196cff8795dba05fe/vmlinuz-5.8.0-rc1-00004-gd002b8bc6dbc2
acpi_rsdp=0x67f44014
max_uptime=3600
RESULT_ROOT=/result/will-it-scale/performance-process-50%-signal1-ucode=0x5002f01-monitor=a122c70f/lkp-csl-2ap3/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/d002b8bc6dbc20e9043e279196cff8795dba05fe/3
LKP_SERVER=inn
nokaslr
selinux=0
debug
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/d002b8bc6dbc20e9043e279196cff8795dba05fe/modules.cgz'
	...
	export last_kernel='5.9.0-rc4-00129-g411790a2e587ac'
	export repeat_to=4
	export queue_at_least_once=1
	export monitor_sha='a122c70f'
	export schedule_notify_address=
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/d002b8bc6dbc20e9043e279196cff8795dba05fe/vmlinuz-5.8.0-rc1-00004-gd002b8bc6dbc2'
	export dequeue_time='2020-10-01 05:37:00 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2ap3/will-it-scale-performance-process-50%-signal1-ucode=0x5002f01-monitor=a122c70f-debian-10.4-x86_64-20200603.cgz-d002b8bc6dbc20e90-20201001-6581-k9gqa-2.cgz'
...
run_job()
{
	...
	run_test mode='process' test='signal1' $LKP_SRC/tests/wrapper will-it-scale
}
...
kconfig: x86_64-rhel-8.3
submit_id: 5f74eef0ad83ab1795b4071f
job_file: "/lkp/jobs/scheduled/lkp-csl-2ap3/will-it-scale-performance-process-50%-signal1-ucode=0x5002f01-monitor=a122c70f-debian-10.4-x86_64-20200603.cgz-d002b8bc6dbc20e90-20201001-6037-emuvxw-1.yaml"
id: dc1422fb488bb55b631492d9a739e0896c8a770c
...
- CONFIG_BLK_DEV_NVME
ucode: '0x5002f01'
enqueue_time: 2020-10-01 04:47:44.411106682 +08:00
_id: 5f74eef3ad83ab1795b40720
_rt: "/result/will-it-scale/performance-process-50%-signal1-ucode=0x5002f01-monitor=a122c70f/lkp-csl-2ap3/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/d002b8bc6dbc20e9043e279196cff8795dba05fe"

#! schedule options
user: lkp
compiler: gcc-9
head_commit: 1f0a58d75c9252d4c740d36eeaae9801e1976d80
base_commit: dcb7fd82c75ee2d6e6f9d8cc71c52519ed52e258
branch: linux-next/master
rootfs: debian-10.4-x86_64-20200603.cgz
result_root: "/result/will-it-scale/performance-process-50%-signal1-ucode=0x5002f01-monitor=a122c70f/lkp-csl-2ap3/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/d002b8bc6dbc20e9043e279196cff8795dba05fe/0"
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-csl-2ap3/will-it-scale-performance-process-50%-signal1-ucode=0x5002f01-monitor=a122c70f-debian-10.4-x86_64-20200603.cgz-d002b8bc6dbc20e90-20201001-6037-emuvxw-1.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- branch=linux-next/master
- commit=d002b8bc6dbc20e9043e279196cff8795dba05fe
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/d002b8bc6dbc20e9043e279196cff8795dba05fe/modules.cgz"
...
#! /lkp/lkp/.src-20200911-111442/include/site/inn
schedule_notify_address: 

#! user overrides
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/d002b8bc6dbc20e9043e279196cff8795dba05fe/vmlinuz-5.8.0-rc1-00004-gd002b8bc6dbc2"
dequeue_time: 2020-10-01 04:48:05.188449025 +08:00

#! /lkp/lkp/.src-20200929-201421/include/site/inn
job_state: finished
loadavg: 74.47 58.14 26.24 1/1281 12880
start_time: '1601498942'
end_time: '1601499243'
...
do
 ...
 "/lkp/benchmarks/python3/bin/python3" "./runtest.py" "signal1" "295" "process" "96"
