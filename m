...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 83E3C1F32B0
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Jun 2020 05:46:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727015AbgFIDqY (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 8 Jun 2020 23:46:24 -0400
Received: from m43-7.mailgun.net ([69.72.43.7]:42304 "EHLO m43-7.mailgun.net"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726915AbgFIDqW (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 8 Jun 2020 23:46:22 -0400
DKIM-Signature: a=rsa-sha256; v=1; c=relaxed/relaxed; d=mg.codeaurora.org; q=dns/txt;
 s=smtp; t=1591674366; h=Content-Transfer-Encoding: MIME-Version:
 Message-Id: Date: Subject: Cc: To: From: Sender;
 bh=bIpnbLtudatWRaEYnOBxwuwAaZ8kPwdYLWomMyubulk=; b=rCnJsAQ7oy+qIrdn0I+ozkY9G+qxH/SbANJ+YiS1SpDE4GKT3wYACrw9TmQr7l6dpWt/nnhS
 H65hxeePf4oo/bXpK+iLgAfJfv1Pe7gxAVs/e+I9rPzBY5MpxnG4RwwhrtEQWNvvrkumM0R9
 A24456Ylu+qZjVekfo6zsQ9RP8w=
X-Mailgun-Sending-Ip: 69.72.43.7
X-Mailgun-Sid: WyI0MWYwYSIsICJsaW51eC1rZXJuZWxAdmdlci5rZXJuZWwub3JnIiwgImJlOWU0YSJd
Received: from smtp.codeaurora.org
 (ec2-35-166-182-171.us-west-2.compute.amazonaws.com [35.166.182.171]) by
 smtp-out-n10.prod.us-west-2.postgun.com with SMTP id
 5edf05f43b3439f23a5e8fa3 (version=TLS1.2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256); Tue, 09 Jun 2020 03:45:56
 GMT
Received: by smtp.codeaurora.org (Postfix, from userid 1001)
        id 0A4A8C433CB; Tue,  9 Jun 2020 03:45:56 +0000 (UTC)
...
Received: from tanmshah-linux.qualcomm.com (i-global254.qualcomm.com [199.106.103.254])
        ...
        by smtp.codeaurora.org (Postfix) with ESMTPSA id CAE5AC433CA;
        Tue,  9 Jun 2020 03:45:36 +0000 (UTC)
DMARC-Filter: OpenDMARC Filter v1.3.2 smtp.codeaurora.org CAE5AC433CA
...
Date:   Mon,  8 Jun 2020 20:45:26 -0700
Message-Id: <20200609034526.10752-1-tanmay@codeaurora.org>
...
@@ -399,8 +444,9 @@ void msm_rd_dump_submit(struct msm_rd_state *rd, struct msm_gem_submit *submit,
 #else
...
+			const char *fmt, ...) {}
 ...
 #endif
@@ -418,7 +464,8 @@ void __iomem *msm_ioremap(struct platform_device *pdev, const char *name,
