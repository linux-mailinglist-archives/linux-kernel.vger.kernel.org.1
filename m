...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8B9AA252BDF
	for <lists+linux-kernel@lfdr.de>; Wed, 26 Aug 2020 12:58:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728811AbgHZK5h (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 26 Aug 2020 06:57:37 -0400
Received: from mail.kernel.org ([198.145.29.99]:42900 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728759AbgHZK4Y (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 26 Aug 2020 06:56:24 -0400
Received: from localhost (83-86-89-107.cable.dynamic.v4.ziggo.nl [83.86.89.107])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 7458B2087C;
        Wed, 26 Aug 2020 10:56:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1598439378;
        bh=pV6nRdwAPyXXGbyZI11TrUDjBLaUqXFFQEAtbtQZBxI=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=QIblZI7mP5KF8xxGXA2K90RGoPB4pH6vAVBN129fXHGQPjxCXTMQlYlSCTg3mMdT6
         bGmYFTA/fs23pNTUg8xc7jAcd6vehSqH3ul5RmhvHtAGsyQvQdhjblv2NxqO+N74Go
         XUIcxvKftZ6BSeBrz9Rtc0qRLSXMwxbbfrT6poXc=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 5.4.61
Date:   Wed, 26 Aug 2020 12:56:21 +0200
Message-Id: <1598439380226125@kroah.com>
X-Mailer: git-send-email 2.28.0
In-Reply-To: <1598439380235254@kroah.com>
References: <1598439380235254@kroah.com>
MIME-Version: 1.0
...
index 7c001e21e28e..2c21b922644d 100644
--- a/Makefile
+++ b/Makefile
@@ -1,7 +1,7 @@
...
index 38b2df0e7109..8920ee7b2881 100644
...
index 499845c32b1b..0d7a173f8e61 100644
...
index 701f5d2fe3b6..cf7a0a65aae8 100644
...
index 4b0ee34aa65d..a1498df419b4 100644
--- a/fs/btrfs/super.c
+++ b/fs/btrfs/super.c
...
index 54589e940f9a..c346ee7ec18d 100644
...
index 6307c1d883e0..0d9b1e2b9da7 100644
--- a/fs/eventpoll.c
+++ b/fs/eventpoll.c
...
@@ -2192,13 +2195,13 @@ SYSCALL_DEFINE4(epoll_ctl, int, epfd, int, op, int, fd,
 			mutex_lock(&epmutex);
...
@@ -2222,8 +2225,6 @@ SYSCALL_DEFINE4(epoll_ctl, int, epfd, int, op, int, fd,
...
-			clear_tfile_check_list();
 	...
 	case EPOLL_CTL_DEL:
 		if (epi)
@@ -2246,8 +2247,10 @@ SYSCALL_DEFINE4(epoll_ctl, int, epfd, int, op, int, fd,
 	mutex_unlock(&ep->mtx);
...
index a564d0289a70..36a81b57012a 100644
--- a/fs/ext4/namei.c
+++ b/fs/ext4/namei.c
...
@@ -2462,7 +2472,7 @@ int ext4_generic_delete_entry(handle_t *handle,
...
index adbb8fef2216..50fa3e08c02f 100644
--- a/fs/gfs2/bmap.c
+++ b/fs/gfs2/bmap.c
...
index 719f49d1fba2..3623d1c5343f 100644
--- a/mm/khugepaged.c
+++ b/mm/khugepaged.c
...
index 8686fe760f34..67a9943aa595 100644
--- a/mm/page_alloc.c
+++ b/mm/page_alloc.c
...
@@ -7867,7 +7872,7 @@ int __meminit init_per_zone_wmark_min(void)
...
index 0f8c77f84711..a94909ad9a53 100644
...
index 88629906f314..06bbcfbb2815 100644
...
index 767ac4eab4fe..7501ec8a4600 100644
...
+
 ...
 {
@@ -2045,18 +2051,21 @@ static int handle_hva_to_gpa(struct kvm *kvm,
