...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8D2AF1F8C56
	for <lists+linux-kernel@lfdr.de>; Mon, 15 Jun 2020 04:50:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728167AbgFOCue (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 14 Jun 2020 22:50:34 -0400
Received: from mga17.intel.com ([192.55.52.151]:19480 "EHLO mga17.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727954AbgFOCud (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 14 Jun 2020 22:50:33 -0400
IronPort-SDR: F/Rppda8z8rujUdHZtJQVGfteStr/4H9YNXj1p+V/ot82QHHfcgJ5ljy6Cn0sX+LA79+HsHNhI
 e4hfwXl2AQbA==
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 14 Jun 2020 17:49:49 -0700
IronPort-SDR: PhKbK/xNLDN7ud0RXLlIJ522h9phFT86EzSbmmNXsI3vH5sgriR8dL81mcCa9lxPiZfQQXUrkA
 gazX5BsPHX7g==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,513,1583222400"; 
   d="xz'?yaml'?scan'208";a="272587395"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.3])
  by orsmga003.jf.intel.com with ESMTP; 14 Jun 2020 17:49:45 -0700
Date:   Mon, 15 Jun 2020 08:49:15 +0800
...
Subject: [fs] 5b41b05dd7:
 packetdrill.packetdrill/gtests/net/tcp/inq/client_ipv4.fail
Message-ID: <20200615004915.GT12456@shao2-debian>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="/x1fcI38Qzc3pqTp"
...
commit: 5b41b05dd7dbec4d7285b2d6c11883d4ed779c02 ("[PATCH] fs: Do not check if there is a fsnotify watcher on pseudo inodes")
url: https://github.com/0day-ci/linux/commits/Mel-Gorman/fs-Do-not-check-if-there-is-a-fsnotify-watcher-on-pseudo-inodes/20200612-172852
...
Content-Disposition: attachment; filename="config-5.7.0-13357-g5b41b05dd7dbe"
...
export_top_env()
{
	...
	export job_origin='/lkp-src/allot/cyclic:p2:linux-devel:devel-hourly/lkp-ivb-2ep1/packetdrill.yaml'
...
queue_at_least_once'
	...
	export submit_id='5ee5abc9e10243443373f8ac'
	export job_file='/lkp/jobs/scheduled/lkp-ivb-2ep1/packetdrill-ucode=0x42e-debian-x86_64-20191114.cgz-5b41b05dd7dbec4d7285b2d6c11883d4ed779c02-20200614-17459-15xiqdi-3.yaml'
	export id='e9cc952a823cf296b6854f1eae0d26fad7146e85'
	...
	export commit='5b41b05dd7dbec4d7285b2d6c11883d4ed779c02'
...
CONFIG_ATA_PIIX
CONFIG_SCSI_SAS_ATA=y'
	export enqueue_time='2020-06-14 12:47:05 +0800'
	export _id='5ee5abcfe10243443373f8ad'
	export _rt='/result/packetdrill/ucode=0x42e/lkp-ivb-2ep1/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-9/5b41b05dd7dbec4d7285b2d6c11883d4ed779c02'
	export user='lkp'
	export compiler='gcc-9'
	export head_commit='1d6f225998676bd95829d804b8aff82c66505a38'
	...
	export result_root='/result/packetdrill/ucode=0x42e/lkp-ivb-2ep1/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-9/5b41b05dd7dbec4d7285b2d6c11883d4ed779c02/3'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-ivb-2ep1/packetdrill-ucode=0x42e-debian-x86_64-20191114.cgz-5b41b05dd7dbec4d7285b2d6c11883d4ed779c02-20200614-17459-15xiqdi-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-7.6
branch=linux-devel/devel-hourly-2020061319
commit=5b41b05dd7dbec4d7285b2d6c11883d4ed779c02
BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-9/5b41b05dd7dbec4d7285b2d6c11883d4ed779c02/vmlinuz-5.7.0-13357-g5b41b05dd7dbe
max_uptime=3600
RESULT_ROOT=/result/packetdrill/ucode=0x42e/lkp-ivb-2ep1/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-9/5b41b05dd7dbec4d7285b2d6c11883d4ed779c02/3
LKP_SERVER=inn
nokaslr
selinux=0
debug
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-7.6/gcc-9/5b41b05dd7dbec4d7285b2d6c11883d4ed779c02/modules.cgz'
	export bm_initrd='/osimage/deps/debian-x86_64-20180403.cgz/run-ipconfig_2018-04-03.cgz,/osimage/deps/debian-x86_64-20180403.cgz/lkp_2019-08-05.cgz,/osimage/deps/debian-x86_64-20180403.cgz/rsync-rootfs_2018-04-03.cgz,/osimage/deps/debian-x86_64-20180403.cgz/packetdrill_20200424.cgz,/osimage/pkg/debian-x86_64-20180403.cgz/packetdrill-x86_64-5da3aa6-1_20200218.cgz,/osimage/deps/debian-x86_64-20180403.cgz/hw_2020-01-02.cgz'
	export ucode_initrd='/osimage/ucode/intel-ucode-20191114.cgz'
	export lkp_initrd='/osimage/user/lkp/lkp-x86_64.cgz'
	export site='inn'
	export LKP_CGI_PORT=80
	export LKP_CIFS_PORT=139
	export last_kernel='5.7.0-15526-gc9ddb8de07140'
	export repeat_to=4
	export schedule_notify_address=
	export queue_at_least_once=1
	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-9/5b41b05dd7dbec4d7285b2d6c11883d4ed779c02/vmlinuz-5.7.0-13357-g5b41b05dd7dbe'
	export dequeue_time='2020-06-14 12:50:53 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-ivb-2ep1/packetdrill-ucode=0x42e-debian-x86_64-20191114.cgz-5b41b05dd7dbec4d7285b2d6c11883d4ed779c02-20200614-17459-15xiqdi-3.cgz'
...

...
2020-06-14 12:51:37 packetdrill/packetdrill --tolerance_usecs=40000 packetdrill/tests/bsd/fast_retransmit/fr-4pkt-sack-bsd.pkt
...
2020-06-14 12:51:38 packetdrill/packetdrill --tolerance_usecs=40000 packetdrill/tests/linux/fast_retransmit/fr-4pkt-sack-linux.pkt
...
2020-06-14 12:51:38 packetdrill/packetdrill --tolerance_usecs=40000 packetdrill/tests/linux/packetdrill/socket_err.pkt
...
2020-06-14 12:51:38 packetdrill/packetdrill --tolerance_usecs=40000 packetdrill/tests/linux/packetdrill/socket_wrong_err.pkt
...
stdout: 
/proc/net/tcp:   0: BEABA8C0:1F90 00000000:0000 0A 00000000:00000000 00:00000000 00000000     0        0 191062 2 00000000bdf68ee1 100 0 0 10 1                    
stderr: 
...
stdout: 
/proc/net/tcp6:   0: 7BFA3DFD00007DD10000000000D6D58E:1F90 00000000000000000000000000000000:0000 0A 00000000:00000000 00:00000000 00000000     0        0 192483 2 0000000012e69379 100 0 0 10 1
stderr: 
...
stdout: 
/proc/net/tcp6:   1: 0000000000000000FFFF0000BD20A8C0:1F90 00000000000000000000000000000000:0000 0A 00000000:00000000 00:00000000 00000000     0        0 123095 2 00000000bcd0aca1 100 0 0 10 1
stderr: 
...
stdout: 
stderr: 
Ran  219 tests:  201 passing,   18 failing,    0 timed out (14.63 sec): tcp
...
need_memory: 1G
packetdrill: 
job_origin: "/lkp-src/allot/cyclic:p2:linux-devel:devel-hourly/lkp-ivb-2ep1/packetdrill.yaml"
...
kconfig: x86_64-rhel-7.6
submit_id: 5ee554e29522bd622baffc2d
job_file: "/lkp/jobs/scheduled/lkp-ivb-2ep1/packetdrill-ucode=0x42e-debian-x86_64-20191114.cgz-5b41b05dd7dbec4d7285b2d6c11883d4ed779c02-20200614-25131-1gdqdk-0.yaml"
id: da9afb40db5cf38fb47b844db20f8ade4fbb0db7
...
- CONFIG_ATA_PIIX
- CONFIG_SCSI_SAS_ATA=y
enqueue_time: 2020-06-14 06:36:19.120582524 +08:00
_id: 5ee554e29522bd622baffc2d
_rt: "/result/packetdrill/ucode=0x42e/lkp-ivb-2ep1/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-9/5b41b05dd7dbec4d7285b2d6c11883d4ed779c02"

#! schedule options
user: lkp
compiler: gcc-9
head_commit: 1d6f225998676bd95829d804b8aff82c66505a38
base_commit: 3d77e6a8804abcc0504c904bd6e5cdf3a5cf8162
branch: linux-devel/devel-hourly-2020061319
rootfs: debian-x86_64-20191114.cgz
result_root: "/result/packetdrill/ucode=0x42e/lkp-ivb-2ep1/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-9/5b41b05dd7dbec4d7285b2d6c11883d4ed779c02/0"
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-ivb-2ep1/packetdrill-ucode=0x42e-debian-x86_64-20191114.cgz-5b41b05dd7dbec4d7285b2d6c11883d4ed779c02-20200614-25131-1gdqdk-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2020061319
- commit=5b41b05dd7dbec4d7285b2d6c11883d4ed779c02
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-9/5b41b05dd7dbec4d7285b2d6c11883d4ed779c02/modules.cgz"
...
#! runtime status
last_kernel: 5.7.0-16558-g0d7bd892b03a0
schedule_notify_address: 

#! user overrides
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-9/5b41b05dd7dbec4d7285b2d6c11883d4ed779c02/vmlinuz-5.7.0-13357-g5b41b05dd7dbe"
dequeue_time: 2020-06-14 06:38:15.706208369 +08:00
job_state: failed
loadavg: 10.71 2.74 0.92 1/904 10384
start_time: '1592087938'
end_time: '1592087953'
