...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 133061C86EA
	for <lists+linux-kernel@lfdr.de>; Thu,  7 May 2020 12:35:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727788AbgEGKdQ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 7 May 2020 06:33:16 -0400
Received: from us-smtp-delivery-1.mimecast.com ([205.139.110.120]:51236 "EHLO
        us-smtp-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1727099AbgEGKdL (ORCPT
...
Subject: [PATCH v3 08/15] virtio-mem: Offline and remove completely unplugged memory blocks
...
@@ -446,6 +446,28 @@ static int virtio_mem_mb_remove(struct virtio_mem *v=
...
+
  ...
  */
@@ -537,7 +559,13 @@ static void virtio_mem_notify_offline(struct virtio_=
mem *vm,
 		break;
 	}
=20
...
=20
@@ -1284,7 +1312,8 @@ static int virtio_mem_mb_unplug_any_sb_offline(stru=
ct virtio_mem *vm,
...
d.
@@ -1340,9 +1369,19 @@ static int virtio_mem_mb_unplug_any_sb_online(stru=
ct virtio_mem *vm,
 	}
=20
 	/*
