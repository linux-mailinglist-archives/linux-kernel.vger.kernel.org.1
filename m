...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 65E062CB4D7
	for <lists+linux-kernel@lfdr.de>; Wed,  2 Dec 2020 07:07:58 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728607AbgLBGGC (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 2 Dec 2020 01:06:02 -0500
Received: from mga17.intel.com ([192.55.52.151]:51856 "EHLO mga17.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728462AbgLBGGB (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 2 Dec 2020 01:06:01 -0500
IronPort-SDR: NXkqgDJkvtJ/6NLri8WTZ0GPUxImk1hMHn53Sc0iTNo1iD5OmhlTz7X2WXX3Cesmr8uOP+BpoR
 zy7DRMoxIIqA==
X-IronPort-AV: E=McAfee;i="6000,8403,9822"; a="152787690"
X-IronPort-AV: E=Sophos;i="5.78,385,1599548400"; 
   d="scan'208";a="152787690"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 01 Dec 2020 22:04:12 -0800
IronPort-SDR: hi+et3TTdD6oBHz+Ll37CjFlycC9vrybsF1Q0DAD+bgMfAc0SPF0U7doMZz3Ci7TIWoKBDkMZs
 rcsic66brH3w==
X-IronPort-AV: E=Sophos;i="5.78,385,1599548400"; 
   d="scan'208";a="549908260"
Received: from xingzhen-mobl.ccr.corp.intel.com (HELO [10.238.4.68]) ([10.238.4.68])
  by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 01 Dec 2020 22:04:07 -0800
Subject: Re: [LKP] Re: [fs/select.c] c191bb1b91: will-it-scale.per_thread_ops
 -2.3% regression
To:     Daniel Axtens <dja@axtens.net>, lkp <oliver.sang@intel.com>
Cc:     0day robot <lkp@intel.com>, LKML <linux-kernel@vger.kernel.org>,
        lkp@lists.01.org, zhengjun.xing@intel.com, viro@zeniv.linux.org.uk,
        linux-fsdevel@vger.kernel.org, David.Laight@ACULAB.COM,
        hch@infradead.org
References: <20201129150722.GB29840@xsang-OptiPlex-9020>
 <87blffhdy4.fsf@dja-thinkpad.axtens.net>
From:   Xing Zhengjun <zhengjun.xing@linux.intel.com>
Message-ID: <d8578174-e29b-9022-911f-1eae2e8754a6@linux.intel.com>
Date:   Wed, 2 Dec 2020 14:04:05 +0800
User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:78.0) Gecko/20100101
 Thunderbird/78.5.0
MIME-Version: 1.0
In-Reply-To: <87blffhdy4.fsf@dja-thinkpad.axtens.net>
...
On 11/30/2020 8:43 AM, Daniel Axtens wrote:
> Hi,
> 
...
>     https://lore.kernel.org/linux-fsdevel/20200813071120.2113039-1-dja@axtens.net/T/#u
>     and does less copying at the price of a more complex loop.
> 
I re-test each case for 4 times, the v1 version patch has -2.0% regression.
=========================================================================================
tbox_group/testcase/rootfs/kconfig/compiler/nr_task/mode/test/cpufreq_governor/ucode/debug-setup:
 
lkp-hsw-4ex1/will-it-scale/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/16/thread/poll1/performance/0x16/test

commit:
   c2e7554e1b85935d962127efa3c2a76483b0b3b6
   ebb9d0cccded0436f6d0612e17261a10d0a9f236 (patch v2)
   14531ce897733d844a1976b4bb802febf6967760 (patch v1)

c2e7554e1b85935d ebb9d0cccded0436f6d0612e172 14531ce897733d844a1976b4bb8
---------------- --------------------------- ---------------------------
          %stddev     %change         %stddev     %change         %stddev
              \          |                \          |                \
   21139098            -2.4%   20626226            -2.0%   20709323 
    will-it-scale.16.threads
    1321193            -2.4%    1289138            -2.0%    1294332 
...
> https://lore.kernel.org/linux-fsdevel/20200813071120.2113039-1-dja@axtens.net/T/#ed9fd3ddcefc48c1d4288dcdfc062a1131c1c9f5b
...
>> 	export submit_id='5fc0c18cd9d6801629cbbe4f'
>> 	export job_file='/lkp/jobs/scheduled/lkp-hsw-4ex1/will-it-scale-performance-thread-16-poll1-ucode=0x16-monitor=6e02c248-debian-10.4-x86_64-20200603.cgz-c191bb1b91be4744f0cdf595dc-20201127-5673-317lhz-2.yaml'
>> 	export id='302592ecf97e02f0cb817d710357901121651ea4'
...
>> 	export commit='c191bb1b91be4744f0cdf595dccbd4036cf24f5f'
>> 	export ucode='0x16'
>> 	export kernel_cmdline_hw='cma=0'
>> 	export need_kconfig_hw='CONFIG_IXGBE=y
>> CONFIG_SCSI_MPT3SAS
>> CONFIG_SATA_AHCI'
>> 	export enqueue_time='2020-11-27 17:06:20 +0800'
>> 	export _id='5fc0c18cd9d6801629cbbe4f'
>> 	export _rt='/result/will-it-scale/performance-thread-16-poll1-ucode=0x16-monitor=6e02c248/lkp-hsw-4ex1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/c191bb1b91be4744f0cdf595dccbd4036cf24f5f'
>> 	export user='lkp'
...
>> 	export branch='linux-review/Daniel-Axtens/fs-select-c-batch-user-writes-in-do_sys_poll/20201119-084654'
>> 	export rootfs='debian-10.4-x86_64-20200603.cgz'
>> 	export monitor_sha='6e02c248'
>> 	export result_root='/result/will-it-scale/performance-thread-16-poll1-ucode=0x16-monitor=6e02c248/lkp-hsw-4ex1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/c191bb1b91be4744f0cdf595dccbd4036cf24f5f/3'
...
>> user=lkp
>> job=/lkp/jobs/scheduled/lkp-hsw-4ex1/will-it-scale-performance-thread-16-poll1-ucode=0x16-monitor=6e02c248-debian-10.4-x86_64-20200603.cgz-c191bb1b91be4744f0cdf595dc-20201127-5673-317lhz-2.yaml
>> ARCH=x86_64
>> kconfig=x86_64-rhel-8.3
>> branch=linux-review/Daniel-Axtens/fs-select-c-batch-user-writes-in-do_sys_poll/20201119-084654
>> commit=c191bb1b91be4744f0cdf595dccbd4036cf24f5f
>> BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/c191bb1b91be4744f0cdf595dccbd4036cf24f5f/vmlinuz-5.10.0-rc4-00108-gc191bb1b91be
>> cma=0
>> max_uptime=2400
>> RESULT_ROOT=/result/will-it-scale/performance-thread-16-poll1-ucode=0x16-monitor=6e02c248/lkp-hsw-4ex1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/c191bb1b91be4744f0cdf595dccbd4036cf24f5f/3
...
>> vga=normal
>> rw'
>> 	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/c191bb1b91be4744f0cdf595dccbd4036cf24f5f/modules.cgz'
...
>> 	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/c191bb1b91be4744f0cdf595dccbd4036cf24f5f/vmlinuz-5.10.0-rc4-00108-gc191bb1b91be'
>> 	export dequeue_time='2020-11-27 17:19:19 +0800'
>> 	export job_initrd='/lkp/jobs/scheduled/lkp-hsw-4ex1/will-it-scale-performance-thread-16-poll1-ucode=0x16-monitor=6e02c248-debian-10.4-x86_64-20200603.cgz-c191bb1b91be4744f0cdf595dc-20201127-5673-317lhz-2.cgz'
>>
>> 	[ -n "$LKP_SRC" ] ||
...
>>
>> 	run_test mode='thread' test='poll1' $LKP_SRC/tests/wrapper will-it-scale
>> }
>>
>> extract_stats()
>> {
...
>> job_file: "/lkp/jobs/scheduled/lkp-hsw-4ex1/will-it-scale-performance-thread-16-poll1-ucode=0x16-monitor=6e02c248-debian-10.4-x86_64-20200603.cgz-c191bb1b91be4744f0cdf595dc-20201127-4518-yvot1u-0.yaml"
...
>> _rt: "/result/will-it-scale/performance-thread-16-poll1-ucode=0x16-monitor=6e02c248/lkp-hsw-4ex1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/c191bb1b91be4744f0cdf595dccbd4036cf24f5f"
>>
>> #! schedule options
>> user: lkp
>> compiler: gcc-9
...
>> result_root: "/result/will-it-scale/performance-thread-16-poll1-ucode=0x16-monitor=6e02c248/lkp-hsw-4ex1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/c191bb1b91be4744f0cdf595dccbd4036cf24f5f/1"
...
>> - root=/dev/ram0
>> - user=lkp
>> - job=/lkp/jobs/scheduled/lkp-hsw-4ex1/will-it-scale-performance-thread-16-poll1-ucode=0x16-monitor=6e02c248-debian-10.4-x86_64-20200603.cgz-c191bb1b91be4744f0cdf595dc-20201127-4518-yvot1u-0.yaml
>> - ARCH=x86_64
>> - kconfig=x86_64-rhel-8.3
>> - branch=linux-devel/devel-hourly-2020112414
>> - commit=c191bb1b91be4744f0cdf595dccbd4036cf24f5f
...
>> - vga=normal
>> - rw
>> modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/c191bb1b91be4744f0cdf595dccbd4036cf24f5f/modules.cgz"
...
>> kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/c191bb1b91be4744f0cdf595dccbd4036cf24f5f/vmlinuz-5.10.0-rc4-00108-gc191bb1b91be"
...
>> done
>>
>>   "/lkp/benchmarks/python3/bin/python3" "./runtest.py" "poll1" "295" "thread" "16"
