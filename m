...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 54BB7203193
	for <lists+linux-kernel@lfdr.de>; Mon, 22 Jun 2020 10:09:38 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726673AbgFVIJg (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 22 Jun 2020 04:09:36 -0400
Received: from mail.kernel.org ([198.145.29.99]:43304 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726383AbgFVIJC (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 22 Jun 2020 04:09:02 -0400
Received: from localhost (83-86-89-107.cable.dynamic.v4.ziggo.nl [83.86.89.107])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id CFC562083E;
        Mon, 22 Jun 2020 08:08:45 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1592813327;
        bh=fBGNLd5/UGvpG8QRVV1ooLElQFGXqgxURdMt2TlnHtU=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=x5xsheKtO2IfA0XAzFcoX5I+WdnwZzC4DI9Z6fvdssMDjOmdBCsqoDxL1Q2B90QGl
         fYjEGvAdMFibQsjaRCynSeOehNjWmZQxRcK0HedQYlCduOaAh7PKnCiv69rVQAqRc7
         iU1Ib9qt7MYTSnkAKrWZvf/sWJUflUqcFIvXgqPg=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 5.4.48
Date:   Mon, 22 Jun 2020 10:08:34 +0200
Message-Id: <159281331313871@kroah.com>
X-Mailer: git-send-email 2.27.0
In-Reply-To: <15928133133012@kroah.com>
References: <15928133133012@kroah.com>
MIME-Version: 1.0
...
@@ -115,31 +138,40 @@ static void notify_handler(acpi_handle handle, u32 event, void *context)
...
@@ -1132,7 +1133,7 @@ static noinline int cow_file_range(struct inode *inode,
 	 */
 	if (extent_reserved) {
...
@@ -1569,9 +1630,9 @@ static noinline int run_delalloc_nocow(struct inode *inode,
...
@@ -1660,8 +1721,8 @@ static noinline int run_delalloc_nocow(struct inode *inode,
...
@@ -8584,7 +8644,8 @@ static int btrfs_submit_direct_hook(struct btrfs_dio_private *dip)
 	if (!status)
 		return 0;
...
+			do_chunk_alloc = true;
 		...
 		/*
@@ -593,6 +599,19 @@ start_transaction(struct btrfs_root *root, unsigned int num_items,
...
@@ -634,6 +635,8 @@ static int kgdb_cpu_enter(struct kgdb_state *ks, struct pt_regs *regs,
...
@@ -706,6 +709,8 @@ static int kgdb_cpu_enter(struct kgdb_state *ks, struct pt_regs *regs,
