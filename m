...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C3E5F2B333E
	for <lists+linux-kernel@lfdr.de>; Sun, 15 Nov 2020 10:43:50 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726869AbgKOJlf (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 15 Nov 2020 04:41:35 -0500
Received: from mga07.intel.com ([134.134.136.100]:44542 "EHLO mga07.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726834AbgKOJl3 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 15 Nov 2020 04:41:29 -0500
IronPort-SDR: vDrRLgtkg9I+Yt69ZNH7lSEQOtqfSPFb1qIjwOH9nDp8Sks8+2AEMub32mQpT13nEY9qujGb6Q
 Bspi+EwaOr6g==
X-IronPort-AV: E=McAfee;i="6000,8403,9805"; a="234791900"
X-IronPort-AV: E=Sophos;i="5.77,480,1596524400"; 
   d="yaml'?scan'208";a="234791900"
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 15 Nov 2020 01:41:22 -0800
IronPort-SDR: dcn49KZjMX1DenVZDa5KUzFwJzokDGyPYBJZuorsC/UuQfuAZb91sVG5erqqHT//wT+OQK8oyd
 F28JVnzSASoA==
X-IronPort-AV: E=Sophos;i="5.77,480,1596524400"; 
   d="yaml'?scan'208";a="543205756"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.140])
  by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 15 Nov 2020 01:41:17 -0800
Date:   Sun, 15 Nov 2020 17:55:44 +0800
...
Message-ID: <20201115095543.GC32502@xsang-OptiPlex-9020>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.7.0-03920-gbe5d0a74c62d8d"
...
export_top_env()
{
	...
	export nr_task=96
	export job_origin='/lkp-src/allot/cyclic:p1:internal-devel:devel-hourly/lkp-csl-2ap3/will-it-scale-part3.yaml'
...
queue_at_least_once'
	...
	export submit_id='5faf3ece208aae2b441fd0a6'
	export job_file='/lkp/jobs/scheduled/lkp-csl-2ap3/will-it-scale-performance-thread-50%-page_fault2-ucode=0x5002f01-monitor=3472ca3d-debian-10.4-x86_64-20200603.cgz-be5d0a74c62d8d-20201114-11076-1c1l7nl-2.yaml'
	export id='a4f9d768e70ba61ff04c2117b948789ce653f8ae'
	...
	export commit='be5d0a74c62d8da43f9526a5b08cdd18e2bbc37a'
	export need_kconfig_hw='CONFIG_IGB=y
CONFIG_BLK_DEV_NVME'
	export ucode='0x5002f01'
	export enqueue_time='2020-11-14 10:19:58 +0800'
	export _id='5faf3ece208aae2b441fd0a6'
	export _rt='/result/will-it-scale/performance-thread-50%-page_fault2-ucode=0x5002f01-monitor=3472ca3d/lkp-csl-2ap3/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/be5d0a74c62d8da43f9526a5b08cdd18e2bbc37a'
	export user='lkp'
	export compiler='gcc-9'
	export head_commit='2b8d703dfd8d257b968e977f87decf01819750c8'
	export base_commit='bbf5c979011a099af5dc76498918ed7df445635b'
	export branch='linus/master'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export monitor_sha='3472ca3d'
	export result_root='/result/will-it-scale/performance-thread-50%-page_fault2-ucode=0x5002f01-monitor=3472ca3d/lkp-csl-2ap3/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/be5d0a74c62d8da43f9526a5b08cdd18e2bbc37a/3'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-csl-2ap3/will-it-scale-performance-thread-50%-page_fault2-ucode=0x5002f01-monitor=3472ca3d-debian-10.4-x86_64-20200603.cgz-be5d0a74c62d8d-20201114-11076-1c1l7nl-2.yaml
ARCH=x86_64
kconfig=x86_64-rhel-8.3
branch=linus/master
commit=be5d0a74c62d8da43f9526a5b08cdd18e2bbc37a
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/be5d0a74c62d8da43f9526a5b08cdd18e2bbc37a/vmlinuz-5.7.0-03920-gbe5d0a74c62d8d
acpi_rsdp=0x67f44014
max_uptime=3600
RESULT_ROOT=/result/will-it-scale/performance-thread-50%-page_fault2-ucode=0x5002f01-monitor=3472ca3d/lkp-csl-2ap3/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/be5d0a74c62d8da43f9526a5b08cdd18e2bbc37a/3
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/be5d0a74c62d8da43f9526a5b08cdd18e2bbc37a/modules.cgz'
	...
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/be5d0a74c62d8da43f9526a5b08cdd18e2bbc37a/vmlinuz-5.7.0-03920-gbe5d0a74c62d8d'
	export dequeue_time='2020-11-14 10:26:40 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2ap3/will-it-scale-performance-thread-50%-page_fault2-ucode=0x5002f01-monitor=3472ca3d-debian-10.4-x86_64-20200603.cgz-be5d0a74c62d8d-20201114-11076-1c1l7nl-2.cgz'
...
will-it-scale:
  mode: thread
  test: page_fault2
job_origin: "/lkp-src/allot/cyclic:p1:internal-devel:devel-hourly/lkp-csl-2ap3/will-it-scale-part3.yaml"
...
kconfig: x86_64-rhel-8.3
submit_id: 5faf382e208aae29f3aa937e
job_file: "/lkp/jobs/scheduled/lkp-csl-2ap3/will-it-scale-performance-thread-50%-page_fault2-ucode=0x5002f01-monitor=3472ca3d-debian-10.4-x86_64-20200603.cgz-be5d0a74c62d8d-20201114-10739-urf30j-0.yaml"
id: f7d565a2ada11aaa044f8d90ccd654df9a3d53e2
...
- CONFIG_BLK_DEV_NVME
ucode: '0x5002f01'
enqueue_time: 2020-11-14 09:51:42.673169320 +08:00
_id: 5faf382e208aae29f3aa937e
_rt: "/result/will-it-scale/performance-thread-50%-page_fault2-ucode=0x5002f01-monitor=3472ca3d/lkp-csl-2ap3/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/be5d0a74c62d8da43f9526a5b08cdd18e2bbc37a"

#! schedule options
user: lkp
compiler: gcc-9
head_commit: 2b8d703dfd8d257b968e977f87decf01819750c8
base_commit: bbf5c979011a099af5dc76498918ed7df445635b
branch: linus/master
rootfs: debian-10.4-x86_64-20200603.cgz
monitor_sha: 3472ca3d
result_root: "/result/will-it-scale/performance-thread-50%-page_fault2-ucode=0x5002f01-monitor=3472ca3d/lkp-csl-2ap3/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/be5d0a74c62d8da43f9526a5b08cdd18e2bbc37a/0"
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-csl-2ap3/will-it-scale-performance-thread-50%-page_fault2-ucode=0x5002f01-monitor=3472ca3d-debian-10.4-x86_64-20200603.cgz-be5d0a74c62d8d-20201114-10739-urf30j-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- branch=linus/master
- commit=be5d0a74c62d8da43f9526a5b08cdd18e2bbc37a
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/be5d0a74c62d8da43f9526a5b08cdd18e2bbc37a/modules.cgz"
...
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/be5d0a74c62d8da43f9526a5b08cdd18e2bbc37a/vmlinuz-5.7.0-03920-gbe5d0a74c62d8d"
dequeue_time: 2020-11-14 10:05:00.602884008 +08:00
job_state: finished
loadavg: 80.83 59.65 26.75 1/1275 13105
start_time: '1605319805'
end_time: '1605320109'
version: "/lkp/lkp/.src-20201113-130618:5b55e845:7f3cba39e-dirty"
...
do
 ...
 "/lkp/benchmarks/python3/bin/python3" "./runtest.py" "page_fault2" "295" "thread" "96"
