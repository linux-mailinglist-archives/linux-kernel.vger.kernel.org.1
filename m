...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 67F582926C6
	for <lists+linux-kernel@lfdr.de>; Mon, 19 Oct 2020 13:53:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728312AbgJSLxU (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 19 Oct 2020 07:53:20 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45378 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728269AbgJSLxP (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 19 Oct 2020 07:53:15 -0400
Received: from mail-pj1-x1041.google.com (mail-pj1-x1041.google.com [IPv6:2607:f8b0:4864:20::1041])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E22BBC0613D0
        for <linux-kernel@vger.kernel.org>; Mon, 19 Oct 2020 04:53:14 -0700 (PDT)
Received: by mail-pj1-x1041.google.com with SMTP id az3so5190828pjb.4
        for <linux-kernel@vger.kernel.org>; Mon, 19 Oct 2020 04:53:14 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=android.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=ydt8JoTpjy+VU1pgt4ywv6n85iJkgYfGoMtqBuMU1h8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=ydt8JoTpjy+VU1pgt4ywv6n85iJkgYfGoMtqBuMU1h8=;
        b=
X-Gm-Message-State: AOAM531YEpudnHfFz9tVOxX/KlX4VzPYMPSc7kk3Lb2XS7dRZjEOq2Rr
        mYWMa4Bo3a5BPoRXkGAqds5xy7aFvARfgA==
X-Google-Smtp-Source: ABdhPJz5EEF7/hCZMKo7NwYHBoAErMSm5XM/bawbrMvBI0y2AJRsJOVwmkJl5DFMhbre4PtxXSOXqg==
X-Received: by 2002:a17:90a:3e4a:: with SMTP id t10mr16810990pjm.151.1603108394073;
        Mon, 19 Oct 2020 04:53:14 -0700 (PDT)
Received: from nebulus.mtv.corp.google.com ([2620:15c:211:200:4a0f:cfff:fe35:d61b])
        by smtp.gmail.com with ESMTPSA id w68sm12128099pfb.108.2020.10.19.04.53.12
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 19 Oct 2020 04:53:13 -0700 (PDT)
...
Subject: [PATCH v16 1/4] Add flags option to get xattr method paired to __vfs_getxattr
Date:   Mon, 19 Oct 2020 04:52:36 -0700
Message-Id: <20201019115239.2732422-2-salyzyn@android.com>
...
---
 ...
 49 files changed, 133 insertions(+), 89 deletions(-)
...
index 6e95c85fe395..33efea1da3bb 100644
--- a/fs/nfs/nfs4proc.c
+++ b/fs/nfs/nfs4proc.c
@@ -7401,7 +7401,8 @@ static int nfs4_xattr_set_nfs4_acl(const struct xattr_handler *handler,
...
@@ -7426,7 +7427,8 @@ static int nfs4_xattr_set_nfs4_label(const struct xattr_handler *handler,
...
@@ -7503,7 +7505,8 @@ static int nfs4_xattr_set_nfs4_user(const struct xattr_handler *handler,
