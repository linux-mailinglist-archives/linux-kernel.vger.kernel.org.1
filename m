...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 362392F5B8F
	for <lists+linux-kernel@lfdr.de>; Thu, 14 Jan 2021 08:52:08 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727505AbhANHuk (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 14 Jan 2021 02:50:40 -0500
Received: from szxga06-in.huawei.com ([45.249.212.32]:10966 "EHLO
        szxga06-in.huawei.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727319AbhANHuj (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 14 Jan 2021 02:50:39 -0500
Received: from DGGEMS406-HUB.china.huawei.com (unknown [172.30.72.58])
        by szxga06-in.huawei.com (SkyGuard) with ESMTP id 4DGbzk27D0zj5hb;
...
Subject: [PATCH v2 1/2] perf tools: add 'perf irq' to measure the hardware interrupts
Date:   Thu, 14 Jan 2021 15:48:51 +0800
Message-ID: <20210114074852.13231-2-cuibixuan@huawei.com>
...
index 000000000000..58dd1a488edf
--- /dev/null
...
+		NULL
+	};
+	const char *const irq_subcommands[] = { "record", "report", "script",
+						NULL };
...
+	} else if (!strncmp(argv[0], "report", 11)) {
+		if (argc > 1) {
