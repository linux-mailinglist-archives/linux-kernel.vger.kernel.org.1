...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 805902E6FA0
	for <lists+linux-kernel@lfdr.de>; Tue, 29 Dec 2020 11:24:20 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726371AbgL2KXZ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 29 Dec 2020 05:23:25 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48712 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726189AbgL2KXY (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 29 Dec 2020 05:23:24 -0500
Received: from mail-wr1-x434.google.com (mail-wr1-x434.google.com [IPv6:2a00:1450:4864:20::434])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1E9CEC061799
        for <linux-kernel@vger.kernel.org>; Tue, 29 Dec 2020 02:22:44 -0800 (PST)
Received: by mail-wr1-x434.google.com with SMTP id w5so14186506wrm.11
        for <linux-kernel@vger.kernel.org>; Tue, 29 Dec 2020 02:22:44 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=bgdev-pl.20150623.gappssmtp.com; s=20150623;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=brKzI07OrCgLgZNXcEIweSdzyPpH8dhYXtEgqrfQyCA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=brKzI07OrCgLgZNXcEIweSdzyPpH8dhYXtEgqrfQyCA=;
        b=
X-Gm-Message-State: AOAM530ZTHiMIFyHmcBvYbpQ4VRV+doc9q3t9ESgLisjDnb/kBCz5C/D
        nAN7NkpfV7XSZb2KfWkwTp9vZQ==
X-Google-Smtp-Source: ABdhPJyFCWqreOZbXwfKEOyM2dgyOCdpwVbSfFe+QokygSzNZT5wJfZ1ljrro6v1qSySP4dKNr7i1w==
X-Received: by 2002:adf:9d82:: with SMTP id p2mr42807368wre.330.1609237362839;
        Tue, 29 Dec 2020 02:22:42 -0800 (PST)
Received: from debian-brgl.home (amarseille-656-1-4-167.w90-8.abo.wanadoo.fr. [90.8.158.167])
        by smtp.gmail.com with ESMTPSA id h5sm61174512wrp.56.2020.12.29.02.22.41
...
Subject: [RESEND PATCH v3 3/4] configfs: implement committable items
Date:   Tue, 29 Dec 2020 11:22:34 +0100
Message-Id: <20201229102235.29550-4-brgl@bgdev.pl>
...
index b839dd1b459f..a1390ff33283 100644
--- a/fs/configfs/dir.c
+++ b/fs/configfs/dir.c
...
@@ -1561,9 +1708,92 @@ static int configfs_rmdir(struct inode *dir, struct dentry *dentry)
 	return 0;
 }
