...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 368941C4E5E
	for <lists+linux-kernel@lfdr.de>; Tue,  5 May 2020 08:35:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728276AbgEEGfV (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 5 May 2020 02:35:21 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33390 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-FAIL-OK-FAIL)
        by vger.kernel.org with ESMTP id S1728056AbgEEGfV (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 5 May 2020 02:35:21 -0400
Received: from metis.ext.pengutronix.de (metis.ext.pengutronix.de [IPv6:2001:67c:670:201:290:27ff:fe1d:cc33])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id F0E94C061A10
        for <linux-kernel@vger.kernel.org>; Mon,  4 May 2020 23:35:20 -0700 (PDT)
Received: from dude.hi.pengutronix.de ([2001:67c:670:100:1d::7])
        by metis.ext.pengutronix.de with esmtps (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <ore@pengutronix.de>)
        id 1jVrAe-0003lP-01; Tue, 05 May 2020 08:35:12 +0200
Received: from ore by dude.hi.pengutronix.de with local (Exim 4.92)
        (envelope-from <ore@pengutronix.de>)
        id 1jVrAa-0001W7-QC; Tue, 05 May 2020 08:35:08 +0200
...
Subject: [PATCH net-next v6 1/2] ethtool: provide UAPI for PHY master/slave configuration.
Date:   Tue,  5 May 2020 08:35:05 +0200
Message-Id: <20200505063506.3848-2-o.rempel@pengutronix.de>
...
index 89d0b1827aaff..525e8865f511f 100644
--- a/net/ethtool/ioctl.c
+++ b/net/ethtool/ioctl.c
@@ -553,6 +553,8 @@ static int ethtool_get_link_ksettings(struct net_device *dev,
...
@@ -590,6 +592,10 @@ static int ethtool_set_link_ksettings(struct net_device *dev,
 	    != link_ksettings.base.link_mode_masks_nwords)
 		return -EINVAL;
...
index 452608c6d8562..fd4f3e58c6f62 100644
