...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 581562D551F
	for <lists+linux-kernel@lfdr.de>; Thu, 10 Dec 2020 09:07:17 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387566AbgLJIGB (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 10 Dec 2020 03:06:01 -0500
Received: from mga01.intel.com ([192.55.52.88]:1785 "EHLO mga01.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1733215AbgLJIF4 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 10 Dec 2020 03:05:56 -0500
IronPort-SDR: 3L7ik5GUvawcsM45EEEniDWfwQ3uhYGZxXdPYEvOLJ8PaQUGQhkeC8DBhl9E4yuy3gRAwVkyGc
 M371XS7EveRQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9830"; a="192526702"
X-IronPort-AV: E=Sophos;i="5.78,407,1599548400"; 
   d="yaml'?scan'208";a="192526702"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 10 Dec 2020 00:05:11 -0800
IronPort-SDR: UlTCRD0u2xQ4cjWr2Pzc38dlCAkLR7k8+vMViTuRGLG8MIeUnuF2Q5HCktcY7EdqH1H4+KePlU
 AeR+feWhoYAQ==
X-IronPort-AV: E=Sophos;i="5.78,407,1599548400"; 
   d="yaml'?scan'208";a="364512901"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.140])
  by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 10 Dec 2020 00:05:04 -0800
...
Content-Disposition: attachment; filename="config-5.10.0-rc1-00033-g2558aacff858"
...
export_top_env()
{
	...
	export nr_task=144
	export job_origin='/lkp-src/allot/cyclic:p1:linux-devel:devel-hourly/lkp-cpl-4sp1/will-it-scale-part4.yaml'
...
queue_at_least_once'
	...
	export submit_id='5fd1b95b7746a0165efbaa79'
	export job_file='/lkp/jobs/scheduled/lkp-cpl-4sp1/will-it-scale-performance-thread-100%-sched_yield-ucode=0x700001e-monitor=0fe5055f-debian-10.4-x86_64-20200603.cgz-2558aacff8586-20201210-5726-1oap4q1-3.yaml'
	export id='ab1376186d9d7721bdfd225b2d843ef6b6dd4528'
...
/dev/disk/by-id/nvme-INTEL_SSDPE2KX040T7_PHLF741401DF4P0IGN-part5'
	...
	export commit='2558aacff8586699bcd248b406febb28b0a25de2'
	export need_kconfig_hw='CONFIG_IGB=y
CONFIG_SATA_AHCI'
	export ucode='0x700001e'
	export enqueue_time='2020-12-10 13:59:55 +0800'
	export _id='5fd1b9607746a0165efbaa7a'
	export _rt='/result/will-it-scale/performance-thread-100%-sched_yield-ucode=0x700001e-monitor=0fe5055f/lkp-cpl-4sp1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/2558aacff8586699bcd248b406febb28b0a25de2'
	export user='lkp'
	...
	export branch='tip/sched/migrate-disable'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export monitor_sha='0fe5055f'
	export result_root='/result/will-it-scale/performance-thread-100%-sched_yield-ucode=0x700001e-monitor=0fe5055f/lkp-cpl-4sp1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/2558aacff8586699bcd248b406febb28b0a25de2/3'
	export scheduler_version='/lkp/lkp/.src-20201210-114650'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-cpl-4sp1/will-it-scale-performance-thread-100%-sched_yield-ucode=0x700001e-monitor=0fe5055f-debian-10.4-x86_64-20200603.cgz-2558aacff8586-20201210-5726-1oap4q1-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-8.3
branch=tip/sched/migrate-disable
commit=2558aacff8586699bcd248b406febb28b0a25de2
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/2558aacff8586699bcd248b406febb28b0a25de2/vmlinuz-5.10.0-rc1-00033-g2558aacff858
acpi_rsdp=0x695fd014
max_uptime=2100
RESULT_ROOT=/result/will-it-scale/performance-thread-100%-sched_yield-ucode=0x700001e-monitor=0fe5055f/lkp-cpl-4sp1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/2558aacff8586699bcd248b406febb28b0a25de2/3
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/2558aacff8586699bcd248b406febb28b0a25de2/modules.cgz'
	...
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/2558aacff8586699bcd248b406febb28b0a25de2/vmlinuz-5.10.0-rc1-00033-g2558aacff858'
	export dequeue_time='2020-12-10 14:12:53 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-cpl-4sp1/will-it-scale-performance-thread-100%-sched_yield-ucode=0x700001e-monitor=0fe5055f-debian-10.4-x86_64-20200603.cgz-2558aacff8586-20201210-5726-1oap4q1-3.cgz'
...
run_job()
{
	...
	run_test mode='thread' test='sched_yield' $LKP_SRC/tests/wrapper will-it-scale
}
...
will-it-scale:
  mode: thread
  test: sched_yield
job_origin: "/lkp-src/allot/cyclic:p1:linux-devel:devel-hourly/lkp-cpl-4sp1/will-it-scale-part4.yaml"
...
kconfig: x86_64-rhel-8.3
submit_id: 5fd1b3a97746a0152c6059a3
job_file: "/lkp/jobs/scheduled/lkp-cpl-4sp1/will-it-scale-performance-thread-100%-sched_yield-ucode=0x700001e-monitor=0fe5055f-debian-10.4-x86_64-20200603.cgz-2558aacff8586-20201210-5420-b91kua-1.yaml"
id: eb26f89c06b67fa25a113c267c6ed5ca2e5a05d2
...
- CONFIG_SATA_AHCI
ucode: '0x700001e'
enqueue_time: 2020-12-10 13:35:37.489714648 +08:00
_id: 5fd1b3af7746a0152c6059a4
_rt: "/result/will-it-scale/performance-thread-100%-sched_yield-ucode=0x700001e-monitor=0fe5055f/lkp-cpl-4sp1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/2558aacff8586699bcd248b406febb28b0a25de2"
...
result_root: "/result/will-it-scale/performance-thread-100%-sched_yield-ucode=0x700001e-monitor=0fe5055f/lkp-cpl-4sp1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/2558aacff8586699bcd248b406febb28b0a25de2/0"
scheduler_version: "/lkp/lkp/.src-20201210-114650"
LKP_SERVER: internal-lkp-server
arch: x86_64
max_uptime: 2100
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-cpl-4sp1/will-it-scale-performance-thread-100%-sched_yield-ucode=0x700001e-monitor=0fe5055f-debian-10.4-x86_64-20200603.cgz-2558aacff8586-20201210-5420-b91kua-1.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- branch=linux-devel/devel-hourly-2020120305
- commit=2558aacff8586699bcd248b406febb28b0a25de2
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/2558aacff8586699bcd248b406febb28b0a25de2/modules.cgz"
...
#! /lkp/lkp/.src-20201208-144549/include/site/inn
LKP_CGI_PORT: 80
LKP_CIFS_PORT: 139
oom-killer: 
watchdog: 
...
#! runtime status
last_kernel: 5.10.0-rc6-02048-g5e3e578b5682
repeat_to: 2
schedule_notify_address: 

#! user overrides
queue_at_least_once: 0
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/2558aacff8586699bcd248b406febb28b0a25de2/vmlinuz-5.10.0-rc1-00033-g2558aacff858"
dequeue_time: 2020-12-10 13:39:10.510282097 +08:00

#! /lkp/lkp/.src-20201210-114650/include/site/inn
job_state: finished
loadavg: 4.55 45.24 32.60 1/991 12385
start_time: '1550139125'
end_time: '1550139426'
version: "/lkp/lkp/.src-20201210-114727:d9fa833a:d4bf4f8be"
...
do
 ...
 "/lkp/benchmarks/python3/bin/python3" "./runtest.py" "sched_yield" "295" "thread" "144"
