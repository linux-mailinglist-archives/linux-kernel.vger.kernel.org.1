...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0DF49240100
	for <lists+linux-kernel@lfdr.de>; Mon, 10 Aug 2020 04:45:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726491AbgHJCpA (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 9 Aug 2020 22:45:00 -0400
Received: from mga17.intel.com ([192.55.52.151]:50123 "EHLO mga17.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726219AbgHJCo6 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 9 Aug 2020 22:44:58 -0400
IronPort-SDR: 1DqzUDbfjTNpLJTZg9Z96UwaR6IZNf9BDnbj65kqtRUsawCYVtRulMnhTiB8JxxuJTX8zLjYKz
 r7ULmbHNQj7A==
X-IronPort-AV: E=McAfee;i="6000,8403,9708"; a="133523431"
X-IronPort-AV: E=Sophos;i="5.75,456,1589266800"; 
   d="scan'208";a="133523431"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 09 Aug 2020 19:44:57 -0700
IronPort-SDR: Gp7SrNoeoDvRWfUS6eY37IdC5GH3yNQCT6Aw9ey1Bn6wqrGbEy7z2KJFC4JxlsfsspA3+2KuaR
 DS+71sMi/UFw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,456,1589266800"; 
   d="scan'208";a="334095066"
Received: from yilunxu-optiplex-7050.sh.intel.com ([10.239.159.141])
  by orsmga007.jf.intel.com with ESMTP; 09 Aug 2020 19:44:55 -0700
...
Subject: [PATCH v4 2/4] fpga: dfl: map feature mmio resources in their own feature drivers
Date:   Mon, 10 Aug 2020 10:41:11 +0800
Message-Id: <1597027273-25288-3-git-send-email-yilun.xu@intel.com>
...
@@ -530,16 +547,30 @@ static int build_info_commit_dev(struct build_feature_devs_info *binfo)
...
@@ -582,19 +613,13 @@ static int build_info_commit_dev(struct build_feature_devs_info *binfo)
...
@@ -605,7 +630,7 @@ build_info_create_dev(struct build_feature_devs_info *binfo,
...
@@ -747,18 +772,17 @@ static int parse_feature_irqs(struct build_feature_devs_info *binfo,
  */
 static int
...
@@ -770,12 +794,11 @@ create_feature_instance(struct build_feature_devs_info *binfo,
 		return -ENOMEM;
...
-	finfo->ioaddr = dfl->ioaddr + ofst;
 	...
 	binfo->feature_num++;
@@ -784,7 +807,6 @@ create_feature_instance(struct build_feature_devs_info *binfo,
 }
...
@@ -792,21 +814,22 @@ static int parse_feature_port_afu(struct build_feature_devs_info *binfo,
...
@@ -815,8 +838,39 @@ static int parse_feature_afu(struct build_feature_devs_info *binfo,
 	return 0;
 }
...
-			     struct dfl_fpga_enum_dfl *dfl,
 ...
 {
 	int ret = 0;
@@ -824,27 +878,39 @@ static int parse_feature_fiu(struct build_feature_devs_info *binfo,
 	u16 id;
 	u64 v;
...
@@ -852,41 +918,39 @@ static int parse_feature_fiu(struct build_feature_devs_info *binfo,
 }
...
@@ -896,14 +960,17 @@ static int parse_feature(struct build_feature_devs_info *binfo,
 }
...
@@ -911,11 +978,11 @@ static int parse_feature_list(struct build_feature_devs_info *binfo,
 			return -EINVAL;
 		}
...
@@ -924,7 +991,12 @@ static int parse_feature_list(struct build_feature_devs_info *binfo,
 	}
...
@@ -977,7 +1049,6 @@ EXPORT_SYMBOL_GPL(dfl_fpga_enum_info_free);
...
@@ -986,8 +1057,7 @@ EXPORT_SYMBOL_GPL(dfl_fpga_enum_info_free);
...
@@ -997,7 +1067,6 @@ int dfl_fpga_enum_info_add_dfl(struct dfl_fpga_enum_info *info,
...
@@ -1120,7 +1189,7 @@ dfl_fpga_feature_devs_enumerate(struct dfl_fpga_enum_info *info)
 	 * Lists.
 	 */
