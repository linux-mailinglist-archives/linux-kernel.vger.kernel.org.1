...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A304D240105
	for <lists+linux-kernel@lfdr.de>; Mon, 10 Aug 2020 04:46:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726505AbgHJCqd (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 9 Aug 2020 22:46:33 -0400
Received: from mga17.intel.com ([192.55.52.151]:50195 "EHLO mga17.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726219AbgHJCqd (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 9 Aug 2020 22:46:33 -0400
IronPort-SDR: esk3+Ie8q24NnWMzG5TBzHZIqzYqAlRK86csBWZhB03xgvWhQR96cGcFvKpJ5dGOqqMcPsvODn
 2GPkBreEqpqw==
X-IronPort-AV: E=McAfee;i="6000,8403,9708"; a="133523481"
X-IronPort-AV: E=Sophos;i="5.75,456,1589266800"; 
   d="scan'208";a="133523481"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 09 Aug 2020 19:45:30 -0700
IronPort-SDR: YOo1koDgT8jQxyzOn34E/Sa9bTWk2Og2/ib+xT5sGQK/+MdhIXPh2b5Q+AaNqALeRTNEZt90vi
 da16Gw9jF9lA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,456,1589266800"; 
   d="scan'208";a="334095208"
Received: from yilunxu-optiplex-7050.sh.intel.com ([10.239.159.141])
  by orsmga007.jf.intel.com with ESMTP; 09 Aug 2020 19:45:27 -0700
...
Subject: [PATCH v4 3/4] fpga: dfl: create a dfl bus type to support DFL devices
Date:   Mon, 10 Aug 2020 10:41:12 +0800
Message-Id: <1597027273-25288-4-git-send-email-yilun.xu@intel.com>
...
-
 enum dfl_fpga_devt_type {
 	DFL_FPGA_DEVT_FME,
 	DFL_FPGA_DEVT_PORT,
@@ -250,6 +244,245 @@ int dfl_fpga_check_port_id(struct platform_device *pdev, void *pport_id)
 }
...
+
 ...
 /**
@@ -261,12 +494,15 @@ void dfl_fpga_dev_feature_uinit(struct platform_device *pdev)
 	struct dfl_feature_platform_data *pdata = dev_get_platdata(&pdev->dev);
 	struct dfl_feature *feature;
...
@@ -347,6 +583,10 @@ int dfl_fpga_dev_feature_init(struct platform_device *pdev,
 		drv++;
 	}
...
@@ -514,4 +515,88 @@ long dfl_feature_ioctl_set_irq(struct platform_device *pdev,
 			       struct dfl_feature *feature,
 			       unsigned long arg);
