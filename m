...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6579C21CB14
	for <lists+linux-kernel@lfdr.de>; Sun, 12 Jul 2020 21:11:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729323AbgGLTLb (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 12 Jul 2020 15:11:31 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47914 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1729122AbgGLTLa (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 12 Jul 2020 15:11:30 -0400
Received: from mail-pj1-x1041.google.com (mail-pj1-x1041.google.com [IPv6:2607:f8b0:4864:20::1041])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1B707C061794;
        Sun, 12 Jul 2020 12:11:30 -0700 (PDT)
Received: by mail-pj1-x1041.google.com with SMTP id f16so5073397pjt.0;
        Sun, 12 Jul 2020 12:11:30 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=date:from:to:cc:subject:message-id:references:mime-version
         :content-disposition:in-reply-to;
        bh=czRXMWgYM2HQfwD2pGBjlbDPDGbNT1Pq05rfX02EpTg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=czRXMWgYM2HQfwD2pGBjlbDPDGbNT1Pq05rfX02EpTg=;
        b=
X-Gm-Message-State: AOAM533yGO98srAs5tW3vH/C+5Olt2MC4mOVyT8Xc3c9109+8/AlHPsK
        JJfqIX/Q5Co0H0QC24xKXFkFFSjs
X-Google-Smtp-Source: ABdhPJxseQzoUogn8bJZu7DzbOOUj1/PkPGbSSRd+KKYNYzGgKlbPTzu2y2HpiEHuW64LGhiZsnf7Q==
X-Received: by 2002:a17:90a:3684:: with SMTP id t4mr15863268pjb.91.1594581089297;
        Sun, 12 Jul 2020 12:11:29 -0700 (PDT)
Received: from dtor-ws ([100.99.132.186])
        by smtp.gmail.com with ESMTPSA id q11sm12153945pjj.17.2020.07.12.12.11.28
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 12 Jul 2020 12:11:28 -0700 (PDT)
Date:   Sun, 12 Jul 2020 12:11:26 -0700
...
Subject: Re: [PATCH 2/2] Input: elan_i2c - High resolution report for new
 pattern 2.
Message-ID: <20200712191126.GB3224245@dtor-ws>
References: <20200710054116.5529-1-jingle.wu@emc.com.tw>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20200710054116.5529-1-jingle.wu@emc.com.tw>
...
Do SMbus controllers use the new report type? Do controllers use only
one type of report (old or the new 0x60), or can they send mix?
...
There is no point in executing this max for 16 bit value, so if we can
drop this altogether, as long as we are certain that older firmware did
not return garbage in 4 upper bits of this data.
...
It looks like SMBus code always returns '0' as pattern. Do we need to
have this method in transport code, or can it be moved into core?
