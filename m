...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C81EA1F843B
	for <lists+linux-kernel@lfdr.de>; Sat, 13 Jun 2020 18:08:24 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726502AbgFMQIJ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 13 Jun 2020 12:08:09 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36578 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726403AbgFMQIH (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 13 Jun 2020 12:08:07 -0400
Received: from mail-lf1-x143.google.com (mail-lf1-x143.google.com [IPv6:2a00:1450:4864:20::143])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D558CC03E96F
        for <linux-kernel@vger.kernel.org>; Sat, 13 Jun 2020 09:08:05 -0700 (PDT)
Received: by mail-lf1-x143.google.com with SMTP id d27so2551953lfq.5
        for <linux-kernel@vger.kernel.org>; Sat, 13 Jun 2020 09:08:05 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:date:to:cc:subject:message-id:references:mime-version
         :content-disposition:in-reply-to:user-agent;
        bh=7Mv04nsWoJdRMhQFRfObeO+hNdTIEbXMjQ9VBaVEdIo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=7Mv04nsWoJdRMhQFRfObeO+hNdTIEbXMjQ9VBaVEdIo=;
        b=
X-Gm-Message-State: AOAM531/jjxLElsOaXpwAkMLguMwvohaW5/ghSvx0ktGzK6GoICs8hVy
        t1otEQJmi5AP+Fee7DweVaeq4StVT3k=
X-Google-Smtp-Source: ABdhPJwPTJWR/F+1DXu6SlVJsIbJ2Cyf+pUxPHyfR0sERmCZND8YIxPEVgEkPqz8ZwVG43JkiSg4Sg==
X-Received: by 2002:a19:c8c2:: with SMTP id y185mr1369432lff.52.1592064481667;
        Sat, 13 Jun 2020 09:08:01 -0700 (PDT)
Received: from pc636 (h5ef52e31.seluork.dyn.perspektivbredband.net. [94.245.46.49])
        by smtp.gmail.com with ESMTPSA id t15sm2701354lji.49.2020.06.13.09.08.00
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sat, 13 Jun 2020 09:08:00 -0700 (PDT)
From:   Uladzislau Rezki <urezki@gmail.com>
X-Google-Original-From: Uladzislau Rezki <urezki@pc636>
Date:   Sat, 13 Jun 2020 18:07:58 +0200
To:     LKML <linux-kernel@vger.kernel.org>
Cc:     Ingo Molnar <mingo@kernel.org>,
        LKML <linux-kernel@vger.kernel.org>, x86@kernel.org,
        lkp@lists.01.org, urezki@gmail.com
Subject: Re: [mm/vmalloc] 0acd9a0ded: kernel_BUG_at_mm/vmalloc.c
Message-ID: <20200613160758.GA11426@pc636>
...
I am trying to reproduce this BUG_ON(). During lkp-tests setup
i run into one issue:

<snip>
urezki@pc638:~/data/coding/lkp-tests$ bin/lkp qemu -k /tmp/bzImage /tmp/job-script
==> Making package: lkp-src 0-1 (Sat 13 Jun 2020 06:05:50 PM CEST)
==> Checking runtime dependencies...
==> Checking buildtime dependencies...
==> WARNING: Using existing $srcdir/ tree
==> Removing existing $pkgdir/ directory...
==> Starting build()...
make: Entering directory '/home/urezki/data/coding/lkp-tests/bin/event'
gcc  -m32 -D_FORTIFY_SOURCE=2  -c -o wakeup.o wakeup.c
gcc  -m32 -Wl,-O1,--sort-common,--as-needed,-z,relro -static -o wakeup wakeup.o
rm -f wakeup.o
strip wakeup
make: Leaving directory '/home/urezki/data/coding/lkp-tests/bin/event'
==> Entering fakeroot environment...
==> Starting package()...
==> Creating package "lkp-src"...
7428 blocks
==> Leaving fakeroot environment.
==> Finished making: lkp-src 0-1 (Sat 13 Jun 2020 06:05:51 PM CEST)
Failed to pack: /home/urezki/.lkp/cache/lkp-i386.cgz
urezki@pc638:~/data/coding/lkp-tests$
<snip>

<snip>
urezki@pc638:~/data/coding/lkp-tests$ cat /etc/issue
Debian GNU/Linux 10 \n \l
