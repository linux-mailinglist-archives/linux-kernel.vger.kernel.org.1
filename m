...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 4BDA22D796F
	for <lists+linux-kernel@lfdr.de>; Fri, 11 Dec 2020 16:33:45 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728074AbgLKPb4 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 11 Dec 2020 10:31:56 -0500
Received: from mail.kernel.org ([198.145.29.99]:47404 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1733107AbgLKPaM (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
...
Subject: Re: Linux 4.14.212
Date:   Fri, 11 Dec 2020 15:12:53 +0100
Message-Id: <1607695972252186@kroah.com>
X-Mailer: git-send-email 2.29.2
In-Reply-To: <160769597221416@kroah.com>
References: <160769597221416@kroah.com>
MIME-Version: 1.0
...
index 31c2f8973a5d..37c1bd221115 100644
--- a/Makefile
+++ b/Makefile
@@ -1,7 +1,7 @@
...
index ce7a2bfd1dd8..b7413655353c 100644
...
index 8f6903ec7aec..6dd6a5542ce5 100644
...
index 0e9f248370a3..d95dd2b48cac 100644
...
index ac3cac052af9..3caf3b1e8d67 100644
...
index 2ea4bb9ce6e1..62eac76be9f6 100644
...
index 7c86a8ee03aa..11adc2c13a74 100644
...
+	ret = spi_register_master(master);
 	if (ret < 0) {
 		...
 		goto qspi_reg_err;
@@ -1378,8 +1370,6 @@ int bcm_qspi_probe(struct platform_device *pdev,
...
index fe1bb0284fe3..5aae06bc6fe3 100644
...
index dba4f53a7fff..d7e56de19c58 100644
...
index e7032309ee87..b71e61e79c5a 100644
...
@@ -510,20 +518,30 @@ static int tiocspgrp(struct tty_struct *tty, struct tty_struct *real_tty, pid_t
  *
...
index 2ff7c21bbda5..2f98161d062e 100644
...
index d45a3f4e752c..389b24b84ba4 100644
...
index 595415e59d5d..fd02b19129fc 100644
...
@@ -329,8 +329,6 @@ static int  klsi_105_open(struct tty_struct *tty, struct usb_serial_port *port)
 			     KLSI_TIMEOUT);
 err_generic_close:
...
index 49e6aa9aec54..0a4b0c3839b5 100644
...
index 64e52374ecc2..73be08ea135f 100644
--- a/fs/cifs/connect.c
+++ b/fs/cifs/connect.c
...
index c4eb6a5fcea9..87656030ec7d 100644
--- a/fs/gfs2/rgrp.c
+++ b/fs/gfs2/rgrp.c
...
index 87b8c20d5b27..af4f2a7f8e9a 100644
...
index 2f1b61d8b151..641c93acc557 100644
...
index d30e4c869438..09ed8a48b454 100644
...
index bb242da3724b..5b200b879765 100644
...
index 1339ee556743..c0dbc683322f 100644
...
index 01506162522f..5097e9406e78 100644
...
index 9dee657ce9e2..14881fe80a21 100644
...
index c27623052264..331a62b85987 100644
