...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id EBF762F3B14
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Jan 2021 20:51:03 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2406982AbhALTsK (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 12 Jan 2021 14:48:10 -0500
Received: from mail.kernel.org ([198.145.29.99]:57258 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2406881AbhALTsF (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 12 Jan 2021 14:48:05 -0500
Received: by mail.kernel.org (Postfix) with ESMTPSA id D3ACF2311B;
        Tue, 12 Jan 2021 19:47:20 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=linuxfoundation.org;
        s=korg; t=1610480841;
        bh=Zk3xW/xn51nZ60oXPDvQs+ROyRj0eaJYB586+xeemp4=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=Y0FmLGs08fmA1niYPwB2zQpGxCkdY5io7aXhXlq3cVo0otBNSkPan9RtT0xk1yl1V
         Sr4ACUM3dMjLAqpwIAjvQLBKX0w5BNseh4wQG/xU7s5OAkNKwxIQJwz+0KsGwor+MU
         BvKRbqBCuI+s/9PN+atAVlq73Dpfn8J57Jve7J50=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 5.4.89
Date:   Tue, 12 Jan 2021 20:48:24 +0100
Message-Id: <161048090315576@kroah.com>
X-Mailer: git-send-email 2.30.0
In-Reply-To: <16104809036124@kroah.com>
References: <16104809036124@kroah.com>
MIME-Version: 1.0
...
+		if (is_waiting_for_rm(sctx, ino, gen)) {
 			...
 			if (ret < 0)
 				goto out;
@@ -2865,8 +2866,8 @@ static int orphanize_inode(struct send_ctx *sctx, u64 ino, u64 gen,
 	return ret;
 }
