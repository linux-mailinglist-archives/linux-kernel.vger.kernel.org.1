...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E0E232D31F9
	for <lists+linux-kernel@lfdr.de>; Tue,  8 Dec 2020 19:18:22 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731035AbgLHSRu (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 8 Dec 2020 13:17:50 -0500
Received: from mx0b-00082601.pphosted.com ([67.231.153.30]:56940 "EHLO
        mx0b-00082601.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1731006AbgLHSRt (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 8 Dec 2020 13:17:49 -0500
Received: from pps.filterd (m0109332.ppops.net [127.0.0.1])
        by mx0a-00082601.pphosted.com (8.16.0.43/8.16.0.43) with SMTP id 0B8IFbRT027475
        for <linux-kernel@vger.kernel.org>; Tue, 8 Dec 2020 10:17:04 -0800
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=fb.com; h=from : to : cc : subject
 : date : message-id : in-reply-to : references : mime-version :
 content-transfer-encoding : content-type; s=facebook;
 bh=Jivx90yycMZCEi2XeSWQz8ywUBJltxO/uBNh3EZYF2U=;
 b=G0gUb5wjLBxzux5Z9BAbvonnaL2WnDELqZ0LN6v690nvx30WVKJ9CuOOzu12gK0hI7pA
 4PO22K964Fx+PD7Kjoxeqp6GO459Fpg2HXtNrpe1M3ztGB0AyzZsJI2ewEz6h3jF+ODZ
 ZxRstowYy2xES154iNniafv1EfUKlpUsDNY= 
Received: from maileast.thefacebook.com ([163.114.130.16])
        by mx0a-00082601.pphosted.com with ESMTP id 35a66wurcw-3
        (version=TLSv1.2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128 verify=NOT)
        for <linux-kernel@vger.kernel.org>; Tue, 08 Dec 2020 10:17:04 -0800
Received: from intmgw001.08.frc2.facebook.com (2620:10d:c0a8:1b::d) by
 mail.thefacebook.com (2620:10d:c0a8:82::d) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1979.3; Tue, 8 Dec 2020 10:17:03 -0800
Received: by devbig006.ftw2.facebook.com (Postfix, from userid 4523)
        id 06DD162E4EC6; Tue,  8 Dec 2020 10:17:03 -0800 (PST)
...
Subject: [PATCH v3 2/2] perf-stat: enable counting events for BPF programs
Date:   Tue, 8 Dec 2020 10:16:46 -0800
Message-ID: <20201208181646.3044417-3-songliubraving@fb.com>
...
index 9ea9047a621bc..bc07b999a1049 100644
...
index b01af171d94f5..43046176d5d0c 100644
...
@@ -2054,11 +2097,12 @@ int cmd_stat(int argc, const char **argv)
...
=20
 	/*
@@ -2239,8 +2289,6 @@ int cmd_stat(int argc, const char **argv)
 			goto out;
 	}
=20
...
=20
@@ -2371,9 +2419,10 @@ int cmd_stat(int argc, const char **argv)
 		 * tools remain  -acme
 		 */
 		int fd =3D perf_data__fd(&perf_stat.data);
...
index 0000000000000..7d625f744ae02
--- /dev/null
...
@@ -1770,6 +1777,8 @@ static int evsel__open_cpu(struct evsel *evsel, str=
...
=20
@@ -1788,6 +1797,8 @@ static int evsel__open_cpu(struct evsel *evsel, str=
uct perf_cpu_map *cpus,
=20
...
@@ -423,4 +428,5 @@ static inline bool evsel__is_dummy_event(struct evsel=
 *evsel)
...
y.c
index a963b5b8eb724..a49b42028d488 100644
--- a/tools/perf/util/stat-display.c
+++ b/tools/perf/util/stat-display.c
@@ -1026,7 +1026,9 @@ static void print_header(struct perf_stat_config *c=
onfig,
