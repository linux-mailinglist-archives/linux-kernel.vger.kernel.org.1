...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 42DDC2498B5
	for <lists+linux-kernel@lfdr.de>; Wed, 19 Aug 2020 10:53:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727776AbgHSIxv (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 19 Aug 2020 04:53:51 -0400
Received: from mail.kernel.org ([198.145.29.99]:52554 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726959AbgHSIvw (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 19 Aug 2020 04:51:52 -0400
Received: from localhost (83-86-89-107.cable.dynamic.v4.ziggo.nl [83.86.89.107])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 1747C207DE;
        Wed, 19 Aug 2020 08:51:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1597827087;
        bh=IAfVRcoAeJ4YZ114uKWK+YTls9F9ugGIdDRzQAKZvVs=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=IvrZgZbqLTBspyofDJkdtIwsUPpv60Rtb301KeqwvZnAnejOL79NwH+mG/71IvnUn
         FR7LmQAeZtAoJo9aBhgNSg5cdAPvIs3gSTLpp7Qym9LBoYvZJddH6QVMrHL8WFCcnb
         BDLtepFdYD7Arf8z6Ajukil1naIqpiFliL/a2S64=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 5.8.2
Date:   Wed, 19 Aug 2020 10:51:42 +0200
Message-Id: <15978271018938@kroah.com>
X-Mailer: git-send-email 2.28.0
In-Reply-To: <1597827101207207@kroah.com>
References: <1597827101207207@kroah.com>
MIME-Version: 1.0
...
@@ -6816,20 +6818,30 @@ static int ufshcd_scsi_add_wlus(struct ufs_hba *hba)
...
-		__set_current_state(TASK_RUNNING);
 		if (io_sq_thread_acquire_mm(ctx, req)) {
 			...
 			goto end_req;
@@ -4370,6 +4420,7 @@ static void io_async_task_func(struct callback_head *cb)
