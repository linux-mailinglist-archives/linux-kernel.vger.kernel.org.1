...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7188E2A3C8D
	for <lists+linux-kernel@lfdr.de>; Tue,  3 Nov 2020 07:05:11 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727389AbgKCGFF (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 3 Nov 2020 01:05:05 -0500
Received: from mga03.intel.com ([134.134.136.65]:52339 "EHLO mga03.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725968AbgKCGFE (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 3 Nov 2020 01:05:04 -0500
IronPort-SDR: 1q3vQ2mpTjxy08JtKyC30yK4ZAMHdM/o9QoJOibLtoues36JxYfiEyqjaQo/mfmmFDKyuEj/Br
 yRh4eXVsjg+Q==
X-IronPort-AV: E=McAfee;i="6000,8403,9793"; a="169108281"
X-IronPort-AV: E=Sophos;i="5.77,447,1596524400"; 
   d="scan'208";a="169108281"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 02 Nov 2020 22:05:02 -0800
IronPort-SDR: 4gAa4mfaA54JmDqiao7KiIXi2DdIGEuzsc7Go6Ue50vrC8ywQvpp42/QHh4fxf6EHOofoAqoFP
 FpUT40gsfSBw==
X-IronPort-AV: E=Sophos;i="5.77,447,1596524400"; 
   d="scan'208";a="538329087"
Received: from xingzhen-mobl.ccr.corp.intel.com (HELO [10.238.4.68]) ([10.238.4.68])
  by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 02 Nov 2020 22:05:00 -0800
Subject: Re: [LKP] Re: [btrfs] c75e839414: aim7.jobs-per-min -9.1% regression
...
References: <20200612061144.GM12456@shao2-debian>
 <cc74fe05-da4e-ba65-a2e9-8df742627445@linux.intel.com>
 <aea680a8-ad1e-f348-6555-7db1cb9c6853@linux.intel.com>
Message-ID: <93783add-bce3-2c3b-f24a-642a5a479938@linux.intel.com>
Date:   Tue, 3 Nov 2020 14:04:58 +0800
User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:78.0) Gecko/20100101
 Thunderbird/78.4.0
MIME-Version: 1.0
In-Reply-To: <aea680a8-ad1e-f348-6555-7db1cb9c6853@linux.intel.com>
...
>>> numa-vmstat.node2.nr_active_file
>>>       13786 ±  6%     +22.6%      16906 ±  4%  
>>> numa-vmstat.node2.nr_dirty
>>>       14074 ±  5%     +21.7%      17130 ±  4% 
>>> numa-vmstat.node2.nr_zone_active_file
>>>       13617 ±  7%     +23.3%      16789 ±  4% 
>>> numa-vmstat.node2.nr_zone_write_pending
>>>       14151 ±  6%     +20.7%      17074 ±  3% 
>>> numa-vmstat.node3.nr_active_file
>>>       13790 ±  6%     +22.1%      16832 ±  4%  
>>> numa-vmstat.node3.nr_dirty
>>>       14152 ±  6%     +20.7%      17074 ±  3% 
>>> numa-vmstat.node3.nr_zone_active_file
>>>       13627 ±  6%     +22.5%      16696 ±  4% 
>>> numa-vmstat.node3.nr_zone_write_pending
>>>      828631 ± 16%     +49.9%    1241934 ±  8% 
>>> sched_debug.cfs_rq:/.min_vruntime.stddev
>>>        1.33 ± 30%     +96.9%       2.61 ± 14% 
>>> sched_debug.cfs_rq:/.nr_spread_over.avg
>>>      831152 ± 16%     +49.7%    1244586 ±  8% 
...
>>>    10766873 ±  2%     +11.0%   11947268 ±  2% 
>>> perf-stat.ps.node-load-misses
>>>      645940 ±  2%     +24.7%     805392 ±  2%  perf-stat.ps.node-loads
>>>     5965618 ±  2%      -6.2%    5595562 ±  2% 
>>> perf-stat.ps.node-store-misses
>>>      383092            -6.5%     358124 ±  2%  perf-stat.ps.node-stores
>>>        4395            -1.8%       4315        perf-stat.ps.page-faults
>>>   1.538e+13 ±  2%     +10.0%  1.692e+13 ±  2% 
>>> perf-stat.total.instructions
>>>       27.39            -0.1       27.28 
>>> perf-profile.calltrace.cycles-pp.btrfs_dirty_pages.btrfs_buffered_write.btrfs_file_write_iter.new_sync_write.vfs_write 
>>>
>>>       35.13            +0.1       35.23 
>>> perf-profile.calltrace.cycles-pp.native_queued_spin_lock_slowpath._raw_spin_lock.btrfs_reserve_metadata_bytes.btrfs_delalloc_reserve_metadata.btrfs_buffered_write 
>>>
>>>       35.23            +0.1       35.34 
>>> perf-profile.calltrace.cycles-pp._raw_spin_lock.btrfs_reserve_metadata_bytes.btrfs_delalloc_reserve_metadata.btrfs_buffered_write.btrfs_file_write_iter 
>>>
>>>       35.48            +0.1       35.60 
>>> perf-profile.calltrace.cycles-pp.btrfs_reserve_metadata_bytes.btrfs_delalloc_reserve_metadata.btrfs_buffered_write.btrfs_file_write_iter.new_sync_write 
>>>
>>>       35.08            +0.1       35.22 
>>> perf-profile.calltrace.cycles-pp._raw_spin_lock.btrfs_block_rsv_release.btrfs_inode_rsv_release.btrfs_buffered_write.btrfs_file_write_iter 
>>>
>>>       34.97            +0.1       35.12 
>>> perf-profile.calltrace.cycles-pp.native_queued_spin_lock_slowpath._raw_spin_lock.btrfs_block_rsv_release.btrfs_inode_rsv_release.btrfs_buffered_write 
>>>
>>>       35.57            +0.1       35.72 
>>> perf-profile.calltrace.cycles-pp.btrfs_delalloc_reserve_metadata.btrfs_buffered_write.btrfs_file_write_iter.new_sync_write.vfs_write 
>>>
>>>       35.10            +0.2       35.26 
>>> perf-profile.calltrace.cycles-pp.btrfs_block_rsv_release.btrfs_inode_rsv_release.btrfs_buffered_write.btrfs_file_write_iter.new_sync_write 
>>>
>>>       35.11            +0.2       35.27 
>>> perf-profile.calltrace.cycles-pp.btrfs_inode_rsv_release.btrfs_buffered_write.btrfs_file_write_iter.new_sync_write.vfs_write 
>>>
>>>       98.71            +0.2       98.88 
...
>>>
>>>       98.63            +0.2       98.81 
>>> perf-profile.calltrace.cycles-pp.btrfs_file_write_iter.new_sync_write.vfs_write.ksys_write.do_syscall_64 
>>>
>>>       98.58            +0.2       98.77 
>>> perf-profile.calltrace.cycles-pp.btrfs_buffered_write.btrfs_file_write_iter.new_sync_write.vfs_write.ksys_write 
>>>
>>>       27.39            -0.1       27.28 
...
>>>        0.26 ±  4%      -0.0        0.22 ±  6% 
>>> perf-profile.children.cycles-pp.creat
>>>        0.00            +0.0        0.05 
>>> perf-profile.children.cycles-pp.btrfs_calculate_inode_block_rsv_size
>>>       99.65            +0.1       99.73 
