...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0C2F31C36BA
	for <lists+linux-kernel@lfdr.de>; Mon,  4 May 2020 12:22:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728508AbgEDKWc (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 4 May 2020 06:22:32 -0400
Received: from mail.kernel.org ([198.145.29.99]:42452 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727088AbgEDKWa (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 4 May 2020 06:22:30 -0400
Received: from localhost (83-86-89-107.cable.dynamic.v4.ziggo.nl [83.86.89.107])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 490C1206E6;
        Mon,  4 May 2020 10:22:24 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1588587745;
        bh=jh/LP7MbgNiLFdBeW0QkLimG1MrBsm4vI2hzweoQdKo=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=nv2XeFeigTIuvmFjg9z4NxOjXGXin0+BxD6JNBvnPgqirQ234f4gQkQDGHlOHWgRU
         aVR17E6hdWYZIHZ5R5acbqY158RV6jzpanfqI9CRB9F+e1SybPikMNWQC8dPa5RuzX
         xCykzTKGcMSH9vKo0s3nwxrekjWOoni6+hmedQbU=
Date:   Mon, 4 May 2020 12:22:22 +0200
From:   Greg KH <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org,
        Andrew Morton <akpm@linux-foundation.org>,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, Jiri Slaby <jslaby@suse.cz>
Subject: Re: Linux 4.14.178
Message-ID: <20200504102222.GB1450422@kroah.com>
References: <20200504102217.GA1450422@kroah.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20200504102217.GA1450422@kroah.com>
...
+				 "iget: bogus i_mode (%o)", inode->i_mode);
 	...
 	brelse(iloc.bh);
@@ -4969,13 +4999,6 @@ struct inode *ext4_iget(struct super_block *sb, unsigned long ino)
 	return ERR_PTR(ret);
 }
...
@@ -4370,7 +4362,7 @@ static int ext4_fill_super(struct super_block *sb, void *data, int silent)
