...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7522A2F3A1B
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Jan 2021 20:24:21 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2436920AbhALTXq (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 12 Jan 2021 14:23:46 -0500
Received: from foss.arm.com ([217.140.110.172]:52254 "EHLO foss.arm.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2436843AbhALTX2 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 12 Jan 2021 14:23:28 -0500
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 7C3B0165C;
        Tue, 12 Jan 2021 11:22:12 -0800 (PST)
Received: from e120937-lin.home (unknown [172.31.20.19])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id AAA243F66E;
        Tue, 12 Jan 2021 11:22:10 -0800 (PST)
...
Subject: [PATCH v5 34/36] firmware: arm_scmi: make notify_priv really private
Date:   Tue, 12 Jan 2021 19:20:16 +0000
Message-Id: <20210112192018.34994-35-cristian.marussi@arm.com>
...
index b80a05f7a5a0..033372de4e7f 100644
...
index 16d1b8a32032..ddcbaee8daa5 100644
--- a/include/linux/scmi_protocol.h
+++ b/include/linux/scmi_protocol.h
@@ -606,8 +606,6 @@ struct scmi_notify_ops {
...
- *	(for internal use only)
 ...
 struct scmi_handle {
 	struct device *dev;
@@ -619,7 +617,6 @@ struct scmi_handle {
