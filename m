...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 630282B3064
	for <lists+linux-kernel@lfdr.de>; Sat, 14 Nov 2020 20:54:59 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726645AbgKNTyH (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 14 Nov 2020 14:54:07 -0500
Received: from mx0a-0016f401.pphosted.com ([67.231.148.174]:35120 "EHLO
        mx0b-0016f401.pphosted.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1726543AbgKNTyB (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 14 Nov 2020 14:54:01 -0500
Received: from pps.filterd (m0045849.ppops.net [127.0.0.1])
        by mx0a-0016f401.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id 0AEJousF029426;
        Sat, 14 Nov 2020 11:53:59 -0800
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=marvell.com; h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-type; s=pfpt0220; bh=KaKZC8PWAThDwHJNHmsUYxmrQQ7UGm6BJ8LeG7cMsiI=;
 b= ig== 
Received: from sc-exch03.marvell.com ([199.233.58.183])
        by mx0a-0016f401.pphosted.com with ESMTP id 34tdfts05s-1
...
Received: from maili.marvell.com (10.69.176.80) by DC5-EXCH01.marvell.com
 ...
 Transport; Sat, 14 Nov 2020 11:53:58 -0800
Received: from hyd1583.caveonetworks.com (unknown [10.29.37.44])
        by maili.marvell.com (Postfix) with ESMTP id BCCD83F7040;
        Sat, 14 Nov 2020 11:53:54 -0800 (PST)
...
Subject: [PATCH v4 net-next 12/13] octeontx2-af: Add new mbox messages to retrieve MCAM entries
Date:   Sun, 15 Nov 2020 01:23:02 +0530
Message-ID: <20201114195303.25967-13-naveenm@marvell.com>
...
index 2eb41692c5ce..dd54d41801fb 100644
--- a/drivers/net/ethernet/marvell/octeontx2/af/rvu_npc.c
+++ b/drivers/net/ethernet/marvell/octeontx2/af/rvu_npc.c
@@ -2193,6 +2193,30 @@ int rvu_mbox_handler_npc_mcam_free_entry(struct rvu *rvu,
 	return rc;
 }
