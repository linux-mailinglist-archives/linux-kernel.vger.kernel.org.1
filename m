...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 32D00290883
	for <lists+linux-kernel@lfdr.de>; Fri, 16 Oct 2020 17:32:54 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2410260AbgJPPc2 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 16 Oct 2020 11:32:28 -0400
Received: from relaydlg-01.paragon-software.com ([81.5.88.159]:45073 "EHLO
        relaydlg-01.paragon-software.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S2410171AbgJPPcB (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 16 Oct 2020 11:32:01 -0400
Received: from dlg2.mail.paragon-software.com (vdlg-exch-02.paragon-software.com [172.30.1.105])
        by relaydlg-01.paragon-software.com (Postfix) with ESMTPS id C625282243;
        Fri, 16 Oct 2020 18:31:44 +0300 (MSK)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=paragon-software.com; s=mail; t=1602862304;
        bh=4+w/HXU34GivJAo0rcfmBNNh5K2jymvPMakVgSAn/PY=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=RzhjH8oMA3snij3f2FuzYlaH1yBLEgJokZE8TkSvwCxsWISitBszWlcegJFBO9OI3
         DEpainoqjniAMFsnH6Q/P4Ea2Nxkv/WNTfr9beW3GwlPJ8GcX7gP90va4I9lzXuFJe
         gX7lOul7dCMg3tT0l3RMvA+vV86YSMMDVzkoBOPM=
...
Subject: [PATCH v9 05/10] fs/ntfs3: Add attrib operations
Date:   Fri, 16 Oct 2020 18:29:32 +0300
Message-ID: <20201016152937.4030001-6-almaz.alexandrovich@paragon-software.com>
...
index 000000000000..5123bacb6384
--- /dev/null
+++ b/fs/ntfs3/attrib.c
@@ -0,0 +1,1383 @@
...
+	struct ATTR_LIST_ENTRY *le, *le_b;
+	struct mft_inode *mi, *mi_b;
+	CLST hint, svcn, to_alloc, evcn1, next_evcn1, next_svcn, asize, end;
...
+			goto repack;
+		}
+	} else if (!ni->attr_list.size) {
+		/* evcn1 == file size in clusters */
+		err = -EINVAL;
+		goto out;
+	}
+
...
+		goto ins_ext;
+
+	/* next attribute should start from next_svcn */
+	next_evcn1 = le64_to_cpu(attr->nres.evcn) + 1;
+
+	svcn = next_svcn;
+
+	if (svcn >= next_evcn1) {
...
+
+	if (svcn > evcn1) {
+		/* trim head of next attribute to start from next_vcn */
+		err = attr_load_runs(attr, ni, run, &svcn);
+		if (err)
+			goto out;
+	} else if (le32_to_cpu(mi->mrec->used) + 8 > sbi->record_size) {
+		goto ins_ext;
+	} else {
+		/* add new runs into head of next attribute */
+		err = attr_load_runs(attr, ni, run, &evcn1);
+		if (err)
+			goto out;
+	}
+
+	attr->nres.svcn = cpu_to_le64(svcn);
+	err = mi_pack_runs(mi, attr, run, next_evcn1 - svcn);
+	if (err < 0)
+		goto out;
+
...
+	struct ATTR_LIST_ENTRY *le, *le_b;
+	struct mft_inode *mi, *mi_b;
+	CLST svcn, evcn1, next_evcn1, next_svcn, lcn, len;
...
new file mode 100644
index 000000000000..beb6bf552f91
--- /dev/null
