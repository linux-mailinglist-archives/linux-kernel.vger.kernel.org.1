...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0DAC92C90DF
	for <lists+linux-kernel@lfdr.de>; Mon, 30 Nov 2020 23:21:30 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730573AbgK3WUE (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 30 Nov 2020 17:20:04 -0500
Received: from mga07.intel.com ([134.134.136.100]:41156 "EHLO mga07.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726775AbgK3WUD (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 30 Nov 2020 17:20:03 -0500
IronPort-SDR: Wi7WEP4eoWKPWifBjxf68XMGtXKn+a5TfwkqKyoJsw1X/M6925MjLxhY/KobpSr1Kwh6skqzCc
 48Ev/M9WnRhQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9821"; a="236848863"
X-IronPort-AV: E=Sophos;i="5.78,382,1599548400"; 
   d="scan'208";a="236848863"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 30 Nov 2020 14:19:21 -0800
IronPort-SDR: NcGdWr4bWSLqPOZK9DFoDM+WSAycYF8L4nNj/zOKfpsce3Ktuhz/k22AG+vcV64QYrLMUBh4qL
 JuyPoXgCX7Nw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,382,1599548400"; 
   d="scan'208";a="314732247"
...
x-forefront-antispam-report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:BY5PR11MB4182.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(4636009)(366004)(376002)(396003)(346002)(136003)(39860400002)(186003)(8676002)(8936002)(7696005)(52536014)(83380400001)(4326008)(5660300002)(53546011)(6506007)(66446008)(478600001)(66556008)(55016002)(66476007)(76116006)(64756008)(71200400001)(26005)(33656002)(2906002)(86362001)(316002)(66946007)(110136005)(9686003)(54906003);DIR:OUT;SFP:1102;
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 30 Nov 2020 22:19:13.9730
 (UTC)
...
>   128 |   kmb->plane_status[plane_id].ctrl =3D LCD_CTRL_GL2_ENABLE;
>       |   ~~~~~~~~~~~~~~~~~^~~~~~~~~~
> drivers/gpu/drm/kmb/kmb_plane.c:125:20: warning: array subscript 2 is
> above array bounds of 'struct layer_status[1]' [-Warray-bounds]
>   125 |   kmb->plane_status[plane_id].ctrl =3D LCD_CTRL_GL1_ENABLE;
>       |   ~~~~~~~~~~~~~~~~~^~~~~~~~~~
> drivers/gpu/drm/kmb/kmb_plane.c:122:20: warning: array subscript 1 is
> above array bounds of 'struct layer_status[1]' [-Warray-bounds]
>   122 |   kmb->plane_status[plane_id].ctrl =3D LCD_CTRL_VL2_ENABLE;
>=20
