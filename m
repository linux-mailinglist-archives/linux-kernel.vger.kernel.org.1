...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1E5501B943C
	for <lists+linux-kernel@lfdr.de>; Sun, 26 Apr 2020 23:43:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726329AbgDZVnk (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 26 Apr 2020 17:43:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47590 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726184AbgDZVnj (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 26 Apr 2020 17:43:39 -0400
Received: from mail-lf1-x141.google.com (mail-lf1-x141.google.com [IPv6:2a00:1450:4864:20::141])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 21310C061A0F
        for <linux-kernel@vger.kernel.org>; Sun, 26 Apr 2020 14:43:39 -0700 (PDT)
Received: by mail-lf1-x141.google.com with SMTP id 131so12142207lfh.11
        for <linux-kernel@vger.kernel.org>; Sun, 26 Apr 2020 14:43:39 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linux-foundation.org; s=google;
        h=mime-version:from:date:message-id:subject:to
         :content-transfer-encoding;
        bh=Wja21I69UspoBi6bwV9v34FMKZPPAmvSB+N0uiWMffo=;
        b=cMt+H0YGDGXQWeRazcmTCtnAhTE6StRoZN9gTbwfOfvNNQ5Lbp8oj8fJ8wYvvUv4fn
         WuSJLmzAnyXbMJBAQHs9zUsWspr8g3fWrj9bOIb2lGuwzGi6jcF0buJutG/9234VC0Ii
         Ej/TTp2n5bKR2votzTkWs+RTXwFNu1FjHgCTc=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:mime-version:from:date:message-id:subject:to
         :content-transfer-encoding;
        bh=Wja21I69UspoBi6bwV9v34FMKZPPAmvSB+N0uiWMffo=;
        b=
X-Gm-Message-State: AGi0Pua+wgiZO5XFqXWV+PfuT2IlXZpWcF30DrC5cz5xHQvy5id0kIT6
        vqDY0IF8zNNOJInAdz3QYC6nXZ38F6M=
X-Google-Smtp-Source: APiQypJm7IheneO+HftBOoRCENPhOk85Eg5A8bKAwcJApiZCZdMCzBRyEuAr+TAY+aRjGZmanXcMrA==
X-Received: by 2002:ac2:420c:: with SMTP id y12mr13383707lfh.26.1587937416188;
        Sun, 26 Apr 2020 14:43:36 -0700 (PDT)
Received: from mail-lj1-f170.google.com (mail-lj1-f170.google.com. [209.85.208.170])
        by smtp.gmail.com with ESMTPSA id k22sm8842640ljj.85.2020.04.26.14.43.35
        for <linux-kernel@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Sun, 26 Apr 2020 14:43:35 -0700 (PDT)
Received: by mail-lj1-f170.google.com with SMTP id w20so15553211ljj.0
        for <linux-kernel@vger.kernel.org>; Sun, 26 Apr 2020 14:43:35 -0700 (PDT)
X-Received: by 2002:a2e:9a54:: with SMTP id k20mr10764322ljj.265.1587937413855;
 Sun, 26 Apr 2020 14:43:33 -0700 (PDT)
MIME-Version: 1.0
From:   Linus Torvalds <torvalds@linux-foundation.org>
Date:   Sun, 26 Apr 2020 14:43:17 -0700
X-Gmail-Original-Message-ID: <CAHk-=wiDq0imdGHZwCnvWM1bc8r++==fB4BDrfenAB9_CZ45+w@mail.gmail.com>
...
Giovanni Gherdovich (3):
      x86, sched: Bail out of frequency invariance if base frequency is unk=
nown
      x86, sched: Account for CPUs with less than 4 cores in freq. invarian=
ce
...
ext-irq shareable
      ACPI: button: Drop no longer necessary Asus T200TA lid_init_state qui=
rk
...
Mathias Nyman (3):
      xhci: Fix handling halted endpoint even if endpoint ring appears empt=
y
...
Oliver Upton (2):
      ...
      kvm: nVMX: match comment with return type for nested_vmx_exit_reflect=
ed
...
Toke H=C3=B8iland-J=C3=B8rgensen (3):
      ...
      selftests/bpf: Add test for freplace program with expected_attach_typ=
e
...
Venkatesh Srinivas (1):
      kvm: Handle reads of SandyBridge RAPL PMU MSRs rather than injecting =
#GP
...
Vitor Massaru Iha (1):
      um: ensure `make ARCH=3Dum mrproper` removes
...
Xiao Yang (1):
      selftests/ftrace: Add CONFIG_SAMPLE_FTRACE_DIRECT=3Dm kconfig
