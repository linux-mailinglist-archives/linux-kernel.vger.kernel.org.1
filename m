...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D461E2AAE88
	for <lists+linux-kernel@lfdr.de>; Mon,  9 Nov 2020 01:29:37 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728846AbgKIA30 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 8 Nov 2020 19:29:26 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45470 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727929AbgKIA3Z (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 8 Nov 2020 19:29:25 -0500
Received: from mail-lf1-x130.google.com (mail-lf1-x130.google.com [IPv6:2a00:1450:4864:20::130])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A46D2C0613CF
        for <linux-kernel@vger.kernel.org>; Sun,  8 Nov 2020 16:29:24 -0800 (PST)
Received: by mail-lf1-x130.google.com with SMTP id i6so10010998lfd.1
        for <linux-kernel@vger.kernel.org>; Sun, 08 Nov 2020 16:29:24 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linux-foundation.org; s=google;
        h=mime-version:from:date:message-id:subject:to
         :content-transfer-encoding;
        bh=Y848dTTvvV56NLOe0w7Zsq7tn5RxtwWdhSQqUFSSYPU=;
        b=WBQuU4Yd1dy2WsdBSB3McNbbmUePcfGqqy8xgIfQyNexhVPRFEAkTht7tkcJp6q7Vo
         F99DeS8+B24bvfKa774uorVs4bUCwb9BIK5Nb1wuERxEVATi5xBvPs353z8SjSVPCmNf
         naIAsdwXG41CMDan64HKCGSwbALkmO6iRNfEQ=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:mime-version:from:date:message-id:subject:to
         :content-transfer-encoding;
        bh=Y848dTTvvV56NLOe0w7Zsq7tn5RxtwWdhSQqUFSSYPU=;
        b=
X-Gm-Message-State: AOAM530Rv+Kd2GSwGsZYOWrFqGHTXho+fU2lbhp+00cWOVFDDmSH0NaB
        vC4HRoAD8RN4wardcZHztwo9zuosINO5/A==
X-Google-Smtp-Source: ABdhPJyArJe03K48NFnHtQELXf9MDaicboG47zEY4mhp3dGimpBcZoS7RGSN3JHkEv2H6bVxUsHjnQ==
X-Received: by 2002:a19:c013:: with SMTP id q19mr4206594lff.96.1604881761973;
        Sun, 08 Nov 2020 16:29:21 -0800 (PST)
Received: from mail-lj1-f178.google.com (mail-lj1-f178.google.com. [209.85.208.178])
        by smtp.gmail.com with ESMTPSA id k3sm1579865lfd.245.2020.11.08.16.29.20
        for <linux-kernel@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Sun, 08 Nov 2020 16:29:21 -0800 (PST)
Received: by mail-lj1-f178.google.com with SMTP id r17so2574824ljg.5
        for <linux-kernel@vger.kernel.org>; Sun, 08 Nov 2020 16:29:20 -0800 (PST)
X-Received: by 2002:a2e:2202:: with SMTP id i2mr4637134lji.70.1604881759933;
 Sun, 08 Nov 2020 16:29:19 -0800 (PST)
MIME-Version: 1.0
From:   Linus Torvalds <torvalds@linux-foundation.org>
Date:   Sun, 8 Nov 2020 16:29:03 -0800
X-Gmail-Original-Message-ID: <CAHk-=wiZtabGDAxTbxaAkxf7QjuJSK7c7mcZXFkrYjRfXmSnmQ@mail.gmail.com>
Message-ID: <CAHk-=wiZtabGDAxTbxaAkxf7QjuJSK7c7mcZXFkrYjRfXmSnmQ@mail.gmail.com>
...
Alex Williamson (1):
      vfio/pci: Implement ioeventfd thread handler for contended memory loc=
k
...
Andreas Gruenbacher (1):
      gfs2: Don't call cancel_delayed_work_sync from within delete work fun=
ction
...
Bob Peterson (6):
      ...
      gfs2: init_journal's undo directive should also undo the statfs inode=
s
...
Brian Foster (3):
      ...
      iomap: support partial page discard on writeback block mapping failur=
e
...
Darrick J. Wong (4):
      xfs: set xefi_discard when creating a deferred agfl free log intent i=
tem
...
Eddy Wu (1):
      fork: fix copy_process(CLONE_PARENT) race with the exiting ->real_par=
ent
...
Fabio Estevam (2):
      mtd: rawnand: mxc: Move the ECC engine initialization to the right pl=
ace
      mtd: rawnand: ifc: Move the ECC engine initialization to the right pl=
ace
...
Fangrui Song (1):
      x86/lib: Change .weak to SYM_FUNC_START_WEAK for arch/x86/lib/mem*_64=
.S
...
Hangbin Liu (2):
      ...
      IPv6: reply ICMP error if the first fragment don't include all header=
s
...
Jason A. Donenfeld (2):
      wireguard: selftests: check that route_me_harder packets use the righ=
t sk
      netfilter: use actual socket sk rather than skb sk when routing harde=
r
...
#VC handler
      ...
      x86/head/64: Check SEV encryption before switching to kernel page-tab=
le
...
Michael Wu (2):
      ...
      i2c: designware: slave should do WRITE_REQUESTED before WRITE_RECEIVE=
D

Micha=C5=82 Miros=C5=82aw (1):
      regulator: defer probe when trying to get voltage from unresolved sup=
ply
...
Oleg Nesterov (1):
      ptrace: fix task_join_group_stop() for the case when current is trace=
d
...
value for RTR frames
      can: isotp: isotp_rcv_cf(): enable RX timeout handling in listen-only=
 mode
...
Peter Ujfalusi (3):
      dt-bindings: irqchip: ti, sci-inta: Update for unmapped event handlin=
g
...
Petr Malat (1):
      sctp: Fix COMM_LOST/CANT_STR_ASSOC err reporting on big-endian platfo=
rms
...
Song Liu (1):
      perf hists browser: Increase size of 'buf' in perf_evsel__hists_brows=
e()
...
Steven Rostedt (VMware) (6):
      selftests/ftrace: Use $FUNCTION_FORK to reference kernel fork functio=
n
...
zhongjiang-ali (1):
      mm: memcontrol: correct the NR_ANON_THPS counter of hierarchical memc=
g
