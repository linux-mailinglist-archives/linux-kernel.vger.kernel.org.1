...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2C4A72C4FE7
	for <lists+linux-kernel@lfdr.de>; Thu, 26 Nov 2020 09:00:49 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2388565AbgKZH6x (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 26 Nov 2020 02:58:53 -0500
Received: from mga06.intel.com ([134.134.136.31]:51629 "EHLO mga06.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1730005AbgKZH6w (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 26 Nov 2020 02:58:52 -0500
IronPort-SDR: wxPjvz+gzH/cyUiuvzoT3bzW3fG4O79q89psUDcQXeZLrPrApAuEE9yo5sAP0yquAxc7HB+F1J
 I9JPKpKN+5Og==
X-IronPort-AV: E=McAfee;i="6000,8403,9816"; a="233856208"
X-IronPort-AV: E=Sophos;i="5.78,371,1599548400"; 
   d="yaml'?scan'208";a="233856208"
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 25 Nov 2020 23:58:39 -0800
IronPort-SDR: /81MZgUMImJu5que+JvNQPbQ/Tnh2TNOI6z4261PZicCVpNVJXyTTkr/Pf/u1vypyaZp5mfc5r
 lDI7+ftCtWwA==
X-IronPort-AV: E=Sophos;i="5.78,371,1599548400"; 
   d="yaml'?scan'208";a="547618879"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.140])
  by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 25 Nov 2020 23:58:34 -0800
Date:   Thu, 26 Nov 2020 16:12:44 +0800
From:   kernel test robot <oliver.sang@intel.com>
To:     Waiman Long <longman@redhat.com>
Cc:     0day robot <lkp@intel.com>, LKML <linux-kernel@vger.kernel.org>,
        lkp@lists.01.org, ying.huang@intel.com, feng.tang@intel.com,
        zhengjun.xing@intel.com, Peter Zijlstra <peterz@infradead.org>,
        Ingo Molnar <mingo@redhat.com>, Will Deacon <will@kernel.org>,
        Davidlohr Bueso <dave@stgolabs.net>,
        Phil Auld <pauld@redhat.com>, Waiman Long <longman@redhat.com>
Subject: [locking/rwsem]  25d0c60b0e:  vm-scalability.throughput 316.2%
 improvement
Message-ID: <20201126081244.GA9086@xsang-OptiPlex-9020>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.10.0-rc3-00003-g25d0c60b0e40"
...
queue_at_least_once'
	...
	export submit_id='5fbecc04e3f06f25498b18f7'
	export job_file='/lkp/jobs/scheduled/lkp-csl-2ap4/vm-scalability-performance-300s-small-allocs-mt-ucode=0x5003003-monitor=6e02c248-debian-10.4-x86_64-20200603.cgz-25d0c60b0e409c6-20201126-9545-1lxdhka-3.yaml'
	export id='40ef7c4d99fa8f331d6f062072a19654da4bc916'
	...
	export commit='25d0c60b0e409c6c69f7192516ccdb7bcb505c19'
	export need_kconfig_hw='CONFIG_IGB=y
CONFIG_BLK_DEV_NVME'
	export ucode='0x5003003'
	export enqueue_time='2020-11-26 05:26:28 +0800'
	export _id='5fbecc08e3f06f25498b18f8'
	export _rt='/result/vm-scalability/performance-300s-small-allocs-mt-ucode=0x5003003-monitor=6e02c248/lkp-csl-2ap4/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/25d0c60b0e409c6c69f7192516ccdb7bcb505c19'
	export user='lkp'
	export compiler='gcc-9'
	export head_commit='258c14366a1e8ecd585f525a6644a4c55296c536'
	...
	export result_root='/result/vm-scalability/performance-300s-small-allocs-mt-ucode=0x5003003-monitor=6e02c248/lkp-csl-2ap4/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/25d0c60b0e409c6c69f7192516ccdb7bcb505c19/3'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-csl-2ap4/vm-scalability-performance-300s-small-allocs-mt-ucode=0x5003003-monitor=6e02c248-debian-10.4-x86_64-20200603.cgz-25d0c60b0e409c6-20201126-9545-1lxdhka-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-8.3
branch=linux-review/Waiman-Long/locking-rwsem-Rework-reader-optimistic-spinning/20201121-122118
commit=25d0c60b0e409c6c69f7192516ccdb7bcb505c19
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/25d0c60b0e409c6c69f7192516ccdb7bcb505c19/vmlinuz-5.10.0-rc3-00003-g25d0c60b0e40
acpi_rsdp=0x67f44014
max_uptime=3600
RESULT_ROOT=/result/vm-scalability/performance-300s-small-allocs-mt-ucode=0x5003003-monitor=6e02c248/lkp-csl-2ap4/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/25d0c60b0e409c6c69f7192516ccdb7bcb505c19/3
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/25d0c60b0e409c6c69f7192516ccdb7bcb505c19/modules.cgz'
	...
	export last_kernel='5.10.0-rc4-intel-next-02854-g220a22aee7ff'
	export repeat_to=4
	export schedule_notify_address=
	export queue_at_least_once=1
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/25d0c60b0e409c6c69f7192516ccdb7bcb505c19/vmlinuz-5.10.0-rc3-00003-g25d0c60b0e40'
	export dequeue_time='2020-11-26 05:35:47 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2ap4/vm-scalability-performance-300s-small-allocs-mt-ucode=0x5003003-monitor=6e02c248-debian-10.4-x86_64-20200603.cgz-25d0c60b0e409c6-20201126-9545-1lxdhka-3.cgz'
...
kconfig: x86_64-rhel-8.3
submit_id: 5fbea5e368e48a2bc4682d4c
job_file: "/lkp/jobs/scheduled/lkp-csl-2ap4/vm-scalability-performance-300s-small-allocs-mt-ucode=0x5003003-monitor=6e02c248-debian-10.4-x86_64-20200603.cgz-25d0c60b0e409c6-20201126-11204-1dyny8z-1.yaml"
id: 0b82b86c71d7668802bbf6293411767cbb3cb67c
...
- CONFIG_BLK_DEV_NVME
ucode: '0x5003003'
enqueue_time: 2020-11-26 02:43:48.021125301 +08:00
_id: 5fbea5e868e48a2bc4682d4d
_rt: "/result/vm-scalability/performance-300s-small-allocs-mt-ucode=0x5003003-monitor=6e02c248/lkp-csl-2ap4/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/25d0c60b0e409c6c69f7192516ccdb7bcb505c19"

#! schedule options
user: lkp
compiler: gcc-9
head_commit: 258c14366a1e8ecd585f525a6644a4c55296c536
base_commit: '09162bc32c880a791c6c0668ce0745cf7958f576'
branch: linux-devel/devel-hourly-2020112119
rootfs: debian-10.4-x86_64-20200603.cgz
monitor_sha: 6e02c248
result_root: "/result/vm-scalability/performance-300s-small-allocs-mt-ucode=0x5003003-monitor=6e02c248/lkp-csl-2ap4/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/25d0c60b0e409c6c69f7192516ccdb7bcb505c19/0"
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-csl-2ap4/vm-scalability-performance-300s-small-allocs-mt-ucode=0x5003003-monitor=6e02c248-debian-10.4-x86_64-20200603.cgz-25d0c60b0e409c6-20201126-11204-1dyny8z-1.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- branch=linux-devel/devel-hourly-2020112119
- commit=25d0c60b0e409c6c69f7192516ccdb7bcb505c19
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/25d0c60b0e409c6c69f7192516ccdb7bcb505c19/modules.cgz"
...
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/25d0c60b0e409c6c69f7192516ccdb7bcb505c19/vmlinuz-5.10.0-rc3-00003-g25d0c60b0e40"
dequeue_time: 2020-11-26 03:12:19.590676784 +08:00

#! /lkp/lkp/.src-20201125-160031/include/site/inn
job_state: finished
loadavg: 136.72 114.02 52.03 1/1292 13385
start_time: '1606332050'
end_time: '1606332358'
...
cd /lkp/benchmarks/vm-scalability
 ...
 truncate -s 202462588928 /tmp/vm-scalability-tmp/vm-scalability.img
