...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0B4751C70B3
	for <lists+linux-kernel@lfdr.de>; Wed,  6 May 2020 14:48:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728590AbgEFMr3 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 6 May 2020 08:47:29 -0400
Received: from mail.kernel.org ([198.145.29.99]:59190 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728330AbgEFMr1 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 6 May 2020 08:47:27 -0400
Received: from localhost (83-86-89-107.cable.dynamic.v4.ziggo.nl [83.86.89.107])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 0F9ED206DD;
        Wed,  6 May 2020 12:47:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1588769244;
        bh=DcIlEql+DHSK86E3XF28LdjCwCIXqWNnuOffKZAE5j8=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=iS+xgRU2KD72hBqi6nOFMOkPfrBp4dNaI4WWElEJ4ENeRn9MqaSUbc8Uf928gw54k
         EWht5A8Rdcfa1GN4t2d+G3ge+bcOYUNRamuwyuuN068NzjFP9NuOuGGLZLx7uVoHo0
         pK3U8Lck3iIuVJmAcnDTFE3Ot4TPa27u37V92g4g=
...
Subject: Re: Linux 5.6.11
Message-ID: <20200506124722.GB3146555@kroah.com>
References: <20200506124716.GA3146555@kroah.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20200506124716.GA3146555@kroah.com>
...
@@ -2093,8 +2127,6 @@ static int writecache_ctr(struct dm_target *ti, unsigned argc, char **argv)
 			goto bad;
 		}
 	} else {
-		struct dm_io_region region;
...
@@ -2151,19 +2183,9 @@ static int writecache_ctr(struct dm_target *ti, unsigned argc, char **argv)
 			goto bad;
 		}
