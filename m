...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9E5C1245B13
	for <lists+linux-kernel@lfdr.de>; Mon, 17 Aug 2020 05:37:11 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726938AbgHQDhK (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 16 Aug 2020 23:37:10 -0400
Received: from mga04.intel.com ([192.55.52.120]:53830 "EHLO mga04.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727076AbgHQDhJ (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 16 Aug 2020 23:37:09 -0400
IronPort-SDR: zRA+oyt3K/lbaE4GZar3AVJr3LXtLm+9fhzgQvv/BU0efz4VHADUsb2LMi6Sr87n/lgGoOtYAM
 57kqldWYpv1w==
X-IronPort-AV: E=McAfee;i="6000,8403,9715"; a="152033209"
X-IronPort-AV: E=Sophos;i="5.76,322,1592895600"; 
   d="scan'208";a="152033209"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 16 Aug 2020 20:34:07 -0700
IronPort-SDR: UG5mug5OKNQg5enZApooOgo9o4UhiQ6//4SpQMsyRSgmmsKak+adyWzmRqA6fQrPKNpVgP5DKG
 rmrKyDRrDMGQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.76,322,1592895600"; 
   d="scan'208";a="400075247"
Received: from chenyi-pc.sh.intel.com ([10.239.159.72])
  by fmsmga001.fm.intel.com with ESMTP; 16 Aug 2020 20:34:05 -0700
...
Subject: [RESEND RFC v2 2/2] KVM: VMX: Enable bus lock VM exit
Date:   Mon, 17 Aug 2020 11:36:04 +0800
Message-Id: <20200817033604.5836-3-chenyi.qiang@intel.com>
...
index 6959eaa66254..c618b5e7e9fd 100644
...
@@ -5685,6 +5689,16 @@ static int handle_encls(struct kvm_vcpu *vcpu)
 	return 1;
 }
...
@@ -5741,6 +5755,7 @@ static int (*kvm_vmx_exit_handlers[])(struct kvm_vcpu *vcpu) = {
...
@@ -6884,6 +6899,19 @@ static fastpath_t vmx_vcpu_run(struct kvm_vcpu *vcpu)
...
@@ -8097,6 +8125,9 @@ static __init int hardware_setup(void)
...
index 599d73206299..ac810033481a 100644
...
@@ -224,6 +226,7 @@ struct kvm_stats_debugfs_item debugfs_entries[] = {
...
@@ -3581,6 +3584,9 @@ int kvm_vm_ioctl_check_extension(struct kvm *kvm, long ext)
...
@@ -5033,6 +5039,12 @@ int kvm_vm_ioctl_enable_cap(struct kvm *kvm,
...
+		break;
 	default:
 		r = -EINVAL;
 		break;
@@ -7775,12 +7787,23 @@ static void post_kvm_run_save(struct kvm_vcpu *vcpu)
 	struct kvm_run *kvm_run = vcpu->run;
...
@@ -8639,6 +8662,17 @@ static int vcpu_enter_guest(struct kvm_vcpu *vcpu)
...
index f6d86033c4fa..015089b874f1 100644
