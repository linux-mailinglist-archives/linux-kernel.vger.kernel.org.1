...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 4A9CB1BB977
	for <lists+linux-kernel@lfdr.de>; Tue, 28 Apr 2020 11:07:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726826AbgD1JHR (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 28 Apr 2020 05:07:17 -0400
Received: from mga03.intel.com ([134.134.136.65]:14841 "EHLO mga03.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726271AbgD1JHQ (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 28 Apr 2020 05:07:16 -0400
IronPort-SDR: Prl7GEvHppSMrA2GzuQBBy9n8soHrUZ6xMKkSUUf59EQ1+Ivl3kx9LMlW/wF6OLi3pNHRWIV+S
 4+MCuIeS0eKg==
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 28 Apr 2020 02:04:38 -0700
IronPort-SDR: yNeFlh156/aVl/hMxigAWAhX7kzdsYlaOgNx4nvol17oGrM1IuCyvzhaFDu44MN55eDV1p0rog
 MuoZ+XSaHkAA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,327,1583222400"; 
   d="yaml'?scan'208";a="458718830"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.3])
  by fmsmga005.fm.intel.com with ESMTP; 28 Apr 2020 02:04:35 -0700
...
export_top_env()
{
	...
	export timeout='30m'
	export testtime=1
	export job_origin='/lkp/lkp/.src-20200424-144738/allot/cyclic:p1:linux-devel:devel-hourly/lkp-bdw-ep6/stress-ng.yaml'
...
queue_at_least_once'
	...
	export submit_id='5ea74bb85a78265406f1d1fc'
	export job_file='/lkp/jobs/scheduled/lkp-bdw-ep6/stress-ng-cpu-performance-1HDD-100%-1s-ucode=0xb000038-debian-x86_64-20191114.cgz-beeb460cd12ac9b91640b484b6a52dcba9d9fc8f-20200428-21510-1vhq3pb-3.yaml'
	export id='e3c46958baa57e87d68bbe8918ff5856601049e4'
...
CONFIG_HAS_DMA=y'
	...
	export enqueue_time='2020-04-28 05:16:45 +0800'
	export _id='5ea74bbf5a78265406f1d1fd'
	export _rt='/result/stress-ng/cpu-performance-1HDD-100%-1s-ucode=0xb000038/lkp-bdw-ep6/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/beeb460cd12ac9b91640b484b6a52dcba9d9fc8f'
	export user='lkp'
	...
	export result_root='/result/stress-ng/cpu-performance-1HDD-100%-1s-ucode=0xb000038/lkp-bdw-ep6/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/beeb460cd12ac9b91640b484b6a52dcba9d9fc8f/3'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-bdw-ep6/stress-ng-cpu-performance-1HDD-100%-1s-ucode=0xb000038-debian-x86_64-20191114.cgz-beeb460cd12ac9b91640b484b6a52dcba9d9fc8f-20200428-21510-1vhq3pb-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-7.6
branch=linux-devel/devel-hourly-2020042321
commit=beeb460cd12ac9b91640b484b6a52dcba9d9fc8f
BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/beeb460cd12ac9b91640b484b6a52dcba9d9fc8f/vmlinuz-5.7.0-rc1-00021-gbeeb460cd12ac
max_uptime=1800
RESULT_ROOT=/result/stress-ng/cpu-performance-1HDD-100%-1s-ucode=0xb000038/lkp-bdw-ep6/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/beeb460cd12ac9b91640b484b6a52dcba9d9fc8f/3
LKP_SERVER=inn
nokaslr
selinux=0
debug
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-7.6/gcc-7/beeb460cd12ac9b91640b484b6a52dcba9d9fc8f/modules.cgz'
	...
	export last_kernel='5.7.0-rc2-intel-next-01094-gb7d815827e5ab'
	export repeat_to=4
	export schedule_notify_address=
	export queue_at_least_once=1
	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-7/beeb460cd12ac9b91640b484b6a52dcba9d9fc8f/vmlinuz-5.7.0-rc1-00021-gbeeb460cd12ac'
	export dequeue_time='2020-04-28 05:19:08 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-bdw-ep6/stress-ng-cpu-performance-1HDD-100%-1s-ucode=0xb000038-debian-x86_64-20191114.cgz-beeb460cd12ac9b91640b484b6a52dcba9d9fc8f-20200428-21510-1vhq3pb-3.cgz'
...
run_job()
{
	...
	run_test class='cpu' $LKP_SRC/tests/wrapper stress-ng
}
...
stress-ng:
  class: cpu
job_origin: "/lkp/lkp/.src-20200424-144738/allot/cyclic:p1:linux-devel:devel-hourly/lkp-bdw-ep6/stress-ng.yaml"
...
submit_id: 5ea740df5a7826532de1e111
job_file: "/lkp/jobs/scheduled/lkp-bdw-ep6/stress-ng-cpu-performance-1HDD-100%-1s-ucode=0xb000038-debian-x86_64-20191114.cgz-beeb460cd12ac9b91640b484b6a52dcba9d9fc8f-20200428-21293-1e10zmr-0.yaml"
id: b1bea4a7bfa873d209aed6519888fcc7e751688c
...
kconfig: x86_64-rhel-7.6
compiler: gcc-7
enqueue_time: 2020-04-28 04:30:27.061640056 +08:00
_id: 5ea740df5a7826532de1e111
_rt: "/result/stress-ng/cpu-performance-1HDD-100%-1s-ucode=0xb000038/lkp-bdw-ep6/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/beeb460cd12ac9b91640b484b6a52dcba9d9fc8f"

#! schedule options
user: lkp
head_commit: 94755da21cb62dd290e3d9d93362c7aa722a3e3f
base_commit: ae83d0b416db002fe95601e7f97f64b59514d936
branch: linux-devel/devel-hourly-2020042321
rootfs: debian-x86_64-20191114.cgz
result_root: "/result/stress-ng/cpu-performance-1HDD-100%-1s-ucode=0xb000038/lkp-bdw-ep6/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/beeb460cd12ac9b91640b484b6a52dcba9d9fc8f/0"
scheduler_version: "/lkp/lkp/.src-20200427-120211"
LKP_SERVER: inn
arch: x86_64
max_uptime: 1800
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-bdw-ep6/stress-ng-cpu-performance-1HDD-100%-1s-ucode=0xb000038-debian-x86_64-20191114.cgz-beeb460cd12ac9b91640b484b6a52dcba9d9fc8f-20200428-21293-1e10zmr-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2020042321
- commit=beeb460cd12ac9b91640b484b6a52dcba9d9fc8f
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/beeb460cd12ac9b91640b484b6a52dcba9d9fc8f/modules.cgz"
...
#! /lkp/lkp/.src-20200427-120211/include/site/inn
LKP_CGI_PORT: 80
LKP_CIFS_PORT: 139
oom-killer: 
watchdog: 
...
#! runtime status
last_kernel: 5.7.0-rc2-intel-next-01094-gb7d815827e5ab
repeat_to: 2
schedule_notify_address: 

#! user overrides
queue_at_least_once: 0
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/beeb460cd12ac9b91640b484b6a52dcba9d9fc8f/vmlinuz-5.7.0-rc1-00021-gbeeb460cd12ac"
dequeue_time: 2020-04-28 05:01:44.251357946 +08:00
job_state: finished
loadavg: 37.22 11.06 3.81 1/1034 39809
start_time: '1588021377'
end_time: '1588021420'
version: "/lkp/lkp/.src-20200427-120241:c9c16b6b:ab0c67f55-dirty"
...
do
 ...
 "stress-ng" "--timeout" "1" "--times" "--verify" "--metrics-brief" "--sequential" "88" "--class" "cpu" "--exclude" "spawn,exec,swap"
