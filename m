...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BBFE1248A8D
	for <lists+linux-kernel@lfdr.de>; Tue, 18 Aug 2020 17:52:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728274AbgHRPwR (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 18 Aug 2020 11:52:17 -0400
Received: from mga06.intel.com ([134.134.136.31]:19090 "EHLO mga06.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728227AbgHRPsA (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 18 Aug 2020 11:48:00 -0400
IronPort-SDR: XMJNDWaACYkJTw+aGOL0ZPqdf2Q81oa9aqJ1viiXfrxZ1NwTfU2LcRHwRmao+8MHnxgGDGAfcy
 JBzF8V4DZYrw==
X-IronPort-AV: E=McAfee;i="6000,8403,9716"; a="216462444"
X-IronPort-AV: E=Sophos;i="5.76,327,1592895600"; 
   d="scan'208";a="216462444"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 18 Aug 2020 08:47:59 -0700
IronPort-SDR: UyWu+LA0Pwg7U/z0GVXd4sCeig8j72S8iC0/gFW2mhRhvh2p+sm45uXoIsW9nhGyl3/m2tn45K
 lOpA+8amDIDw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.76,327,1592895600"; 
   d="scan'208";a="400530409"
Received: from pg-nxl3.altera.com ([10.142.129.93])
  by fmsmga001.fm.intel.com with ESMTP; 18 Aug 2020 08:47:56 -0700
...
Subject: [PATCH v6 09/10] net: eth: altera: add msgdma prefetcher
Date:   Tue, 18 Aug 2020 23:46:12 +0800
Message-Id: <20200818154613.148921-10-joyce.ooi@intel.com>
...
index acf9f5044c96..1cce8b2005f4 100644
...
+#include "altera_msgdma_prefetcher.h"
 ...
 /* Module parameters */
@@ -1496,6 +1497,23 @@ static int altera_tse_probe(struct platform_device *pdev)
...
@@ -1753,7 +1771,29 @@ static const struct altera_dmaops altera_dtype_msgdma = {
 	.start_txdma = NULL,
 };
