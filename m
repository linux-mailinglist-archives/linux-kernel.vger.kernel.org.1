...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 33C2D1EA343
	for <lists+linux-kernel@lfdr.de>; Mon,  1 Jun 2020 14:01:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727900AbgFAMA0 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 1 Jun 2020 08:00:26 -0400
Received: from us-smtp-1.mimecast.com ([205.139.110.61]:23037 "EHLO
        us-smtp-delivery-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1727068AbgFAMAT (ORCPT
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        ...
        bh=cstkp/Mapy/ERbEgvcpiPEazVPeCT6HVjySJyjTnNQY=;
        b=QvkdhoKu3rXBXK50nwo/b9ji/YKpqFTBBOAb33hehqD0Nw8p4jbj/fNHuXeDhCHdU8YsJf
        66wovpDr/lavGkTv+yIb38eFrPW6dlI+0FrEjaXC1D21iCPSgxWzN+TyZ0Wrr8BHm3GcbI
        nDnVaF+rV+5LJbNQPh8zfeuTve3orIs=
Received: from mail-qk1-f199.google.com (mail-qk1-f199.google.com
 [209.85.222.199]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-238-Jc_NrruPOJqouvc6I7U9DA-1; Mon, 01 Jun 2020 08:00:13 -0400
X-MC-Unique: Jc_NrruPOJqouvc6I7U9DA-1
Received: by mail-qk1-f199.google.com with SMTP id 205so7824771qkh.5
        for <linux-kernel@vger.kernel.org>; Mon, 01 Jun 2020 05:00:13 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:mime-version:content-transfer-encoding;
        bh=cstkp/Mapy/ERbEgvcpiPEazVPeCT6HVjySJyjTnNQY=;
        b=
X-Gm-Message-State: AOAM533G8Uj1pKmrQRqn2wh5dbBWcNHkaT5xzUSb7X8iNnmsn0N8iidb
        oyOdm4vgMkQrtyog5R/v9Hom8QkOY4wywTskKNzMn5zapw8/tm28OtrPYvTRikDaIgGTVt1XuVc
        /IfxQ5SjfqtKJKtnvhu8wiv/r
X-Received: by 2002:ac8:4e4f:: with SMTP id e15mr21507952qtw.318.1591012812254;
        Mon, 01 Jun 2020 05:00:12 -0700 (PDT)
X-Google-Smtp-Source: ABdhPJx/ChvaKOAM3eYcWS42h3tFzXlfaUz2aMkhtwUtAsSWizeM8XweqzkE0B4abSv6ddtTBzzkYg==
X-Received: by 2002:ac8:4e4f:: with SMTP id e15mr21507880qtw.318.1591012811544;
        Mon, 01 Jun 2020 05:00:11 -0700 (PDT)
Received: from xz-x1.redhat.com ([2607:9880:19c0:32::2])
        by smtp.gmail.com with ESMTPSA id l9sm14474185qki.90.2020.06.01.05.00.09
...
Subject: [PATCH v10 05/14] KVM: X86: Implement ring-based dirty memory tracking
Date:   Mon,  1 Jun 2020 07:59:48 -0400
Message-Id: <20200601115957.1581250-6-peterx@redhat.com>
...
index c44637e8e9d6..9f4dbc61e787 100644
--- a/arch/x86/kvm/vmx/vmx.c
+++ b/arch/x86/kvm/vmx/vmx.c
@@ -7701,6 +7701,11 @@ static bool vmx_check_apicv_inhibit_reasons(ulong bit)
...
@@ -7836,6 +7841,7 @@ static struct kvm_x86_ops vmx_x86_ops __initdata = {
...
@@ -7953,6 +7959,7 @@ static __init int hardware_setup(void)
...
@@ -8017,7 +8024,6 @@ static struct kvm_x86_init_ops vmx_init_ops __initdata = {
...
index a7460e93d457..c40b0c57427f 100644
...
@@ -2916,6 +2924,17 @@ void kvm_vcpu_on_spin(struct kvm_vcpu *me, bool yield_to_kernel_mode)
 }
...
@@ -2931,6 +2950,10 @@ static vm_fault_t kvm_vcpu_fault(struct vm_fault *vmf)
...
+		    vmf->pgoff - KVM_DIRTY_LOG_PAGE_OFFSET);
 	...
 	get_page(page);
@@ -2944,6 +2967,14 @@ static const struct vm_operations_struct kvm_vcpu_vm_ops = {
...
@@ -3037,6 +3068,13 @@ static int kvm_vm_ioctl_create_vcpu(struct kvm *kvm, u32 id)
 	if (r)
...
+
 	...
 	mutex_lock(&kvm->lock);
@@ -3072,6 +3110,8 @@ static int kvm_vm_ioctl_create_vcpu(struct kvm *kvm, u32 id)
 unlock_vcpu_destroy:
...
@@ -3543,12 +3583,78 @@ static long kvm_vm_ioctl_check_extension_generic(struct kvm *kvm, long arg)
 #endif
...
+
 ...
 {
@@ -3572,6 +3678,8 @@ static int kvm_vm_ioctl_enable_cap_generic(struct kvm *kvm,
 		return 0;
 	}
 #endif
+	case KVM_CAP_DIRTY_LOG_RING:
...
@@ -3759,6 +3867,9 @@ static long kvm_vm_ioctl(struct file *filp,
