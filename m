...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 30B8F234764
	for <lists+linux-kernel@lfdr.de>; Fri, 31 Jul 2020 16:08:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387519AbgGaOIW (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 31 Jul 2020 10:08:22 -0400
Received: from labrats.qualcomm.com ([199.106.110.90]:12145 "EHLO
        labrats.qualcomm.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2387500AbgGaOIU (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 31 Jul 2020 10:08:20 -0400
IronPort-SDR: 
X-IronPort-AV: E=Sophos;i="5.75,418,1589266800"; 
   d="scan'208";a="47235772"
Received: from unknown (HELO ironmsg05-sd.qualcomm.com) ([10.53.140.145])
  by labrats.qualcomm.com with ESMTP; 31 Jul 2020 07:08:19 -0700
Received: from pacamara-linux.qualcomm.com ([192.168.140.135])
  by ironmsg05-sd.qualcomm.com with ESMTP; 31 Jul 2020 07:08:18 -0700
Received: by pacamara-linux.qualcomm.com (Postfix, from userid 359480)
        id E26F322E4D; Fri, 31 Jul 2020 07:08:18 -0700 (PDT)
...
Date:   Fri, 31 Jul 2020 07:07:53 -0700
Message-Id: <1596204478-5420-6-git-send-email-cang@codeaurora.org>
...
@@ -8405,10 +8404,13 @@ static int ufshcd_resume(struct ufs_hba *hba, enum ufs_pm_op pm_op)
...
@@ -8782,6 +8784,7 @@ int ufshcd_init(struct ufs_hba *hba, void __iomem *mmio_base, unsigned int irq)
 	int err;
...
+	char eh_wq_name[sizeof("ufs_eh_wq_00")];
 	...
 	if (!mmio_base) {
 		dev_err(hba->dev,
@@ -8843,6 +8846,15 @@ int ufshcd_init(struct ufs_hba *hba, void __iomem *mmio_base, unsigned int irq)
