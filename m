...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 300AA280BB7
	for <lists+linux-kernel@lfdr.de>; Fri,  2 Oct 2020 02:36:29 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387446AbgJBAgZ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 1 Oct 2020 20:36:25 -0400
Received: from mx0b-002e3701.pphosted.com ([148.163.143.35]:46772 "EHLO
        mx0b-002e3701.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1728090AbgJBAgY (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 1 Oct 2020 20:36:24 -0400
Received: from pps.filterd (m0150244.ppops.net [127.0.0.1])
        by mx0b-002e3701.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id 091NwAwb022510;
        Fri, 2 Oct 2020 00:06:26 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=hpe.com; h=from : to : cc : subject
 : date : message-id : in-reply-to : references : mime-version :
 content-transfer-encoding; s=pps0720;
 bh=z09lYG/l0oVAsQGt9URDZe3ecdrNnE3zioFtL+IFjWc=;
 b= KA== 
Received: from g2t2354.austin.hpe.com (g2t2354.austin.hpe.com [15.233.44.27])
        by mx0b-002e3701.pphosted.com with ESMTP id 33w8mb8jwy-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Fri, 02 Oct 2020 00:06:24 +0000
Received: from g2t2360.austin.hpecorp.net (g2t2360.austin.hpecorp.net [16.196.225.135])
        by g2t2354.austin.hpe.com (Postfix) with ESMTP id DA7FB9D;
        Fri,  2 Oct 2020 00:06:23 +0000 (UTC)
Received: from dog.eag.rdlabs.hpecorp.net (dog.eag.rdlabs.hpecorp.net [128.162.243.181])
        by g2t2360.austin.hpecorp.net (Postfix) with ESMTP id 815543A;
...
Subject: [PATCH v3 04/13] x86/platform/uv: Update UV MMRs for UV5
Date:   Thu,  1 Oct 2020 19:05:29 -0500
Message-Id: <20201002000538.94424-5-mike.travis@hpe.com>
...
---
 ...
 5 files changed, 4277 insertions(+), 3701 deletions(-)
...
index f51fabf56010..a9f3baa7582d 100644
...
@@ -87,41 +88,72 @@ static bool uv_is_untracked_pat_range(u64 start, u64 end)
...
@@ -221,29 +253,28 @@ static void __init uv_stringify(int len, char *to, char *from)
...
@@ -252,60 +283,78 @@ static int __init uv_acpi_madt_oem_check(char *_oem_id, char *_oem_table_id)
 		return 0;
 	}
...
@@ -673,12 +722,12 @@ static struct apic apic_x2apic_uv_x __ro_after_init = {
 };
...
+	union uvh_rh_gam_alias_2_redirect_config_u redirect;
 	...
 	int i;
@@ -686,16 +735,16 @@ static __init void get_lowmem_redirect(unsigned long *base, unsigned long *size)
...
@@ -730,12 +779,12 @@ static __init void map_high(char *id, unsigned long base, int pshift, int bshift
...
+	gru.v = uv_read_local_mmr(UVH_RH_GAM_GRU_OVERLAY_CONFIG);
 	if (!gru.s.enable) {
 		...
 		return;
@@ -749,10 +798,10 @@ static __init void map_gru_high(int max_pnode)
...
@@ -773,29 +822,29 @@ static __init void map_mmioh_high_uv34(int index, int min_pnode, int max_pnode)
...
@@ -855,7 +904,7 @@ static __init void map_mmioh_high_uv34(int index, int min_pnode, int max_pnode)
...
@@ -867,8 +916,8 @@ static __init void map_mmioh_high(int min_pnode, int max_pnode)
 	}
...
+	m_n_config.v	= uv_read_local_mmr(UVH_RH_GAM_ADDR_MAP_CONFIG);
 	...
 	if (is_uv4_hub()) {
@@ -964,7 +1013,7 @@ static void get_mn(struct mn *mnp)
 		mnp->n_lshift	= 0;
 	} else if (is_uv3_hub()) {
...
@@ -988,6 +1037,7 @@ static void __init uv_init_hub_info(struct uv_hub_info_s *hi)
...
@@ -999,7 +1049,7 @@ static void __init uv_init_hub_info(struct uv_hub_info_s *hi)
...
@@ -1011,7 +1061,9 @@ static void __init uv_init_hub_info(struct uv_hub_info_s *hi)
...
@@ -1135,11 +1187,7 @@ static int __init decode_uv_systab(void)
 	return 0;
 }
...
index f82a1337a608..e94436ba3022 100644
