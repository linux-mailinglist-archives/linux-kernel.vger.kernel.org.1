...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9CD0A2708F7
	for <lists+linux-kernel@lfdr.de>; Sat, 19 Sep 2020 00:34:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726236AbgIRWe3 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 18 Sep 2020 18:34:29 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46274 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726064AbgIRWeZ (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 18 Sep 2020 18:34:25 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [IPv6:2a0a:51c0:0:12e:550::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7B3A2C0613CE
        for <linux-kernel@vger.kernel.org>; Fri, 18 Sep 2020 15:34:25 -0700 (PDT)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        ...
        bh=nqFIOAdQE5CbkQqnuH0+UEX9ljGdPCB6U22h0IGNdXU=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1600468463;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=nqFIOAdQE5CbkQqnuH0+UEX9ljGdPCB6U22h0IGNdXU=;
        b=hNoAjPT/sI5nWo6Axi9azivAe8sqSrE/fvQhNSqNXx/o9/XZo6mVf0CXz+FlzVBSx/Yaj9
        pIsX+s9mHcYKzNCA==
...
Subject: [PATCH printk v2 2/3] printk: move dictionary keys to dev_printk_info
Date:   Sat, 19 Sep 2020 00:40:20 +0206
Message-Id: <20200918223421.21621-3-john.ogness@linutronix.de>
...
index 25cfe4fe48af..269f0abd1ddf 100644
...
@@ -941,6 +942,8 @@ const struct file_operations kmsg_fops = {
  */
...
@@ -978,6 +981,13 @@ void log_buf_vmcoreinfo_setup(void)
...
@@ -1070,22 +1080,19 @@ static unsigned int __init add_to_rb(struct printk_ringbuffer *rb,
 	struct prb_reserved_entry e;
...
@@ -1093,7 +1100,6 @@ static unsigned int __init add_to_rb(struct printk_ringbuffer *rb,
 }
...
-static char setup_dict_buf[CONSOLE_EXT_LOG_MAX] __initdata;
 ...
 {
@@ -1165,7 +1171,7 @@ void __init setup_log_buf(int early)
...
@@ -1903,7 +1909,9 @@ static inline u32 printk_caller_id(void)
...
@@ -1927,12 +1935,12 @@ static size_t log_output(int facility, int level, enum log_flags lflags, const c
...
@@ -1974,15 +1982,14 @@ int vprintk_store(int facility, int level,
...
+			    const struct dev_printk_info *dev_info,
 ...
 {
 	int printed_len;
@@ -2003,7 +2010,7 @@ asmlinkage int vprintk_emit(int facility, int level,
...
@@ -2037,7 +2044,7 @@ EXPORT_SYMBOL(vprintk);
...
@@ -2100,8 +2107,8 @@ static ssize_t info_print_ext_header(char *buf, size_t size,
 	return 0;
 }
 static ssize_t msg_print_ext_body(char *buf, size_t size,
-				  char *dict, size_t dict_len,
...
@@ -2390,7 +2397,6 @@ void console_unlock(void)
 {
...
-	static char dict[LOG_LINE_MAX];
 	...
 	struct printk_info info;
@@ -2401,7 +2407,7 @@ void console_unlock(void)
 		return;
 	}
...
@@ -2473,10 +2479,9 @@ void console_unlock(void)
 						r.info);
...
@@ -3055,7 +3060,7 @@ int vprintk_deferred(const char *fmt, va_list args)
 {
 	int r;
