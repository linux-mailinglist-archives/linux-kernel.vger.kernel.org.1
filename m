...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2EE72216B66
	for <lists+linux-kernel@lfdr.de>; Tue,  7 Jul 2020 13:22:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728309AbgGGLV7 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 7 Jul 2020 07:21:59 -0400
Received: from szxga05-in.huawei.com ([45.249.212.191]:7267 "EHLO huawei.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1728250AbgGGLV5 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 7 Jul 2020 07:21:57 -0400
Received: from DGGEMS409-HUB.china.huawei.com (unknown [172.30.72.59])
        by Forcepoint Email with ESMTP id 3DB32492299279FCE12F;
        Tue,  7 Jul 2020 19:21:53 +0800 (CST)
Received: from szvp000203569.huawei.com (10.120.216.130) by
 DGGEMS409-HUB.china.huawei.com (10.3.19.209) with Microsoft SMTP Server id
 14.3.487.0; Tue, 7 Jul 2020 19:21:46 +0800
From:   Chao Yu <yuchao0@huawei.com>
To:     <jaegeuk@kernel.org>
CC:     <linux-f2fs-devel@lists.sourceforge.net>,
        <linux-kernel@vger.kernel.org>, <chao@kernel.org>,
        Chao Yu <yuchao0@huawei.com>
Subject: [PATCH 5/5] f2fs: support age threshold based garbage collection
Date:   Tue, 7 Jul 2020 19:21:28 +0800
Message-ID: <20200707112128.89136-6-yuchao0@huawei.com>
...
index bb9eb67d48f9..415bd120e561 100644
--- a/fs/f2fs/checkpoint.c
+++ b/fs/f2fs/checkpoint.c
@@ -1617,7 +1617,7 @@ int f2fs_write_checkpoint(struct f2fs_sb_info *sbi, struct cp_control *cpc)
...
+	f2fs_save_inmem_curseg(sbi);
 	...
 	if (err)
@@ -1625,7 +1625,7 @@ int f2fs_write_checkpoint(struct f2fs_sb_info *sbi, struct cp_control *cpc)
 	else
...
index 7f108684de1d..59e4b03ee4ca 100644
--- a/fs/f2fs/data.c
+++ b/fs/f2fs/data.c
...
index 3430964f0f6a..ef4babc96723 100644
--- a/fs/f2fs/f2fs.h
+++ b/fs/f2fs/f2fs.h
...
index da187aec988f..74ccab19fba8 100644
--- a/fs/f2fs/gc.c
+++ b/fs/f2fs/gc.c
@@ -21,6 +21,8 @@
 #include "gc.h"
...
@@ -1413,6 +1734,38 @@ int f2fs_gc(struct f2fs_sb_info *sbi, bool sync,
 	return ret;
 }
...
@@ -1423,6 +1776,8 @@ void f2fs_build_gc_manager(struct f2fs_sb_info *sbi)
...
index b66ac28d9aa5..e92b0aa3bad6 100644
--- a/fs/f2fs/segment.c
+++ b/fs/f2fs/segment.c
