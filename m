...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7C1202A982C
	for <lists+linux-kernel@lfdr.de>; Fri,  6 Nov 2020 16:12:07 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727743AbgKFPL7 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 6 Nov 2020 10:11:59 -0500
Received: from relaydlg-01.paragon-software.com ([81.5.88.159]:48958 "EHLO
        relaydlg-01.paragon-software.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1727314AbgKFPLs (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 6 Nov 2020 10:11:48 -0500
Received: from dlg2.mail.paragon-software.com (vdlg-exch-02.paragon-software.com [172.30.1.105])
        by relaydlg-01.paragon-software.com (Postfix) with ESMTPS id 30F6D8222A;
        Fri,  6 Nov 2020 18:11:16 +0300 (MSK)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=paragon-software.com; s=mail; t=1604675476;
        bh=ulgceWjfJ/k1uPh+/t9QGOi2hkN8PaAWrzUlFSFF4Ck=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=O9Bq5u6oLQ89/Oy+3aSP+Vm9hVDQ+yCP0DcvpJvs8OMIMq0EB2M6BWMrURCAunIaW
         jO2iyvu6C7bs9pLaqn9Xglmb+4IKTJhs0pnb2rqHZBk9lLHbWffSohw5eBvAjGUZK2
         4sWWxTmnKylevw2CKuLkp31HkM+Otsq1b01iPM7E=
Received: from fsd-lkpg.ufsd.paragon-software.com (172.30.114.105) by
 vdlg-exch-02.paragon-software.com (172.30.1.105) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1847.3; Fri, 6 Nov 2020 18:11:15 +0300
...
Subject: [PATCH v12 02/10] fs/ntfs3: Add initialization of super block
Date:   Fri, 6 Nov 2020 18:09:01 +0300
Message-ID: <20201106150909.1779040-3-almaz.alexandrovich@paragon-software.com>
...
---
 ...
 4 files changed, 8812 insertions(+)
...
index 000000000000..a75b48e0c003
--- /dev/null
+++ b/fs/ntfs3/fsntfs.c
@@ -0,0 +1,2565 @@
...
+	struct page *page;
+	u8 cluster_bits = sbi->cluster_bits;
+	CLST lcn, clen, vcn = vbo >> cluster_bits;
...
+
+	re.de.view.data_off = cpu_to_le16(SIZEOF_R_DIRENTRY);
...
new file mode 100644
index 000000000000..4645ffa7ea1a
--- /dev/null
+++ b/fs/ntfs3/inode.c
@@ -0,0 +1,2115 @@
+// SPDX-License-Identifier: GPL-2.0
...
+		data = resident_data(attr) + off;
+
+		if (off > data_size)
+			memset(kaddr + off, 0, block_size - off);
+		else if (off + block_size <= data_size)
+			memcpy(kaddr + off, data, block_size);
+		else {
+			memcpy(kaddr + off, data, data_size - off);
+			memset(kaddr + data_size, 0, block_size - data_size);
+		}
+		kunmap_atomic(kaddr);
...
+
+	if (new) {
+		u32 allocated = len << cluster_bits;
+
+		set_buffer_new(bh);
+		if (allocated > block_size)
+			ntfs_sparse_cluster(inode, page,
+					    (loff_t)vcn << cluster_bits,
+					    allocated);
+	}
+
+	lbo = ((u64)lcn << cluster_bits) + off;
...
+				    &mi);
+		if (!attr || attr->non_res) {
+			/* inode is locked -> attribute can not change resident->nonresident*/
+			ni_unlock(ni);
+			return -EINVAL;
+		}
+		/* page already contains previous attribute data*/
+		off = pos & (PAGE_SIZE - 1);
+		data_size = le32_to_cpu(attr->res.data_size);
+		if (off >= data_size) {
+			err = 0;
...
+
+			err = min(data_size - off, copied);
+			memcpy(resident_data(attr) + off, kaddr + off, err);
+			kunmap_atomic(kaddr);
+			mi->dirty = true;
+			dirty = true;
+		}
...
new file mode 100644
index 000000000000..f573f95291dd
--- /dev/null
+++ b/fs/ntfs3/super.c
@@ -0,0 +1,1467 @@
+// SPDX-License-Identifier: GPL-2.0
...
+		 * use mount option?
+		 */
+		sbi->compress.lznt = get_lznt_ctx(0);
