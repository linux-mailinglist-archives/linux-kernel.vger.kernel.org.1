...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 81E2D23B565
	for <lists+linux-kernel@lfdr.de>; Tue,  4 Aug 2020 09:09:39 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729562AbgHDHJI (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 4 Aug 2020 03:09:08 -0400
Received: from mga06.intel.com ([134.134.136.31]:60927 "EHLO mga06.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726660AbgHDHJH (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 4 Aug 2020 03:09:07 -0400
IronPort-SDR: ZPl6LV/kWCN/ulVMTDgs9CUgQMMB1Xeum9nxsEQSu8QMAB/42Su+9q3mH8ugPwE3HiZzK5vNvQ
 HBnhQVteLwQQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9702"; a="213801923"
X-IronPort-AV: E=Sophos;i="5.75,433,1589266800"; 
   d="scan'208";a="213801923"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 04 Aug 2020 00:09:03 -0700
IronPort-SDR: KSw3cVUWYfwc6SohVWzvezikstlV7KkTM9CSEtTFreVpTh+DW5J7kLgtIhyuEzJD/m/E3TxODO
 3DY1PsDZ3Ihw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,433,1589266800"; 
   d="scan'208";a="315226151"
Received: from yilunxu-optiplex-7050.sh.intel.com ([10.239.159.141])
  by fmsmga004.fm.intel.com with ESMTP; 04 Aug 2020 00:09:01 -0700
...
Subject: [PATCH v3 2/4] fpga: dfl: map feature mmio resources in their own feature drivers
Date:   Tue,  4 Aug 2020 15:05:13 +0800
Message-Id: <1596524715-18038-3-git-send-email-yilun.xu@intel.com>
...
@@ -815,8 +838,40 @@ static int parse_feature_afu(struct build_feature_devs_info *binfo,
 	return 0;
 }
...
-			     struct dfl_fpga_enum_dfl *dfl,
 ...
 {
 	int ret = 0;
@@ -824,27 +879,39 @@ static int parse_feature_fiu(struct build_feature_devs_info *binfo,
 	u16 id;
 	u64 v;
...
@@ -852,16 +919,15 @@ static int parse_feature_fiu(struct build_feature_devs_info *binfo,
 }
...
+	return create_feature_instance(binfo, ofst, 0, 0);
 ...
 /**
@@ -869,24 +935,24 @@ static int parse_feature_private(struct build_feature_devs_info *binfo,
  *
