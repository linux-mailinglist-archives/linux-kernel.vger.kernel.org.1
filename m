...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7AF221F3117
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Jun 2020 03:07:01 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2388085AbgFIBFV (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 8 Jun 2020 21:05:21 -0400
Received: from mx0b-00082601.pphosted.com ([67.231.153.30]:3336 "EHLO
        mx0b-00082601.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1727816AbgFHXHS (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 8 Jun 2020 19:07:18 -0400
Received: from pps.filterd (m0109332.ppops.net [127.0.0.1])
        by mx0a-00082601.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id 058N0Q0U015266
        for <linux-kernel@vger.kernel.org>; Mon, 8 Jun 2020 16:07:12 -0700
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=fb.com; h=from : to : cc : subject
 : date : message-id : in-reply-to : references : mime-version :
 content-transfer-encoding : content-type; s=facebook;
 bh=1IuR7ZhzU5CXcF7cRmx/kCmY6BdMuMHO6KjrAAGHN0I=;
 b=kFFWAtRvYzVP9VdLOp5ZJcV+Nzgh3D8aE7wLXGiBcpjY4PeoKiTxQlcFXewWIG+QhDYs
 zTORPKpfZ8g9IK4mFHa8GQ6bDpXHfQ2xxkirkg0pr+hLbqS+PZMdYfzIrf3vgDUpK3Ql
 lb4BMvgreP9LwttH+BYDrR54VczyRtWvRJk= 
Received: from maileast.thefacebook.com ([163.114.130.16])
        by mx0a-00082601.pphosted.com with ESMTP id 31g8vna5wv-7
        (version=TLSv1.2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128 verify=NOT)
        for <linux-kernel@vger.kernel.org>; Mon, 08 Jun 2020 16:07:12 -0700
Received: from intmgw001.41.prn1.facebook.com (2620:10d:c0a8:1b::d) by
 mail.thefacebook.com (2620:10d:c0a8:83::4) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1979.3; Mon, 8 Jun 2020 16:07:10 -0700
Received: by devvm1291.vll0.facebook.com (Postfix, from userid 111017)
        id 61F081D8FE52; Mon,  8 Jun 2020 16:07:00 -0700 (PDT)
...
Subject: [PATCH v6 12/19] mm: memcg/slab: use a single set of kmem_caches for all accounted allocations
Date:   Mon, 8 Jun 2020 16:06:47 -0700
Message-ID: <20200608230654.828134-13-guro@fb.com>
...
X-Proofpoint-Spam-Details: rule=fb_default_notspam policy=fb_default score=0 mlxlogscore=999
 suspectscore=2 phishscore=0 impostorscore=0 spamscore=0 mlxscore=0
...
@@ -2912,31 +2911,24 @@ static void memcg_kmem_cache_create_func(struct w=
ork_struct *w)
 {
...
=20
@@ -2944,102 +2936,26 @@ static void memcg_schedule_kmem_cache_create(str=
...
=20
 /**
@@ -3728,7 +3644,6 @@ static int memcg_online_kmem(struct mem_cgroup *mem=
cg)
 	 */
...
@@ -3741,22 +3656,13 @@ static void memcg_offline_kmem(struct mem_cgroup =
*memcg)
=20
...
@@ -3791,10 +3697,8 @@ static void memcg_free_kmem(struct mem_cgroup *mem=
cg)
...
@@ -5386,9 +5290,6 @@ mem_cgroup_css_alloc(struct cgroup_subsys_state *pa=
rent_css)
=20
...
@@ -3861,7 +3850,8 @@ static int do_tune_cpucache(struct kmem_cache *cach=
ep, int limit,
 		return ret;
=20
...
=20
@@ -281,14 +238,6 @@ static inline int cache_vmstat_idx(struct kmem_cache=
 *s)
...
@@ -319,6 +268,13 @@ static inline struct kmem_cache *memcg_root_cache(st=
ruct kmem_cache *s)
 	return s->memcg_params.root_cache;
 }
=20
...
+
 ...
 {
 	/*
@@ -331,25 +287,9 @@ static inline struct obj_cgroup **page_obj_cgroups(s=
truct page *page)
...
@@ -386,16 +326,25 @@ static inline struct kmem_cache *memcg_slab_pre_all=
...
=20
@@ -434,7 +383,6 @@ static inline void memcg_slab_post_alloc_hook(struct =
kmem_cache *s,
 		}
 	}
 	obj_cgroup_put(objcg);
...
e *page,
@@ -458,7 +406,7 @@ static inline void memcg_slab_free_hook(struct kmem_c=
...
=20
@@ -466,9 +414,6 @@ extern void memcg_link_cache(struct kmem_cache *s, st=
...
-
 ...
 {
 	return true;
@@ -490,7 +435,17 @@ static inline struct kmem_cache *memcg_root_cache(st=
ruct kmem_cache *s)
 	return s;
 }
=20
...
@@ -527,8 +482,7 @@ static inline void slab_init_memcg_params(struct kmem=
_cache *s)
 {
 }
=20
...
+
 	mod_node_page_state(page_pgdat(page), cache_vmstat_idx(s),
 			    PAGE_SIZE << order);
 	return 0;
@@ -568,12 +519,9 @@ static __always_inline int charge_slab_page(struct p=
age *page,
...
@@ -722,9 +670,6 @@ static inline struct kmem_cache_node *get_node(struct=
...
-
 ...
 {
 	struct kmem_cache *s;
@@ -4322,7 +4292,7 @@ static struct kmem_cache * __init bootstrap(struct =
...
=20
@@ -4390,7 +4360,8 @@ __kmem_cache_alias(const char *name, unsigned int s=
