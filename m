...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B9C5E1DA518
	for <lists+linux-kernel@lfdr.de>; Wed, 20 May 2020 01:01:54 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727957AbgESXBw (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 19 May 2020 19:01:52 -0400
Received: from mga14.intel.com ([192.55.52.115]:48994 "EHLO mga14.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726959AbgESXBv (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 19 May 2020 19:01:51 -0400
IronPort-SDR: tyOoJkW13+cAAfjGdYUjP1MSw/hPwQHB7CLZLkWrvd7cxxtzcrlI3JipACO/JQIku48eUi+d0j
 FRz5Hq1Ea7yg==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 19 May 2020 15:28:48 -0700
IronPort-SDR: nQLYA0tJaLSqenWNh6cEiDQjlSjmRw/L0BE5HVjbpf/zvOAJw/IA+49skT2zNrn/yYWJlV4uGy
 KHp58NwFnkUQ==
X-IronPort-AV: E=Sophos;i="5.73,411,1583222400"; 
   d="scan'208";a="282474657"
Received: from dwillia2-desk3.jf.intel.com (HELO dwillia2-desk3.amr.corp.intel.com) ([10.54.39.16])
  by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 19 May 2020 15:28:48 -0700
...
Date:   Tue, 19 May 2020 15:12:37 -0700
Message-ID: <158992635697.403910.6957168747147028694.stgit@dwillia2-desk3.amr.corp.intel.com>
...
---
 ...
 36 files changed, 418 insertions(+), 522 deletions(-)
...
index 924c541a9260..a8896497ff11 100644
...
index bc10e3dc64fe..9f7e7e27f0a4 100644
--- a/arch/x86/include/asm/uaccess_64.h
+++ b/arch/x86/include/asm/uaccess_64.h
@@ -46,21 +46,23 @@ copy_user_generic(void *to, const void *from, unsigned len)
 	return ret;
 }
...
@@ -102,8 +104,4 @@ __copy_from_user_flushcache(void *dst, const void __user *src, unsigned size)
...
index 02e1f165f148..d75ffd599618 100644
...
@@ -1982,7 +1981,7 @@ void mce_disable_bank(int bank)
 	and older.
...
+ * mce=recovery force enable copy_mc_fragile()
 ...
 {
@@ -2590,13 +2589,10 @@ static void __init mcheck_debugfs_init(void)
