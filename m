...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 18E7F2D1044
	for <lists+linux-kernel@lfdr.de>; Mon,  7 Dec 2020 13:16:38 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727521AbgLGMQ2 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 7 Dec 2020 07:16:28 -0500
Received: from esa2.microchip.iphmx.com ([68.232.149.84]:18700 "EHLO
        esa2.microchip.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727055AbgLGMQ0 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 7 Dec 2020 07:16:26 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1607343384; x=1638879384;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=gKlhKIZNE8NnR+fc+1UNFpkER9s/7Wm8YL1ONL2DwPU=;
  b=ISnohEv8uJbzBBpDRciRvpaU28ctb11fntlZjEJ2ukT+Ug0vsyWfkJzy
   wDoI6M16T8RqIjBNCOJL/YwqD2BWqeXLylqop6xCdWnkOHe/gI+IgzpHo
   JQXJAvvFp3q8QXtDb1C4RM8/108jq65EBfBR0+Gf1AyW73lQLVvplH2cg
   GNVmV80HvMjIwAMnpeXPFeEZ31kNkMznz/KDZv8dhxqHJqf60dRmzAe0B
   XpMfQ+Dt9wFZ9KvMZXFFfX4bLn6C6IXCftrLyCP9mV+nPYSLc5KVVIocA
   eEGGQOrfulWH7rn5WCvONz+aBiABhAIX9kdNmiYGJ+ACk03qjbV/+/Gnf
   w==;
IronPort-SDR: 
X-IronPort-AV: E=Sophos;i="5.78,399,1599548400"; 
   d="scan'208";a="98863071"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa2.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 07 Dec 2020 05:14:04 -0700
Received: from chn-vm-ex04.mchp-main.com (10.10.85.152) by
 chn-vm-ex04.mchp-main.com (10.10.85.152) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1979.3; Mon, 7 Dec 2020 05:14:03 -0700
Received: from mchp-dev-shegelun.microchip.com (10.10.115.15) by
 chn-vm-ex04.mchp-main.com (10.10.85.152) with Microsoft SMTP Server id
 15.1.1979.3 via Frontend Transport; Mon, 7 Dec 2020 05:14:01 -0700
...
Subject: [PATCH v9 3/4] phy: Add Sparx5 ethernet serdes PHY driver
Date:   Mon, 7 Dec 2020 13:13:44 +0100
Message-ID: <20201207121345.3818234-4-steen.hegelund@microchip.com>
...
---
 ...
 7 files changed, 5281 insertions(+), 1 deletion(-)
...
new file mode 100644
index 000000000000..66fe82b842e0
--- /dev/null
...
+	if (value != 1) {
+		dev_err(macro->priv->dev, "sd_lane_stat pma_rst_done failed with 0x%x\n", value);
+		ret = -EINVAL;
+	}
+
...
+	if (value) {
+		ret = -EINVAL;
+		dev_err(macro->priv->dev, "CMU_E0 pll_lol_udl: 0x%x\n", value);
+	}
