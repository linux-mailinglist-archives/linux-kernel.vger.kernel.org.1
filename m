...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id A4CA01A2CD4
	for <lists+linux-kernel@lfdr.de>; Thu,  9 Apr 2020 02:26:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726571AbgDIA0E convert rfc822-to-8bit (ORCPT
        <rfc822;lists+linux-kernel@lfdr.de>); Wed, 8 Apr 2020 20:26:04 -0400
Received: from outbound-mail2.linode.com ([173.255.198.11]:41632 "EHLO
        outbound-mail2.linode.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726536AbgDIA0D (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 8 Apr 2020 20:26:03 -0400
...
Message-Id: <B975B84B-C0DC-49AD-87A5-CC34BEA0AFEF@theshore.net>
Date:   Wed, 8 Apr 2020 20:25:59 -0400
...
We've actually been encountering this bug for quite a long time - years. It was annoying but not a frequent problem and we were never able to figure it out. Recently, with our move towards AMD powered machines, this has become a critical issue. We're facing up to dozens of crashes daily across our fleet of these machines. Thankfully, we've figured out how to reproduce it - and hope to find a fix:

What these machines do:
- Hosts for virtual machines - qemu/kvm
- Multiple NICs (Intel or Mellanox)
...
The combination of packets and running ebtables seems to be what triggers it. Do either without the other and the machine is fine. Combine them and it will crash. Example initial kernel output:
...
We have output from other kernel versions crashing, and are very willing to provide anything we can or test anything you'd like to help get this resolved.
