...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 09DCB2AF8E0
	for <lists+linux-kernel@lfdr.de>; Wed, 11 Nov 2020 20:21:25 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727658AbgKKTVW (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 11 Nov 2020 14:21:22 -0500
Received: from mga09.intel.com ([134.134.136.24]:50570 "EHLO mga09.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726810AbgKKTVR (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 11 Nov 2020 14:21:17 -0500
IronPort-SDR: denu45N4iaL27EGNsqqxD3FPvdDrIKxnFum/0Az4+ApnlAqke12cs4AdMZcADAgQG7idZ0a5L0
 HQwAQtiRLaHg==
X-IronPort-AV: E=McAfee;i="6000,8403,9802"; a="170367983"
X-IronPort-AV: E=Sophos;i="5.77,470,1596524400"; 
   d="scan'208";a="170367983"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 11 Nov 2020 11:21:16 -0800
IronPort-SDR: EJHc4bmhrzNgicXdV6yJAcd2C8t+6jWn62uWqOwwTieMY7j7y8hZAr16BL42fo8XcJ6JzOXhuu
 HmCvBwZOUpxg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,470,1596524400"; 
   d="scan'208";a="354942658"
...
Subject: [PATCH v2 3/4] x86/bus_lock: Set rate limit for bus lock
Date:   Wed, 11 Nov 2020 19:20:47 +0000
Message-Id: <20201111192048.2602065-4-fenghua.yu@intel.com>
...
index 42277eb2e9b1..411f5dc7451f 100644
...
+	    sld_state == sld_ratelimit)
 	...
 	return true;
@@ -1170,6 +1187,10 @@ void handle_bus_lock(struct pt_regs *regs)
 	case sld_fatal:
...
@@ -1263,6 +1284,10 @@ static void sld_state_show(void)
 		else
