...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id AD0582A092D
	for <lists+linux-kernel@lfdr.de>; Fri, 30 Oct 2020 16:06:20 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727142AbgJ3PFi (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 30 Oct 2020 11:05:38 -0400
Received: from relayfre-01.paragon-software.com ([176.12.100.13]:35410 "EHLO
        relayfre-01.paragon-software.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726691AbgJ3PEx (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 30 Oct 2020 11:04:53 -0400
Received: from dlg2.mail.paragon-software.com (vdlg-exch-02.paragon-software.com [172.30.1.105])
        by relayfre-01.paragon-software.com (Postfix) with ESMTPS id 7D1F31D21;
        Fri, 30 Oct 2020 18:04:47 +0300 (MSK)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=paragon-software.com; s=mail; t=1604070287;
        bh=8CArdlhvewOfWnLguUxfptk73P+E6Hc0MTQzSWpbUvc=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=LQwVTQtPdac6xAuzEUDZh7gYAUe7BnJzpzMtnfTReadnKNa4BCen8vIe3TRcsMDpJ
         yB6kC+lc+k0Ekf3Aia9V2snyJ3FlwPuRBKasMuRSn+A1jK/keveIqF3GFkrccynuTC
         tIh5vOyOAXCEffWAdnBJAEv/Fm5ebVpjH77jo15I=
Received: from fsd-lkpg.ufsd.paragon-software.com (172.30.114.105) by
 vdlg-exch-02.paragon-software.com (172.30.1.105) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1847.3; Fri, 30 Oct 2020 18:04:45 +0300
...
Subject: [PATCH v11 02/10] fs/ntfs3: Add initialization of super block
Date:   Fri, 30 Oct 2020 18:02:31 +0300
Message-ID: <20201030150239.3957156-3-almaz.alexandrovich@paragon-software.com>
...
---
 ...
 4 files changed, 8739 insertions(+)
...
new file mode 100644
index 000000000000..79160d00120d
--- /dev/null
+++ b/fs/ntfs3/inode.c
@@ -0,0 +1,2030 @@
+// SPDX-License-Identifier: GPL-2.0
...
+		/*
+		 * regular file
+		 * Create empty nonresident data attribute
+		 */
+		attr->type = ATTR_DATA;
+		attr->id = cpu_to_le16(aid++);
...
new file mode 100644
index 000000000000..433fc4721c4e
--- /dev/null
+++ b/fs/ntfs3/super.c
@@ -0,0 +1,1479 @@
+// SPDX-License-Identifier: GPL-2.0
