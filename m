...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A28CC2C21D7
	for <lists+linux-kernel@lfdr.de>; Tue, 24 Nov 2020 10:40:20 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731387AbgKXJkB (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 24 Nov 2020 04:40:01 -0500
Received: from mxout70.expurgate.net ([194.37.255.70]:45477 "EHLO
        mxout70.expurgate.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1731175AbgKXJj7 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 24 Nov 2020 04:39:59 -0500
Received: from [127.0.0.1] (helo=localhost)
        by relay.expurgate.net with smtp (Exim 4.90)
        (envelope-from <ms@dev.tdt.de>)
        id 1khUnh-0007tu-En; Tue, 24 Nov 2020 10:39:53 +0100
Received: from [195.243.126.94] (helo=securemail.tdt.de)
        by relay.expurgate.net with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.90)
        (envelope-from <ms@dev.tdt.de>)
        id 1khUng-0002c3-AU; Tue, 24 Nov 2020 10:39:52 +0100
Received: from securemail.tdt.de (localhost [127.0.0.1])
        by securemail.tdt.de (Postfix) with ESMTP id DAA37240041;
        Tue, 24 Nov 2020 10:39:51 +0100 (CET)
Received: from mail.dev.tdt.de (unknown [10.2.4.42])
        by securemail.tdt.de (Postfix) with ESMTP id 5CCEC240040;
        Tue, 24 Nov 2020 10:39:51 +0100 (CET)
Received: from mschiller01.dev.tdt.de (unknown [10.2.3.20])
        by mail.dev.tdt.de (Postfix) with ESMTPSA id 0B79B20115;
        Tue, 24 Nov 2020 10:39:51 +0100 (CET)
...
Date:   Tue, 24 Nov 2020 10:39:34 +0100
Message-ID: <20201124093938.22012-2-ms@dev.tdt.de>
...
X-purgate: clean
X-purgate-ID: 151534::1606210792-000013A4-ADBEABE0/0/0
Precedence: bulk
