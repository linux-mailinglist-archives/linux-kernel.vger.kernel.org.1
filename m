...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E2CF51C86E1
	for <lists+linux-kernel@lfdr.de>; Thu,  7 May 2020 12:35:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727030AbgEGKcm (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 7 May 2020 06:32:42 -0400
Received: from us-smtp-delivery-1.mimecast.com ([205.139.110.120]:30080 "EHLO
        us-smtp-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1726884AbgEGKck (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 7 May 2020 06:32:40 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        ...
        b=I/O/7DUTVvqgD7XSrfjxPyzGepVuPIpTIE7yKZ1ERc0V3lnuRg5JZ2qRLGczHR6jdF9RuQ
        gxYbRGSPB82VLYtF9uBXdEjG0JXf7jH7t20SdZrJk9hh5OAD6vX6j+NkrvV49KZQbZLJhY
        4rSwfs4s4/H7lRQfCaa45mmT7GxKXAw=
...
@@ -654,23 +658,35 @@ static int virtio_mem_memory_notifier_cb(struct not=
ifier_block *nb,
 }
=20
 /*
...
=20
 /*
@@ -686,10 +702,26 @@ static void virtio_mem_fake_online(unsigned long pf=
...
der)
@@ -718,7 +750,8 @@ static void virtio_mem_online_page_cb(struct page *pa=
...
@@ -1186,6 +1219,72 @@ static int virtio_mem_mb_unplug_any_sb_offline(str=
uct virtio_mem *vm,
 	return 0;
 }
=20
...
+
  ...
  */
@@ -1225,8 +1324,37 @@ static int virtio_mem_unplug_request(struct virtio=
...
+	return nb_sb ? -EBUSY : 0;
 out_unlock:
 	mutex_unlock(&vm->hotplug_mutex);
 	return rc;
@@ -1332,7 +1460,8 @@ static void virtio_mem_run_wq(struct work_struct *w=
ork)
 	case -EBUSY:
 		/*
...
--- a/mm/page_alloc.c
+++ b/mm/page_alloc.c
@@ -8461,6 +8461,7 @@ int alloc_contig_range(unsigned long start, unsigne=
d long end,
...
@@ -8576,6 +8577,7 @@ void free_contig_range(unsigned long pfn, unsigned =
int nr_pages)
 	}
