...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C7C5929226E
	for <lists+linux-kernel@lfdr.de>; Mon, 19 Oct 2020 08:21:01 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726867AbgJSGTa (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 19 Oct 2020 02:19:30 -0400
Received: from mga05.intel.com ([192.55.52.43]:2305 "EHLO mga05.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726801AbgJSGTa (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 19 Oct 2020 02:19:30 -0400
IronPort-SDR: zz5kkWmmhutUHj/73B9+oz6bpgSs0m03HWyy3Q0nRKk+fQ+VPATKWOnrDFsZvce3GdywfzI07a
 q7Dq6d8bDTtA==
X-IronPort-AV: E=McAfee;i="6000,8403,9778"; a="251670158"
X-IronPort-AV: E=Sophos;i="5.77,393,1596524400"; 
   d="scan'208";a="251670158"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 18 Oct 2020 23:19:26 -0700
IronPort-SDR: uGTmNCkClNqn/7kMctiwUXn//jxav2flLCAd3zL7X3QUK1CDk5YpyynO1PLys3IRwMNdcmGZXF
 /jdOIvmrF/Iw==
X-IronPort-AV: E=Sophos;i="5.77,393,1596524400"; 
   d="scan'208";a="331794522"
Received: from shsi6026.sh.intel.com (HELO localhost) ([10.239.147.88])
  by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 18 Oct 2020 23:19:14 -0700
...
Subject: [PATCH v5 09/17] virt: acrn: Introduce I/O request management
Date:   Mon, 19 Oct 2020 14:17:55 +0800
Message-Id: <20201019061803.13298-10-shuo.a.liu@intel.com>
...
@@ -92,6 +151,11 @@ struct vm_memory_mapping {
...
@@ -114,4 +183,17 @@ int acrn_vm_memseg_unmap(struct acrn_vm *vm, struct acrn_vm_memmap *memmap);
...
index 016a6f2a4374..15cfb4fb5f1b 100644
...
@@ -127,6 +128,29 @@ static long acrn_dev_ioctl(struct file *filp, unsigned int cmd,
...
+		break;
 	default:
 		...
 		ret = -ENOTTY;
@@ -168,14 +192,18 @@ static int __init hsm_init(void)
 		return -EPERM;
...
index 000000000000..95df44049cca
--- /dev/null
