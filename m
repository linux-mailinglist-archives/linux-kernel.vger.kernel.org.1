...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9DCEB1A9256
	for <lists+linux-kernel@lfdr.de>; Wed, 15 Apr 2020 07:18:57 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2393263AbgDOFQw (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 15 Apr 2020 01:16:52 -0400
Received: from mga11.intel.com ([192.55.52.93]:15310 "EHLO mga11.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2389458AbgDOFQq (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 15 Apr 2020 01:16:46 -0400
IronPort-SDR: 1GAkEOQcbfse6iprZvK18dM0sAEFurZ4XNwq8P2vfiEUUTSR+cY8fBaGzb3cPW14KreQlTr5sd
 SjF88GXEBgmw==
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 14 Apr 2020 22:15:42 -0700
IronPort-SDR: ZhMrfKORsAilY5MZK0P90nWOgLO9uQDgm5kVFOJE/IHBJ1e8QMllKUfyZ6COjGuy/z1hayf4pK
 AH4MxEx9j3lg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.72,385,1580803200"; 
   d="yaml'?scan'208";a="277501700"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.3])
  by fmsmga004.fm.intel.com with ESMTP; 14 Apr 2020 22:15:38 -0700
Date:   Wed, 15 Apr 2020 13:15:12 +0800
From:   kernel test robot <rong.a.chen@intel.com>
To:     liliangleo <liliang.opensource@gmail.com>
Cc:     Alexander Duyck <alexander.h.duyck@linux.intel.com>,
        ...
        Alex Williamson <alex.williamson@redhat.com>, lkp@lists.01.org
Subject: [mm] 5ae8a9d7c8: will-it-scale.per_thread_ops -2.1% regression
Message-ID: <20200415051512.GS8179@shao2-debian>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="NncV4Eud7lVzK4Rv"
...
Content-Disposition: attachment; filename="config-5.6.0-12710-g5ae8a9d7c84e7"
...
export_top_env()
{
	...
	export nr_task=8
	export job_origin='/lkp/lkp/.src-20200413-124813/allot/cyclic:p1:linux-devel:devel-hourly/lkp-ivb-d01/will-it-scale-100.yaml'
...
queue_at_least_once'
	...
	export submit_id='5e9629a3c3ed9b16aef735c4'
	export job_file='/lkp/jobs/scheduled/lkp-ivb-d01/will-it-scale-performance-thread-100%-page_fault1-ucode=0x21-debian-x86_64-20191114.cgz-5ae8a9d7c84e7e6fa64ccaa357a1351015f1457c-20200415-5806-1reggcs-3.yaml'
	export id='965b792dcbe7ac5afe86db649a18877d56feaa52'
	...
	export commit='5ae8a9d7c84e7e6fa64ccaa357a1351015f1457c'
...
CONFIG_SATA_AHCI'
	...
	export enqueue_time='2020-04-15 05:22:48 +0800'
	export _id='5e9629a8c3ed9b16aef735c5'
	export _rt='/result/will-it-scale/performance-thread-100%-page_fault1-ucode=0x21/lkp-ivb-d01/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/5ae8a9d7c84e7e6fa64ccaa357a1351015f1457c'
	export user='lkp'
	export head_commit='b73de0abcde148c213e1eb23a4164620b4ba5197'
	export base_commit='8f3d9f354286745c751374f5f1fcafee6b3f3136'
	export branch='linux-devel/devel-hourly-2020041322'
	export rootfs='debian-x86_64-20191114.cgz'
	export result_root='/result/will-it-scale/performance-thread-100%-page_fault1-ucode=0x21/lkp-ivb-d01/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/5ae8a9d7c84e7e6fa64ccaa357a1351015f1457c/3'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-ivb-d01/will-it-scale-performance-thread-100%-page_fault1-ucode=0x21-debian-x86_64-20191114.cgz-5ae8a9d7c84e7e6fa64ccaa357a1351015f1457c-20200415-5806-1reggcs-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-7.6
branch=linux-devel/devel-hourly-2020041322
commit=5ae8a9d7c84e7e6fa64ccaa357a1351015f1457c
BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/5ae8a9d7c84e7e6fa64ccaa357a1351015f1457c/vmlinuz-5.6.0-12710-g5ae8a9d7c84e7
max_uptime=1500
RESULT_ROOT=/result/will-it-scale/performance-thread-100%-page_fault1-ucode=0x21/lkp-ivb-d01/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/5ae8a9d7c84e7e6fa64ccaa357a1351015f1457c/3
LKP_SERVER=inn
nokaslr
selinux=0
debug
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-7.6/gcc-7/5ae8a9d7c84e7e6fa64ccaa357a1351015f1457c/modules.cgz'
	...
	export last_kernel='5.7.0-rc1'
	export repeat_to=4
	export schedule_notify_address=
	export queue_at_least_once=1
	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-7/5ae8a9d7c84e7e6fa64ccaa357a1351015f1457c/vmlinuz-5.6.0-12710-g5ae8a9d7c84e7'
	export dequeue_time='2020-04-15 05:32:13 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-ivb-d01/will-it-scale-performance-thread-100%-page_fault1-ucode=0x21-debian-x86_64-20191114.cgz-5ae8a9d7c84e7e6fa64ccaa357a1351015f1457c-20200415-5806-1reggcs-3.cgz'
...
run_job()
{
	...
	run_test mode='thread' test='page_fault1' $LKP_SRC/tests/wrapper will-it-scale
}
...
will-it-scale:
  mode: thread
  test: page_fault1
job_origin: "/lkp/lkp/.src-20200413-124813/allot/cyclic:p1:linux-devel:devel-hourly/lkp-ivb-d01/will-it-scale-100.yaml"
...
submit_id: 5e95ea8736e4bd13a4ca0bb8
job_file: "/lkp/jobs/scheduled/lkp-ivb-d01/will-it-scale-performance-thread-100%-page_fault1-ucode=0x21-debian-x86_64-20191114.cgz-5ae8a9d7c84e7e6fa64ccaa357a1351015f1457c-20200415-5028-55z4x5-0.yaml"
id: 604041ea6d08e0b1f2c800710ae31b99b60a15f9
...
kconfig: x86_64-rhel-7.6
compiler: gcc-7
enqueue_time: 2020-04-15 00:53:30.447110819 +08:00
_id: 5e95ea8736e4bd13a4ca0bb8
_rt: "/result/will-it-scale/performance-thread-100%-page_fault1-ucode=0x21/lkp-ivb-d01/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/5ae8a9d7c84e7e6fa64ccaa357a1351015f1457c"

#! schedule options
user: lkp
head_commit: b73de0abcde148c213e1eb23a4164620b4ba5197
base_commit: 8f3d9f354286745c751374f5f1fcafee6b3f3136
branch: linux-devel/devel-hourly-2020041322
rootfs: debian-x86_64-20191114.cgz
result_root: "/result/will-it-scale/performance-thread-100%-page_fault1-ucode=0x21/lkp-ivb-d01/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/5ae8a9d7c84e7e6fa64ccaa357a1351015f1457c/0"
scheduler_version: "/lkp/lkp/.src-20200414-231014"
LKP_SERVER: inn
arch: x86_64
max_uptime: 1500
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-ivb-d01/will-it-scale-performance-thread-100%-page_fault1-ucode=0x21-debian-x86_64-20191114.cgz-5ae8a9d7c84e7e6fa64ccaa357a1351015f1457c-20200415-5028-55z4x5-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2020041322
- commit=5ae8a9d7c84e7e6fa64ccaa357a1351015f1457c
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/5ae8a9d7c84e7e6fa64ccaa357a1351015f1457c/modules.cgz"
...
#! runtime status
last_kernel: 5.7.0-rc1-03173-g6fada4b06107f1
repeat_to: 2
schedule_notify_address: 

#! user overrides
queue_at_least_once: 0
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/5ae8a9d7c84e7e6fa64ccaa357a1351015f1457c/vmlinuz-5.6.0-12710-g5ae8a9d7c84e7"
dequeue_time: 2020-04-15 00:57:23.542329138 +08:00

#! /lkp/lkp/.src-20200414-231014/include/site/inn
job_state: finished
loadavg: 7.46 5.16 2.30 1/185 5208
start_time: '1586883487'
end_time: '1586883789'
version: "/lkp/lkp/.src-20200414-231047:f35db41c:00f5e1fb0"
...
do
 ...
 "python2" "./runtest.py" "page_fault1" "295" "thread" "8"
