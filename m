...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1A41128DE63
	for <lists+linux-kernel@lfdr.de>; Wed, 14 Oct 2020 12:13:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729395AbgJNKM5 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 14 Oct 2020 06:12:57 -0400
Received: from mail.kernel.org ([198.145.29.99]:33424 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1729896AbgJNKMp (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 14 Oct 2020 06:12:45 -0400
Received: from localhost (83-86-74-64.cable.dynamic.v4.ziggo.nl [83.86.74.64])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id A495D2068E;
        Wed, 14 Oct 2020 10:12:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1602670351;
        bh=GdBv4vCDGl3peFCIwWhoOSI/SBS4HEotZyyVvMhR/OY=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=Fc4SgylIcXv653KAYwARkV+OAjt47tHvL7ghd/z6bOIvlk049bAWrMrxd3MtxH1Tg
         ZICyDSGl3E8X3yfS6OSh6G1duOo4se8h1lrSEleSo0pqryJhGPiuDBXX9Fm3KV/iSM
         rpwSwN4ihgdw4c7k9zLaK5N2hsoyFJCrZT5PVv+U=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 5.8.15
Date:   Wed, 14 Oct 2020 12:12:57 +0200
Message-Id: <160267037615237@kroah.com>
X-Mailer: git-send-email 2.28.0
In-Reply-To: <1602670376150118@kroah.com>
References: <1602670376150118@kroah.com>
MIME-Version: 1.0
...
index 33ceda527e5e..6c787cd1cb51 100644
--- a/Makefile
+++ b/Makefile
@@ -1,7 +1,7 @@
...
index e229d95f470b..7c1dadf14f56 100644
...
index 6e813b13d698..02154d8b1c0d 100644
...
index 500aa3e19a4c..fddf7c502355 100644
...
index 7c167a394b76..259a612da003 100644
...
index 7fe39a155b32..070288c8b4f3 100644
...
index d338efe5f3f5..91343e2d3a14 100644
--- a/drivers/net/ethernet/intel/iavf/iavf_main.c
+++ b/drivers/net/ethernet/intel/iavf/iavf_main.c
@@ -3777,7 +3777,6 @@ static int iavf_probe(struct pci_dev *pdev, const struct pci_device_id *ent)
 	return err;
 }
...
@@ -3785,11 +3784,10 @@ static int iavf_probe(struct pci_dev *pdev, const struct pci_device_id *ent)
  *
...
index 76b23ba7a468..cb3857e136d6 100644
...
index 98e909bf3c1e..3e32264cf613 100644
...
index cccf65fc116e..f8a20dd81437 100644
...
index d0b79cca5184..61bbb7a09004 100644
...
index 000000000000..66b58b242f77
--- /dev/null
...
index 69165a8f7c1f..a9d5682cdea5 100644
...
index 6c42f73c1dfd..805ce604dee6 100644
...
index e85d8e58320c..663197fecb20 100644
...
index df3c52d72159..8653950c56d4 100644
...
index 09cb46e94f40..3e82f632841d 100644
...
index eb86e4b88c73..e4a1c6afe35d 100644
--- a/fs/btrfs/dev-replace.c
+++ b/fs/btrfs/dev-replace.c
@@ -783,7 +783,9 @@ static int btrfs_dev_replace_finishing(struct btrfs_fs_info *fs_info,
...
@@ -792,6 +794,8 @@ static int btrfs_dev_replace_finishing(struct btrfs_fs_info *fs_info,
...
index 956eb0d6bc58..79e9a80bd37a 100644
...
index ebc3586b1879..d2bb2ae9551f 100644
--- a/fs/io_uring.c
+++ b/fs/io_uring.c
...
index 9e9b1ec30b90..d7eb9e7689b4 100644
...
index e6fc7c3e7dc9..bc2812bb1a01 100644
--- a/mm/khugepaged.c
+++ b/mm/khugepaged.c
...
@@ -2320,3 +2333,11 @@ int start_stop_khugepaged(void)
...
index c50bd7a7943a..72f4a3730ecf 100644
--- a/net/core/skbuff.c
+++ b/net/core/skbuff.c
...
index 30c1142584b1..06a8242aa698 100644
--- a/net/ipv4/tcp.c
+++ b/net/ipv4/tcp.c
...
index 41d8440deaf1..0eb4722cf7cd 100644
...
index 279c87a2a523..4d7b25506722 100644
