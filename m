...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 30FA72C86C2
	for <lists+linux-kernel@lfdr.de>; Mon, 30 Nov 2020 15:32:03 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727706AbgK3O3v (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 30 Nov 2020 09:29:51 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47408 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727368AbgK3O3u (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 30 Nov 2020 09:29:50 -0500
Received: from mail-pg1-x52b.google.com (mail-pg1-x52b.google.com [IPv6:2607:f8b0:4864:20::52b])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 10286C0613CF
        for <linux-kernel@vger.kernel.org>; Mon, 30 Nov 2020 06:29:04 -0800 (PST)
Received: by mail-pg1-x52b.google.com with SMTP id k11so10189640pgq.2
        for <linux-kernel@vger.kernel.org>; Mon, 30 Nov 2020 06:29:04 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=w+dC6P/KLIzHgY7Cm38BrvrGlI9t/SBmUdhueSJ7ufo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=w+dC6P/KLIzHgY7Cm38BrvrGlI9t/SBmUdhueSJ7ufo=;
        b=
X-Gm-Message-State: AOAM530F19kA5ITQBYUEooiplHhyYPmwIjOystXX4tBltnDxcEzo0BhG
        9isXUYyx3QmVHs9+6KqKb0FGgWPuT0I=
X-Google-Smtp-Source: ABdhPJweJm6lxoBGlXHPyVMpyYymwuyRXdj5Bs1bhS0grrVTnnClXBvRoFgsaMbRHBX5GUv+DigvMg==
X-Received: by 2002:a63:30c6:: with SMTP id w189mr8301829pgw.120.1606746542306;
        Mon, 30 Nov 2020 06:29:02 -0800 (PST)
Received: from nj08008nbu.spreadtrum.com ([117.18.48.82])
        by smtp.gmail.com with ESMTPSA id 17sm15580479pfh.173.2020.11.30.06.28.58
        (version=TLS1_2 cipher=ECDHE-ECDSA-AES128-GCM-SHA256 bits=128/128);
        Mon, 30 Nov 2020 06:29:01 -0800 (PST)
...
Subject: [PATCH 6/6] drm/sprd: add Unisoc's drm mipi dsi&dphy driver
Date:   Mon, 30 Nov 2020 22:28:33 +0800
Message-Id: <1606746513-30909-7-git-send-email-kevin3.tang@gmail.com>
...
---
 ...
 drivers/gpu/drm/sprd/sprd_drm.c        |   42 +
 drivers/gpu/drm/sprd/sprd_drm.h        |    4 +
 drivers/gpu/drm/sprd/sprd_dsi.c        | 1105 ++++++++++++++++++++++++
 drivers/gpu/drm/sprd/sprd_dsi.h        |  105 +++
 13 files changed, 4675 insertions(+), 2 deletions(-)
...
+	ctx->ctrlbase = devm_ioremap(dev, res->start, resource_size(res));
+	if (!ctx->ctrlbase) {
...
+	if (res) {
+		ctx->apbbase = devm_ioremap(dev, res->start, resource_size(res));
+		if (!ctx->apbbase) {
...
@@ -197,6 +237,8 @@ static struct platform_driver sprd_drm_driver = {
...
index 85d4a8b..29361e6 100644
--- a/drivers/gpu/drm/sprd/sprd_drm.h
+++ b/drivers/gpu/drm/sprd/sprd_drm.h
@@ -13,6 +13,10 @@ struct sprd_drm {
