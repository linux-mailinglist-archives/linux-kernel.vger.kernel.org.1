...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 052BC247DC6
	for <lists+linux-kernel@lfdr.de>; Tue, 18 Aug 2020 07:13:11 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726583AbgHRFNG (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 18 Aug 2020 01:13:06 -0400
Received: from mail29.static.mailgun.info ([104.130.122.29]:56301 "EHLO
        mail29.static.mailgun.info" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726306AbgHRFNA (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 18 Aug 2020 01:13:00 -0400
DKIM-Signature: a=rsa-sha256; v=1; c=relaxed/relaxed; d=mg.codeaurora.org; q=dns/txt;
 s=smtp; t=1597727565; h=Content-Transfer-Encoding: MIME-Version:
 References: In-Reply-To: Message-Id: Date: Subject: Cc: To: From:
 Sender; bh=xpOrWZKk3S+eKvAM8Q91YIl1Gfj02SQicyQz0Gq6fIo=; b=ANLrmJ+bDnVi0Y8y8+q2RLCfdq37PwN8gcSDazYGP/ONvzETQP9t6aH7mQZAN3324ZrnvVR0
 1SN/MamC7cpUTooEKdWxwlAUACtLVovfsQdzUxYyLDkSdGUA1tNZZeUPvqPKDupuhxDloQqd
 G1BJNJJmn73xd2onTgaMLhBv9Go=
X-Mailgun-Sending-Ip: 104.130.122.29
X-Mailgun-Sid: WyI0MWYwYSIsICJsaW51eC1rZXJuZWxAdmdlci5rZXJuZWwub3JnIiwgImJlOWU0YSJd
Received: from smtp.codeaurora.org
 (ec2-35-166-182-171.us-west-2.compute.amazonaws.com [35.166.182.171]) by
 smtp-out-n01.prod.us-east-1.postgun.com with SMTP id
 5f3b634d247ccc308c4422c7 (version=TLS1.2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256); Tue, 18 Aug 2020 05:12:45
 GMT
Received: by smtp.codeaurora.org (Postfix, from userid 1001)
        id 706CEC43391; Tue, 18 Aug 2020 05:12:43 +0000 (UTC)
...
Received: from linuxdisplay-lab-04.qualcomm.com (i-global254.qualcomm.com [199.106.103.254])
        ...
        by smtp.codeaurora.org (Postfix) with ESMTPSA id 127F4C433CA;
        Tue, 18 Aug 2020 05:12:11 +0000 (UTC)
DMARC-Filter: OpenDMARC Filter v1.3.2 smtp.codeaurora.org 127F4C433CA
...
Subject: [PATCH v11 2/5] drm/msm/dp: add displayPort driver support
Date:   Mon, 17 Aug 2020 22:11:34 -0700
Message-Id: <20200818051137.21478-3-tanmay@codeaurora.org>
...
-- Fix Kconfig entry help description
...
---
 ...
 27 files changed, 7989 insertions(+), 3 deletions(-)
...
index 36d98d4116ca..0f59a202227a 100644
--- a/drivers/gpu/drm/msm/msm_drv.c
+++ b/drivers/gpu/drm/msm/msm_drv.c
@@ -1361,6 +1361,7 @@ static int __init msm_drm_register(void)
 	msm_dsi_register();
 	msm_edp_register();
 	msm_hdmi_register();
+	msm_dp_register();
...
@@ -1369,6 +1370,7 @@ static void __exit msm_drm_unregister(void)
 {
 	DBG("fini");
