...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A9A12251874
	for <lists+linux-kernel@lfdr.de>; Tue, 25 Aug 2020 14:21:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729528AbgHYMVY (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 25 Aug 2020 08:21:24 -0400
Received: from mail-eopbgr00093.outbound.protection.outlook.com ([40.107.0.93]:59392
        "EHLO EUR02-AM5-obe.outbound.protection.outlook.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1726090AbgHYMUz (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 25 Aug 2020 08:20:55 -0400
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=Loo+tI+/6bLYHIfKpdFdOFWiUhH9QMnSMyqGvT6/fLY=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=plvision.eu;
 ...
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=Loo+tI+/6bLYHIfKpdFdOFWiUhH9QMnSMyqGvT6/fLY=;
 b=xrhstA3qDz+Qq91ZCmqxd8Og87vv0FYFf31LY87bO3SfUB5tTI6DnccXTZb8Kw+00GzeG15gh4TH8tnx0YT+KQw9ubV+Rm3Y/YRxLmhJuOvSssOdDTn+JAARP25naJbXtHixOoGnLX7AtSxTwj4K66xxEULc9kEA3hhcJk6j5zw=
...
Received: from HE1P190MB0539.EURP190.PROD.OUTLOOK.COM (2603:10a6:7:56::28) by
 ...
 15.20.3305.26; Tue, 25 Aug 2020 12:20:36 +0000
...
Subject: [net-next v5 1/6] net: marvell: prestera: Add driver for Prestera family ASIC devices
Date:   Tue, 25 Aug 2020 15:20:08 +0300
Message-Id: <20200825122013.2844-2-vadym.kochan@plvision.eu>
...
Received: from pc60716vkochan.x.ow.s (217.20.186.93) by AM6PR08CA0039.eurprd08.prod.outlook.com (2603:10a6:20b:c0::27) with Microsoft SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.3305.25 via Frontend Transport; Tue, 25 Aug 2020 12:20:34 +0000
X-Mailer: git-send-email 2.17.1
X-Originating-IP: [217.20.186.93]
X-MS-PublicTrafficType: Email
X-MS-Office365-Filtering-Correlation-Id: ca901659-3c3e-4da4-abc2-08d848f14531
X-MS-TrafficTypeDiagnostic: HE1P190MB0395:
X-MS-Exchange-Transport-Forked: True
X-Microsoft-Antispam-PRVS: <HE1P190MB03957166881CE242073EA5EA95570@HE1P190MB0395.EURP190.PROD.OUTLOOK.COM>
X-MS-Oob-TLC-OOBClassifiers: OLM:9508;
X-MS-Exchange-SenderADCheck: 1
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:HE1P190MB0539.EURP190.PROD.OUTLOOK.COM;PTR:;CAT:NONE;SFS:(366004)(376002)(396003)(39830400003)(136003)(346002)(8936002)(16526019)(54906003)(186003)(107886003)(110136005)(6506007)(478600001)(316002)(66946007)(26005)(66476007)(66556008)(4326008)(5660300002)(8676002)(30864003)(83380400001)(6666004)(6486002)(86362001)(6512007)(2906002)(2616005)(36756003)(44832011)(956004)(52116002)(1076003)(333604002)(921003)(579004)(559001);DIR:OUT;SFP:1102;
X-MS-Exchange-AntiSpam-MessageData: 
X-OriginatorOrg: plvision.eu
X-MS-Exchange-CrossTenant-Network-Message-Id: ca901659-3c3e-4da4-abc2-08d848f14531
X-MS-Exchange-CrossTenant-AuthSource: HE1P190MB0539.EURP190.PROD.OUTLOOK.COM
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 25 Aug 2020 12:20:36.2129
 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 03707b74-30f3-46b6-a0e0-ff0a7438c9c4
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: eha6PwvMiUtc7wRpLG3hj3puEs2IUmx9b3IKLd2jW0lcKal4Rvf4c2LD+AbAmog/2Y1XwRdI4C41zc2gBgJh6qAYfQy/hC94dGDyy9aHIS8=
...
PATCH v5:
    ...
    2) Change 'u8 *' -> 'void *' in prestera.h: struct prestera_device->{send_req,recv_msg} callbacks.
    ...
    6) Simplify evt->id checking by using single if in prestera_hw.c: prestera_fw_parse_port_evt
...
PATCH v3:
 ...
 .../ethernet/marvell/prestera/prestera_main.c | 503 ++++++++++
...
new file mode 100644
index 000000000000..14eb8228c149
--- /dev/null
...
new file mode 100644
index 000000000000..18d5ef8a9a50
--- /dev/null
...
+
+	dsa->vlan.is_tagged = FIELD_GET(PRESTERA_W0_IS_TAGGED, words[0]);
+	dsa->vlan.cfi_bit = FIELD_GET(PRESTERA_W1_CFI_BIT, words[1]);
+	dsa->vlan.vpt = FIELD_GET(PRESTERA_W0_VPT, words[0]);
+	dsa->vlan.vid = FIELD_GET(PRESTERA_W0_VID, words[0]);
...
new file mode 100644
index 000000000000..89125240934b
--- /dev/null
...
new file mode 100644
index 000000000000..9e98deb0ef43
--- /dev/null
...
new file mode 100644
index 000000000000..f12c368c4727
--- /dev/null
...
new file mode 100644
index 000000000000..f407cfc4f85b
--- /dev/null
...
new file mode 100644
index 000000000000..b4cfe3f1f0ae
--- /dev/null
...
+	((le32_to_cpu((desc)->word2) >> 16) & GENMASK(15, 0))
+
...
new file mode 100644
index 000000000000..3add8acb2f1c
--- /dev/null
