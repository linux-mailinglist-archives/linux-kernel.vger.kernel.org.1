...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 59ADE267B20
	for <lists+linux-kernel@lfdr.de>; Sat, 12 Sep 2020 17:00:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725955AbgILO55 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 12 Sep 2020 10:57:57 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51142 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725888AbgILOla (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 12 Sep 2020 10:41:30 -0400
Received: from mail-ed1-x542.google.com (mail-ed1-x542.google.com [IPv6:2a00:1450:4864:20::542])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6C720C061795;
        Sat, 12 Sep 2020 07:41:29 -0700 (PDT)
Received: by mail-ed1-x542.google.com with SMTP id w1so13379182edr.3;
        Sat, 12 Sep 2020 07:41:29 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=uB/5zgHVeZkVk96vFNExkpSOQnrCOg2jPo+0CFQ72F8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=uB/5zgHVeZkVk96vFNExkpSOQnrCOg2jPo+0CFQ72F8=;
        b=
X-Gm-Message-State: AOAM530xJVUPvFU15mxksJYRSzRVOLIGfNa4vSbiVCD3H1H1kXCVB3UL
        kkF3buQ3w82js/qTYCsub9osQwU3uPc=
X-Google-Smtp-Source: ABdhPJwA4TiDF1zdFfPfj2iyy5WH8ROKdFLw3+InU5ZjclUIfA0ZnNf/NUjyUmKDghE5pnPhBbC+BQ==
X-Received: by 2002:aa7:c308:: with SMTP id l8mr8599187edq.361.1599921685448;
        Sat, 12 Sep 2020 07:41:25 -0700 (PDT)
Received: from ogabbay-VM.habana-labs.com ([213.57.90.10])
        by smtp.gmail.com with ESMTPSA id y25sm4842938edv.15.2020.09.12.07.41.22
...
Subject: [PATCH v2 05/14] habanalabs/gaudi: add NIC Ethernet support
Date:   Sat, 12 Sep 2020 17:40:57 +0300
Message-Id: <20200912144106.11799-6-oded.gabbay@gmail.com>
...
---
Changes in v2:
  - Remove nic_debugfs_reset flag
  - Remove kernel parameter of nic_rx_poll
  - Fix all instances of reverse Christmas tree
  - Remove obsolete TODOs
  - Add status enum for handling Ethernet packets
  - Silently drop corrupted packets
  - Increament the dropped counter for corrupted packets
  - Continue to next packet instead of exiting the handling loop in case of
    corrupted packet
  - Increament the packet counter in case of dropped packet as well, for
    quitting the handling loop in case of too many dropped packets
