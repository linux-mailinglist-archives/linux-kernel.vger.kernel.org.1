...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D3D871E03D2
	for <lists+linux-kernel@lfdr.de>; Mon, 25 May 2020 01:01:14 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2388549AbgEXXBN (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 24 May 2020 19:01:13 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42662 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2387863AbgEXXBM (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 24 May 2020 19:01:12 -0400
Received: from mail-lf1-x131.google.com (mail-lf1-x131.google.com [IPv6:2a00:1450:4864:20::131])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C1399C061A0E
        for <linux-kernel@vger.kernel.org>; Sun, 24 May 2020 16:01:10 -0700 (PDT)
Received: by mail-lf1-x131.google.com with SMTP id z206so5882493lfc.6
        for <linux-kernel@vger.kernel.org>; Sun, 24 May 2020 16:01:10 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linux-foundation.org; s=google;
        h=mime-version:from:date:message-id:subject:to
         :content-transfer-encoding;
        bh=ufAQlWT352XSIQ/v8zLa9ONYoLTrlAMRzh39HkLA3Tw=;
        b=bm9fViG7YzrlveJE1CxqNxdVzeNzJxk0omYCrEMtOPHTGWdaHJI92XHHv0YutPcuNE
         0JTPMP+UYz6heZ7drO7AbL4yXpfhWeJqM+3cv5mnui4QATnoHVuoh9I10FO770WKyIXI
         eZCL97xM42muCRr6y4UY39mPGvYccSqL5ME64=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:mime-version:from:date:message-id:subject:to
         :content-transfer-encoding;
        bh=ufAQlWT352XSIQ/v8zLa9ONYoLTrlAMRzh39HkLA3Tw=;
        b=
X-Gm-Message-State: AOAM533mfYH1ysHGN66z0JC5KYlyXprPlP7/M8TIv4xrYaXIRrBK/0wb
        FT4YpSEV4/IGfdae4JAFDPThVahLNwU=
X-Google-Smtp-Source: ABdhPJyQCb/qXUlP7YIorPma6lxL09TgCtdluIREZIpRbRBjNfcNuJIbhOE17tIj4uN2viDcmp7m6A==
X-Received: by 2002:a19:cb05:: with SMTP id b5mr5704391lfg.108.1590361268500;
        Sun, 24 May 2020 16:01:08 -0700 (PDT)
Received: from mail-lj1-f170.google.com (mail-lj1-f170.google.com. [209.85.208.170])
        by smtp.gmail.com with ESMTPSA id n21sm3997986ljg.74.2020.05.24.16.01.07
        for <linux-kernel@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Sun, 24 May 2020 16:01:07 -0700 (PDT)
Received: by mail-lj1-f170.google.com with SMTP id z18so18779629lji.12
        for <linux-kernel@vger.kernel.org>; Sun, 24 May 2020 16:01:07 -0700 (PDT)
X-Received: by 2002:a2e:9891:: with SMTP id b17mr11023805ljj.312.1590361266813;
 Sun, 24 May 2020 16:01:06 -0700 (PDT)
MIME-Version: 1.0
From:   Linus Torvalds <torvalds@linux-foundation.org>
Date:   Sun, 24 May 2020 16:00:50 -0700
X-Gmail-Original-Message-ID: <CAHk-=whan1CiRtcgBt-5SkW-ga_GeLH5+AO26RmK7vOA5yw9ng@mail.gmail.com>
Message-ID: <CAHk-=whan1CiRtcgBt-5SkW-ga_GeLH5+AO26RmK7vOA5yw9ng@mail.gmail.com>
...
Can Guo (1):
      scsi: pm: Balance pm_only counter of request queue during system resu=
me
...
David Hildenbrand (1):
      device-dax: don't leak kernel memory to user space after unloading km=
em

David Howells (5):
      rxrpc: Fix the excessive initial retransmission timeout
      afs: Don't unlock fetched data pages until the op completes successfu=
lly
...
Heikki Krogerus (1):
      kobject: Make sure the parent does not get released before its childr=
en
...
Josh Poimboeuf (1):
      x86/unwind/orc: Fix unwind_get_return_address_ptr() for inactive task=
s
...
Sabrina Dubroca (1):
      net: don't return invalid table id error when we fall back to PF_UNSP=
EC
