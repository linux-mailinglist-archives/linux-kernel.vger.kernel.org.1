...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CCE5E2AB16F
	for <lists+linux-kernel@lfdr.de>; Mon,  9 Nov 2020 07:53:17 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729560AbgKIGxL (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 9 Nov 2020 01:53:11 -0500
Received: from mga01.intel.com ([192.55.52.88]:17538 "EHLO mga01.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727077AbgKIGxL (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 9 Nov 2020 01:53:11 -0500
IronPort-SDR: za0xoKg0EB2LvMUQmWi9htnADRRLzBtnitihSjEpxADF9fXSCE9PGbgeWcinQS6g2dpJdbWWS8
 QU8Irsn0Xllg==
X-IronPort-AV: E=McAfee;i="6000,8403,9799"; a="187703562"
X-IronPort-AV: E=Sophos;i="5.77,462,1596524400"; 
   d="gz'50?scan'50,208,50";a="187703562"
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 08 Nov 2020 22:53:09 -0800
IronPort-SDR: 2FxnUsVAZfrm2klAH/je/wSU7R7LSKH1ywwWx8tzbAAX5z2w81R3+qWDihiM0OtZ0TpV4XOVB+
 X0m6DbvMVuQA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,462,1596524400"; 
   d="gz'50?scan'50,208,50";a="365376268"
Received: from lkp-server02.sh.intel.com (HELO defa7f6e4f65) ([10.239.97.151])
  by orsmga007.jf.intel.com with ESMTP; 08 Nov 2020 22:53:07 -0800
Received: from kbuild by defa7f6e4f65 with local (Exim 4.92)
        (envelope-from <lkp@intel.com>)
        id 1kc134-0000Gu-Bh; Mon, 09 Nov 2020 06:53:06 +0000
Date:   Mon, 9 Nov 2020 14:52:27 +0800
From:   kernel test robot <lkp@intel.com>
To:     Luc Van Oostenryck <luc.vanoostenryck@gmail.com>
Cc:     kbuild-all@lists.01.org, linux-kernel@vger.kernel.org,
        Miguel Ojeda <miguel.ojeda.sandonis@gmail.com>
Subject: net/ipv6/ip6mr.c:1837:13: sparse: sparse: incorrect type in argument
 1 (different address spaces)
Message-ID: <202011091422.7TYTKJMU-lkp@intel.com>
MIME-Version: 1.0
...
vim +1837 net/ipv6/ip6mr.c

7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1800  
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1801  /*
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1802   *	Getsock opt support for the multicast routing system.
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1803   */
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1804  
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1805  int ip6_mroute_getsockopt(struct sock *sk, int optname, char __user *optval,
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1806  			  int __user *optlen)
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1807  {
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1808  	int olr;
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1809  	int val;
8229efdaef1e791 Benjamin Thery    2008-12-10  1810  	struct net *net = sock_net(sk);
b70432f7319eb75 Yuval Mintz       2018-02-28  1811  	struct mr_table *mrt;
d1db275dd3f6e41 Patrick McHardy   2010-05-11  1812  
99253eb750fda6a Xin Long          2017-02-24  1813  	if (sk->sk_type != SOCK_RAW ||
99253eb750fda6a Xin Long          2017-02-24  1814  	    inet_sk(sk)->inet_num != IPPROTO_ICMPV6)
99253eb750fda6a Xin Long          2017-02-24  1815  		return -EOPNOTSUPP;
99253eb750fda6a Xin Long          2017-02-24  1816  
d1db275dd3f6e41 Patrick McHardy   2010-05-11  1817  	mrt = ip6mr_get_table(net, raw6_sk(sk)->ip6mr_table ? : RT6_TABLE_DFLT);
63159f29be1df7f Ian Morris        2015-03-29  1818  	if (!mrt)
d1db275dd3f6e41 Patrick McHardy   2010-05-11  1819  		return -ENOENT;
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1820  
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1821  	switch (optname) {
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1822  	case MRT6_VERSION:
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1823  		val = 0x0305;
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1824  		break;
14fb64e1f449ef6 YOSHIFUJI Hideaki 2008-04-03  1825  #ifdef CONFIG_IPV6_PIMSM_V2
14fb64e1f449ef6 YOSHIFUJI Hideaki 2008-04-03  1826  	case MRT6_PIM:
6bd521433942d85 Patrick McHardy   2010-05-11  1827  		val = mrt->mroute_do_pim;
14fb64e1f449ef6 YOSHIFUJI Hideaki 2008-04-03  1828  		break;
14fb64e1f449ef6 YOSHIFUJI Hideaki 2008-04-03  1829  #endif
14fb64e1f449ef6 YOSHIFUJI Hideaki 2008-04-03  1830  	case MRT6_ASSERT:
6bd521433942d85 Patrick McHardy   2010-05-11  1831  		val = mrt->mroute_do_assert;
14fb64e1f449ef6 YOSHIFUJI Hideaki 2008-04-03  1832  		break;
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1833  	default:
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1834  		return -ENOPROTOOPT;
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1835  	}
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1836  
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03 @1837  	if (get_user(olr, optlen))
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1838  		return -EFAULT;
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1839  
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1840  	olr = min_t(int, olr, sizeof(int));
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1841  	if (olr < 0)
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1842  		return -EINVAL;
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1843  
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1844  	if (put_user(olr, optlen))
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1845  		return -EFAULT;
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1846  	if (copy_to_user(optval, &val, olr))
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1847  		return -EFAULT;
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1848  	return 0;
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1849  }
7bc570c8b4f75dd YOSHIFUJI Hideaki 2008-04-03  1850  

:::::: The code at line 1837 was first introduced by commit
:::::: 7bc570c8b4f75ddb3fd5dbeb38127cdc4acbcc9c [IPV6] MROUTE: Support multicast forwarding.
...
H4sICOHHqF8AAy5jb25maWcAlDzbcts2sO/9Ck760j60lS3HieeMH0AQJFGRBAOAkuwXjmsr
