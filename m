...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 85A5C2A3BA0
	for <lists+linux-kernel@lfdr.de>; Tue,  3 Nov 2020 06:04:42 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726938AbgKCFEh (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 3 Nov 2020 00:04:37 -0500
Received: from mga06.intel.com ([134.134.136.31]:9436 "EHLO mga06.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725980AbgKCFEf (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 3 Nov 2020 00:04:35 -0500
IronPort-SDR: PIYxXMAMriGa+FoYe4Nvd2W7q6wp0oWaYi8rDxG/xhWOtoLh67jdrfMsEnU3QOxJgp8sJBMIid
 q3kxJOdNBnNQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9793"; a="230628765"
X-IronPort-AV: E=Sophos;i="5.77,447,1596524400"; 
   d="yaml'?scan'208";a="230628765"
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 02 Nov 2020 21:04:25 -0800
IronPort-SDR: mYdf/GWKkNRxszzvAhkj5Kkcslb/Ltqi7R7dYZ6szMJRPmngIjTyl70qwDhMCcJkjQKEo7mBZI
 Y0A73bEuH+Ng==
X-IronPort-AV: E=Sophos;i="5.77,447,1596524400"; 
   d="yaml'?scan'208";a="528278622"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.3])
  by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 02 Nov 2020 21:04:20 -0800
Date:   Tue, 3 Nov 2020 13:03:29 +0800
...
Subject: [mm/swap] aae466b005: vm-scalability.throughput 17.2% improvement
Message-ID: <20201103050329.GO31092@shao2-debian>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="oHxSCaSS3y4TqjY8"
...
FYI, we noticed a 17.2% improvement of vm-scalability.throughput due to commit:
...
---------------- --------------------------- 
 ...
 3.555e+12            -6.8%  3.311e+12        perf-stat.total.instructions
  ...
  4.4e+06 |-+                                           O    O       O      |   
          |                                           O   O        O        |   
  4.3e+06 |-O O                                                  O        O |   
  4.2e+06 |-+    O O     O    O O O    O O   O    O O          O            |   
  4.1e+06 |-+        O      O       O      O   O                        O   |   
    4e+06 |-+          O                                                    |   
          |                                                                 |   
  3.9e+06 |-+                                                               |   
...
Content-Disposition: attachment; filename="config-5.8.0-12310-gaae466b0052e1"
...
export_top_env()
{
	...
	export job_origin='/lkp-src/allot/cyclic:p1:linux-devel:devel-hourly/lkp-hsw-4ex1/vm-scalability-swap-4pmem-lkp-hsw-4ex1.yaml'
...
queue_at_least_once'
	...
	export submit_id='5fa057cded67f02406fc714a'
	export job_file='/lkp/jobs/scheduled/lkp-hsw-4ex1/vm-scalability-performance-4-8-1-swap-w-seq-never-never-ucode=0x16-monitor=3472ca3d-debian-10.4-x86_64-20200603.cgz-aae466b0052e-20201103-9222-vgbd7t-3.yaml'
	export id='a7011c1635a0ac3658c24e5c1a26b7cb59f8d6ae'
...
CONFIG_SCSI_MPT3SAS
CONFIG_SATA_AHCI'
	export enqueue_time='2020-11-03 03:02:38 +0800'
	export _id='5fa057d3ed67f02406fc714b'
	export _rt='/result/vm-scalability/performance-4-8-1-swap-w-seq-never-never-ucode=0x16-monitor=3472ca3d/lkp-hsw-4ex1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/aae466b0052e1888edd1d7f473d4310d64936196'
	export user='lkp'
	...
	export result_root='/result/vm-scalability/performance-4-8-1-swap-w-seq-never-never-ucode=0x16-monitor=3472ca3d/lkp-hsw-4ex1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/aae466b0052e1888edd1d7f473d4310d64936196/3'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-hsw-4ex1/vm-scalability-performance-4-8-1-swap-w-seq-never-never-ucode=0x16-monitor=3472ca3d-debian-10.4-x86_64-20200603.cgz-aae466b0052e-20201103-9222-vgbd7t-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-8.3
branch=linus/master
commit=aae466b0052e1888edd1d7f473d4310d64936196
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/aae466b0052e1888edd1d7f473d4310d64936196/vmlinuz-5.8.0-12310-gaae466b0052e1
cma=0
memmap=120G!4G
memmap=120G!130G
memmap=120G!258G
memmap=120G!386G
max_uptime=3600
RESULT_ROOT=/result/vm-scalability/performance-4-8-1-swap-w-seq-never-never-ucode=0x16-monitor=3472ca3d/lkp-hsw-4ex1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/aae466b0052e1888edd1d7f473d4310d64936196/3
...
rw'
	...
	export bm_initrd='/osimage/deps/debian-10.4-x86_64-20200603.cgz/run-ipconfig_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/lkp_20200709.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/rsync-rootfs_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/perf_20200723.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/perf-x86_64-c85fb28b6f99-1_20201008.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/vm-scalability_20201007.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/vm-scalability-x86_64-1.0-0_20201007.cgz,/osimage/pkg/common/vm-scalability-x86_64.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/mpstat_20200714.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/sar-x86_64-34c92ae-1_20200702.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/hw_20200715.cgz'
	export ucode_initrd='/osimage/ucode/intel-ucode-20200610.cgz'
	export lkp_initrd='/osimage/user/lkp/lkp-x86_64.cgz'
	export site='inn'
	export LKP_CGI_PORT=80
	export LKP_CIFS_PORT=139
	export last_kernel='5.8.0-10127-g09e70bb4d89f72'
	export repeat_to=4
	export schedule_notify_address=
	export queue_at_least_once=1
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/aae466b0052e1888edd1d7f473d4310d64936196/vmlinuz-5.8.0-12310-gaae466b0052e1'
	export dequeue_time='2020-11-03 03:12:29 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-hsw-4ex1/vm-scalability-performance-4-8-1-swap-w-seq-never-never-ucode=0x16-monitor=3472ca3d-debian-10.4-x86_64-20200603.cgz-aae466b0052e-20201103-9222-vgbd7t-3.cgz'
...
vm-scalability:
  test: swap-w-seq
job_origin: "/lkp-src/allot/cyclic:p1:linux-devel:devel-hourly/lkp-hsw-4ex1/vm-scalability-swap-4pmem-lkp-hsw-4ex1.yaml"
...
kconfig: x86_64-rhel-8.3
submit_id: 5fa053c0ed67f0231b2997f5
job_file: "/lkp/jobs/scheduled/lkp-hsw-4ex1/vm-scalability-performance-4-8-1-swap-w-seq-never-never-ucode=0x16-monitor=3472ca3d-debian-10.4-x86_64-20200603.cgz-aae466b0052e-20201103-8987-bivgjm-1.yaml"
id: 58f3b38155f90d9027e654855bf2cf86e970f40e
...
- CONFIG_SCSI_MPT3SAS
- CONFIG_SATA_AHCI
enqueue_time: 2020-11-03 02:45:21.407321146 +08:00
_id: 5fa053c7ed67f0231b2997f6
_rt: "/result/vm-scalability/performance-4-8-1-swap-w-seq-never-never-ucode=0x16-monitor=3472ca3d/lkp-hsw-4ex1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/aae466b0052e1888edd1d7f473d4310d64936196"
...
result_root: "/result/vm-scalability/performance-4-8-1-swap-w-seq-never-never-ucode=0x16-monitor=3472ca3d/lkp-hsw-4ex1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/aae466b0052e1888edd1d7f473d4310d64936196/0"
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-hsw-4ex1/vm-scalability-performance-4-8-1-swap-w-seq-never-never-ucode=0x16-monitor=3472ca3d-debian-10.4-x86_64-20200603.cgz-aae466b0052e-20201103-8987-bivgjm-1.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- branch=linus/master
- commit=aae466b0052e1888edd1d7f473d4310d64936196
...
#! /lkp/lkp/.src-20201027-155511/include/site/inn
repeat_to: 2
schedule_notify_address: 

#! user overrides
queue_at_least_once: 0
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/aae466b0052e1888edd1d7f473d4310d64936196/vmlinuz-5.8.0-12310-gaae466b0052e1"
dequeue_time: 2020-11-03 02:53:52.283620068 +08:00

#! /lkp/lkp/.src-20201102-230049/include/site/inn
job_state: finished
loadavg: 7.40 3.85 1.49 1/1075 7243
start_time: '1604343327'
end_time: '1604343454'
version: "/lkp/lkp/.src-20201102-230122:288504f9:d5b451ce2-dirty"
...
mkswap /dev/pmem2
swapon /dev/pmem2 -p 1
mkswap /dev/pmem3
swapon /dev/pmem3 -p 1
...
cd /lkp/benchmarks/vm-scalability
 ...
 truncate -s 33566171136 /tmp/vm-scalability-tmp/vm-scalability.img
 ...
 ./case-swap-w-seq
 ./usemem --runtime 300 -n 8 50407836288
