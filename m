...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5A6CA23F6EA
	for <lists+linux-kernel@lfdr.de>; Sat,  8 Aug 2020 10:12:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726242AbgHHIMj (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 8 Aug 2020 04:12:39 -0400
Received: from mail.kernel.org ([198.145.29.99]:41994 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725853AbgHHIMi (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 8 Aug 2020 04:12:38 -0400
Received: from coco.lan (ip5f5ad5c5.dynamic.kabel-deutschland.de [95.90.213.197])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id EA3E420855;
        Sat,  8 Aug 2020 08:12:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1596874348;
        bh=1qwpVogg1zQ+As+TspacQEZAWQRefO8QEuGr4mn+P0M=;
        h=Date:From:To:Cc:Subject:In-Reply-To:References:From;
        b=aJQmdeJCkpN1euJq1naKIbXqfyWnahtjOf72R9QntFV8tjq0gyGHXVNYGUM6z1abl
         bsHkPZ7OD8pPzMGOJ02X4daW7J0hHBjysbiarGUCgoPE5fDm7MHfg0ffiUmMIYWHaE
         /j4XfJQ66nDthSmagL9ZV7I6sRtHqNdzzoyL5tJc=
Date:   Sat, 8 Aug 2020 10:12:22 +0200
...
Message-ID: <20200808101222.5103093e@coco.lan>
...
Em Fri, 3 Apr 2020 19:13:03 +0200
...
It sounds that this patch broke insmod on a device I'm currently
working with (Hikey 970). I'm building the Kernel for arm64.

I added some pr_info() stuff after each call starting from
kernel_read_file(). That's what I've got:

	[   61.280898] kernel_read_file: security_kernel_post_read_file returned 0
	[   61.280903] kernel_read_file: returning 0
	[   61.280907] load_module: elf_header_check returned 0
	[   61.280923] load_module: setup_load_info returned 0
	[   61.280925] load_module: module_sig_check returned 0
	[   61.280928] load_module: rewrite_section_headers returned 0
	[   61.280945] layout_and_allocate: check_modinfo returned 0
	[   61.281114] layout_and_allocate: module_frob_arch_sections returned 0
	[   61.281116] layout_and_allocate: module_enforce_rwx_sections returned -8
	[   61.281118] load_module: layout_and_allocate returned -8
	[   61.281209] __do_sys_finit_module: load_module returned -8
...
I'm enclosing the config used to build the Kernel. The failed
Kernel is basically a vanilla 5.8 Kernel, with some new drivers
I'm working in order to support KMS and USB on this device. 
...
#
CONFIG_CC_VERSION_TEXT="gcc (Debian 9.3.0-15) 9.3.0"
CONFIG_CC_IS_GCC=y
...
# CONFIG_DRM_HISI_KIRIN6220 is not set
CONFIG_DRM_HISI_KIRIN9XX=m
CONFIG_DRM_HISI_KIRIN9XX_DSI=m
