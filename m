...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3812C29C7D1
	for <lists+linux-kernel@lfdr.de>; Tue, 27 Oct 2020 19:53:07 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1829169AbgJ0Sus (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 27 Oct 2020 14:50:48 -0400
Received: from mail-vs1-f68.google.com ([209.85.217.68]:36000 "EHLO
        mail-vs1-f68.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1829129AbgJ0Sup (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 27 Oct 2020 14:50:45 -0400
Received: by mail-vs1-f68.google.com with SMTP id h5so1465956vsp.3
        for <linux-kernel@vger.kernel.org>; Tue, 27 Oct 2020 11:50:41 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=rajagiritech-edu-in.20150623.gappssmtp.com; s=20150623;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc:content-transfer-encoding;
        bh=LViBvd1iTffgszoauC6CUTIIoCCoIfhXBfBGqTZCpu4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=LViBvd1iTffgszoauC6CUTIIoCCoIfhXBfBGqTZCpu4=;
        b=
X-Gm-Message-State: AOAM531DfylFSwuxOM7YsqwuO+smpJPoQmQ1+m4A/aw8l9zl5ESuUPGX
        fw7w2qbO8PNzkl4ni1fm8wrLlddCK2I+dzBeT7+tHg==
X-Google-Smtp-Source: ABdhPJz2G06aWQGMsyvxkQuyBdJTEogI2Zs8uHJGKjSuQuzCDdIaq7466NmDAMzCMFBiamhTe/aN0CTWmxZwGjEtLLQ=
X-Received: by 2002:a67:7d93:: with SMTP id y141mr2881284vsc.21.1603824639311;
 Tue, 27 Oct 2020 11:50:39 -0700 (PDT)
MIME-Version: 1.0
References: <20201027135522.655719020@linuxfoundation.org>
In-Reply-To: <20201027135522.655719020@linuxfoundation.org>
From:   Jeffrin Thalakkottoor <jeffrin@rajagiritech.edu.in>
Date:   Wed, 28 Oct 2020 00:20:02 +0530
Message-ID: <CAG=yYw=05yt5trbpMbEtuMMDTS7H30NwbNW=8g1a6S5fHLS_dA@mail.gmail.com>
...
_anchored_urbs()
>
> Mikael Wikstr=C3=B6m <leakim.wikstrom@gmail.com>
...
>     dt-bindings: crypto: Specify that allwinner, sun8i-a33-crypto needs r=
eset
>
...
>
> Stephan Gerhold <stephan@gerhold.net>
>     arm64: dts: qcom: msm8916: Remove one more thermal trip point unit na=
me
>
> Sibi Sankar <sibis@codeaurora.org>
...
>
> Horia Geant=C4=83 <horia.geanta@nxp.com>
...
>
> Timoth=C3=A9e COCAULT <timothee.cocault@orange.com>
...
>     Input: elants_i2c - fix typo for an attribute to show calibration cou=
nt
>
> Gwendal Grignou <gwendal@chromium.org>
>     platform/chrome: cros_ec_lightbar: Reduce ligthbar get version comman=
d
>
...
>     perf trace: Fix off by ones in memset() after realloc() in arches usi=
ng libaudit
>
> Krzysztof Kozlowski <krzk@kernel.org>
...
>     perf stat: Fix out of bounds CPU map access when handling armv8_pmu e=
vents
>
...
>     powerpc/perf: Exclude pmc5/6 from the irrelevant PMU group constraint=
s
>
...
>
> Jason Gunthorpe <jgg@nvidia.com>
>     RDMA/mlx5: Make mkeys always owned by the kernel's PD when not enable=
d
>
> Jason Gunthorpe <jgg@nvidia.com>
...
>     powerpc/pseries: explicitly reschedule during drmem_lmb list traversa=
l
>
> Jason Gunthorpe <jgg@nvidia.com>
...
>     hv: clocksource: Add notrace attribute to read_hv_sched_clock_*() fun=
ctions
>
...
>     tty: hvc: fix link error with CONFIG_SERIAL_CORE_CONSOLE=3Dn
>
...
>
> Necip Fazil Yildiran <fazilyildiran@gmail.com>
>     ASoC: cros_ec_codec: fix kconfig dependency warning for SND_SOC_CROS_=
EC_CODEC
>
...
>
> Sai Prakash Ranjan <saiprakash.ranjan@codeaurora.org>
>     coresight: etm4x: Fix etm4_count race by moving cpuhp callbacks to in=
it
>
...
>
> Yu Kuai <yukuai3@huawei.com>
>     ASoC: fsl: imx-es8328: add missing put_device() call in imx_es8328_pr=
obe()
>
> Dinghao Liu <dinghao.liu@zju.edu.cn>
...
>
> Eric Biggers <ebiggers@google.com>
>     scsi: ufs: Make ufshcd_print_trs() consider UFSHCD_QUIRK_PRDT_BYTE_GR=
AN
>
...
>
> =C5=81ukasz Stelmach <l.stelmach@samsung.com>
>     spi: spi-s3c64xx: swap s3c64xx_spi_set_cs() and s3c64xx_enable_datapa=
th()
>
> Necip Fazil Yildiran <fazilyildiran@gmail.com>
...
>
> Lad Prabhakar <prabhakar.mahadev-lad.rj@bp.renesas.com>
>     media: i2c: ov5640: Remain in power down for DVP mode unless streamin=
g
>
> Dinghao Liu <dinghao.liu@zju.edu.cn>
...
>
> Eric Biggers <ebiggers@google.com>
>     fscrypt: restrict IV_INO_LBLK_32 to ino_bits <=3D 32
>
> Tom Rix <trix@redhat.com>
...
>
> Maulik Shah <mkshah@codeaurora.org>
>     pinctrl: qcom: Set IRQCHIP_SET_TYPE_MASKED and IRQCHIP_MASK_ON_SUSPEN=
D flags
>
> Colin Ian King <colin.king@canonical.com>
...
>
> Arvind Sankar <nivedita@alum.mit.edu>
>     x86/fpu: Allow multiple bits in clearcpuid=3D parameter
>
> Kan Liang <kan.liang@linux.intel.com>
...
>     sched/fair: Fix wrong negative conversion in find_energy_efficient_cp=
u()
>
...
>     KVM: x86/mmu: Commit zap of remaining invalid pages when recovering l=
pages
>
> Sean Christopherson <sean.j.christopherson@intel.com>
...
>
> Sean Christopherson <sean.j.christopherson@intel.com>
>     KVM: nVMX: Morph notification vector IRQ on nested VM-Enter to pendin=
g PI
>
...
>     ALSA: usb-audio: Line6 Pod Go interface requires static clock rate qu=
irk
>
> Hui Wang <hui.wang@canonical.com>
...
>     can: m_can_platform: don't call m_can_class_suspend in runtime suspen=
d
>
> Christian Eggers <ceggers@arri.de>
