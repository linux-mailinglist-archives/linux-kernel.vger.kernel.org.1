...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id DD635240460
	for <lists+linux-kernel@lfdr.de>; Mon, 10 Aug 2020 11:58:14 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726797AbgHJJ6I (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 10 Aug 2020 05:58:08 -0400
Received: from 60-251-196-230.HINET-IP.hinet.net ([60.251.196.230]:59300 "EHLO
        ironport.ite.com.tw" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726304AbgHJJ6F (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 10 Aug 2020 05:58:05 -0400
IronPort-SDR: MVbwveihVxAnLGYcB7wcWWgWzvAszIhbDnv/2tPhMN0OTv1ve/cwX1MCj/s+DEh1jKA1lAyFOF
 pGj8H8rghkZg==
Received: from unknown (HELO mse.ite.com.tw) ([192.168.35.30])
  by ironport.ite.com.tw with ESMTP; 10 Aug 2020 17:58:03 +0800
Received: from CSBMAIL1.internal.ite.com.tw (csbmail1.internal.ite.com.tw [192.168.65.58])
        by mse.ite.com.tw with ESMTP id 07A9vwoB018447;
        Mon, 10 Aug 2020 17:57:58 +0800 (GMT-8)
        (envelope-from allen.chen@ite.com.tw)
Received: from allen-VirtualBox.internal.ite.com.tw (192.168.70.14) by
 CSBMAIL1.internal.ite.com.tw (192.168.65.58) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id
 15.1.1713.5; Mon, 10 Aug 2020 17:57:58 +0800
...
CC:     Allen Chen <allen.chen@ite.com.tw>,
        ...
        Yilun Lin <yllin@google.com>, Hermes Wu <hermes.wu@ite.com.tw>,
...
Subject: [PATCH v1 2/2] drm/bridge: add refactored it6505 driver
Date:   Mon, 10 Aug 2020 17:53:18 +0800
Message-ID: <1597053278-25421-3-git-send-email-allen.chen@ite.com.tw>
...
X-TM-SNTS-SMTP: D70786E22334C86A2B105420DB49E1CAF333C9086CCDE252B40D4CC6B35D69582000:8
X-MAIL: mse.ite.com.tw 07A9vwoB018447
...
+	DRM_DEV_DEBUG_DRIVER(dev, "binfo:0x%*ph", ARRAY_SIZE(binfo), binfo);
+
...
+			     ARRAY_SIZE(it6505->bksvs), it6505->bksvs);
+
...
+}
+
+void it6505_show_hdcp_info(struct it6505 *it6505)
+{
+	struct device *dev = &it6505->client->dev;
+	int i;
...
+	DRM_DEV_DEBUG_DRIVER(dev, "bksv = 0x%*ph", ARRAY_SIZE(it6505->bksvs),
+			     it6505->bksvs);
+
