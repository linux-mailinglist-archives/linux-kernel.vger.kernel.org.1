...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5B94A1AE0B0
	for <lists+linux-kernel@lfdr.de>; Fri, 17 Apr 2020 17:14:16 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728777AbgDQPK1 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 17 Apr 2020 11:10:27 -0400
Received: from mail.kernel.org ([198.145.29.99]:42192 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728114AbgDQPK1 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 17 Apr 2020 11:10:27 -0400
Received: from localhost (83-86-89-107.cable.dynamic.v4.ziggo.nl [83.86.89.107])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id BBE3520857;
        Fri, 17 Apr 2020 15:10:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1587136224;
        bh=T3SVpe2LVNpsD8IUhtsanWXen1R22V4PTcXdzca4KlI=;
        h=Date:From:To:Cc:Subject:From;
        b=A3KZLE97Q5FF8q+cQljuqrsyAcEjsAj4AaoQCxJlI9Wh1STKeFDUr8fmv1ME8UPZc
         cCdhUovwXTvinjFNVB5uAw2e2FBPtj0o64zfi0DiwU8G+ToBipbeZQIgx+qnEQ5C7Q
         o9MrRKHPj2H1txsMoAQaAhu7a/OnOJM2s1Ewa0JE=
Date:   Fri, 17 Apr 2020 17:10:22 +0200
From:   Greg KH <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org,
        Andrew Morton <akpm@linux-foundation.org>,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, Jiri Slaby <jslaby@suse.cz>
Subject: Linux 5.4.33
Message-ID: <20200417151022.GA708373@kroah.com>
MIME-Version: 1.0
...
I'm announcing the release of the 5.4.33 kernel.
...
------------
 ...
 drivers/md/dm-clone-metadata.h                        |    6=20
 ...
 drivers/scsi/lpfc/lpfc.h                              |   10=20
 drivers/scsi/lpfc/lpfc_crtn.h                         |    8=20
...
++
 ...
 drivers/staging/wilc1000/wilc_wlan.c                  |    1=20
...
-----
 ...
 268 files changed, 2960 insertions(+), 1279 deletions(-)
...
or path
      ...
      scsi: lpfc: Fix Fabric hostname registration if system hostname chang=
es
...

=kWsA
-----END PGP SIGNATURE-----
