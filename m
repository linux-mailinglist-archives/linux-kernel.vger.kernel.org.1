...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 88D0628DB87
	for <lists+linux-kernel@lfdr.de>; Wed, 14 Oct 2020 10:31:40 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729312AbgJNI3r (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 14 Oct 2020 04:29:47 -0400
Received: from mail.kernel.org ([198.145.29.99]:52606 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728761AbgJNI3k (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 14 Oct 2020 04:29:40 -0400
Received: from localhost (83-86-74-64.cable.dynamic.v4.ziggo.nl [83.86.74.64])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id B9D5722244;
        Wed, 14 Oct 2020 08:29:37 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1602664178;
        bh=lR/JgD7E2/sWdpy6gg/D+0Y+aalbgPIjxcF10PfhuRA=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=hzMaxuM1YGrBhV8PgjSq//3uXNvvTCMauoTVFuHDXDq3KEutFqnVnCguwFaoboBtJ
         UKdlITc/1YpmgIO65kkVb0QP7VPLK1MpRbhCcZE/HDc7zNQc/vj1Wc1Xtb9gBuXOzR
         /1uXCi6ebfxPrVKsDmrbjDVFjZpGRQ6ZmqZumqdE=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 4.9.239
Date:   Wed, 14 Oct 2020 10:30:07 +0200
Message-Id: <1602664206189109@kroah.com>
X-Mailer: git-send-email 2.28.0
In-Reply-To: <160266420614166@kroah.com>
References: <160266420614166@kroah.com>
MIME-Version: 1.0
...
index 41a7d6626e35..82bb1b27d2f5 100644
--- a/Makefile
+++ b/Makefile
@@ -1,6 +1,6 @@
 VERSION = 4
...
index 854d218ea76a..ff59a1851cb4 100644
--- a/drivers/base/dd.c
+++ b/drivers/base/dd.c
...
+		goto done;
 ...
 re_probe:
@@ -446,7 +447,7 @@ static int really_probe(struct device *dev, struct device_driver *drv)
 	ret = 0;
 done:
...
index fdf7a1805888..fd97532bf7eb 100644
...
index 05ff98b43c50..80c60a62d39e 100644
...
index ddf3e24cc289..2cf19372efb9 100644
...
index 8322129c3f98..240d7850c825 100644
...
index a5de56bcbac0..93d3152752ff 100644
...
index 4f4f71b2966b..9ccbdf143106 100644
...
index b6e0cfb095d3..bba19d068207 100644
...
index 63546d131798..35589ee0cde1 100644
...
index b65ce7519411..379f9633f78e 100644
...
index b69747367bd7..0061bf130598 100644
...
index 4b7d0f9a820a..44df6f6fd063 100644
...
index 33bddf3f3040..1a3a2f1d9817 100644
...
index 8c40d6652a9a..865afb58266a 100644
--- a/fs/eventpoll.c
+++ b/fs/eventpoll.c
...
@@ -1402,9 +1403,6 @@ static int ep_insert(struct eventpoll *ep, struct epoll_event *event,
...
index 9e2f260cbb51..b2a405c93a34 100644
...
index b562467d2d49..7aad4d22b422 100644
...
index 889dab44bd74..d5c3137d93f4 100644
--- a/lib/random32.c
+++ b/lib/random32.c
...
index 1538e5e5c628..753b0e2fef36 100644
--- a/mm/khugepaged.c
+++ b/mm/khugepaged.c
...
@@ -1964,3 +1977,11 @@ int start_stop_khugepaged(void)
...
index 458523bc7391..b0c451e3b59f 100644
--- a/mm/page_alloc.c
+++ b/mm/page_alloc.c
@@ -64,6 +64,7 @@
...
index 5e28702c801f..a25be03f60f5 100644
...
index 7fc340726d03..fa475b02bdce 100644
--- a/net/rxrpc/key.c
+++ b/net/rxrpc/key.c
...
index e107754e29a7..1eb77161d5e6 100644
...
index 3734ad56b456..0eb85765d35a 100644
