...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 601942A78AD
	for <lists+linux-kernel@lfdr.de>; Thu,  5 Nov 2020 09:16:09 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730585AbgKEIQF (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 5 Nov 2020 03:16:05 -0500
Received: from mga04.intel.com ([192.55.52.120]:39805 "EHLO mga04.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1730429AbgKEIQB (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 5 Nov 2020 03:16:01 -0500
IronPort-SDR: qmMGskcewqlfS4k+r85C8v6ZbCUBKRN422NNbPXy2O8vqRnMf3JaodqNAHd+P8uX0h/1T8bJrZ
 6NKy7X7/A3WA==
X-IronPort-AV: E=McAfee;i="6000,8403,9795"; a="166755743"
X-IronPort-AV: E=Sophos;i="5.77,453,1596524400"; 
   d="scan'208";a="166755743"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 05 Nov 2020 00:16:01 -0800
IronPort-SDR: Wu3WUHNYN0iy0aFB7GwAGElIt94HtzM5fiHwtbCMAALLMT6J5I9n+bZzZdC0XWBf9E5d1KPvWr
 ZVMgsgG6xCig==
X-IronPort-AV: E=Sophos;i="5.77,453,1596524400"; 
   d="scan'208";a="539281515"
Received: from chenyi-pc.sh.intel.com ([10.239.159.72])
  by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 05 Nov 2020 00:15:58 -0800
...
Subject: [RFC v3 7/7] KVM: VMX: Enable PKS for nested VM
Date:   Thu,  5 Nov 2020 16:18:04 +0800
Message-Id: <20201105081805.5674-8-chenyi.qiang@intel.com>
...
index 67af89ed9bb0..d5239408bec3 100644
--- a/arch/x86/kvm/vmx/vmx.c
+++ b/arch/x86/kvm/vmx/vmx.c
@@ -7168,6 +7168,7 @@ static void nested_vmx_cr_fixed1_bits_update(struct kvm_vcpu *vcpu)
...
@@ -7187,6 +7188,15 @@ static void nested_vmx_entry_exit_ctls_update(struct kvm_vcpu *vcpu)
...
index 1912710e5a6f..69f4693463d8 100644
