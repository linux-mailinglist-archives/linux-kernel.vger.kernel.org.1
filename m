...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 54FE7240CD2
	for <lists+linux-kernel@lfdr.de>; Mon, 10 Aug 2020 20:16:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728091AbgHJSQY (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 10 Aug 2020 14:16:24 -0400
Received: from asavdk3.altibox.net ([109.247.116.14]:53688 "EHLO
        asavdk3.altibox.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727904AbgHJSQY (ORCPT
...
On Thu, Jul 16, 2020 at 05:47:31PM +0800, allen wrote:
...
> ---
Can you please add a From: line so it is possible for the tools to pick
who is the author.
Right now you are picked - which may or may not be OK.


I tried to apply the patch - but there is a few things to look at:

I got this with one of my configs (allyes or allmodconfigs):
 CC [M]  drivers/gpu/drm/bridge/ite-it6505.o
/home/sam/drm/linux.git/drivers/gpu/drm/bridge/ite-it6505.c:2589:12: warning: ‘it6505_bridge_suspend’ defined but not used [-Wunused-function]
 2589 | static int it6505_bridge_suspend(struct device *dev)
      |            ^~~~~~~~~~~~~~~~~~~~~
/home/sam/drm/linux.git/drivers/gpu/drm/bridge/ite-it6505.c:2582:12: warning: ‘it6505_bridge_resume’ defined but not used [-Wunused-function]
 2582 | static int it6505_bridge_resume(struct device *dev)
      |            ^~~~~~~~~~~~~~~~~~~~

Please fix.


Please try to run it through checkpatch with the following options:
./scripts/checkpatch -q --emacs --strict --show-types --codespell

Drop codespell if it does not work for you.

Codespell did not like afe - seems that it does not know this is a
shorthand for "analog front end". This is one of the warnings to ignore.

There are several valid warnings that needs fixing. For example indent.


The driver needs to support "flags" in attach to make connector creation
optional - support for this is mandatory in new drivers.

The driver also needs to support relevant bridge operations.
	.get_edid
	.detect

needs to be supported, maybe more.

See other bridge drivers - most of them are converted today.


Please fix so we can get this driver applied.
