...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A59361B2E1C
	for <lists+linux-kernel@lfdr.de>; Tue, 21 Apr 2020 19:18:19 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729514AbgDURRv (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 21 Apr 2020 13:17:51 -0400
Received: from aserp2120.oracle.com ([141.146.126.78]:46468 "EHLO
        aserp2120.oracle.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726012AbgDURRr (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 21 Apr 2020 13:17:47 -0400
Received: from pps.filterd (aserp2120.oracle.com [127.0.0.1])
        by aserp2120.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 03LHCXNu039436;
        Tue, 21 Apr 2020 17:16:33 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com; h=date : from : to : cc
 : subject : message-id : references : mime-version : content-type :
 content-transfer-encoding : in-reply-to; s=corp-2020-01-29;
 bh=3WLF5lCkF8dvaAEWV7yQNwmmBAuJPvw5X/MZ5hSnhRA=;
 b= FQ== 
Received: from userp3030.oracle.com (userp3030.oracle.com [156.151.31.80])
        by aserp2120.oracle.com with ESMTP id 30fsgkxac6-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Tue, 21 Apr 2020 17:16:29 +0000
Received: from pps.filterd (userp3030.oracle.com [127.0.0.1])
        by userp3030.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 03LHCEPY180333;
        Tue, 21 Apr 2020 17:16:29 GMT
Received: from aserv0121.oracle.com (aserv0121.oracle.com [141.146.126.235])
        by userp3030.oracle.com with ESMTP id 30gb1gj89q-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Tue, 21 Apr 2020 17:16:25 +0000
Received: from abhmp0017.oracle.com (abhmp0017.oracle.com [141.146.116.23])
        by aserv0121.oracle.com (8.14.4/8.13.8) with ESMTP id 03LHGJJ7011471;
        Tue, 21 Apr 2020 17:16:24 GMT
Received: from localhost (/67.169.218.210)
        by default (Oracle Beehive Gateway v4.0)
        with ESMTP ; Tue, 21 Apr 2020 10:16:17 -0700
Date:   Tue, 21 Apr 2020 10:16:16 -0700
...
(and a lot of amdgpu warnings), which is a bit worrisome.  FWIW, USB
bridges have caused us a lot of trouble in the past.

--D

> I am evaluating the feasibility of using XFS with reflinks as a
> replacement for Restic for my backups. Unfortunately it is not suitable
> for that yet.
> 
> According to 
> https://blogs.oracle.com/linux/xfs-data-block-sharing-reflink this is
> now production ready with xfsprogs 5.1 (I got 5.3), doesn't say from
> which kernel version though. I tried both 5.3.0-46 and 5.4.0-24 Ubuntu
> kernels.
> 
...
> swapfile -o -name steamapps -print0 | xargs --verbose -0 -n1 -P0 -I% rm
> % -rf\
...
> 
> (I used fallocate --dig-holes prior to duperemove, because otherwise
...
> froze (screen was off due to screensaver settings, and no reply to ping
...
> 2255716352), "/mnt/storage/from-restic/10350278/tmp/fast/c14-sd-92016-
...
> 23-233346/edwin/.mu/xapian/postlist.DB" had status (-5) "Input/output
> error".
> [0x556dfa962980] Dedupe for file "/mnt/storage/from-
> restic/04683ed4/tmp/fast/c14-sd-92016-2-home/2017-06-07-233355/2017-06-
> 07-233355/edwin/.mu/xapian/postlist.DB" had status (-5) "Input/output
> error".
...
> "/mnt/storage/restore/root.squashfs/home/edwin/cycles_benchmark_2016022
> 8.zip" had status (-5) "Input/output error".
> [0x556de5dc7240] Dedupe for file
> "/mnt/storage/restore/root.squashfs/home/edwin/.phoronix-test-
> suite/installed-tests/pts/blender-1.4.1/cycles_benchmark_20160228.zip"
> had status (-5) "Input/output error".
> [0x556de5dc7240] Dedupe for file
> "/mnt/storage/restore/root.squashfs/home/edwin/.phoronix-test-
> suite/installed-tests/pts/blender-1.7.0/cycles_benchmark_20160228.zip"
> had status (-5) "Input/output error".
...
> [104763.870102] RSP: 002b:00007fe0c9441bf8 EFLAGS: 00000246 ORIG_RAX:
> 0000000000000010
...
> [108129.210856] CPU: 15 PID: 97752 Comm: pool Tainted: G W 5.4.0-24-
> generic #28-Ubuntu
...
> [108129.211003] Code: 0f 1e fa 48 8b 05 15 3b 0d 00 64 c7 00 26 00 00
> 00 48 c7 c0 ff ff ff ff c3 66 0f 1f 44 00 00 f3 0f 1e fa b8 10 00 00 00
> 0f 05 <48> 3d 01 f0 ff ff 73 01 c3 48 8b 0d e5 3a 0d 00 f7 d8 64 89 01
> 48
> [108129.211004] RSP: 002b:00007fe089ffac38 EFLAGS: 00000246 ORIG_RAX:
> 0000000000000010
...
> 00007fe07000c690
> [108129.230787] XFS (dm-4): xfs_do_force_shutdown(0x8) called from line
...
> [108129.230790] XFS (dm-4): Please unmount the filesystem and rectify
> the problem(s)
...
> [124074.632650] xfs filesystem being mounted at /mnt/storage supports
...
> xfs_repair showed some 'clearing reflink flag on inode N' for quite a
...
> done
> 
> Is there any more useful debug info that I could gather that could help
> narrow down and reproduce this on your end?
> 
> E.g. is there an easy way to record and replay all the dedup IOCTLs
> that duperemove makes? (running duperemove to find the problem takes
> nearly an entire day, so trying a kernel with XFS_DEBUG or KASAN would
> not be feasible at this point, unless I can narrow it down to a faster
...
> Linux version 5.4.0-24-generic (buildd@lgw01-amd64-017) (gcc version
> 9.3.0 (Ubuntu 9.3.0-10ubuntu2)) #28-Ubuntu SMP Thu Apr 9 22:16:42 UTC
> 2020
> Linux version 5.3.0-46-generic (buildd@lgw01-amd64-003) (gcc version
...
> /mnt/storage/hashes
> 
> (But you obviously need to have the terrabytes of data that I have on
> /mnt/storage for that to reproduce the issue, I haven't found a smaller
> reproducer yet)
> 
> [8.] Environment
> [8.1.] Software (add the output of the ver_linux script here)
> Linux storm 5.4.0-24-generic #28-Ubuntu SMP Thu Apr 9 22:16:42 UTC 2020
...
> Udev                	245
> Wireless-tools      	30
> Modules Loaded      	aesni_intel ahci amd_iommu_v2 amdgpu asus_wmi
> autofs4 binfmt_misc ccp cfg80211 crc32_pclmul crct10dif_pclmul cryptd
> crypto_simd drm drm_kms_helper edac_mce_amd eeepc_wmi enclosure
> fb_sys_fops ghash_clmulni_intel glue_helper gpu_sched hid hid_generic
> hwmon_vid i2c_algo_bit i2c_piix4 input_leds ip_tables joydev k10temp
> kvm kvm_amd ledtrig_audio libahci libcrc32c lp mac_hid mc msr nct6775
...
> syscopyarea sysfillrect sysimgblt ttm uas usb_storage usbhid uvcvideo
...
> cqm_mbm_local clzero irperf xsaveerptr wbnoinvd arat npt lbrv svm_lock
...
> snd_pcm 106496 5
> snd_usb_audio,snd_hda_codec_hdmi,snd_hda_intel,snd_hda_codec,snd_hda_co
...
> snd 90112 209
> snd_hda_codec_realtek,snd_hda_codec_generic,snd_usb_audio,snd_usbmidi_l
> ib,snd_hda_codec_hdmi,snd_rawmidi,snd_hda_intel,snd_hda_codec,snd_hwdep
...
> AuxPwr- TransPend-
> 		LnkCap:	Port #1, Speed 16GT/s, Width x4, ASPM L1, Exit
> Latency L1 <64us
...
> 
> 00:01.2 PCI bridge: Advanced Micro Devices, Inc. [AMD] Starship/Matisse
> GPP Bridge (prog-if 00 [Normal decode])
> 	Control: I/O+ Mem+ BusMaster+ SpecCycle- MemWINV- VGASnoop-
> ParErr- Stepping- SERR- FastB2B- DisINTx+
> 	Status: Cap+ 66MHz- UDF- FastB2B- ParErr- DEVSEL=fast >TAbort-
...
> <TAbort- <MAbort- >SERR- <PERR- INTx-
> 
> 00:03.1 PCI bridge: Advanced Micro Devices, Inc. [AMD] Starship/Matisse
> GPP Bridge (prog-if 00 [Normal decode])
> 	Control: I/O+ Mem+ BusMaster+ SpecCycle- MemWINV- VGASnoop-
> ParErr- Stepping- SERR- FastB2B- DisINTx+
> 	Status: Cap+ 66MHz- UDF- FastB2B- ParErr- DEVSEL=fast >TAbort-
...
> 		DevSta:	CorrErr- NonFatalErr- FatalErr- UnsupReq-
> AuxPwr- TransPend-
> 		LnkCap:	Port #0, Speed 16GT/s, Width x16, ASPM L1, Exit
> Latency L1 <64us
> 			ClockPM- Surprise- LLActRep+ BwNot+
> ASPMOptComp+
> 		LnkCtl:	ASPM Disabled; RCB 64 bytes Disabled- CommClk+
...
> 	Kernel driver in use: pcieport
> 
> 00:08.2 PCI bridge: Advanced Micro Devices, Inc. [AMD] Starship/Matisse
> Internal PCIe GPP Bridge 0 to bus[E:B] (prog-if 00 [Normal decode])
> 	Control: I/O+ Mem+ BusMaster+ SpecCycle- MemWINV- VGASnoop-
> ParErr- Stepping- SERR- FastB2B- DisINTx+
> 	Status: Cap+ 66MHz- UDF- FastB2B- ParErr- DEVSEL=fast >TAbort-
...
> 	Kernel driver in use: pcieport
> 
> 00:08.3 PCI bridge: Advanced Micro Devices, Inc. [AMD] Starship/Matisse
> Internal PCIe GPP Bridge 0 to bus[E:B] (prog-if 00 [Normal decode])
> 	Control: I/O+ Mem+ BusMaster+ SpecCycle- MemWINV- VGASnoop-
> ParErr- Stepping- SERR- FastB2B- DisINTx+
> 	Status: Cap+ 66MHz- UDF- FastB2B- ParErr- DEVSEL=fast >TAbort-
...
> 	Latency: 0
> 
> 00:18.0 Host bridge: Advanced Micro Devices, Inc. [AMD] Matisse Device
> 24: Function 0
> 	Control: I/O- Mem- BusMaster- SpecCycle- MemWINV- VGASnoop-
> ParErr- Stepping- SERR- FastB2B- DisINTx-
> 	Status: Cap- 66MHz- UDF- FastB2B- ParErr- DEVSEL=fast >TAbort-
> <TAbort- <MAbort- >SERR- <PERR- INTx-
> 
> 00:18.1 Host bridge: Advanced Micro Devices, Inc. [AMD] Matisse Device
> 24: Function 1
> 	Control: I/O- Mem- BusMaster- SpecCycle- MemWINV- VGASnoop-
> ParErr- Stepping- SERR- FastB2B- DisINTx-
> 	Status: Cap- 66MHz- UDF- FastB2B- ParErr- DEVSEL=fast >TAbort-
> <TAbort- <MAbort- >SERR- <PERR- INTx-
> 
> 00:18.2 Host bridge: Advanced Micro Devices, Inc. [AMD] Matisse Device
> 24: Function 2
> 	Control: I/O- Mem- BusMaster- SpecCycle- MemWINV- VGASnoop-
> ParErr- Stepping- SERR- FastB2B- DisINTx-
> 	Status: Cap- 66MHz- UDF- FastB2B- ParErr- DEVSEL=fast >TAbort-
> <TAbort- <MAbort- >SERR- <PERR- INTx-
> 
> 00:18.3 Host bridge: Advanced Micro Devices, Inc. [AMD] Matisse Device
> 24: Function 3
> 	Control: I/O- Mem- BusMaster- SpecCycle- MemWINV- VGASnoop-
> ParErr- Stepping- SERR- FastB2B- DisINTx-
> 	Status: Cap- 66MHz- UDF- FastB2B- ParErr- DEVSEL=fast >TAbort-
...
> 
> 00:18.4 Host bridge: Advanced Micro Devices, Inc. [AMD] Matisse Device
> 24: Function 4
> 	Control: I/O- Mem- BusMaster- SpecCycle- MemWINV- VGASnoop-
> ParErr- Stepping- SERR- FastB2B- DisINTx-
> 	Status: Cap- 66MHz- UDF- FastB2B- ParErr- DEVSEL=fast >TAbort-
> <TAbort- <MAbort- >SERR- <PERR- INTx-
> 
> 00:18.5 Host bridge: Advanced Micro Devices, Inc. [AMD] Matisse Device
> 24: Function 5
> 	Control: I/O- Mem- BusMaster- SpecCycle- MemWINV- VGASnoop-
> ParErr- Stepping- SERR- FastB2B- DisINTx-
> 	Status: Cap- 66MHz- UDF- FastB2B- ParErr- DEVSEL=fast >TAbort-
> <TAbort- <MAbort- >SERR- <PERR- INTx-
> 
> 00:18.6 Host bridge: Advanced Micro Devices, Inc. [AMD] Matisse Device
> 24: Function 6
> 	Control: I/O- Mem- BusMaster- SpecCycle- MemWINV- VGASnoop-
> ParErr- Stepping- SERR- FastB2B- DisINTx-
> 	Status: Cap- 66MHz- UDF- FastB2B- ParErr- DEVSEL=fast >TAbort-
> <TAbort- <MAbort- >SERR- <PERR- INTx-
> 
> 00:18.7 Host bridge: Advanced Micro Devices, Inc. [AMD] Matisse Device
> 24: Function 7
> 	Control: I/O- Mem- BusMaster- SpecCycle- MemWINV- VGASnoop-
> ParErr- Stepping- SERR- FastB2B- DisINTx-
> 	Status: Cap- 66MHz- UDF- FastB2B- ParErr- DEVSEL=fast >TAbort-
...
> 	Kernel modules: nvme
> 
> 02:00.0 PCI bridge: Advanced Micro Devices, Inc. [AMD] Matisse Switch
...
> 	Kernel driver in use: pcieport
> 
> 03:01.0 PCI bridge: Advanced Micro Devices, Inc. [AMD] Matisse PCIe GPP
...
> 	Kernel driver in use: pcieport
> 
> 03:02.0 PCI bridge: Advanced Micro Devices, Inc. [AMD] Matisse PCIe GPP
> Bridge (prog-if 00 [Normal decode])
> 	Control: I/O+ Mem+ BusMaster+ SpecCycle- MemWINV- VGASnoop-
> ParErr- Stepping- SERR- FastB2B- DisINTx+
> 	Status: Cap+ 66MHz- UDF- FastB2B- ParErr- DEVSEL=fast >TAbort-
...
> 	Kernel driver in use: pcieport
> 
> 03:05.0 PCI bridge: Advanced Micro Devices, Inc. [AMD] Matisse PCIe GPP
> Bridge (prog-if 00 [Normal decode])
> 	Control: I/O+ Mem+ BusMaster+ SpecCycle- MemWINV- VGASnoop-
> ParErr- Stepping- SERR- FastB2B- DisINTx+
> 	Status: Cap+ 66MHz- UDF- FastB2B- ParErr- DEVSEL=fast >TAbort-
...
> 		DevSta:	CorrErr- NonFatalErr- FatalErr- UnsupReq-
> AuxPwr- TransPend-
> 		LnkCap:	Port #5, Speed 16GT/s, Width x1, ASPM L1, Exit
> Latency L1 <64us
> 			ClockPM- Surprise- LLActRep+ BwNot+
> ASPMOptComp+
> 		LnkCtl:	ASPM Disabled; Disabled- CommClk+
...
> 	Kernel driver in use: pcieport
> 
> 03:08.0 PCI bridge: Advanced Micro Devices, Inc. [AMD] Matisse PCIe GPP
> Bridge (prog-if 00 [Normal decode])
> 	Control: I/O+ Mem+ BusMaster+ SpecCycle- MemWINV- VGASnoop-
> ParErr- Stepping- SERR- FastB2B- DisINTx+
> 	Status: Cap+ 66MHz- UDF- FastB2B- ParErr- DEVSEL=fast >TAbort-
...
> 	Kernel driver in use: pcieport
> 
> 03:09.0 PCI bridge: Advanced Micro Devices, Inc. [AMD] Matisse PCIe GPP
> Bridge (prog-if 00 [Normal decode])
> 	Control: I/O+ Mem+ BusMaster+ SpecCycle- MemWINV- VGASnoop-
> ParErr- Stepping- SERR- FastB2B- DisINTx+
> 	Status: Cap+ 66MHz- UDF- FastB2B- ParErr- DEVSEL=fast >TAbort-
...
> 	Kernel driver in use: pcieport
> 
> 03:0a.0 PCI bridge: Advanced Micro Devices, Inc. [AMD] Matisse PCIe GPP
> Bridge (prog-if 00 [Normal decode])
> 	Control: I/O+ Mem+ BusMaster+ SpecCycle- MemWINV- VGASnoop-
> ParErr- Stepping- SERR- FastB2B- DisINTx+
> 	Status: Cap+ 66MHz- UDF- FastB2B- ParErr- DEVSEL=fast >TAbort-
...
> 	Capabilities: [440 v1] Lane Margining at the Receiver <?>
> 
> 07:00.1 USB controller: Advanced Micro Devices, Inc. [AMD] Matisse USB
...
> 
> 07:00.3 USB controller: Advanced Micro Devices, Inc. [AMD] Matisse USB
> 3.0 Host Controller (prog-if 30 [XHCI])
...
> [AMD/ATI] Navi 10 [Radeon RX 5600 OEM/5600 XT / 5700/5700 XT] (rev c0)
...
> 
> 0c:00.1 Audio device: Advanced Micro Devices, Inc. [AMD/ATI] Navi 10
> HDMI Audio
...
> 	Kernel modules: ccp
> 
> 0e:00.3 USB controller: Advanced Micro Devices, Inc. [AMD] Matisse USB
> 3.0 Host Controller (prog-if 30 [XHCI])
> 	Subsystem: ASUSTeK Computer Inc. Matisse USB 3.0 Host
> Controller
> 	Control: I/O+ Mem+ BusMaster+ SpecCycle- MemWINV- VGASnoop-
...
> 	Kernel modules: snd_hda_intel
> 
> 0f:00.0 SATA controller: Advanced Micro Devices, Inc. [AMD] FCH SATA
> Controller [AHCI mode] (rev 51) (prog-if 01 [AHCI 1.0])
...
> 	Kernel modules: ahci
> 
> 10:00.0 SATA controller: Advanced Micro Devices, Inc. [AMD] FCH SATA
> Controller [AHCI mode] (rev 51) (prog-if 01 [AHCI 1.0])
> 	Subsystem: ASUSTeK Computer Inc. FCH SATA Controller [AHCI
> mode]
> 	Control: I/O+ Mem+ BusMaster+ SpecCycle- MemWINV- VGASnoop-
