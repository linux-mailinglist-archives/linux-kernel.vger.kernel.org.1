...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 722D72CB1F0
	for <lists+linux-kernel@lfdr.de>; Wed,  2 Dec 2020 01:59:06 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727848AbgLBA6l (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 1 Dec 2020 19:58:41 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59002 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726619AbgLBA6k (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 1 Dec 2020 19:58:40 -0500
Received: from mail-pf1-x42e.google.com (mail-pf1-x42e.google.com [IPv6:2607:f8b0:4864:20::42e])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9F36DC0613D6
        for <linux-kernel@vger.kernel.org>; Tue,  1 Dec 2020 16:58:00 -0800 (PST)
Received: by mail-pf1-x42e.google.com with SMTP id q10so134366pfn.0
        for <linux-kernel@vger.kernel.org>; Tue, 01 Dec 2020 16:58:00 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=UTMqnktoqMxJU6kxwaQJ7PHE65OrsngpjPjy7UkSONI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=UTMqnktoqMxJU6kxwaQJ7PHE65OrsngpjPjy7UkSONI=;
        b=
X-Gm-Message-State: AOAM531x7bPOoyjtz3God8s1SNlWK5vEp4u8P7qfG0FJ2LoAAhZLCQSy
        wJtSvrgvGICTRuynUufI6RY=
X-Google-Smtp-Source: ABdhPJz1Cgw0NbzQrx8qD5OE/JnODO/y9jx72w1zhkCwTws3Rrrmwq9w2JMQHsbn4k/gyip3aQqkXw==
X-Received: by 2002:aa7:90d2:0:b029:198:39d8:e5b0 with SMTP id k18-20020aa790d20000b029019839d8e5b0mr42593pfk.1.1606870679949;
        Tue, 01 Dec 2020 16:57:59 -0800 (PST)
Received: from robinhsu-p520.ntc.corp.google.com ([2401:fa00:fc:202:1ea0:b8ff:fe77:fe45])
        by smtp.gmail.com with ESMTPSA id gz2sm116974pjb.2.2020.12.01.16.57.58
...
Subject: [PATCH 2/3] f2fs-tools:sload.f2fs compression support
Date:   Wed,  2 Dec 2020 08:57:23 +0800
Message-Id: <20201202005724.691458-3-robinh3123@gmail.com>
...
---
 ...
 lib/libf2fs_io.c        |  33 +++++++
 8 files changed, 641 insertions(+), 14 deletions(-)
...
@@ -812,6 +922,26 @@ static int do_resize(struct f2fs_sb_info *sbi)
 #endif
 
 #ifdef WITH_SLOAD
+void init_compr(struct f2fs_sb_info *sbi)
+{
+	if (!(sbi->raw_super->feature
+			& cpu_to_le32(F2FS_FEATURE_COMPRESSION))) {
+		printf("Error: Compression (-c) was requested "
+			"but the file system is not created "
+			"with such feature.\n");
+		abort();
+	}
+	c.sldc_compr = compr_ops + c.sldc_ca;
+	if (c.sldc_compr == NULL) {
+		printf("Error: The selected compression algorithm is not\n"
+				" supported\n");
+		abort();
+	}
...
+
 ...
 {
 	if (!c.from_dir) {
@@ -821,6 +951,9 @@ static int do_sload(struct f2fs_sb_info *sbi)
 	if (!c.mount_point)
 		c.mount_point = "/";
