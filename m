...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 533A92E6C95
	for <lists+linux-kernel@lfdr.de>; Tue, 29 Dec 2020 00:50:02 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729235AbgL1XsD (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 28 Dec 2020 18:48:03 -0500
Received: from mga05.intel.com ([192.55.52.43]:6844 "EHLO mga05.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726232AbgL1XsC (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 28 Dec 2020 18:48:02 -0500
IronPort-SDR: vduTJWpObLe68BWx6RbqyD5C0RAqqvrddSsRuRNGvFccz47CUmIA0SfJ1B00V0+zKxf6Tiv7s7
 viKjyqEfpc9A==
X-IronPort-AV: E=McAfee;i="6000,8403,9848"; a="261186892"
X-IronPort-AV: E=Sophos;i="5.78,456,1599548400"; 
   d="gz'50?scan'50,208,50";a="261186892"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 28 Dec 2020 15:47:19 -0800
IronPort-SDR: yTNs4XlsUR/xmXaKVF/QI6mMyWvRXsgRbPzWqq5II7yBSxgWov26f3jxIPrjslrXKPKhpOjSI/
 H17H/GtikAwA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,456,1599548400"; 
   d="gz'50?scan'50,208,50";a="358727827"
Received: from lkp-server02.sh.intel.com (HELO 4242b19f17ef) ([10.239.97.151])
  by orsmga002.jf.intel.com with ESMTP; 28 Dec 2020 15:47:17 -0800
Received: from kbuild by 4242b19f17ef with local (Exim 4.92)
        (envelope-from <lkp@intel.com>)
        id 1ku2EO-0003Ao-D3; Mon, 28 Dec 2020 23:47:16 +0000
Date:   Tue, 29 Dec 2020 07:46:42 +0800
From:   kernel test robot <lkp@intel.com>
To:     Takashi Iwai <tiwai@suse.de>
Cc:     kbuild-all@lists.01.org, linux-kernel@vger.kernel.org
Subject: ERROR: ".regcache_cache_only" undefined!
Message-ID: <202012290736.RZEGCPlU-lkp@intel.com>
MIME-Version: 1.0
...
commit: 1a462be52f4505a2719631fb5aa7bfdbd37bfd8d ALSA: hda: Manage concurrent reg access more properly
date:   12 months ago
...
reproduce:
        ...
        # https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=1a462be52f4505a2719631fb5aa7bfdbd37bfd8d
        git remote add linus https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git
        git fetch --no-tags linus master
        git checkout 1a462be52f4505a2719631fb5aa7bfdbd37bfd8d
...
All errors (new ones prefixed by >>):
   ...
   ERROR: ".aoa_get_card" [sound/aoa/codecs/snd-aoa-codec-onyx.ko] undefined!
   ERROR: ".i2c_smbus_read_byte_data" [sound/aoa/codecs/snd-aoa-codec-onyx.ko] undefined!
   ERROR: ".i2c_register_driver" [sound/aoa/codecs/snd-aoa-codec-onyx.ko] undefined!
   ERROR: ".memcpy" [sound/aoa/codecs/snd-aoa-codec-onyx.ko] undefined!
   ERROR: ".printk" [sound/aoa/codecs/snd-aoa-codec-onyx.ko] undefined!
   ERROR: ".msleep" [sound/aoa/codecs/snd-aoa-codec-onyx.ko] undefined!
   ERROR: ".__stack_chk_fail" [sound/aoa/codecs/snd-aoa-codec-onyx.ko] undefined!
   ERROR: ".mutex_unlock" [sound/aoa/codecs/snd-aoa-codec-onyx.ko] undefined!
   ERROR: ".snd_device_free" [sound/aoa/codecs/snd-aoa-codec-onyx.ko] undefined!
   ERROR: ".aoa_snd_ctl_add" [sound/aoa/codecs/snd-aoa-codec-onyx.ko] undefined!
   ERROR: ".aoa_codec_unregister" [sound/aoa/codecs/snd-aoa-codec-onyx.ko] undefined!
   ERROR: ".strlen" [sound/aoa/soundbus/snd-aoa-soundbus.ko] undefined!
   ERROR: ".put_device" [sound/aoa/soundbus/snd-aoa-soundbus.ko] undefined!
   ERROR: ".of_device_register" [sound/aoa/soundbus/snd-aoa-soundbus.ko] undefined!
   ERROR: ".of_device_unregister" [sound/aoa/soundbus/snd-aoa-soundbus.ko] undefined!
   ERROR: ".sprintf" [sound/aoa/soundbus/snd-aoa-soundbus.ko] undefined!
...
>> ERROR: ".regmap_update_bits_base" [sound/hda/snd-hda-core.ko] undefined!
   ...
   ERROR: ".regcache_sync" [sound/hda/snd-hda-core.ko] undefined!
...
>> ERROR: ".regcache_cache_only" [sound/hda/snd-hda-core.ko] undefined!
   ...
   ERROR: ".devm_kmalloc" [sound/soc/xilinx/snd-soc-xlnx-i2s.ko] undefined!
   ERROR: ".__platform_driver_register" [sound/soc/xilinx/snd-soc-xlnx-i2s.ko] undefined!
   ERROR: "._dev_info" [sound/soc/xilinx/snd-soc-xlnx-i2s.ko] undefined!
   ERROR: ".of_property_read_variable_u32_array" [sound/soc/xilinx/snd-soc-xlnx-i2s.ko] undefined!
   ERROR: ".platform_driver_unregister" [sound/soc/xilinx/snd-soc-xlnx-i2s.ko] undefined!
   ERROR: ".devm_snd_soc_register_component" [sound/soc/xilinx/snd-soc-xlnx-i2s.ko] undefined!
   ERROR: ".devm_platform_ioremap_resource" [sound/soc/xilinx/snd-soc-xlnx-i2s.ko] undefined!
   ERROR: ".of_device_is_compatible" [sound/soc/xilinx/snd-soc-xlnx-i2s.ko] undefined!
   ERROR: "._dev_err" [sound/soc/xilinx/snd-soc-xlnx-i2s.ko] undefined!
   ERROR: ".__stack_chk_fail" [sound/soc/xilinx/snd-soc-xlnx-i2s.ko] undefined!
   ERROR: ".ftrace_likely_update" [sound/soc/xilinx/snd-soc-xlnx-i2s.ko] undefined!
   ERROR: ".edma_pcm_platform_register" [sound/soc/ti/snd-soc-davinci-vcif.ko] undefined!
   ERROR: ".devm_kmalloc" [sound/soc/ti/snd-soc-davinci-vcif.ko] undefined!
   ERROR: ".__platform_driver_register" [sound/soc/ti/snd-soc-davinci-vcif.ko] undefined!
   ERROR: ".eeh_check_failure" [sound/soc/ti/snd-soc-davinci-vcif.ko] undefined!
   ERROR: ".platform_driver_unregister" [sound/soc/ti/snd-soc-davinci-vcif.ko] undefined!
   ERROR: ".devm_snd_soc_register_component" [sound/soc/ti/snd-soc-davinci-vcif.ko] undefined!
   ERROR: "._dev_err" [sound/soc/ti/snd-soc-davinci-vcif.ko] undefined!
   ERROR: ".printk" [sound/soc/ti/snd-soc-davinci-vcif.ko] undefined!
   ERROR: ".devm_kmalloc" [sound/soc/ti/snd-soc-ti-edma.ko] undefined!
   ERROR: ".devm_snd_dmaengine_pcm_register" [sound/soc/ti/snd-soc-ti-edma.ko] undefined!
   ERROR: ".memset" [sound/soc/ti/snd-soc-ti-edma.ko] undefined!
   ERROR: ".__devm_regmap_init" [sound/soc/sunxi/sun8i-adda-pr-regmap.ko] undefined!
   ERROR: ".eeh_check_failure" [sound/soc/sunxi/sun8i-adda-pr-regmap.ko] undefined!
   ERROR: ".platform_driver_unregister" [sound/soc/sunxi/sun50i-codec-analog.ko] undefined!
   ERROR: ".__platform_driver_register" [sound/soc/sunxi/sun50i-codec-analog.ko] undefined!
   ERROR: "._dev_err" [sound/soc/sunxi/sun50i-codec-analog.ko] undefined!
   ERROR: ".devm_snd_soc_register_component" [sound/soc/sunxi/sun50i-codec-analog.ko] undefined!
   ERROR: ".sun8i_adda_pr_regmap_init" [sound/soc/sunxi/sun50i-codec-analog.ko] undefined!
   ERROR: ".ftrace_likely_update" [sound/soc/sunxi/sun50i-codec-analog.ko] undefined!
   ERROR: ".devm_platform_ioremap_resource" [sound/soc/sunxi/sun50i-codec-analog.ko] undefined!
   ERROR: ".platform_driver_unregister" [sound/soc/sunxi/sun8i-codec-analog.ko] undefined!
   ERROR: ".__platform_driver_register" [sound/soc/sunxi/sun8i-codec-analog.ko] undefined!
   ERROR: ".snd_soc_add_component_controls" [sound/soc/sunxi/sun8i-codec-analog.ko] undefined!
   ERROR: ".snd_soc_dapm_add_routes" [sound/soc/sunxi/sun8i-codec-analog.ko] undefined!
   ERROR: ".snd_soc_dapm_new_controls" [sound/soc/sunxi/sun8i-codec-analog.ko] undefined!
   ERROR: ".of_device_get_match_data" [sound/soc/sunxi/sun8i-codec-analog.ko] undefined!
   ERROR: "._dev_err" [sound/soc/sunxi/sun8i-codec-analog.ko] undefined!
   ERROR: ".devm_snd_soc_register_component" [sound/soc/sunxi/sun8i-codec-analog.ko] undefined!
   ERROR: ".sun8i_adda_pr_regmap_init" [sound/soc/sunxi/sun8i-codec-analog.ko] undefined!
   ERROR: ".ftrace_likely_update" [sound/soc/sunxi/sun8i-codec-analog.ko] undefined!
   ERROR: ".devm_platform_ioremap_resource" [sound/soc/sunxi/sun8i-codec-analog.ko] undefined!
   ERROR: ".msleep" [sound/soc/sunxi/sun8i-codec-analog.ko] undefined!
   ERROR: ".snd_soc_component_update_bits" [sound/soc/sunxi/sun8i-codec-analog.ko] undefined!
   ERROR: ".platform_driver_unregister" [sound/soc/sunxi/sun4i-spdif.ko] undefined!
   ERROR: ".__platform_driver_register" [sound/soc/sunxi/sun4i-spdif.ko] undefined!
   ERROR: "._dev_err" [sound/soc/sunxi/sun4i-spdif.ko] undefined!
   ERROR: ".__pm_runtime_disable" [sound/soc/sunxi/sun4i-spdif.ko] undefined!
   ERROR: ".devm_snd_dmaengine_pcm_register" [sound/soc/sunxi/sun4i-spdif.ko] undefined!
   ERROR: ".pm_runtime_enable" [sound/soc/sunxi/sun4i-spdif.ko] undefined!
   ERROR: ".devm_snd_soc_register_component" [sound/soc/sunxi/sun4i-spdif.ko] undefined!
   ERROR: ".reset_control_deassert" [sound/soc/sunxi/sun4i-spdif.ko] undefined!
...
H4sICPTQ6V8AAy5jb25maWcAjFxbc9s4sn7fX6HKvOzWVmZ9SZzknPIDSIISRiTBAKAk+4Xl
