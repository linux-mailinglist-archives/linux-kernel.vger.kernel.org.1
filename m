...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CC9FA2F00CF
	for <lists+linux-kernel@lfdr.de>; Sat,  9 Jan 2021 16:28:24 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726796AbhAIP0k (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 9 Jan 2021 10:26:40 -0500
Received: from mail.kernel.org ([198.145.29.99]:57206 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726522AbhAIP0h (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 9 Jan 2021 10:26:37 -0500
Received: by mail.kernel.org (Postfix) with ESMTPSA id 7E36723A75;
        Sat,  9 Jan 2021 15:25:34 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=linuxfoundation.org;
        s=korg; t=1610205935;
        bh=LAr9OcgvYG6yRRsSPLVOXAKRjMj3RYyO8ACzwNLyymQ=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=iHAj4EGLaaMORziGcwWRrhiTdxGhxmS8JtbzlO3UBmfUrkeGsFhXtusRaZMblh9Pq
         UZtWSjyJ9RRhc6mDerS4kJ+YLyJOaPRk6Z6bj4/MW6TIbb4QqcOVG5yKsduhTIMCnA
         1ptM4TsZvPvMAMnCvvNd+DDx/SCdqRPEUAs8KE4g=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 5.4.88
Date:   Sat,  9 Jan 2021 16:26:45 +0100
Message-Id: <161020600439211@kroah.com>
X-Mailer: git-send-email 2.30.0
In-Reply-To: <161020600422122@kroah.com>
References: <161020600422122@kroah.com>
MIME-Version: 1.0
...
index ff366c2f58c1..303bc3e601a1 100644
...
index 09410971615c..d2dd387c95d8 100644
...
index 2441eb1a1e2d..1b4d2206d53a 100644
--- a/fs/exec.c
+++ b/fs/exec.c
...
index ee190119f45c..60378f3baaae 100644
--- a/fs/fuse/dir.c
+++ b/fs/fuse/dir.c
...
index ab4fc1255aca..1e1aef1bc20b 100644
--- a/fs/fuse/file.c
+++ b/fs/fuse/file.c
...
index d7cde216fc87..e3688312e9f1 100644
--- a/fs/fuse/fuse_i.h
+++ b/fs/fuse/fuse_i.h
@@ -158,6 +158,8 @@ enum {
 	FUSE_I_INIT_RDPLUS,
...
index f58ab84b09fb..aa1d5cf1bc3a 100644
--- a/fs/fuse/inode.c
+++ b/fs/fuse/inode.c
...
index 20d052e08b3b..28fed5295770 100644
--- a/fs/fuse/xattr.c
+++ b/fs/fuse/xattr.c
...
index b690074e65ff..653c2d8aa1cd 100644
--- a/fs/proc/base.c
+++ b/fs/proc/base.c
...
index a29df79540ce..baf58f4cb057 100644
...
index bd403ed3e418..df7041be96fc 100644
--- a/init/init_task.c
+++ b/init/init_task.c
...
index 9f7c2da99299..2ef33e9a7591 100644
...
@@ -11320,7 +11320,10 @@ SYSCALL_DEFINE5(perf_event_open,
 	if (move_group)
...
@@ -11332,9 +11335,6 @@ SYSCALL_DEFINE5(perf_event_open,
 	 */
 	if (!event_file)
 		free_event(event);
-err_cred:
...
index 419fff8eb9e5..50f37d5afb32 100644
--- a/kernel/fork.c
+++ b/kernel/fork.c
...
index baafa1dd9fcc..5d54ff3179b8 100644
