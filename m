...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1532F2996C8
	for <lists+linux-kernel@lfdr.de>; Mon, 26 Oct 2020 20:26:00 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1792996AbgJZTZ5 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 26 Oct 2020 15:25:57 -0400
Received: from mga01.intel.com ([192.55.52.88]:54217 "EHLO mga01.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1784590AbgJZTZ4 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 26 Oct 2020 15:25:56 -0400
IronPort-SDR: /CcG9u3ihjFnNkZ6xGRV6rPdKZmaAX1iFTPUK9Eyy2VTvFpH8rwKOEhbKyiYangG9nOQNkpAv6
 2ADwwmbkK2KQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9786"; a="185705775"
X-IronPort-AV: E=Sophos;i="5.77,420,1596524400"; 
   d="scan'208";a="185705775"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 26 Oct 2020 12:25:55 -0700
IronPort-SDR: t4Mcrdm18uk3nAYYkuIREnz3JqgmthSKqzsZLpne7fx+PXS2RARw2BTOiO2JMzISf/EPmUqv9G
 Whig18L3CDrA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,420,1596524400"; 
   d="scan'208";a="303508487"
Received: from black.fi.intel.com ([10.237.72.28])
  by fmsmga008.fm.intel.com with ESMTP; 26 Oct 2020 12:25:54 -0700
Received: by black.fi.intel.com (Postfix, from userid 1003)
        id C265013C; Mon, 26 Oct 2020 21:25:53 +0200 (EET)
From:   Andy Shevchenko <andriy.shevchenko@linux.intel.com>
To:     Mika Westerberg <mika.westerberg@linux.intel.com>,
        linux-kernel@vger.kernel.org,
        Linus Walleij <linus.walleij@linaro.org>
Cc:     Andy Shevchenko <andriy.shevchenko@linux.intel.com>
Subject: [PATCH v1] pinctrl: intel: Add Intel Alder Lake pin controller support
Date:   Mon, 26 Oct 2020 21:25:52 +0200
Message-Id: <20201026192552.20903-1-andriy.shevchenko@linux.intel.com>
...
index a726dd7e6c6f..0510e62475ab 100644
--- a/drivers/pinctrl/intel/Makefile
+++ b/drivers/pinctrl/intel/Makefile
@@ -9,6 +9,7 @@ obj-$(CONFIG_PINCTRL_LYNXPOINT)		+= pinctrl-lynxpoint.o
