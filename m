...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 494AE2F3AA6
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Jan 2021 20:37:12 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2393046AbhALTcF (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 12 Jan 2021 14:32:05 -0500
Received: from mail.kernel.org ([198.145.29.99]:50168 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2392811AbhALTcD (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 12 Jan 2021 14:32:03 -0500
Received: by mail.kernel.org (Postfix) with ESMTPSA id 066C12311F;
        Tue, 12 Jan 2021 19:31:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=linuxfoundation.org;
        s=korg; t=1610479879;
        bh=UoUR0u1u/YxPiarROYOAaoJFirtn2FJkbb7/isKzyMc=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=AOTx/lBIFdsrif1KbNKodD5L5RGZM707ISJfkNCmPoT0TT/gxvZk5WPqmfqO0OZv+
         lJRRTri8y17ZA/XMedEusycXoRBqtX+/0Ntp/snnjfixgwC26UU0aMj0YQYgAHN1uS
         wf6qPX49OLTdCYIaiw4IN/KoqR3NTLfUxX6gECjg=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 4.19.167
Date:   Tue, 12 Jan 2021 20:32:18 +0100
Message-Id: <1610479938138141@kroah.com>
X-Mailer: git-send-email 2.30.0
In-Reply-To: <1610479938185165@kroah.com>
References: <1610479938185165@kroah.com>
MIME-Version: 1.0
...
index b2c939f289c2..91a82c22a474 100644
--- a/Makefile
+++ b/Makefile
@@ -1,7 +1,7 @@
...
index f0cdf38ed31c..4818aaddd712 100644
...
index a017322dba82..7ffeb37e8f20 100644
...
@@ -1245,6 +1245,7 @@ static int ethoc_probe(struct platform_device *pdev)
...
index e4e43519710d..986292a34f4f 100644
...
index fe0e02e11f29..1a86b016b842 100644
--- a/drivers/net/tun.c
+++ b/drivers/net/tun.c
...
index 1f57a6a2b8a2..e0bbefcbefa1 100644
...
index 61b1eae42ea8..40f478c4d118 100644
...
index d6968b90ee6b..55ee41283f39 100644
...
index 40b3ed93596a..4cfcc73f3979 100644
...
index d582921f7257..425981ab7a4d 100644
...
index 39ebc1b03698..156651df6b4d 100644
...
index 0348ea899d06..a753221c2268 100644
...
+		if (is_waiting_for_rm(sctx, ino, gen)) {
 			...
 			if (ret < 0)
 				goto out;
@@ -2863,8 +2864,8 @@ static int orphanize_inode(struct send_ctx *sctx, u64 ino, u64 gen,
 	return ret;
 }
...
index eef77c82d2e1..cd98ef48345e 100644
...
index ca20efe775ee..a2cae543a285 100644
...
index 115d48049686..6672172a7512 100644
...
index b1441349e151..3b067d5a62ee 100644
...
index 6b9617aee0e6..11bf7ace5ab2 100644
