...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7A1B120F180
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Jun 2020 11:24:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731869AbgF3JYF (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 30 Jun 2020 05:24:05 -0400
Received: from mga14.intel.com ([192.55.52.115]:9073 "EHLO mga14.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727059AbgF3JYB (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 30 Jun 2020 05:24:01 -0400
IronPort-SDR: dLlIumV7x6bQbrudCXH3xmyQfukqy3Z9wAa/Z+fX71fRZzPqwy4SsdwWL1wolnoJDZmnMEKIYI
 0bsqzl7LsmBA==
X-IronPort-AV: E=McAfee;i="6000,8403,9666"; a="145256866"
X-IronPort-AV: E=Sophos;i="5.75,297,1589266800"; 
   d="yaml'?scan'208";a="145256866"
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 30 Jun 2020 02:23:43 -0700
IronPort-SDR: Jk58YOjoEY65/Ptb5aaQCLmK2cv5z01iseB6EIwqDajNpr3DXDuoA5/lG3b0D8GxFUlQ/hahWD
 eVVLQogMCwzg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,297,1589266800"; 
   d="yaml'?scan'208";a="481114792"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.3])
  by fmsmga005.fm.intel.com with ESMTP; 30 Jun 2020 02:23:40 -0700
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="5AMDinkw1evBROKu"
...
Content-Disposition: attachment; filename="config-5.7.0-00916-g16accae3d97f9"
...
export_top_env()
{
	...
	export runtime=300
	export nr_task=57
	export job_origin='/lkp-src/allot/cyclic:p1:linux-devel:devel-hourly/lkp-csl-2ap2/unixbench.yaml'
...
queue_at_least_once'
	...
	export submit_id='5efa97e2842a6332f33e5c09'
	export job_file='/lkp/jobs/scheduled/lkp-csl-2ap2/unixbench-performance-30%-300s-context1-ucode=0x5002f01-debian-x86_64-20191114.cgz-16accae3d97f97d7f61c4ee5d0002bccdef59088-20200630-13043-1ra3dno-3.yaml'
	export id='3172be6d0baf859a35794541baf724e189d46897'
	...
	export commit='16accae3d97f97d7f61c4ee5d0002bccdef59088'
	export need_kconfig_hw='CONFIG_IGB=y
CONFIG_BLK_DEV_NVME'
	export ucode='0x5002f01'
	export enqueue_time='2020-06-30 09:39:47 +0800'
	export _id='5efa97e7842a6332f33e5c0a'
	export _rt='/result/unixbench/performance-30%-300s-context1-ucode=0x5002f01/lkp-csl-2ap2/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-9/16accae3d97f97d7f61c4ee5d0002bccdef59088'
	export user='lkp'
	...
	export result_root='/result/unixbench/performance-30%-300s-context1-ucode=0x5002f01/lkp-csl-2ap2/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-9/16accae3d97f97d7f61c4ee5d0002bccdef59088/3'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-csl-2ap2/unixbench-performance-30%-300s-context1-ucode=0x5002f01-debian-x86_64-20191114.cgz-16accae3d97f97d7f61c4ee5d0002bccdef59088-20200630-13043-1ra3dno-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-7.6
branch=linux-devel/devel-hourly-2020062917
commit=16accae3d97f97d7f61c4ee5d0002bccdef59088
BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-9/16accae3d97f97d7f61c4ee5d0002bccdef59088/vmlinuz-5.7.0-00916-g16accae3d97f9
acpi_rsdp=0x67f44014
max_uptime=1500
RESULT_ROOT=/result/unixbench/performance-30%-300s-context1-ucode=0x5002f01/lkp-csl-2ap2/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-9/16accae3d97f97d7f61c4ee5d0002bccdef59088/3
LKP_SERVER=inn
nokaslr
selinux=0
debug
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-7.6/gcc-9/16accae3d97f97d7f61c4ee5d0002bccdef59088/modules.cgz'
	...
	export last_kernel='5.8.0-rc3-04072-g0f6f2b1fe9f21'
	export repeat_to=4
	export schedule_notify_address=
	export queue_at_least_once=1
	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-9/16accae3d97f97d7f61c4ee5d0002bccdef59088/vmlinuz-5.7.0-00916-g16accae3d97f9'
	export dequeue_time='2020-06-30 09:52:41 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2ap2/unixbench-performance-30%-300s-context1-ucode=0x5002f01-debian-x86_64-20191114.cgz-16accae3d97f97d7f61c4ee5d0002bccdef59088-20200630-13043-1ra3dno-3.cgz'
...
unixbench:
  test: context1
job_origin: "/lkp-src/allot/cyclic:p1:linux-devel:devel-hourly/lkp-csl-2ap2/unixbench.yaml"
...
kconfig: x86_64-rhel-7.6
submit_id: 5efa6de9842a632e984a179d
job_file: "/lkp/jobs/scheduled/lkp-csl-2ap2/unixbench-performance-30%-300s-context1-ucode=0x5002f01-debian-x86_64-20191114.cgz-16accae3d97f97d7f61c4ee5d0002bccdef59088-20200630-11928-1p4qh6z-0.yaml"
id: '0266482a03f0cb135eec57a5726942766585476e'
...
- CONFIG_BLK_DEV_NVME
ucode: '0x5002f01'
enqueue_time: 2020-06-30 06:40:41.988425418 +08:00
_id: 5efa6de9842a632e984a179d
_rt: "/result/unixbench/performance-30%-300s-context1-ucode=0x5002f01/lkp-csl-2ap2/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-9/16accae3d97f97d7f61c4ee5d0002bccdef59088"
...
result_root: "/result/unixbench/performance-30%-300s-context1-ucode=0x5002f01/lkp-csl-2ap2/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-9/16accae3d97f97d7f61c4ee5d0002bccdef59088/0"
scheduler_version: "/lkp/lkp/.src-20200629-154619"
LKP_SERVER: inn
arch: x86_64
max_uptime: 1500
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-csl-2ap2/unixbench-performance-30%-300s-context1-ucode=0x5002f01-debian-x86_64-20191114.cgz-16accae3d97f97d7f61c4ee5d0002bccdef59088-20200630-11928-1p4qh6z-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2020062917
- commit=16accae3d97f97d7f61c4ee5d0002bccdef59088
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-9/16accae3d97f97d7f61c4ee5d0002bccdef59088/modules.cgz"
...
#! runtime status
last_kernel: 5.8.0-rc3
repeat_to: 2
schedule_notify_address: 

#! user overrides
queue_at_least_once: 0
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-9/16accae3d97f97d7f61c4ee5d0002bccdef59088/vmlinuz-5.7.0-00916-g16accae3d97f9"
dequeue_time: 2020-06-30 06:43:51.678730479 +08:00
job_state: finished
loadavg: 69.03 61.97 30.65 1/1300 22141
start_time: '1593470693'
end_time: '1593471084'
version: "/lkp/lkp/.src-20200629-154655:46a32c45:9b90d48ed"
