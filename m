...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5979029A4B2
	for <lists+linux-kernel@lfdr.de>; Tue, 27 Oct 2020 07:33:55 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2506767AbgJ0GdG (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 27 Oct 2020 02:33:06 -0400
Received: from mga12.intel.com ([192.55.52.136]:9330 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2506759AbgJ0GdE (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 27 Oct 2020 02:33:04 -0400
IronPort-SDR: 9251p9z0EoJyT5Tb6UfOJ+/vnnzLG70R5jCumX2JTm2HaWWKG6XJmw3z9NzG69SyDpdlhM9ne1
 qiZJUu5IH2aw==
X-IronPort-AV: E=McAfee;i="6000,8403,9786"; a="147317863"
X-IronPort-AV: E=Sophos;i="5.77,422,1596524400"; 
   d="scan'208";a="147317863"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 26 Oct 2020 23:33:03 -0700
IronPort-SDR: h03juRq+nL3ikTWPxIVyl7QUWPAaSSyMSCH9QEpA/Bfb3QTdbclnx/6xNCdaoDC44LJtT+gRne
 ei0pNdvD2Bcw==
X-IronPort-AV: E=Sophos;i="5.77,422,1596524400"; 
   d="scan'208";a="535666715"
Received: from lzhengha-mobl.ccr.corp.intel.com (HELO yhuang-mobile.ccr.corp.intel.com) ([10.254.213.46])
  by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 26 Oct 2020 23:33:00 -0700
...
Subject: [RFC -V4 3/6] autonuma, memory tiering: Hot page selection with hint page fault latency
Date:   Tue, 27 Oct 2020 14:32:14 +0800
Message-Id: <20201027063217.211096-4-ying.huang@intel.com>
...
@@ -1338,6 +1350,16 @@ static inline int page_cpupid_xchg_last(struct page *page, int cpupid)
...
@@ -1353,6 +1375,7 @@ static inline int page_cpupid_last(struct page *page)
 }
...
+extern unsigned int xchg_page_access_time(struct page *page, unsigned int time);
 ...
 {
@@ -1365,6 +1388,12 @@ static inline int page_cpupid_xchg_last(struct page *page, int cpupid)
...
index 1a68a0536add..fafb312c1b24 100644
...
@@ -2634,6 +2689,11 @@ void task_numa_fault(int last_cpupid, int mem_node, int pages, int flags)
 	if (!p->mm)
 		return;
...
@@ -2653,6 +2713,13 @@ void task_numa_fault(int last_cpupid, int mem_node, int pages, int flags)
 	 */
...
index a8c2ddd0cc4a..4e46d838257d 100644
--- a/mm/huge_memory.c
+++ b/mm/huge_memory.c
@@ -1379,7 +1379,7 @@ vm_fault_t do_huge_pmd_numa_page(struct vm_fault *vmf, pmd_t pmd)
 	struct page *page;
...
+	int target_nid, last_cpupid = (-1 & LAST_CPUPID_MASK);
 	...
 	bool migrated = false;
 	bool was_writable;
@@ -1406,7 +1406,8 @@ vm_fault_t do_huge_pmd_numa_page(struct vm_fault *vmf, pmd_t pmd)
 	page = pmd_page(pmd);
...
@@ -1798,6 +1799,7 @@ int change_huge_pmd(struct vm_area_struct *vma, pmd_t *pmd,
...
@@ -1810,13 +1812,18 @@ int change_huge_pmd(struct vm_area_struct *vma, pmd_t *pmd,
 			goto unlock;
...
index 469af373ae76..84c5383fae51 100644
--- a/mm/memory.c
+++ b/mm/memory.c
@@ -74,6 +74,7 @@
...
@@ -4063,8 +4064,16 @@ static vm_fault_t do_numa_page(struct vm_fault *vmf)
...
index 2079a69b40ed..d8d80b111a6a 100644
--- a/mm/migrate.c
+++ b/mm/migrate.c
