...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E59AE27F75D
	for <lists+linux-kernel@lfdr.de>; Thu,  1 Oct 2020 03:28:54 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730310AbgJAB2u (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 30 Sep 2020 21:28:50 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50798 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1730260AbgJAB2o (ORCPT
...
Received: from mail-ua1-x963.google.com (mail-ua1-x963.google.com [IPv6:2607:f8b0:4864:20::963])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E7A16C061755
        for <linux-kernel@vger.kernel.org>; Wed, 30 Sep 2020 18:28:43 -0700 (PDT)
Received: by mail-ua1-x963.google.com with SMTP id o64so1007937uao.1
        for <linux-kernel@vger.kernel.org>; Wed, 30 Sep 2020 18:28:43 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=37W7v3W9Y+Wmk3buYhSK0das6Hh790L2Q+R16QEpwEc=;
        b=e+0fpVZQNy5h9tHw1T5QzVc0IVWrplOTnrnJiNKkrSeLHniJumgUVpUHiSNWxJstVp
         lppUQdjaNK8VF1L5P92MdjeHL9ue8P7N/zvGTdwaK7L2JOz4VobLLsdxVSC2gagappxy
         ++tBnhESnu7QDLC7o9FlmfLlBRInFAFkG7IQQ=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=37W7v3W9Y+Wmk3buYhSK0das6Hh790L2Q+R16QEpwEc=;
        b=
X-Gm-Message-State: AOAM533MkKvwjONiW52RiCGbdub1usSlKgZ5651SmFk2qgpOJOcZUqru
        Z/3UmeoCR1h/zyoQtiez1e/p9AJNvR+4r4Eg94F8nCtQVnlQ
X-Google-Smtp-Source: ABdhPJycBFBdETugJdNt5X57M1SXXxPWwRoWSkwwOqI3jIp2nZC7CV54G1HbAzhF+Ka921ExMXGaWC3AuZ4e
X-Received: by 2002:ab0:5ac1:: with SMTP id x1mr3385701uae.20.1601515723026;
        Wed, 30 Sep 2020 18:28:43 -0700 (PDT)
Received: from lbrmn-lnxub113.broadcom.net ([192.19.228.250])
        by smtp-relay.gmail.com with ESMTPS id r25sm520472vkq.14.2020.09.30.18.28.41
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 30 Sep 2020 18:28:42 -0700 (PDT)
...
Subject: [PATCH v5 03/15] misc: bcm-vk: add autoload support
Date:   Wed, 30 Sep 2020 18:27:58 -0700
Message-Id: <20201001012810.4172-4-scott.branden@broadcom.com>
...
index f52ac59fe967..50a65f6f290b 100644
...
+
 	...
 	pci_dev_put(pdev);
@@ -109,6 +778,22 @@ static void bcm_vk_remove(struct pci_dev *pdev)
 	int i;
...
@@ -119,6 +804,38 @@ static void bcm_vk_remove(struct pci_dev *pdev)
 	pci_disable_device(pdev);
 }
...
@@ -131,6 +848,7 @@ static struct pci_driver pci_driver = {
 	.id_table = bcm_vk_ids,
 	.probe    = bcm_vk_probe,
