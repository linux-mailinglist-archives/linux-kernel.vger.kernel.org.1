...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 42B29231B9A
	for <lists+linux-kernel@lfdr.de>; Wed, 29 Jul 2020 10:52:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728000AbgG2Iw2 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 29 Jul 2020 04:52:28 -0400
Received: from mail.kernel.org ([198.145.29.99]:51764 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726737AbgG2Iw1 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 29 Jul 2020 04:52:27 -0400
Received: from localhost (83-86-89-107.cable.dynamic.v4.ziggo.nl [83.86.89.107])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 339EC2075D;
        Wed, 29 Jul 2020 08:52:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1596012744;
        bh=eTpqm7CCEVwknT0bvXDSwNuPBRVZT7AHQ7S7xXMZFd0=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=MLuKZcSg2nGWevW26xLaV/lRHvJl610zrfyj/4BXdBjCDCyS8Jq7NS30CLFdv/2bN
         h/n/PVzWT09q1eoc1ISOpYbne4ihDgCxULTw3YVBeVhizlGXCtr0FxGzNx1mz4FrT3
         gM0abHwe+pLFrOT9Trt/dOofdRb1HXHnb0y23p6E=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 4.14.190
Date:   Wed, 29 Jul 2020 10:52:05 +0200
Message-Id: <15960127237363@kroah.com>
X-Mailer: git-send-email 2.27.0
In-Reply-To: <1596012723217164@kroah.com>
References: <1596012723217164@kroah.com>
MIME-Version: 1.0
...
@@ -883,6 +897,8 @@ static int ath9k_hif_usb_alloc_rx_urbs(struct hif_device_usb *hif_dev)
 err_skb:
 	usb_free_urb(urb);
 err_urb:
+	kfree(rx_buf);
...
@@ -946,6 +972,8 @@ static int ath9k_hif_usb_alloc_reg_in_urbs(struct hif_device_usb *hif_dev)
 err_skb:
 	usb_free_urb(urb);
 err_urb:
+	kfree(rx_buf);
