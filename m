...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C71AC2A6D05
	for <lists+linux-kernel@lfdr.de>; Wed,  4 Nov 2020 19:43:52 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730737AbgKDSnj (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 4 Nov 2020 13:43:39 -0500
Received: from foss.arm.com ([217.140.110.172]:42010 "EHLO foss.arm.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726737AbgKDSnj (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 4 Nov 2020 13:43:39 -0500
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id A5A3C14BF;
        Wed,  4 Nov 2020 10:43:37 -0800 (PST)
Received: from [10.57.54.223] (unknown [10.57.54.223])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 6E0BE3F718;
        Wed,  4 Nov 2020 10:43:36 -0800 (PST)
Subject: Re: [PATCH v5] driver/perf: Add PMU driver for the ARM DMC-620 memory
 controller
...
Message-ID: <c0c429ce-597e-9613-6e72-306dd1d58278@arm.com>
Date:   Wed, 4 Nov 2020 18:43:35 +0000
...
On 2020-10-29 21:29, Tuan Phan wrote:
...
Oops, 64BIT snuck in anyway... You don't need this - I tried a 32-bit 
build with W=1 and it's completely clean, so you've definitely fixed the 
previous issues.
...
Seems I managed to overlook this so far (thanks LKP!) - you're not doing 
anything involved with the CPU PMU framework, so drop this include.

Beyond that, the rest of the diff from v4 looks OK to me. Good catch on 
