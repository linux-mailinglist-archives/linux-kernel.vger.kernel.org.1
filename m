...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A34321C8757
	for <lists+linux-kernel@lfdr.de>; Thu,  7 May 2020 12:54:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726268AbgEGKyb (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 7 May 2020 06:54:31 -0400
Received: from mga04.intel.com ([192.55.52.120]:32445 "EHLO mga04.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725985AbgEGKy3 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 7 May 2020 06:54:29 -0400
IronPort-SDR: 9RbD7M5TUK0AMJYsydrPIC5pkH3Tj6JxMndrcMnHiGGHK3eUm98C4bZzINtMWKWy+v0IhUZ/EV
 pXMSr2TsF9LA==
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 07 May 2020 03:54:21 -0700
IronPort-SDR: LHhgDTZ58Z8auwJM4W+IBq36u8WEtgDqL7PXsqZsxBFHuF7lrOGpK/rQBblKjJPeWOK3Mbgx39
 BunNtMe6dD8w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,363,1583222400"; 
   d="yaml'?scan'208";a="295686801"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.3])
  by fmsmga002.fm.intel.com with ESMTP; 07 May 2020 03:54:18 -0700
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="qse+WBH4guesipZ+"
...
Content-Disposition: attachment; filename="config-5.7.0-rc1-00025-g9266baf8eea588"
...
export_top_env()
{
	...
	export job_origin='/lkp/lkp/.src-20200430-230534/allot/cyclic:p1:linux-devel:devel-hourly/lkp-cfl-e1/vm-scalability-hugetlb.yaml'
...
queue_at_least_once'
	...
	export submit_id='5eb2d24bad616e57fd793d0f'
	export job_file='/lkp/jobs/scheduled/lkp-cfl-e1/vm-scalability-performance-300s-8T-anon-w-seq-hugetlb-ucode=0xca-debian-x86_64-20191114.cgz-9266baf8eea588a78e5a0aa4ccd6cae36ff7-20200506-88061-1i83v75-3.yaml'
	export id='bdc20bc367773511ebca92987c04976cd86a4cf0'
	...
	export commit='9266baf8eea588a78e5a0aa4ccd6cae36ff7349d'
	export ucode='0xca'
	export need_kconfig_hw='CONFIG_IGB=y
CONFIG_SATA_AHCI'
	export kconfig='x86_64-rhel-7.6'
	export compiler='gcc-7'
	export enqueue_time='2020-05-06 23:05:50 +0800'
	export _id='5eb2d24ead616e57fd793d10'
	export _rt='/result/vm-scalability/performance-300s-8T-anon-w-seq-hugetlb-ucode=0xca/lkp-cfl-e1/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/9266baf8eea588a78e5a0aa4ccd6cae36ff7349d'
	export user='lkp'
	...
	export result_root='/result/vm-scalability/performance-300s-8T-anon-w-seq-hugetlb-ucode=0xca/lkp-cfl-e1/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/9266baf8eea588a78e5a0aa4ccd6cae36ff7349d/3'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-cfl-e1/vm-scalability-performance-300s-8T-anon-w-seq-hugetlb-ucode=0xca-debian-x86_64-20191114.cgz-9266baf8eea588a78e5a0aa4ccd6cae36ff7-20200506-88061-1i83v75-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-7.6
branch=linux-devel/devel-hourly-2020050301
commit=9266baf8eea588a78e5a0aa4ccd6cae36ff7349d
BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/9266baf8eea588a78e5a0aa4ccd6cae36ff7349d/vmlinuz-5.7.0-rc1-00025-g9266baf8eea588
max_uptime=1500
RESULT_ROOT=/result/vm-scalability/performance-300s-8T-anon-w-seq-hugetlb-ucode=0xca/lkp-cfl-e1/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/9266baf8eea588a78e5a0aa4ccd6cae36ff7349d/3
LKP_SERVER=inn
nokaslr
selinux=0
debug
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-7.6/gcc-7/9266baf8eea588a78e5a0aa4ccd6cae36ff7349d/modules.cgz'
	...
	export last_kernel='5.7.0-rc3'
	export repeat_to=4
	export schedule_notify_address=
	export queue_at_least_once=1
	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-7/9266baf8eea588a78e5a0aa4ccd6cae36ff7349d/vmlinuz-5.7.0-rc1-00025-g9266baf8eea588'
	export dequeue_time='2020-05-06 23:18:39 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-cfl-e1/vm-scalability-performance-300s-8T-anon-w-seq-hugetlb-ucode=0xca-debian-x86_64-20191114.cgz-9266baf8eea588a78e5a0aa4ccd6cae36ff7-20200506-88061-1i83v75-3.cgz'
...
vm-scalability:
  test: anon-w-seq-hugetlb
job_origin: "/lkp/lkp/.src-20200430-230534/allot/cyclic:p1:linux-devel:devel-hourly/lkp-cfl-e1/vm-scalability-hugetlb.yaml"
...
submit_id: 5eb2bd8aad616e558476c9ff
job_file: "/lkp/jobs/scheduled/lkp-cfl-e1/vm-scalability-performance-300s-8T-anon-w-seq-hugetlb-ucode=0xca-debian-x86_64-20191114.cgz-9266baf8eea588a78e5a0aa4ccd6cae36ff7-20200506-87428-x5ypsx-0.yaml"
id: 28a0db2e04f047c986671a39a2a05d29084005bb
...
kconfig: x86_64-rhel-7.6
compiler: gcc-7
enqueue_time: 2020-05-06 21:37:17.520922234 +08:00
_id: 5eb2bd8aad616e558476c9ff
_rt: "/result/vm-scalability/performance-300s-8T-anon-w-seq-hugetlb-ucode=0xca/lkp-cfl-e1/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/9266baf8eea588a78e5a0aa4ccd6cae36ff7349d"

#! schedule options
user: lkp
head_commit: e3288a7d4843ced220673bc2662c95000adb2b37
base_commit: 6a8b55ed4056ea5559ebe4f6a4b247f627870d4c
branch: linux-devel/devel-hourly-2020050301
rootfs: debian-x86_64-20191114.cgz
result_root: "/result/vm-scalability/performance-300s-8T-anon-w-seq-hugetlb-ucode=0xca/lkp-cfl-e1/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/9266baf8eea588a78e5a0aa4ccd6cae36ff7349d/0"
scheduler_version: "/lkp/lkp/.src-20200506-145547"
LKP_SERVER: inn
arch: x86_64
max_uptime: 1500
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-cfl-e1/vm-scalability-performance-300s-8T-anon-w-seq-hugetlb-ucode=0xca-debian-x86_64-20191114.cgz-9266baf8eea588a78e5a0aa4ccd6cae36ff7-20200506-87428-x5ypsx-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2020050301
- commit=9266baf8eea588a78e5a0aa4ccd6cae36ff7349d
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/9266baf8eea588a78e5a0aa4ccd6cae36ff7349d/modules.cgz"
...
#! /lkp/lkp/.src-20200505-191844/include/site/inn
LKP_CGI_PORT: 80
LKP_CIFS_PORT: 139
oom-killer: 
watchdog: 
...
#! runtime status
last_kernel: 5.7.0-rc3
repeat_to: 2
schedule_notify_address: 

#! user overrides
queue_at_least_once: 0
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/9266baf8eea588a78e5a0aa4ccd6cae36ff7349d/vmlinuz-5.7.0-rc1-00025-g9266baf8eea588"
dequeue_time: 2020-05-06 21:40:36.105316655 +08:00

#! /lkp/lkp/.src-20200506-145547/include/site/inn
job_state: finished
loadavg: 13.68 10.21 4.60 1/248 9848
start_time: '1588772498'
end_time: '1588772799'
version: "/lkp/lkp/.src-20200506-145618:0040de30:e75578eff"
...
cd /lkp/benchmarks/vm-scalability
 ...
 ./usemem --runtime 300 -n 16 -O -U 1050313600
 ./case-anon-w-seq-hugetlb
 ./usemem --runtime 300 -n 16 -O -U 1050313600
 ./case-anon-w-seq-hugetlb
 ./usemem --runtime 300 -n 16 -O -U 1050313600
