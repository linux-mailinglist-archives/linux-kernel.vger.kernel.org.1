...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 801342A8132
	for <lists+linux-kernel@lfdr.de>; Thu,  5 Nov 2020 15:45:15 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731173AbgKEOo7 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 5 Nov 2020 09:44:59 -0500
Received: from esa4.microchip.iphmx.com ([68.232.154.123]:60481 "EHLO
        esa4.microchip.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1731044AbgKEOo4 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 5 Nov 2020 09:44:56 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1604587491; x=1636123491;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=GDVOglmRRaHFxVijVFDrgMhMvGV0f4UuAj0U1EBEOAE=;
  b=xxD+EtxQexL/6krMy9tQ5+UY9QkEczbrsQ0scyUeSC8hJ1LvnMyNOBih
   3STAvJvoS0m2oPnQh4wLLfL2RbmfjMZjXjKy8EOmqv7hMgmp3GvsmVOcg
   XRmEynm0Two1vuj3Qrfmu61Qk/zna5EwjgMObQSg7x2lCdRDoU/vdF5QB
   X4KH6NgrzdtCGGUhqz/cmrGqgnR+adaNe7NGJBwsxjf31SUYTWVC5ulGd
   kLj8RKdHx4jaShjlAxIUHuxO0xGt/QsiVVnscUUMwuqBfL3EtWQpQWhPy
   vh1MurYQWLxy7Ljem5/Q8INjOiYqtyWiUQpgH6iTq2/33OOyH4nVaPRXS
   w==;
IronPort-SDR: 
X-IronPort-AV: E=Sophos;i="5.77,453,1596524400"; 
   d="scan'208";a="92620333"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa4.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 05 Nov 2020 07:44:50 -0700
Received: from chn-vm-ex02.mchp-main.com (10.10.85.144) by
 chn-vm-ex03.mchp-main.com (10.10.85.151) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1979.3; Thu, 5 Nov 2020 07:44:50 -0700
Received: from mchp-dev-shegelun.microchip.com (10.10.115.15) by
 chn-vm-ex02.mchp-main.com (10.10.85.144) with Microsoft SMTP Server id
 15.1.1979.3 via Frontend Transport; Thu, 5 Nov 2020 07:44:47 -0700
...
Subject: [PATCH v1 3/4] phy: Add Sparx5 ethernet serdes PHY driver
Date:   Thu, 5 Nov 2020 15:44:28 +0100
Message-ID: <20201105144429.2438358-4-steen.hegelund@microchip.com>
...
---
 ...
 6 files changed, 5261 insertions(+)
...
new file mode 100644
index 000000000000..1add4d8b87d8
--- /dev/null
...
+};
+
+struct sparx5_sd25g28_media_preset media_presets_25g[] = {
+	{ /* ETH_MEDIA_DEFAULT */
+		.cfg_en_adv               = 0,
+		.cfg_en_main              = 1,
+		.cfg_en_dly               = 0,
...
+};
+
+struct sparx5_sd25g28_mode_preset mode_presets_25g[] = {
+	{ /* SPX5_SD25G28_MODE_PRESET_25000 */
+		.bitwidth           = 40,
+		.tx_pre_div         = 0,
+		.fifo_ck_div        = 0,
...
+};
+
+struct sparx5_sd10g28_media_preset media_presets_10g[] = {
+	{ /* ETH_MEDIA_DEFAULT */
+		.cfg_en_adv               = 0,
+		.cfg_en_main              = 1,
+		.cfg_en_dly               = 0,
...
+};
+
+struct sparx5_sd10g28_mode_preset mode_presets_10g[] = {
+	{ /* SPX5_SD10G28_MODE_PRESET_10000 */
+		.bwidth           = 64,
...
+		u32 freq = macro->coreclock == 250 ? 2 : macro->coreclock == 500 ? 1 : 0;
+
...
+	macro->coreclock = opts->eth_serdes.clk;
+
...
+	{ TARGET_SD_CMU, "sd_cmu_0" },
+	{ TARGET_SD_CMU + 1, "sd_cmu_1" },
+	{ TARGET_SD_CMU + 2, "sd_cmu_2" },
+	{ TARGET_SD_CMU + 3, "sd_cmu_3" },
+	{ TARGET_SD_CMU + 4, "sd_cmu_4" },
+	{ TARGET_SD_CMU + 5, "sd_cmu_5" },
+	{ TARGET_SD_CMU + 6, "sd_cmu_6" },
+	{ TARGET_SD_CMU + 7, "sd_cmu_7" },
+	{ TARGET_SD_CMU + 8, "sd_cmu_8" },
+	{ TARGET_SD_CMU_CFG, "sd_cmu_cfg_0" },
+	{ TARGET_SD_CMU_CFG + 1, "sd_cmu_cfg_1" },
+	{ TARGET_SD_CMU_CFG + 2, "sd_cmu_cfg_2" },
+	{ TARGET_SD_CMU_CFG + 3, "sd_cmu_cfg_3" },
+	{ TARGET_SD_CMU_CFG + 4, "sd_cmu_cfg_4" },
+	{ TARGET_SD_CMU_CFG + 5, "sd_cmu_cfg_5" },
+	{ TARGET_SD_CMU_CFG + 6, "sd_cmu_cfg_6" },
+	{ TARGET_SD_CMU_CFG + 7, "sd_cmu_cfg_7" },
+	{ TARGET_SD_CMU_CFG + 8, "sd_cmu_cfg_8" },
+	{ TARGET_SD6G_LANE, "sd6g_lane_0" },
+	{ TARGET_SD6G_LANE + 1, "sd6g_lane_1" },
+	{ TARGET_SD6G_LANE + 2, "sd6g_lane_2" },
+	{ TARGET_SD6G_LANE + 3, "sd6g_lane_3" },
+	{ TARGET_SD6G_LANE + 4, "sd6g_lane_4" },
+	{ TARGET_SD6G_LANE + 5, "sd6g_lane_5" },
+	{ TARGET_SD6G_LANE + 6, "sd6g_lane_6" },
+	{ TARGET_SD6G_LANE + 7, "sd6g_lane_7" },
+	{ TARGET_SD6G_LANE + 8, "sd6g_lane_8" },
+	{ TARGET_SD6G_LANE + 9, "sd6g_lane_9" },
+	{ TARGET_SD6G_LANE + 10, "sd6g_lane_10" },
+	{ TARGET_SD6G_LANE + 11, "sd6g_lane_11" },
+	{ TARGET_SD6G_LANE + 12, "sd6g_lane_12" },
+	{ TARGET_SD10G_LANE, "sd10g_lane_0" },
+	{ TARGET_SD10G_LANE + 1, "sd10g_lane_1" },
+	{ TARGET_SD10G_LANE + 2, "sd10g_lane_2" },
+	{ TARGET_SD10G_LANE + 3, "sd10g_lane_3" },
+	{ TARGET_SD_LANE, "sd_lane_0" },
+	{ TARGET_SD_LANE + 1, "sd_lane_1" },
+	{ TARGET_SD_LANE + 2, "sd_lane_2" },
+	{ TARGET_SD_LANE + 3, "sd_lane_3" },
+	{ TARGET_SD_LANE + 4, "sd_lane_4" },
+	{ TARGET_SD_LANE + 5, "sd_lane_5" },
+	{ TARGET_SD_LANE + 6, "sd_lane_6" },
+	{ TARGET_SD_LANE + 7, "sd_lane_7" },
+	{ TARGET_SD_LANE + 8, "sd_lane_8" },
+	{ TARGET_SD_LANE + 9, "sd_lane_9" },
+	{ TARGET_SD_LANE + 10, "sd_lane_10" },
+	{ TARGET_SD_LANE + 11, "sd_lane_11" },
+	{ TARGET_SD_LANE + 12, "sd_lane_12" },
+	{ TARGET_SD_LANE + 13, "sd_lane_13" },
+	{ TARGET_SD_LANE + 14, "sd_lane_14" },
+	{ TARGET_SD_LANE + 15, "sd_lane_15" },
+	{ TARGET_SD_LANE + 16, "sd_lane_16" },
+	{ TARGET_SD_CMU + 9, "sd_cmu_9" },
+	{ TARGET_SD_CMU + 10, "sd_cmu_10" },
+	{ TARGET_SD_CMU + 11, "sd_cmu_11" },
+	{ TARGET_SD_CMU + 12, "sd_cmu_12" },
+	{ TARGET_SD_CMU + 13, "sd_cmu_13" },
+	{ TARGET_SD_CMU_CFG + 9, "sd_cmu_cfg_9" },
+	{ TARGET_SD_CMU_CFG + 10, "sd_cmu_cfg_10" },
+	{ TARGET_SD_CMU_CFG + 11, "sd_cmu_cfg_11" },
+	{ TARGET_SD_CMU_CFG + 12, "sd_cmu_cfg_12" },
+	{ TARGET_SD_CMU_CFG + 13, "sd_cmu_cfg_13" },
+	{ TARGET_SD10G_LANE + 4, "sd10g_lane_4" },
+	{ TARGET_SD10G_LANE + 5, "sd10g_lane_5" },
+	{ TARGET_SD10G_LANE + 6, "sd10g_lane_6" },
+	{ TARGET_SD10G_LANE + 7, "sd10g_lane_7" },
+	{ TARGET_SD10G_LANE + 8, "sd10g_lane_8" },
+	{ TARGET_SD10G_LANE + 9, "sd10g_lane_9" },
+	{ TARGET_SD10G_LANE + 10, "sd10g_lane_10" },
+	{ TARGET_SD10G_LANE + 11, "sd10g_lane_11" },
+	{ TARGET_SD25G_LANE, "sd25g_lane_0" },
+	{ TARGET_SD25G_LANE + 1, "sd25g_lane_1" },
+	{ TARGET_SD25G_LANE + 2, "sd25g_lane_2" },
+	{ TARGET_SD25G_LANE + 3, "sd25g_lane_3" },
+	{ TARGET_SD25G_LANE + 4, "sd25g_lane_4" },
+	{ TARGET_SD25G_LANE + 5, "sd25g_lane_5" },
+	{ TARGET_SD25G_LANE + 6, "sd25g_lane_6" },
+	{ TARGET_SD25G_LANE + 7, "sd25g_lane_7" },
+	{ TARGET_SD_LANE + 17, "sd_lane_17" },
+	{ TARGET_SD_LANE + 18, "sd_lane_18" },
+	{ TARGET_SD_LANE + 19, "sd_lane_19" },
+	{ TARGET_SD_LANE + 20, "sd_lane_20" },
+	{ TARGET_SD_LANE + 21, "sd_lane_21" },
+	{ TARGET_SD_LANE + 22, "sd_lane_22" },
+	{ TARGET_SD_LANE + 23, "sd_lane_23" },
+	{ TARGET_SD_LANE + 24, "sd_lane_24" },
+	{ TARGET_SD_LANE_25G, "sd_lane_25g_25" },
+	{ TARGET_SD_LANE_25G + 1, "sd_lane_25g_26" },
+	{ TARGET_SD_LANE_25G + 2, "sd_lane_25g_27" },
+	{ TARGET_SD_LANE_25G + 3, "sd_lane_25g_28" },
+	{ TARGET_SD_LANE_25G + 4, "sd_lane_25g_29" },
+	{ TARGET_SD_LANE_25G + 5, "sd_lane_25g_30" },
+	{ TARGET_SD_LANE_25G + 6, "sd_lane_25g_31" },
+	{ TARGET_SD_LANE_25G + 7, "sd_lane_25g_32" },
+};
+
...
+		if (!resource) {
+			dev_err(priv->dev,
+				"Unable to get serdes registers: %s\n",
+				sparx5_serdes_iomap[idx].name);
+			return -ENODEV;
+		}
+
+		priv->regs[sparx5_serdes_iomap[idx].id] =
+			devm_ioremap(priv->dev,
+				     resource->start,
+				     resource->end -
+				     resource->start + 1);
+		if (IS_ERR(priv->regs[sparx5_serdes_iomap[idx].id])) {
+			dev_err(&pdev->dev,
+				"Unable to map serdes registers: %s\n",
+				sparx5_serdes_iomap[idx].name);
+			return PTR_ERR(priv->regs[sparx5_serdes_iomap[idx].id]);
+		}
+	}
+	for (idx = 0; idx < SPX5_SERDES_MAX; idx++) {
...
new file mode 100644
index 000000000000..0fc35d58cc80
--- /dev/null
...
+ */
+
+/* This file is autogenerated by cml-utils 2020-11-03 15:18:10 +0100.
+ * Commit ID: 244c3203100988f015ececd59ccd2de69d28c600
+ */
+
...
+}
+
+#define SDX5_RD_(sparx5, id, tinst, tcnt,			\
+		 gbase, ginst, gcnt, gwidth,			\
+		 raddr, rinst, rcnt, rwidth)			\
+	readl(sdx5_addr((sparx5)->regs, id, tinst, tcnt,	\
+			gbase, ginst, gcnt, gwidth,             \
+			raddr, rinst, rcnt, rwidth))
+
+#define SDX5_RMW_(val, mask, sparx5, id, tinst, tcnt,			\
+		  gbase, ginst, gcnt, gwidth,				\
+		  raddr, rinst, rcnt, rwidth)				\
+	do {								\
+		u32 _v_;						\
+		u32 _m_ = mask;						\
+		void __iomem *addr =					\
+			sdx5_addr((sparx5)->regs, id, tinst, tcnt,	\
+				  gbase, ginst, gcnt, gwidth,		\
+				  raddr, rinst, rcnt, rwidth);		\
+		_v_ = readl(addr);					\
+		_v_ = ((_v_ & ~(_m_)) | ((val) & (_m_)));		\
...
+	} while (0)
+
+#define SDX5_INST_RMW_(val, mask, iomem, id, tinst, tcnt,		\
+		       gbase, ginst, gcnt, gwidth,			\
+		       raddr, rinst, rcnt, rwidth)			\
+	do {								\
+		u32 _v_;						\
...
+	} while (0)
+
+#define SDX5_RD(...)  SDX5_RD_(__VA_ARGS__)
+#define SDX5_RMW(...) SDX5_RMW_(__VA_ARGS__)
+#define SDX5_INST_RMW(...) SDX5_INST_RMW_(__VA_ARGS__)
+#define SDX5_INST_GET(sparx5, id, tinst) ((sparx5)->regs[(id) + (tinst)])
+
