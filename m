...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2FA3C1A76E9
	for <lists+linux-kernel@lfdr.de>; Tue, 14 Apr 2020 11:04:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2437354AbgDNJEl (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 14 Apr 2020 05:04:41 -0400
Received: from mga01.intel.com ([192.55.52.88]:52785 "EHLO mga01.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2437118AbgDNJEh (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 14 Apr 2020 05:04:37 -0400
IronPort-SDR: fqdT1kvK1RPjtx/mIJPHDtLF69AWan0xiW6wYnysbLz+PZv/5eAlxZgO56ft9Seno3+9xA0ijx
 pKUzifsW4/Iw==
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 14 Apr 2020 01:59:21 -0700
IronPort-SDR: VA/Df4gjFkybNISzZ6gcaH70fiHvysQfVrWqz6Z11JlWKQJqiBtD7Vee3M7Z5ChjcDt4D7cKta
 YMxfAOdz5/Tw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.72,382,1580803200"; 
   d="yaml'?scan'208";a="332114831"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.3])
  by orsmga001.jf.intel.com with ESMTP; 14 Apr 2020 01:59:18 -0700
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="7QsOHKuLbhbLTwLB"
...
Content-Disposition: attachment; filename="config-5.6.0-rc6-00081-g90c91dfb86d0f"
...
export_top_env()
{
	...
	export media='ssd'
	export job_origin='/lkp/lkp/.src-20200330-144334/allot/cyclic:p2:linux-devel:devel-hourly/lkp-csl-2ap1/fxmark-1ssd.yaml'
...
queue_at_least_once'
	...
	export submit_id='5e95390aa4592635414b5c55'
	export job_file='/lkp/jobs/scheduled/lkp-csl-2ap1/fxmark-performance-directio-1SSD-f2fs-ssd-DRBL-ucode=0x400002c-debian-x86_64-20191114.cgz-90c91dfb86d0ff545bd329d3ddd72c147e2ae1-20200414-13633-153xj49-3.yaml'
	export id='cb291f9131bdfdd87de80933e02564379574d7d1'
	...
	export ssd_partitions='/dev/disk/by-id/nvme-INTEL_SSDPE2KX010T8_BTLJ904508P61P0FGN-part4'
	export rootfs_partition='/dev/disk/by-id/nvme-INTEL_SSDPE2KX010T8_BTLJ904508P61P0FGN-part3'
...
CONFIG_PCI=y
CONFIG_F2FS_FS=m'
	export commit='90c91dfb86d0ff545bd329d3ddd72c147e2ae198'
	export need_kconfig_hw='CONFIG_IGB=y
CONFIG_BLK_DEV_NVME'
	export ucode='0x400002c'
	export kconfig='x86_64-rhel-7.6'
	export compiler='gcc-7'
	export enqueue_time='2020-04-14 12:16:14 +0800'
	export _id='5e95390ea4592635414b5c56'
	export _rt='/result/fxmark/performance-directio-1SSD-f2fs-ssd-DRBL-ucode=0x400002c/lkp-csl-2ap1/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/90c91dfb86d0ff545bd329d3ddd72c147e2ae198'
	export user='lkp'
	export head_commit='803d688020ba2792f5d7e3206362f8f73254998b'
	export base_commit='7111951b8d4973bda27ff663f2cf18b663d15b48'
	export branch='linux-devel/devel-hourly-2020041303'
	export rootfs='debian-x86_64-20191114.cgz'
	export result_root='/result/fxmark/performance-directio-1SSD-f2fs-ssd-DRBL-ucode=0x400002c/lkp-csl-2ap1/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/90c91dfb86d0ff545bd329d3ddd72c147e2ae198/3'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-csl-2ap1/fxmark-performance-directio-1SSD-f2fs-ssd-DRBL-ucode=0x400002c-debian-x86_64-20191114.cgz-90c91dfb86d0ff545bd329d3ddd72c147e2ae1-20200414-13633-153xj49-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-7.6
branch=linux-devel/devel-hourly-2020041303
commit=90c91dfb86d0ff545bd329d3ddd72c147e2ae198
BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/90c91dfb86d0ff545bd329d3ddd72c147e2ae198/vmlinuz-5.6.0-rc6-00081-g90c91dfb86d0f
acpi_rsdp=0x68005014
max_uptime=3600
RESULT_ROOT=/result/fxmark/performance-directio-1SSD-f2fs-ssd-DRBL-ucode=0x400002c/lkp-csl-2ap1/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/90c91dfb86d0ff545bd329d3ddd72c147e2ae198/3
LKP_SERVER=inn
nokaslr
selinux=0
debug
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-7.6/gcc-7/90c91dfb86d0ff545bd329d3ddd72c147e2ae198/modules.cgz'
	export bm_initrd='/osimage/deps/debian-x86_64-20180403.cgz/run-ipconfig_2018-04-03.cgz,/osimage/deps/debian-x86_64-20180403.cgz/lkp_2019-08-05.cgz,/osimage/deps/debian-x86_64-20180403.cgz/rsync-rootfs_2018-04-03.cgz,/osimage/deps/debian-x86_64-20180403.cgz/fxmark_20200319.cgz,/osimage/pkg/debian-x86_64-20180403.cgz/fxmark-x86_64-0ce9491-1_2020-01-09.cgz,/osimage/deps/debian-x86_64-20180403.cgz/mpstat_2020-01-03.cgz,/osimage/deps/debian-x86_64-20180403.cgz/vmstat_2020-01-07.cgz,/osimage/deps/debian-x86_64-20180403.cgz/perf_20200325.cgz,/osimage/pkg/debian-x86_64-20180403.cgz/perf-x86_64-76ccd234269b-1_20200325.cgz,/osimage/pkg/debian-x86_64-20180403.cgz/sar-x86_64-e011d97-1_2020-01-03.cgz,/osimage/deps/debian-x86_64-20180403.cgz/hw_2020-01-02.cgz'
	export lkp_initrd='/osimage/user/lkp/lkp-x86_64.cgz'
	export site='inn'
	export LKP_CGI_PORT=80
	export LKP_CIFS_PORT=139
	export last_kernel='5.6.0-wt-16806-g803d688020ba27'
	export repeat_to=4
	export schedule_notify_address=
	export queue_at_least_once=1
	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-7/90c91dfb86d0ff545bd329d3ddd72c147e2ae198/vmlinuz-5.6.0-rc6-00081-g90c91dfb86d0f'
	export dequeue_time='2020-04-14 12:22:59 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2ap1/fxmark-performance-directio-1SSD-f2fs-ssd-DRBL-ucode=0x400002c-debian-x86_64-20191114.cgz-90c91dfb86d0ff545bd329d3ddd72c147e2ae1-20200414-13633-153xj49-3.cgz'
...
run_job()
{
	...
	run_test test='DRBL' fstype='f2fs' directio='directio' $LKP_SRC/tests/wrapper fxmark
}
...
fxmark:
  ...
  fstype: f2fs
  directio: directio
job_origin: "/lkp/lkp/.src-20200330-144334/allot/cyclic:p2:linux-devel:devel-hourly/lkp-csl-2ap1/fxmark-1ssd.yaml"
...
submit_id: 5e951c07a459263311e0aada
job_file: "/lkp/jobs/scheduled/lkp-csl-2ap1/fxmark-performance-directio-1SSD-f2fs-ssd-DRBL-ucode=0x400002c-debian-x86_64-20191114.cgz-90c91dfb86d0ff545bd329d3ddd72c147e2ae1-20200414-13073-u2563-0.yaml"
id: '069af0b95983e0c4de34f5e8d9f3d1f124452f5d'
...
memory: 192G
nr_ssd_partitions: 1
ssd_partitions: "/dev/disk/by-id/nvme-INTEL_SSDPE2KX010T8_BTLJ904508P61P0FGN-part4"
rootfs_partition: "/dev/disk/by-id/nvme-INTEL_SSDPE2KX010T8_BTLJ904508P61P0FGN-part3"
...
kconfig: x86_64-rhel-7.6
compiler: gcc-7
enqueue_time: 2020-04-14 10:12:27.464461309 +08:00
_id: 5e951c07a459263311e0aada
_rt: "/result/fxmark/performance-directio-1SSD-f2fs-ssd-DRBL-ucode=0x400002c/lkp-csl-2ap1/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/90c91dfb86d0ff545bd329d3ddd72c147e2ae198"

#! schedule options
user: lkp
head_commit: 803d688020ba2792f5d7e3206362f8f73254998b
base_commit: 7111951b8d4973bda27ff663f2cf18b663d15b48
branch: linux-devel/devel-hourly-2020041303
rootfs: debian-x86_64-20191114.cgz
result_root: "/result/fxmark/performance-directio-1SSD-f2fs-ssd-DRBL-ucode=0x400002c/lkp-csl-2ap1/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/90c91dfb86d0ff545bd329d3ddd72c147e2ae198/0"
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-csl-2ap1/fxmark-performance-directio-1SSD-f2fs-ssd-DRBL-ucode=0x400002c-debian-x86_64-20191114.cgz-90c91dfb86d0ff545bd329d3ddd72c147e2ae1-20200414-13073-u2563-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2020041303
- commit=90c91dfb86d0ff545bd329d3ddd72c147e2ae198
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/90c91dfb86d0ff545bd329d3ddd72c147e2ae198/modules.cgz"
...
#! runtime status
last_kernel: 5.7.0-rc1-03064-gb73de0abcde14
repeat_to: 2
schedule_notify_address: 

#! user overrides
queue_at_least_once: 0
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/90c91dfb86d0ff545bd329d3ddd72c147e2ae198/vmlinuz-5.6.0-rc6-00081-g90c91dfb86d0f"
dequeue_time: 2020-04-14 10:54:18.625855981 +08:00

#! /lkp/lkp/.src-20200414-102605/include/site/inn
job_state: finished
loadavg: 2.69 3.92 2.01 1/1339 14590
start_time: '1586832924'
end_time: '1586833256'
