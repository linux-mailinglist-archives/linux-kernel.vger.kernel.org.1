...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 16FB72DCE83
	for <lists+linux-kernel@lfdr.de>; Thu, 17 Dec 2020 10:37:04 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727035AbgLQJgq (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 17 Dec 2020 04:36:46 -0500
Received: from mga18.intel.com ([134.134.136.126]:45690 "EHLO mga18.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725930AbgLQJgd (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 17 Dec 2020 04:36:33 -0500
IronPort-SDR: jQ/S+eHP7Z7aFt+fRQ2LRCXiprylPWbvKxge1Ebs5OjPcgrQaYULeyOzGL0+f21n6YipB64Mcp
 TjjrCcyPEDsg==
X-IronPort-AV: E=McAfee;i="6000,8403,9837"; a="162961985"
X-IronPort-AV: E=Sophos;i="5.78,426,1599548400"; 
   d="yaml'?scan'208";a="162961985"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 17 Dec 2020 01:35:44 -0800
IronPort-SDR: WrMsDKWifrrHmPp6vYsc1a7gn4BhKd4fA2FzfL0zXRHkRTfS4rcb5xpjAF5U4KIbQYxNLvUSQB
 vZr5m0eneGGA==
X-IronPort-AV: E=Sophos;i="5.78,426,1599548400"; 
   d="yaml'?scan'208";a="369760322"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.140])
  by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 17 Dec 2020 01:35:36 -0800
Date:   Thu, 17 Dec 2020 17:49:11 +0800
From:   kernel test robot <oliver.sang@intel.com>
To:     Sven Schnelle <svens@linux.ibm.com>
Cc:     0day robot <lkp@intel.com>, LKML <linux-kernel@vger.kernel.org>,
        lkp@lists.01.org, ying.huang@intel.com, feng.tang@intel.com,
        zhengjun.xing@intel.com, Thomas Gleixner <tglx@linutronix.de>,
        hca@linux.ibm.com, Sven Schnelle <svens@linux.ibm.com>
Subject: [entry]  a358d5636c:  unixbench.score -1.9% regression
Message-ID: <20201217094911.GA32379@xsang-OptiPlex-9020>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.10.0-rc4-00001-ga358d5636cfc"
...
export_top_env()
{
	...
	export submit_id='5fcce7ee0b9a939abd786d8e'
	export job_file='/lkp/jobs/scheduled/lkp-csl-2ap2/will-it-scale-performance-process-16-futex3-ucode=0x5003003-monitor=0fe5055f-debian-10.4-x86_64-20200603.cgz-a358d5636cfcb8b278c-20201206-39613-14v97wc-0.yaml'
	export id='9c16bc22b2839a0366aa818715e87f8b0bce392d'
	export queuer_version='/lkp/xsang/.src-20201206-205813'
	...
	export commit='a358d5636cfcb8b278c766ac261ad99143215041'
	export need_kconfig_hw='CONFIG_IGB=y
CONFIG_BLK_DEV_NVME'
	export ucode='0x5003003'
	export enqueue_time='2020-12-06 22:17:18 +0800'
	export _id='5fcce7ee0b9a939abd786d8e'
	export _rt='/result/will-it-scale/performance-process-16-futex3-ucode=0x5003003-monitor=0fe5055f/lkp-csl-2ap2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/a358d5636cfcb8b278c766ac261ad99143215041'
	export user='lkp'
	...
	export branch='linux-review/Sven-Schnelle/entry-split-lockdep-and-syscall-work-functions/20201201-163931'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export monitor_sha='0fe5055f'
	export result_root='/result/will-it-scale/performance-process-16-futex3-ucode=0x5003003-monitor=0fe5055f/lkp-csl-2ap2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/a358d5636cfcb8b278c766ac261ad99143215041/8'
	export scheduler_version='/lkp/lkp/.src-20201206-151247'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-csl-2ap2/will-it-scale-performance-process-16-futex3-ucode=0x5003003-monitor=0fe5055f-debian-10.4-x86_64-20200603.cgz-a358d5636cfcb8b278c-20201206-39613-14v97wc-0.yaml
ARCH=x86_64
kconfig=x86_64-rhel-8.3
branch=linux-review/Sven-Schnelle/entry-split-lockdep-and-syscall-work-functions/20201201-163931
commit=a358d5636cfcb8b278c766ac261ad99143215041
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/a358d5636cfcb8b278c766ac261ad99143215041/vmlinuz-5.10.0-rc4-00001-ga358d5636cfc
acpi_rsdp=0x67f44014
max_uptime=2400
RESULT_ROOT=/result/will-it-scale/performance-process-16-futex3-ucode=0x5003003-monitor=0fe5055f/lkp-csl-2ap2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/a358d5636cfcb8b278c766ac261ad99143215041/8
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/a358d5636cfcb8b278c766ac261ad99143215041/modules.cgz'
	...
	export last_kernel='5.10.0-rc4-00001-ga358d5636cfc'
	export good_samples='10304605
10274242
10305496'
	export queue_at_least_once=1
	export schedule_notify_address=
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/a358d5636cfcb8b278c766ac261ad99143215041/vmlinuz-5.10.0-rc4-00001-ga358d5636cfc'
	export dequeue_time='2020-12-07 00:20:06 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2ap2/will-it-scale-performance-process-16-futex3-ucode=0x5003003-monitor=0fe5055f-debian-10.4-x86_64-20200603.cgz-a358d5636cfcb8b278c-20201206-39613-14v97wc-0.cgz'
...
kconfig: x86_64-rhel-8.3
submit_id: 5fcad7b8d1f3a9250e70c11c
job_file: "/lkp/jobs/scheduled/lkp-csl-2ap2/will-it-scale-performance-process-16-futex3-ucode=0x5003003-monitor=0fe5055f-debian-10.4-x86_64-20200603.cgz-a358d5636cfcb8b278c-20201205-9486-1y21qtx-1.yaml"
id: 7c44c8dc4a28610571510c96de09f89a0b7fca58
...
- CONFIG_BLK_DEV_NVME
ucode: '0x5003003'
enqueue_time: 2020-12-05 08:43:36.650934817 +08:00
_id: 5fcad7bcd1f3a9250e70c11d
_rt: "/result/will-it-scale/performance-process-16-futex3-ucode=0x5003003-monitor=0fe5055f/lkp-csl-2ap2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/a358d5636cfcb8b278c766ac261ad99143215041"
user: lkp
compiler: gcc-9
...
result_root: "/result/will-it-scale/performance-process-16-futex3-ucode=0x5003003-monitor=0fe5055f/lkp-csl-2ap2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/a358d5636cfcb8b278c766ac261ad99143215041/0"
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-csl-2ap2/will-it-scale-performance-process-16-futex3-ucode=0x5003003-monitor=0fe5055f-debian-10.4-x86_64-20200603.cgz-a358d5636cfcb8b278c-20201205-9486-1y21qtx-1.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- branch=linux-devel/devel-hourly-2020120305
- commit=a358d5636cfcb8b278c766ac261ad99143215041
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/a358d5636cfcb8b278c766ac261ad99143215041/modules.cgz"
...
oom-killer: 
watchdog: 
last_kernel: 5.10.0-rc6-04212-ga7a52821451b
repeat_to: 2
good_samples:
- 10304605
- 10274242
...
#! schedule options
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/a358d5636cfcb8b278c766ac261ad99143215041/vmlinuz-5.10.0-rc4-00001-ga358d5636cfc"
dequeue_time: 2020-12-05 09:00:55.932873648 +08:00

#! /lkp/lkp/.src-20201204-160157/include/site/inn

#! runtime status
job_state: finished
loadavg: 14.75 10.20 4.54 1/1282 13043
start_time: '1607130301'
end_time: '1607130602'
...
do
 ...
 "/lkp/benchmarks/python3/bin/python3" "./runtest.py" "futex3" "295" "process" "16"
