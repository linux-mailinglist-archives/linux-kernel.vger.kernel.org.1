...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 08B032753E5
	for <lists+linux-kernel@lfdr.de>; Wed, 23 Sep 2020 10:57:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726670AbgIWI5I (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 23 Sep 2020 04:57:08 -0400
Received: from mga09.intel.com ([134.134.136.24]:62874 "EHLO mga09.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726244AbgIWI5I (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 23 Sep 2020 04:57:08 -0400
IronPort-SDR: cCXNHWJk1NvozL5RQy7+OKzL5dcGjNNwcJJl+SwbFGe2AuDul0DUby/NV1szcvS+iHwI9gsrGm
 6vZKyXDlO85g==
X-IronPort-AV: E=McAfee;i="6000,8403,9752"; a="161770512"
X-IronPort-AV: E=Sophos;i="5.77,293,1596524400"; 
   d="yaml'?scan'208";a="161770512"
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
  by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Sep 2020 01:56:29 -0700
IronPort-SDR: QfA8L8yzUa4mN1y7gHVP3E8TD+Xu1flF5W5BVik1IlFSEm8tvlBKDEk6XjpB4dhWnXetqhp3SZ
 EkwoB8EgYRUg==
X-IronPort-AV: E=Sophos;i="5.77,293,1596524400"; 
   d="yaml'?scan'208";a="454822535"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.3])
  by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Sep 2020 01:56:25 -0700
Date:   Wed, 23 Sep 2020 16:55:44 +0800
...
Subject: [core/entry] b6ec413461: will-it-scale.per_process_ops 5.0%
 improvement
Message-ID: <20200923085544.GE28663@shao2-debian>
MIME-Version: 1.0
...
---------------- --------------------------- 
 ...
 1.517e+13            +5.0%  1.592e+13        perf-stat.total.instructions
     ...
     24.90 ±  6%      -4.2       20.66 ±  9%  perf-profile.children.cycles-pp.do_syscall_64
      ...
      0.31 ±  6%      -0.0        0.28 ±  3%  perf-profile.children.cycles-pp.lseek@plt
...
Content-Disposition: attachment; filename="config-5.9.0-rc5-00001-gb6ec413461034"
...
export_top_env()
{
	...
	export nr_task=16
	export job_origin='/lkp-src/allot/cyclic:p1:internal-devel:devel-hourly/lkp-csl-2ap2/will-it-scale-16.yaml'
...
queue_at_least_once'
	...
	export submit_id='5f69d14ba6dc3e247e9cc417'
	export job_file='/lkp/jobs/scheduled/lkp-csl-2ap2/will-it-scale-performance-process-16-lseek2-ucode=0x5002f01-monitor=a122c70f-debian-10.4-x86_64-20200603.cgz-b6ec413461034d49f9e-20200922-9342-146w9su-2.yaml'
	export id='46796287e00f035a2871103e04067253c6628684'
	...
	export commit='b6ec413461034d49f9e586845825adb35ba308f6'
	export need_kconfig_hw='CONFIG_IGB=y
CONFIG_BLK_DEV_NVME'
	export ucode='0x5002f01'
	export enqueue_time='2020-09-22 18:26:19 +0800'
	export _id='5f69d14ba6dc3e247e9cc417'
	export _rt='/result/will-it-scale/performance-process-16-lseek2-ucode=0x5002f01-monitor=a122c70f/lkp-csl-2ap2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/b6ec413461034d49f9e586845825adb35ba308f6'
	export user='lkp'
	export compiler='gcc-9'
	export head_commit='018fad0fd6894979b5b2f6f01d6a3ba5c152a750'
	export base_commit='ba4f184e126b751d1bffad5897f263108befc780'
	export branch='linus/master'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export monitor_sha='a122c70f'
	export result_root='/result/will-it-scale/performance-process-16-lseek2-ucode=0x5002f01-monitor=a122c70f/lkp-csl-2ap2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/b6ec413461034d49f9e586845825adb35ba308f6/3'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-csl-2ap2/will-it-scale-performance-process-16-lseek2-ucode=0x5002f01-monitor=a122c70f-debian-10.4-x86_64-20200603.cgz-b6ec413461034d49f9e-20200922-9342-146w9su-2.yaml
ARCH=x86_64
kconfig=x86_64-rhel-8.3
branch=linus/master
commit=b6ec413461034d49f9e586845825adb35ba308f6
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/b6ec413461034d49f9e586845825adb35ba308f6/vmlinuz-5.9.0-rc5-00001-gb6ec413461034
acpi_rsdp=0x67f44014
max_uptime=3600
RESULT_ROOT=/result/will-it-scale/performance-process-16-lseek2-ucode=0x5002f01-monitor=a122c70f/lkp-csl-2ap2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/b6ec413461034d49f9e586845825adb35ba308f6/3
LKP_SERVER=inn
nokaslr
selinux=0
debug
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/b6ec413461034d49f9e586845825adb35ba308f6/modules.cgz'
	...
	export last_kernel='5.9.0-rc3-00081-gd5c678aed5edd'
	export repeat_to=4
	export schedule_notify_address=
	export queue_at_least_once=1
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/b6ec413461034d49f9e586845825adb35ba308f6/vmlinuz-5.9.0-rc5-00001-gb6ec413461034'
	export dequeue_time='2020-09-22 18:33:28 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2ap2/will-it-scale-performance-process-16-lseek2-ucode=0x5002f01-monitor=a122c70f-debian-10.4-x86_64-20200603.cgz-b6ec413461034d49f9e-20200922-9342-146w9su-2.cgz'
...
run_job()
{
	...
	run_test mode='process' test='lseek2' $LKP_SRC/tests/wrapper will-it-scale
}
...
will-it-scale:
  mode: process
  test: lseek2
job_origin: "/lkp-src/allot/cyclic:p1:internal-devel:devel-hourly/lkp-csl-2ap2/will-it-scale-16.yaml"
...
kconfig: x86_64-rhel-8.3
submit_id: 5f69c79fa6dc3e23f41b7566
job_file: "/lkp/jobs/scheduled/lkp-csl-2ap2/will-it-scale-performance-process-16-lseek2-ucode=0x5002f01-monitor=a122c70f-debian-10.4-x86_64-20200603.cgz-b6ec413461034d49f9e-20200922-9204-17v39p6-1.yaml"
id: e751565f4ace86c9c8ae87a215b77188abcead46
...
- CONFIG_BLK_DEV_NVME
ucode: '0x5002f01'
enqueue_time: 2020-09-22 17:45:03.341824427 +08:00
_id: 5f69c7a5a6dc3e23f41b7567
_rt: "/result/will-it-scale/performance-process-16-lseek2-ucode=0x5002f01-monitor=a122c70f/lkp-csl-2ap2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/b6ec413461034d49f9e586845825adb35ba308f6"

#! schedule options
user: lkp
compiler: gcc-9
head_commit: '018fad0fd6894979b5b2f6f01d6a3ba5c152a750'
base_commit: ba4f184e126b751d1bffad5897f263108befc780
branch: internal-devel/devel-hourly-2020092115
rootfs: debian-10.4-x86_64-20200603.cgz
monitor_sha: a122c70f
result_root: "/result/will-it-scale/performance-process-16-lseek2-ucode=0x5002f01-monitor=a122c70f/lkp-csl-2ap2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/b6ec413461034d49f9e586845825adb35ba308f6/0"
scheduler_version: "/lkp/lkp/.src-20200922-154531"
LKP_SERVER: inn
arch: x86_64
max_uptime: 3600
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-csl-2ap2/will-it-scale-performance-process-16-lseek2-ucode=0x5002f01-monitor=a122c70f-debian-10.4-x86_64-20200603.cgz-b6ec413461034d49f9e-20200922-9204-17v39p6-1.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- branch=internal-devel/devel-hourly-2020092115
- commit=b6ec413461034d49f9e586845825adb35ba308f6
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/b6ec413461034d49f9e586845825adb35ba308f6/modules.cgz"
...
#! runtime status
last_kernel: 5.9.0-rc5-00004-g3e84c1dcb2e814
repeat_to: 2
schedule_notify_address: 

#! user overrides
queue_at_least_once: 0
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/b6ec413461034d49f9e586845825adb35ba308f6/vmlinuz-5.9.0-rc5-00001-gb6ec413461034"
dequeue_time: 2020-09-22 17:49:33.154876405 +08:00

#! /lkp/lkp/.src-20200922-154531/include/site/inn
job_state: finished
loadavg: 13.47 9.90 4.44 1/1283 12875
start_time: '1600768235'
end_time: '1600768536'
version: "/lkp/lkp/.src-20200922-154606:b65c777e-dirty:c27160e87-dirty"
...
do
 ...
 "/lkp/benchmarks/python3/bin/python3" "./runtest.py" "lseek2" "295" "process" "16"
