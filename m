...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id DA9C51D4C88
	for <lists+linux-kernel@lfdr.de>; Fri, 15 May 2020 13:26:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726170AbgEOL0A (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 15 May 2020 07:26:00 -0400
Received: from mail-eopbgr80048.outbound.protection.outlook.com ([40.107.8.48]:12214
        "EHLO EUR04-VI1-obe.outbound.protection.outlook.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1725986AbgEOLZ7 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 15 May 2020 07:25:59 -0400
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=6HuZnAjKcFIXBf0H0vPLHWW/kji3S18iXHkxQXiOwo8=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=NXP1.onmicrosoft.com;
 ...
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=6HuZnAjKcFIXBf0H0vPLHWW/kji3S18iXHkxQXiOwo8=;
 b=eMbpHClyvSMLnaLk0xok0OX66wp67Mz4MxIGJpJfEl2tLAgkAezTVzfPolFjjvFRRZyj6yhQ9zYjZ8Uuhq7/XNCrvJJ380IqgMlx6+RoV1QFLiTmoue9HOf2wUtoGkPM+b2Fa9IOh4FaMbLgzEYrWabhkRSGFiqPcTbH25WYdsI=
...
Received: from VI1PR0402MB3902.eurprd04.prod.outlook.com
 (2603:10a6:803:22::27) by VI1PR0402MB3568.eurprd04.prod.outlook.com
 (2603:10a6:803:f::27) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.3000.26; Fri, 15 May
 2020 11:10:17 +0000
Received: from VI1PR0402MB3902.eurprd04.prod.outlook.com
 ([fe80::b0ae:5b70:d513:7dd7]) by VI1PR0402MB3902.eurprd04.prod.outlook.com
 ([fe80::b0ae:5b70:d513:7dd7%3]) with mapi id 15.20.3000.022; Fri, 15 May 2020
 11:10:16 +0000
Date:   Fri, 15 May 2020 14:10:13 +0300
...
Subject: Re: [PATCH v4 2/4] drm/imx: Add initial support for DCSS on iMX8MQ
Message-ID: <20200515111012.GA1796@fsr-ub1864-141>
References: <20200306124930.20978-1-laurentiu.palcu@oss.nxp.com>
 <20200306124930.20978-3-laurentiu.palcu@oss.nxp.com>
 <20200515092719.GA22192@bogon.m.sigxcpu.org>
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <20200515092719.GA22192@bogon.m.sigxcpu.org>
User-Agent: Mutt/1.9.4 (2018-02-28)
X-ClientProxiedBy: AM0PR02CA0091.eurprd02.prod.outlook.com
 (2603:10a6:208:154::32) To VI1PR0402MB3902.eurprd04.prod.outlook.com
 (2603:10a6:803:22::27)
MIME-Version: 1.0
X-MS-Exchange-MessageSentRepresentingType: 1
Received: from fsr-ub1864-141 (83.217.231.2) by AM0PR02CA0091.eurprd02.prod.outlook.com (2603:10a6:208:154::32) with Microsoft SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.3000.20 via Frontend Transport; Fri, 15 May 2020 11:10:15 +0000
X-Originating-IP: [83.217.231.2]
X-MS-PublicTrafficType: Email
X-MS-Office365-Filtering-HT: Tenant
X-MS-Office365-Filtering-Correlation-Id: 6c56850b-c16a-484b-5abd-08d7f8c08c18
X-MS-TrafficTypeDiagnostic: VI1PR0402MB3568:
X-MS-Exchange-SharedMailbox-RoutingAgent-Processed: True
X-MS-Exchange-Transport-Forked: True
X-Microsoft-Antispam-PRVS: <VI1PR0402MB35681660F4EBC240992B864CBEBD0@VI1PR0402MB3568.eurprd04.prod.outlook.com>
X-MS-Oob-TLC-OOBClassifiers: OLM:4303;
X-Forefront-PRVS: 04041A2886
X-MS-Exchange-SenderADCheck: 1
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:VI1PR0402MB3902.eurprd04.prod.outlook.com;PTR:;CAT:NONE;SFTY:;SFS:(4636009)(136003)(346002)(39860400002)(366004)(396003)(376002)(54906003)(44832011)(33716001)(26005)(316002)(6916009)(16526019)(9686003)(55016002)(186003)(956004)(966005)(478600001)(8936002)(8676002)(86362001)(33656002)(66556008)(66574014)(1076003)(2906002)(52116002)(66476007)(6496006)(5660300002)(30864003)(66946007)(4326008)(32563001)(559001)(579004);DIR:OUT;SFP:1101;
X-MS-Exchange-AntiSpam-MessageData: 
X-OriginatorOrg: oss.nxp.com
X-MS-Exchange-CrossTenant-Network-Message-Id: 6c56850b-c16a-484b-5abd-08d7f8c08c18
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 15 May 2020 11:10:16.8117
 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 686ea1d3-bc2b-4c6f-a92c-d99c5c301635
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: ov7goGvyeJ6O4/KSqUhi1YqexdlS/1LTyFYbOL+i9cIlKYTQ1hCqeyCL0UCqIAuGwGqToyAqaltUwLBYW29gqw==
...
> > new file mode 100644
> > index 000000000000..0276917f409f
> > --- /dev/null
...
> > new file mode 100644
> > index 000000000000..7a058e4c935b
> > --- /dev/null
...
> > +	dcss_ctxld_register_completion(dcss->ctxld, &dcss_crtc->dis_completion);
> > +	dcss_ctxld_enable(dcss->ctxld);
> > +
> > +	if (!wait_for_completion_timeout(&dcss_crtc->dis_completion,
> > +					 msecs_to_jiffies(100)))
> > +		dev_err(dcss->dev, "Waiting for DTG shutting off timed out.\n");
> > +
...
> > new file mode 100644
> > index 000000000000..357fb25d104a
> > --- /dev/null
...
> > +
> > +	/* This must be set before shutting off DCSS. */
...
> > +		ctxld->in_use = false;
> > +
> > +		if (ctxld->dis_completion) {
> > +			dcss_dtg_shutoff(dcss->dtg);
> > +			complete(ctxld->dis_completion);
> > +			ctxld->dis_completion = NULL;
> > +		}
...
> > +				    struct completion *dis_completion)
> > +{
> > +	ctxld->dis_completion = dis_completion;
> > +}
> > +
...
> > new file mode 100644
> > index 000000000000..3e53c47ed2f5
> > --- /dev/null
...
> > new file mode 100644
> > index 000000000000..363e1fd93c75
> > --- /dev/null
...
> > new file mode 100644
> > index 000000000000..09d0ac28e28a
> > --- /dev/null
...
> > +	}
> 
> I wonder why the dcss driver is being both a component driver and able
> to drive a downstream bridge?

Because, downstream, the HDP driver is a component driver. I suppose I
could remove this functionality in these patches and add it only in our
downstream tree. Once HDP driver will make it to the lists, I'll
probably add it back, or not, depending on how HDP driver will be
implemented.

Thanks,
laurentiu

> Wouldn't it be better to handle HDMI/DP later on as
> 
> DCSS -> mhdp (drm bridge) -> HDMI/DP (phy layer)
> 
> that would match
> 
> DCSS -> nwl (drm bridge) -> DSI phy (phy layer)
> 
> Cheers,
>  -- Guido
> 
...
> > new file mode 100644
> > index 000000000000..5824941ea563
> > --- /dev/null
...
> > +
> > +/*
> > + * Do not call this directly. DTG has to be shutoff after CTXLD has finished.
> > + * This function will be called from CTXLD IRQ handler if a completion has been
> > + * registered.
> > + */
> > +void dcss_dtg_shutoff(struct dcss_dtg *dtg)
> > +{
...
> > new file mode 100644
> > index 000000000000..819d4d28d293
> > --- /dev/null
...
> > new file mode 100644
> > index 000000000000..8824a08ada84
> > --- /dev/null
...
> > new file mode 100644
> > index 000000000000..45d3e1af0d79
> > --- /dev/null
