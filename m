...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A459B200A5F
	for <lists+linux-kernel@lfdr.de>; Fri, 19 Jun 2020 15:41:16 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732813AbgFSNjI (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 19 Jun 2020 09:39:08 -0400
Received: from foss.arm.com ([217.140.110.172]:59490 "EHLO foss.arm.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1730995AbgFSNi6 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 19 Jun 2020 09:38:58 -0400
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 9725811B3;
        Fri, 19 Jun 2020 06:38:56 -0700 (PDT)
Received: from e120937-lin.home (unknown [172.31.20.19])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 857E73F6CF;
        Fri, 19 Jun 2020 06:38:55 -0700 (PDT)
From:   Cristian Marussi <cristian.marussi@arm.com>
To:     linux-kernel@vger.kernel.org, linux-arm-kernel@lists.infradead.org
Cc:     sudeep.holla@arm.com, lukasz.luba@arm.com,
        james.quinlan@broadcom.com, Jonathan.Cameron@Huawei.com,
        cristian.marussi@arm.com
Subject: [PATCH v10 2/9] firmware: arm_scmi: Add notification callbacks-registration
Date:   Fri, 19 Jun 2020 14:38:27 +0100
Message-Id: <20200619133834.18497-3-cristian.marussi@arm.com>
...
index 4b451754c390..a762bfa068c3 100644
...
+
 ...
 /**
@@ -63,9 +163,13 @@ struct scmi_registered_events_desc;
  * core
...
@@ -73,7 +177,12 @@ struct scmi_registered_events_desc;
...
+	DECLARE_HASHTABLE(pending_events_handlers, SCMI_PENDING_HASH_SZ);
 ...
 /**
@@ -122,6 +231,9 @@ struct scmi_registered_event;
...
@@ -142,6 +254,8 @@ struct scmi_registered_events_desc {
 	void				*in_flight;
 	int				num_events;
...
+	DECLARE_HASHTABLE(registered_events_handlers, SCMI_REGISTERED_HASH_SZ);
 ...
 /**
@@ -173,6 +287,38 @@ struct scmi_registered_event {
...
@@ -258,6 +404,10 @@ scmi_allocate_registered_events_desc(struct scmi_notify_instance *ni,
...
+
 ...
 err:
@@ -358,6 +514,551 @@ int scmi_register_protocol_events(const struct scmi_handle *handle,
 	return -ENOMEM;
 }
...
@@ -405,6 +1106,12 @@ int scmi_notification_init(struct scmi_handle *handle)
