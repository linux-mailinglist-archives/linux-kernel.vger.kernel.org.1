...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 669431D6396
	for <lists+linux-kernel@lfdr.de>; Sat, 16 May 2020 20:29:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726656AbgEPS3X (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 16 May 2020 14:29:23 -0400
Received: from mga05.intel.com ([192.55.52.43]:56285 "EHLO mga05.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726374AbgEPS3W (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 16 May 2020 14:29:22 -0400
IronPort-SDR: YUYTrFj4QBZ0IkuHfHOR5fHZ1Bcz6HJ4pVXS12jRfCBazenU7nGYTflfP5RYOnEuZXKi7VjtP7
 81Jt4qMgQCTA==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 16 May 2020 11:29:20 -0700
IronPort-SDR: OO/bZrxUHlrp7TPmWG+3ORIdZ0zqF87pISU/JCpqH5gXVRq8o6oCLb4fGZYpBSu+JzBhy7S83v
 hbuKcSF8vuWQ==
X-IronPort-AV: E=Sophos;i="5.73,400,1583222400"; 
   d="scan'208";a="281563325"
...
Subject: [PATCH V4 1/4] x86/resctrl: Enable user to view and select thread throttling mode
Date:   Sat, 16 May 2020 11:28:38 -0700
Message-Id: <667e48a36924c1710f6f2dd0116d388170721528.1589652468.git.reinette.chatre@intel.com>
...
@@ -250,6 +250,45 @@ static inline bool rdt_get_mb_table(struct rdt_resource *r)
 	return false;
 }
...
@@ -270,6 +309,14 @@ static bool __get_mem_config_intel(struct rdt_resource *r)
 	}
 	r->data_width = 3;
...
@@ -289,6 +336,11 @@ static bool __rdt_get_mem_config_amd(struct rdt_resource *r)
...
@@ -580,6 +632,8 @@ static void domain_add_cpu(int cpu, struct rdt_resource *r)
