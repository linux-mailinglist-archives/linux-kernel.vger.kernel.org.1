...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 646E12972A9
	for <lists+linux-kernel@lfdr.de>; Fri, 23 Oct 2020 17:45:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1751061AbgJWPoy (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 23 Oct 2020 11:44:54 -0400
Received: from relaydlg-01.paragon-software.com ([81.5.88.159]:36654 "EHLO
        relaydlg-01.paragon-software.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S463290AbgJWPow (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 23 Oct 2020 11:44:52 -0400
Received: from dlg2.mail.paragon-software.com (vdlg-exch-02.paragon-software.com [172.30.1.105])
        by relaydlg-01.paragon-software.com (Postfix) with ESMTPS id 2A486821D7;
        Fri, 23 Oct 2020 18:44:37 +0300 (MSK)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=paragon-software.com; s=mail; t=1603467877;
        bh=iaNWZZYdHTOBgzfBOPVas9GUKWksxhRg9KPd4uHcUK4=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=cByEfkB6Rb83AK6pcdBV8or2k6KEHHnMuUnrZTlOKsp57I9AsKA4virc1tVztMTqr
         JihSsKWK+lueRjY5LHOGq6DJlBltq2YAjLCXAtt51Tn/wK7oI5BjVhx2r8EpGeIxhK
         wWJW98+1AGy79KX7CyQl0cQdo5bV+vk9lc+0dhds=
...
Subject: [PATCH v10 01/10] fs/ntfs3: Add headers and misc files
Date:   Fri, 23 Oct 2020 18:44:22 +0300
Message-ID: <20201023154431.1853715-2-almaz.alexandrovich@paragon-software.com>
...
---
 ...
 4 files changed, 2389 insertions(+)
...
index 000000000000..4a5fd488713c
--- /dev/null
+++ b/fs/ntfs3/debug.h
@@ -0,0 +1,62 @@
...
new file mode 100644
index 000000000000..c729e74292f3
--- /dev/null
+++ b/fs/ntfs3/ntfs.h
@@ -0,0 +1,1262 @@
+/* SPDX-License-Identifier: GPL-2.0 */
...
+extern const __le16 EFS_NAME[4];
+extern const __le16 WOF_NAME[17];
+extern const __le16 J_NAME[2];
+extern const __le16 MAX_NAME[4];
+
...
new file mode 100644
index 000000000000..314c879666f4
--- /dev/null
...
new file mode 100644
index 000000000000..16e05a27c423
--- /dev/null
+++ b/fs/ntfs3/upcase.c
@@ -0,0 +1,78 @@
+// SPDX-License-Identifier: GPL-2.0
