...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 83D832C8480
	for <lists+linux-kernel@lfdr.de>; Mon, 30 Nov 2020 13:57:22 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726385AbgK3M4x (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 30 Nov 2020 07:56:53 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:32920 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725897AbgK3M4w (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 30 Nov 2020 07:56:52 -0500
Received: from merlin.infradead.org (merlin.infradead.org [IPv6:2001:8b0:10b:1231::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 61285C0613CF;
        Mon, 30 Nov 2020 04:56:11 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        d=infradead.org; s=merlin.20170209; h=Mime-Version:Content-Type:References:
        In-Reply-To:Date:Cc:To:From:Subject:Message-ID:Sender:Reply-To:
        Content-Transfer-Encoding:Content-ID:Content-Description;
        bh=YluytUCNMj4hB0rn5ZJJqQr/Ajs1lxevxGE4cIG6BtQ=; b=C8ObFZyOCxYqiUajpBvTiC9wEI
        ;
Received: from [54.239.6.186] (helo=freeip.amazon.com)
        by merlin.infradead.org with esmtpsa (Exim 4.92.3 #3 (Red Hat Linux))
        id 1kjiij-00030L-UU; Mon, 30 Nov 2020 12:55:58 +0000
...
> > > EVTCHNOP_send short-circuiting happens by marking the event as pendin=
g
...
> >=20
>=20
> One thing I didn't quite do at the time, is the whitelisting of unregiste=
red
> ports to userspace. Right now, it's a blacklist i.e. if it's not handled =
in
> the kernel (IPIs, timer vIRQ, etc) it goes back to userspace. When the on=
ly
...
> and let it route its evtchn port handling to the its own I/O handling thr=
ead.
...
MTMwMTI1NTU0WjAvBgkqhkiG9w0BCQQxIgQgmtp/0PNBSoGeOyVji4+u4ec7bG1MlQZunkwlnBV5
ZwMwgb4GCSsGAQQBgjcQBDGBsDCBrTCBlzELMAkGA1UEBhMCR0IxGzAZBgNVBAgTEkdyZWF0ZXIg
...

