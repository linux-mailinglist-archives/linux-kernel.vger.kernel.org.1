...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 01A6B27A78C
	for <lists+linux-kernel@lfdr.de>; Mon, 28 Sep 2020 08:28:10 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726604AbgI1G2G (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 28 Sep 2020 02:28:06 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50160 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725290AbgI1G2G (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 28 Sep 2020 02:28:06 -0400
Received: from mail-pf1-x444.google.com (mail-pf1-x444.google.com [IPv6:2607:f8b0:4864:20::444])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4C1A8C0613CE
        for <linux-kernel@vger.kernel.org>; Sun, 27 Sep 2020 23:28:06 -0700 (PDT)
Received: by mail-pf1-x444.google.com with SMTP id d6so8418966pfn.9
        for <linux-kernel@vger.kernel.org>; Sun, 27 Sep 2020 23:28:06 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=cjYevJ0IOSk9rvnZGYcC2MPNAFAfpF19Zrwc5Bal7vA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=cjYevJ0IOSk9rvnZGYcC2MPNAFAfpF19Zrwc5Bal7vA=;
        b=
X-Gm-Message-State: AOAM531zbCDYWx0eVYGGn/vh4MQnXuPICKisPFP0MDigAkQKcl1DsNzM
        lg37kr4SVCxEQbGVmndLIMw=
X-Google-Smtp-Source: ABdhPJzflSuLhqdeXML+1yN9OrU5R3cwfY0pSpg1HLEPxI/4FZtzYUJQ1dJmpcDx47ti2FhPwWG5Bg==
X-Received: by 2002:a63:cc42:: with SMTP id q2mr113942pgi.216.1601274485528;
        Sun, 27 Sep 2020 23:28:05 -0700 (PDT)
Received: from nj08008nbu.spreadtrum.com ([117.18.48.82])
        by smtp.gmail.com with ESMTPSA id il14sm5712509pjb.54.2020.09.27.23.28.01
        (version=TLS1_2 cipher=ECDHE-ECDSA-AES128-GCM-SHA256 bits=128/128);
        Sun, 27 Sep 2020 23:28:04 -0700 (PDT)
...
Subject: [PATCH RFC v7 4/6] drm/sprd: add Unisoc's drm display controller driver
Date:   Mon, 28 Sep 2020 14:27:38 +0800
Message-Id: <1601274460-7866-5-git-send-email-kevin3.tang@gmail.com>
...
+}
+
+static int dpu_img_ctrl(struct dpu_layer *layer, u32 format, u32 angle, u32 blend)
+{
+	switch (format) {
