...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D5BC52A24AA
	for <lists+linux-kernel@lfdr.de>; Mon,  2 Nov 2020 07:15:22 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728150AbgKBGOS (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 2 Nov 2020 01:14:18 -0500
Received: from mx0a-0016f401.pphosted.com ([67.231.148.174]:26546 "EHLO
        mx0b-0016f401.pphosted.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1728104AbgKBGOP (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 2 Nov 2020 01:14:15 -0500
Received: from pps.filterd (m0045849.ppops.net [127.0.0.1])
        by mx0a-0016f401.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id 0A26BKiF030837;
        Sun, 1 Nov 2020 22:14:13 -0800
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=marvell.com; h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-type; s=pfpt0220; bh=SF0Utwr3dVApFlFcDeXGHvr3ccgwKMGnw/4+T4TL16o=;
 b= yw== 
Received: from sc-exch01.marvell.com ([199.233.58.181])
        by mx0a-0016f401.pphosted.com with ESMTP id 34h59mpnhu-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-SHA384 bits=256 verify=NOT);
        Sun, 01 Nov 2020 22:14:13 -0800
...
Received: from maili.marvell.com (10.69.176.80) by DC5-EXCH02.marvell.com
 ...
 Transport; Sun, 1 Nov 2020 22:14:11 -0800
Received: from hyd1583.caveonetworks.com (unknown [10.29.37.44])
        by maili.marvell.com (Postfix) with ESMTP id ED1133F703F;
        Sun,  1 Nov 2020 22:14:06 -0800 (PST)
...
Subject: [PATCH net-next 11/13] octeontx2-af: Handle PF-VF mac address changes
Date:   Mon, 2 Nov 2020 11:41:20 +0530
Message-ID: <20201102061122.8915-12-naveenm@marvell.com>
...
+	u8		default_mac[ETH_ALEN]; /* MAC address from FWdata */
 	...
 	u16			bcast_mce_idx;
@@ -584,6 +585,7 @@ int nix_get_nixlf(struct rvu *rvu, u16 pcifunc, int *nixlf, int *nix_blkaddr);
