...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E76002DD22F
	for <lists+linux-kernel@lfdr.de>; Thu, 17 Dec 2020 14:32:40 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727294AbgLQNcH (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 17 Dec 2020 08:32:07 -0500
Received: from mout.gmx.net ([212.227.15.19]:33469 "EHLO mout.gmx.net"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726012AbgLQNcH (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 17 Dec 2020 08:32:07 -0500
...
Subject: [bisected] Re: regression:  nouveau fifo: fault 01 ==> channel 1:
 killed ==> dead desktop
...
> [  961.579832] nouveau 0000:01:00.0: fifo: fault 01 [WRITE] at 000000000=
069f000 engine 15 [CE0] client 01 [HUB/CE0] reason 02 [PTE] on channel 1 [=
00ff73d000 DRM]
> [  961.579840] nouveau 0000:01:00.0: fifo: channel 1: killed
> [  961.579844] nouveau 0000:01:00.0: fifo: runlist 0: scheduled for reco=
very
> [  961.579850] nouveau 0000:01:00.0: fifo: runlist 4: scheduled for reco=
very
> [  961.579853] nouveau 0000:01:00.0: fifo: engine 4: scheduled for recov=
ery
>
...
Date:   Thu Oct 29 13:59:20 2020 +1000
    ...
    Link: https://patchwork.freedesktop.org/patch/msgid/20201109005432.861=
936-4-airlied@gmail.com
...
# bad: [bcc68bd8161261ceeb1a4ab02b5265758944f90d] Merge tag 'auxdisplay-fo=
r-linus-v5.11' of git://github.com/ojeda/linux
...
# bad: [a1ac250a82a5e97db71f14101ff7468291a6aaef] fbcon: Avoid using FNTCH=
ARCNT() and hard-coded built-in font charcount
git bisect bad a1ac250a82a5e97db71f14101ff7468291a6aaef
# good: [a39855076c859b7f6c58ed4da8f195a2a6cd3c7b] drm/cma-helper: Make de=
fault object functions the default
git bisect good a39855076c859b7f6c58ed4da8f195a2a6cd3c7b
# bad: [5f1f10998e7f0ba98a8efc27009cd9a11cff6616] drm/atmel-hlcdc/atmel_hl=
cdc_plane: Staticise local function 'atmel_hlcdc_plane_setup_scaler()'
...
# bad: [0c8c0659d7475b6304b67374caf15b56cf0be4f9] drm/nouveau/ttm: use mul=
tihop
git bisect bad 0c8c0659d7475b6304b67374caf15b56cf0be4f9
# good: [23d6ab1d4c503660632e7b18cbb571d62d9bf792] drm: remove pgprot_decr=
ypted() before calls to io_remap_pfn_range()
git bisect good 23d6ab1d4c503660632e7b18cbb571d62d9bf792
# good: [ebdf565169af006ee3be8c40eecbfc77d28a3b84] drm/ttm: add multihop i=
nfrastrucutre (v3)
git bisect good ebdf565169af006ee3be8c40eecbfc77d28a3b84
# good: [f5a89a5cae812a39993be32e74c8ed7856b1e2b2] drm/amdgpu/ttm: use mul=
tihop
