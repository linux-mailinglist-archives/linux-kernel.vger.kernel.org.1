...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 37D512A64AD
	for <lists+linux-kernel@lfdr.de>; Wed,  4 Nov 2020 13:52:45 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729871AbgKDMwg (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 4 Nov 2020 07:52:36 -0500
Received: from mga12.intel.com ([192.55.52.136]:50663 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1729309AbgKDMwg (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 4 Nov 2020 07:52:36 -0500
IronPort-SDR: zodew5fuDvspIprKeWRGq/5w/rWEu73TUkDQLQqCmOwo9JjIkuZdGSZu39U/d+pH6g6EmdOLCI
 o0rK18bQnqLA==
X-IronPort-AV: E=McAfee;i="6000,8403,9794"; a="148490992"
X-IronPort-AV: E=Sophos;i="5.77,450,1596524400"; 
   d="gz'50?scan'50,208,50";a="148490992"
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 04 Nov 2020 04:52:34 -0800
IronPort-SDR: 4A3izjYxQAJ69lVmxiRtpteUZSyl8wQg4edCgg1m5nDEyy0JOlMPR2f2RWuM1knvzKJuJulQrt
 HYyHJIzjq1bQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,450,1596524400"; 
   d="gz'50?scan'50,208,50";a="363424693"
Received: from lkp-server02.sh.intel.com (HELO e61783667810) ([10.239.97.151])
  by FMSMGA003.fm.intel.com with ESMTP; 04 Nov 2020 04:52:32 -0800
Received: from kbuild by e61783667810 with local (Exim 4.92)
        (envelope-from <lkp@intel.com>)
        id 1kaIH9-0000v3-VQ; Wed, 04 Nov 2020 12:52:31 +0000
Date:   Wed, 4 Nov 2020 20:51:55 +0800
From:   kernel test robot <lkp@intel.com>
To:     Luc Van Oostenryck <luc.vanoostenryck@gmail.com>
Cc:     kbuild-all@lists.01.org, linux-kernel@vger.kernel.org,
        Miguel Ojeda <miguel.ojeda.sandonis@gmail.com>
Subject: drivers/usb/gadget/function/rndis.c:1126:21: sparse: sparse:
 incorrect type in argument 1 (different address spaces)
Message-ID: <202011042042.Pf0bmnqi-lkp@intel.com>
MIME-Version: 1.0
...
e184d5fcaac9676 drivers/usb/gadget/rndis.c          Alexey Dobriyan       2008-05-14  1117  static ssize_t rndis_proc_write(struct file *file, const char __user *buffer,
e184d5fcaac9676 drivers/usb/gadget/rndis.c          Alexey Dobriyan       2008-05-14  1118  				size_t count, loff_t *ppos)
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1119  {
d9dda78bad87959 drivers/usb/gadget/rndis.c          Al Viro               2013-03-31  1120  	rndis_params *p = PDE_DATA(file_inode(file));
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1121  	u32 speed = 0;
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1122  	int i, fl_speed = 0;
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1123  
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1124  	for (i = 0; i < count; i++) {
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1125  		char c;
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16 @1126  		if (get_user(c, buffer))
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1127  			return -EFAULT;
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1128  		switch (c) {
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1129  		case '0':
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1130  		case '1':
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1131  		case '2':
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1132  		case '3':
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1133  		case '4':
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1134  		case '5':
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1135  		case '6':
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1136  		case '7':
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1137  		case '8':
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1138  		case '9':
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1139  			fl_speed = 1;
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1140  			speed = speed * 10 + c - '0';
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1141  			break;
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1142  		case 'C':
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1143  		case 'c':
868055fdd2399cb drivers/usb/gadget/function/rndis.c Andrzej Pietrasiewicz 2015-05-18  1144  			rndis_signal_connect(p);
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1145  			break;
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1146  		case 'D':
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1147  		case 'd':
868055fdd2399cb drivers/usb/gadget/function/rndis.c Andrzej Pietrasiewicz 2015-05-18  1148  			rndis_signal_disconnect(p);
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1149  			break;
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1150  		default:
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1151  			if (fl_speed) p->speed = speed;
33376c1c043c050 drivers/usb/gadget/rndis.c          David Brownell        2008-08-18  1152  			else pr_debug("%c is not valid\n", c);
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1153  			break;
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1154  		}
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1155  
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1156  		buffer++;
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1157  	}
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1158  
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1159  	return count;
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1160  }
^1da177e4c3f415 drivers/usb/gadget/rndis.c          Linus Torvalds        2005-04-16  1161  
...
H4sICCttol8AAy5jb25maWcAlDzbcts2sO/9Ck760j60lS3HieeMH0AQJFGRBAOAkuwXjmsr
