...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 71FBB27B8B4
	for <lists+linux-kernel@lfdr.de>; Tue, 29 Sep 2020 02:13:19 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727263AbgI2ANP (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 28 Sep 2020 20:13:15 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45764 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727243AbgI2ANN (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 28 Sep 2020 20:13:13 -0400
Received: from mail-pj1-x1061.google.com (mail-pj1-x1061.google.com [IPv6:2607:f8b0:4864:20::1061])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CD363C0613D4
        for <linux-kernel@vger.kernel.org>; Mon, 28 Sep 2020 17:13:12 -0700 (PDT)
Received: by mail-pj1-x1061.google.com with SMTP id b17so1670703pji.1
        for <linux-kernel@vger.kernel.org>; Mon, 28 Sep 2020 17:13:12 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=+jcLmVJYZMbRqN7ECn7yUCgTiEV+NJj0i5jhGYY0814=;
        b=GLQEC6aj9xKelpFhyiuWjT+7RyBWThFGmk4dRF1YEPzex4LIB3CB5CdoW1/Ulhxuuh
         r5mwrFh2ad6OJZvukclC8amveJZhd5wSJTP5Vv35kqt2rUS7HaUscSC1yUloMApIzz8z
         MhAppdSZ/xCNGD1zFgigYvySMbGfMdzkWfwHo=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=+jcLmVJYZMbRqN7ECn7yUCgTiEV+NJj0i5jhGYY0814=;
        b=
X-Gm-Message-State: AOAM530LAbBItnwMVbOPtiqxY3KYmEmVpRDYwF8U+K0RDM9YPV3lfRq+
        Uvkj43rwGvG40eGS5+Zik52BuXCYIGHNQM/dGoI2UOfJTNHt
X-Google-Smtp-Source: ABdhPJwW4NSQdhlF38I4OJcEzpvO9ycw50hqdn3BNN16vNYqj11VzZNHFqsjv7qRY80dULYXET/7mxgzmC/4
X-Received: by 2002:a17:902:ff07:b029:d1:e5fa:aa1d with SMTP id f7-20020a170902ff07b02900d1e5faaa1dmr1821805plj.84.1601338392139;
        Mon, 28 Sep 2020 17:13:12 -0700 (PDT)
Received: from lbrmn-lnxub113.broadcom.net ([192.19.228.250])
        by smtp-relay.gmail.com with ESMTPS id t1sm1047973pjr.8.2020.09.28.17.13.07
...
Subject: [PATCH v4 10/16] misc: bcm-vk: add VK messaging support
Date:   Mon, 28 Sep 2020 17:12:03 -0700
Message-Id: <20200929001209.16393-11-scott.branden@broadcom.com>
...
---
 ...
 drivers/misc/bcm-vk/bcm_vk.h     |  120 ++++
 drivers/misc/bcm-vk/bcm_vk_dev.c |  304 +++++++-
...
index a2d1577663ec..e4a1486f7209 100644
...
index 11fa748a4fbd..b96a7c291ddd 100644
...
+
 enum pci_barno {
 	BAR_0 = 0,
 	BAR_1,
@@ -282,9 +328,27 @@ struct bcm_vk_proc_mon_info {
...
@@ -375,11 +475,31 @@ static inline bool bcm_vk_msgq_marker_valid(struct bcm_vk *vk)
 }
...
index 6a35a9a088b6..5a793c0e728f 100644
...
@@ -283,6 +473,32 @@ static int bcm_vk_sync_card_info(struct bcm_vk *vk)
 	return 0;
 }
...
+
 ...
 {
@@ -500,6 +716,17 @@ static int bcm_vk_load_image_by_type(struct bcm_vk *vk, u32 load_type,
...
+
 			...
 			if (ret) {
@@ -650,12 +877,20 @@ static int bcm_vk_trigger_autoload(struct bcm_vk *vk)
 }
...
@@ -666,6 +901,14 @@ static void bcm_vk_wq_handler(struct work_struct *work)
...
@@ -814,6 +1057,9 @@ static long bcm_vk_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
...
@@ -846,6 +1092,12 @@ static int bcm_vk_probe(struct pci_dev *pdev, const struct pci_device_id *ent)
 		return -ENOMEM;
...
@@ -908,11 +1160,35 @@ static int bcm_vk_probe(struct pci_dev *pdev, const struct pci_device_id *ent)
 		}
 	}
...
+		goto err_irq;
 	...
 	vk->devid = id;
@@ -942,6 +1218,12 @@ static int bcm_vk_probe(struct pci_dev *pdev, const struct pci_device_id *ent)
...
@@ -975,6 +1257,9 @@ static int bcm_vk_probe(struct pci_dev *pdev, const struct pci_device_id *ent)
 		}
 	}
...
+
 	...
 	return 0;
@@ -999,6 +1284,13 @@ static int bcm_vk_probe(struct pci_dev *pdev, const struct pci_device_id *ent)
 err_ida_remove:
...
+
 err_iounmap:
 	for (i = 0; i < MAX_BAR; i++) {
 		if (vk->bar[i])
@@ -1034,6 +1326,8 @@ static void bcm_vk_remove(struct pci_dev *pdev)
...
@@ -1047,6 +1341,7 @@ static void bcm_vk_remove(struct pci_dev *pdev)
...
+	bcm_vk_msg_remove(vk);
 	...
 	if (vk->tdma_vaddr)
@@ -1059,6 +1354,11 @@ static void bcm_vk_remove(struct pci_dev *pdev)
