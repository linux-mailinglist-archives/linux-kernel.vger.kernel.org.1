...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 4DAA019CB34
	for <lists+linux-kernel@lfdr.de>; Thu,  2 Apr 2020 22:27:19 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2390189AbgDBU1R (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 2 Apr 2020 16:27:17 -0400
Received: from mail.kernel.org ([198.145.29.99]:39592 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1730837AbgDBU1R (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 2 Apr 2020 16:27:17 -0400
Received: from localhost (83-86-89-107.cable.dynamic.v4.ziggo.nl [83.86.89.107])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id DAFFB2078B;
        Thu,  2 Apr 2020 20:27:12 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1585859233;
        bh=7MjU+8hd3J1+jIHbJ27lJPS2KPb5PgRSFgr07qArlzM=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=XSAdp5FFpidYt5niP+RGaYI4L3vMeNnuxLygrITN9q0KSRhJmuMoNJV0BrvmoAstC
         Okrr5rgCBKYUYucUSq6h2Gmw0XrB+Ue1QxJCNf8j4tsNOa1LXanNVsyclV81yntnF6
         ov5T6upDFdd3k7Qn/8b/RECyyk8RxGocr2Z+ArG0=
Date:   Thu, 2 Apr 2020 22:27:10 +0200
From:   Greg KH <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org,
        Andrew Morton <akpm@linux-foundation.org>,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, Jiri Slaby <jslaby@suse.cz>
Subject: Re: Linux 5.5.15
Message-ID: <20200402202710.GB3259729@kroah.com>
References: <20200402202701.GA3259729@kroah.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20200402202701.GA3259729@kroah.com>
...
@@ -275,6 +275,16 @@ crypto: crypto@1c15000 {
...
@@ -2988,7 +2990,7 @@ static int bpf_task_fd_query(const union bpf_attr *attr,
...
--- a/net/mac80211/tx.c
+++ b/net/mac80211/tx.c
@@ -3604,8 +3604,26 @@ struct sk_buff *ieee80211_tx_dequeue(struct ieee80211_hw *hw,
 	tx.skb = skb;
