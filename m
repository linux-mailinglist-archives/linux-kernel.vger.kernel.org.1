...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8FFC52CBDCC
	for <lists+linux-kernel@lfdr.de>; Wed,  2 Dec 2020 14:08:18 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730086AbgLBNGd (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 2 Dec 2020 08:06:33 -0500
Received: from esa3.microchip.iphmx.com ([68.232.153.233]:37213 "EHLO
        esa3.microchip.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1730078AbgLBNGc (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 2 Dec 2020 08:06:32 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1606914389; x=1638450389;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=g279fgxQNAD7Pac9vQW9R9+/mTj7nAuIiovMibOzjoI=;
  b=X8Hhdn1aFTKGgzW893LlVMmmHTsP2vuEHHwwnDfMM8pbc+ZSCZjVy5gZ
   H9LnJnx9VU4YErN38v7D36sLK+UEAAMK+AtghPBeJbtD02rMXa120kh+5
   c3yvycxcidDXAGyYGtmuWTVRJ4esk3yv01FC6EUo1xRtTtw6+RFVH7k8k
   AGb7qFQdMKMrtRaVSILNJojibA5xuTuKES/L+vZs3dWLcI+D8Ie4YqwEi
   SN3yaF2Gai95qdz32WBtVYmmS4baUOY1of+M7Y4FCL7Opfp9S+baoYL9M
   +11+zscK85FWxGPXH6obLEVEXNmrcOR4A4wMADr9v9ycGN70GfMVZGMn3
   g==;
IronPort-SDR: 
X-IronPort-AV: E=Sophos;i="5.78,386,1599548400"; 
   d="scan'208";a="101125137"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa3.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 02 Dec 2020 06:04:58 -0700
Received: from chn-vm-ex01.mchp-main.com (10.10.85.143) by
 chn-vm-ex02.mchp-main.com (10.10.85.144) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1979.3; Wed, 2 Dec 2020 06:04:54 -0700
Received: from mchp-dev-shegelun.microchip.com (10.10.115.15) by
 chn-vm-ex01.mchp-main.com (10.10.85.143) with Microsoft SMTP Server id
 15.1.1979.3 via Frontend Transport; Wed, 2 Dec 2020 06:04:52 -0700
...
Subject: [PATCH v7 3/4] phy: Add Sparx5 ethernet serdes PHY driver
Date:   Wed, 2 Dec 2020 14:04:37 +0100
Message-ID: <20201202130438.3330228-4-steen.hegelund@microchip.com>
...
new file mode 100644
index 000000000000..bd15f219630f
--- /dev/null
...
+	{ TARGET_SD_CMU,          0x610808000 }, /* sd_cmu_0 */
+	{ TARGET_SD_CMU + 1,      0x610810000 }, /* sd_cmu_1 */
+	{ TARGET_SD_CMU + 2,      0x610818000 }, /* sd_cmu_2 */
+	{ TARGET_SD_CMU + 3,      0x610820000 }, /* sd_cmu_3 */
+	{ TARGET_SD_CMU + 4,      0x610828000 }, /* sd_cmu_4 */
+	{ TARGET_SD_CMU + 5,      0x610830000 }, /* sd_cmu_5 */
+	{ TARGET_SD_CMU + 6,      0x610838000 }, /* sd_cmu_6 */
+	{ TARGET_SD_CMU + 7,      0x610840000 }, /* sd_cmu_7 */
+	{ TARGET_SD_CMU + 8,      0x610848000 }, /* sd_cmu_8 */
+	{ TARGET_SD_CMU_CFG,      0x610850000 }, /* sd_cmu_cfg_0 */
+	{ TARGET_SD_CMU_CFG + 1,  0x610858000 }, /* sd_cmu_cfg_1 */
+	{ TARGET_SD_CMU_CFG + 2,  0x610860000 }, /* sd_cmu_cfg_2 */
+	{ TARGET_SD_CMU_CFG + 3,  0x610868000 }, /* sd_cmu_cfg_3 */
+	{ TARGET_SD_CMU_CFG + 4,  0x610870000 }, /* sd_cmu_cfg_4 */
+	{ TARGET_SD_CMU_CFG + 5,  0x610878000 }, /* sd_cmu_cfg_5 */
+	{ TARGET_SD_CMU_CFG + 6,  0x610880000 }, /* sd_cmu_cfg_6 */
+	{ TARGET_SD_CMU_CFG + 7,  0x610888000 }, /* sd_cmu_cfg_7 */
+	{ TARGET_SD_CMU_CFG + 8,  0x610890000 }, /* sd_cmu_cfg_8 */
+	{ TARGET_SD6G_LANE,       0x610898000 }, /* sd6g_lane_0 */
+	{ TARGET_SD6G_LANE + 1,   0x6108a0000 }, /* sd6g_lane_1 */
+	{ TARGET_SD6G_LANE + 2,   0x6108a8000 }, /* sd6g_lane_2 */
+	{ TARGET_SD6G_LANE + 3,   0x6108b0000 }, /* sd6g_lane_3 */
+	{ TARGET_SD6G_LANE + 4,   0x6108b8000 }, /* sd6g_lane_4 */
+	{ TARGET_SD6G_LANE + 5,   0x6108c0000 }, /* sd6g_lane_5 */
+	{ TARGET_SD6G_LANE + 6,   0x6108c8000 }, /* sd6g_lane_6 */
+	{ TARGET_SD6G_LANE + 7,   0x6108d0000 }, /* sd6g_lane_7 */
+	{ TARGET_SD6G_LANE + 8,   0x6108d8000 }, /* sd6g_lane_8 */
+	{ TARGET_SD6G_LANE + 9,   0x6108e0000 }, /* sd6g_lane_9 */
+	{ TARGET_SD6G_LANE + 10,  0x6108e8000 }, /* sd6g_lane_10 */
+	{ TARGET_SD6G_LANE + 11,  0x6108f0000 }, /* sd6g_lane_11 */
+	{ TARGET_SD6G_LANE + 12,  0x6108f8000 }, /* sd6g_lane_12 */
+	{ TARGET_SD10G_LANE,      0x610900000 }, /* sd10g_lane_0 */
+	{ TARGET_SD10G_LANE + 1,  0x610908000 }, /* sd10g_lane_1 */
+	{ TARGET_SD10G_LANE + 2,  0x610910000 }, /* sd10g_lane_2 */
+	{ TARGET_SD10G_LANE + 3,  0x610918000 }, /* sd10g_lane_3 */
+	{ TARGET_SD_LANE,         0x6109a8000 }, /* sd_lane_0 */
+	{ TARGET_SD_LANE + 1,     0x6109b0000 }, /* sd_lane_1 */
+	{ TARGET_SD_LANE + 2,     0x6109b8000 }, /* sd_lane_2 */
+	{ TARGET_SD_LANE + 3,     0x6109c0000 }, /* sd_lane_3 */
+	{ TARGET_SD_LANE + 4,     0x6109c8000 }, /* sd_lane_4 */
+	{ TARGET_SD_LANE + 5,     0x6109d0000 }, /* sd_lane_5 */
+	{ TARGET_SD_LANE + 6,     0x6109d8000 }, /* sd_lane_6 */
+	{ TARGET_SD_LANE + 7,     0x6109e0000 }, /* sd_lane_7 */
+	{ TARGET_SD_LANE + 8,     0x6109e8000 }, /* sd_lane_8 */
+	{ TARGET_SD_LANE + 9,     0x6109f0000 }, /* sd_lane_9 */
+	{ TARGET_SD_LANE + 10,    0x6109f8000 }, /* sd_lane_10 */
+	{ TARGET_SD_LANE + 11,    0x610a00000 }, /* sd_lane_11 */
+	{ TARGET_SD_LANE + 12,    0x610a08000 }, /* sd_lane_12 */
+	{ TARGET_SD_LANE + 13,    0x610a10000 }, /* sd_lane_13 */
+	{ TARGET_SD_LANE + 14,    0x610a18000 }, /* sd_lane_14 */
+	{ TARGET_SD_LANE + 15,    0x610a20000 }, /* sd_lane_15 */
+	{ TARGET_SD_LANE + 16,    0x610a28000 }, /* sd_lane_16 */
+	{ TARGET_SD_CMU + 9,      0x610c08000 }, /* sd_cmu_9 */
+	{ TARGET_SD_CMU + 10,     0x610c10000 }, /* sd_cmu_10 */
+	{ TARGET_SD_CMU + 11,     0x610c18000 }, /* sd_cmu_11 */
+	{ TARGET_SD_CMU + 12,     0x610c20000 }, /* sd_cmu_12 */
+	{ TARGET_SD_CMU + 13,     0x610c28000 }, /* sd_cmu_13 */
+	{ TARGET_SD_CMU_CFG + 9,  0x610c30000 }, /* sd_cmu_cfg_9 */
+	{ TARGET_SD_CMU_CFG + 10, 0x610c38000 }, /* sd_cmu_cfg_10 */
+	{ TARGET_SD_CMU_CFG + 11, 0x610c40000 }, /* sd_cmu_cfg_11 */
+	{ TARGET_SD_CMU_CFG + 12, 0x610c48000 }, /* sd_cmu_cfg_12 */
+	{ TARGET_SD_CMU_CFG + 13, 0x610c50000 }, /* sd_cmu_cfg_13 */
+	{ TARGET_SD10G_LANE + 4,  0x610c58000 }, /* sd10g_lane_4 */
+	{ TARGET_SD10G_LANE + 5,  0x610c60000 }, /* sd10g_lane_5 */
+	{ TARGET_SD10G_LANE + 6,  0x610c68000 }, /* sd10g_lane_6 */
+	{ TARGET_SD10G_LANE + 7,  0x610c70000 }, /* sd10g_lane_7 */
+	{ TARGET_SD10G_LANE + 8,  0x610c78000 }, /* sd10g_lane_8 */
+	{ TARGET_SD10G_LANE + 9,  0x610c80000 }, /* sd10g_lane_9 */
+	{ TARGET_SD10G_LANE + 10, 0x610c88000 }, /* sd10g_lane_10 */
+	{ TARGET_SD10G_LANE + 11, 0x610c90000 }, /* sd10g_lane_11 */
+	{ TARGET_SD25G_LANE,      0x610c98000 }, /* sd25g_lane_0 */
+	{ TARGET_SD25G_LANE + 1,  0x610ca0000 }, /* sd25g_lane_1 */
+	{ TARGET_SD25G_LANE + 2,  0x610ca8000 }, /* sd25g_lane_2 */
+	{ TARGET_SD25G_LANE + 3,  0x610cb0000 }, /* sd25g_lane_3 */
+	{ TARGET_SD25G_LANE + 4,  0x610cb8000 }, /* sd25g_lane_4 */
+	{ TARGET_SD25G_LANE + 5,  0x610cc0000 }, /* sd25g_lane_5 */
+	{ TARGET_SD25G_LANE + 6,  0x610cc8000 }, /* sd25g_lane_6 */
+	{ TARGET_SD25G_LANE + 7,  0x610cd0000 }, /* sd25g_lane_7 */
+	{ TARGET_SD_LANE + 17,    0x610d58000 }, /* sd_lane_17 */
+	{ TARGET_SD_LANE + 18,    0x610d60000 }, /* sd_lane_18 */
+	{ TARGET_SD_LANE + 19,    0x610d68000 }, /* sd_lane_19 */
+	{ TARGET_SD_LANE + 20,    0x610d70000 }, /* sd_lane_20 */
+	{ TARGET_SD_LANE + 21,    0x610d78000 }, /* sd_lane_21 */
+	{ TARGET_SD_LANE + 22,    0x610d80000 }, /* sd_lane_22 */
+	{ TARGET_SD_LANE + 23,    0x610d88000 }, /* sd_lane_23 */
+	{ TARGET_SD_LANE + 24,    0x610d90000 }, /* sd_lane_24 */
+	{ TARGET_SD_LANE_25G,     0x610d98000 }, /* sd_lane_25g_25 */
+	{ TARGET_SD_LANE_25G + 1, 0x610da0000 }, /* sd_lane_25g_26 */
+	{ TARGET_SD_LANE_25G + 2, 0x610da8000 }, /* sd_lane_25g_27 */
+	{ TARGET_SD_LANE_25G + 3, 0x610db0000 }, /* sd_lane_25g_28 */
+	{ TARGET_SD_LANE_25G + 4, 0x610db8000 }, /* sd_lane_25g_29 */
+	{ TARGET_SD_LANE_25G + 5, 0x610dc0000 }, /* sd_lane_25g_30 */
+	{ TARGET_SD_LANE_25G + 6, 0x610dc8000 }, /* sd_lane_25g_31 */
+	{ TARGET_SD_LANE_25G + 7, 0x610dd0000 }, /* sd_lane_25g_32 */
+};
+
...
+
+		priv->regs[iomap->id] = iomem + iomap->phys - iores->start;
+	}
+	for (idx = 0; idx < SPX5_SERDES_MAX; idx++) {
