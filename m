...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 16F75275E16
	for <lists+linux-kernel@lfdr.de>; Wed, 23 Sep 2020 19:00:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726718AbgIWRAX (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 23 Sep 2020 13:00:23 -0400
Received: from mga03.intel.com ([134.134.136.65]:38130 "EHLO mga03.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726419AbgIWRAW (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 23 Sep 2020 13:00:22 -0400
IronPort-SDR: HQ4ExIVT+wi/YXecQ6+t0HcE+TiAup5oX3UEoSDRn3PJOkf7FFFzEa3weOtL60/+Ad9L4k5Vbq
 HQVS6dGGaNww==
X-IronPort-AV: E=McAfee;i="6000,8403,9753"; a="161028440"
X-IronPort-AV: E=Sophos;i="5.77,293,1596524400"; 
   d="scan'208";a="161028440"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Sep 2020 10:00:19 -0700
IronPort-SDR: uV9g8gNr0tN+sCFhhOxsJ4Q5rWtsNITIwN7hJm655HbPynZ5zNP40k8uFWTU+yWyVkgYP0/KBb
 dHnyty+3hH9A==
X-IronPort-AV: E=Sophos;i="5.77,293,1596524400"; 
   d="scan'208";a="347424812"
Received: from dwillia2-desk3.jf.intel.com (HELO dwillia2-desk3.amr.corp.intel.com) ([10.54.39.16])
  by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Sep 2020 10:00:17 -0700
Subject: [PATCH v9 1/2] x86,
...
Date:   Wed, 23 Sep 2020 09:41:33 -0700
Message-ID: <160087929294.3520.12013578778066801369.stgit@dwillia2-desk3.amr.corp.intel.com>
...
index f43a78bde670..00cf438635bc 100644
...
@@ -2062,7 +2061,7 @@ void mce_disable_bank(int bank)
 	and older.
...
+ * mce=recovery force enable copy_mc_fragile()
 ...
 {
@@ -2670,13 +2669,10 @@ static void __init mcheck_debugfs_init(void)
...
index 1b10717c9321..1047b536f665 100644
...
index 5e40786c8f12..d812eef23a32 100644
--- a/lib/iov_iter.c
+++ b/lib/iov_iter.c
...
@@ -695,7 +695,7 @@ static size_t copy_pipe_to_iter_mcsafe(const void *addr, size_t bytes,
 }
...
index 90a66891441a..cf2d076f6ba5 100644
...
@@ -3283,7 +3283,7 @@ static struct platform_driver nfit_test_driver = {
...
@@ -3300,7 +3300,7 @@ static void mcsafe_test_init(char *dst, char *src, size_t size)
 		src[i] = (char) i;
 }
...
+static bool copy_mc_test_validate(unsigned char *dst, unsigned char *src,
 ...
 {
 	size_t i;
@@ -3321,12 +3321,12 @@ static bool mcsafe_test_validate(unsigned char *dst, unsigned char *src,
 	return true;
 }
...
@@ -3344,31 +3344,31 @@ void mcsafe_test(void)
...
@@ -3380,8 +3380,8 @@ void mcsafe_test(void)
 		}
 	}
...
@@ -3392,7 +3392,7 @@ static __init int nfit_test_init(void)
 	libnvdimm_test();
 	acpi_nfit_test();
 	device_dax_test();
-	mcsafe_test();
