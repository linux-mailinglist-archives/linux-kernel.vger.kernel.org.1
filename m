...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6C73C2D7969
	for <lists+linux-kernel@lfdr.de>; Fri, 11 Dec 2020 16:33:42 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727969AbgLKPbm (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 11 Dec 2020 10:31:42 -0500
Received: from mail.kernel.org ([198.145.29.99]:47406 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1733271AbgLKPaM (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 11 Dec 2020 10:30:12 -0500
...
Subject: Re: Linux 5.4.83
Date:   Fri, 11 Dec 2020 15:13:06 +0100
Message-Id: <160769598587118@kroah.com>
X-Mailer: git-send-email 2.29.2
In-Reply-To: <160769598511141@kroah.com>
References: <160769598511141@kroah.com>
MIME-Version: 1.0
...
index e520dee34490..eee1aa092ede 100644
--- a/Makefile
+++ b/Makefile
@@ -1,7 +1,7 @@
...
index 3a9f79d18f6b..1b7b0d0c3ebd 100644
...
index 154f27be8bfc..a51ffeea6d87 100644
...
index 8cd745ef8c7b..fae5b00cbccf 100644
...
index 306c3a0902ba..cbe7e2503394 100644
...
index 9543c9816eed..9d3f42fd6352 100644
...
index 5a89c1cfdaa9..6ff6b5710dd4 100644
...
index 3ec090adcdae..76e9d3e2f9f2 100644
...
index 4e414b06192e..08ae59a6e873 100644
...
index 667db23f10ee..bf3c2a1159e6 100644
--- a/drivers/md/dm.c
+++ b/drivers/md/dm.c
...
+	}
 	...
 	if (!tgt) {
@@ -493,7 +495,6 @@ static int dm_blk_report_zones(struct gendisk *disk, sector_t sector,
...
-	__acquires(md->io_barrier)
 {
 	...
 	struct dm_table *map;
@@ -527,7 +528,6 @@ static int dm_prepare_ioctl(struct mapped_device *md, int *srcu_idx,
 }
...
index 496ae07aca5e..c7ec3d24eabc 100644
...
index 6ad985e98e42..5a906101498d 100644
...
index cae7caf5ab28..5a1174a8e2ba 100644
...
index bae7cf70ee17..1c5c172315de 100644
...
index 9917dbce2470..472804c3f44d 100644
...
index 245588f691e7..2f932b61b69a 100644
...
index f8bcfc506f4a..d2cfb8ff9ca8 100644
...
index 390bc4b25045..fdaefbe92490 100644
...
index 741c72bd499a..c2ef23865300 100644
...
index f5df2a4195c2..ab9eeb5ff8e5 100644
--- a/fs/cifs/connect.c
+++ b/fs/cifs/connect.c
...
index 5c0375e7440f..f34767eedf38 100644
--- a/fs/coredump.c
+++ b/fs/coredump.c
...
index 5d9d93ca0db7..c056ed5c6df3 100644
--- a/fs/gfs2/rgrp.c
+++ b/fs/gfs2/rgrp.c
...
index 03cf5856d76f..d0bb9e3bcec1 100644
...
index c776b8e86fbc..5a60de39457c 100644
...
index fbba31baef53..cbb76ffaf499 100644
...
index f7cac11a9005..67af28f03cf4 100644
...
index 0f1f6b06b7f3..d12c1943f6f3 100644
--- a/mm/list_lru.c
+++ b/mm/list_lru.c
...
index ff83ffe7a910..7947633d3ced 100644
--- a/mm/swapfile.c
+++ b/mm/swapfile.c
...
index fd6ef6d26846..306d3584a441 100644
--- a/net/can/af_can.c
+++ b/net/can/af_can.c
...
index 3cc4daa856d6..16ae770f049d 100644
...
index 51391d5d2265..459b7c054711 100644
...
index c480549a7f94..3aa4306ca39f 100644
...
index 62dc728bf93c..921f8f45b17f 100644
...
index 2374adb50558..e3d79f8b69d8 100644
--- a/net/tipc/core.c
+++ b/net/tipc/core.c
...
index 3042f654e0af..e119c4a88d63 100644
--- a/net/tipc/core.h
+++ b/net/tipc/core.h
...
index 2de3cec9929d..2498ce8b83c1 100644
--- a/net/tipc/net.c
+++ b/net/tipc/net.c
@@ -105,12 +105,6 @@
...
index b7f2e364eb99..a6a4dba13673 100644
--- a/net/tipc/net.h
+++ b/net/tipc/net.h
@@ -42,6 +42,7 @@
...
index e1750bdbe51f..3caea6d58c9a 100644
...
index fb9f1a90238b..e728df6145ad 100644
...
index bd802cbc1165..c804c15debc6 100644
...
index 37a4c390750b..d7f0ae8f3c44 100644
