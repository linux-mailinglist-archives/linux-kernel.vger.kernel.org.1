...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id AD0951B8B6C
	for <lists+linux-kernel@lfdr.de>; Sun, 26 Apr 2020 04:45:47 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726151AbgDZCpm (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 25 Apr 2020 22:45:42 -0400
Received: from us-smtp-1.mimecast.com ([207.211.31.81]:25482 "EHLO
        us-smtp-delivery-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1726110AbgDZCpm (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 25 Apr 2020 22:45:42 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1587869113;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc; bh=dFfKWG1eUuYd9YtJVWkz6JX/oQLA3oQ+e3Y7vJ2i38A=;
        b=Nzq1nA9jMpeS1GrZ/XvMN/hvB8Htf/jGjdcTgIU1tgTKDEucjilOreD5M9azETWItpRelm
        2FI7pL488vN09C8NK6GDMVCZPORfSFPSzZtzCbLjmW6tR2lPOPdEzmZkqwdGBXLta4wEKE
        rBTe0KC7qw+bgrlJKOvwaQJ9//o9CQg=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-423-bPjSEQzTPrGmDSZ_plaXuw-1; Sat, 25 Apr 2020 22:45:03 -0400
X-MC-Unique: bPjSEQzTPrGmDSZ_plaXuw-1
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.phx2.redhat.com [10.5.11.15])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 51241107ACCD;
        Sun, 26 Apr 2020 02:45:02 +0000 (UTC)
Received: from localhost (ovpn-112-86.rdu2.redhat.com [10.10.112.86])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 7158B5D714;
        Sun, 26 Apr 2020 02:45:01 +0000 (UTC)
From:   Clark Williams <williams@redhat.com>
Subject: [ANNOUNCE] 4.14.177-rt82
Date:   Sun, 26 Apr 2020 01:40:19 -0000
Message-ID: <158786521955.71892.5304198022118468681@theseus.lan>
...
I'm pleased to announce the 4.14.177-rt82 stable release.
...
You can get this release via the git tree at:
  ...
  branch: v4.14-rt
  Head SHA1: 6b24e91362c8e9c78750c3325e757033856be392

Or to build 4.14.177-rt82 directly, the following patches should be applied:

  https://www.kernel.org/pub/linux/kernel/v4.x/linux-4.14.tar.xz

  https://www.kernel.org/pub/linux/kernel/v4.x/patch-4.14.177.xz

  https://www.kernel.org/pub/linux/kernel/projects/rt/4.14/patch-4.14.177-rt82.patch.xz


You can also build from 4.14.175-rt81 by applying the incremental patch:

  https://www.kernel.org/pub/linux/kernel/projects/rt/4.14/incr/patch-4.14.175-rt81-rt82.patch.xz

Enjoy!
Clark

Changes from v4.14.175-rt81:
---
...
Clark Williams (2):
      Merge tag 'v4.14.177' into v4.14-rt
      Linux 4.14.177-rt82
...
Documentation/sound/hd-audio/index.rst             |   1 +
 ...
 usr/Kconfig                                        |  22 ++--
 269 files changed, 1906 insertions(+), 1144 deletions(-)
---
...
index 3b792208fbc2..d81fb98737f7 100644
--- a/Makefile
+++ b/Makefile
@@ -1,7 +1,7 @@
...
@@ -163,8 +163,11 @@ END_FTR_SECTION_IFCLR(CPU_FTR_ARCH_300)
...
@@ -198,8 +201,16 @@ END_FTR_SECTION_IFCLR(CPU_FTR_ARCH_300)
 	SAVE_NVGPRS(r1)
...
index 77a5493e003c..1b38b7b3cb6c 100644
--- a/arch/x86/entry/entry_32.S
+++ b/arch/x86/entry/entry_32.S
@@ -1074,6 +1074,7 @@ ENTRY(int3)
 END(int3)
...
@@ -1692,6 +1757,19 @@ static int rdtgroup_mkdir_ctrl_mon(struct kernfs_node *parent_kn,
 	return ret;
 }
...
index 93fcebf950aa..e8d2e7ee4e68 100644
--- a/arch/x86/kvm/x86.c
+++ b/arch/x86/kvm/x86.c
@@ -6645,7 +6645,7 @@ static void update_cr8_intercept(struct kvm_vcpu *vcpu)
...
@@ -6672,7 +6672,7 @@ static int inject_pending_event(struct kvm_vcpu *vcpu, bool req_int_win)
 	}
...
@@ -6713,7 +6713,7 @@ static int inject_pending_event(struct kvm_vcpu *vcpu, bool req_int_win)
...
@@ -7159,7 +7159,7 @@ static int vcpu_enter_guest(struct kvm_vcpu *vcpu)
 			goto out;
 		}
...
@@ -7367,7 +7367,7 @@ static inline int vcpu_block(struct kvm *kvm, struct kvm_vcpu *vcpu)
...
@@ -8591,6 +8591,13 @@ int kvm_arch_create_memslot(struct kvm *kvm, struct kvm_memory_slot *slot,
 {
 	int i;
...
+
 	for (i = 0; i < KVM_NR_PAGE_SIZES; ++i) {
 		...
 		unsigned long ugfn;
@@ -8664,6 +8671,10 @@ int kvm_arch_prepare_memory_region(struct kvm *kvm,
...
index ca9ea624f159..4c1de9ad8098 100644
--- a/block/blk-ioc.c
+++ b/block/blk-ioc.c
@@ -88,6 +88,7 @@ static void ioc_destroy_icq(struct io_cq *icq)
...
@@ -231,15 +232,21 @@ static void __ioc_clear_queue(struct list_head *icq_list)
 {
 	unsigned long flags;
...
index a6314b82273e..b41bbd3dfdd3 100644
--- a/block/blk-mq.c
+++ b/block/blk-mq.c
@@ -2771,6 +2771,10 @@ static void __blk_mq_update_nr_hw_queues(struct blk_mq_tag_set *set,
...
@@ -1919,6 +1926,7 @@ static int null_add_dev(struct nullb_device *dev)
...
index 459e222aad28..e610ec881bec 100644
--- a/drivers/char/random.c
+++ b/drivers/char/random.c
@@ -2194,11 +2194,11 @@ struct batched_entropy {
...
@@ -2211,15 +2211,6 @@ u64 get_random_u64(void)
...
@@ -2244,9 +2235,6 @@ u32 get_random_u32(void)
 	struct batched_entropy *batch;
 	static void *previous;
...
index f6fd541e1401..7be4f1770c67 100644
--- a/drivers/firmware/efi/efi.c
+++ b/drivers/firmware/efi/efi.c
@@ -553,7 +553,7 @@ int __init efi_config_parse_tables(void *config_tables, int count, int sz,
 		}
 	}
...
index c8c83f84aced..42eaeae86bb8 100644
...
@@ -1042,10 +1043,12 @@ static bool drm_dp_port_setup_pdt(struct drm_dp_mst_port *port)
...
+		}
 	...
 	return send_link;
@@ -2037,6 +2040,7 @@ int drm_dp_mst_topology_mgr_set_mst(struct drm_dp_mst_topology_mgr *mgr, bool ms
 	int ret = 0;
...
+	mutex_lock(&mgr->payload_lock);
 	...
 	if (mst_state == mgr->mst_state)
 		goto out_unlock;
@@ -2095,7 +2099,10 @@ int drm_dp_mst_topology_mgr_set_mst(struct drm_dp_mst_topology_mgr *mgr, bool ms
...
+		       mgr->max_payloads * sizeof(mgr->proposed_vcpis[0]));
 		...
 		mgr->vcpi_mask = 0;
@@ -2103,6 +2110,7 @@ int drm_dp_mst_topology_mgr_set_mst(struct drm_dp_mst_topology_mgr *mgr, bool ms
...
index 419655af60d2..2a140eea223e 100644
...
index 5fe58c6b2c60..c4fced54449a 100644
--- a/drivers/irqchip/irq-gic-v3-its.c
+++ b/drivers/irqchip/irq-gic-v3-its.c
@@ -2613,12 +2613,18 @@ static int its_vpe_set_irqchip_state(struct irq_data *d,
 	return 0;
 }
...
index d1720c24d82f..34643d1102d9 100644
--- a/drivers/net/wireless/mac80211_hwsim.c
+++ b/drivers/net/wireless/mac80211_hwsim.c
@@ -3130,9 +3130,9 @@ static int hwsim_new_radio_nl(struct sk_buff *msg, struct genl_info *info)
 		param.no_vif = true;
...
+				  GFP_KERNEL);
 		if (!hwname)
 			return -ENOMEM;
 		param.hwname = hwname;
@@ -3171,9 +3171,9 @@ static int hwsim_del_radio_nl(struct sk_buff *msg, struct genl_info *info)
...
index 1e6253f1e070..7802663efe33 100644
...
@@ -811,9 +812,6 @@ static int qcom_glink_rx_data(struct qcom_glink *glink, size_t avail)
 		return -EAGAIN;
 	}
...
index 53b3a43160f4..ed616b0bc563 100644
...
@@ -185,6 +181,9 @@ static void glink_smem_tx_write(struct qcom_glink_pipe *glink_pipe,
...
@@ -216,6 +215,7 @@ struct qcom_glink *qcom_glink_smem_register(struct device *parent,
...
@@ -298,7 +298,7 @@ struct qcom_glink *qcom_glink_smem_register(struct device *parent,
 	return glink;
...
index 81fcd68202a2..92e738d30cf9 100644
...
@@ -2480,7 +2482,21 @@ void merge_reloc_roots(struct reloc_control *rc)
...
index ce1bbc779c75..940f9e1e6751 100644
--- a/fs/buffer.c
+++ b/fs/buffer.c
@@ -1390,6 +1390,17 @@ void __breadahead(struct block_device *bdev, sector_t block, unsigned size)
 }
...
@@ -845,9 +870,6 @@ static struct dentry *open_root_dentry(struct ceph_fs_client *fsc,
 	return root;
 }
...
index 244c0e0cce7b..4ed53cb84ce4 100644
--- a/fs/exec.c
+++ b/fs/exec.c
@@ -1375,7 +1375,7 @@ void setup_new_exec(struct linux_binprm * bprm)
...
index 48505fade7e1..100a342880d1 100644
--- a/include/linux/buffer_head.h
+++ b/include/linux/buffer_head.h
@@ -229,6 +229,8 @@ struct buffer_head *__getblk_gfp(struct block_device *bdev, sector_t block,
...
@@ -361,6 +363,12 @@ sb_breadahead(struct super_block *sb, sector_t block)
...
index 6e3eded72d8e..0faf621b1624 100644
--- a/include/linux/sched.h
+++ b/include/linux/sched.h
@@ -871,8 +871,8 @@ struct task_struct {
...
index b486b094a626..b6bb272931cc 100644
--- a/kernel/cpu.c
+++ b/kernel/cpu.c
@@ -2133,10 +2133,8 @@ int cpuhp_smt_disable(enum cpuhp_smt_control ctrlval)
 		 */
...
@@ -2147,7 +2145,6 @@ int cpuhp_smt_enable(void)
...
index 35c025237c35..e3e13f4810a0 100644
--- a/kernel/locking/lockdep.c
+++ b/kernel/locking/lockdep.c
@@ -1298,9 +1298,11 @@ unsigned long lockdep_count_forward_deps(struct lock_class *class)
 	this.class = class;
...
+	current->lockdep_recursion = 0;
 	...
 	return ret;
@@ -1325,9 +1327,11 @@ unsigned long lockdep_count_backward_deps(struct lock_class *class)
 	this.class = class;
...
index 5d01ac590d4c..4e438533b2aa 100644
--- a/kernel/locking/locktorture.c
+++ b/kernel/locking/locktorture.c
@@ -722,10 +722,10 @@ static void __torture_print_stats(char *page,
...
index 04c41c997a0e..d816eee9715b 100644
...
index b5dd145b4a26..cbb69501af99 100644
--- a/kernel/signal.c
+++ b/kernel/signal.c
@@ -1769,7 +1769,7 @@ bool do_notify_parent(struct task_struct *tsk, int sig)
...
index e6428554f060..a2e7804d3fa4 100644
...
index 3c40d4174052..ccdeb5529fd3 100644
...
index 866a218505e4..cdd782b81e43 100644
--- a/mm/page_alloc.c
+++ b/mm/page_alloc.c
@@ -4385,11 +4385,11 @@ void *page_frag_alloc(struct page_frag_cache *nc,
...
@@ -4405,10 +4405,10 @@ void *page_frag_alloc(struct page_frag_cache *nc,
 		size = nc->size;
 #endif
...
index 481a795b94c7..9ca91415fdb0 100644
--- a/mm/slub.c
+++ b/mm/slub.c
...
index aec1d8c7b746..d4a311b9a495 100644
--- a/mm/vmalloc.c
+++ b/mm/vmalloc.c
@@ -1685,7 +1685,6 @@ static void *__vmalloc_area_node(struct vm_struct *area, gfp_t gfp_mask,
...
@@ -1693,13 +1692,16 @@ static void *__vmalloc_area_node(struct vm_struct *area, gfp_t gfp_mask,
 	} else {
...
index abc88087bbf0..54aac77b0997 100644
--- a/net/core/dev.c
+++ b/net/core/dev.c
@@ -3592,7 +3592,8 @@ EXPORT_SYMBOL(netdev_max_backlog);
