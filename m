...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B4FC51B6CDE
	for <lists+linux-kernel@lfdr.de>; Fri, 24 Apr 2020 06:57:00 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726584AbgDXE4w (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 24 Apr 2020 00:56:52 -0400
Received: from mx0a-00128a01.pphosted.com ([148.163.135.77]:41790 "EHLO
        mx0a-00128a01.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726515AbgDXE4q (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 24 Apr 2020 00:56:46 -0400
Received: from pps.filterd (m0167088.ppops.net [127.0.0.1])
        by mx0a-00128a01.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id 03O4o3kP030543;
        Fri, 24 Apr 2020 00:56:30 -0400
Received: from nwd2mta4.analog.com ([137.71.173.58])
        by mx0a-00128a01.pphosted.com with ESMTP id 30fud7n643-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Fri, 24 Apr 2020 00:56:30 -0400
Received: from SCSQMBX11.ad.analog.com (scsqmbx11.ad.analog.com [10.77.17.10])
        by nwd2mta4.analog.com (8.14.7/8.14.7) with ESMTP id 03O4uSGG047672
        (version=TLSv1/SSLv3 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128 verify=FAIL);
        Fri, 24 Apr 2020 00:56:29 -0400
...
Received: from zeus.spd.analog.com (10.64.82.11) by SCSQMBX10.ad.analog.com
 ...
 Transport; Thu, 23 Apr 2020 21:56:27 -0700
Received: from localhost.localdomain ([10.48.65.12])
        by zeus.spd.analog.com (8.15.1/8.15.1) with ESMTP id 03O4uGpo017534;
        Fri, 24 Apr 2020 00:56:24 -0400
From:   Alexandru Ardelean <alexandru.ardelean@analog.com>
To:     <linux-iio@vger.kernel.org>, <linux-kernel@vger.kernel.org>
CC:     <lars@metafoo.de>, <jic23@kernel.org>, <pmeerw@pmeerw.net>,
        Alexandru Ardelean <alexandru.ardelean@analog.com>
Subject: [PATCH v4 5/7] iio: buffer,event: duplicate chardev creation for buffers & events
Date:   Fri, 24 Apr 2020 07:56:40 +0300
Message-ID: <20200424045642.4903-6-alexandru.ardelean@analog.com>
...
index bcf5f561c4b5..3daa44deee80 100644
...
@@ -1109,6 +1151,17 @@ void iio_disable_all_buffers(struct iio_dev *indio_dev)
...
+
 static ssize_t iio_buffer_store_enable(struct device *dev,
 				       ...
 				       const char *buf,
@@ -1336,6 +1389,29 @@ void iio_buffer_free_sysfs_and_mask(struct iio_dev *indio_dev)
...
index 03f5b5baeb94..07b9aac9ffa5 100644
--- a/drivers/iio/industrialio-core.c
+++ b/drivers/iio/industrialio-core.c
@@ -1578,79 +1578,6 @@ struct iio_dev *devm_iio_device_alloc(struct device *dev, int sizeof_priv)
 }
...
-
 ...
 {
 	int i, j;
@@ -1676,15 +1603,6 @@ static int iio_check_unique_scan_index(struct iio_dev *indio_dev)
...
-
 ...
 {
 	int ret;
@@ -1735,16 +1653,17 @@ int __iio_device_register(struct iio_dev *indio_dev, struct module *this_mod)
...
+	} else
 	...
 	if (ret < 0)
@@ -1770,13 +1689,15 @@ EXPORT_SYMBOL(__iio_device_register);
  **/
...
index d63884a54939..88b0f2100180 100644
