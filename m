...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C4CAB2AF8E3
	for <lists+linux-kernel@lfdr.de>; Wed, 11 Nov 2020 20:21:45 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727732AbgKKTV2 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 11 Nov 2020 14:21:28 -0500
Received: from mga09.intel.com ([134.134.136.24]:50568 "EHLO mga09.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725949AbgKKTVR (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 11 Nov 2020 14:21:17 -0500
IronPort-SDR: fyjxxq8ou+kBG8sLIxhUFQQFTE809IFQBhzXw8mYRTuHlSEDqkVcpGC/DlBJuFidwmsDIz9R0u
 A1CciAu5tIKw==
X-IronPort-AV: E=McAfee;i="6000,8403,9802"; a="170367981"
X-IronPort-AV: E=Sophos;i="5.77,470,1596524400"; 
   d="scan'208";a="170367981"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 11 Nov 2020 11:21:16 -0800
IronPort-SDR: +IZ0b+BPnKqTUCFEZU8zql/Ce6yP+02AXl9bUqpSm13SI2cv5VBjkhiq3faY3LOWZhomZzd3Ol
 DRXgOgo4N5+A==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,470,1596524400"; 
   d="scan'208";a="354942652"
...
Subject: [PATCH v2 2/4] x86/bus_lock: Handle warn and fatal in #DB for bus lock
Date:   Wed, 11 Nov 2020 19:20:46 +0000
Message-Id: <20201111192048.2602065-3-fenghua.yu@intel.com>
...
- Remove DR6_RESERVED change (PeterZ).
 ...
 arch/x86/kernel/cpu/intel.c          | 128 ++++++++++++++++++++++-----
...
index 59a1e3ce3f14..42277eb2e9b1 100644
...
@@ -1115,14 +1129,50 @@ bool handle_guest_split_lock(unsigned long ip)
 }
...
@@ -1162,7 +1212,7 @@ static const struct x86_cpu_id split_lock_cpu_ids[] __initconst = {
 	{}
 };
...
+static void __init split_lock_setup(struct cpuinfo_x86 *c)
 {
 	...
 	u64 ia32_core_caps;
@@ -1189,5 +1239,43 @@ void __init cpu_set_core_cap_bits(struct cpuinfo_x86 *c)
 	}
