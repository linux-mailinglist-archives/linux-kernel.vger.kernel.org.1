...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 917C327B8AE
	for <lists+linux-kernel@lfdr.de>; Tue, 29 Sep 2020 02:12:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727166AbgI2AMq (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 28 Sep 2020 20:12:46 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45678 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727136AbgI2AMo (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 28 Sep 2020 20:12:44 -0400
Received: from mail-pj1-x1062.google.com (mail-pj1-x1062.google.com [IPv6:2607:f8b0:4864:20::1062])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id EBC7BC0613D3
        for <linux-kernel@vger.kernel.org>; Mon, 28 Sep 2020 17:12:43 -0700 (PDT)
Received: by mail-pj1-x1062.google.com with SMTP id bw23so1690930pjb.2
        for <linux-kernel@vger.kernel.org>; Mon, 28 Sep 2020 17:12:43 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=8kdiEWawW50vjPtxzsOLdqgg/FDhqSjrEuy55zLHz2g=;
        b=bBe2yGVZ2sIYB7fvf31/HuOjBpM7+GmAaThWNEi5PKHzJLvPcSMDawURA5k/kCs9VB
         JOFhdCN/SkqVF6GQ4stb/cVn7w5ukpPLXMpM6O/z7xrGA6ADqDqr/P+WiuMPjOavjYAZ
         hizBv5EB75gzHbfL1nVR2N52Z4qHbFxRv3AZg=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=8kdiEWawW50vjPtxzsOLdqgg/FDhqSjrEuy55zLHz2g=;
        b=
X-Gm-Message-State: AOAM533h/R3qAxlVffYoLcraFUYlE1Kot0Dzv54++brFQaMWps71qxd1
        q+mHUq0HH8zkVyAz27/Mf7olgmXVAgrPCKdIGVm5j4D3POGS
X-Google-Smtp-Source: ABdhPJyhxOU7NAU0FybyqBLkoWZx+3se/wrqhjnZLpMYE9GCJGLBK+sjsP0hdAHC3FnFjkTwc8tawe67c3j4
X-Received: by 2002:a17:90a:17cb:: with SMTP id q69mr1427958pja.44.1601338363319;
        Mon, 28 Sep 2020 17:12:43 -0700 (PDT)
Received: from lbrmn-lnxub113.broadcom.net ([192.19.228.250])
        by smtp-relay.gmail.com with ESMTPS id t1sm1047973pjr.8.2020.09.28.17.12.39
...
Subject: [PATCH v4 03/16] misc: bcm-vk: add autoload support
Date:   Mon, 28 Sep 2020 17:11:56 -0700
Message-Id: <20200929001209.16393-4-scott.branden@broadcom.com>
...
index bb24efb1b9fb..36f04fd0a54e 100644
...
@@ -84,8 +704,53 @@ static int bcm_vk_probe(struct pci_dev *pdev, const struct pci_device_id *ent)
 		}
 	}
...
+
 err_iounmap:
 	for (i = 0; i < MAX_BAR; i++) {
 		if (vk->bar[i])
@@ -94,6 +759,10 @@ static int bcm_vk_probe(struct pci_dev *pdev, const struct pci_device_id *ent)
...
+
 	...
 	pci_dev_put(pdev);
@@ -106,6 +775,22 @@ static void bcm_vk_remove(struct pci_dev *pdev)
 	int i;
...
@@ -116,6 +801,38 @@ static void bcm_vk_remove(struct pci_dev *pdev)
 	pci_disable_device(pdev);
 }
...
@@ -128,6 +845,7 @@ static struct pci_driver pci_driver = {
 	.id_table = bcm_vk_ids,
 	.probe    = bcm_vk_probe,
