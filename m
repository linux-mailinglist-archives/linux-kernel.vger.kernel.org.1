...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 618E21B7073
	for <lists+linux-kernel@lfdr.de>; Fri, 24 Apr 2020 11:15:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726911AbgDXJPk (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 24 Apr 2020 05:15:40 -0400
Received: from mail.kernel.org ([198.145.29.99]:50880 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726523AbgDXJPj (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 24 Apr 2020 05:15:39 -0400
Received: from localhost (83-86-89-107.cable.dynamic.v4.ziggo.nl [83.86.89.107])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id D978F20724;
        Fri, 24 Apr 2020 09:15:32 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1587719733;
        bh=J81TcuC5xRIPsioUzWiyPZXHrqQt5kKqcoNJFjqv4Yk=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=eskI0SrBg8mdVQnfqgzHDy/1l82BvyBsrZkJVVwUe73tpUk7onE57LiXxJBUewELs
         yvC9BjWfOa9IfnzZJOugPK9vqBC5g6vU4RUVExyrjyfjvnSX/+dcuTRCSiFEHnq85O
         WPYsCFR/NIMzexUf2ROVjuPID0OyAJIg4RYUygSg=
Date:   Fri, 24 Apr 2020 11:15:31 +0200
From:   Greg KH <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org,
        Andrew Morton <akpm@linux-foundation.org>,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, Jiri Slaby <jslaby@suse.cz>
Subject: Re: Linux 5.4.35
Message-ID: <20200424091531.GB359915@kroah.com>
References: <20200424091525.GA359915@kroah.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <20200424091525.GA359915@kroah.com>
...
+
 	...
 	return 0;
@@ -1406,7 +1437,6 @@ static int vmbus_bus_init(void)
 	hv_remove_vmbus_irq();
...
@@ -1849,7 +1852,7 @@ static ssize_t f2fs_quota_write(struct super_block *sb, int type,
...
+						page, fsdata);
 		...
 		towrite -= tocopy;
 		off += tocopy;
@@ -3488,7 +3491,8 @@ static int f2fs_fill_super(struct super_block *sb, void *data, int silent)
