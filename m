...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D13CC2B6728
	for <lists+linux-kernel@lfdr.de>; Tue, 17 Nov 2020 15:11:50 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729000AbgKQOKY (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 17 Nov 2020 09:10:24 -0500
Received: from mx2.cyber.ee ([193.40.6.72]:56952 "EHLO mx2.cyber.ee"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728176AbgKQOKW (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 17 Nov 2020 09:10:22 -0500
To:     LKML <linux-kernel@vger.kernel.org>
From:   Meelis Roos <mroos@linux.ee>
Subject: VGA text console corruption in 5.9.0 and 5.10-rc4
Message-ID: <654af2d2-69ee-ebd8-3e1e-28175f79ceb7@linux.ee>
Date:   Tue, 17 Nov 2020 16:09:05 +0200
...
5.9 introduces VGA console corruption in one of my test PC-s (I do not have VGA console on most). The PC has Intel D2550MUD2 board with Atom D2550.

The symptoms include:
* missing screen updates on VT switch
* fragments of other VT-s appear during scrolling (kernel compilation output on visible VT1 scrolls up, sometimes it includes 5 or so lines from curses application on VT2 or its scroll-back history)
* missing up-scrolling of lines/fragments in curses applications. Visible in make menuconfig and mc
...
5.9.0 and todays 5.10-rc4+git exhibit this behavior if I let them use VGA text console.
...
[    0.000000] Linux version 5.10.0-rc4-00067-g9c87c9f41245 (mroos@d2550) (gcc (Debian 10.2.0-15) 10.2.0, GNU ld (GNU Binutils for Debian) 2.35.1) #8 SMP Tue Nov 17 14:39:11 EET 2020
[    0.000000] DMI:  /D2550MUD2, BIOS MUCDT10N.86A.0075.2013.0427.1548 04/27/2013
[    0.001878] MTRR default type: uncachable
[    0.001881] MTRR fixed ranges enabled:
[    0.001885]   00000-9FFFF write-back
[    0.001888]   A0000-BFFFF uncachable
[    0.001891]   C0000-DFFFF write-protect
[    0.001893]   E0000-FFFFF uncachable
[    0.001896] MTRR variable ranges enabled:
[    0.001900]   0 base 000000000 mask F80000000 write-back
[    0.001903]   1 base 07F000000 mask FFF000000 uncachable
[    0.001907]   2 base 0FFE00000 mask FFFE00000 write-protect
[    0.001909]   3 disabled
[    0.001911]   4 disabled
[    0.001913]   5 disabled
[    0.001915]   6 disabled
[    0.002024] x86/PAT: Configuration [0-7]: WB  WC  UC- UC  WB  WP  UC- WT
[    0.028625] ACPI: HPET id: 0x8086a201 base: 0xfed00000
[    0.028636] smpboot: Allowing 4 CPUs, 0 hotplug CPUs
[    0.095056] Console: colour VGA+ 80x25
[    0.099221] printk: console [tty0] enabled
[    0.226357] smpboot: CPU0: Intel(R) Atom(TM) CPU D2550   @ 1.86GHz (family: 0x6, model: 0x36, stepping: 0x1)[    0.095056] Console: colour VGA+ 80x25
...
[    0.238692] PCI: MMCONFIG for domain 0000 [bus 00-3f] at [mem 0xe0000000-0xe3ffffff] (base 0xe0000000)
[    0.238756] PCI: MMCONFIG at [mem 0xe0000000-0xe3ffffff] reserved in E820
