...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B3D761AFE7D
	for <lists+linux-kernel@lfdr.de>; Sun, 19 Apr 2020 23:58:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726124AbgDSV6k (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 19 Apr 2020 17:58:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37958 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-FAIL-OK-FAIL)
        by vger.kernel.org with ESMTP id S1725848AbgDSV6k (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 19 Apr 2020 17:58:40 -0400
Received: from mail-lf1-x142.google.com (mail-lf1-x142.google.com [IPv6:2a00:1450:4864:20::142])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7C29FC061A0C
        for <linux-kernel@vger.kernel.org>; Sun, 19 Apr 2020 14:58:39 -0700 (PDT)
Received: by mail-lf1-x142.google.com with SMTP id k28so6274859lfe.10
        for <linux-kernel@vger.kernel.org>; Sun, 19 Apr 2020 14:58:39 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linux-foundation.org; s=google;
        h=mime-version:from:date:message-id:subject:to
         :content-transfer-encoding;
        bh=ptuf1f365UK4/TH5qdeyMbh4neOkPRZX1BQrD8HFsME=;
        b=Hwp9c7sHOkntOt2fX9N2DAAulgJLnF9pJjosB/Mun9E/K2zPOkvkePslYXrE+g1Enz
         K/aHuljgQfdPbJwbn20dt5nt+U0S2sJmK2FE+AJwO4/PMgmTWLs9Teq9Ge+hJ7J9KxEo
         gNgCDocaIiKQHuh7lIP/4qeQNzMGakDy0GJQs=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:mime-version:from:date:message-id:subject:to
         :content-transfer-encoding;
        bh=ptuf1f365UK4/TH5qdeyMbh4neOkPRZX1BQrD8HFsME=;
        b=
X-Gm-Message-State: AGi0PuYjK1hrdA+GhWhaMySHLSfmZTZ7rCbA1WIR3fbl1C/zYXRc3kIg
        kcelqVSaoyWYFdVLAKAh9kqtlQ60uvc=
X-Google-Smtp-Source: APiQypI4tO+J4+qRSRxSh6Of+wR38znG/jwWfOgVuP7JovWU6uLExKzcIqMa6j0ASHDQTO4W4GDYOQ==
X-Received: by 2002:ac2:57cc:: with SMTP id k12mr8251319lfo.69.1587333517076;
        Sun, 19 Apr 2020 14:58:37 -0700 (PDT)
Received: from mail-lj1-f176.google.com (mail-lj1-f176.google.com. [209.85.208.176])
        by smtp.gmail.com with ESMTPSA id y199sm24292869lfa.80.2020.04.19.14.58.36
        for <linux-kernel@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Sun, 19 Apr 2020 14:58:36 -0700 (PDT)
Received: by mail-lj1-f176.google.com with SMTP id f18so1789238lja.13
        for <linux-kernel@vger.kernel.org>; Sun, 19 Apr 2020 14:58:36 -0700 (PDT)
X-Received: by 2002:a2e:87d9:: with SMTP id v25mr3795590ljj.241.1587333515484;
 Sun, 19 Apr 2020 14:58:35 -0700 (PDT)
MIME-Version: 1.0
From:   Linus Torvalds <torvalds@linux-foundation.org>
Date:   Sun, 19 Apr 2020 14:58:19 -0700
X-Gmail-Original-Message-ID: <CAHk-=wiQsJu-ZFjt7+c9FVD5R40khtZiihrT+7O3UaVvHYz=HQ@mail.gmail.com>
Message-ID: <CAHk-=wiQsJu-ZFjt7+c9FVD5R40khtZiihrT+7O3UaVvHYz=HQ@mail.gmail.com>
...
ing
      ...
      libbpf: Always specify expected_attach_type on program load if suppor=
ted

Ann T Ropea (1):
      hwmon: (drivetemp) Use drivetemp's true module name in Kconfig sectio=
n
...
Colin Ian King (5):
      bpf: Fix spelling mistake "arithmatic" -> "arithmetic" in test_verifi=
er
...
Darrick J. Wong (2):
      xfs: fix partially uninitialized structure in xfs_reflink_remap_exten=
t
...
Eugene Syromiatnikov (4):
      btrfs: re-instantiate the removed BTRFS_SUBVOL_CREATE_ASYNC definitio=
n
      clone3: fix cgroup argument sanity check
      clone3: add a check for the user struct size if CLONE_INTO_CGROUP is =
set
...
Geert Uytterhoeven (2):
      m68k: Drop redundant generic-y +=3D hardirq.h
...
Gustavo A. R. Silva (29):
      hv: hyperv_vmbus.h: Replace zero-length array with flexible-array mem=
ber
...
flexible-array member
      ...
      sched: topology.h: Replace zero-length array with flexible-array memb=
er
...
Jens Axboe (4):
      ...
      io_uring: only post events in io_poll_remove_all() if we completed so=
me
...
Jones Syue (1):
      cifs: improve read performance for page size 64KB & cache=3Dstrict
& vers=3D2.1+
...
Mauro Carvalho Chehab (6):
      ...
      MAINTAINERS: dt: fix pointers for ARM Integrator, Versatile and RealV=
iew
...
Toke H=C3=B8iland-J=C3=B8rgensen (2):
      ...
      selftests/bpf: Check for correct program attach/detach in xdp_attach =
test

Tommi Rantala (2):
      blk-wbt: Use tracepoint_string() for wbt_step tracepoint string liter=
als
...
Zhiqiang Liu (2):
      ...
      signal: use kill_proc_info instead of kill_pid_info in kill_something=
_info
