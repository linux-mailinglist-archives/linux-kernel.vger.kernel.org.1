Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

From: Srini <srini.raju@purelifi.com>
...
+	ccflags-y += -DTYPE_AP
+endif
diff --git a/drivers/staging/purelifi/TODO b/drivers/staging/purelifi/TODO
new file mode 100644
index 000000000000..f18a4ebf59a2
--- /dev/null
...
+<info@purelifi.com>
diff --git a/drivers/staging/purelifi/chip.c b/drivers/staging/purelifi/chip.c
new file mode 100644
index 000000000000..d21d562a2b75
--- /dev/null
...
+
+MODULE_LICENSE("GPL");
diff --git a/drivers/staging/purelifi/chip.h b/drivers/staging/purelifi/chip.h
new file mode 100644
index 000000000000..7e688f48c828
--- /dev/null
+++ b/drivers/staging/purelifi/chip.h
@@ -0,0 +1,101 @@
+/* SPDX-License-Identifier: GNU General Public License v2.0 or later */
+/* Copyright (c) 2015-2020 pureLiFi Ltd
+ * All rights reserved.
...
+}
+#endif /* _LF_X_CHIP_H */
diff --git a/drivers/staging/purelifi/def.h b/drivers/staging/purelifi/def.h
new file mode 100644
index 000000000000..e724818e8bdd
--- /dev/null
+++ b/drivers/staging/purelifi/def.h
@@ -0,0 +1,70 @@
+/* SPDX-License-Identifier: GNU General Public License v2.0 or later */
+/* Copyright (c) 2015-2020 pureLiFi Ltd
+ * All rights reserved.
...
diff --git a/drivers/staging/purelifi/log.h b/drivers/staging/purelifi/log.h
new file mode 100644
index 000000000000..9cff1d3394d2
--- /dev/null
+++ b/drivers/staging/purelifi/log.h
@@ -0,0 +1,32 @@
+/* SPDX-License-Identifier: GNU General Public License v2.0 or later */
+/* Copyright (c) 2015-2020 pureLiFi Ltd
+ * All rights reserved.
...
+#endif
+#endif
diff --git a/drivers/staging/purelifi/mac.c b/drivers/staging/purelifi/mac.c
new file mode 100644
index 000000000000..99b3743c3250
--- /dev/null
+++ b/drivers/staging/purelifi/mac.c
@@ -0,0 +1,984 @@
+// SPDX-License-Identifier: GNU General Public License v2.0 or later
+/* Copyright (c) 2015-2020 pureLiFi Ltd
+ * All rights reserved.
...
+
+MODULE_LICENSE("GPL");
diff --git a/drivers/staging/purelifi/mac.h b/drivers/staging/purelifi/mac.h
new file mode 100644
index 000000000000..5cbb2a6a607c
--- /dev/null
+++ b/drivers/staging/purelifi/mac.h
@@ -0,0 +1,196 @@
+/* SPDX-License-Identifier: GNU General Public License v2.0 or later */
+/* Copyright (c) 2015-2020 pureLiFi Ltd
+ * All rights reserved.
...
+
+#endif
diff --git a/drivers/staging/purelifi/mac_usb_interface.h b/drivers/staging/purelifi/mac_usb_interface.h
new file mode 100644
index 000000000000..4e155957f6ed
--- /dev/null
+++ b/drivers/staging/purelifi/mac_usb_interface.h
@@ -0,0 +1,56 @@
+/* SPDX-License-Identifier: GNU General Public License v2.0 or later */
+/* Copyright (c) 2015-2020 pureLiFi Ltd
+ * All rights reserved.
...
+
+#endif
diff --git a/drivers/staging/purelifi/usb.c b/drivers/staging/purelifi/usb.c
new file mode 100644
index 000000000000..51581ea9e7e5
--- /dev/null
+++ b/drivers/staging/purelifi/usb.c
@@ -0,0 +1,1948 @@
+// SPDX-License-Identifier: GNU General Public License v2.0 or later
+/* Copyright (c) 2015-2020 pureLiFi Ltd
+ * All rights reserved.
...
+}
+
+int purelifi_usb_scnprint_id(struct purelifi_usb *usb, char *buffer,
+			     size_t size)
+{
...
+		printk(KERN_ERR "%s usb_register() failed. Error  %d\n",
+		       driver.name, r);
+		return r;
+	}
+
...
diff --git a/drivers/staging/purelifi/usb.h b/drivers/staging/purelifi/usb.h
new file mode 100644
index 000000000000..f6452e4e6bff
--- /dev/null
+++ b/drivers/staging/purelifi/usb.h
@@ -0,0 +1,166 @@
+/* SPDX-License-Identifier: GNU General Public License v2.0 or later */
+/* Copyright (c) 2015-2020 pureLiFi Ltd
+ * All rights reserved.
