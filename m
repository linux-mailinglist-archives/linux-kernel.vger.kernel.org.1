...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9A2402866AC
	for <lists+linux-kernel@lfdr.de>; Wed,  7 Oct 2020 20:15:05 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728883AbgJGSOl (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 7 Oct 2020 14:14:41 -0400
Received: from us-smtp-delivery-124.mimecast.com ([63.128.21.124]:31622 "EHLO
        us-smtp-delivery-124.mimecast.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1727458AbgJGSOf (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 7 Oct 2020 14:14:35 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1602094471;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=1CnOWMqS3tQltUxLy5ZaN9yQ+y89SFaTvFSwf18I1CM=;
        b=Cc2pOZKrCilstW5yCxwEOLc/fss+11bJXJsLtRPicanbcOgplTEHS/Tqt252dd0HGKT4xD
        /R+UEB+z3oS9WDk3civciWfbOcxfyzG6PWAvKtyT/i2O7JVQ4vMYk4+MtRssWcDHpnVdWm
        oobL+H3E2Elm4oxjO6SWqYCpQElawM4=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-278-8RNM2dy9PsWFiXQEPSuXvQ-1; Wed, 07 Oct 2020 14:14:27 -0400
X-MC-Unique: 8RNM2dy9PsWFiXQEPSuXvQ-1
Received: from smtp.corp.redhat.com (int-mx05.intmail.prod.int.phx2.redhat.com [10.5.11.15])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 4492B64144;
...
Received: from hpe-dl360pgen9-01.klab.eng.bos.redhat.com (hpe-dl360pgen9-01.klab.eng.bos.redhat.com [10.16.160.31])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 665ED55764;
        Wed,  7 Oct 2020 18:14:25 +0000 (UTC)
...
Subject: [PATCH net-next v3 2/5] bonding: replace use of the term master where possible
Date:   Wed,  7 Oct 2020 14:14:06 -0400
Message-Id: <20201007181409.1275639-3-jarod@redhat.com>
...
index 0c79d9e56a5e..66c47631407a 100644
...
@@ -4805,7 +4805,7 @@ static inline bool netif_is_macvlan_port(const struct net_device *dev)
...
@@ -4872,7 +4872,7 @@ static inline bool netif_is_team_port(const struct net_device *dev)
