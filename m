...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C3F1728348B
	for <lists+linux-kernel@lfdr.de>; Mon,  5 Oct 2020 13:01:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726517AbgJELBj (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 5 Oct 2020 07:01:39 -0400
Received: from smtp-fw-9102.amazon.com ([207.171.184.29]:7225 "EHLO
        smtp-fw-9102.amazon.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725891AbgJELBi (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 5 Oct 2020 07:01:38 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  d=amazon.com; i=@amazon.com; q=dns/txt; s=amazon201209;
  t=1601895694; x=1633431694;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version;
  bh=BI4YGExrQlWz4n6Egh3IKokbr03rRMYIj1iPHw+47/w=;
  b=rDGXLBEvPIW7o9Zx0hXQSVrhrW+Qd72D+EPI6G2GHyZmifqZD30rD8jq
   U/m5Lbb8V65Rhzn756IiLwhvyrTRyoIBquvh3rp40FyUCoAevSio4hd2Q
   JHW0RPdpYUEyRmdrO1Era/vOq1N3AUyHwNj/RJWI2ShOZbqx+ILDrsgoS
   w=;
X-IronPort-AV: E=Sophos;i="5.77,338,1596499200"; 
   d="scan'208";a="81594733"
Received: from sea32-co-svc-lb4-vlan3.sea.corp.amazon.com (HELO email-inbound-relay-1e-303d0b0e.us-east-1.amazon.com) ([10.47.23.38])
  by smtp-border-fw-out-9102.sea19.amazon.com with ESMTP; 05 Oct 2020 11:01:31 +0000
Received: from EX13D31EUA001.ant.amazon.com (iad12-ws-svc-p26-lb9-vlan2.iad.amazon.com [10.40.163.34])
        by email-inbound-relay-1e-303d0b0e.us-east-1.amazon.com (Postfix) with ESMTPS id 6BD59A04E1;
        Mon,  5 Oct 2020 11:01:18 +0000 (UTC)
Received: from u3f2cd687b01c55.ant.amazon.com (10.43.160.146) by
 EX13D31EUA001.ant.amazon.com (10.43.165.15) with Microsoft SMTP Server (TLS)
 id 15.0.1497.2; Mon, 5 Oct 2020 11:00:53 +0000
...
Subject: [PATCH v21 16/18] mm/damon: Add kunit tests
Date:   Mon, 5 Oct 2020 12:55:20 +0200
Message-ID: <20201005105522.23841-17-sjpark@amazon.com>
...
index e38f95d28f74..efb158cdc0fc 100644
--- a/mm/damon/Kconfig
+++ b/mm/damon/Kconfig
...
@@ -22,6 +33,17 @@ config DAMON_PRIMITIVES
...
index 908fa395bdfb..df807ffb283e 100644
--- a/mm/damon/dbgfs.c
+++ b/mm/damon/dbgfs.c
@@ -914,3 +914,5 @@ static int __init damon_dbgfs_init(void)
 }
...
index 9f33677e4807..b03200965b6d 100644
