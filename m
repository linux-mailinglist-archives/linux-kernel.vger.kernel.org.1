...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C8AEA25DB2A
	for <lists+linux-kernel@lfdr.de>; Fri,  4 Sep 2020 16:16:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730617AbgIDOQe (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 4 Sep 2020 10:16:34 -0400
Received: from relayfre-01.paragon-software.com ([176.12.100.13]:50234 "EHLO
        relayfre-01.paragon-software.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1730554AbgIDNot (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 4 Sep 2020 09:44:49 -0400
Received: from dlg2.mail.paragon-software.com (vdlg-exch-02.paragon-software.com [172.30.1.105])
        by relayfre-01.paragon-software.com (Postfix) with ESMTPS id 01FA635D;
        Fri,  4 Sep 2020 16:34:39 +0300 (MSK)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=paragon-software.com; s=mail; t=1599226479;
        bh=NL/DWQxJgMmJhjVVNHOq8ikeIYoGikeXSC9DJWS0mN4=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=r0c8+zEbaJilDk6vvR29AF4a3IUJI+EFWSSgWf1dlnwW26zDSze/wDXf/D1j5+5JB
         VcnDcOpMQ7C0iSv8OjRKvSQSTylhRwIrrmPK8l18ulK5ElticL1Igr2l13bsOzEwGR
         Qu7qxo46MnITDiuOUVfzLo70J+0Y/hd5X67Z7V2I=
Received: from fsd-lkpg.ufsd.paragon-software.com (172.30.114.105) by
 vdlg-exch-02.paragon-software.com (172.30.1.105) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1847.3; Fri, 4 Sep 2020 16:34:38 +0300
...
Subject: [PATCH v4 05/10] fs/ntfs3: Add attrib operations
Date:   Fri, 4 Sep 2020 16:32:26 +0300
Message-ID: <20200904133231.1769292-6-almaz.alexandrovich@paragon-software.com>
...
index 000000000000..df4c9b221c25
--- /dev/null
+++ b/fs/ntfs3/attrib.c
@@ -0,0 +1,1302 @@
...
+
+	total_size =
+		le64_to_cpu(attr_b->nres.total_size) + (*len << cluster_bits);
+
+repack:
+
...
new file mode 100644
index 000000000000..a349435dff66
--- /dev/null
+++ b/fs/ntfs3/xattr.c
@@ -0,0 +1,1006 @@
+// SPDX-License-Identifier: GPL-2.0
