...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 27F132A7A7C
	for <lists+linux-kernel@lfdr.de>; Thu,  5 Nov 2020 10:29:05 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731327AbgKEJ27 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 5 Nov 2020 04:28:59 -0500
Received: from mx0b-0016f401.pphosted.com ([67.231.156.173]:21924 "EHLO
        mx0b-0016f401.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1730368AbgKEJ2z (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 5 Nov 2020 04:28:55 -0500
Received: from pps.filterd (m0045851.ppops.net [127.0.0.1])
        by mx0b-0016f401.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id 0A59PwYA017417;
        Thu, 5 Nov 2020 01:28:50 -0800
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=marvell.com; h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-type; s=pfpt0220; bh=hnZcZjD8WATumtYScu7OkqLGg14ICDBZ5h4xuq6AoXw=;
 b= Pw== 
Received: from sc-exch02.marvell.com ([199.233.58.182])
        by mx0b-0016f401.pphosted.com with ESMTP id 34h7ep6mdy-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-SHA384 bits=256 verify=NOT);
        Thu, 05 Nov 2020 01:28:49 -0800
Received: from DC5-EXCH01.marvell.com (10.69.176.38) by SC-EXCH02.marvell.com
 (10.93.176.82) with Microsoft SMTP Server (TLS) id 15.0.1497.2; Thu, 5 Nov
 2020 01:28:47 -0800
Received: from maili.marvell.com (10.69.176.80) by DC5-EXCH01.marvell.com
 (10.69.176.38) with Microsoft SMTP Server id 15.0.1497.2 via Frontend
 Transport; Thu, 5 Nov 2020 01:28:48 -0800
Received: from hyd1583.caveonetworks.com (unknown [10.29.37.44])
        by maili.marvell.com (Postfix) with ESMTP id 7BD2E3F703F;
        Thu,  5 Nov 2020 01:28:44 -0800 (PST)
...
Subject: [PATCH v2 net-next 05/13] octeontx2-pf: Add support for ethtool ntuple filters
Date:   Thu, 5 Nov 2020 14:58:08 +0530
Message-ID: <20201105092816.819-6-naveenm@marvell.com>
...
index 386cb08497e4..0f33bbba4e2b 100644
...
@@ -644,4 +658,21 @@ int otx2_open(struct net_device *netdev);
...
index 000000000000..a66b19c58f51
--- /dev/null
...
index 672768630557..f85073528eb9 100644
--- a/drivers/net/ethernet/marvell/octeontx2/nic/otx2_pf.c
+++ b/drivers/net/ethernet/marvell/octeontx2/nic/otx2_pf.c
@@ -1715,7 +1715,7 @@ static void otx2_set_rx_mode(struct net_device *netdev)
...
@@ -2112,7 +2116,8 @@ static int otx2_probe(struct pci_dev *pdev, const struct pci_device_id *id)
 			       NETIF_F_GSO_UDP_L4);
...
@@ -2133,6 +2138,10 @@ static int otx2_probe(struct pci_dev *pdev, const struct pci_device_id *id)
 	if (err)
...
@@ -2304,6 +2313,7 @@ static void otx2_remove(struct pci_dev *pdev)
