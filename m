...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8085022E8E9
	for <lists+linux-kernel@lfdr.de>; Mon, 27 Jul 2020 11:25:00 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728199AbgG0JYb (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 27 Jul 2020 05:24:31 -0400
Received: from mga04.intel.com ([192.55.52.120]:61621 "EHLO mga04.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728117AbgG0JY3 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 27 Jul 2020 05:24:29 -0400
IronPort-SDR: 3tEf/CRzb/V1k1p1NyqOswaTHwq4RVrDCGr67oCOKPo3wrISWO1XtFZbHaDL/Tjt+cIxMTMwAo
 0hVhtr7jpU0Q==
X-IronPort-AV: E=McAfee;i="6000,8403,9694"; a="148455005"
X-IronPort-AV: E=Sophos;i="5.75,402,1589266800"; 
   d="scan'208";a="148455005"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 27 Jul 2020 02:24:26 -0700
IronPort-SDR: vdE6zmjyPQcCACVHY7G9K2XQRIF0THCwnSFJy/j4HvD3/iw0mqyw/3xqmJlyaN4j/ZWF/gMjdq
 45JICRFrLxOQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,402,1589266800"; 
   d="scan'208";a="303394131"
Received: from pg-nxl3.altera.com ([10.142.129.93])
  by orsmga002.jf.intel.com with ESMTP; 27 Jul 2020 02:24:23 -0700
...
Subject: [PATCH v5 09/10] net: eth: altera: add msgdma prefetcher
Date:   Mon, 27 Jul 2020 17:21:56 +0800
Message-Id: <20200727092157.115937-10-joyce.ooi@intel.com>
...
v5: hardcode poll_freq instead of reading from device tree and some minor edits
---
...
index 000000000000..518f6e04b23b
--- /dev/null
...
index 87faecee80d2..c966b8768ed5 100644
...
index 4e9da29156dd..d1b8728bfceb 100644
...
+#include "altera_msgdma_prefetcher.h"
 ...
 /* Module parameters */
@@ -1498,6 +1499,23 @@ static int altera_tse_probe(struct platform_device *pdev)
...
@@ -1756,7 +1774,29 @@ static const struct altera_dmaops altera_dtype_msgdma = {
 	.start_txdma = NULL,
 };
