...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8BDEC27DD2B
	for <lists+linux-kernel@lfdr.de>; Wed, 30 Sep 2020 01:59:48 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729475AbgI2X7k (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 29 Sep 2020 19:59:40 -0400
Received: from mx0a-00082601.pphosted.com ([67.231.145.42]:38884 "EHLO
        mx0a-00082601.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1728192AbgI2X7g (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 29 Sep 2020 19:59:36 -0400
Received: from pps.filterd (m0148461.ppops.net [127.0.0.1])
        by mx0a-00082601.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id 08TNsiBK028846
        for <linux-kernel@vger.kernel.org>; Tue, 29 Sep 2020 16:59:32 -0700
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=fb.com; h=from : to : cc : subject
 : date : message-id : in-reply-to : references : mime-version :
 content-transfer-encoding : content-type; s=facebook;
 bh=xQ07DZ6YVT+kiKig7H1ea/qrBewORu/Ppkkb3lHRKyI=;
 b=HzXsKbZOEazRoesCrsirholyCqI+0x4ip3d3xFfPg3sJ4o3zifrNH2GcqfN9YmQzE/ZG
 OneHn4Jn0ukBGj80Hlp/UdybyA9IIPv5SqAZx9dD6S23kOzz6VB76Frkc+4XI2beYXz/
 ULUFGX708/PwAskAZ9oYr26eqxtMbc+t2MU= 
Received: from maileast.thefacebook.com ([163.114.130.16])
        by mx0a-00082601.pphosted.com with ESMTP id 33v6jxax2h-2
        (version=TLSv1.2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128 verify=NOT)
        for <linux-kernel@vger.kernel.org>; Tue, 29 Sep 2020 16:59:32 -0700
Received: from intmgw003.06.prn3.facebook.com (2620:10d:c0a8:1b::d) by
 mail.thefacebook.com (2620:10d:c0a8:82::f) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1979.3; Tue, 29 Sep 2020 16:59:30 -0700
Received: by devvm1755.vll0.facebook.com (Postfix, from userid 111017)
        id 6676ED62152; Tue, 29 Sep 2020 16:59:21 -0700 (PDT)
...
Subject: [PATCH v3 1/4] mm: memcontrol: use helpers to access page's memcg data
Date:   Tue, 29 Sep 2020 16:59:17 -0700
Message-ID: <20200929235920.537849-2-guro@fb.com>
...
+
+/*
+ * clear_page_memcg - clear an association of a page with a memory cgrou=
p
+ * @page: a pointer to the page struct
+ *
...
@@ -743,15 +846,19 @@ static inline void mod_memcg_state(struct mem_cgrou=
p *memcg,
...
@@ -834,16 +941,17 @@ static inline void __mod_lruvec_page_state(struct p=
age *page,
...
=20
@@ -878,8 +986,10 @@ static inline void count_memcg_events(struct mem_cgr=
oup *memcg,
...
+
 ...
 {
 	return true;
@@ -1430,7 +1565,7 @@ static inline void mem_cgroup_track_foreign_dirty(s=
truct page *page,
...
=20
@@ -2880,7 +2871,7 @@ static void cancel_charge(struct mem_cgroup *memcg,=
...
+	VM_BUG_ON_PAGE(page_memcg(page), page);
 	 ...
 	 *
@@ -2889,7 +2880,7 @@ static void commit_charge(struct page *page, struct=
 mem_cgroup *memcg)
 	 * - lock_page_memcg()
 	 * - exclusive reference
 	 */
...
@@ -2916,6 +2906,12 @@ int memcg_alloc_page_obj_cgroups(struct page *page=
, struct kmem_cache *s,
 /*
...
@@ -3095,7 +3086,7 @@ int __memcg_kmem_charge_page(struct page *page, gfp=
_t gfp, int order)
...
@@ -3111,7 +3102,7 @@ int __memcg_kmem_charge_page(struct page *page, gfp=
_t gfp, int order)
  */
...
=20
 	if (!memcg)
@@ -3119,7 +3110,7 @@ void __memcg_kmem_uncharge_page(struct page *page, =
int order)
=20
...
@@ -3270,7 +3261,7 @@ void obj_cgroup_uncharge(struct obj_cgroup *objcg, =
size_t size)
  */
...
@@ -4654,7 +4645,7 @@ void mem_cgroup_wb_stats(struct bdi_writeback *wb, =
...
@@ -5623,14 +5614,14 @@ static int mem_cgroup_move_account(struct page *p=
age,
=20
 	/*
...
@@ -5685,13 +5676,13 @@ static int mem_cgroup_move_account(struct page *p=
age,
 	/*
...
+	 * to save space. As soon as we switch page's memory cgroup to a
 	 ...
 	 */
@@ -5700,7 +5691,7 @@ static int mem_cgroup_move_account(struct page *pag=
e,
 	css_get(&to->css);
 	css_put(&from->css);
=20
...
=20
@@ -5766,7 +5757,7 @@ static enum mc_target_type get_mctgt_type(struct vm=
_area_struct *vma,
...
@@ -5810,7 +5801,7 @@ static enum mc_target_type get_mctgt_type_thp(struc=
...
+	if (page_memcg(page) =3D=3D mc.from) {
 		...
 		if (target) {
 			get_page(page);
@@ -6793,12 +6784,12 @@ int mem_cgroup_charge(struct page *page, struct m=
...
@@ -6882,21 +6873,21 @@ static void uncharge_page(struct page *page, stru=
...
@@ -6913,7 +6904,7 @@ static void uncharge_page(struct page *page, struct=
 uncharge_gather *ug)
 	}
=20
...
=20
 	uncharge_gather_clear(&ug);
@@ -7006,11 +6997,11 @@ void mem_cgroup_migrate(struct page *oldpage, str=
uct page *newpage)
 		return;
=20
...
+	memcg =3D page_memcg(oldpage);
 	if (!memcg)
 		return;
=20
@@ -7205,7 +7196,7 @@ void mem_cgroup_swapout(struct page *page, swp_entr=
y_t entry)
...
=20
 	...
 	if (!memcg)
@@ -7226,7 +7217,7 @@ void mem_cgroup_swapout(struct page *page, swp_entr=
y_t entry)
...
@@ -7269,7 +7260,7 @@ int mem_cgroup_try_charge_swap(struct page *page, s=
wp_entry_t entry)
 	if (!cgroup_subsys_on_dfl(memory_cgrp_subsys))
 		return 0;
=20
...
--- a/mm/page_io.c
+++ b/mm/page_io.c
@@ -281,12 +281,14 @@ static inline void count_swpout_vm_event(struct pag=
e *page)
