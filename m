...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7DB6D2A0917
	for <lists+linux-kernel@lfdr.de>; Fri, 30 Oct 2020 16:05:14 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727092AbgJ3PFE (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 30 Oct 2020 11:05:04 -0400
Received: from relayfre-01.paragon-software.com ([176.12.100.13]:35450 "EHLO
        relayfre-01.paragon-software.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726977AbgJ3PE7 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 30 Oct 2020 11:04:59 -0400
Received: from dlg2.mail.paragon-software.com (vdlg-exch-02.paragon-software.com [172.30.1.105])
        by relayfre-01.paragon-software.com (Postfix) with ESMTPS id 30BB51D3B;
        Fri, 30 Oct 2020 18:04:48 +0300 (MSK)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=paragon-software.com; s=mail; t=1604070288;
        bh=keWSrM+L5cywXG7XZEJCywx1Ic82n+zJL8DJp5yvTxY=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=tBVF3qCNqZV0quEc4o+7Yosb1OlHISbcUuQuxbvqCxRWLflDvj+qzOv3DR2b/WSLG
         GMn2nvqlygNY95jvrdPDt93Jm6hfe8MNCmEBnjhpK3CfNZTzXyOIkaHRVcYv7g629u
         4M+Mg7IIacp5AXnx6AmTeXVajmJXn+IUQ+9k5Wg4=
...
Subject: [PATCH v11 04/10] fs/ntfs3: Add file operations and implementation
Date:   Fri, 30 Oct 2020 18:02:33 +0300
Message-ID: <20201030150239.3957156-5-almaz.alexandrovich@paragon-software.com>
...
---
 ...
 fs/ntfs3/run.c     | 1190 +++++++++++++++++++
 6 files changed, 6838 insertions(+)
...
index 000000000000..f8abe459c39d
--- /dev/null
+++ b/fs/ntfs3/dir.c
@@ -0,0 +1,610 @@
...
new file mode 100644
index 000000000000..38177db431b4
--- /dev/null
+++ b/fs/ntfs3/file.c
@@ -0,0 +1,1153 @@
+// SPDX-License-Identifier: GPL-2.0
...
new file mode 100644
index 000000000000..f8f762ccdbcc
--- /dev/null
...
+
+		if (!svcn) {
+			alloc = le32_to_cpu(attr->nres.alloc_size) >>
+				cluster_bits;
+			mi_p = NULL;
+		} else if (svcn != evcn + 1) {
+			err = -EINVAL;
...
+	 */
+	frame_ondisk = vmap(pages_disk, npages_disk, VM_MAP, PAGE_KERNEL);
+	if (!frame_ondisk) {
+		err = -ENOMEM;
+		goto out1;
+	}
...
new file mode 100644
index 000000000000..85321249e592
--- /dev/null
+++ b/fs/ntfs3/run.c
@@ -0,0 +1,1190 @@
+// SPDX-License-Identifier: GPL-2.0
...
+			}
+
+			//BUG_ON(bytes > NTFS3_RUN_MAX_BYTES);
+			WARN_ON(bytes > NTFS3_RUN_MAX_BYTES);
+
