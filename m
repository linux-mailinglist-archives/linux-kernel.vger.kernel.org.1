...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 733812190BB
	for <lists+linux-kernel@lfdr.de>; Wed,  8 Jul 2020 21:34:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726840AbgGHTeb (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 8 Jul 2020 15:34:31 -0400
Received: from us-smtp-delivery-1.mimecast.com ([205.139.110.120]:20974 "EHLO
        us-smtp-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1726782AbgGHTe2 (ORCPT
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        ...
        bh=tNjrHlr2+ShjChOBaSvvaxfKDc7/rEe/Dktu3iMNb7Y=;
        b=IxxS+oAAREduEw1o/S9u2axHAjfTH+Wqqq0/Tj6iSIeCtzXKiPiOomXumF2GcrC6+Uo+zb
        ADFVkvJZ7cS7C0TEeOMbLGEHTpDUNJUSsxqvsmJs3KItWgDXB5qzCr6e2rAqfqfryvxN5D
        owBdUOzB3914T1+uIJEyEfqGji3avWc=
Received: from mail-qt1-f199.google.com (mail-qt1-f199.google.com
 [209.85.160.199]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-224-trkym1hQNdGnkhVsi_qo9w-1; Wed, 08 Jul 2020 15:34:20 -0400
X-MC-Unique: trkym1hQNdGnkhVsi_qo9w-1
Received: by mail-qt1-f199.google.com with SMTP id t36so15935263qtc.16
        for <linux-kernel@vger.kernel.org>; Wed, 08 Jul 2020 12:34:20 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:mime-version:content-transfer-encoding;
        bh=tNjrHlr2+ShjChOBaSvvaxfKDc7/rEe/Dktu3iMNb7Y=;
        b=
X-Gm-Message-State: AOAM531IXIs+lpKjPGeyy0Thb61GaxG5Rc1ngcCESq8M36NuTUgvQ1bS
        S6s3EhZcMKL3PAGloyojv54YUQm0BnYuUQAUM9LtO/TnoWvgOTRE0yZ++V/LDHUPmeTN0rlHUv7
        rELWIw3NqA54nb+Mx2Hs9Hj24
X-Received: by 2002:a0c:b8a9:: with SMTP id y41mr45792763qvf.49.1594236859692;
        Wed, 08 Jul 2020 12:34:19 -0700 (PDT)
X-Google-Smtp-Source: ABdhPJxC3JPu3m6HYhAccJhfLfOCorYDt03YIksAI241lySXF5Kj+FCUgemeH/3O2kQFmNTLIZ2chQ==
X-Received: by 2002:a0c:b8a9:: with SMTP id y41mr45792698qvf.49.1594236858733;
        Wed, 08 Jul 2020 12:34:18 -0700 (PDT)
Received: from xz-x1.redhat.com ([2607:9880:19c8:6f::1f4f])
        by smtp.gmail.com with ESMTPSA id f18sm664884qtc.28.2020.07.08.12.34.17
...
Subject: [PATCH v11 04/13] KVM: X86: Implement ring-based dirty memory tracking
Date:   Wed,  8 Jul 2020 15:33:59 -0400
Message-Id: <20200708193408.242909-5-peterx@redhat.com>
...
index 1cfe79b932d6..c6b9f083d216 100644
...
+
 ...
 -------------------------
@@ -6151,3 +6164,106 @@ KVM can therefore start protected VMs.
...
index f26bc2bdacf4..825ad3dc284a 100644
--- a/arch/x86/include/asm/kvm_host.h
+++ b/arch/x86/include/asm/kvm_host.h
@@ -1188,6 +1188,7 @@ struct kvm_x86_ops {
...
@@ -1695,4 +1696,6 @@ static inline int kvm_cpu_get_apicid(int mps_cpu)
...
index 17c5a038f42d..45fdaaf84c21 100644
...
index 69ddc3528362..1ed625445bef 100644
--- a/arch/x86/kvm/mmu/mmu.c
+++ b/arch/x86/kvm/mmu/mmu.c
@@ -1739,6 +1739,14 @@ void kvm_arch_mmu_enable_log_dirty_pt_masked(struct kvm *kvm,
...
index 6e5208a735ec..18a60490dd34 100644
--- a/arch/x86/kvm/vmx/vmx.c
+++ b/arch/x86/kvm/vmx/vmx.c
@@ -7827,6 +7827,11 @@ static bool vmx_check_apicv_inhibit_reasons(ulong bit)
...
@@ -7954,6 +7959,7 @@ static struct kvm_x86_ops vmx_x86_ops __initdata = {
...
@@ -8071,6 +8077,7 @@ static __init int hardware_setup(void)
...
@@ -8134,7 +8141,6 @@ static struct kvm_x86_init_ops vmx_init_ops __initdata = {
...
index 65be4977f608..280f587447d2 100644
--- a/arch/x86/kvm/x86.c
+++ b/arch/x86/kvm/x86.c
@@ -8350,6 +8350,15 @@ static int vcpu_enter_guest(struct kvm_vcpu *vcpu)
...
index 346ee5905359..824dd15df580 100644
...
+	u32 dirty_ring_size;
 ...
 #define kvm_err(fmt, ...) \
@@ -1440,4 +1443,14 @@ int kvm_vm_create_worker_thread(struct kvm *kvm, kvm_vm_thread_fn_t thread_fn,
...
index 2c735a3e6613..9b1d791bff2e 100644
...
index ff9b335620d0..4a6a1022c434 100644
...
@@ -1033,6 +1034,7 @@ struct kvm_ppc_resize_hpt {
 #define KVM_CAP_HALT_POLL 182
 #define KVM_CAP_ASYNC_PF_INT 183
 #define KVM_CAP_LAST_CPU 184
+#define KVM_CAP_DIRTY_LOG_RING 185
 
 #ifdef KVM_CAP_IRQ_ROUTING
 
@@ -1534,6 +1536,9 @@ struct kvm_pv_cmd {
...
@@ -1687,4 +1692,52 @@ struct kvm_hyperv_eventfd {
...
index 32ff377dd019..43e5536cfa93 100644
...
@@ -364,6 +366,7 @@ static void kvm_vcpu_init(struct kvm_vcpu *vcpu, struct kvm *kvm, unsigned id)
...
+	kvm_dirty_ring_free(&vcpu->dirty_ring);
 	...
 	/*
@@ -2591,8 +2594,13 @@ static void mark_page_dirty_in_slot(struct kvm *kvm,
 {
...
@@ -2951,6 +2959,17 @@ void kvm_vcpu_on_spin(struct kvm_vcpu *me, bool yield_to_kernel_mode)
 }
...
@@ -2966,6 +2985,10 @@ static vm_fault_t kvm_vcpu_fault(struct vm_fault *vmf)
...
+		    vmf->pgoff - KVM_DIRTY_LOG_PAGE_OFFSET);
 	...
 	get_page(page);
@@ -2979,6 +3002,14 @@ static const struct vm_operations_struct kvm_vcpu_vm_ops = {
...
@@ -3072,6 +3103,13 @@ static int kvm_vm_ioctl_create_vcpu(struct kvm *kvm, u32 id)
 	if (r)
...
+
 	...
 	if (kvm_get_vcpu_by_id(kvm, id)) {
 		r = -EEXIST;
@@ -3105,6 +3143,8 @@ static int kvm_vm_ioctl_create_vcpu(struct kvm *kvm, u32 id)
...
@@ -3576,12 +3616,78 @@ static long kvm_vm_ioctl_check_extension_generic(struct kvm *kvm, long arg)
 #endif
...
+
 ...
 {
@@ -3612,6 +3718,8 @@ static int kvm_vm_ioctl_enable_cap_generic(struct kvm *kvm,
...
@@ -3796,6 +3904,9 @@ static long kvm_vm_ioctl(struct file *filp,
