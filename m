...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id F2BDC2BA1F2
	for <lists+linux-kernel@lfdr.de>; Fri, 20 Nov 2020 06:41:15 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725936AbgKTFk7 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 20 Nov 2020 00:40:59 -0500
Received: from mxout70.expurgate.net ([194.37.255.70]:40769 "EHLO
        mxout70.expurgate.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725208AbgKTFk6 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 20 Nov 2020 00:40:58 -0500
Received: from [127.0.0.1] (helo=localhost)
        by relay.expurgate.net with smtp (Exim 4.90)
        (envelope-from <ms@dev.tdt.de>)
        id 1kfzAB-000809-Q2; Fri, 20 Nov 2020 06:40:51 +0100
Received: from [195.243.126.94] (helo=securemail.tdt.de)
        by relay.expurgate.net with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.90)
        (envelope-from <ms@dev.tdt.de>)
        id 1kfzAA-0007qn-N5; Fri, 20 Nov 2020 06:40:50 +0100
Received: from securemail.tdt.de (localhost [127.0.0.1])
        by securemail.tdt.de (Postfix) with ESMTP id 4847C240041;
        Fri, 20 Nov 2020 06:40:50 +0100 (CET)
Received: from mail.dev.tdt.de (unknown [10.2.4.42])
        by securemail.tdt.de (Postfix) with ESMTP id BEDEC240040;
        Fri, 20 Nov 2020 06:40:49 +0100 (CET)
Received: from mschiller01.dev.tdt.de (unknown [10.2.3.20])
        by mail.dev.tdt.de (Postfix) with ESMTPSA id 3998E20D9C;
        Fri, 20 Nov 2020 06:40:49 +0100 (CET)
...
Subject: [PATCH net-next v4 1/5] net/x25: handle additional netdev events
Date:   Fri, 20 Nov 2020 06:40:32 +0100
Message-ID: <20201120054036.15199-2-ms@dev.tdt.de>
...
X-purgate: clean
X-purgate-ID: 151534::1605850851-000037DC-58689DEE/0/0
