...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CA2482CD344
	for <lists+linux-kernel@lfdr.de>; Thu,  3 Dec 2020 11:18:27 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387766AbgLCKRI (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 3 Dec 2020 05:17:08 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56932 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728659AbgLCKRH (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 3 Dec 2020 05:17:07 -0500
Received: from merlin.infradead.org (merlin.infradead.org [IPv6:2001:8b0:10b:1231::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id EC6C3C061A4D;
        Thu,  3 Dec 2020 02:16:26 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        d=infradead.org; s=merlin.20170209; h=Mime-Version:Content-Type:References:
        In-Reply-To:Date:Cc:To:From:Subject:Message-ID:Sender:Reply-To:
        Content-Transfer-Encoding:Content-ID:Content-Description;
        bh=xw2z9hEfxGfnQ8r2IOxfYKkzEEJeZRAPI2jz+eHTDDc=; b=qV+p5SPIFui9TLUEP1aJFkOIpk
        ;
Received: from 54-240-197-226.amazon.com ([54.240.197.226] helo=u3832b3a9db3152.ant.amazon.com)
        by merlin.infradead.org with esmtpsa (Exim 4.92.3 #3 (Red Hat Linux))
        id 1kklek-00038Y-7E; Thu, 03 Dec 2020 10:16:10 +0000
Message-ID: <8c92b2f3a8e8829ec85d22091b2fe84794f12f78.camel@infradead.org>
...
Date:   Thu, 03 Dec 2020 10:16:06 +0000
In-Reply-To: <6ea92fe2-4067-d0e0-b716-16d39a7a6065@oracle.com>
...
are *out* of guest mode by the time...
    ...
    ...er... maybe not by the time the notifier returns, because all=20
    we've done is *send* the IPI and we don't know the other CPUs have=20
    actually stopped running the guest yet?=20

    Maybe there's some explanation of why the actual TLB shootdown=20
    truly *will* occur before the page goes away, and some ordering=20
    rules which mean our reschedule IPI will happen first? Something=20
...
MjAzMTAxNjA2WjAvBgkqhkiG9w0BCQQxIgQgApIlzKXpbbcMczJgNDO4GcG8MI+lZcZ5sKS9lhdQ
BGYwgb4GCSsGAQQBgjcQBDGBsDCBrTCBlzELMAkGA1UEBhMCR0IxGzAZBgNVBAgTEkdyZWF0ZXIg
...

