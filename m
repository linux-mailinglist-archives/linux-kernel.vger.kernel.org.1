...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id EDC92255CD3
	for <lists+linux-kernel@lfdr.de>; Fri, 28 Aug 2020 16:42:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726952AbgH1Om3 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 28 Aug 2020 10:42:29 -0400
Received: from relaydlg-01.paragon-software.com ([81.5.88.159]:49847 "EHLO
        relaydlg-01.paragon-software.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1727979AbgH1Okq (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 28 Aug 2020 10:40:46 -0400
Received: from dlg2.mail.paragon-software.com (vdlg-exch-02.paragon-software.com [172.30.1.105])
        by relaydlg-01.paragon-software.com (Postfix) with ESMTPS id 67800821F8;
        Fri, 28 Aug 2020 17:40:18 +0300 (MSK)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=paragon-software.com; s=mail; t=1598625618;
        bh=yk0X+trYm1VAn7KXldj2PKSIaayD2SL3RX3mrpsEeA0=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=lh82Ol7wRo/BS3fjEjJ3Ido4slXocZYhOyC/z9CwMq+DskYMzbo7pdQQXIt8BDG9y
         KdlqZ9jlijV2RAMmpc0AWayQU3HmHU+tq2hOMb5nhmxVlTWtGpCoIWuiJV8B4hK4Il
         fTo1egdvK4IO8aNDCbKakIXFalttiA/C1cpGNl3U=
Received: from localhost.localdomain (172.30.8.44) by
 vdlg-exch-02.paragon-software.com (172.30.1.105) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1847.3; Fri, 28 Aug 2020 17:40:16 +0300
...
Subject: [PATCH v3 04/10] fs/ntfs3: Add file operations and implementation
Date:   Fri, 28 Aug 2020 07:39:32 -0700
Message-ID: <20200828143938.102889-5-almaz.alexandrovich@paragon-software.com>
...
---
 ...
 fs/ntfs3/run.c     | 1188 ++++++++++++++++++++++
 6 files changed, 6617 insertions(+)
...
+		err = ntfs_set_size(inode, ntfs_up_cluster(sbi, end));
+	} else {
...
new file mode 100644
index 000000000000..ad09fca5d7db
--- /dev/null
...
+		if (!attr->non_res &&
+		    le32_to_cpu(attr->res.data_size) >= sizeof(struct GUID))
...
new file mode 100644
index 000000000000..55116311ade9
--- /dev/null
+++ b/fs/ntfs3/namei.c
@@ -0,0 +1,580 @@
+// SPDX-License-Identifier: GPL-2.0
...
new file mode 100644
index 000000000000..8a3f7af581b7
--- /dev/null
+++ b/fs/ntfs3/record.c
@@ -0,0 +1,615 @@
+// SPDX-License-Identifier: GPL-2.0
...
new file mode 100644
index 000000000000..4c6757b8bb82
--- /dev/null
+++ b/fs/ntfs3/run.c
@@ -0,0 +1,1188 @@
+// SPDX-License-Identifier: GPL-2.0
