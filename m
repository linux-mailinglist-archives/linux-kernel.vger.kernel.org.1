...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id EC14B2662A9
	for <lists+linux-kernel@lfdr.de>; Fri, 11 Sep 2020 17:56:23 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726501AbgIKP4N (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 11 Sep 2020 11:56:13 -0400
Received: from relayfre-01.paragon-software.com ([176.12.100.13]:48532 "EHLO
        relayfre-01.paragon-software.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726584AbgIKPys (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 11 Sep 2020 11:54:48 -0400
Received: from dlg2.mail.paragon-software.com (vdlg-exch-02.paragon-software.com [172.30.1.105])
        by relayfre-01.paragon-software.com (Postfix) with ESMTPS id ADB7F42C;
        Fri, 11 Sep 2020 17:10:25 +0300 (MSK)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=paragon-software.com; s=mail; t=1599833425;
        bh=prbd3XcAGpwPNZtGWiXcl8WFMzPgo04sAQ0IddyxSGg=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=b/78vJCCluaxEnU/DvX3srj9HObp9keeq363Ch92rxnVfPcswgaMgk/6O9mv886pI
         GIInoYRXINlLXNKQfySZq0u8JlRVO6vua25+5FXlhU+TGUyLHiGaNz6nnLp2nNuXJD
         r9e96lT9pVu9tSmJVmL46Ck1X3e75hi3MYa6GX50=
Received: from fsd-lkpg.ufsd.paragon-software.com (172.30.114.105) by
 vdlg-exch-02.paragon-software.com (172.30.1.105) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1847.3; Fri, 11 Sep 2020 17:10:24 +0300
...
Subject: [PATCH v5 04/10] fs/ntfs3: Add file operations and implementation
Date:   Fri, 11 Sep 2020 17:10:12 +0300
Message-ID: <20200911141018.2457639-5-almaz.alexandrovich@paragon-software.com>
...
---
 ...
 fs/ntfs3/run.c     | 1156 ++++++++++++++++++++++
 6 files changed, 6528 insertions(+)
...
index 000000000000..b91311ed3b3b
--- /dev/null
+++ b/fs/ntfs3/dir.c
@@ -0,0 +1,631 @@
...
new file mode 100644
index 000000000000..2773235322ce
--- /dev/null
+++ b/fs/ntfs3/file.c
@@ -0,0 +1,1224 @@
+// SPDX-License-Identifier: GPL-2.0
...
new file mode 100644
index 000000000000..4a4ee59ec174
--- /dev/null
...
new file mode 100644
index 000000000000..661b7d85ff2c
--- /dev/null
+++ b/fs/ntfs3/namei.c
@@ -0,0 +1,542 @@
+// SPDX-License-Identifier: GPL-2.0
