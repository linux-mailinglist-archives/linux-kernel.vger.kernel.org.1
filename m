...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2F7332E8A6F
	for <lists+linux-kernel@lfdr.de>; Sun,  3 Jan 2021 05:16:40 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726504AbhACEP2 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 2 Jan 2021 23:15:28 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55030 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725827AbhACEP0 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 2 Jan 2021 23:15:26 -0500
Received: from mail-ej1-x62c.google.com (mail-ej1-x62c.google.com [IPv6:2a00:1450:4864:20::62c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7EBF0C061573;
        Sat,  2 Jan 2021 20:14:45 -0800 (PST)
Received: by mail-ej1-x62c.google.com with SMTP id g20so32586688ejb.1;
        Sat, 02 Jan 2021 20:14:45 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=mime-version:from:date:message-id:subject:to;
        bh=TQ44n6RAJlaOm4sXL+8Njagm7enKecPoZUUC7wvg9cY=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:mime-version:from:date:message-id:subject:to;
        bh=TQ44n6RAJlaOm4sXL+8Njagm7enKecPoZUUC7wvg9cY=;
        b=
X-Gm-Message-State: AOAM531cZiVAdWTqvAQK03pEavxeYF9+9o2/8LJATeTtJCOb0zR9ISRO
        MsGL6yH1ya4eHmLaEW/ElPhyuEnlsgsQUNhWqrU=
X-Google-Smtp-Source: ABdhPJzANMXdm7uiYlNPZvqqO0RiSGqYI8cd0Ll4duL3y2/VqvBopmBaxAwxJxvh2x99Yyp5HsQ2gYnBc3IgwYLUeMg=
X-Received: by 2002:a17:907:d9e:: with SMTP id go30mr60272417ejc.488.1609647283230;
 Sat, 02 Jan 2021 20:14:43 -0800 (PST)
MIME-Version: 1.0
From:   Palash Oswal <oswalpalash@gmail.com>
Date:   Sun, 3 Jan 2021 09:44:30 +0530
Message-ID: <CAGyP=7cFM6BJE7X2PN9YUptQgt5uQYwM4aVmOiVayQPJg1pqaA@mail.gmail.com>
Subject: INFO: task hung in __io_uring_task_cancel
...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000024 = 0;
  res = -1;
  res = syz_io_uring_setup(0x3c5a, 0x20000000, 0x20e0e000, 0x20e0f000,
  ...
  *(uint8_t*)0x2000017f = 0;
  ...
  syscall(__NR_io_uring_enter, r[0], 0x10b0, 0, 0ul, 0ul, 0ul);
  memcpy((void*)0x20000180, "./file0\000", 8);
  syscall(__NR_execveat, -1, 0x20000180ul, 0ul, 0ul, 0ul);
}
int main(void)
{
...
r0 = syz_io_uring_setup(0x3c5a, &(0x7f0000000000),
&(0x7f0000e0e000/0x4000)=nil, &(0x7f0000e0f000/0x2000)=nil,
&(0x7f0000000080)=<r1=>0x0, &(0x7f00000000c0)=<r2=>0x0)
syz_io_uring_submit(r1, r2,
&(0x7f0000000140)=@IORING_OP_POLL_ADD={0x6, 0x0, 0x0, @fd_index=0x3},
0x0)
io_uring_enter(r0, 0x10b0, 0x0, 0x0, 0x0, 0x0)
execveat(0xffffffffffffffff, &(0x7f0000000180)='./file0\x00', 0x0, 0x0, 0x0)

Compiler : gcc (Ubuntu 10.2.0-13ubuntu1) 10.2.0
...
didn't mess this bug report; found a similar one
https://groups.google.com/g/syzkaller-bugs/c/r6e8DFgpE30/m/VJll0tyyBQAJ
