...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D7F5F2A1DA9
	for <lists+linux-kernel@lfdr.de>; Sun,  1 Nov 2020 12:44:40 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726545AbgKALob (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 1 Nov 2020 06:44:31 -0500
Received: from mail.kernel.org ([198.145.29.99]:40842 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726515AbgKALo1 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 1 Nov 2020 06:44:27 -0500
Received: from localhost (83-86-74-64.cable.dynamic.v4.ziggo.nl [83.86.74.64])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 68B962084C;
        Sun,  1 Nov 2020 11:44:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1604231064;
        bh=YTm21ou3swt995+ECiGc8duvLLsRcThNpZCXVkuTgCc=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=TqW54pGX+oPWjHnUtkLVwiVbl1ULgQzCafpJTJi6Psw3S3o2qtIw7574fmAwCWjd+
         TuEygwIusUow2AFqsI6OtwHl2QedyKvsJXzF3j1rjMwntdlB/9NNvG0oIHqHl3DGUq
         qHWOW90naN04LGaRduq72f+VHaE7Zk+5G77iX4ik=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 5.4.74
Date:   Sun,  1 Nov 2020 12:44:59 +0100
Message-Id: <16042310973394@kroah.com>
X-Mailer: git-send-email 2.29.2
In-Reply-To: <160423109766120@kroah.com>
References: <160423109766120@kroah.com>
MIME-Version: 1.0
...
index 96abe558aea8..cd8f3cdabfd0 100644
...
index d2e738c45556..1e16c4e00e77 100644
--- a/arch/arm64/kernel/cpu_errata.c
+++ b/arch/arm64/kernel/cpu_errata.c
@@ -492,6 +492,12 @@ static bool has_ssbd_mitigation(const struct arm64_cpu_capabilities *entry,
 	return required;
 }
...
index 3dbf398c92ea..9ef62e647cd2 100644
...
index 9b410ffafc4d..e2c64c943cfc 100644
...
index a5903cfc8352..4c44d7c0c2c1 100644
--- a/drivers/crypto/chelsio/chtls/chtls_io.c
+++ b/drivers/crypto/chelsio/chtls/chtls_io.c
@@ -1537,6 +1537,7 @@ static int chtls_pt_recvmsg(struct sock *sk, struct msghdr *msg, size_t len,
 			tp->urg_data = 0;
...
@@ -1546,8 +1547,10 @@ static int chtls_pt_recvmsg(struct sock *sk, struct msghdr *msg, size_t len,
...
index 1753a9801b70..8beed4197e73 100644
...
index 1b9afb192f7f..358f0fe40270 100644
...
index 634bdea38ecb..4e19c3149848 100644
--- a/drivers/net/gtp.c
+++ b/drivers/net/gtp.c
...
index 81401f386c9c..246864bbb3e4 100644
...
index fa4f6447ddad..9760a52800b4 100644
...
index f9022b702875..40c262b3f9ff 100644
--- a/fs/fuse/dev.c
+++ b/fs/fuse/dev.c
...
index 97f2b11ce203..d3ced6a39bcf 100644
--- a/net/ipv4/tcp.c
+++ b/net/ipv4/tcp.c
...
index 62f8ba404818..54fd6bc5adcc 100644
...
index ff2d2b514506..5a77b7a17722 100644
...
index 914cd0618d5a..c480549a7f94 100644
...
index f496c99d9826..7954021ade33 100644
...
index 42e557d48e4e..f4101a920d1f 100644
...
index 27a4112848c2..e8c34b0a8b00 100644
