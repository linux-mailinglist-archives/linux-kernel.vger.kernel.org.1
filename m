...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 43C6A1E315F
	for <lists+linux-kernel@lfdr.de>; Tue, 26 May 2020 23:44:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2390423AbgEZVnV (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 26 May 2020 17:43:21 -0400
Received: from mx0b-00082601.pphosted.com ([67.231.153.30]:35884 "EHLO
        mx0a-00082601.pphosted.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S2390758AbgEZVmu (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 26 May 2020 17:42:50 -0400
Received: from pps.filterd (m0089730.ppops.net [127.0.0.1])
        by m0089730.ppops.net (8.16.0.42/8.16.0.42) with SMTP id 04QLdw8E019459
        for <linux-kernel@vger.kernel.org>; Tue, 26 May 2020 14:42:46 -0700
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=fb.com; h=from : to : cc : subject
 : date : message-id : in-reply-to : references : mime-version :
 content-transfer-encoding : content-type; s=facebook;
 bh=8u+SBHTl+Hn/esLEljDiOrpXhLZPSd29eCuq54rp8do=;
 b=iaDYO1L3SD+oo/q7VKwnX7QaPuFP4NbRFoLiNCQidvhR0iUDsgRYqK7wEIOayvpVmYSu
 FhZBe57oSz8QMZVFv3Ad4nu/O+1/cbk9OKy7WP9+lFE+EujsC0fInsDlgR7/Nyt5DLpz
 XbmnJvpjbFdvqXcHzH4LPHFKUOWWPnDmXXI= 
Received: from maileast.thefacebook.com ([163.114.130.16])
        by m0089730.ppops.net with ESMTP id 316yb14wme-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128 verify=NOT)
        for <linux-kernel@vger.kernel.org>; Tue, 26 May 2020 14:42:45 -0700
Received: from intmgw001.41.prn1.facebook.com (2620:10d:c0a8:1b::d) by
 mail.thefacebook.com (2620:10d:c0a8:83::7) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1979.3; Tue, 26 May 2020 14:42:44 -0700
Received: by devvm1291.vll0.facebook.com (Postfix, from userid 111017)
        id 9B0AF15EA7E8; Tue, 26 May 2020 14:42:33 -0700 (PDT)
...
Subject: [PATCH v4 17/19] mm: memcg/slab: use a single set of kmem_caches for all allocations
Date:   Tue, 26 May 2020 14:42:25 -0700
Message-ID: <20200526214227.989341-18-guro@fb.com>
...
=20
 	mod_node_page_state(page_pgdat(page), cache_vmstat_idx(s),
@@ -526,8 +430,7 @@ static inline struct kmem_cache *cache_from_obj(struc=
...
@@ -535,7 +438,7 @@ static inline struct kmem_cache *cache_from_obj(struc=
t kmem_cache *s, void *x)
 		return s;
=20
...
+	WARN_ONCE(cachep && cachep !=3D s,
 	...
 	return cachep;
@@ -587,7 +490,7 @@ static inline struct kmem_cache *slab_pre_alloc_hook(=
struct kmem_cache *s,
=20
 	if (memcg_kmem_enabled() &&
...
@@ -606,8 +509,8 @@ static inline void slab_post_alloc_hook(struct kmem_c=
ache *s,
 					 s->flags, flags);
 	}
=20
