...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0E8C41E4E80
	for <lists+linux-kernel@lfdr.de>; Wed, 27 May 2020 21:47:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728434AbgE0TrE (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 27 May 2020 15:47:04 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37660 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725872AbgE0TrD (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 27 May 2020 15:47:03 -0400
Received: from Galois.linutronix.de (Galois.linutronix.de [IPv6:2a0a:51c0:0:12e:550::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A86F0C05BD1E
        for <linux-kernel@vger.kernel.org>; Wed, 27 May 2020 12:47:02 -0700 (PDT)
Received: from localhost ([127.0.0.1] helo=flow.W.breakpoint.cc)
        by Galois.linutronix.de with esmtp (Exim 4.80)
        (envelope-from <bigeasy@linutronix.de>)
        id 1je20y-0005H4-JI; Wed, 27 May 2020 21:47:00 +0200
...
Subject: [PATCH v2 2/2] workqueue: Convert the pool::lock and wq_mayday_lock to raw_spinlock_t
Date:   Wed, 27 May 2020 21:46:33 +0200
Message-Id: <20200527194633.1660952-3-bigeasy@linutronix.de>
...
+	raw_spinlock_t		lock;		/* the pool lock */
 	...
 	int			id;		/* I: pool ID */
@@ -300,7 +300,7 @@ static struct workqueue_attrs *wq_update_unbound_numa_a=
ttrs_buf;
=20
...
@@ -3718,7 +3718,7 @@ static void pwq_adjust_max_active(struct pool_workque=
ue *pwq)
 		return;
=20
...
@@ -3741,7 +3741,7 @@ static void pwq_adjust_max_active(struct pool_workque=
ue *pwq)
 		pwq->max_active =3D 0;
 	}
=20
...
@@ -4143,9 +4143,9 @@ static void wq_update_unbound_numa(struct workqueue_s=
truct *wq, int cpu,
=20
 use_dfl_pwq:
 	mutex_lock(&wq->mutex);
...
+		raw_spin_unlock_irqrestore(&pool->lock, flags);
 		 ...
 		 * We could be printing a lot from atomic context, e.g.
 		 * sysrq-t -> show_workqueue_state(). Avoid triggering
@@ -4848,7 +4848,7 @@ void wq_worker_comm(char *buf, size_t size, struct ta=
sk_struct *task)
...
@@ -4862,7 +4862,7 @@ void wq_worker_comm(char *buf, size_t size, struct ta=
sk_struct *task)
