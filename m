...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 952D71C542D
	for <lists+linux-kernel@lfdr.de>; Tue,  5 May 2020 13:14:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728941AbgEELO5 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 5 May 2020 07:14:57 -0400
Received: from smtp-fw-6002.amazon.com ([52.95.49.90]:4965 "EHLO
        smtp-fw-6002.amazon.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725766AbgEELO4 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 5 May 2020 07:14:56 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  d=amazon.com; i=@amazon.com; q=dns/txt; s=amazon201209;
  t=1588677292; x=1620213292;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version;
  bh=go/UebcZ7wM6P0xd/6n7FU3Bh9bDmMYFl6+W+MbG5r4=;
  b=Fip2R3VWpqWwNUZv+EULaYWTLdK7uoueO0HfH3ZT/Ca0xX00MUS6lIIc
   hQj3tO2njUh1BTaCOQzhL1fbvNDidFc+DaB11nrocBEK0JZuvFz5T07TT
   fx/Mc53534e5F2zdPmFc/TBkxvE3t07HUmcyRxzrt4jMNiiBDA/pDj+hj
   w=;
IronPort-SDR: VEKqgnVqMLYwtJVuWTIePEePHJYUFcy3yZ2W+1iWqk6yweFjsQQxORZ9sqy8hYKvLu/Yv1bhVy
 96hel0PZHong==
X-IronPort-AV: E=Sophos;i="5.73,354,1583193600"; 
   d="scan'208";a="28673712"
Received: from iad12-co-svc-p1-lb1-vlan3.amazon.com (HELO email-inbound-relay-2c-87a10be6.us-west-2.amazon.com) ([10.43.8.6])
  by smtp-border-fw-out-6002.iad6.amazon.com with ESMTP; 05 May 2020 11:14:48 +0000
Received: from EX13MTAUEA002.ant.amazon.com (pdx4-ws-svc-p6-lb7-vlan2.pdx.amazon.com [10.170.41.162])
        by email-inbound-relay-2c-87a10be6.us-west-2.amazon.com (Postfix) with ESMTPS id 7FD66A1E4C;
        Tue,  5 May 2020 11:14:46 +0000 (UTC)
Received: from EX13D31EUA001.ant.amazon.com (10.43.165.15) by
 EX13MTAUEA002.ant.amazon.com (10.43.61.77) with Microsoft SMTP Server (TLS)
 id 15.0.1497.2; Tue, 5 May 2020 11:14:46 +0000
Received: from u886c93fd17d25d.ant.amazon.com (10.43.160.92) by
 EX13D31EUA001.ant.amazon.com (10.43.165.15) with Microsoft SMTP Server (TLS)
 id 15.0.1497.2; Tue, 5 May 2020 11:14:29 +0000
...
Subject: [PATCH v10 14/16] mm/damon: Add kunit tests
Date:   Tue, 5 May 2020 13:08:13 +0200
Message-ID: <20200505110815.10532-15-sjpark@amazon.com>
...
index 000000000000..851c2062a480
--- /dev/null
+++ b/mm/damon-test.h
@@ -0,0 +1,622 @@
...
index 9f7d173eca3b..cff27cb9c0e0 100644
--- a/mm/damon.c
+++ b/mm/damon.c
@@ -25,7 +25,11 @@
...
@@ -1496,3 +1500,5 @@ module_exit(damon_exit);
 MODULE_LICENSE("GPL");
