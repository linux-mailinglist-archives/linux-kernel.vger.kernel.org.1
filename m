...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A3E13290877
	for <lists+linux-kernel@lfdr.de>; Fri, 16 Oct 2020 17:32:14 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2408101AbgJPPcL (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 16 Oct 2020 11:32:11 -0400
Received: from relayfre-01.paragon-software.com ([176.12.100.13]:38850 "EHLO
        relayfre-01.paragon-software.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S2410168AbgJPPbz (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 16 Oct 2020 11:31:55 -0400
Received: from dlg2.mail.paragon-software.com (vdlg-exch-02.paragon-software.com [172.30.1.105])
        by relayfre-01.paragon-software.com (Postfix) with ESMTPS id C8E301EF7;
        Fri, 16 Oct 2020 18:31:43 +0300 (MSK)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=paragon-software.com; s=mail; t=1602862304;
        bh=Jg7UlbETwgNRhF1zbEVJzHtVuNqjjCW6hneqC/eY3I8=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=GEbQFHfDD/IaebjEjm8cPucxg8r07XKE0kmT70pISofe9KuB9Z/8BuFr+/dA0+c1g
         Y6RAHO1Zm4PyPEZ2HwRvGixuluiHG/f56YGZRTeDEh1E+1f6Vx1RujBa9hU1Fl+bzS
         XdpX+FRj5SenLTLi2ERfcaVP3ekXtoLDExD+YJ6Y=
...
Subject: [PATCH v9 02/10] fs/ntfs3: Add initialization of super block
Date:   Fri, 16 Oct 2020 18:29:29 +0300
Message-ID: <20201016152937.4030001-3-almaz.alexandrovich@paragon-software.com>
...
index 000000000000..03554ad50ad6
--- /dev/null
+++ b/fs/ntfs3/fsntfs.c
@@ -0,0 +1,2385 @@
...
new file mode 100644
index 000000000000..db892dcc66be
--- /dev/null
+++ b/fs/ntfs3/index.c
@@ -0,0 +1,2646 @@
+// SPDX-License-Identifier: GPL-2.0
...
new file mode 100644
index 000000000000..0757cf82e258
--- /dev/null
+++ b/fs/ntfs3/inode.c
@@ -0,0 +1,1961 @@
+// SPDX-License-Identifier: GPL-2.0
