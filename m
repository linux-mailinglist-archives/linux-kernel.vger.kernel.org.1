...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 076E52F41E6
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Jan 2021 03:42:00 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728272AbhAMClN (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 12 Jan 2021 21:41:13 -0500
Received: from mga06.intel.com ([134.134.136.31]:16435 "EHLO mga06.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725811AbhAMClM (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 12 Jan 2021 21:41:12 -0500
IronPort-SDR: enKZZk3jvpkT6Pk8DJr0u35NU0RiF7+SgA2dtoMOCvJS3+HXoKzMRQXTEtMBRp7IeITq6N7Syg
 7QRPDCfHvIGg==
X-IronPort-AV: E=McAfee;i="6000,8403,9862"; a="239681583"
X-IronPort-AV: E=Sophos;i="5.79,343,1602572400"; 
   d="yaml'?scan'208";a="239681583"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 Jan 2021 18:40:22 -0800
IronPort-SDR: TAEhOtvcH7A9I8a9RwufqKyZxIhdPFRE6WocMKiOpBnXvYUR5TNn4Iqph6U6klcJIq367XiO08
 8XyX1V+/qn2g==
X-IronPort-AV: E=Sophos;i="5.79,343,1602572400"; 
   d="yaml'?scan'208";a="571892642"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.140])
  by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 Jan 2021 18:40:17 -0800
...
Content-Disposition: attachment; filename="config-5.11.0-rc2-00182-gef0ba0553829"
...
queue_at_least_once'
	...
	export submit_id='5ffbbfafc6fd9215ac81549c'
	export job_file='/lkp/jobs/scheduled/lkp-hsw-4ex1/will-it-scale-performance-thread-50%-poll2-ucode=0x16-monitor=70d6d718-debian-10.4-x86_64-20200603.cgz-ef0ba05538299f1391cbe097d-20210111-5548-6wqjs7-2.yaml'
	export id='6223a28b506d604301208bcb3f70bf52ff5e5df7'
	...
	export commit='ef0ba05538299f1391cbe097de36895bb36ecfe6'
	export ucode='0x16'
	export kernel_cmdline_hw='cma=0'
	export need_kconfig_hw='CONFIG_IXGBE=y
CONFIG_SCSI_MPT3SAS
CONFIG_SATA_AHCI'
	export enqueue_time='2021-01-11 11:02:07 +0800'
	export _id='5ffbbfafc6fd9215ac81549c'
	export _rt='/result/will-it-scale/performance-thread-50%-poll2-ucode=0x16-monitor=70d6d718/lkp-hsw-4ex1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/ef0ba05538299f1391cbe097de36895bb36ecfe6'
	export user='lkp'
	...
	export result_root='/result/will-it-scale/performance-thread-50%-poll2-ucode=0x16-monitor=70d6d718/lkp-hsw-4ex1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/ef0ba05538299f1391cbe097de36895bb36ecfe6/3'
	export scheduler_version='/lkp/lkp/.src-20210111-085347'
	export arch='x86_64'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-10.4-x86_64-20200603.cgz'
	export bootloader_append='root=/dev/ram0
user=lkp
job=/lkp/jobs/scheduled/lkp-hsw-4ex1/will-it-scale-performance-thread-50%-poll2-ucode=0x16-monitor=70d6d718-debian-10.4-x86_64-20200603.cgz-ef0ba05538299f1391cbe097d-20210111-5548-6wqjs7-2.yaml
ARCH=x86_64
kconfig=x86_64-rhel-8.3
branch=linus/master
commit=ef0ba05538299f1391cbe097de36895bb36ecfe6
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/ef0ba05538299f1391cbe097de36895bb36ecfe6/vmlinuz-5.11.0-rc2-00182-gef0ba0553829
cma=0
max_uptime=2100
RESULT_ROOT=/result/will-it-scale/performance-thread-50%-poll2-ucode=0x16-monitor=70d6d718/lkp-hsw-4ex1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/ef0ba05538299f1391cbe097de36895bb36ecfe6/3
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/ef0ba05538299f1391cbe097de36895bb36ecfe6/modules.cgz'
	...
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/ef0ba05538299f1391cbe097de36895bb36ecfe6/vmlinuz-5.11.0-rc2-00182-gef0ba0553829'
	export dequeue_time='2021-01-11 11:16:32 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-hsw-4ex1/will-it-scale-performance-thread-50%-poll2-ucode=0x16-monitor=70d6d718-debian-10.4-x86_64-20200603.cgz-ef0ba05538299f1391cbe097d-20210111-5548-6wqjs7-2.cgz'
...
kconfig: x86_64-rhel-8.3
submit_id: 5ffbb14ec6fd92146e08a382
job_file: "/lkp/jobs/scheduled/lkp-hsw-4ex1/will-it-scale-performance-thread-50%-poll2-ucode=0x16-monitor=70d6d718-debian-10.4-x86_64-20200603.cgz-ef0ba05538299f1391cbe097d-20210111-5230-14lf4s8-0.yaml"
id: 7da91afdbeda8adfb30fff911e312a5c9d872815
...
- CONFIG_SCSI_MPT3SAS
- CONFIG_SATA_AHCI
enqueue_time: 2021-01-11 10:00:46.331549435 +08:00
_id: 5ffbb14ec6fd92146e08a382
_rt: "/result/will-it-scale/performance-thread-50%-poll2-ucode=0x16-monitor=70d6d718/lkp-hsw-4ex1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/ef0ba05538299f1391cbe097de36895bb36ecfe6"
...
result_root: "/result/will-it-scale/performance-thread-50%-poll2-ucode=0x16-monitor=70d6d718/lkp-hsw-4ex1/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/ef0ba05538299f1391cbe097de36895bb36ecfe6/1"
scheduler_version: "/lkp/lkp/.src-20210111-085347"
arch: x86_64
max_uptime: 2100
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-hsw-4ex1/will-it-scale-performance-thread-50%-poll2-ucode=0x16-monitor=70d6d718-debian-10.4-x86_64-20200603.cgz-ef0ba05538299f1391cbe097d-20210111-5230-14lf4s8-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- branch=linux-devel/devel-hourly-2021010915
- commit=ef0ba05538299f1391cbe097de36895bb36ecfe6
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/ef0ba05538299f1391cbe097de36895bb36ecfe6/modules.cgz"
...
#! runtime status
last_kernel: 5.11.0-rc2-00182-gef0ba0553829
repeat_to: 2

#! user overrides
queue_at_least_once: 0
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/ef0ba05538299f1391cbe097de36895bb36ecfe6/vmlinuz-5.11.0-rc2-00182-gef0ba0553829"
dequeue_time: 2021-01-11 10:50:08.810321024 +08:00

#! /lkp/lkp/.src-20210111-085347/include/site/inn
job_state: finished
loadavg: 14.62 33.16 18.08 1/1072 12591
start_time: '1610333563'
end_time: '1610333864'
version: "/lkp/lkp/.src-20210111-085417:1ce4af12-dirty:4869e3844"
