...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 671201E4976
	for <lists+linux-kernel@lfdr.de>; Wed, 27 May 2020 18:11:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2390877AbgE0QK6 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 27 May 2020 12:10:58 -0400
Received: from mail.kernel.org ([198.145.29.99]:50590 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2388257AbgE0QKz (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 27 May 2020 12:10:55 -0400
Received: from localhost (83-86-89-107.cable.dynamic.v4.ziggo.nl [83.86.89.107])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id D48DA20873;
        Wed, 27 May 2020 16:10:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1590595850;
        bh=PMY030NfGS6VYmijwDqMJAFfbMyB9LLXUF+B7fjARhY=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=VkWw63peZujBMv1+swdyUKiPx91fmp2C0euQFHzYilEHnkpkM9PTUNyoI+SSfGKYY
         Br4TkJN04wVVEy+ngSJzyQ2XHAkuMFngMN6ezVHdESsVBZvzA0JmkScnDBe0VKKBab
         DqsmVCaOMWPZlvogtc+diSDmj0wjdCg/YCPgrXAs=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 4.9.225
Date:   Wed, 27 May 2020 18:10:28 +0200
Message-Id: <1590595827138136@kroah.com>
X-Mailer: git-send-email 2.26.2
In-Reply-To: <15905958271144@kroah.com>
References: <15905958271144@kroah.com>
MIME-Version: 1.0
...
+
 	for_each_port(adapter, i) {
 		netdev = alloc_etherdev_mq(sizeof(struct port_info),
 					   MAX_ETH_QSETS);
@@ -5067,6 +5069,7 @@ static int init_one(struct pci_dev *pdev, const struct pci_device_id *ent)
...
@@ -241,18 +237,18 @@ static inline struct l2tp_tunnel *l2tp_sock_to_tunnel(struct sock *sk)
 	return tunnel;
 }
...
@@ -795,25 +851,19 @@ static int pppol2tp_connect(struct socket *sock, struct sockaddr *uservaddr,
