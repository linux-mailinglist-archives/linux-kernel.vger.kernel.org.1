...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 975071C9FA2
	for <lists+linux-kernel@lfdr.de>; Fri,  8 May 2020 02:28:54 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727779AbgEHA2S (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 7 May 2020 20:28:18 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57916 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-FAIL-OK-FAIL)
        by vger.kernel.org with ESMTP id S1726612AbgEHA2O (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 7 May 2020 20:28:14 -0400
Received: from mail-pg1-x542.google.com (mail-pg1-x542.google.com [IPv6:2607:f8b0:4864:20::542])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 84378C05BD43
        for <linux-kernel@vger.kernel.org>; Thu,  7 May 2020 17:28:14 -0700 (PDT)
Received: by mail-pg1-x542.google.com with SMTP id t11so40560pgg.2
        for <linux-kernel@vger.kernel.org>; Thu, 07 May 2020 17:28:14 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=v0h34zERG1/bI07GfpJIqLEDKClPSLHS8tFZ1eH4JaU=;
        b=WxAnKx01RtyYRG9nDjbP4px1M1lk9DvjCsY8KjC1Z2EkM8HqnI00hsIj/zNRe4fd5u
         CdWv3SR92g3WmO4abq3cJGShF5lzX+OCV2E2XSM54+XKx5pgfyQZTyOtJ5DjniS4BNeU
         ylRDGxyBAUcqW7fEq2BZMoPceGv4+bLwNm3hQ=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=v0h34zERG1/bI07GfpJIqLEDKClPSLHS8tFZ1eH4JaU=;
        b=
X-Gm-Message-State: AGi0PuZrOPR8iBDL/JqJTbFiLb3pVWt6I85m9bd7fPtKB+7ybpiF8vIX
        KzBzlOpMXcg0ZZfHT9KXpVK6bA==
X-Google-Smtp-Source: APiQypJMN10+WFgN5HCUtm/u+9K7WkMmxwtSMzx9d7xtD3U0AHxdZN7NSwZpqEccT3qCqZtCKF1Eow==
X-Received: by 2002:a62:5ec7:: with SMTP id s190mr15968807pfb.130.1588897691917;
        Thu, 07 May 2020 17:28:11 -0700 (PDT)
Received: from lbrmn-lnxub113.broadcom.net ([192.19.228.250])
        by smtp.gmail.com with ESMTPSA id gz14sm882677pjb.42.2020.05.07.17.28.07
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 07 May 2020 17:28:10 -0700 (PDT)
...
Subject: [PATCH v5 6/7] misc: bcm-vk: add Broadcom VK driver
Date:   Thu,  7 May 2020 17:27:38 -0700
Message-Id: <20200508002739.19360-7-scott.branden@broadcom.com>
...
---
 ...
 12 files changed, 4127 insertions(+)
...
index 99e151475d8f..1cfd5c4ce5e8 100644
...
index 9abf2923d831..31c2b89e9b24 100644
...
new file mode 100644
index 000000000000..cbc2a933e2ad
--- /dev/null
...
new file mode 100644
index 000000000000..f1318410f955
--- /dev/null
...
new file mode 100644
index 000000000000..e2173f5f7797
--- /dev/null
...
+MODULE_VERSION("1.0");
diff --git a/drivers/misc/bcm-vk/bcm_vk_legacy.c b/drivers/misc/bcm-vk/bcm_vk_legacy.c
new file mode 100644
index 000000000000..6ed86c22165a
--- /dev/null
+++ b/drivers/misc/bcm-vk/bcm_vk_legacy.c
@@ -0,0 +1,89 @@
+// SPDX-License-Identifier: GPL-2.0
+/*
+ * Copyright 2018-2020 Broadcom.
...
new file mode 100644
index 000000000000..defdeaa601c4
--- /dev/null
...
new file mode 100644
index 000000000000..60ec9518c494
--- /dev/null
...
new file mode 100644
index 000000000000..de200dde3a95
--- /dev/null
