...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 277481EE01C
	for <lists+linux-kernel@lfdr.de>; Thu,  4 Jun 2020 10:51:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728296AbgFDIua (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 4 Jun 2020 04:50:30 -0400
Received: from mga05.intel.com ([192.55.52.43]:39753 "EHLO mga05.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728277AbgFDIu2 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 4 Jun 2020 04:50:28 -0400
IronPort-SDR: 4I9iJy4PqJ4b4Kui8peRnt9pd19+P7cyH8c90Mk29WejGTDzI1b2ZXa9J1vzZS9/+/Ue0FT7mZ
 68KlX5jbCGxw==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 04 Jun 2020 01:50:28 -0700
IronPort-SDR: h2Wxpg0+nFQPqe0oVogay83oV24iNnG2gzh+z0QVaxGO7N3OmCXInZpjQXqQeSYovuEaB9tdLD
 ldZochNpMaIw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,471,1583222400"; 
   d="scan'208";a="445435064"
Received: from yilunxu-optiplex-7050.sh.intel.com ([10.239.159.141])
  by orsmga005.jf.intel.com with ESMTP; 04 Jun 2020 01:50:25 -0700
...
Subject: [PATCH v6 3/7] fpga: dfl: introduce interrupt trigger setting API
Date:   Thu,  4 Jun 2020 16:46:24 +0800
Message-Id: <1591260388-15128-4-git-send-email-yilun.xu@intel.com>
...
@@ -1394,6 +1397,158 @@ int dfl_fpga_cdev_config_ports_vf(struct dfl_fpga_cdev *cdev, int num_vfs)
 }
...
@@ -232,6 +239,7 @@ struct dfl_feature_irq_ctx {
...
+	struct platform_device *dev;
 	...
 	int resource_index;
 	void __iomem *ioaddr;
@@ -508,4 +516,13 @@ int dfl_fpga_cdev_release_port(struct dfl_fpga_cdev *cdev, int port_id);
