...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id EFB9B2340D6
	for <lists+linux-kernel@lfdr.de>; Fri, 31 Jul 2020 10:09:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731888AbgGaIIg (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 31 Jul 2020 04:08:36 -0400
Received: from labrats.qualcomm.com ([199.106.110.90]:3782 "EHLO
        labrats.qualcomm.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1731861AbgGaIIf (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 31 Jul 2020 04:08:35 -0400
IronPort-SDR: 
X-IronPort-AV: E=Sophos;i="5.75,417,1589266800"; 
   d="scan'208";a="29059980"
Received: from unknown (HELO ironmsg04-sd.qualcomm.com) ([10.53.140.144])
  by labrats.qualcomm.com with ESMTP; 31 Jul 2020 01:08:33 -0700
Received: from pacamara-linux.qualcomm.com ([192.168.140.135])
  by ironmsg04-sd.qualcomm.com with ESMTP; 31 Jul 2020 01:08:32 -0700
Received: by pacamara-linux.qualcomm.com (Postfix, from userid 359480)
        id 76DBC22E73; Fri, 31 Jul 2020 01:08:32 -0700 (PDT)
...
Subject: [PATCH 5/8] scsi: ufs: Fix concurrency of error handler and other error recovery paths
Date:   Fri, 31 Jul 2020 01:08:05 -0700
Message-Id: <1596182890-10086-6-git-send-email-cang@codeaurora.org>
...
@@ -5827,30 +5822,22 @@ static irqreturn_t ufshcd_check_errors(struct ufs_hba *hba)
...
+		ufshcd_schedule_eh_work(hba);
 	...
 	/*
@@ -6595,8 +6582,6 @@ static int ufshcd_host_reset_and_restore(struct ufs_hba *hba)
...
@@ -6615,9 +6600,23 @@ static int ufshcd_host_reset_and_restore(struct ufs_hba *hba)
  */
...
@@ -6625,6 +6624,18 @@ static int ufshcd_reset_and_restore(struct ufs_hba *hba)
...
@@ -6636,48 +6647,25 @@ static int ufshcd_reset_and_restore(struct ufs_hba *hba)
  */
...
@@ -7398,6 +7386,7 @@ static int ufshcd_add_lus(struct ufs_hba *hba)
...
@@ -7462,14 +7451,17 @@ static int ufshcd_probe_hba(struct ufs_hba *hba, bool async)
 	 */
...
@@ -8076,10 +8068,13 @@ static int ufshcd_link_state_transition(struct ufs_hba *hba,
...
@@ -8095,8 +8090,11 @@ static int ufshcd_link_state_transition(struct ufs_hba *hba,
...
@@ -8405,10 +8403,13 @@ static int ufshcd_resume(struct ufs_hba *hba, enum ufs_pm_op pm_op)
...
@@ -8782,6 +8783,7 @@ int ufshcd_init(struct ufs_hba *hba, void __iomem *mmio_base, unsigned int irq)
 	int err;
...
+	char eh_wq_name[sizeof("ufs_eh_wq_00")];
 	...
 	if (!mmio_base) {
 		dev_err(hba->dev,
@@ -8843,6 +8845,15 @@ int ufshcd_init(struct ufs_hba *hba, void __iomem *mmio_base, unsigned int irq)
