...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9B8052D2F24
	for <lists+linux-kernel@lfdr.de>; Tue,  8 Dec 2020 17:09:33 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730435AbgLHQJT (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 8 Dec 2020 11:09:19 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52990 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1730117AbgLHQJS (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 8 Dec 2020 11:09:18 -0500
Received: from merlin.infradead.org (merlin.infradead.org [IPv6:2001:8b0:10b:1231::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1374DC061749;
        Tue,  8 Dec 2020 08:08:38 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        d=infradead.org; s=merlin.20170209; h=Mime-Version:Content-Type:References:
        In-Reply-To:Date:Cc:To:From:Subject:Message-ID:Sender:Reply-To:
        Content-Transfer-Encoding:Content-ID:Content-Description;
        bh=wddLdYbc8ARDunHmBIB61bBKi6X0rPVf2KjfwWJ/gBk=; b=O8jDqnKXhgMKp5wUHci7YWo8m8
        ;
Received: from 54-240-197-238.amazon.com ([54.240.197.238] helo=u3832b3a9db3152.ant.amazon.com)
        by merlin.infradead.org with esmtpsa (Exim 4.92.3 #3 (Red Hat Linux))
        id 1kmfX2-000430-GW; Tue, 08 Dec 2020 16:08:04 +0000
Message-ID: <6a6b5806be1fe4c0fe96c0b664710d1ce614f29d.camel@infradead.org>
...
Date:   Tue, 08 Dec 2020 16:08:01 +0000
...
--=-eQni5XxhE08yWumD0VVA
Content-Type: text/plain; charset="UTF-8"
Content-Transfer-Encoding: quoted-printable

On Wed, 2020-12-02 at 19:02 +0000, David Woodhouse wrote:
>=20
> > I feel we could just accommodate it as subtype in KVM_XEN_ATTR_TYPE_CAL=
LBACK_VIA.
> > Don't see the adavantage in having another xen attr type.
>=20
> Yeah, fair enough.
>=20
> > But kinda have mixed feelings in having kernel handling all event chann=
els ABI,
> > as opposed to only the ones userspace asked to offload. It looks a tad =
unncessary besides
> > the added gain to VMMs that don't need to care about how the internals =
of event channels.
...
> channels, I'd rather just do it in one place =E2=80=94 and if the kernel =
does
...
@@ -2380,6 +2380,9 @@ int kvm_apic_accept_pic_intr(struct kvm_vcpu *vcpu)
        if ((lvt0 & APIC_LVT_MASKED) =3D=3D 0 &&
            GET_APIC_DELIVERY_MODE(lvt0) =3D=3D APIC_MODE_EXTINT)
                r =3D 1;
+       /* Shoot me. */
+       if (vcpu->arch.pending_external_vector =3D=3D 243)
+               r =3D 1;
        return r;
 }
=20
...
+       if (vector =3D=3D 243 || test_bit(vector, vcpu_to_synic(vcpu)->auto=
_eoi_bitmap)) {
                /*
...
MjA4MTYwODAxWjAvBgkqhkiG9w0BCQQxIgQgIfzbkFh42e8k+a3dYU+XNrJqIQFq6PHxVPejxHe8
oocwgb4GCSsGAQQBgjcQBDGBsDCBrTCBlzELMAkGA1UEBhMCR0IxGzAZBgNVBAgTEkdyZWF0ZXIg
...

