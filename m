...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3FFF524C0EA
	for <lists+linux-kernel@lfdr.de>; Thu, 20 Aug 2020 16:50:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727937AbgHTOuQ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 20 Aug 2020 10:50:16 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50028 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726911AbgHTOtl (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 20 Aug 2020 10:49:41 -0400
Received: from mail-wm1-x341.google.com (mail-wm1-x341.google.com [IPv6:2a00:1450:4864:20::341])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1A006C061385
        for <linux-kernel@vger.kernel.org>; Thu, 20 Aug 2020 07:49:40 -0700 (PDT)
Received: by mail-wm1-x341.google.com with SMTP id c80so1857688wme.0
        for <linux-kernel@vger.kernel.org>; Thu, 20 Aug 2020 07:49:40 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20161025;
        h=date:from:to:cc:subject:message-id:references:mime-version
         :content-disposition:in-reply-to:user-agent;
        bh=lBclAdcwEJhlgvcd0UVuUFoWs4KiS6o2e5w6CHYm9eE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=lBclAdcwEJhlgvcd0UVuUFoWs4KiS6o2e5w6CHYm9eE=;
        b=
X-Gm-Message-State: AOAM532U5Er7vVx8khsD3D4SUs7rRXjmAeK4TMiVQYNtgYUWC8HB37vb
        QWohmK8kXVqqwDr1iwW1NnraHTBiWYsxKw==
X-Google-Smtp-Source: ABdhPJzV07H0JQdmRYEghtM2hJWn5s7gytWYo0soaPIsmMdtOS9ZZQkQwQ5xR8jzuR8YvGu+RiHzSw==
X-Received: by 2002:a7b:cf3a:: with SMTP id m26mr4053498wmg.25.1597934978322;
        Thu, 20 Aug 2020 07:49:38 -0700 (PDT)
Received: from elver.google.com ([100.105.32.75])
        by smtp.gmail.com with ESMTPSA id s19sm5098420wrb.54.2020.08.20.07.49.36
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 20 Aug 2020 07:49:36 -0700 (PDT)
Date:   Thu, 20 Aug 2020 16:49:31 +0200
From:   Marco Elver <elver@google.com>
To:     Steven Rostedt <rostedt@goodmis.org>
Cc:     Peter Zijlstra <peterz@infradead.org>,
        linux-kernel@vger.kernel.org, mingo@kernel.org, will@kernel.org,
        npiggin@gmail.com, jgross@suse.com, paulmck@kernel.org,
...
=46rom 5b12649cbcf0c7d164e6995c40ce88a4e3e86f28 Mon Sep 17 00:00:00 2001
...
@@ -261,14 +261,15 @@ should_watch(const volatile void *ptr, size_t size, i=
nt type, struct kcsan_ctx *
 		return false;
=20
 	/*
...
+/* Requires: KCSAN is disabled, to avoid prandom_u32() recursion. */
 ...
 {
 	long skip_count =3D kcsan_skip_watch -
@@ -283,12 +284,23 @@ static __always_inline bool kcsan_is_enabled(void)
 	return READ_ONCE(kcsan_enabled) && get_ctx()->disable_count =3D=3D 0;
 }
=20
...
+static void delay_access(void)
 {
 	unsigned int delay =3D in_task() ? kcsan_udelay_task : kcsan_udelay_inter=
rupt;
...
+	 */
+	delay -=3D IS_ENABLED(CONFIG_KCSAN_DELAY_RANDOMIZE) ? prandom_u32_max(del=
ay) : 0;
+
...
@@ -386,17 +398,30 @@ kcsan_setup_watchpoint(const volatile void *ptr, size=
_t size, int type)
 	} expect_value;
 	unsigned long access_mask;
 	enum kcsan_value_change value_change =3D KCSAN_VALUE_CHANGE_MAYBE;
-	unsigned long ua_flags =3D user_access_save();
+	unsigned long ua_flags =3D 0;
...
@@ -458,19 +483,17 @@ kcsan_setup_watchpoint(const volatile void *ptr, size=
_t size, int type)
 	}
=20
...
@@ -563,6 +586,7 @@ kcsan_setup_watchpoint(const volatile void *ptr, size_t=
 size, int type)
...
...
Freeing SMP alternatives memory: 112K
...
smpboot: CPU 4 Converting physical 0 to logical die 4
smpboot: CPU 5 Converting physical 0 to logical die 5
smpboot: CPU 6 Converting physical 0 to logical die 6
smpboot: CPU 7 Converting physical 0 to logical die 7
=============================
WARNING: suspicious RCU usage
5.9.0-rc1+ #20 Tainted: G        W        
-----------------------------
...
stack backtrace:
CPU: 5 PID: 0 Comm: swapper/5 Tainted: G        W         5.9.0-rc1+ #20
...
Call Trace:
 ...
 is_idle_task+0xd/0x20 include/linux/sched.h:1671
 irqentry_enter+0x17/0x50 kernel/entry/common.c:293
 sysvec_apic_timer_interrupt+0xc/0xf0 arch/x86/kernel/apic/apic.c:1091
 asm_sysvec_apic_timer_interrupt+0x12/0x20 arch/x86/include/asm/idtentry.h:581
RIP: 0010:default_idle+0x13/0x20 arch/x86/kernel/process.c:688
Code: fd ff ff e8 3f 19 5b fb 0f 0b e8 88 9c fe ff cc cc cc cc cc cc cc cc e8 fb 95 5e fb e9 07 00 00 00 0f 00 2d a1 72 58 00 fb f4 <c3> 66 66 2e 0f 1f 84 00 00 00 00 00 90 65 48 8b 04 25 00 70 01 00
RSP: 0000:ffffc900000a3ef8 EFLAGS: 00000202
RAX: 0000000000000005 RBX: 0000000000000005 RCX: ffffffff8148284a
RDX: 0000000000000000 RSI: 0000000000000001 RDI: 0000000000000000
RBP: ffff88881c758440 R08: 0000000000000001 R09: 0000000000000001
R10: 0000000000000000 R11: 000088881c758467 R12: 0000000000000000
R13: 0000000000000000 R14: 0000000000000000 R15: 0000000000000000
 default_idle_call+0x37/0x50 kernel/sched/idle.c:98
 cpuidle_idle_call kernel/sched/idle.c:168 [inline]
 do_idle+0x1fe/0x280 kernel/sched/idle.c:273
 cpu_startup_entry+0x14/0x20 kernel/sched/idle.c:369
 secondary_startup_64+0xa4/0xb0 arch/x86/kernel/head_64.S:243
=============================
WARNING: suspicious RCU usage
5.9.0-rc1+ #20 Not tainted
-----------------------------
include/trace/events/lock.h:13 suspicious rcu_dereference_check() usage!
...
stack backtrace:
CPU: 5 PID: 0 Comm: swapper/5 Not tainted 5.9.0-rc1+ #20
Hardware name: QEMU Standard PC (i440FX + PIIX, 1996), BIOS 1.13.0-1 04/01/2014
Call Trace:
------------[ cut here ]------------
DEBUG_LOCKS_WARN_ON(lockdep_hardirqs_enabled())
WARNING: CPU: 5 PID: 0 at kernel/locking/lockdep.c:4875 check_flags.part.0+0x157/0x160 kernel/locking/lockdep.c:4875
Modules linked in:
CPU: 5 PID: 0 Comm: swapper/5 Not tainted 5.9.0-rc1+ #20
Hardware name: QEMU Standard PC (i440FX + PIIX, 1996), BIOS 1.13.0-1 04/01/2014
RIP: 0010:check_flags.part.0+0x157/0x160 kernel/locking/lockdep.c:4875
Code: c0 0f 84 70 5d 00 00 44 8b 0d fd 11 5f 06 45 85 c9 0f 85 60 5d 00 00 48 c7 c6 3e d0 f4 86 48 c7 c7 ca 49 f3 86 e8 8d 49 f6 ff <0f> 0b e9 46 5d 00 00 66 90 41 57 41 56 49 89 fe 41 55 41 89 d5 41
RSP: 0000:ffffc900000a3a10 EFLAGS: 00010082
RAX: 0000000000000000 RBX: 0000000000000000 RCX: ffffffff814b701f
RDX: ffff88881c758440 RSI: ffffffff8136387e RDI: 0000000000000001
RBP: 0000000000000000 R08: 0000000000000000 R09: 000088881fcaa2d5
R10: 0000000000000000 R11: 0000c900000a383f R12: 0000000000000002
R13: 0000000000000000 R14: ffffffff874f2740 R15: 0000000000000046
FS:  0000000000000000(0000) GS:ffff88881fc80000(0000) knlGS:0000000000000000
...
Call Trace:
 ...
 lock_acquire+0x7d/0x400 kernel/locking/lockdep.c:5003
 rcu_lock_acquire include/linux/rcupdate.h:241 [inline]
 rcu_read_lock include/linux/rcupdate.h:634 [inline]
 is_bpf_text_address+0x36/0x190 kernel/bpf/core.c:704
 __bpf_address_lookup+0x230/0x230 kernel/bpf/core.c:679
 kernel_text_address kernel/extable.c:151 [inline]
 kernel_text_address+0xac/0xc0 kernel/extable.c:120
 __kernel_text_address+0x9/0x30 kernel/extable.c:105
 show_trace_log_lvl+0x1a5/0x2ba arch/x86/kernel/dumpstack.c:239
 __dump_stack lib/dump_stack.c:77 [inline]
 dump_stack+0xf1/0x14d lib/dump_stack.c:118
 __dump_stack lib/dump_stack.c:77 [inline]
 dump_stack+0xf1/0x14d lib/dump_stack.c:118
 trace_lock_acquire include/trace/events/lock.h:13 [inline]
 lock_acquire.cold+0x1f/0x40 kernel/locking/lockdep.c:4980
 __lock_acquire+0x58e/0x23c0 kernel/locking/lockdep.c:4431
 __raw_spin_lock include/linux/spinlock_api_smp.h:142 [inline]
 _raw_spin_lock+0x2a/0x40 kernel/locking/spinlock.c:151
 vprintk_emit+0xd6/0x550 kernel/printk/printk.c:2009
 vprintk_emit+0xd6/0x550 kernel/printk/printk.c:2009
 vprintk_default+0x23/0x30 kernel/printk/printk.c:2047
 vprintk_func+0x8d/0x151 kernel/printk/printk_safe.c:393
 printk+0x60/0x7d kernel/printk/printk.c:2078
 trace_prandom_u32 include/trace/events/random.h:310 [inline]
 prandom_u32+0x1c6/0x200 lib/random32.c:86
 lockdep_rcu_suspicious+0x1c/0xdd kernel/locking/lockdep.c:5894
 trace_prandom_u32 include/trace/events/random.h:310 [inline]
 prandom_u32+0x1ee/0x200 lib/random32.c:86
 prandom_u32_max include/linux/prandom.h:46 [inline]
 reset_kcsan_skip kernel/kcsan/core.c:277 [inline]
...
R10: 0000000000000000 R11: 000088881c758467 R12: 0000000000000000
R13: 0000000000000000 R14: 0000000000000000 R15: 0000000000000000
 trace_hardirqs_on+0x3a/0x1a0 kernel/trace/trace_preemptirq.c:43
 default_idle+0x5/0x20 arch/x86/kernel/process.c:687
 default_idle_call+0x37/0x50 kernel/sched/idle.c:98
 cpuidle_idle_call kernel/sched/idle.c:168 [inline]
 do_idle+0x1fe/0x280 kernel/sched/idle.c:273
 ...
 secondary_startup_64+0xa4/0xb0 arch/x86/kernel/head_64.S:243
irq event stamp: 273
hardirqs last  enabled at (273): [<ffffffff85e99215>] default_idle+0x5/0x20 arch/x86/kernel/process.c:687
hardirqs last disabled at (272): [<ffffffff8131235c>] do_idle+0x9c/0x280 kernel/sched/idle.c:253
softirqs last  enabled at (268): [<ffffffff812b022d>] irq_enter_rcu+0x7d/0x80 kernel/softirq.c:360
softirqs last disabled at (267): [<ffffffff812b0212>] irq_enter_rcu+0x62/0x80 kernel/softirq.c:363
---[ end trace 65ed88957f1ee9b8 ]---
...
CONFIG_KCSAN_REPORT_ONCE_IN_MS=300
