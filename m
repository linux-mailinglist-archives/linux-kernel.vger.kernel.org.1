...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id DB2692DACA6
	for <lists+linux-kernel@lfdr.de>; Tue, 15 Dec 2020 13:06:36 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729085AbgLOMDP (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 15 Dec 2020 07:03:15 -0500
Received: from smtp-fw-33001.amazon.com ([207.171.190.10]:52644 "EHLO
        smtp-fw-33001.amazon.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728606AbgLOMCy (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 15 Dec 2020 07:02:54 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  d=amazon.com; i=@amazon.com; q=dns/txt; s=amazon201209;
  t=1608033770; x=1639569770;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version;
  bh=NX2wfGlD9FY0xaZO0iJFmWF3k2rkc2lgU68tuRbCO7U=;
  b=LUhrKWBsN9/LUNsfQ7C9athYnp2l4Z296fEbyuCy59xCL7IBEbvmaSVq
   c2Wp4Gyn663w/0dcqNU278HgyUbQ04OZVl8B0olxDCk8FC1ZMm+s070RO
   4KDguC23VL+67+ovOjraZvEoXGQ2PiTA7pKkX9slMYM+DBqlJeY7c9e9D
   A=;
X-IronPort-AV: E=Sophos;i="5.78,420,1599523200"; 
   d="scan'208";a="103148696"
Received: from sea32-co-svc-lb4-vlan3.sea.corp.amazon.com (HELO email-inbound-relay-1e-42f764a0.us-east-1.amazon.com) ([10.47.23.38])
  by smtp-border-fw-out-33001.sea14.amazon.com with ESMTP; 15 Dec 2020 12:02:07 +0000
Received: from EX13D31EUA001.ant.amazon.com (iad12-ws-svc-p26-lb9-vlan2.iad.amazon.com [10.40.163.34])
        by email-inbound-relay-1e-42f764a0.us-east-1.amazon.com (Postfix) with ESMTPS id A635BC1C0A;
        Tue, 15 Dec 2020 12:02:03 +0000 (UTC)
Received: from u3f2cd687b01c55.ant.amazon.com (10.43.162.252) by
 EX13D31EUA001.ant.amazon.com (10.43.165.15) with Microsoft SMTP Server (TLS)
 id 15.0.1497.2; Tue, 15 Dec 2020 12:01:47 +0000
...
Subject: [PATCH v23 13/15] mm/damon: Add kunit tests
Date:   Tue, 15 Dec 2020 12:54:46 +0100
Message-ID: <20201215115448.25633-14-sjpark@amazon.com>
...
index 000000000000..c1a5dcab6c07
--- /dev/null
...
index b9575a6bebff..214ff404a423 100644
--- a/mm/damon/core.c
+++ b/mm/damon/core.c
@@ -16,6 +16,11 @@
...
@@ -708,3 +713,5 @@ static int kdamond_fn(void *data)
...
index 46186b057e1a..7380c6502f3d 100644
--- a/mm/damon/dbgfs.c
+++ b/mm/damon/dbgfs.c
@@ -863,3 +863,5 @@ static int __init damon_dbgfs_init(void)
 }
...
new file mode 100644
index 000000000000..bd36161d00f4
--- /dev/null
...
index efc56ef843fe..8ee48a4abc17 100644
--- a/mm/damon/vaddr.c
+++ b/mm/damon/vaddr.c
@@ -15,6 +15,11 @@
