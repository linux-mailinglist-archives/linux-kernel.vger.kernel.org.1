...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 827062708F8
	for <lists+linux-kernel@lfdr.de>; Sat, 19 Sep 2020 00:34:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726267AbgIRWeb (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 18 Sep 2020 18:34:31 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46276 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726157AbgIRWe0 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 18 Sep 2020 18:34:26 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [IPv6:2a0a:51c0:0:12e:550::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 12218C0613CF
        for <linux-kernel@vger.kernel.org>; Fri, 18 Sep 2020 15:34:26 -0700 (PDT)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        ...
        bh=Ty3AoYEVxNiiugEUgJyRvKwW2/de6SXviIngbcgzTXE=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1600468464;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=Ty3AoYEVxNiiugEUgJyRvKwW2/de6SXviIngbcgzTXE=;
        b=IAKkAKYpwZTi8qSHnF13fRGxMCBYKWoaL1S/zvu/R03WYxc7sm3NJIEA4y885EKhaliS9M
        L999OFnBDEOLX+BQ==
...
Subject: [PATCH printk v2 3/3] printk: remove dict ring
Date:   Sat, 19 Sep 2020 00:40:21 +0206
Message-Id: <20200918223421.21621-4-john.ogness@linutronix.de>
...
@@ -1080,7 +1075,7 @@ static unsigned int __init add_to_rb(struct printk_ringbuffer *rb,
...
+	prb_rec_init_wr(&dest_r, r->info->text_len);
 	...
 	if (!prb_reserve(&e, rb, &dest_r))
 		return 0;
@@ -1111,7 +1106,6 @@ void __init setup_log_buf(int early)
...
@@ -1169,13 +1156,10 @@ void __init setup_log_buf(int early)
 		goto err_free_descs;
 	}
...
@@ -1210,8 +1194,6 @@ void __init setup_log_buf(int early)
...
@@ -1462,7 +1444,7 @@ static int syslog_print(char __user *buf, int size)
 	if (!text)
 		return -ENOMEM;
...
+	prb_rec_init_rd(&r, &info, text, LOG_LINE_MAX + PREFIX_MAX);
 	...
 	while (size > 0) {
 		size_t n;
@@ -1549,7 +1531,7 @@ static int syslog_print_all(char __user *buf, int size, bool clear)
...
@@ -1919,7 +1901,7 @@ static size_t log_output(int facility, int level, enum log_flags lflags,
 		struct prb_reserved_entry e;
 		struct printk_record r;
...
@@ -2407,7 +2389,7 @@ void console_unlock(void)
 		return;
 	}
...
@@ -3265,7 +3247,7 @@ bool kmsg_dump_get_line_nolock(struct kmsg_dumper *dumper, bool syslog,
 	size_t l = 0;
 	bool ret = false;
...
+	prb_rec_init_rd(&r, &info, line, size);
 	...
 	if (!dumper->active)
 		goto out;
@@ -3356,7 +3338,7 @@ bool kmsg_dump_get_buffer(struct kmsg_dumper *dumper, bool syslog,
 	bool ret = false;
...
+	prb_rec_init_rd(&r, &info, buf, size);
 	...
 	if (!dumper->active || !buf || !size)
 		goto out;
@@ -3404,7 +3386,7 @@ bool kmsg_dump_get_buffer(struct kmsg_dumper *dumper, bool syslog,
