...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 4C2832D7D02
	for <lists+linux-kernel@lfdr.de>; Fri, 11 Dec 2020 18:38:14 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2405437AbgLKRgm (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 11 Dec 2020 12:36:42 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45280 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2395372AbgLKRgh (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 11 Dec 2020 12:36:37 -0500
Received: from mail-pl1-x629.google.com (mail-pl1-x629.google.com [IPv6:2607:f8b0:4864:20::629])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 45FC9C061793
        for <linux-kernel@vger.kernel.org>; Fri, 11 Dec 2020 09:35:57 -0800 (PST)
Received: by mail-pl1-x629.google.com with SMTP id t6so4941495plq.1
        for <linux-kernel@vger.kernel.org>; Fri, 11 Dec 2020 09:35:57 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=LLsce8dqUHI5Rl2DtnfWCHxIjxrfy6LRgmWpWIR8zg8=;
        b=azXuKJ9M8dzjrIEJl12RMsnVO7IqvuBrOAkMlOCtT3vporDcVNb4+q1ydOcwnHSQoS
         Dnq8EyXrRVjVQH+ufmMFZsySAGwPxVHaEYFajk05KnyeYkb5M/iMcN06UpA5i1OvX/ZF
         ya+SwajeD6NywTGGCP7f/9jcpP62vmmGhjEuk=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:mime-version:content-transfer-encoding;
        bh=LLsce8dqUHI5Rl2DtnfWCHxIjxrfy6LRgmWpWIR8zg8=;
        b=
X-Gm-Message-State: AOAM533qwAI/al2yt0wAMdXOJqIifRieBwjC5WO6HKS8RbN0/xeGQT2Y
        39z7CwAYY/0DsgEcU7EvIj81hg==
X-Google-Smtp-Source: ABdhPJzuCuaTQAzCJ52T4aDf+8oCzJZsO3RR6tA6REoNsl6LvQaCFnUjylXWAkWOLv+fe/MOyoe5Zg==
X-Received: by 2002:a17:90a:4093:: with SMTP id l19mr14178119pjg.218.1607708156538;
        Fri, 11 Dec 2020 09:35:56 -0800 (PST)
Received: from tictac2.mtv.corp.google.com ([2620:15c:202:1:42b0:34ff:fe3d:58e6])
        by smtp.gmail.com with ESMTPSA id r185sm11402765pfc.53.2020.12.11.09.35.54
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 11 Dec 2020 09:35:55 -0800 (PST)
...
Cc:     hdegoede@redhat.com, swboyd@chromium.org, robh+dt@kernel.org,
        ...
        Coiby Xu <coiby.xu@gmail.com>, Jiri Kosina <jikos@kernel.org>,
        Masahiro Yamada <masahiroy@kernel.org>,
        Pavel Balan <admin@kryma.net>,
        Xiaofei Tan <tanxiaofei@huawei.com>,
        linux-kernel@vger.kernel.org
Subject: [PATCH v7 1/4] HID: i2c-hid: Reorganize so ACPI and OF are separate modules
Date:   Fri, 11 Dec 2020 09:35:23 -0800
Message-Id: <20201211092956.v7.1.Ied4ce10d229cd7c69abf13a0361ba0b8d82eb9c4@changeid>
...
index bfe716d7ea44..fcd155be89a5 100644
...
+int i2c_hid_core_suspend(struct device *dev)
 {
 	...
 	struct i2c_hid *ihid = i2c_get_clientdata(client);
@@ -1217,14 +1074,14 @@ static int i2c_hid_suspend(struct device *dev)
...
+int i2c_hid_core_resume(struct device *dev)
 {
 	int ret;
 	struct i2c_client *client = to_i2c_client(dev);
@@ -1233,13 +1090,7 @@ static int i2c_hid_resume(struct device *dev)
 	int wake_status;
...
+		i2c_hid_core_power_up(ihid);
 		...
 		if (!wake_status)
@@ -1274,36 +1125,13 @@ static int i2c_hid_resume(struct device *dev)
