...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6A6D62A9823
	for <lists+linux-kernel@lfdr.de>; Fri,  6 Nov 2020 16:11:59 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727706AbgKFPLg (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 6 Nov 2020 10:11:36 -0500
Received: from relayfre-01.paragon-software.com ([176.12.100.13]:50112 "EHLO
        relayfre-01.paragon-software.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1727557AbgKFPLU (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 6 Nov 2020 10:11:20 -0500
Received: from dlg2.mail.paragon-software.com (vdlg-exch-02.paragon-software.com [172.30.1.105])
        by relayfre-01.paragon-software.com (Postfix) with ESMTPS id BB0001D29;
        Fri,  6 Nov 2020 18:11:16 +0300 (MSK)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=paragon-software.com; s=mail; t=1604675476;
        bh=enUDnEPcvd/S9yXivjdAJrnR9I3bCN8zdJxxwBG/DhA=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=iXjJslSUharwaC9b+DNvjuoDoAnG93n/bVoBwbBBRCPoCecS19rIBKDMrn6+UL0iH
         UEAvtE0smujthEXmwl7R4j8htGRR5itRHNemDGA6s7TpvL+g36/7O/60tESHVlUmp8
         A1itkBd3HakUzBLfQnrhvTTKmEjGOrjmLfZ6JwWg=
Received: from fsd-lkpg.ufsd.paragon-software.com (172.30.114.105) by
 vdlg-exch-02.paragon-software.com (172.30.1.105) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1847.3; Fri, 6 Nov 2020 18:11:16 +0300
...
Subject: [PATCH v12 05/10] fs/ntfs3: Add attrib operations
Date:   Fri, 6 Nov 2020 18:09:04 +0300
Message-ID: <20201106150909.1779040-6-almaz.alexandrovich@paragon-software.com>
...
index 000000000000..15e2cdbce910
--- /dev/null
+++ b/fs/ntfs3/attrib.c
@@ -0,0 +1,1395 @@
...
+			}
+			lock_page(page);
+			memcpy(page_address(page), resident_data(attr), rsize);
+			err = ntfs_bio_pages(sbi, run, &page, 1, 0, rsize,
+					     REQ_OP_WRITE);
+			unlock_page(page);
+			put_page(page);
+		} else {
+			err = ntfs_sb_write_run(sbi, run, 0,
+						resident_data(attr), rsize);
+		}
+		if (err)
+			goto out;
+	}
...
new file mode 100644
index 000000000000..5e7f03193512
--- /dev/null
+++ b/fs/ntfs3/xattr.c
@@ -0,0 +1,1073 @@
+// SPDX-License-Identifier: GPL-2.0
