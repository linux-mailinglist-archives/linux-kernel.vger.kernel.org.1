...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8884923AB7B
	for <lists+linux-kernel@lfdr.de>; Mon,  3 Aug 2020 19:19:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728459AbgHCRRn (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 3 Aug 2020 13:17:43 -0400
Received: from cloudserver094114.home.pl ([79.96.170.134]:52720 "EHLO
        cloudserver094114.home.pl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728032AbgHCRRm (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 3 Aug 2020 13:17:42 -0400
Received: from 89-64-89-42.dynamic.chello.pl (89.64.89.42) (HELO kreacher.localnet)
 by serwer1319399.home.pl (79.96.170.134) with SMTP (IdeaSmtpServer 0.83.415)
 id 39128dc000c8ea5e; Mon, 3 Aug 2020 19:17:38 +0200
...
Subject: [PATCH v5] cpufreq: intel_pstate: Implement passive mode with HWP enabled
Date:   Mon, 03 Aug 2020 19:17:37 +0200
Message-ID: <5605271.5WD5kalLAl@kreacher>
In-Reply-To: <4684795.LlGW2geaUc@kreacher>
References: <4981405.3kqTVLv5tO@kreacher> <13207937.r2GEYrEf4f@kreacher> <4684795.LlGW2geaUc@kreacher>
MIME-Version: 1.0
...
This is on top of the linux-next branch in linux-pm.git from today (should
be there in linux-next tomorrow).

This is just one patch now, because the previous [1/2] has been merged
into the branch above (it is needed to fix a bug).
...
---
 ...
 drivers/cpufreq/intel_pstate.c                |  203 ++++++++++++++++++++------
 2 files changed, 203 insertions(+), 89 deletions(-)
...
+	s16 epp_cached;
 	...
 	u64 hwp_cap_cached;
 	u64 last_io_update;
@@ -697,6 +700,8 @@ static ssize_t show_energy_performance_a
...
+
 ...
 {
@@ -725,11 +730,31 @@ static ssize_t store_energy_performance_
 		raw = true;
 	}
...
@@ -1145,8 +1170,6 @@ static ssize_t store_no_turbo(struct kob
 	return count;
 }
...
@@ -1330,9 +1353,10 @@ static const struct attribute_group inte
...
@@ -1357,17 +1381,31 @@ static void __init intel_pstate_sysfs_ex
...
@@ -2048,6 +2086,7 @@ static int intel_pstate_init_cpu(unsigne
...
@@ -2246,7 +2285,10 @@ static int intel_pstate_verify_policy(st
...
@@ -2254,12 +2296,10 @@ static void intel_pstate_stop_cpu(struct
...
@@ -2389,13 +2429,82 @@ static void intel_cpufreq_trace(struct c
...
@@ -2403,6 +2512,7 @@ static int intel_cpufreq_target(struct c
...
@@ -2414,15 +2524,11 @@ static int intel_cpufreq_target(struct c
...
+
 	...
 	return 0;
@@ -2432,15 +2538,14 @@ static unsigned int intel_cpufreq_fast_s
 					      unsigned int target_freq)
 {
 	struct cpudata *cpu = all_cpu_data[policy->cpu];
-	int target_pstate, old_pstate;
...
@@ -2460,7 +2565,6 @@ static int intel_cpufreq_cpu_init(struct
 		return ret;
...
@@ -2472,10 +2576,17 @@ static int intel_cpufreq_cpu_init(struct
...
@@ -2552,6 +2663,10 @@ static void intel_pstate_driver_cleanup(
 		}
 	}
 	put_online_cpus();
+
...
@@ -2559,6 +2674,9 @@ static int intel_pstate_register_driver(
 {
 	int ret;
...
@@ -2576,9 +2694,6 @@ static int intel_pstate_register_driver(
...
@@ -2834,7 +2949,10 @@ static int __init intel_pstate_init(void
 			hwp_active++;
...
@@ -2905,14 +3023,13 @@ static int __init intel_pstate_setup(cha
 	if (!str)
 		return -EINVAL;
