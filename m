...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1D5AB1E2A42
	for <lists+linux-kernel@lfdr.de>; Tue, 26 May 2020 20:47:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2389019AbgEZSr4 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 26 May 2020 14:47:56 -0400
Received: from pb-smtp1.pobox.com ([64.147.108.70]:64597 "EHLO
        pb-smtp1.pobox.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2388740AbgEZSrz (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 26 May 2020 14:47:55 -0400
Received: from pb-smtp1.pobox.com (unknown [127.0.0.1])
        by pb-smtp1.pobox.com (Postfix) with ESMTP id 527027563C;
        Tue, 26 May 2020 14:47:47 -0400 (EDT)
        (envelope-from junio@pobox.com)
DKIM-Signature: v=1; a=rsa-sha1; c=relaxed; d=pobox.com; h=from:to:cc
        :subject:date:message-id:mime-version:content-type
        :content-transfer-encoding; s=sasl; bh=Jie/XcLRxgeHPieNOwk4I3Qvv
        hw=; b=FaYKHx9MPxRSFGkpO4AStHwoOhFjRsmZW+xHBZKTIddtnFmilldwXk2IE
        ggimHyyNJYMjj14xi5Q81LVr83E77GnM3nO+O0z/HER6JF8mIBUQOrKo4smLRM6C
        DnCxczeudt6ceN2Q++vBkbwS8U6qqlFK7y9KFldfTva0oakr24=
DomainKey-Signature: a=rsa-sha1; c=nofws; d=pobox.com; h=from:to:cc
        :subject:date:message-id:mime-version:content-type
        :content-transfer-encoding; q=dns; s=sasl; b=UAHmZsMcHnKUrCJ2Jex
        rZCjWMU8QXFQ2aePeD3gbWlIo/G9QGKvBg47wxI5fTfydOPYH3rQuslH/uSSLXUj
        TFaZhGZ6jHjfOvcQoNxKLM+GGBqmDz6WrfSeM4sdsqR2PMhnawT4sNule2ZdqGHD
        5oUZa3cn0b4lGNNsJHu1Q+sE=
Received: from pb-smtp1.nyi.icgroup.com (unknown [127.0.0.1])
        by pb-smtp1.pobox.com (Postfix) with ESMTP id 481197563B;
        Tue, 26 May 2020 14:47:47 -0400 (EDT)
        (envelope-from junio@pobox.com)
Received: from pobox.com (unknown [35.196.173.25])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by pb-smtp1.pobox.com (Postfix) with ESMTPSA id 9DE1D7563A;
        Tue, 26 May 2020 14:47:46 -0400 (EDT)
        (envelope-from junio@pobox.com)
From:   Junio C Hamano <gitster@pobox.com>
To:     git@vger.kernel.org
Cc:     Linux Kernel <linux-kernel@vger.kernel.org>,
        git-packagers@googlegroups.com
Subject: [ANNOUNCE] Git v2.27.0-rc2
Date:   Tue, 26 May 2020 11:47:45 -0700
Message-ID: <xmqqtv02mt2m.fsf@gitster.c.googlers.com>
User-Agent: Gnus/5.13 (Gnus v5.13) Emacs/26.3 (gnu/linux)
MIME-Version: 1.0
Content-Type: text/plain; charset=utf-8
X-Pobox-Relay-ID: 64114EC0-9F81-11EA-AF81-C28CBED8090B-77302942!pb-smtp1.pobox.com
...
Welcome to the Git development community!
  ...
  Matthias A=C3=9Fhauer, Michael F. Sch=C3=B6nitzer, Nathan Sanders,
...
C=C3=B4ng
  ...
  Jonathan Tan, Josh Steadmon, Junio C Hamano, Martin =C3=85gren,
  Matheus Tavares, Patrick Steinhardt, Philippe Blain, Phillip
  Wood, Pratyush Yadav, Ren=C3=A9 Scharfe, Shourya Shukla, SZEDER
  G=C3=A1bor, Taylor Blau, Thomas Gummerer, and Todd Zullinger.
...
=C4=90o=C3=A0n Tr=E1=BA=A7n C=C3=B4ng Danh (36):
