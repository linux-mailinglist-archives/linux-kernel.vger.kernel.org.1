...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 17C642D615D
	for <lists+linux-kernel@lfdr.de>; Thu, 10 Dec 2020 17:13:31 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731470AbgLJQM6 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 10 Dec 2020 11:12:58 -0500
Received: from mail.kernel.org ([198.145.29.99]:39600 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2392341AbgLJQMZ (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 10 Dec 2020 11:12:25 -0500
...
Subject: [PATCH v2 05/12] drm/mediatek: Move regs info from struct mtk_ddp_comp to sub driver private data
Date:   Fri, 11 Dec 2020 00:10:43 +0800
Message-Id: <20201210161050.8460-6-chunkuang.hu@kernel.org>
...
index 7556976cd461..93863dbfb761 100644
...
@@ -135,6 +137,13 @@ static int mtk_disp_color_probe(struct platform_device *pdev)
...
index 589c33937793..90a78db0e96b 100644
...
+	struct resource *res;
 	...
 	int irq;
 	int ret;
@@ -396,6 +408,13 @@ static int mtk_disp_ovl_probe(struct platform_device *pdev)
 		return PTR_ERR(priv->clk);
 	}
...
index 95feacda49b1..1057c7a42ff2 100644
...
+	struct resource *res;
 	...
 	int irq;
 	int ret;
@@ -309,6 +312,13 @@ static int mtk_disp_rdma_probe(struct platform_device *pdev)
 		return PTR_ERR(priv->clk);
 	}
...
index 9ed0d38830df..eaca3b930c5b 100644
