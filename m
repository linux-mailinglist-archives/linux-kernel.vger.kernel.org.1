...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BC533297C24
	for <lists+linux-kernel@lfdr.de>; Sat, 24 Oct 2020 13:40:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1760364AbgJXLkd (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 24 Oct 2020 07:40:33 -0400
Received: from rere.qmqm.pl ([91.227.64.183]:8555 "EHLO rere.qmqm.pl"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1760066AbgJXLka (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 24 Oct 2020 07:40:30 -0400
Received: from remote.user (localhost [127.0.0.1])
        by rere.qmqm.pl (Postfix) with ESMTPSA id 4CJK0S5NNtz5H;
        Sat, 24 Oct 2020 13:40:24 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=rere.qmqm.pl; s=1;
        t=1603539626; bh=8oMq4yMthen2qiKGAEWdwR8TejG6EYnvf2IU4pYLhfc=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=
X-Virus-Status: Clean
X-Virus-Scanned: clamav-milter 0.102.4 at mail
Date:   Sat, 24 Oct 2020 13:40:23 +0200
From:   =?iso-8859-2?Q?Micha=B3_Mios=B3aw?= <mirq-linux@rere.qmqm.pl>
To:     Corentin Labbe <clabbe.montjoie@gmail.com>
Cc:     mripard@kernel.org, wens@csie.org, broonie@kernel.org,
        lgirdwood@gmail.com, linux-kernel@vger.kernel.org,
        linux-arm-kernel@lists.infradead.org
Subject: Re: [BUG] Error applying setting, reverse things back on lot of
 devices
Message-ID: <20201024114022.GA22398@qmqm.qmqm.pl>
...
In-Reply-To: <20201023203943.GA21435@Red>
...
It looks like the axp20x driver sets some internal supply names
without of exposing them in DT. This means that regulator core is
not able to find the supply before it is registered... but the driver
seems to register regulators in correct order, so I'm not sure yet
what the bug is.
