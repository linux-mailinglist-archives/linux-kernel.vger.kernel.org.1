...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BF6D01F526B
	for <lists+linux-kernel@lfdr.de>; Wed, 10 Jun 2020 12:36:52 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728273AbgFJKgn (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 10 Jun 2020 06:36:43 -0400
Received: from mga14.intel.com ([192.55.52.115]:65012 "EHLO mga14.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726754AbgFJKgm (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 10 Jun 2020 06:36:42 -0400
IronPort-SDR: fyJrAsKVywyYwmdzfOuxsKq6m23zGky4AQYHoCo1tACLHrPKt+ktiMV80bQ+WWP7fQC+lSvGFb
 AXs0LUUAWO+w==
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 10 Jun 2020 01:35:34 -0700
IronPort-SDR: Ck9Q2OEuu3yMBluQmjCkTq5vI3EUMdscYS5b/2IkGCcaxiAIKcaUZR5D2FQaWUdKLCrrcK/cB0
 v6DA8s6Hgbyw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,495,1583222400"; 
   d="yaml'?scan'208";a="306484399"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.3])
  by fmsmga002.fm.intel.com with ESMTP; 10 Jun 2020 01:35:31 -0700
Date:   Wed, 10 Jun 2020 16:35:02 +0800
...
Message-ID: <20200610083502.GF12456@shao2-debian>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="06e8aCKEiI5FEIzX"
...
Content-Disposition: attachment; filename="config-5.7.0-rc6-00143-gb2a02fc43a1f4"
...
export_top_env()
{
	...
	export rtcwake=5
	export idle_time=
	export job_origin='/home/rzhang1/jobs/ss-10x10-freeze.yaml'
	export queue_cmdline_keys=
	export schedule_notify_address=
	export queue='vip'
	export testbox='lkp-bxtm-lenovo1'
	export tbox_group='lkp-bxtm-lenovo1'
	export branch='linus/master'
	export commit='b2a02fc43a1f40ef4eb2fb2b06357382608d4d84'
	export submit_id='5ee0486f0b9a93a8050daf70'
	export job_file='/lkp/jobs/scheduled/lkp-bxtm-lenovo1/suspend-stress-10-freeze-debian-x86_64-20180403.cgz-b2a02fc43a1f40ef4eb2fb2b06357382608d4d84-20200610-43013-y6kbze-0.yaml'
	export id='b4c2fb83fc7dc7804a906fd4ec81f263f0f53e6f'
	export queuer_version='/lkp/rzhang1/.src-20200608-135048'
	export model='Broxton'
	export nr_cpu=2
	export memory='4G'
	export swap_partitions='ata-ST500LT012-1DG142_SBY6QFKZ-part6'
	export bios_version='1MCN29WW'
	export ksc_version='1MEC24WW'
	export hw_version='Lenovo V110-14IAP'
...
CONFIG_PM_DEBUG=y'
	...
	export enqueue_time='2020-06-10 10:42:48 +0800'
	export _id='5ee048a90b9a93a8050daf74'
	export _rt='/result/suspend-stress/10-freeze/lkp-bxtm-lenovo1/debian-x86_64-20180403.cgz/x86_64-rhel-7.6/gcc-9/b2a02fc43a1f40ef4eb2fb2b06357382608d4d84'
	export user='lkp'
	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-9/b2a02fc43a1f40ef4eb2fb2b06357382608d4d84/vmlinuz-5.7.0-rc6-00143-gb2a02fc43a1f4'
	export result_root='/result/suspend-stress/10-freeze/lkp-bxtm-lenovo1/debian-x86_64-20180403.cgz/x86_64-rhel-7.6/gcc-9/b2a02fc43a1f40ef4eb2fb2b06357382608d4d84/8'
	export dequeue_time='2020-06-10 13:03:12 +0800'
	export scheduler_version='/lkp/lkp/.src-20200609-235012'
	export LKP_SERVER='inn'
	export arch='x86_64'
	export max_uptime=11400
	export initrd='/osimage/debian/debian-x86_64-20180403.cgz'
	export bootloader_append='root=/dev/ram0
user=lkp
job=/lkp/jobs/scheduled/lkp-bxtm-lenovo1/suspend-stress-10-freeze-debian-x86_64-20180403.cgz-b2a02fc43a1f40ef4eb2fb2b06357382608d4d84-20200610-43013-y6kbze-0.yaml
ARCH=x86_64
kconfig=x86_64-rhel-7.6
branch=linus/master
commit=b2a02fc43a1f40ef4eb2fb2b06357382608d4d84
BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-9/b2a02fc43a1f40ef4eb2fb2b06357382608d4d84/vmlinuz-5.7.0-rc6-00143-gb2a02fc43a1f4
initcall_debug log_buf_len=4M no_console_suspend ignore_loglevel
max_uptime=11400
RESULT_ROOT=/result/suspend-stress/10-freeze/lkp-bxtm-lenovo1/debian-x86_64-20180403.cgz/x86_64-rhel-7.6/gcc-9/b2a02fc43a1f40ef4eb2fb2b06357382608d4d84/8
LKP_SERVER=inn
nokaslr
selinux=0
debug
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-7.6/gcc-9/b2a02fc43a1f40ef4eb2fb2b06357382608d4d84/modules.cgz'
	...
	export job_initrd='/lkp/jobs/scheduled/lkp-bxtm-lenovo1/suspend-stress-10-freeze-debian-x86_64-20180403.cgz-b2a02fc43a1f40ef4eb2fb2b06357382608d4d84-20200610-43013-y6kbze-0.cgz'
...
rtcwake: 
idle_time: 
job_origin: "/lkp/lkp/.src-20200605-102203/allot/cyclic:power:linux-devel:devel-hourly/lkp-bxtm-lenovo1/suspend-stress.yaml"
...
- commit
queue: bisect
testbox: lkp-bxtm-lenovo1
tbox_group: lkp-bxtm-lenovo1
submit_id: 5edc2ad0fac5704a5b19d192
job_file: "/lkp/jobs/scheduled/lkp-bxtm-lenovo1/suspend-stress-10-freeze-debian-x86_64-20180403.cgz-b2a02fc43a1f40ef4eb2fb2b06357382608d4d84-20200607-19035-148qwep-0.yaml"
id: 475f45ff58300372f90d2af45ecedbc3d04b6491
queuer_version: "/lkp-src"

#! hosts/lkp-bxtm-lenovo1
model: Broxton
nr_cpu: 2
memory: 4G
swap_partitions: ata-ST500LT012-1DG142_SBY6QFKZ-part6
bios_version: 1MCN29WW
ksc_version: 1MEC24WW
hw_version: Lenovo V110-14IAP
belongs_to: power
...
#! include/testbox/lkp-bxtm-lenovo1
rootfs: debian-x86_64-20180403.cgz

#! default params
kconfig: x86_64-rhel-7.6
compiler: gcc-9
enqueue_time: 2020-06-07 07:46:27.283619775 +08:00
_id: 5edc2ad0fac5704a5b19d192
_rt: "/result/suspend-stress/10-freeze/lkp-bxtm-lenovo1/debian-x86_64-20180403.cgz/x86_64-rhel-7.6/gcc-9/b2a02fc43a1f40ef4eb2fb2b06357382608d4d84"

#! schedule options
user: lkp
head_commit: b3215594be87f60d60c6ce25edbae4b9407ba836
base_commit: 3d77e6a8804abcc0504c904bd6e5cdf3a5cf8162
branch: linux-devel/devel-hourly-2020060606
result_root: "/result/suspend-stress/10-freeze/lkp-bxtm-lenovo1/debian-x86_64-20180403.cgz/x86_64-rhel-7.6/gcc-9/b2a02fc43a1f40ef4eb2fb2b06357382608d4d84/0"
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-bxtm-lenovo1/suspend-stress-10-freeze-debian-x86_64-20180403.cgz-b2a02fc43a1f40ef4eb2fb2b06357382608d4d84-20200607-19035-148qwep-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2020060606
- commit=b2a02fc43a1f40ef4eb2fb2b06357382608d4d84
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-9/b2a02fc43a1f40ef4eb2fb2b06357382608d4d84/modules.cgz"
...
#! user overrides
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-9/b2a02fc43a1f40ef4eb2fb2b06357382608d4d84/vmlinuz-5.7.0-rc6-00143-gb2a02fc43a1f4"
dequeue_time: 2020-06-07 08:26:25.492485070 +08:00
