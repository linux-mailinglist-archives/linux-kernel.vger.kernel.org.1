...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CBDC62AE28E
	for <lists+linux-kernel@lfdr.de>; Tue, 10 Nov 2020 23:08:17 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732000AbgKJWIH (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 10 Nov 2020 17:08:07 -0500
Received: from mx0a-00082601.pphosted.com ([67.231.145.42]:1314 "EHLO
        mx0a-00082601.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726467AbgKJWIG (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 10 Nov 2020 17:08:06 -0500
Received: from pps.filterd (m0109333.ppops.net [127.0.0.1])
        by mx0a-00082601.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id 0AAM5rsP005474
        for <linux-kernel@vger.kernel.org>; Tue, 10 Nov 2020 14:08:05 -0800
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=fb.com; h=from : to : cc : subject
 : date : message-id : in-reply-to : references : mime-version :
 content-transfer-encoding : content-type; s=facebook;
 bh=DzQ8RPtZ9/0jMg6/qsxagacHc9kK+sqwtwfHG4yeiYE=;
 b=clk0YKu+njbeCsTELH+0h6h4Q57phzl+zaE8ag0A1L1LqQF4S93brr8M57o1NZV3MZiv
 mLaTNqgaf/h+mgUZ32LswnjUYb6ku2gD84jjSWTY05QWOJATZplxsHPJhqVKZZIj1Yn3
 ryGC8FZ4eWWSWT28mm7dNC7HUbeEJYyVlNk= 
Received: from mail.thefacebook.com ([163.114.132.120])
        by mx0a-00082601.pphosted.com with ESMTP id 34pbxxng68-1
...
Received: by devvm1755.vll0.facebook.com (Postfix, from userid 111017)
        id 30FD9239AED3; Tue, 10 Nov 2020 14:08:01 -0800 (PST)
...
Subject: [PATCH v1 1/3] mm: memcg: deprecate the non-hierarchical mode
Date:   Tue, 10 Nov 2020 14:07:58 -0800
Message-ID: <20201110220800.929549-2-guro@fb.com>
...
index 20108e426f84..aaa557dff5f4 100644
...
index 69a2893a6455..ea05e4ed5aa1 100644
--- a/mm/memcontrol.c
+++ b/mm/memcontrol.c
...
-out:
 	if (prev && prev !=3D root)
 		css_put(&prev->css);
=20
@@ -3438,10 +3431,7 @@ unsigned long mem_cgroup_soft_limit_reclaim(pg_dat=
a_t *pgdat, int order,
 }
=20
 /*
...
+ * Test whether @memcg has children, dead or alive.
 ...
 {
@@ -3501,37 +3491,20 @@ static ssize_t mem_cgroup_force_empty_write(struc=
...
p)
@@ -3725,8 +3698,6 @@ static void memcg_offline_kmem(struct mem_cgroup *m=
emcg)
...
-			break;
 	...
 	rcu_read_unlock();
=20
@@ -5317,38 +5288,22 @@ mem_cgroup_css_alloc(struct cgroup_subsys_state *=
parent_css)
 	if (parent) {
...
@@ -6540,7 +6477,6 @@ struct cgroup_subsys memory_cgrp_subsys =3D {
