...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7545D1AE625
	for <lists+linux-kernel@lfdr.de>; Fri, 17 Apr 2020 21:44:39 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730880AbgDQTns (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 17 Apr 2020 15:43:48 -0400
Received: from us-smtp-delivery-1.mimecast.com ([207.211.31.120]:55679 "EHLO
        us-smtp-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1730449AbgDQTnr (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 17 Apr 2020 15:43:47 -0400
...
Subject: [RFC v3 11/11] drm/nouveau/kms/nvd9-: Add CRC support
...
+{
+	struct drm_vblank_work *work =3D to_drm_vblank_work(kwork);
...
+
 ...
 {
@@ -1899,6 +1912,7 @@ nv50_disp_atomic_commit_tail(struct drm_atomic_stat=
e *state)
 	int i;
=20
...
@@ -1908,6 +1922,7 @@ nv50_disp_atomic_commit_tail(struct drm_atomic_stat=
e *state)
=20
 	/* Disable head(s). */
...
+		struct nv50_head_atom *armh =3D nv50_head_atom(old_crtc_state);
 		...
 		struct nv50_head *head =3D nv50_head(crtc);
=20
@@ -1920,7 +1935,8 @@ nv50_disp_atomic_commit_tail(struct drm_atomic_stat=
e *state)
 		}
=20
 		if (asyh->clr.mask) {
...
@@ -1969,6 +1985,8 @@ nv50_disp_atomic_commit_tail(struct drm_atomic_stat=
e *state)
 		}
 	}
=20
...
@@ -1991,6 +2009,7 @@ nv50_disp_atomic_commit_tail(struct drm_atomic_stat=
e *state)
=20
 	/* Update head(s). */
 	for_each_oldnew_crtc_in_state(state, crtc, old_crtc_state, new_crtc_sta=
...
+		struct nv50_head_atom *armh =3D nv50_head_atom(old_crtc_state);
 		...
 		struct nv50_head *head =3D nv50_head(crtc);
=20
@@ -1998,7 +2017,7 @@ nv50_disp_atomic_commit_tail(struct drm_atomic_stat=
e *state)
...
=20
@@ -2082,6 +2101,7 @@ nv50_disp_atomic_commit_tail(struct drm_atomic_stat=
e *state)
 		}
 	}
=20
