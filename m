...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 369C2252C02
	for <lists+linux-kernel@lfdr.de>; Wed, 26 Aug 2020 13:03:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728842AbgHZLD3 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 26 Aug 2020 07:03:29 -0400
Received: from mail.kernel.org ([198.145.29.99]:42458 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728739AbgHZKz4 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 26 Aug 2020 06:55:56 -0400
Received: from localhost (83-86-89-107.cable.dynamic.v4.ziggo.nl [83.86.89.107])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id DDA1220838;
        Wed, 26 Aug 2020 10:55:52 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1598439353;
        bh=XpyHkDT19Azu8et6RFeL2YvdD1oEwgSxv828FfPx7MU=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=AA/1BzGDMU4deGCJEiXg5P53jKiJTd7b9mtHMPgVz90MPUmNe0lfVUr5L0wDS6jxm
         QHHWXjNr6REc7q/8MXM0TufzsY7TC9R+VKyJ1s6gGVjFyn9zeQtHzPr9MzzaIkrIVb
         foaXJ+4/oa4mA9MvbgLUt4sgmWTCdDOTypJ4efGk=
From:   Greg Kroah-Hartman <gregkh@linuxfoundation.org>
To:     linux-kernel@vger.kernel.org, akpm@linux-foundation.org,
        torvalds@linux-foundation.org, stable@vger.kernel.org
Cc:     lwn@lwn.net, jslaby@suse.cz,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>
Subject: Re: Linux 4.14.195
Date:   Wed, 26 Aug 2020 12:56:03 +0200
Message-Id: <159843936220427@kroah.com>
X-Mailer: git-send-email 2.28.0
In-Reply-To: <159843936281102@kroah.com>
References: <159843936281102@kroah.com>
MIME-Version: 1.0
...
index 5fc8a010fdf0..ebe97e5500ee 100644
...
-
 	...
 	if (is_write)
@@ -488,8 +500,17 @@ static int __do_page_fault(struct pt_regs *regs, unsigned long address,
...
index 1f867e275408..861d2c0a521a 100644
...
index 57908ee964a2..17856e92b93d 100644
--- a/fs/btrfs/inode.c
+++ b/fs/btrfs/inode.c
@@ -629,7 +629,21 @@ static noinline void compress_file_range(struct inode *inode,
...
@@ -708,13 +722,6 @@ static noinline void compress_file_range(struct inode *inode,
 	*num_added += 1;
...
index c291bf61afb9..00f0902e27e8 100644
--- a/fs/eventpoll.c
+++ b/fs/eventpoll.c
...
index 161099f39ab9..3f999053457b 100644
--- a/fs/ext4/namei.c
+++ b/fs/ext4/namei.c
...
index 04b4c38d0c18..9dfe364d4c0d 100644
--- a/mm/khugepaged.c
+++ b/mm/khugepaged.c
...
index e992afe3a58e..a3958b4fec6c 100644
--- a/mm/page_alloc.c
+++ b/mm/page_alloc.c
